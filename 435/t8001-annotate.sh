...
[master (root-commit) eb032ed] Initial.
 Author: A <A@test.git>
...
Merging:
4bf89b6 Branch2-1
virtual 6fbb7c635cbf91217d6a69fc6fd1eb4d4ab28efc
...
expecting success: echo "evil merge." >>file &&
     git commit -a --amend
[branch2 e228a2f] Merge branch 'branch1' into branch2

...
[master (root-commit) 8e6034b] first commit
 Author: A U Thor <author@example.com>
 1 files changed, 1 insertions(+), 0 deletions(-)
 create mode 100644 foo
[master 0f40cbc] second commit
 Author: A U Thor <author@example.com>
 1 files changed, 1 insertions(+), 0 deletions(-)
 create mode 100644 bar
[master f0845fe] third commit
 Author: A U Thor <author@example.com>
 1 files changed, 1 insertions(+), 0 deletions(-)
 create mode 100644 baz
[master 14fda2d] fourth commit
 Author: A U Thor <author@example.com>
 1 files changed, 1 insertions(+), 0 deletions(-)
...
commit 8e6034bba66004d239996173c19d13986fb3d6c4
Author: A U Thor <author@example.com>
Date:   Sun Jan 9 04:02:33 2011 +0000

...
[ISO-2022-JP d5f0e5b] $B$O$l$R$[$U(B
 Author: A U Thor <author@example.com>
 1 files changed, 1 insertions(+), 0 deletions(-)
...
[eucJP-fixup d972f63] ¤Ï¤ì¤Ò¤Û¤Õ
 Author: A U Thor <author@example.com>
 1 files changed, 1 insertions(+), 0 deletions(-)
[eucJP-fixup 6ecf9b5] intermediate commit
 Author: A U Thor <author@example.com>
 1 files changed, 1 insertions(+), 0 deletions(-)
 create mode 100644 G
[eucJP-fixup 664204f] fixup! ¤Ï¤ì¤Ò¤Û¤Õ
 Author: A U Thor <author@example.com>
 1 files changed, 1 insertions(+), 0 deletions(-)
Rebasing (2/3)[detached HEAD 4e5e2cc] ¤Ï¤ì¤Ò¤Û¤Õ
 Author: A U Thor <author@example.com>
...
[ISO-2022-JP-squash fd5c22d] $B$O$l$R$[$U(B
 Author: A U Thor <author@example.com>
 1 files changed, 1 insertions(+), 0 deletions(-)
[ISO-2022-JP-squash 88daa16] intermediate commit
 Author: A U Thor <author@example.com>
 1 files changed, 1 insertions(+), 0 deletions(-)
 create mode 100644 G
[ISO-2022-JP-squash befe8f3] squash! $B$O$l$R$[$U(B
 Author: A U Thor <author@example.com>
 1 files changed, 1 insertions(+), 0 deletions(-)
Rebasing (2/3)[detached HEAD d6a2037] $B$O$l$R$[$U(B
 Author: A U Thor <author@example.com>
 1 files changed, 2 insertions(+), 0 deletions(-)
Rebasing (3/3)

...
[master (root-commit) a97ddf7] Initial empty commit
 Author: A U Thor <author@example.com>
[master 81f700b] first
 Author: A U Thor <author@example.com>
 1 files changed, 4 insertions(+), 0 deletions(-)
 create mode 100644 file
[master afe7c67] second
 Author: A U Thor <author@example.com>

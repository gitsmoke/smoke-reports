...
[master (root-commit) 27e719c] Initial
 Author: A U Thor <author@example.com>
 1 files changed, 1 insertions(+), 0 deletions(-)
 create mode 100644 file
[master 4358aaa] add line from a
 Author: A U Thor <author@example.com>
 1 files changed, 1 insertions(+), 1 deletions(-)
[side 7166585] add line from b
 Author: A U Thor <author@example.com>
 1 files changed, 1 insertions(+), 1 deletions(-)
ok 1 - setup
...
HEAD is now at 27e719c Initial
Merge made by ours.
...
HEAD is now at 4358aaa add line from a
Merging:
4358aaa add line from a
virtual side

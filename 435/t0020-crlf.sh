...
expecting success: 
	...
	echo happy.
[master (root-commit) 5b3e170] initial
...
expecting success: 
	...
	git reset --hard HEAD^
HEAD is now at 5b3e170 initial
...
[master f331f65] Add .gitattributes
 Author: A U Thor <author@example.com>
...
[master f78425a] initial
 Author: A U Thor <author@example.com>
 1 files changed, 1 insertions(+), 0 deletions(-)
[master b2aeea5] second
 Author: A U Thor <author@example.com>
...
[master 98c9080] alllf, allcrlf and mixed only
 Author: A U Thor <author@example.com>

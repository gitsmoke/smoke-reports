...
expecting success: git svn fetch
	...
	A	ne_crlf
	A	empty
r1 = 90ad3863a7428b64235418ec45d17dce18a1cec6 (refs/remotes/git-svn)
	M	kw.c
r2 = fb35e5a59adfb039ce0e8e00e7d21f468f5e7d80 (refs/remotes/git-svn)
	M	kw.c
r3 = 36cc22cd07d563a46f5508b82cd473cf27955c33 (refs/remotes/git-svn)
	M	kw.c
r4 = 3dfcddee2ee2053767f6785de74e45cb5dbbc2f5 (refs/remotes/git-svn)
...
[mybranch 0b6e580] test keywords ignoring
 Author: A U Thor <author@example.com>
 1 files changed, 1 insertions(+), 0 deletions(-)
	M	kw.c
	M	kw.c
r5 = 53b530f0e295d62137b51875cf281a45f399b1f6 (refs/remotes/git-svn)
Done committing 1 revisions to SVN
Updating 0b6e580..53b530f
Fast-forward
...
expecting success: git svn fetch &&
	...
	M	ne_crlf
	M	empty
r6 = 5211c76af6c524ea6ed61cdbd2982944b11be039 (refs/remotes/git-svn)
Updating 53b530f..5211c76
Fast-forward
 crlf    |    3 +--
 ne_crlf |    3 +--
...
expecting success: git svn fetch && git pull . ${remotes_git_svn}
	M	cr
	M	ne_cr
r7 = 9483643e56c5540ae03d0e4f23b277f896c17855 (refs/remotes/git-svn)
Updating 5211c76..9483643
Fast-forward
 cr    |    4 +++-
 ne_cr |    4 +++-
...
expecting success: 
	...
	A	deeply/nested/directory/.keep
r8 = 6569321eeece14f73ca718798eaebb97fd1336c9 (refs/remotes/git-svn)
Updating 9483643..6569321
Fast-forward

...
git checkout master
[master (root-commit) 0a1b396] initial has A and M
 Author: A U Thor <author@example.com>
 2 files changed, 30 insertions(+), 0 deletions(-)
 create mode 100644 A
 create mode 100644 M
[master 8efe719] master updates A
 Author: A U Thor <author@example.com>
 1 files changed, 1 insertions(+), 1 deletions(-)
[yellow a1b2132] yellow removes M
 Author: A U Thor <author@example.com>
 1 files changed, 0 insertions(+), 15 deletions(-)
 delete mode 100644 M
[white e50d592] white renames A->B, M->N
 Author: A U Thor <author@example.com>
 2 files changed, 2 insertions(+), 2 deletions(-)
 rename A => B (93%)
 rename M => N (93%)
[red 249387e] red renames A->B, M->N
 Author: A U Thor <author@example.com>
 2 files changed, 2 insertions(+), 2 deletions(-)
 rename A => B (93%)
 rename M => N (93%)
[blue 4b88b56] blue renames A->C, M->N
 Author: A U Thor <author@example.com>
 2 files changed, 2 insertions(+), 2 deletions(-)
 rename A => C (93%)
 rename M => N (93%)
...
Merging:
8efe719 master updates A
virtual e50d592099258c30c35cbb48d81726be49d23175
found 1 common ancestor(s):
0a1b396 initial has A and M
Auto-merging B
...
expecting success: 
	...
	git diff --exit-code white N
HEAD is now at 8efe719 master updates A
Merging:
249387e red renames A->B, M->N
virtual e50d592099258c30c35cbb48d81726be49d23175
found 1 common ancestor(s):
0a1b396 initial has A and M
Auto-merging B
...
expecting success: 
	...
	git diff --exit-code white N
HEAD is now at 249387e red renames A->B, M->N
! [blue] blue renames A->C, M->N
 ! [change] changed
  ! [change+rename] changed and renamed
   ! [master] master updates A
...
Merging:
249387e red renames A->B, M->N
virtual 8efe7198097dba9bc5cbc69ad85a08a3b4d0967a
found 1 common ancestor(s):
0a1b396 initial has A and M
Auto-merging B
CONFLICT (content): Merge conflict in B
...
Merging:
249387e red renames A->B, M->N
virtual 4b88b5697b5bbf4599d24ed43884b75477b74f32
found 1 common ancestor(s):
0a1b396 initial has A and M
Skipped N (merged same as existing)
CONFLICT (rename/rename): Rename "A"->"B" in branch "HEAD" rename "A"->"C" in "4b88b5697b5bbf4599d24ed43884b75477b74f32"
Automatic merge failed; fix conflicts and then commit the result.
g : red changes a line
...
+++++*+ [change+rename^] initial has A and M
Merging:
e50d592 white renames A->B, M->N
virtual 249387e033ebc0a55f9991c2dcdd9a2238601c0c
found 1 common ancestor(s):
0a1b396 initial has A and M
Auto-merging B
CONFLICT (content): Merge conflict in B
...
HEAD is now at e50d592 white renames A->B, M->N
...
Merging:
8efe719 master updates A
virtual a1b21328cde93090d5d04dda81c51e3537d06d09
found 1 common ancestor(s):
0a1b396 initial has A and M
Removing M
...
HEAD is now at 8efe719 master updates A
Updated tag 'anchor' (was 8efe719)
! [blue] blue renames A->C, M->N
 ! [change] changed
  ! [change+rename] changed and renamed
   ! [master] master updates A
...
Merge made by recursive.
 A |    2 +-
 1 files changed, 1 insertions(+), 1 deletions(-)
HEAD is now at a1b2132 yellow removes M
...
HEAD is now at 87bf136 changed and renamed
Skipped B (merged same as existing)
...
HEAD is now at 04f3982 Merge branch 'change+rename' into change
rm 'B'
rm 'M'
[dir-in-way (root-commit) 8df5c95] Common commmit
 Author: A U Thor <author@example.com>
...
[dir-in-way 7ab63b4] Commit to merge, with dir in the way
 Author: A U Thor <author@example.com>
 2 files changed, 2 insertions(+), 0 deletions(-)
rm 'dir/file-in-the-way'
[dir-not-in-way b09a7df] Commit to merge, with dir removed
 Author: A U Thor <author@example.com>
 2 files changed, 1 insertions(+), 1 deletions(-)
 delete mode 100644 dir/file-in-the-way
rm 'dir/file-in-the-way'
rm 'sub/file'
[renamed-file-has-no-conflicts 7cf3742] Independent change
 Author: A U Thor <author@example.com>
 2 files changed, 1 insertions(+), 2 deletions(-)
 rename sub/file => dir (79%)
 delete mode 100644 dir/file-in-the-way
rm 'dir/file-in-the-way'
[renamed-file-has-conflicts 2f32ca7] Conflicting change
 Author: A U Thor <author@example.com>
 2 files changed, 1 insertions(+), 1 deletions(-)
...
HEAD is now at 2f32ca7 Conflicting change
Merging:
7cf3742 Independent change
virtual dir-not-in-way
found 1 common ancestor(s):
8df5c95 Common commmit
...
HEAD is now at 3a5cf81 Merge branch 'dir-not-in-way' into HEAD
...
HEAD is now at 7cf3742 Independent change
...
expecting success: 
	...
	test -f dir &&
	test_cmp expected dir
HEAD is now at 7ab63b4 Commit to merge, with dir in the way
Merging:
2f32ca7 Conflicting change
virtual dir-not-in-way
found 1 common ancestor(s):
8df5c95 Common commmit
Removing dir to make room for subdirectory; may re-add later.
...
HEAD is now at 2f32ca7 Conflicting change
Merging:
7ab63b4 Commit to merge, with dir in the way
...
rm 'n.stages'
rm 'sub/file'
[rename-dest (root-commit) 2dd5e1e] Common commmit
 Author: A U Thor <author@example.com>
 1 files changed, 1 insertions(+), 0 deletions(-)
 create mode 100644 one/file
[rename-dest 5fe354f] Renamed to destdir
 Author: A U Thor <author@example.com>
 1 files changed, 0 insertions(+), 0 deletions(-)
 rename one/file => destdir (100%)
rm 'one/file'
[source-conflict a7ce474] Conflicts in the way
 Author: A U Thor <author@example.com>
...
HEAD is now at a7ce474 Conflicts in the way
Merging:
5fe354f Renamed to destdir
virtual source-conflict
found 1 common ancestor(s):
2dd5e1e Common commmit
...
HEAD is now at 5fe354f Renamed to destdir
rm 'destdir'
[rename-two (root-commit) 00ab07d] Common commmit
 Author: A U Thor <author@example.com>
 2 files changed, 2 insertions(+), 0 deletions(-)
 create mode 100644 one/file
 create mode 100644 two/file
rm 'one/file'
[rename-two eca1a05] Rename two/file -> one
 Author: A U Thor <author@example.com>
 2 files changed, 0 insertions(+), 1 deletions(-)
 rename two/file => one (100%)
 delete mode 100644 one/file
rm 'two/file'
[rename-one a859b8b] Rename one/file -> two
 Author: A U Thor <author@example.com>
 2 files changed, 0 insertions(+), 1 deletions(-)
...
expecting success: 
	...
	test "stuff" = $(cat two)
Merging:
a859b8b Rename one/file -> two
virtual rename-two
found 1 common ancestor(s):
00ab07d Common commmit
...
HEAD is now at a859b8b Rename one/file -> two
Merging:
a859b8b Rename one/file -> two
virtual rename-two
found 1 common ancestor(s):
...
HEAD is now at a859b8b Rename one/file -> two
rm 'two'
[first-rename (root-commit) 5162396] Common commmit
 Author: A U Thor <author@example.com>
 1 files changed, 1 insertions(+), 0 deletions(-)
 create mode 100644 original
[first-rename 6768723] Put two/file in the way, rename to one
 Author: A U Thor <author@example.com>
 1 files changed, 0 insertions(+), 0 deletions(-)
 rename original => one (100%)
 create mode 100644 two/file
[second-rename 7395b47] Put one/file in the way, rename to two
 Author: A U Thor <author@example.com>
 1 files changed, 0 insertions(+), 0 deletions(-)
 create mode 100644 one/file
...
Merging:
6768723 Put two/file in the way, rename to one
virtual second-rename
found 1 common ancestor(s):
5162396 Common commmit
...
HEAD is now at 6768723 Put two/file in the way, rename to one
rm 'one'
rm 'two/file'
[first-rename-redo (root-commit) f56bc86] Common commmit
 Author: A U Thor <author@example.com>
 1 files changed, 1 insertions(+), 0 deletions(-)
 create mode 100644 one/file
 create mode 100644 original
 create mode 100644 two/file
rm 'one/file'
[first-rename-redo 5e01abd] Rename to one
 Author: A U Thor <author@example.com>
 1 files changed, 0 insertions(+), 0 deletions(-)
 rename original => one (100%)
 delete mode 100644 one/file
rm 'two/file'
[second-rename-redo 7a8d389] Rename to two
 Author: A U Thor <author@example.com>
 1 files changed, 0 insertions(+), 0 deletions(-)
 rename original => two (100%)
 delete mode 100644 two/file
...
expecting success: 
	...
	! test -f original
Merging:
5e01abd Rename to one
virtual second-rename-redo
found 1 common ancestor(s):
f56bc86 Common commmit
Removing one to make room for subdirectory; may re-add later.
Removing two/file

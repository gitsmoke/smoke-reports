...
[master 71e9708] Test: Remove, add and update
 Author: A U Thor <author@example.com>
...
[master af29a01] generatiion 1
 Author: A U Thor <author@example.com>
 1 files changed, 0 insertions(+), 0 deletions(-)
[master f3377a7] generation 2
 Author: A U Thor <author@example.com>
 1 files changed, 0 insertions(+), 0 deletions(-)
Checking if patch will apply
Applying
...
HEAD is now at 71e9708 Test: Remove, add and update
[master 7e30fae] test: remove only a binary file
 Author: A U Thor <author@example.com>
 1 files changed, 0 insertions(+), 0 deletions(-)
...
[master 105d3d1] test: remove only a binary file
 Author: A U Thor <author@example.com>
...
[master 5fd4b0a] Update with spaces
 Author: A U Thor <author@example.com>
 2 files changed, 1 insertions(+), 0 deletions(-)
Checking if patch will apply
Applying
...
[master 362b8e9] Update one
 Author: A U Thor <author@example.com>
 1 files changed, 1 insertions(+), 0 deletions(-)
[master 3a6d4ed] Update two
 Author: A U Thor <author@example.com>
 1 files changed, 1 insertions(+), 0 deletions(-)
Checking if patch will apply
Applying
...
[master ed98cca] Add release notes
 Author: A U Thor <author@example.com>
 1 files changed, 1 insertions(+), 0 deletions(-)
...
initial revision: 1.1
Committed successfully to CVS
[master 7a48fd4] Add two files with the same basename
 Author: A U Thor <author@example.com>
...
[master 31bc2fc] Added attic_gremlin
 Author: A U Thor <author@example.com>
 1 files changed, 1 insertions(+), 0 deletions(-)
...
[master 5a4cd25] Add a file with a leading space
 Author: A U Thor <author@example.com>
 1 files changed, 1 insertions(+), 0 deletions(-)
...
[master (root-commit) f6d3324] fake initial commit
 Author: A U Thor <author@example.com>
 1 files changed, 1 insertions(+), 0 deletions(-)
 create mode 100644  space
[master c7f64b9] Another change
 Author: A U Thor <author@example.com>
 1 files changed, 1 insertions(+), 0 deletions(-)
Checking if patch will apply
Applying

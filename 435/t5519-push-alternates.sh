...
[master (root-commit) 4656c23] initial
...
Updating 4656c23..37a11ef
Fast-forward
 file |    1 +
 1 files changed, 1 insertions(+), 0 deletions(-)
[master 9ed7aae] third
 Author: A U Thor <author@example.com>
...
[master b61096c] sixth.1
 Author: A U Thor <author@example.com>
 1 files changed, 1 insertions(+), 1 deletions(-)
[master 46214ab] sixth.2
 Author: A U Thor <author@example.com>
 1 files changed, 1 insertions(+), 0 deletions(-)
[master 44d9737] sixth.3
 Author: A U Thor <author@example.com>
 1 files changed, 1 insertions(+), 0 deletions(-)
...
44d9737814c5e79f76de23d4316b5996a033950a
[master 953b787] seventh
 Author: A U Thor <author@example.com>
 1 files changed, 1 insertions(+), 1 deletions(-)

...
expecting success: 
	...
	echo other >four &&
	echo other >five
[master (root-commit) 6e16f05] First
 Author: A U Thor <author@example.com>
 1 files changed, 1 insertions(+), 0 deletions(-)
 create mode 100644 one
[branch 535b5be] Second
 Author: A U Thor <author@example.com>
...
expecting success: 
	...
	git reset --hard HEAD^
Updating 6e16f05..535b5be
Aborting
[master caf7b6a] empty
 Author: A U Thor <author@example.com>
Aborting
HEAD is now at 6e16f05 First
...
[master (root-commit) 1febc9f] init
 Author: A U Thor <author@example.com>
...
rm 'rep/foo'
rm 'rep2/foo'
[branch 08f2553] added test as a file
 Author: A U Thor <author@example.com>

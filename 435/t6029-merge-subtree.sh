...
expecting success: 
	...
	git add hello &&
	git commit -m master
[master (root-commit) 2fe168a] initial
...
[master (root-commit) 167f22a] initial git-gui
 Author: A U Thor <author@example.com>
 1 files changed, 1 insertions(+), 0 deletions(-)
...
[master (root-commit) c2747f6] initial git
 Author: A U Thor <author@example.com>
 1 files changed, 1 insertions(+), 0 deletions(-)
...
Updating gui
[master d3e4bd1] Merge git-gui as our subdirectory
 Author: A U Thor <author@example.com>
...
expecting success: 
	...
	test_cmp expected actual
M	git-gui.sh
[master2 1f6d3c9] update git-gui
 Author: A U Thor <author@example.com>
 1 files changed, 1 insertions(+), 1 deletions(-)
Merging:
d3e4bd1 Merge git-gui as our subdirectory
virtual 1f6d3c9c039c6d7fdd938912ad2b0b0b44cca3f8
found 1 common ancestor(s):
167f22a initial git-gui
Merge made by subtree.
...
expecting success: 
	...
	test_cmp expected actual
HEAD is now at d3e4bd1 Merge git-gui as our subdirectory
Already up-to-date.
[master2 b9558c9] Merge git-gui2 as our subdirectory
 Author: A U Thor <author@example.com>
 1 files changed, 1 insertions(+), 0 deletions(-)
...
expecting success: 
	...
	test_cmp expected actual
HEAD is now at b9558c9 Merge git-gui2 as our subdirectory
Merging:
b9558c9 Merge git-gui2 as our subdirectory
virtual 1f6d3c9c039c6d7fdd938912ad2b0b0b44cca3f8
found 1 common ancestor(s):
167f22a initial git-gui

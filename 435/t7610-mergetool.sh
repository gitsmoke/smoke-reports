...
[master (root-commit) c602ab7] added file1
 Author: A U Thor <author@example.com>
 2 files changed, 2 insertions(+), 0 deletions(-)
 create mode 100644 file1
 create mode 100644 subdir/file3
[branch1 727005a] branch1 changes
 Author: A U Thor <author@example.com>
 3 files changed, 3 insertions(+), 2 deletions(-)
 create mode 100644 file2
[master c5bc26d] master updates
 Author: A U Thor <author@example.com>
 3 files changed, 3 insertions(+), 2 deletions(-)
 create mode 100644 file2
...
[test1 a686399] branch1 resolved with mergetool
 Author: A U Thor <author@example.com>
...
x")" &&
    ...
    git reset --hard
[test2 b1608ba] branch1 resolved with mergetool - autocrlf
 Author: A U Thor <author@example.com>
HEAD is now at b1608ba branch1 resolved with mergetool - autocrlf
ok 3 - mergetool crlf
...
[test3 1a8ad04] branch1 resolved with mergetool - subdir
 Author: A U Thor <author@example.com>
...
HEAD is now at 727005a branch1 changes
...
Normal merge conflict for 'subdir/file3':
  {local}: modified
  {remote}: modified
[test4 365c75d] branch2 resolved by mergetool from subdir
 Author: A U Thor <author@example.com>

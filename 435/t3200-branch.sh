...
[master (root-commit) 4130999] Initial commit.
 Author: A U Thor <author@example.com>
 1 files changed, 1 insertions(+), 0 deletions(-)
 create mode 100644 A
[master 4f87622] Second commit.
 Author: A U Thor <author@example.com>
 1 files changed, 1 insertions(+), 0 deletions(-)
...
expecting success: git branch -d d/e/f &&
	 test ! -f .git/refs/heads/d/e/f &&
	 test ! -f .git/logs/refs/heads/d/e/f
Deleted branch d/e/f (was 4f87622).
...
expecting success: git branch l/m &&
        git branch -d l/m &&
        git branch l
Deleted branch l/m (was 4f87622).
...
Deleted branch s/t (was 4f87622).
...
Deleted branch my7 (was 4f87622).
...
4f87622d91780d5f522715afc71693f14bce6a98
...
expecting success: 
	...
	git branch -d my8
Deleted branch my8 (was 4f87622).

...
[master (root-commit) de509e6] Add A1
 Author: A U Thor <bogus_email_address>
 1 files changed, 1 insertions(+), 0 deletions(-)
 create mode 100644 A
[topic ae380db] Add B1
 Author: A U Thor <bogus_email_address>
 1 files changed, 1 insertions(+), 0 deletions(-)
 create mode 100644 B
[master 9b018a6] Modify A2
 Author: A U Thor <bogus_email_address>
 1 files changed, 1 insertions(+), 0 deletions(-)
Cloning into clone1...
done.
...
Merge made by recursive.
 A |    1 +
 1 files changed, 1 insertions(+), 0 deletions(-)
[master cd5287b] Add different B
 Author: A U Thor <bogus_email_address>
 1 files changed, 1 insertions(+), 0 deletions(-)
 create mode 100644 B
Cloning into clone2...
...
[topic 1861bba] Merge origin/master into topic
 Author: A U Thor <bogus_email_address>
[topic 979ac9a] Modify B2
 Author: A U Thor <bogus_email_address>
 1 files changed, 1 insertions(+), 0 deletions(-)
...
Rebasing (1/1)Merging:
979ac9a Modify B2
virtual cd5287bba4dea279ab58b843dc5ad88288a4813f
found 1 common ancestor(s):
de509e6 Add A1
Auto-merging B
CONFLICT (add/add): Merge conflict in B
...
B: needs merge
@@@ -1,1 -1,1 +1,1 @@@
[detached HEAD 2dd912a] Merge origin/master into topic
 Author: A U Thor <bogus_email_address>
Rebasing (1/1)

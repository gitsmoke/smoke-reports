...
[master (root-commit) 1f3574c] initial commit
...
[master (root-commit) c25d189] submodule commit 1
 Author: A U Thor <author@example.com>
...
[master (root-commit) a22a128] Ignore everything
 Author: A U Thor <author@example.com>
 1 files changed, 1 insertions(+), 0 deletions(-)
...
rev1: c25d18970dedd79c48367b46e24a14bf14656a2c
...
expecting success: 
	git submodule status >lines &&
	grep "^-$rev1" lines
-c25d18970dedd79c48367b46e24a14bf14656a2c init
...
Submodule path 'init': checked out 'c25d18970dedd79c48367b46e24a14bf14656a2c'
...
expecting success: 
	...
	grep "^ $rev1" list
 c25d18970dedd79c48367b46e24a14bf14656a2c init (rev-1)
...
expecting success: 
	...
	grep "^+$rev2" list
[detached HEAD 855ad73] submodule commit 2
 Author: A U Thor <author@example.com>
 1 files changed, 1 insertions(+), 0 deletions(-)
 create mode 100644 b
+855ad73a7549e4c4b997fedcd80e05c2fe00f5c9 init (rev-1-1-g855ad73)
...
+Subproject commit 855ad73a7549e4c4b997fedcd80e05c2fe00f5c9
...
[detached HEAD d67d760] change subproject
 Author: A U Thor <author@example.com>
 1 files changed, 1 insertions(+), 0 deletions(-)
 create mode 100644 s
[master 1e32ad6] change init
 Author: A U Thor <author@example.com>
...
Submodule path 'init': checked out 'd67d760fc408c7f939bfa78fb452257a3b5e2f31'
...
HEAD is now at a87d218 super commit 1
...
HEAD is now at a87d218 super commit 1
[second 9bab736] commit subproject
 Author: A U Thor <author@example.com>
 1 files changed, 1 insertions(+), 1 deletions(-)
diff --git a/init b/init
index d67d760..54351de 160000
--- a/init
+++ b/init
@@ -1 +1 @@
-Subproject commit d67d760fc408c7f939bfa78fb452257a3b5e2f31
+Subproject commit 54351de0f16a6f4ac647656fce326998e828506a
...
HEAD is now at 9bab736 commit subproject
...
[master (root-commit) 57e6b63] repo commit 1
 Author: A U Thor <author@example.com>
 1 files changed, 1 insertions(+), 0 deletions(-)

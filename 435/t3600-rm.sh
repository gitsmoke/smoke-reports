...
[master (root-commit) 696c7b9] add normal files
...
[master 38af055] add files with tabs and newlines
 Author: A U Thor <author@example.com>
 0 files changed, 0 insertions(+), 0 deletions(-)
...
[master 29f78c3] add file for rm test
 Author: A U Thor <author@example.com>
...
[master 2f89fe7] remove file from rm test
 Author: A U Thor <author@example.com>
...
[master 2544ce2] add file for rm --quiet test
 Author: A U Thor <author@example.com>
 1 files changed, 1 insertions(+), 0 deletions(-)
 create mode 100644 test-file
[master dd3840b] remove file from rm --quiet test
 Author: A U Thor <author@example.com>
 1 files changed, 0 insertions(+), 1 deletions(-)
 delete mode 100644 test-file
...
[master (root-commit) 3ba434a] add a file
 Author: A U Thor <author@example.com>
 1 files changed, 1 insertions(+), 0 deletions(-)
...
HEAD is now at 4cee1fb subdir test
rm 'frotz/nitfol'

...
r1 = 4854829327255d5cd5949735e853954905e670cd (refs/remotes/git-svn)
...
[test-rmdir 25e64a1] remove another
 ...
 delete mode 100644 deeply/nested/directory/number/2/another
	...
	D	deeply/nested/directory/number/2/another
	D	deeply/nested/directory/number/2/
r2 = c5772cd290735a9732a0e9423a1d32963411d7ca (refs/remotes/git-svn)

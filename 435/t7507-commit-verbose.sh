...
[master (root-commit) 5df9571] subject
...
expecting success: 
	...
	check_message diff
[master 3fed196] This is an example commit message that contains a diff.
 Author: A U Thor <author@example.com>
 1 files changed, 1 insertions(+), 1 deletions(-)
...
checking known breakage: 
	...
	check_message diff
[master 4f2a7fd] This is an example commit message that contains a diff.
 Author: A U Thor <author@example.com>
 1 files changed, 1 insertions(+), 1 deletions(-)
--- diff	2011-01-09 04:03:15.000000000 +0000
+++ actual	2011-01-09 04:03:15.000000000 +0000
@@ -1,9 +1,2 @@

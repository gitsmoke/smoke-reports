...
[master (root-commit) 7f12e88] A-initial
...
[master (root-commit) 5d8a257] B-super-initial
 Author: A U Thor <author@example.com>
 1 files changed, 1 insertions(+), 0 deletions(-)
...
Cloning into sub...
Submodule path 'sub': checked out '7f12e8822d04c9bf2b8f4fff241278beb157d7d5'

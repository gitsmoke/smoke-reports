...
expecting success: 
	...
	git tag initial
[master (root-commit) fa91c05] initial
...
HEAD is now at fa91c05 initial
[master 48a1bd3] add=5
 Author: A U Thor <author@example.com>
...
Deleted branch test5 (was a9b6cdd).
HEAD is now at fa91c05 initial
[master 48a1bd3] add=5
 Author: A U Thor <author@example.com>
 5 files changed, 110 insertions(+), 0 deletions(-)
...
Deleted branch test5 (was 6d34464).
HEAD is now at fa91c05 initial
[master 954587f] add=5
 Author: A U Thor <author@example.com>
 5 files changed, 110 insertions(+), 0 deletions(-)
 create mode 100644 1
 create mode 100644 2
...
[simple-change 954c11b] unrelated-change
 Author: A U Thor <author@example.com>
 0 files changed, 0 insertions(+), 0 deletions(-)

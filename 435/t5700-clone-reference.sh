...
[master (root-commit) d59c8d6] initial
...
Merging:
20d83f7 addition
virtual 602f349f1037811d06c847762f458dbcd25f80b3
...
[master (root-commit) b8fdb0b] initial
 Author: A U Thor <author@example.com>
 1 files changed, 1 insertions(+), 0 deletions(-)
 create mode 100644 file1

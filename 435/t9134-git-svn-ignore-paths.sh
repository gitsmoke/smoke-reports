...
Initialized empty Git repository in /Users/trast/git-smoke/t/trash directory.t9134-git-svn-ignore-paths/g/.git/
	A	qqq/test_qqq.txt
r1 = 3369e85f0465d299f147cbef3c22d68200fe2208 (refs/remotes/git-svn)
r2 = 5c8543f098a7a7ebe2d25179644d10e43e6456ee (refs/remotes/git-svn)
...
" > expect &&
	...
	M	qqq/test_qqq.txt
r3 = 46acdbdb75fd5d985c31f7c63b9c348e1263b3d3 (refs/remotes/git-svn)
...
r4 = 76c0467152a4ea5126bf614b4afee6009ec1759a (refs/remotes/git-svn)
First, rewinding head to replay your work on top of it...
Fast-forwarded master to refs/remotes/git-svn.
...
" > expect &&
	...
	M	qqq/test_qqq.txt
r5 = 7dfa6baf88d77611e0a785f0b82d0e1ba32720dd (refs/remotes/git-svn)
First, rewinding head to replay your work on top of it...
Fast-forwarded master to refs/remotes/git-svn.

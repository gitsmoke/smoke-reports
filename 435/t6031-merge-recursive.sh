...
[master (root-commit) 55bf4a3] initial
...
[other d6b3381] changesimplefile
 Author: A U Thor <author@example.com>
 1 files changed, 1 insertions(+), 0 deletions(-)
rm 'sub1'
[main 12e2858] changefiletodir
 Author: A U Thor <author@example.com>

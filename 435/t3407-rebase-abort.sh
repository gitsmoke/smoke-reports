...
[master a7b9486] c
 Author: A U Thor <author@example.com>
 1 files changed, 1 insertions(+), 1 deletions(-)
[to-rebase cc4a055] merge should fail on this
 Author: A U Thor <author@example.com>
 1 files changed, 1 insertions(+), 1 deletions(-)
[to-rebase dc59c92] merge should fail on this, too
 Author: A U Thor <author@example.com>
 1 files changed, 1 insertions(+), 1 deletions(-)
...
HEAD is now at dc59c92 merge should fail on this, too
...
Merging HEAD with merge should fail on this, too
Merging:
095b4f0 merge should fail on this
virtual merge should fail on this, too
found 1 common ancestor(s):
virtual f788de73cfc81f8d734fa7efc658cc63ca083f50
Auto-merging a
...
Merging:
a7b9486 c
cc4a055 merge should fail on this
found 1 common ancestor(s):
c446ce7 a
Auto-merging a
CONFLICT (content): Merge conflict in a
...
Merging:
a7b9486 c
dc59c92 merge should fail on this, too
found 1 common ancestor(s):
cc4a055 merge should fail on this
Auto-merging a
CONFLICT (content): Merge conflict in a
...
Auto-merging a
CONFLICT (content): Merge conflict in a
[detached HEAD 3c8df11] merge should fail on this
 Author: A U Thor <author@example.com>
 1 files changed, 1 insertions(+), 0 deletions(-)
Committed: 0001 merge should fail on this
Merging master with HEAD~0
Merging:
3c8df11 merge should fail on this
dc59c92 merge should fail on this, too
found 1 common ancestor(s):
cc4a055 merge should fail on this
Auto-merging a

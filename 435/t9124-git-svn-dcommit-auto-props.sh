...
Committed revision 1.
	A	foo
r1 = cedd0da3ccdede524dc382ae15c22073577b6309 (refs/remotes/git-svn)
...
[master aea5bf0] files for enabled auto-props
...
Committed r2
	...
	A	bar
	A	exec1.sh
r2 = e83654f0ff994ef94d80b184f79e84eee350df5d (refs/remotes/git-svn)
...
[master b52223a] files for disabled auto-props
 Author: A U Thor <author@example.com>
 3 files changed, 3 insertions(+), 0 deletions(-)
...
Committed r3
	...
	A	world.txt
	A	zot
r3 = ee7cba1b8abd8632d1af8c872aeb7b80028c934d (refs/remotes/git-svn)
No changes between current HEAD and refs/remotes/git-svn
Resetting to the latest refs/remotes/git-svn
...
Committed r4
	D	foo
	A	foo.sh
r4 = 8338c27460675cf7b6ad14a1c4ec5f33752e8299 (refs/remotes/git-svn)
No changes between current HEAD and refs/remotes/git-svn
Resetting to the latest refs/remotes/git-svn
D    foo
A    foo.sh

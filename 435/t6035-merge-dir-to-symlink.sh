...
HEAD is now at e3e9897 dir to symlink
rm 'a/b'
[detached HEAD b89b881] untracked symlink remains
 Author: A U Thor <author@example.com>
...
HEAD is now at 04f4c8f base
[detached HEAD fb9d291] x
 Author: A U Thor <author@example.com>
 1 files changed, 1 insertions(+), 0 deletions(-)
...
expecting success: 
	...
	test -h a/b &&
	test -f a/b-2/c/d
HEAD is now at a33937c Merge branch 'master' into HEAD
Merging:
fb9d291 x
virtual master
...
HEAD is now at f39fe98 Merge branch 'master' into HEAD
Trying really trivial in-index merge...
Nope.
Trying simple merge.
Simple merge failed, trying Automatic merge.
...
HEAD is now at 59065ec Merge commit 'baseline^0' into HEAD
Merging:
e3e9897 dir to symlink
virtual baseline^0
found 1 common ancestor(s):
04f4c8f base
...
expecting success: 
	...
	test -f a/b/c/e &&
	test -f a/b-2/c/d
HEAD is now at dc009d8 Merge branch 'master' into HEAD
Merging:
fb9d291 x
virtual master
found 1 common ancestor(s):
...
expecting success: 
	...
	git tag test2
HEAD is now at fb9d291 x
[detached HEAD 2ee1f14] dir a/b-2 to symlink
 Author: A U Thor <author@example.com>
...
HEAD is now at 2ee1f14 dir a/b-2 to symlink
Trying really trivial in-index merge...
Nope.
Trying simple merge.
Simple merge failed, trying Automatic merge.
...
expecting success: 
	...
	test -h a/b-2 &&
	test -f a/b/c/d
HEAD is now at e7d9358 Merge commit 'test2' into HEAD
Merging:
fb9d291 x
virtual test2
found 1 common ancestor(s):

...
[master (root-commit) 0c29271] initial
...
[master 530dca9] master removes file2 and subdir/file2
 Author: A U Thor <author@example.com>
...
D	file2
D	subdir/file2
[side 8a976ec] side adds file3 and removes file2
 Author: A U Thor <author@example.com>
...
HEAD is now at 530dca9 master removes file2 and subdir/file2
...
expecting success: 
	...
	git checkout side-a
HEAD is now at 530dca9 master removes file2 and subdir/file2
[side-a 06668a2] side-a changes file1
 Author: A U Thor <author@example.com>
 1 files changed, 1 insertions(+), 0 deletions(-)
[side-b ad2a352] side-b changes file2
 Author: A U Thor <author@example.com>
 1 files changed, 1 insertions(+), 0 deletions(-)
...
HEAD is now at 06668a2 side-a changes file1
...
HEAD is now at 06668a2 side-a changes file1
[sym-b 74b36c2] side adds a/b
 Author: A U Thor <author@example.com>
 0 files changed, 0 insertions(+), 0 deletions(-)
 create mode 100644 a/b
[sym-a 9f69ad8] we add a/b
 Author: A U Thor <author@example.com>
 1 files changed, 1 insertions(+), 0 deletions(-)
...
HEAD is now at 9f69ad8 we add a/b
...
HEAD is now at 9f69ad8 we add a/b
[side-a 8ac6df3] side-a changes file2 to directory
 Author: A U Thor <author@example.com>
...
HEAD is now at ad2a352 side-b changes file2
Trying simple merge.
...
Merging:
ad2a352 side-b changes file2
8ac6df3 side-a changes file2 to directory

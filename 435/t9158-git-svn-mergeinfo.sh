...
expecting success: 
	...
	git svn fetch
r1 = d8462744580c3baeb23767b5c137e765283f41c7 (refs/remotes/git-svn)
	A	foo
r2 = 4c6ede6f30a3f8c0144925d59eb5cd270d780b7a (refs/remotes/git-svn)
...
Committed r3
	A	bar
r3 = 0de655d4f72f857de2f26ba88d57d49a9c4a50f4 (refs/remotes/git-svn)

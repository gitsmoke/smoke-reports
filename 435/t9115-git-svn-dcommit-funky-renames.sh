...
[master 1f24930] new file in ugly parent
...
Committed r2
	A	#{bad_directory_name}/ foo
r2 = d4c54caac782a4d4ab7f098c3036af5e63f98eac (refs/remotes/git-svn)
...
[master ceb385a] rename ugly file
 Author: A U Thor <author@example.com>
...
r3 = dc97632fc263e58a96a101aa69ae77f937f70618 (refs/remotes/git-svn)
No changes between current HEAD and refs/remotes/git-svn
Resetting to the latest refs/remotes/git-svn
...
Committed r4
	A	pretty
r4 = 4a3a2fe8ccd038043ffd83c0b346ad2e37c27145 (refs/remotes/git-svn)
No changes between current HEAD and refs/remotes/git-svn
Resetting to the latest refs/remotes/git-svn
[master 029b11b] moved pretty file
 Author: A U Thor <author@example.com>
 1 files changed, 0 insertions(+), 0 deletions(-)
...
r5 = 0786f5d6b2f658d68438cc5dcc2525d38d90f62b (refs/remotes/git-svn)
No changes between current HEAD and refs/remotes/git-svn
Resetting to the latest refs/remotes/git-svn
...
r6 = e56886609b00fca06e546176fba13fca30c1dc68 (refs/remotes/git-svn)
No changes between current HEAD and refs/remotes/git-svn
Resetting to the latest refs/remotes/git-svn
...
Committed r7
	A	+_+
r7 = a33b78c009280576696a265a3410bd01dd95b7f8 (refs/remotes/git-svn)
No changes between current HEAD and refs/remotes/git-svn
Resetting to the latest refs/remotes/git-svn
...
Committed r8
	D	+_+
	A	gtk+/_+_
r8 = 5a3abd9fa0b50db1201c609405f88da24b7577e2 (refs/remotes/git-svn)
No changes between current HEAD and refs/remotes/git-svn
Resetting to the latest refs/remotes/git-svn
...
[master d1acda5] test-rebase-main
 Author: A U Thor <author@example.com>
 1 files changed, 1 insertions(+), 0 deletions(-)
...
Committed r9
	A	test-rebase-main
r9 = d64423f100fc655ec81a3a8eb16d7f390dbd188e (refs/remotes/git-svn)
No changes between current HEAD and refs/remotes/git-svn
Resetting to the latest refs/remotes/git-svn

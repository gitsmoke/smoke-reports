...
[master (root-commit) ab77c10] commit
...
Unstaged changes after reset:
M	file
[master e91d600] commit
 Author: A U Thor <author@example.com>
 1 files changed, 1 insertions(+), 1 deletions(-)
HEAD is now at ab77c10 commit
...
[master b4679d6] clear local changes
 Author: A U Thor <author@example.com>
 1 files changed, 1 insertions(+), 0 deletions(-)
...
HEAD is now at b4679d6 clear local changes
[master 7900e53] non-empty
 Author: A U Thor <author@example.com>
 1 files changed, 1 insertions(+), 0 deletions(-)
...
HEAD is now at 7900e53 non-empty
[master 3110596] empty
 Author: A U Thor <author@example.com>

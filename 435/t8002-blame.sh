...
[master (root-commit) f5a8c27] Initial.
 Author: A <A@test.git>
...
Merging:
07803ea Branch2-1
virtual f34faf029096f41cdeb8c705c09a9d9fe5573e41
...
expecting success: echo "evil merge." >>file &&
     git commit -a --amend
[branch2 cf4b3d3] Merge branch 'branch1' into branch2

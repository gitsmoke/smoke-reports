...
ok 27 - diff driver 'objc'
ok 28 - diff driver 'pascal'
ok 29 - diff driver 'perl'
ok 30 - diff driver 'php'
ok 31 - diff driver 'python'
ok 32 - diff driver 'ruby'
ok 33 - diff driver 'tex'
ok 34 - word-diff with diff.sbe

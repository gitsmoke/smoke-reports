...
ok 22 # skip stash file to symlink (missing SYMLINKS of SYMLINKS)
ok 23 # skip stash file to symlink (stage rm) (missing SYMLINKS of SYMLINKS)
ok 24 # skip stash file to symlink (full stage) (missing SYMLINKS of SYMLINKS)
ok 25 # skip stash symlink to file (missing SYMLINKS of SYMLINKS)
ok 26 # skip stash symlink to file (stage rm) (missing SYMLINKS of SYMLINKS)
ok 27 # skip stash symlink to file (full stage) (missing SYMLINKS of SYMLINKS)

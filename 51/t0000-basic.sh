...
ok 28 # skip git ls-tree output for a known tree. (missing SYMLINKS of SYMLINKS)
ok 29 - showing tree with git ls-tree -r
ok 30 - git ls-tree -r output for a known tree.
ok 31 - showing tree with git ls-tree -r -t
ok 32 # skip git ls-tree -r output for a known tree. (missing SYMLINKS of SYMLINKS)
...
ok 48 # skip absolute path works as expected (missing SYMLINKS of SYMLINKS)

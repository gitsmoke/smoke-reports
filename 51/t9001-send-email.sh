...
ok 11 - setup expect
not ok - 12 Verify commandline
#	test_cmp expected commandline1
ok 13 - Send patches with --envelope-sender=auto
ok 14 - setup expect
not ok - 15 Verify commandline
#	test_cmp expected commandline1
ok 16 - setup expect
...
ok 78 - setup expect
ok 79 - setup expect
not ok - 80 asks about and fixes 8bit encodings
#	
#		clean_fake_sendmail &&
#		echo |
...
#	
not ok - 81 sendemail.8bitEncoding works
#	
#		clean_fake_sendmail &&
...
#		test_cmp actual content-type-decl
#	
not ok - 82 --8bit-encoding overrides sendemail.8bitEncoding
#	
#		clean_fake_sendmail &&
...
ok 83 - setup expect
ok 84 - setup expect
not ok - 85 --8bit-encoding also treats subject
#	
#		clean_fake_sendmail &&
#		echo bogus |
#		git send-email --from=author@example.com --to=nobody@example.com \

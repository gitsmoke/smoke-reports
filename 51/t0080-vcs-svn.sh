...
#	
not ok - 2 obj pool: NULL is offset ~0
#	
#		echo "$uint32_max" >expected &&
#		echo null one | test-obj-pool >actual &&
#		test_cmp expected actual
#	
not ok - 3 obj pool: out-of-bounds access
#	
#		cat <<-EOF >expected &&
#		0
#		0
...
#		test_cmp expected actual
#	
not ok - 4 obj pool: high-water mark
#	
#		cat <<-\EOF >expected &&
#		0
#		0

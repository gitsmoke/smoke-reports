...
ok 22 # skip init creates a new deep directory (umask vs. shared) (missing POSIXPERM of POSIXPERM)
ok 23 - init notices EEXIST (1)
ok 24 - init notices EEXIST (2)
ok 25 # skip init notices EPERM (missing SANITY,POSIXPERM of POSIXPERM,SANITY)

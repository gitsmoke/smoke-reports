...
ok 2 # skip add files with funny names (missing FUNNYNAMES of FUNNYNAMES)
...
ok 14 # skip Test that "git rm -f" succeeds with embedded space, tab, or newline characters. (missing FUNNYNAMES of FUNNYNAMES)

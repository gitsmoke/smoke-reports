...
#		 gitweb_run "p=.git;a=commitdiff"
ok 31 # skip commitdiff(0): file to symlink (missing SYMLINKS of SYMLINKS)
...
#		 gitweb_run "p=.git;a=commitdiff"
ok 37 # skip setup typechange commits (missing SYMLINKS of SYMLINKS)
...
ok 89 # skip syntax highlighting (no highlight) (missing HIGHLIGHT of HIGHLIGHT)
ok 90 # skip syntax highlighting (highlighted) (missing HIGHLIGHT of HIGHLIGHT)
# failed 83 among 90 test(s)
1..90

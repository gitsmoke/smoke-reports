...
[master (root-commit) 774509f] Initial.
 Author: A <A@test.git>
...
Merging:
de325b4 Branch2-1
virtual 3e790d5431a0078ffecc79e5a3f3490f14a0c311
...
expecting success: echo "evil merge." >>file &&
     git commit -a --amend
[branch2 99742ae] Merge branch 'branch1' into branch2

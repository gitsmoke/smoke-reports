...
Initialized empty Git repository in /Users/trast/git-smoke/t/trash directory.t9134-git-svn-ignore-paths/g/.git/
	A	qqq/test_qqq.txt
r1 = 8c29a01d42724a4b7c0752e6f5d87cc3ea331061 (refs/remotes/git-svn)
r2 = 182a7e93f8ca41bc314f58af5651f083d80bc67e (refs/remotes/git-svn)
...
" > expect &&
	...
	M	qqq/test_qqq.txt
r3 = 5aea00ab0276738174d66c9d689086340899e0a6 (refs/remotes/git-svn)
...
r4 = 3ce0baff8f9b9817430cabcd04f49be4d492cbda (refs/remotes/git-svn)
First, rewinding head to replay your work on top of it...
Fast-forwarded master to refs/remotes/git-svn.
...
" > expect &&
	...
	M	qqq/test_qqq.txt
r5 = 8dcb5cc8e9d7a2995b97c47f6de8e3626efadfe1 (refs/remotes/git-svn)
First, rewinding head to replay your work on top of it...
Fast-forwarded master to refs/remotes/git-svn.

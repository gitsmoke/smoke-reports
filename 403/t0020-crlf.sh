...
expecting success: 
	...
	echo happy.
[master (root-commit) 9619de8] initial
...
expecting success: 
	...
	git reset --hard HEAD^
HEAD is now at 9619de8 initial
...
[master 29b2068] Add .gitattributes
 Author: A U Thor <author@example.com>
...
[master a4f786d] initial
 Author: A U Thor <author@example.com>
 1 files changed, 1 insertions(+), 0 deletions(-)
[master b0bbcff] second
 Author: A U Thor <author@example.com>
...
[master 817ff39] alllf, allcrlf and mixed only
 Author: A U Thor <author@example.com>

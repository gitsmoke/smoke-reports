...
[master (root-commit) db9e3ff] initial
 Author: A U Thor <author@example.com>
 0 files changed, 0 insertions(+), 0 deletions(-)
 create mode 100644 camelcase
[topic d812da7] rename
 Author: A U Thor <author@example.com>
...
checking known breakage: 
	...
	git merge topic
HEAD is now at db9e3ff initial
Updating db9e3ff..d812da7
Fast-forward
...
[master (root-commit) 765cab4] initial
 Author: A U Thor <author@example.com>
 0 files changed, 0 insertions(+), 0 deletions(-)
 create mode 100644 "a\314\210"
[topic 15367d3] rename
 Author: A U Thor <author@example.com>
 1 files changed, 0 insertions(+), 0 deletions(-)
...
HEAD is now at 765cab4 initial
Updating 765cab4..15367d3
Aborting

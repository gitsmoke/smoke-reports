...
[master (root-commit) 8fec788] Initial commit.
 Author: A U Thor <author@example.com>
 1 files changed, 1 insertions(+), 0 deletions(-)
 create mode 100644 A
[master 6dd1792] Second commit.
 Author: A U Thor <author@example.com>
 1 files changed, 1 insertions(+), 0 deletions(-)
...
expecting success: git branch l/m &&
        git branch -d l/m &&
        git branch l
Deleted branch l/m (was 6dd1792).
...
Deleted branch s/t (was 6dd1792).
...
Deleted branch my7 (was 6dd1792).
...
6dd179276d3829241a981c89620a4dd5a9e37602
...
expecting success: 
	...
	git branch -d my8
Deleted branch my8 (was 6dd1792).

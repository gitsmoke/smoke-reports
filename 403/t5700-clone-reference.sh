...
[master (root-commit) 89e3375] initial
...
Merging:
76de023 addition
virtual cf8363ca89e3f52bc173fa6056d1ea43d0d089b2
...
[master (root-commit) ce0bc1e] initial
 Author: A U Thor <author@example.com>
 1 files changed, 1 insertions(+), 0 deletions(-)
 create mode 100644 file1

...
[master (root-commit) f57443a] A-initial
...
[master (root-commit) d6184b3] B-super-initial
 Author: A U Thor <author@example.com>
 1 files changed, 1 insertions(+), 0 deletions(-)
...
Cloning into sub...
Submodule path 'sub': checked out 'f57443a8199327657e1100cfe3b832226b834fd1'

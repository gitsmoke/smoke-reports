...
[master (root-commit) 4b485f5] commit
...
Unstaged changes after reset:
M	file
[master 18def9d] commit
 Author: A U Thor <author@example.com>
 1 files changed, 1 insertions(+), 1 deletions(-)
HEAD is now at 4b485f5 commit
...
[master 63305fa] clear local changes
 Author: A U Thor <author@example.com>
 1 files changed, 1 insertions(+), 0 deletions(-)
...
HEAD is now at 63305fa clear local changes
[master b899217] non-empty
 Author: A U Thor <author@example.com>
 1 files changed, 1 insertions(+), 0 deletions(-)
...
HEAD is now at b899217 non-empty
[master 966e059] empty
 Author: A U Thor <author@example.com>

...
git checkout master
[master (root-commit) 02f512c] initial has A and M
 Author: A U Thor <author@example.com>
 2 files changed, 30 insertions(+), 0 deletions(-)
 create mode 100644 A
 create mode 100644 M
[master 5e9c3da] master updates A
 Author: A U Thor <author@example.com>
 1 files changed, 1 insertions(+), 1 deletions(-)
[yellow aa5298d] yellow removes M
 Author: A U Thor <author@example.com>
 1 files changed, 0 insertions(+), 15 deletions(-)
 delete mode 100644 M
[white cc68d7d] white renames A->B, M->N
 Author: A U Thor <author@example.com>
 2 files changed, 2 insertions(+), 2 deletions(-)
 rename A => B (93%)
 rename M => N (93%)
[red bca45b6] red renames A->B, M->N
 Author: A U Thor <author@example.com>
 2 files changed, 2 insertions(+), 2 deletions(-)
 rename A => B (93%)
 rename M => N (93%)
[blue 97505fa] blue renames A->C, M->N
 Author: A U Thor <author@example.com>
 2 files changed, 2 insertions(+), 2 deletions(-)
 rename A => C (93%)
 rename M => N (93%)
...
Merging:
5e9c3da master updates A
virtual cc68d7d55f93c81c913c5c0a43b7a76671a6a286
found 1 common ancestor(s):
02f512c initial has A and M
Auto-merging B
...
expecting success: 
	...
	git diff --exit-code white N
HEAD is now at 5e9c3da master updates A
Merging:
bca45b6 red renames A->B, M->N
virtual cc68d7d55f93c81c913c5c0a43b7a76671a6a286
found 1 common ancestor(s):
02f512c initial has A and M
Auto-merging B
...
expecting success: 
	...
	git diff --exit-code white N
HEAD is now at bca45b6 red renames A->B, M->N
! [blue] blue renames A->C, M->N
 ! [change] changed
  ! [change+rename] changed and renamed
   ! [master] master updates A
...
Merging:
bca45b6 red renames A->B, M->N
virtual 5e9c3dac1013cc93f307799779268aa9e20e4749
found 1 common ancestor(s):
02f512c initial has A and M
Auto-merging B
CONFLICT (content): Merge conflict in B
...
Merging:
bca45b6 red renames A->B, M->N
virtual 97505fad7a1034f3a9afdf9cc6b51a527d0e3d7e
found 1 common ancestor(s):
02f512c initial has A and M
Skipped N (merged same as existing)
CONFLICT (rename/rename): Rename "A"->"B" in branch "HEAD" rename "A"->"C" in "97505fad7a1034f3a9afdf9cc6b51a527d0e3d7e"
Automatic merge failed; fix conflicts and then commit the result.
g : red changes a line
...
+++++*+ [yellow^] initial has A and M
Merging:
cc68d7d white renames A->B, M->N
virtual bca45b6a91473346f690ec4479bc85adc70a825c
found 1 common ancestor(s):
02f512c initial has A and M
Auto-merging B
CONFLICT (content): Merge conflict in B
...
HEAD is now at cc68d7d white renames A->B, M->N
...
Merging:
5e9c3da master updates A
virtual aa5298d00375e06ecf11fdc50bf85839082c5b5b
found 1 common ancestor(s):
02f512c initial has A and M
Removing M
...
expecting success: 
	...
	git reset --hard anchor
HEAD is now at 5e9c3da master updates A
Updated tag 'anchor' (was 5e9c3da)
! [blue] blue renames A->C, M->N
 ! [change] changed
  ! [change+rename] changed and renamed
   ! [master] master updates A
...
Merge made by recursive.
 A |    2 +-
 1 files changed, 1 insertions(+), 1 deletions(-)
HEAD is now at aa5298d yellow removes M
...
HEAD is now at 2a3fe7a changed and renamed
Skipped B (merged same as existing)
...
HEAD is now at 63c4c1b Merge branch 'change+rename' into change
rm 'B'
rm 'M'
[dir-in-way (root-commit) 4ba0980] Common commmit
 Author: A U Thor <author@example.com>
...
[dir-in-way d360bfd] Commit to merge, with dir in the way
 Author: A U Thor <author@example.com>
 2 files changed, 2 insertions(+), 0 deletions(-)
rm 'dir/file-in-the-way'
[dir-not-in-way 6003c2a] Commit to merge, with dir removed
 Author: A U Thor <author@example.com>
 2 files changed, 1 insertions(+), 1 deletions(-)
 delete mode 100644 dir/file-in-the-way
rm 'dir/file-in-the-way'
rm 'sub/file'
[renamed-file-has-no-conflicts 7269a64] Independent change
 Author: A U Thor <author@example.com>
 2 files changed, 1 insertions(+), 2 deletions(-)
 rename sub/file => dir (79%)
 delete mode 100644 dir/file-in-the-way
rm 'dir/file-in-the-way'
[renamed-file-has-conflicts cee2587] Conflicting change
 Author: A U Thor <author@example.com>
 2 files changed, 1 insertions(+), 1 deletions(-)
...
HEAD is now at cee2587 Conflicting change
Merging:
7269a64 Independent change
virtual dir-not-in-way
found 1 common ancestor(s):
4ba0980 Common commmit
...
HEAD is now at 25b07ed Merge branch 'dir-not-in-way' into HEAD
...
HEAD is now at 7269a64 Independent change
...
expecting success: 
	...
	test -f dir &&
	test_cmp expected dir
HEAD is now at d360bfd Commit to merge, with dir in the way
Merging:
cee2587 Conflicting change
virtual dir-not-in-way
found 1 common ancestor(s):
4ba0980 Common commmit
Removing dir to make room for subdirectory; may re-add later.
...
HEAD is now at cee2587 Conflicting change
Merging:
d360bfd Commit to merge, with dir in the way
...
rm 'n.stages'
rm 'sub/file'
[rename-dest (root-commit) 06061eb] Common commmit
 Author: A U Thor <author@example.com>
 1 files changed, 1 insertions(+), 0 deletions(-)
 create mode 100644 one/file
[rename-dest ff1e1f6] Renamed to destdir
 Author: A U Thor <author@example.com>
 1 files changed, 0 insertions(+), 0 deletions(-)
 rename one/file => destdir (100%)
rm 'one/file'
[source-conflict ad4d86f] Conflicts in the way
 Author: A U Thor <author@example.com>
...
HEAD is now at ad4d86f Conflicts in the way
Merging:
ff1e1f6 Renamed to destdir
virtual source-conflict
found 1 common ancestor(s):
06061eb Common commmit
...
HEAD is now at ff1e1f6 Renamed to destdir
rm 'destdir'
[rename-two (root-commit) c67cba6] Common commmit
 Author: A U Thor <author@example.com>
 2 files changed, 2 insertions(+), 0 deletions(-)
 create mode 100644 one/file
 create mode 100644 two/file
rm 'one/file'
[rename-two cb5afad] Rename two/file -> one
 Author: A U Thor <author@example.com>
 2 files changed, 0 insertions(+), 1 deletions(-)
 rename two/file => one (100%)
 delete mode 100644 one/file
rm 'two/file'
[rename-one 928ac39] Rename one/file -> two
 Author: A U Thor <author@example.com>
 2 files changed, 0 insertions(+), 1 deletions(-)
...
expecting success: 
	...
	test "stuff" = $(cat two)
Merging:
928ac39 Rename one/file -> two
virtual rename-two
found 1 common ancestor(s):
c67cba6 Common commmit
...
HEAD is now at 928ac39 Rename one/file -> two
Merging:
928ac39 Rename one/file -> two
virtual rename-two
found 1 common ancestor(s):
...
HEAD is now at 928ac39 Rename one/file -> two
rm 'two'
[first-rename (root-commit) cb79b8a] Common commmit
 Author: A U Thor <author@example.com>
 1 files changed, 1 insertions(+), 0 deletions(-)
 create mode 100644 original
[first-rename 5ab6f8e] Put two/file in the way, rename to one
 Author: A U Thor <author@example.com>
 1 files changed, 0 insertions(+), 0 deletions(-)
 rename original => one (100%)
 create mode 100644 two/file
[second-rename a689e69] Put one/file in the way, rename to two
 Author: A U Thor <author@example.com>
 1 files changed, 0 insertions(+), 0 deletions(-)
 create mode 100644 one/file
...
expecting success: 
	...
	! test -f original
Merging:
5ab6f8e Put two/file in the way, rename to one
virtual second-rename
found 1 common ancestor(s):
cb79b8a Common commmit
...
HEAD is now at 5ab6f8e Put two/file in the way, rename to one
rm 'one'
rm 'two/file'
[first-rename-redo (root-commit) 2e2894b] Common commmit
 Author: A U Thor <author@example.com>
 1 files changed, 1 insertions(+), 0 deletions(-)
 create mode 100644 one/file
 create mode 100644 original
 create mode 100644 two/file
rm 'one/file'
[first-rename-redo 1c59fcf] Rename to one
 Author: A U Thor <author@example.com>
 1 files changed, 0 insertions(+), 0 deletions(-)
 rename original => one (100%)
 delete mode 100644 one/file
rm 'two/file'
[second-rename-redo 313c82b] Rename to two
 Author: A U Thor <author@example.com>
 1 files changed, 0 insertions(+), 0 deletions(-)
 rename original => two (100%)
 delete mode 100644 two/file
...
expecting success: 
	...
	! test -f original
Merging:
1c59fcf Rename to one
virtual second-rename-redo
found 1 common ancestor(s):
2e2894b Common commmit
Removing one to make room for subdirectory; may re-add later.
Removing two/file

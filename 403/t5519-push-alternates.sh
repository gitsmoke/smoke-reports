...
[master (root-commit) f34bee0] initial
...
Updating f34bee0..fed28c5
Fast-forward
 file |    1 +
 1 files changed, 1 insertions(+), 0 deletions(-)
[master b3d57c5] third
 Author: A U Thor <author@example.com>
...
[master 273ba2f] sixth.1
 Author: A U Thor <author@example.com>
 1 files changed, 1 insertions(+), 1 deletions(-)
[master 5d5fa48] sixth.2
 Author: A U Thor <author@example.com>
 1 files changed, 1 insertions(+), 0 deletions(-)
[master 414ebbb] sixth.3
 Author: A U Thor <author@example.com>
 1 files changed, 1 insertions(+), 0 deletions(-)
...
414ebbb394fad23b1b88ead4d89e446c5a464f42
[master 280ced3] seventh
 Author: A U Thor <author@example.com>
 1 files changed, 1 insertions(+), 1 deletions(-)

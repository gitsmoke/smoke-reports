...
r1 = ee9beb42bf05f1911b376446905556761e146fe0 (refs/remotes/git-svn)
...
[mybranch d25e9b8] try a deep --rmdir with a commit
 ...
 rename dir/a/b/c/d/e/file => file (100%)
	...
	D	dir/a/
	A	dir/file
r2 = bd9ae93b698c975c49e2b0fe8a9e597ae56afff2 (refs/remotes/git-svn)
...
[mybranch de7187c] detect node change from file to directory #1
 Author: A U Thor <author@example.com>
...
[mybranch2 fd4a9f5] detect node change from directory to file #1
 Author: A U Thor <author@example.com>
 1 files changed, 0 insertions(+), 0 deletions(-)
...
[mybranch3 f3651f1] detect node change from file to directory #2
 Author: A U Thor <author@example.com>
...
[mybranch4 5dd96fe] detect node change from directory to file #2
 Author: A U Thor <author@example.com>
 2 files changed, 1 insertions(+), 1 deletions(-)
...
[mybranch5 cf5adb4] remove executable bit from a file
 Author: A U Thor <author@example.com>
 0 files changed, 0 insertions(+), 0 deletions(-)
 mode change 100755 => 100644 exec.sh
	M	exec.sh
	M	exec.sh
r3 = 1114df71316a1e790db97e4a0f29ac4d1bc329b3 (refs/remotes/git-svn)
Done committing 1 revisions to SVN
...
expecting success: 
	...
	svn_cmd up "$SVN_TREE" &&
	test -x "$SVN_TREE"/exec.sh
[mybranch5 3c65fb6] add executable bit back file
 Author: A U Thor <author@example.com>
 0 files changed, 0 insertions(+), 0 deletions(-)
 mode change 100644 => 100755 exec.sh
	M	exec.sh
	M	exec.sh
r4 = e129483f236db10adfe3296f79526d8b865feaf9 (refs/remotes/git-svn)
Done committing 1 revisions to SVN
UU   /Users/trast/git-smoke/t/trash directory.t9100-git-svn-basic/.git/svn/refs/remotes/git-svn/svn-tree/exec.sh
...
[mybranch5 db7cba5] executable file becomes a symlink to bar/zzz (file)
 Author: A U Thor <author@example.com>
 ...
 mode change 100755 => 120000
	T	exec.sh
	M	exec.sh
r5 = 09b9d5051dc8353a97648633e81abbc8bcf2dc21 (refs/remotes/git-svn)
Done committing 1 revisions to SVN
UU   /Users/trast/git-smoke/t/trash directory.t9100-git-svn-basic/.git/svn/refs/remotes/git-svn/svn-tree/exec.sh
...
[mybranch5 5347970] new symlink is added to a file that was also just made executable
 Author: A U Thor <author@example.com>
 ...
 create mode 120000 exec-2.sh
	...
	M	bar/zzz
	A	exec-2.sh
r6 = 153d1fdf89027d3b6e5e95bf6d9eb913d9fd3790 (refs/remotes/git-svn)
Done committing 1 revisions to SVN
...
[mybranch5 15ced1f] modify a symlink to become a file
 Author: A U Thor <author@example.com>
 1 files changed, 1 insertions(+), 1 deletions(-)
 ...
 mode change 120000 => 100644
	T	exec-2.sh
	M	exec-2.sh
r7 = c06a04ac3ac5488bf0f789be867c12d0adcfc89c (refs/remotes/git-svn)
Done committing 1 revisions to SVN
...
expecting success: git svn init "$svnrepo" && git svn fetch &&
	...
	A	exec.sh
	A	dir/a/b/c/d/e/file
r1 = ee9beb42bf05f1911b376446905556761e146fe0 (refs/remotes/alt)
	A	file
	D	dir/a/b/c/d/e/file
	D	dir/a/
	A	dir/file
r2 = f344b9006ccd0d9868dff342f3c7fcdd77b95264 (refs/remotes/alt)
	M	exec.sh
r3 = 81e6242e89adaf468fc6689461b6d80b870fa1dc (refs/remotes/alt)
	M	exec.sh
r4 = 0e3aa3639c9e97a5e6e50f15e7cd14cb897b9fb1 (refs/remotes/alt)
	M	exec.sh
r5 = 07cb08c24a70ea53cfd7a067c90fa2ecfd5b6a31 (refs/remotes/alt)
	M	bar/zzz
	A	exec-2.sh
r6 = bda53b001368937b45575980efaddd44fa38f6d9 (refs/remotes/alt)
	M	exec-2.sh
r7 = 950e81d00f586ad3e5186a736be45e756ea933b2 (refs/remotes/alt)
...
expecting success: 
	...
	A	zzz
r1 = ff11476f7302a29a6abda09032b08664440771c8 (refs/remotes/bar)
	M	zzz
r6 = 7395f7de1d5d3edbc65bc941092c80094a3f48fc (refs/remotes/bar)
[my-bar e5d6878] change 1
 Author: A U Thor <author@example.com>
 1 files changed, 1 insertions(+), 0 deletions(-)
 create mode 100644 foo
[my-bar 3cdc67a] change 2
 Author: A U Thor <author@example.com>
 1 files changed, 1 insertions(+), 1 deletions(-)
...
Committed r8
	A	foo
r8 = e2b3147e494d2cefc2e831016765080658f01510 (refs/remotes/bar)
...
The rewritten commit is: e2b3147e494d2cefc2e831016765080658f01510
    change 1
Deleted branch my-bar (was 3cdc67a).
...
expecting success: 
	...
	A	bar/foo
r8 = 423d3e2f5f421140c6855db84c2e76029092bf94 (refs/remotes/alt)
[my-bar 9a2e82c] /bar/d should be in the log
 Author: A U Thor <author@example.com>
 1 files changed, 1 insertions(+), 0 deletions(-)
...
Committed r9
	A	d
r9 = 6d9e17c06bb3348480275c342efe65fabc1ba739 (refs/remotes/bar)
No changes between current HEAD and refs/remotes/bar
Resetting to the latest refs/remotes/bar
[my-bar ad5fbbc] add a new directory
 Author: A U Thor <author@example.com>
 1 files changed, 1 insertions(+), 0 deletions(-)
...
Committed r10
	A	newdir/dir
r10 = 47d709cf7409d5ae88fe5aed85f1a181370a8cb6 (refs/remotes/bar)
No changes between current HEAD and refs/remotes/bar
Resetting to the latest refs/remotes/bar
[my-bar 9b6fe74] modify a file in new directory
 Author: A U Thor <author@example.com>
 1 files changed, 1 insertions(+), 0 deletions(-)
Committing to file:///Users/trast/git-smoke/t/trash directory.t9100-git-svn-basic/svnrepo/bar ...
	M	newdir/dir
Committed r11
	M	newdir/dir
r11 = 339936a8066d2c160dc80e359adfd329f7b8d4e2 (refs/remotes/bar)
No changes between current HEAD and refs/remotes/bar
Resetting to the latest refs/remotes/bar
...
expecting success: 
	...
	test-chmtime =-60 foo &&
	git svn dcommit
[my-bar 4acb9f0] commit-new-file-foo2
 Author: A U Thor <author@example.com>
 1 files changed, 1 insertions(+), 0 deletions(-)
...
Committed r12
	A	foo2
r12 = 0bef27bcf4be756567c1c653fd21107746c6ce19 (refs/remotes/bar)
No changes between current HEAD and refs/remotes/bar
Resetting to the latest refs/remotes/bar
...
[my-bar 680667c] update /bar/d
 Author: A U Thor <author@example.com>
 1 files changed, 1 insertions(+), 1 deletions(-)
	M	d
	M	d
r13 = 7b12db2a9204f5d4569be8491f6b33f0287cbcc8 (refs/remotes/bar)
Done committing 1 revisions to SVN
...
r8 = 423d3e2f5f421140c6855db84c2e76029092bf94 (refs/remotes/alt)
	A	bar/d
r9 = 878e5f2e46cd1dadd36876f8116d6b93b377fc52 (refs/remotes/alt)
	A	bar/newdir/dir
r10 = d031dea41b8ce9dd9f97a7881945f9edc77bf338 (refs/remotes/alt)
	M	bar/newdir/dir
r11 = 463f078125df98745fc0517e59cd015e2a9a7f55 (refs/remotes/alt)
	A	bar/foo2
r12 = 5dfbeb4908334d02e3a5dbc1ddd080775e69f545 (refs/remotes/alt)
	M	bar/d
r13 = 03d2cb80918cb8de2ab5c172bc42477b4e9d01b4 (refs/remotes/alt)

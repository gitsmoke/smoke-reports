...
[master (root-commit) bc6587e] initial commit
...
[master (root-commit) 893587d] submodule commit 1
 Author: A U Thor <author@example.com>
...
[master (root-commit) 4ec515b] Ignore everything
 Author: A U Thor <author@example.com>
 1 files changed, 1 insertions(+), 0 deletions(-)
...
" "$rev1" &&
	test -n "$rev1"
rev1: 893587d3c06e401525ef8cf7f572bac3a08fff9d
...
expecting success: 
	git submodule status >lines &&
	grep "^-$rev1" lines
-893587d3c06e401525ef8cf7f572bac3a08fff9d init
...
Submodule path 'init': checked out '893587d3c06e401525ef8cf7f572bac3a08fff9d'
...
expecting success: 
	...
	grep "^ $rev1" list
 893587d3c06e401525ef8cf7f572bac3a08fff9d init (rev-1)
...
[detached HEAD eae6b8e] submodule commit 2
 Author: A U Thor <author@example.com>
 1 files changed, 1 insertions(+), 0 deletions(-)
 create mode 100644 b
+eae6b8ef7253fed8465d156177e23ee79c9ea1d1 init (rev-1-1-geae6b8e)
...
+Subproject commit eae6b8ef7253fed8465d156177e23ee79c9ea1d1
...
[detached HEAD fc5d228] change subproject
 Author: A U Thor <author@example.com>
 1 files changed, 1 insertions(+), 0 deletions(-)
 create mode 100644 s
[master 76843bf] change init
 Author: A U Thor <author@example.com>
...
Submodule path 'init': checked out 'fc5d22852853640f71e21f81f8324adae9188bb4'
...
HEAD is now at b3d645c super commit 1
...
HEAD is now at b3d645c super commit 1
[second ddf70a6] commit subproject
 Author: A U Thor <author@example.com>
 1 files changed, 1 insertions(+), 1 deletions(-)
diff --git a/init b/init
index fc5d228..80577d3 160000
--- a/init
+++ b/init
@@ -1 +1 @@
-Subproject commit fc5d22852853640f71e21f81f8324adae9188bb4
+Subproject commit 80577d3ac9fc1280f1a0faa54664dc72a400d2bd
...
expecting success: 
	...
	test ! -d init &&
	git checkout second
HEAD is now at ddf70a6 commit subproject
...
[master (root-commit) 655e709] repo commit 1
 Author: A U Thor <author@example.com>
 1 files changed, 1 insertions(+), 0 deletions(-)

...
[master dbec2f7] c
 Author: A U Thor <author@example.com>
 1 files changed, 1 insertions(+), 1 deletions(-)
[to-rebase ea05b3e] merge should fail on this
 Author: A U Thor <author@example.com>
 1 files changed, 1 insertions(+), 1 deletions(-)
[to-rebase dd75b98] merge should fail on this, too
 Author: A U Thor <author@example.com>
 1 files changed, 1 insertions(+), 1 deletions(-)
...
HEAD is now at dd75b98 merge should fail on this, too
...
Merging HEAD with merge should fail on this, too
Merging:
3a99883 merge should fail on this
virtual merge should fail on this, too
found 1 common ancestor(s):
virtual f788de73cfc81f8d734fa7efc658cc63ca083f50
Auto-merging a
...
Merging:
dbec2f7 c
ea05b3e merge should fail on this
found 1 common ancestor(s):
070fd86 a
Auto-merging a
CONFLICT (content): Merge conflict in a
...
Merging:
dbec2f7 c
dd75b98 merge should fail on this, too
found 1 common ancestor(s):
ea05b3e merge should fail on this
Auto-merging a
CONFLICT (content): Merge conflict in a
...
Auto-merging a
CONFLICT (content): Merge conflict in a
[detached HEAD bcf16d6] merge should fail on this
 Author: A U Thor <author@example.com>
 1 files changed, 1 insertions(+), 0 deletions(-)
Committed: 0001 merge should fail on this
Merging master with HEAD~0
Merging:
bcf16d6 merge should fail on this
dd75b98 merge should fail on this, too
found 1 common ancestor(s):
ea05b3e merge should fail on this
Auto-merging a

...
expecting success: 
	...
	echo other >four &&
	echo other >five
[master (root-commit) 47a3188] First
 Author: A U Thor <author@example.com>
 1 files changed, 1 insertions(+), 0 deletions(-)
 create mode 100644 one
[branch e8722cb] Second
 Author: A U Thor <author@example.com>
...
expecting success: 
	...
	git reset --hard HEAD^
Updating 47a3188..e8722cb
Aborting
[master 23bf300] empty
 Author: A U Thor <author@example.com>
Aborting
HEAD is now at 47a3188 First
...
[master (root-commit) 807735b] init
 Author: A U Thor <author@example.com>
...
rm 'rep/foo'
rm 'rep2/foo'
[branch 09c8d0c] added test as a file
 Author: A U Thor <author@example.com>

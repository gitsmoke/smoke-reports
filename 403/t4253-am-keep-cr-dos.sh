...
[master (root-commit) b0bbf70] Initial
 Author: A U Thor <author@example.com>
 1 files changed, 1 insertions(+), 0 deletions(-)
 create mode 100644 file
[master 2ab6404] Second
 Author: A U Thor <author@example.com>
 1 files changed, 1 insertions(+), 0 deletions(-)
[master 95658fe] Third
 Author: A U Thor <author@example.com>
 1 files changed, 1 insertions(+), 0 deletions(-)
...
0001-Second.patch
0002-Third.patch
[dosfiles-keep-cr-continue 4e4a793] different patch
 Author: A U Thor <author@example.com>
 1 files changed, 1 insertions(+), 0 deletions(-)
Applying: Second
Using index info to reconstruct a base tree...
...
[unixfiles-conf-keepcr-override 45db53a] line ending to unix
 Author: A U Thor <author@example.com>

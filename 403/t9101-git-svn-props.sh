...
expecting success: git svn fetch
	...
	A	ne_crlf
	A	empty
r1 = a1471ef8c841e7ba151599d292275cc2ecbe3c3b (refs/remotes/git-svn)
	M	kw.c
r2 = 9082037bf9ccabd550c5f2c4d090cf2276119d1c (refs/remotes/git-svn)
	M	kw.c
r3 = a403456a153267a8de651a8ac2fc91272afb7cfd (refs/remotes/git-svn)
	M	kw.c
r4 = bb1e5f79336dbd770a332022c58acb9b620f5401 (refs/remotes/git-svn)
...
[mybranch 26c4df9] test keywords ignoring
 Author: A U Thor <author@example.com>
 1 files changed, 1 insertions(+), 0 deletions(-)
	M	kw.c
	M	kw.c
r5 = 247148c866485634c2e21a77a34f62bf32e44340 (refs/remotes/git-svn)
Done committing 1 revisions to SVN
Updating 26c4df9..247148c
Fast-forward
...
expecting success: git svn fetch &&
	...
	M	ne_crlf
	M	empty
r6 = 5c1466b8641517f014bb0146fdb5d1192945d190 (refs/remotes/git-svn)
Updating 247148c..5c1466b
Fast-forward
 crlf    |    3 +--
 ne_crlf |    3 +--
...
expecting success: git svn fetch && git pull . ${remotes_git_svn}
	M	cr
	M	ne_cr
r7 = ca0069ca01621f37dd7649530df4c123a82cc0ac (refs/remotes/git-svn)
Updating 5c1466b..ca0069c
Fast-forward
 cr    |    4 +++-
 ne_cr |    4 +++-
...
expecting success: 
	...
	A	deeply/nested/directory/.keep
r8 = bec484660e2bd654248d6224b869a3eb234c90a4 (refs/remotes/git-svn)
Updating ca0069c..bec4846
Fast-forward

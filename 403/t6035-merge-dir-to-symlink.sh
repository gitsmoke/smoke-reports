...
HEAD is now at 3fced6e dir to symlink
rm 'a/b'
[detached HEAD 2942778] untracked symlink remains
 Author: A U Thor <author@example.com>
...
HEAD is now at 364a235 base
[detached HEAD 85e3958] x
 Author: A U Thor <author@example.com>
 1 files changed, 1 insertions(+), 0 deletions(-)
...
HEAD is now at 91de382 Merge branch 'master' into HEAD
Merging:
85e3958 x
virtual master
...
expecting success: 
	...
	test -h a/b &&
	test -f a/b-2/c/d
HEAD is now at 5fc5836 Merge commit 'baseline^0' into HEAD
Merging:
3fced6e dir to symlink
virtual baseline^0
found 1 common ancestor(s):
364a235 base
...
expecting success: 
	...
	git tag test2
HEAD is now at 85e3958 x
[detached HEAD 517c7dd] dir a/b-2 to symlink
 Author: A U Thor <author@example.com>
...
expecting success: 
	...
	test -h a/b-2 &&
	test -f a/b/c/d
HEAD is now at 517c7dd dir a/b-2 to symlink
Trying really trivial in-index merge...
Nope.
Trying simple merge.
Simple merge failed, trying Automatic merge.
...
expecting success: 
	...
	test -h a/b-2 &&
	test -f a/b/c/d
HEAD is now at 4000881 Merge commit 'test2' into HEAD
Merging:
85e3958 x
virtual test2
found 1 common ancestor(s):

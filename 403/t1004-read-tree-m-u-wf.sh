...
[master (root-commit) e28eef0] initial
...
[master 454f832] master removes file2 and subdir/file2
 Author: A U Thor <author@example.com>
...
D	file2
D	subdir/file2
[side 77a1c22] side adds file3 and removes file2
 Author: A U Thor <author@example.com>
...
HEAD is now at 454f832 master removes file2 and subdir/file2
...
expecting success: 
	...
	git checkout side-a
HEAD is now at 454f832 master removes file2 and subdir/file2
[side-a 1142134] side-a changes file1
 Author: A U Thor <author@example.com>
 1 files changed, 1 insertions(+), 0 deletions(-)
[side-b 2579665] side-b changes file2
 Author: A U Thor <author@example.com>
 1 files changed, 1 insertions(+), 0 deletions(-)
...
HEAD is now at 1142134 side-a changes file1
...
HEAD is now at 1142134 side-a changes file1
[sym-b 530299b] side adds a/b
 Author: A U Thor <author@example.com>
 0 files changed, 0 insertions(+), 0 deletions(-)
 create mode 100644 a/b
[sym-a 7e59892] we add a/b
 Author: A U Thor <author@example.com>
 1 files changed, 1 insertions(+), 0 deletions(-)
...
HEAD is now at 7e59892 we add a/b
...
HEAD is now at 7e59892 we add a/b
[side-a aa0df64] side-a changes file2 to directory
 Author: A U Thor <author@example.com>
...
HEAD is now at 2579665 side-b changes file2
Trying simple merge.
...
Merging:
2579665 side-b changes file2
aa0df64 side-a changes file2 to directory

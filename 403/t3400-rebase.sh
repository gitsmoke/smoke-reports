...
[master (root-commit) d4bea22] Add A.
 Author: author@name <bogus@email@address>
 1 files changed, 1 insertions(+), 0 deletions(-)
 create mode 100644 A
[force-3way b1097c5] Add Y.
 Author: author@name <bogus@email@address>
 1 files changed, 1 insertions(+), 0 deletions(-)
 create mode 100644 Y
[filemove 4f3d82b] Move A.
 Author: author@name <bogus@email@address>
 2 files changed, 1 insertions(+), 0 deletions(-)
 rename A => D/A (100%)
 create mode 100644 Y
[my-topic-branch bb18134] Add B.
 Author: author@name <bogus@email@address>
 1 files changed, 1 insertions(+), 0 deletions(-)
 create mode 100644 B
[master d2e39f5] Modify A.
 Author: author@name <bogus@email@address>
 1 files changed, 1 insertions(+), 0 deletions(-)
[side a45996f] Add C
 Author: author@name <bogus@email@address>
...
Merge made by recursive.
 ...
 create mode 100644 C
Merging:
8a32e8c Merge branch 'side' into nonlinear
virtual master
found 1 common ancestor(s):
d4bea22 Add A.
Merge made by recursive.
...
[master f41022b] prepare
 Author: author@name <bogus@email@address>
 1 files changed, 1 insertions(+), 0 deletions(-)
 create mode 100644 X
[modechange 386d278] modechange
 Author: author@name <bogus@email@address>
 1 files changed, 1 insertions(+), 0 deletions(-)
...
[quiet 892b33a] A file with a line with CR
 Author: author@name <bogus@email@address>
...
[detached HEAD 323ac85] n1
 Author: author@name <bogus@email@address>
 1 files changed, 1 insertions(+), 0 deletions(-)
 create mode 100644 n1.t
[detached HEAD 83bae67] n2
 Author: author@name <bogus@email@address>
 1 files changed, 1 insertions(+), 0 deletions(-)
 create mode 100644 n2.t
[detached HEAD 632bd22] n3
 Author: author@name <bogus@email@address>
 1 files changed, 1 insertions(+), 0 deletions(-)

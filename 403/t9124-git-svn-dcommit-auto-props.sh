...
Committed revision 1.
	A	foo
r1 = c1a0682eaefe30632fb59d3504c78e78cae9efe7 (refs/remotes/git-svn)
...
[master 7ff06db] files for enabled auto-props
...
Committed r2
	...
	A	bar
	A	exec1.sh
r2 = 2075af0fed10d2954ce9de280f21995ce7e12292 (refs/remotes/git-svn)
...
[master 8ca94fe] files for disabled auto-props
 Author: A U Thor <author@example.com>
 3 files changed, 3 insertions(+), 0 deletions(-)
...
Committed r3
	...
	A	world.txt
	A	zot
r3 = 96b981854a5571acc3d7ac85305879b0acbda273 (refs/remotes/git-svn)
No changes between current HEAD and refs/remotes/git-svn
Resetting to the latest refs/remotes/git-svn
...
Committed r4
	D	foo
	A	foo.sh
r4 = b1a92c8ec19f7468ac5ea8e80f176278346a687f (refs/remotes/git-svn)
No changes between current HEAD and refs/remotes/git-svn
Resetting to the latest refs/remotes/git-svn
D    foo
A    foo.sh

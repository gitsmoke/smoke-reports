...
expecting success: 
	...
	repo_fetched one &&
	repo_fetched two
[master (root-commit) 7416d45] update-all
...
[master d5d7f25] fetch-group-all
 Author: A U Thor <author@example.com>
 1 files changed, 1 insertions(+), 0 deletions(-)
[master d5d7f25] fetch-group-all
 Author: A U Thor <author@example.com>
...
[master f242cc9] fetch-group-some
 Author: A U Thor <author@example.com>
 1 files changed, 1 insertions(+), 0 deletions(-)
[master f242cc9] fetch-group-some
 Author: A U Thor <author@example.com>

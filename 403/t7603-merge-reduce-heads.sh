...
expecting success: 
	...
	git commit -m I2 &&
	git tag I2
HEAD is now at 79cb4e4 E
[master d1cc040] E2
 Author: A U Thor <author@example.com>
 1 files changed, 1 insertions(+), 0 deletions(-)
 create mode 100644 file.c
HEAD is now at f247b75 I
[master e3bd26a] I2
 Author: A U Thor <author@example.com>
 1 files changed, 1 insertions(+), 0 deletions(-)
 create mode 100644 file.c
...
[master 8864c9f] resolve conflict
 Author: A U Thor <author@example.com>

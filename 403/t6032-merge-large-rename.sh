...
expecting success: 
	...
	git tag initial
[master (root-commit) c447f1a] initial
...
HEAD is now at c447f1a initial
[master 9830a2c] add=5
 Author: A U Thor <author@example.com>
...
Deleted branch test5 (was 63cfb82).
HEAD is now at c447f1a initial
[master 52973a4] add=5
 Author: A U Thor <author@example.com>
 5 files changed, 110 insertions(+), 0 deletions(-)
 create mode 100644 1
 create mode 100644 2
...
Deleted branch test5 (was 8d34a1c).
HEAD is now at c447f1a initial
[master 52973a4] add=5
 Author: A U Thor <author@example.com>
 5 files changed, 110 insertions(+), 0 deletions(-)
...
[simple-change fd60d70] unrelated-change
 Author: A U Thor <author@example.com>
 0 files changed, 0 insertions(+), 0 deletions(-)

...
Initialized empty Git repository in /Users/trast/git-smoke/t/trash directory.t9133-git-svn-nested-git-repo/g/.git/
	A	a
r1 = 2e2659a2cde5a67989262a953bbacacd773aeafd (refs/remotes/git-svn)
r2 = d1dbbf92b608c76a68fe4a2662003a3be3f66730 (refs/remotes/git-svn)
...
expecting success: 
	...
	M	a
r3 = 56a93b48e91df1b3261f65580dd991a0f24fc5ef (refs/remotes/git-svn)
...
[master (root-commit) 5e56284] add a inside an SVN repo
 Author: A U Thor <author@example.com>
 1 files changed, 2 insertions(+), 0 deletions(-)
 create mode 100644 a
commit 5e5628454f06d6535babfe939de12d5f6b313696
Author: A U Thor <author@example.com>
Date:   Thu Dec 30 04:04:05 2010 +0000
...
A         .git/objects/5e
A         .git/objects/5e/5628454f06d6535babfe939de12d5f6b313696
A         .git/objects/a3
...
Adding         .git/objects/5e
Adding         .git/objects/5e/5628454f06d6535babfe939de12d5f6b313696
...
r4 = ccb04820f3f4308582af677ae31ef904c063915c (refs/remotes/git-svn)
First, rewinding head to replay your work on top of it...
Fast-forwarded master to refs/remotes/git-svn.
...
[master d191814] add a inside an SVN repo
 Author: A U Thor <author@example.com>
...
expecting success: 
	...
	M	a
r5 = 140552d033f11b30c6b03dda6d489e1906b3bf78 (refs/remotes/git-svn)
First, rewinding head to replay your work on top of it...
Fast-forwarded master to refs/remotes/git-svn.

...
[master (root-commit) 23f1af8] add normal files
...
[master 998cd79] add files with tabs and newlines
 Author: A U Thor <author@example.com>
 0 files changed, 0 insertions(+), 0 deletions(-)
...
[master 78ad551] add file for rm test
 Author: A U Thor <author@example.com>
...
[master 08bcf8d] remove file from rm test
 Author: A U Thor <author@example.com>
...
[master 421656b] add file for rm --quiet test
 Author: A U Thor <author@example.com>
 1 files changed, 1 insertions(+), 0 deletions(-)
 create mode 100644 test-file
[master 80d3d41] remove file from rm --quiet test
 Author: A U Thor <author@example.com>
 1 files changed, 0 insertions(+), 1 deletions(-)
 delete mode 100644 test-file
...
[master (root-commit) 5e96405] add a file
 Author: A U Thor <author@example.com>
 1 files changed, 1 insertions(+), 0 deletions(-)
...
expecting success: 
	...
	git rm frotz/nitfol &&
	test ! -f frotz/nitfol
HEAD is now at f24ee68 subdir test
rm 'frotz/nitfol'

...
ok 126 - R: die on unknown option
ok 127 - R: unknown commandline options are rejected
ok 128 - R: die on invalid option argument
ok 129 - R: ignore non-git options
ok 130 - R: blob bigger than threshold
ok 131 - R: verify created pack
ok 132 - R: verify written objects
ok 133 - R: blob appears only once

...
ok 19 - submodule update continues after checkout error
ok 20 - submodule update continues after recursive checkout error
ok 21 - submodule update exit immediately in case of merge conflict
ok 22 - submodule update exit immediately after recursive rebase error

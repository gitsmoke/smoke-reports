...
[master (root-commit) aaa3dd4] Initial commit.
...
expecting success: git branch g/h &&
     ...
     git pack-refs --all &&
     git branch -d g
Deleted branch g/h (was aaa3dd4).
Deleted branch g (was aaa3dd4).
...
expecting success: git branch k/l &&
     ...
     git branch -d k/lm &&
     git branch k
Deleted branch k/l (was aaa3dd4).
Deleted branch k/l/m (was aaa3dd4).
Deleted branch k/lm (was aaa3dd4).
...
expecting success: git branch n/o &&
     ...
     git branch -d n/o/p &&
     git branch n
Deleted branch n/o (was aaa3dd4).
Deleted branch n/op (was aaa3dd4).
Deleted branch n/o/p (was aaa3dd4).

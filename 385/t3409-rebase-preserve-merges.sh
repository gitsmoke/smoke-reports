...
[master (root-commit) 306a073] Add A1
 Author: A U Thor <bogus_email_address>
 1 files changed, 1 insertions(+), 0 deletions(-)
 create mode 100644 A
[topic 1fee4a7] Add B1
 Author: A U Thor <bogus_email_address>
 1 files changed, 1 insertions(+), 0 deletions(-)
 create mode 100644 B
[master ebb266b] Modify A2
 Author: A U Thor <bogus_email_address>
 1 files changed, 1 insertions(+), 0 deletions(-)
Cloning into clone1...
done.
...
Merge made by recursive.
 A |    1 +
 1 files changed, 1 insertions(+), 0 deletions(-)
[master 93f73d8] Add different B
 Author: A U Thor <bogus_email_address>
 1 files changed, 1 insertions(+), 0 deletions(-)
 create mode 100644 B
Cloning into clone2...
...
[topic dfd4846] Merge origin/master into topic
 Author: A U Thor <bogus_email_address>
[topic 9ec6f36] Modify B2
 Author: A U Thor <bogus_email_address>
 1 files changed, 1 insertions(+), 0 deletions(-)
...
Rebasing (1/1)Merging:
9ec6f36 Modify B2
virtual 93f73d88c592b656c0a67b63452e94896c13483e
found 1 common ancestor(s):
306a073 Add A1
Auto-merging B
CONFLICT (add/add): Merge conflict in B
...
B: needs merge
@@@ -1,1 -1,1 +1,1 @@@
[detached HEAD 102cf38] Merge origin/master into topic
 Author: A U Thor <bogus_email_address>
Rebasing (1/1)

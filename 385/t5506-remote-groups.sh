...
expecting success: 
	...
	repo_fetched one &&
	repo_fetched two
[master (root-commit) 4641c43] update-all
...
expecting success: 
	...
	repo_fetched one &&
	repo_fetched two
[master 8d72040] fetch-group-all
 Author: A U Thor <author@example.com>
 1 files changed, 1 insertions(+), 0 deletions(-)
[master 8d72040] fetch-group-all
 Author: A U Thor <author@example.com>
...
[master 2e1d9a7] fetch-group-some
 Author: A U Thor <author@example.com>
 1 files changed, 1 insertions(+), 0 deletions(-)
[master 2e1d9a7] fetch-group-some
 Author: A U Thor <author@example.com>

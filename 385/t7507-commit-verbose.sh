...
[master (root-commit) 6aaedef] subject
...
expecting success: 
	...
	check_message diff
[master 85f73e4] This is an example commit message that contains a diff.
 Author: A U Thor <author@example.com>
 1 files changed, 1 insertions(+), 1 deletions(-)
...
checking known breakage: 
	...
	check_message diff
[master bfffbc0] This is an example commit message that contains a diff.
 Author: A U Thor <author@example.com>
 1 files changed, 1 insertions(+), 1 deletions(-)
--- diff	2010-12-24 04:03:17.000000000 +0000
+++ actual	2010-12-24 04:03:17.000000000 +0000
@@ -1,9 +1,2 @@

...
[master (root-commit) 9b52e62] Initial.
 Author: A <A@test.git>
...
Merging:
96f1ce0 Branch2-1
virtual 66a40fd87a257ba73c87b5db990ca626042becfd
...
expecting success: echo "evil merge." >>file &&
     git commit -a --amend
[branch2 7a93d34] Merge branch 'branch1' into branch2

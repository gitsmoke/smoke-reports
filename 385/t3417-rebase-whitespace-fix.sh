...
[master (root-commit) b7f2c21] Initial empty commit
 Author: A U Thor <author@example.com>
[master 9201f7d] first
 Author: A U Thor <author@example.com>
 1 files changed, 4 insertions(+), 0 deletions(-)
 create mode 100644 file
[master a5337ac] second
 Author: A U Thor <author@example.com>

...
[master (root-commit) d6e69c4] snapshot
...
HEAD is now at 8cf4361 yet another
[master 693fb2c] hello 1
 Author: A U Thor <author@example.com>
 1 files changed, 1 insertions(+), 1 deletions(-)
...
HEAD is now at 693fb2c hello 1
[master d04bb92] base
 Author: A U Thor <author@example.com>
...
HEAD is now at d04bb92 base
[master fceb858] empty
 Author: A U Thor <author@example.com>
...
HEAD is now at fceb858 empty
[master b378782] one side
 Author: A U Thor <author@example.com>
 1 files changed, 1 insertions(+), 9 deletions(-)
[detached HEAD 47ec7cb] the other side
 Author: A U Thor <author@example.com>
 1 files changed, 1 insertions(+), 9 deletions(-)
Merging:
47ec7cb the other side
virtual master
...
HEAD is now at 47ec7cb the other side
[detached HEAD ddfd22f] initial
 Author: A U Thor <author@example.com>
 1 files changed, 1 insertions(+), 1 deletions(-)

...
[master (root-commit) 4f00cc0] Initial commit.
 Author: A U Thor <author@example.com>
 1 files changed, 1 insertions(+), 0 deletions(-)
 create mode 100644 A
[master 51c0883] Second commit.
 Author: A U Thor <author@example.com>
 1 files changed, 1 insertions(+), 0 deletions(-)
...
expecting success: git branch -d d/e/f &&
	 test ! -f .git/refs/heads/d/e/f &&
	 test ! -f .git/logs/refs/heads/d/e/f
Deleted branch d/e/f (was 51c0883).
...
expecting success: git branch l/m &&
        git branch -d l/m &&
        git branch l
Deleted branch l/m (was 51c0883).
...
Deleted branch s/t (was 51c0883).
...
Deleted branch my7 (was 51c0883).
...
51c08838ca38431d5c7f59349f3913e763f5ce32
...
expecting success: 
	...
	git branch -d my8
Deleted branch my8 (was 51c0883).

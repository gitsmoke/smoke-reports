...
expecting success: 
	...
	echo happy.
[master (root-commit) 34f1615] initial
...
expecting success: 
	...
	git reset --hard HEAD^
HEAD is now at 34f1615 initial
...
[master aee4a19] Add .gitattributes
 Author: A U Thor <author@example.com>
...
[master 0f2682e] initial
 Author: A U Thor <author@example.com>
 1 files changed, 1 insertions(+), 0 deletions(-)
[master 53381fa] second
 Author: A U Thor <author@example.com>
...
[master 1f572cd] alllf, allcrlf and mixed only
 Author: A U Thor <author@example.com>

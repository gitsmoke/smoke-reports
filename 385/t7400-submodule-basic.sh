...
[master (root-commit) 6d341c9] initial commit
...
[master (root-commit) e0b3c9c] submodule commit 1
 Author: A U Thor <author@example.com>
...
[master (root-commit) 57bfb64] Ignore everything
 Author: A U Thor <author@example.com>
 1 files changed, 1 insertions(+), 0 deletions(-)
...
" "$rev1" &&
	test -n "$rev1"
rev1: e0b3c9c0c11f356d9575464d30f693b0436fcd1a
...
-e0b3c9c0c11f356d9575464d30f693b0436fcd1a init
...
Submodule path 'init': checked out 'e0b3c9c0c11f356d9575464d30f693b0436fcd1a'
...
expecting success: 
	...
	grep "^ $rev1" list
 e0b3c9c0c11f356d9575464d30f693b0436fcd1a init (rev-1)
...
[detached HEAD 7ef30e8] submodule commit 2
 Author: A U Thor <author@example.com>
 1 files changed, 1 insertions(+), 0 deletions(-)
 create mode 100644 b
+7ef30e8d2d1ed43791d4f243d1a8b9af6df96b10 init (rev-1-1-g7ef30e8)
...
+Subproject commit 7ef30e8d2d1ed43791d4f243d1a8b9af6df96b10
...
[detached HEAD 3e56b57] change subproject
 Author: A U Thor <author@example.com>
 1 files changed, 1 insertions(+), 0 deletions(-)
 create mode 100644 s
[master f5d8b83] change init
 Author: A U Thor <author@example.com>
...
Submodule path 'init': checked out '3e56b576a05af4cfd190f98b9f622065dc7f2077'
...
HEAD is now at 978eaa0 super commit 1
...
HEAD is now at 978eaa0 super commit 1
[second 6cd0153] commit subproject
 Author: A U Thor <author@example.com>
 1 files changed, 1 insertions(+), 1 deletions(-)
diff --git a/init b/init
index 3e56b57..c2a2e25 160000
--- a/init
+++ b/init
@@ -1 +1 @@
-Subproject commit 3e56b576a05af4cfd190f98b9f622065dc7f2077
+Subproject commit c2a2e259bed8734ce0261e58eb81925ab9cc49d0
...
expecting success: 
	...
	test ! -d init &&
	git checkout second
HEAD is now at 6cd0153 commit subproject
...
[master (root-commit) 8d468f5] repo commit 1
 Author: A U Thor <author@example.com>
 1 files changed, 1 insertions(+), 0 deletions(-)

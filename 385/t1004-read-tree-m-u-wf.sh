...
[master (root-commit) 3938612] initial
...
[master d3350e3] master removes file2 and subdir/file2
 Author: A U Thor <author@example.com>
...
D	file2
D	subdir/file2
[side 44808b8] side adds file3 and removes file2
 Author: A U Thor <author@example.com>
...
HEAD is now at d3350e3 master removes file2 and subdir/file2
...
expecting success: 
	...
	git checkout side-a
HEAD is now at d3350e3 master removes file2 and subdir/file2
[side-a c3da318] side-a changes file1
 Author: A U Thor <author@example.com>
 1 files changed, 1 insertions(+), 0 deletions(-)
[side-b 291e674] side-b changes file2
 Author: A U Thor <author@example.com>
 1 files changed, 1 insertions(+), 0 deletions(-)
...
HEAD is now at c3da318 side-a changes file1
...
HEAD is now at c3da318 side-a changes file1
[sym-b 39ec9ef] side adds a/b
 Author: A U Thor <author@example.com>
 0 files changed, 0 insertions(+), 0 deletions(-)
 create mode 100644 a/b
[sym-a 583f5b8] we add a/b
 Author: A U Thor <author@example.com>
 1 files changed, 1 insertions(+), 0 deletions(-)
...
HEAD is now at 583f5b8 we add a/b
...
HEAD is now at 583f5b8 we add a/b
[side-a 4de36aa] side-a changes file2 to directory
 Author: A U Thor <author@example.com>
...
HEAD is now at 291e674 side-b changes file2
Trying simple merge.
...
Merging:
291e674 side-b changes file2
4de36aa side-a changes file2 to directory

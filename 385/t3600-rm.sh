...
[master (root-commit) ed0fc75] add normal files
...
[master 6146ba4] add files with tabs and newlines
 Author: A U Thor <author@example.com>
 0 files changed, 0 insertions(+), 0 deletions(-)
...
[master 5b7f0a1] add file for rm test
 Author: A U Thor <author@example.com>
...
[master 86dd389] remove file from rm test
 Author: A U Thor <author@example.com>
...
[master 47e7211] add file for rm --quiet test
 Author: A U Thor <author@example.com>
 1 files changed, 1 insertions(+), 0 deletions(-)
 create mode 100644 test-file
[master 3f5b71c] remove file from rm --quiet test
 Author: A U Thor <author@example.com>
 1 files changed, 0 insertions(+), 1 deletions(-)
 delete mode 100644 test-file
...
[master (root-commit) 8e60708] add a file
 Author: A U Thor <author@example.com>
 1 files changed, 1 insertions(+), 0 deletions(-)
...
HEAD is now at 47a4f84 subdir test
rm 'frotz/nitfol'

...
[master (root-commit) d72e6a0] hello
 Author: A U Thor <author@example.com>
 1 files changed, 1 insertions(+), 0 deletions(-)
 create mode 100644 hello
[master bd2e8d3] hello world
 Author: A U Thor <author@example.com>
 1 files changed, 1 insertions(+), 0 deletions(-)
[master dee780e] goodbye
 Author: A U Thor <author@example.com>
 1 files changed, 1 insertions(+), 0 deletions(-)
[skip-reference 1d2c6e3] we should skip this
 Author: A U Thor <author@example.com>
 1 files changed, 1 insertions(+), 1 deletions(-)
[skip-reference 5698f2d] this should not be skipped
 Author: A U Thor <author@example.com>
 1 files changed, 1 insertions(+), 0 deletions(-)
...
HEAD is now at dee780e goodbye
...
HEAD is now at 5698f2d this should not be skipped
First, rewinding head to replay your work on top of it...
Applying: we should skip this
Using index info to reconstruct a base tree...
Falling back to patching base and 3-way merge...
...
Applying: we should skip this
Applying: this should not be skipped
HEAD is now at 26212ee this should not be skipped
...
Merging:
dee780e goodbye
5698f2d this should not be skipped
found 1 common ancestor(s):
1d2c6e3 we should skip this
[detached HEAD 4b90dae] this should not be skipped
 Author: A U Thor <author@example.com>
 1 files changed, 1 insertions(+), 0 deletions(-)
 create mode 100644 cow
...
Merging:
4b90dae this should not be skipped
5698f2d this should not be skipped
found 1 common ancestor(s):
1d2c6e3 we should skip this

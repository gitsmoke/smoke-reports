...
[master 258897a] new file in ugly parent
...
Committed r2
	A	#{bad_directory_name}/ foo
r2 = 0e840b7260ba2cd46a4c45c6d92d15d0ff47fb3b (refs/remotes/git-svn)
...
[master c410e24] rename ugly file
 Author: A U Thor <author@example.com>
...
r3 = 09d06fdbd76a4ef16049f284eeb459ff62079824 (refs/remotes/git-svn)
No changes between current HEAD and refs/remotes/git-svn
Resetting to the latest refs/remotes/git-svn
...
Committed r4
	A	pretty
r4 = 5bb4357033e082bfb2e4de751a0b781ee1d7ccb6 (refs/remotes/git-svn)
No changes between current HEAD and refs/remotes/git-svn
Resetting to the latest refs/remotes/git-svn
[master ae81e16] moved pretty file
 Author: A U Thor <author@example.com>
 1 files changed, 0 insertions(+), 0 deletions(-)
...
r5 = cfa9c0414cd2708d84711098bcdf32ce056deb71 (refs/remotes/git-svn)
No changes between current HEAD and refs/remotes/git-svn
Resetting to the latest refs/remotes/git-svn
...
r6 = fa49b1144196222bb28f44d9bfe6b8c7e04f1c5a (refs/remotes/git-svn)
No changes between current HEAD and refs/remotes/git-svn
Resetting to the latest refs/remotes/git-svn
...
Committed r7
	A	+_+
r7 = c9411ae5646b9c2f2ca2a7220d2d49474816ae8e (refs/remotes/git-svn)
No changes between current HEAD and refs/remotes/git-svn
Resetting to the latest refs/remotes/git-svn
...
Committed r8
	D	+_+
	A	gtk+/_+_
r8 = 93716a9a9fc1e4b3b71315e8a0a470d0906e4c55 (refs/remotes/git-svn)
No changes between current HEAD and refs/remotes/git-svn
Resetting to the latest refs/remotes/git-svn
...
[master f9b524e] test-rebase-main
 Author: A U Thor <author@example.com>
 1 files changed, 1 insertions(+), 0 deletions(-)
...
Committed r9
	A	test-rebase-main
r9 = 357564ab6fac2b0d50ab0434c537e915d976aa3d (refs/remotes/git-svn)
No changes between current HEAD and refs/remotes/git-svn
Resetting to the latest refs/remotes/git-svn

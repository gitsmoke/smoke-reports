...
r1 = bd146fd79d5095c8956bfe04a48be4165463bcb9 (refs/remotes/git-svn)
...
[test-rmdir 74851e4] remove another
 ...
 delete mode 100644 deeply/nested/directory/number/2/another
	...
	D	deeply/nested/directory/number/2/another
	D	deeply/nested/directory/number/2/
r2 = f80279b9928a8347fb74a9575ff72daa4f0701b9 (refs/remotes/git-svn)

...
expecting success: git svn fetch
	...
	A	ne_crlf
	A	empty
r1 = 8e003c753ad0df3765919a5aac733da693b614e6 (refs/remotes/git-svn)
	M	kw.c
r2 = f6be90bc6f23b438d31efa3ecf4fba1c63d48ad8 (refs/remotes/git-svn)
	M	kw.c
r3 = cb4fb7dcf745b047f02a3ac79d6887a27efdca6e (refs/remotes/git-svn)
	M	kw.c
r4 = 81c57fe643b1ef7a3b4083397301aff24160e99a (refs/remotes/git-svn)
...
[mybranch 5ffdd97] test keywords ignoring
 Author: A U Thor <author@example.com>
 1 files changed, 1 insertions(+), 0 deletions(-)
	M	kw.c
	M	kw.c
r5 = 623b0369a1cadea535e08d36f31a53ea4541eec7 (refs/remotes/git-svn)
Done committing 1 revisions to SVN
Updating 5ffdd97..623b036
Fast-forward
...
expecting success: git svn fetch &&
	...
	M	ne_crlf
	M	empty
r6 = 3810ab16d99bbb2746373efda62827f45082145b (refs/remotes/git-svn)
Updating 623b036..3810ab1
Fast-forward
 crlf    |    3 +--
 ne_crlf |    3 +--
...
expecting success: git svn fetch && git pull . ${remotes_git_svn}
	M	cr
	M	ne_cr
r7 = 83f4c9acaf2fba99bff38fb43e09361fdfeba4f1 (refs/remotes/git-svn)
Updating 3810ab1..83f4c9a
Fast-forward
 cr    |    4 +++-
 ne_cr |    4 +++-
...
expecting success: 
	...
	A	deeply/nested/directory/.keep
r8 = 30f218f48481ca38390601e2ce9a3dd914909e48 (refs/remotes/git-svn)
Updating 83f4c9a..30f218f
Fast-forward

...
Initialized empty Git repository in /Users/trast/git-smoke/t/trash directory.t9134-git-svn-ignore-paths/g/.git/
	A	qqq/test_qqq.txt
r1 = da1186e647ff5902accc3ed2f9d7f632ee96e4ad (refs/remotes/git-svn)
r2 = d3726b813fc6f695d991b77eb5b7774ed701998b (refs/remotes/git-svn)
...
" > expect &&
	...
	M	qqq/test_qqq.txt
r3 = 3c89d03b46b1774394f1e655be8fa23ed4af3c5d (refs/remotes/git-svn)
...
r4 = 624a7dd0e2ec2224139fc34df4e2cc4afd6e8cd7 (refs/remotes/git-svn)
First, rewinding head to replay your work on top of it...
Fast-forwarded master to refs/remotes/git-svn.
...
" > expect &&
	...
	M	qqq/test_qqq.txt
r5 = d18169d7a71c3a73a9e361237d2e39f680d9d3e2 (refs/remotes/git-svn)
First, rewinding head to replay your work on top of it...
Fast-forwarded master to refs/remotes/git-svn.

...
HEAD is now at b6cd7ec dir to symlink
rm 'a/b'
[detached HEAD 6651160] untracked symlink remains
 Author: A U Thor <author@example.com>
...
HEAD is now at 5aecf54 base
[detached HEAD 1b83477] x
 Author: A U Thor <author@example.com>
 1 files changed, 1 insertions(+), 0 deletions(-)
...
HEAD is now at 3135a3b Merge branch 'master' into HEAD
Merging:
1b83477 x
virtual master
...
HEAD is now at ef809a0 Merge commit 'baseline^0' into HEAD
Merging:
b6cd7ec dir to symlink
virtual baseline^0
found 1 common ancestor(s):
5aecf54 base
...
HEAD is now at 1b83477 x
[detached HEAD 7f4607f] dir a/b-2 to symlink
 Author: A U Thor <author@example.com>
...
expecting success: 
	...
	test -h a/b-2 &&
	test -f a/b/c/d
HEAD is now at 7f4607f dir a/b-2 to symlink
Trying really trivial in-index merge...
Nope.
Trying simple merge.
Simple merge failed, trying Automatic merge.
...
HEAD is now at 473bd7d Merge commit 'test2' into HEAD
Merging:
1b83477 x
virtual test2
found 1 common ancestor(s):

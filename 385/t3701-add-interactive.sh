...
expecting success: 
	...
	echo more >>file &&
	echo lines >>file
[master (root-commit) 1380ff7] commit
...
Unstaged changes after reset:
M	file
[master e30cfba] commit
 Author: A U Thor <author@example.com>
 1 files changed, 1 insertions(+), 1 deletions(-)
HEAD is now at 1380ff7 commit
...
[master 981d596] clear local changes
 Author: A U Thor <author@example.com>
 1 files changed, 1 insertions(+), 0 deletions(-)
...
HEAD is now at 981d596 clear local changes
[master dcb5a0b] non-empty
 Author: A U Thor <author@example.com>
 1 files changed, 1 insertions(+), 0 deletions(-)
...
HEAD is now at dcb5a0b non-empty
[master eba3ace] empty
 Author: A U Thor <author@example.com>

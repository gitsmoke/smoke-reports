...
[master (root-commit) 9abd0dd] Initial.
 Author: A <A@test.git>
...
Merging:
eafb7a8 Branch2-1
virtual d24f09ff18ce5541b7560da11fdc68bf8a9eeddd
...
expecting success: echo "evil merge." >>file &&
     git commit -a --amend
[branch2 9251458] Merge branch 'branch1' into branch2

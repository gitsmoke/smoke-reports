...
expecting success: 
	...
	git add hello &&
	git commit -m master
[master (root-commit) 473e029] initial
...
[master (root-commit) 9b0c0f8] initial git-gui
 Author: A U Thor <author@example.com>
 1 files changed, 1 insertions(+), 0 deletions(-)
...
[master (root-commit) 6af141d] initial git
 Author: A U Thor <author@example.com>
 1 files changed, 1 insertions(+), 0 deletions(-)
...
Updating gui
[master fe36130] Merge git-gui as our subdirectory
 Author: A U Thor <author@example.com>
...
M	git-gui.sh
[master2 ab3cb87] update git-gui
 Author: A U Thor <author@example.com>
 1 files changed, 1 insertions(+), 1 deletions(-)
Merging:
fe36130 Merge git-gui as our subdirectory
virtual ab3cb875ef1b326e184940224e9d56bc72363bf6
found 1 common ancestor(s):
9b0c0f8 initial git-gui
Merge made by subtree.
...
HEAD is now at fe36130 Merge git-gui as our subdirectory
Already up-to-date.
[master2 d48e58c] Merge git-gui2 as our subdirectory
 Author: A U Thor <author@example.com>
 1 files changed, 1 insertions(+), 0 deletions(-)
...
expecting success: 
	...
	test_cmp expected actual
HEAD is now at d48e58c Merge git-gui2 as our subdirectory
Merging:
d48e58c Merge git-gui2 as our subdirectory
virtual ab3cb875ef1b326e184940224e9d56bc72363bf6
found 1 common ancestor(s):
9b0c0f8 initial git-gui

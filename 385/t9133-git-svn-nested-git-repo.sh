...
Initialized empty Git repository in /Users/trast/git-smoke/t/trash directory.t9133-git-svn-nested-git-repo/g/.git/
	A	a
r1 = 0fc5db42a0c2ecd933ca0971c6c4bdfa60af0fa3 (refs/remotes/git-svn)
r2 = 6147de2055594a144ca5a4f990338066c1fad8f8 (refs/remotes/git-svn)
...
expecting success: 
	...
	M	a
r3 = 91b472dbc5c6c4465fffbe1bb40459a7b2d8910c (refs/remotes/git-svn)
...
[master (root-commit) ddcc03b] add a inside an SVN repo
 Author: A U Thor <author@example.com>
 1 files changed, 2 insertions(+), 0 deletions(-)
 create mode 100644 a
commit ddcc03be8f98dd96e78f49922413268fe2b18063
Author: A U Thor <author@example.com>
Date:   Fri Dec 24 04:04:32 2010 +0000
...
A         .git/objects/dd
A         .git/objects/dd/cc03be8f98dd96e78f49922413268fe2b18063
...
Adding         .git/objects/dd
Adding         .git/objects/dd/cc03be8f98dd96e78f49922413268fe2b18063
...
r4 = 1370e07446130458803e4c5b87f5b700bc145045 (refs/remotes/git-svn)
First, rewinding head to replay your work on top of it...
Fast-forwarded master to refs/remotes/git-svn.
...
[master 6e8215e] add a inside an SVN repo
 Author: A U Thor <author@example.com>
...
expecting success: 
	...
	M	a
r5 = 9cd7219b39ca32ea9b5187be479469125cf13b4a (refs/remotes/git-svn)
First, rewinding head to replay your work on top of it...
Fast-forwarded master to refs/remotes/git-svn.

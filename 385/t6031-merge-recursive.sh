...
[master (root-commit) 296f0ec] initial
...
[other 0070252] changesimplefile
 Author: A U Thor <author@example.com>
 1 files changed, 1 insertions(+), 0 deletions(-)
rm 'sub1'
[main 2237bec] changefiletodir
 Author: A U Thor <author@example.com>

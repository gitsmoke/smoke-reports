...
[master (root-commit) 6ca22e0] Initial
 Author: A U Thor <author@example.com>
 1 files changed, 1 insertions(+), 0 deletions(-)
 create mode 100644 file
[master 766ae4b] add line from a
 Author: A U Thor <author@example.com>
 1 files changed, 1 insertions(+), 1 deletions(-)
[side 69e18fc] add line from b
 Author: A U Thor <author@example.com>
 1 files changed, 1 insertions(+), 1 deletions(-)
...
HEAD is now at 6ca22e0 Initial
Merge made by ours.
...
HEAD is now at 766ae4b add line from a
Merging:
766ae4b add line from a
virtual side

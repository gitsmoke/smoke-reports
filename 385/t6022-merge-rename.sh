...
git checkout master
[master (root-commit) abe6f0b] initial has A and M
 Author: A U Thor <author@example.com>
 2 files changed, 30 insertions(+), 0 deletions(-)
 create mode 100644 A
 create mode 100644 M
[master 1982ee5] master updates A
 Author: A U Thor <author@example.com>
 1 files changed, 1 insertions(+), 1 deletions(-)
[yellow 3eba381] yellow removes M
 Author: A U Thor <author@example.com>
 1 files changed, 0 insertions(+), 15 deletions(-)
 delete mode 100644 M
[white e41ba0c] white renames A->B, M->N
 Author: A U Thor <author@example.com>
 2 files changed, 2 insertions(+), 2 deletions(-)
 rename A => B (93%)
 rename M => N (93%)
[red 4d87104] red renames A->B, M->N
 Author: A U Thor <author@example.com>
 2 files changed, 2 insertions(+), 2 deletions(-)
 rename A => B (93%)
 rename M => N (93%)
[blue 84cd43c] blue renames A->C, M->N
 Author: A U Thor <author@example.com>
 2 files changed, 2 insertions(+), 2 deletions(-)
 rename A => C (93%)
 rename M => N (93%)
...
Merging:
1982ee5 master updates A
virtual e41ba0c78a38f129db0f1c7e720c29d7248997b8
found 1 common ancestor(s):
abe6f0b initial has A and M
Auto-merging B
...
expecting success: 
	...
	git diff --exit-code white N
HEAD is now at 1982ee5 master updates A
Merging:
4d87104 red renames A->B, M->N
virtual e41ba0c78a38f129db0f1c7e720c29d7248997b8
found 1 common ancestor(s):
abe6f0b initial has A and M
Auto-merging B
...
HEAD is now at 4d87104 red renames A->B, M->N
! [blue] blue renames A->C, M->N
 ! [change] changed
  ! [change+rename] changed and renamed
   ! [master] master updates A
...
Merging:
4d87104 red renames A->B, M->N
virtual 1982ee5dae3fd10a7a5d2f511616809d3354ede4
found 1 common ancestor(s):
abe6f0b initial has A and M
Auto-merging B
CONFLICT (content): Merge conflict in B
...
Merging:
4d87104 red renames A->B, M->N
virtual 84cd43c61c7e67d065cb83d406c6933f32f6a9c4
found 1 common ancestor(s):
abe6f0b initial has A and M
Skipped N (merged same as existing)
CONFLICT (rename/rename): Rename "A"->"B" in branch "HEAD" rename "A"->"C" in "84cd43c61c7e67d065cb83d406c6933f32f6a9c4"
Automatic merge failed; fix conflicts and then commit the result.
g : red changes a line
...
+++++*+ [yellow^] initial has A and M
Merging:
e41ba0c white renames A->B, M->N
virtual 4d8710467eed8c9155b073e425fa5900dee14666
found 1 common ancestor(s):
abe6f0b initial has A and M
Auto-merging B
CONFLICT (content): Merge conflict in B
...
HEAD is now at e41ba0c white renames A->B, M->N
...
Merging:
1982ee5 master updates A
virtual 3eba38126759767173a852cf40b6eae634cb6c93
found 1 common ancestor(s):
abe6f0b initial has A and M
Removing M
...
HEAD is now at 1982ee5 master updates A
Updated tag 'anchor' (was 1982ee5)
! [blue] blue renames A->C, M->N
 ! [change] changed
  ! [change+rename] changed and renamed
   ! [master] master updates A
...
Merge made by recursive.
 A |    2 +-
 1 files changed, 1 insertions(+), 1 deletions(-)
HEAD is now at 3eba381 yellow removes M
...
HEAD is now at c9eb795 changed and renamed
Skipped B (merged same as existing)
...
HEAD is now at 573637c Merge branch 'change+rename' into change
rm 'B'
rm 'M'
[dir-in-way (root-commit) 780415b] Common commmit
 Author: A U Thor <author@example.com>
...
[dir-in-way 347ecda] Commit to merge, with dir in the way
 Author: A U Thor <author@example.com>
 2 files changed, 2 insertions(+), 0 deletions(-)
rm 'dir/file-in-the-way'
[dir-not-in-way 3e9986b] Commit to merge, with dir removed
 Author: A U Thor <author@example.com>
 2 files changed, 1 insertions(+), 1 deletions(-)
 delete mode 100644 dir/file-in-the-way
rm 'dir/file-in-the-way'
rm 'sub/file'
[renamed-file-has-no-conflicts 61429bc] Independent change
 Author: A U Thor <author@example.com>
 2 files changed, 1 insertions(+), 2 deletions(-)
 rename sub/file => dir (79%)
 delete mode 100644 dir/file-in-the-way
rm 'dir/file-in-the-way'
[renamed-file-has-conflicts 5237252] Conflicting change
 Author: A U Thor <author@example.com>
 2 files changed, 1 insertions(+), 1 deletions(-)
...
HEAD is now at 5237252 Conflicting change
Merging:
61429bc Independent change
virtual dir-not-in-way
found 1 common ancestor(s):
780415b Common commmit
...
HEAD is now at 800da0b Merge branch 'dir-not-in-way' into HEAD
...
HEAD is now at 61429bc Independent change
...
HEAD is now at 347ecda Commit to merge, with dir in the way
Merging:
5237252 Conflicting change
virtual dir-not-in-way
found 1 common ancestor(s):
780415b Common commmit
Removing dir to make room for subdirectory; may re-add later.
...
HEAD is now at 5237252 Conflicting change
Merging:
347ecda Commit to merge, with dir in the way
...
rm 'n.stages'
rm 'sub/file'
[rename-dest (root-commit) b813bd6] Common commmit
 Author: A U Thor <author@example.com>
 1 files changed, 1 insertions(+), 0 deletions(-)
 create mode 100644 one/file
[rename-dest 750285d] Renamed to destdir
 Author: A U Thor <author@example.com>
 1 files changed, 0 insertions(+), 0 deletions(-)
 rename one/file => destdir (100%)
rm 'one/file'
[source-conflict af862b8] Conflicts in the way
 Author: A U Thor <author@example.com>
...
HEAD is now at af862b8 Conflicts in the way
Merging:
750285d Renamed to destdir
virtual source-conflict
found 1 common ancestor(s):
b813bd6 Common commmit
...
HEAD is now at 750285d Renamed to destdir
rm 'destdir'
[rename-two (root-commit) 9050546] Common commmit
 Author: A U Thor <author@example.com>
 2 files changed, 2 insertions(+), 0 deletions(-)
 create mode 100644 one/file
 create mode 100644 two/file
rm 'one/file'
[rename-two 3d2537f] Rename two/file -> one
 Author: A U Thor <author@example.com>
 2 files changed, 0 insertions(+), 1 deletions(-)
 rename two/file => one (100%)
 delete mode 100644 one/file
rm 'two/file'
[rename-one 8090144] Rename one/file -> two
 Author: A U Thor <author@example.com>
 2 files changed, 0 insertions(+), 1 deletions(-)
...
Merging:
8090144 Rename one/file -> two
virtual rename-two
found 1 common ancestor(s):
9050546 Common commmit
...
HEAD is now at 8090144 Rename one/file -> two
Merging:
8090144 Rename one/file -> two
virtual rename-two
found 1 common ancestor(s):
...
HEAD is now at 8090144 Rename one/file -> two
rm 'two'
[first-rename (root-commit) 3d6ca23] Common commmit
 Author: A U Thor <author@example.com>
 1 files changed, 1 insertions(+), 0 deletions(-)
 create mode 100644 original
[first-rename 3a2fd25] Put two/file in the way, rename to one
 Author: A U Thor <author@example.com>
 1 files changed, 0 insertions(+), 0 deletions(-)
 rename original => one (100%)
 create mode 100644 two/file
[second-rename 325f197] Put one/file in the way, rename to two
 Author: A U Thor <author@example.com>
 1 files changed, 0 insertions(+), 0 deletions(-)
 create mode 100644 one/file
...
expecting success: 
	...
	! test -f original
Merging:
3a2fd25 Put two/file in the way, rename to one
virtual second-rename
found 1 common ancestor(s):
3d6ca23 Common commmit
...
HEAD is now at 3a2fd25 Put two/file in the way, rename to one
rm 'one'
rm 'two/file'
[first-rename-redo (root-commit) bc2cf70] Common commmit
 Author: A U Thor <author@example.com>
 1 files changed, 1 insertions(+), 0 deletions(-)
 create mode 100644 one/file
 create mode 100644 original
 create mode 100644 two/file
rm 'one/file'
[first-rename-redo 08fe4d8] Rename to one
 Author: A U Thor <author@example.com>
 1 files changed, 0 insertions(+), 0 deletions(-)
 rename original => one (100%)
 delete mode 100644 one/file
rm 'two/file'
[second-rename-redo 0d183a6] Rename to two
 Author: A U Thor <author@example.com>
 1 files changed, 0 insertions(+), 0 deletions(-)
 rename original => two (100%)
 delete mode 100644 two/file
...
Merging:
08fe4d8 Rename to one
virtual second-rename-redo
found 1 common ancestor(s):
bc2cf70 Common commmit
Removing one to make room for subdirectory; may re-add later.
Removing two/file

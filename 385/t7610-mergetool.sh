...
[master (root-commit) 4122a93] added file1
 Author: A U Thor <author@example.com>
 2 files changed, 2 insertions(+), 0 deletions(-)
 create mode 100644 file1
 create mode 100644 subdir/file3
[branch1 efe670d] branch1 changes
 Author: A U Thor <author@example.com>
 3 files changed, 3 insertions(+), 2 deletions(-)
 create mode 100644 file2
[master 798ae84] master updates
 Author: A U Thor <author@example.com>
 3 files changed, 3 insertions(+), 2 deletions(-)
 create mode 100644 file2
...
[test1 a17d013] branch1 resolved with mergetool
 Author: A U Thor <author@example.com>
...
x")" &&
    ...
    git reset --hard
[test2 8d296c7] branch1 resolved with mergetool - autocrlf
 Author: A U Thor <author@example.com>
HEAD is now at 8d296c7 branch1 resolved with mergetool - autocrlf
...
[test3 cd3d539] branch1 resolved with mergetool - subdir
 Author: A U Thor <author@example.com>
...
HEAD is now at efe670d branch1 changes
...
Normal merge conflict for 'subdir/file3':
  {local}: modified
  {remote}: modified
[test4 8570149] branch2 resolved by mergetool from subdir
 Author: A U Thor <author@example.com>

...
expecting success: 
	...
	git tag initial
[master (root-commit) f507673] initial
...
HEAD is now at f507673 initial
[master 2f9ce0d] add=5
 Author: A U Thor <author@example.com>
...
Deleted branch test5 (was d1875a7).
HEAD is now at f507673 initial
[master e2ebc41] add=5
 Author: A U Thor <author@example.com>
 5 files changed, 110 insertions(+), 0 deletions(-)
 create mode 100644 1
 create mode 100644 2
...
Deleted branch test5 (was d5967f2).
HEAD is now at f507673 initial
[master e2ebc41] add=5
 Author: A U Thor <author@example.com>
 5 files changed, 110 insertions(+), 0 deletions(-)
...
[simple-change debc59d] unrelated-change
 Author: A U Thor <author@example.com>
 0 files changed, 0 insertions(+), 0 deletions(-)

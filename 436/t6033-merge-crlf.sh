...
expecting success: 
	...
	git tag b &&
	git checkout master
[master (root-commit) 12e6dbd] Initial
 Author: A U Thor <author@example.com>
 1 files changed, 1 insertions(+), 0 deletions(-)
 create mode 100644 file
[master da2f631] add line from a
 Author: A U Thor <author@example.com>
 1 files changed, 1 insertions(+), 1 deletions(-)
[side b8032f8] add line from b
 Author: A U Thor <author@example.com>
 1 files changed, 1 insertions(+), 1 deletions(-)
ok 1 - setup
...
HEAD is now at 12e6dbd Initial
Merge made by ours.
...
expecting success: 
	...
	cat file | remove_cr | append_cr >file.temp &&
	test_cmp file file.temp
HEAD is now at da2f631 add line from a
Merging:
da2f631 add line from a
virtual side

...
[master (root-commit) e4865be] Initial.
 Author: A <A@test.git>
...
Merging:
258b635 Branch2-1
virtual 36bd8f2a29352b61c050305458e17eb02bf83a72
...
expecting success: echo "evil merge." >>file &&
     git commit -a --amend
[branch2 d2d3d63] Merge branch 'branch1' into branch2

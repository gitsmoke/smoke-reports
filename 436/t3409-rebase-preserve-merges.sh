...
[master (root-commit) 072a75a] Add A1
 Author: A U Thor <bogus_email_address>
 1 files changed, 1 insertions(+), 0 deletions(-)
 create mode 100644 A
[topic be0cec3] Add B1
 Author: A U Thor <bogus_email_address>
 1 files changed, 1 insertions(+), 0 deletions(-)
 create mode 100644 B
[master 029fc84] Modify A2
 Author: A U Thor <bogus_email_address>
 1 files changed, 1 insertions(+), 0 deletions(-)
Cloning into clone1
done.
...
Merge made by recursive.
 A |    1 +
 1 files changed, 1 insertions(+), 0 deletions(-)
[master ed49ab3] Add different B
 Author: A U Thor <bogus_email_address>
 1 files changed, 1 insertions(+), 0 deletions(-)
 create mode 100644 B
Cloning into clone2
...
[topic 198ef4e] Merge origin/master into topic
 Author: A U Thor <bogus_email_address>
[topic c805004] Modify B2
 Author: A U Thor <bogus_email_address>
 1 files changed, 1 insertions(+), 0 deletions(-)
...
Rebasing (1/1)Merging:
c805004 Modify B2
virtual ed49ab3e559b65d1cec0e9981e650323231d369d
found 1 common ancestor(s):
072a75a Add A1
Auto-merging B
CONFLICT (add/add): Merge conflict in B
...
@@@ -1,1 -1,1 +1,1 @@@
[detached HEAD 8326ba8] Merge origin/master into topic
 Author: A U Thor <bogus_email_address>
Rebasing (1/1)

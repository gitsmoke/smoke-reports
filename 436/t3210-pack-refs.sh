...
expecting success: git branch g/h &&
     ...
     git pack-refs --all &&
     git branch -d g
Deleted branch g/h (was f8d3343).
Deleted branch g (was f8d3343).
...
expecting success: git branch k/l &&
     ...
     git branch -d k/lm &&
     git branch k
Deleted branch k/l (was f8d3343).
Deleted branch k/l/m (was f8d3343).
Deleted branch k/lm (was f8d3343).
...
expecting success: git branch n/o &&
     ...
     git branch -d n/o/p &&
     git branch n
Deleted branch n/o (was f8d3343).
Deleted branch n/op (was f8d3343).
Deleted branch n/o/p (was f8d3343).

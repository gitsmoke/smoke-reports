...
[master e4e57ec] Test: Remove, add and update
 Author: A U Thor <author@example.com>
...
[master 4d6f71c] generatiion 1
 Author: A U Thor <author@example.com>
 1 files changed, 0 insertions(+), 0 deletions(-)
[master d730022] generation 2
 Author: A U Thor <author@example.com>
 1 files changed, 0 insertions(+), 0 deletions(-)
Checking if patch will apply
Applying
...
HEAD is now at e4e57ec Test: Remove, add and update
[master bd65940] test: remove only a binary file
 Author: A U Thor <author@example.com>
 1 files changed, 0 insertions(+), 0 deletions(-)
...
[master d52d9ea] test: remove only a binary file
 Author: A U Thor <author@example.com>
...
[master 23beb88] Update with spaces
 Author: A U Thor <author@example.com>
 2 files changed, 1 insertions(+), 0 deletions(-)
Checking if patch will apply
Applying
...
[master 6bb00c1] Update one
 Author: A U Thor <author@example.com>
 1 files changed, 1 insertions(+), 0 deletions(-)
[master b3c99c0] Update two
 Author: A U Thor <author@example.com>
 1 files changed, 1 insertions(+), 0 deletions(-)
Checking if patch will apply
Applying
...
[master 923ebd5] Add release notes
 Author: A U Thor <author@example.com>
 1 files changed, 1 insertions(+), 0 deletions(-)
...
initial revision: 1.1
Committed successfully to CVS
[master 125a916] Add two files with the same basename
 Author: A U Thor <author@example.com>
...
[master c425800] Added attic_gremlin
 Author: A U Thor <author@example.com>
 1 files changed, 1 insertions(+), 0 deletions(-)
...
[master 3aeb245] Add a file with a leading space
 Author: A U Thor <author@example.com>
 1 files changed, 1 insertions(+), 0 deletions(-)
...
[master (root-commit) 0b5e251] fake initial commit
 Author: A U Thor <author@example.com>
 1 files changed, 1 insertions(+), 0 deletions(-)
 create mode 100644  space
[master 80655f4] Another change
 Author: A U Thor <author@example.com>
 1 files changed, 1 insertions(+), 0 deletions(-)
Checking if patch will apply
Applying

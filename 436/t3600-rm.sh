...
[master (root-commit) df722a6] add normal files
...
[master 3f3c75b] add files with tabs and newlines
 Author: A U Thor <author@example.com>
 0 files changed, 0 insertions(+), 0 deletions(-)
...
[master 461f1be] add file for rm test
 Author: A U Thor <author@example.com>
...
[master fda691b] remove file from rm test
 Author: A U Thor <author@example.com>
...
[master f99a4e1] add file for rm --quiet test
 Author: A U Thor <author@example.com>
 1 files changed, 1 insertions(+), 0 deletions(-)
 create mode 100644 test-file
[master 674eb54] remove file from rm --quiet test
 Author: A U Thor <author@example.com>
 1 files changed, 0 insertions(+), 1 deletions(-)
 delete mode 100644 test-file
...
[master (root-commit) d13f2e0] add a file
 Author: A U Thor <author@example.com>
 1 files changed, 1 insertions(+), 0 deletions(-)
...
HEAD is now at 42a71f6 subdir test
rm 'frotz/nitfol'

...
expecting success: 
	...
	git svn fetch
r1 = ad364864fa63d3e50dee81170f9589b5a0f6007e (refs/remotes/git-svn)
	A	foo
r2 = 4805604398174cb22af7da5ba048655853692687 (refs/remotes/git-svn)
...
Committed r3
	A	bar
r3 = 3c768a0debb161ebbee943d9f9565c35879a79dc (refs/remotes/git-svn)

...
[master (root-commit) b660888] initial
...
[master 84ef205] master removes file2 and subdir/file2
 Author: A U Thor <author@example.com>
...
D	file2
D	subdir/file2
[side 712850b] side adds file3 and removes file2
 Author: A U Thor <author@example.com>
...
HEAD is now at 84ef205 master removes file2 and subdir/file2
...
expecting success: 
	...
	git checkout side-a
HEAD is now at 84ef205 master removes file2 and subdir/file2
[side-a ce8e9e0] side-a changes file1
 Author: A U Thor <author@example.com>
 1 files changed, 1 insertions(+), 0 deletions(-)
[side-b 817601b] side-b changes file2
 Author: A U Thor <author@example.com>
 1 files changed, 1 insertions(+), 0 deletions(-)
...
HEAD is now at ce8e9e0 side-a changes file1
...
HEAD is now at ce8e9e0 side-a changes file1
[sym-b 98d9223] side adds a/b
 Author: A U Thor <author@example.com>
 0 files changed, 0 insertions(+), 0 deletions(-)
 create mode 100644 a/b
[sym-a edd1fc9] we add a/b
 Author: A U Thor <author@example.com>
 1 files changed, 1 insertions(+), 0 deletions(-)
...
HEAD is now at edd1fc9 we add a/b
...
HEAD is now at edd1fc9 we add a/b
[side-a a76604c] side-a changes file2 to directory
 Author: A U Thor <author@example.com>
...
HEAD is now at 817601b side-b changes file2
Trying simple merge.
...
Merging:
817601b side-b changes file2
a76604c side-a changes file2 to directory

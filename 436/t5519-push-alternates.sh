...
[master (root-commit) 2e69add] initial
...
Updating 2e69add..88054fb
Fast-forward
 file |    1 +
 1 files changed, 1 insertions(+), 0 deletions(-)
[master 62c9ec4] third
 Author: A U Thor <author@example.com>
...
[master adf281c] sixth.1
 Author: A U Thor <author@example.com>
 1 files changed, 1 insertions(+), 1 deletions(-)
[master 7c5eb0f] sixth.2
 Author: A U Thor <author@example.com>
 1 files changed, 1 insertions(+), 0 deletions(-)
[master 0e02a92] sixth.3
 Author: A U Thor <author@example.com>
 1 files changed, 1 insertions(+), 0 deletions(-)
...
0e02a92bd258e7c7caddf89d394c831603193c15
[master 4201163] seventh
 Author: A U Thor <author@example.com>
 1 files changed, 1 insertions(+), 1 deletions(-)

...
Initialized empty Git repository in /Users/trast/git-smoke/t/trash directory.t9133-git-svn-nested-git-repo/g/.git/
	A	a
r1 = 7f2054e2c81205bce278448ffb7d350ee5bd25c4 (refs/remotes/git-svn)
r2 = 161ecd0df1c4b9709bbd33c5a6cea5b9d6f86ef9 (refs/remotes/git-svn)
...
expecting success: 
	...
	M	a
r3 = a874b8f50c25fab2e7058a33de81c65cf876923e (refs/remotes/git-svn)
...
[master (root-commit) 23ae9e1] add a inside an SVN repo
 Author: A U Thor <author@example.com>
 1 files changed, 2 insertions(+), 0 deletions(-)
 create mode 100644 a
commit 23ae9e1b2423936a84f172eaea4c6e0721b9a24a
Author: A U Thor <author@example.com>
Date:   Sun Jan 9 04:10:40 2011 +0000
...
A         .git/objects/23
A  (bin)  .git/objects/23/ae9e1b2423936a84f172eaea4c6e0721b9a24a
A         .git/objects/42
...
Adding  (bin)  .git/objects/23/ae9e1b2423936a84f172eaea4c6e0721b9a24a
...
r4 = 590064c32ddc1b688737165bb15aedab633f46af (refs/remotes/git-svn)
First, rewinding head to replay your work on top of it...
Fast-forwarded master to refs/remotes/git-svn.
...
[master 2ec6d83] add a inside an SVN repo
 Author: A U Thor <author@example.com>
...
expecting success: 
	...
	M	a
r5 = 4772005950f667e0c364549fe95cfa79dde82de7 (refs/remotes/git-svn)
First, rewinding head to replay your work on top of it...
Fast-forwarded master to refs/remotes/git-svn.

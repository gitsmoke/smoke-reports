...
[master (root-commit) eef5a5b] first commit
 Author: A U Thor <author@example.com>
 1 files changed, 1 insertions(+), 0 deletions(-)
 create mode 100644 foo
[master e8af796] second commit
 Author: A U Thor <author@example.com>
 1 files changed, 1 insertions(+), 0 deletions(-)
 create mode 100644 bar
[master 6937735] third commit
 Author: A U Thor <author@example.com>
 1 files changed, 1 insertions(+), 0 deletions(-)
 create mode 100644 baz
[master ab0f1a9] fourth commit
 Author: A U Thor <author@example.com>
 1 files changed, 1 insertions(+), 0 deletions(-)
...
commit eef5a5bfc16b339e8977a76f31df2661308a7cac
Author: A U Thor <author@example.com>
Date:   Sun Jan 9 04:08:37 2011 +0000

...
[master (root-commit) 18d35a7] commit
...
Unstaged changes after reset:
M	file
[master 29685fe] commit
 Author: A U Thor <author@example.com>
 1 files changed, 1 insertions(+), 1 deletions(-)
HEAD is now at 18d35a7 commit
...
[master 23121a4] clear local changes
 Author: A U Thor <author@example.com>
 1 files changed, 1 insertions(+), 0 deletions(-)
...
HEAD is now at 23121a4 clear local changes
[master 2373e8d] non-empty
 Author: A U Thor <author@example.com>
 1 files changed, 1 insertions(+), 0 deletions(-)
...
HEAD is now at 2373e8d non-empty
[master fb8805e] empty
 Author: A U Thor <author@example.com>

...
expecting success: 
	...
	git add file &&
	git commit -m "first"
[master (root-commit) d06dca8] first
...
expecting success: 
	...
	GIT_EDITOR="\"\$FAKE_EDITOR\"" git commit --no-verify
[master 3a7024a] even more content
 Author: A U Thor <author@example.com>
 1 files changed, 1 insertions(+), 0 deletions(-)

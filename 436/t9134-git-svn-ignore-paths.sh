...
Initialized empty Git repository in /Users/trast/git-smoke/t/trash directory.t9134-git-svn-ignore-paths/g/.git/
	A	qqq/test_qqq.txt
r1 = ef110fdc2b1c6b65bc293c613dfb5792ab1cd355 (refs/remotes/git-svn)
r2 = 1e5881d4224c7160eea9013b62f6c59124cfea09 (refs/remotes/git-svn)
...
" > expect &&
	...
	M	qqq/test_qqq.txt
r3 = 07f107be52fde81dabd11c2e70c01ab0ec5fb56e (refs/remotes/git-svn)
...
r4 = 76d95846d10946dc1ee82726b297699620e43e24 (refs/remotes/git-svn)
First, rewinding head to replay your work on top of it...
Fast-forwarded master to refs/remotes/git-svn.
...
" > expect &&
	...
	M	qqq/test_qqq.txt
r5 = b2045eff6f0dc8835652b20403fbf75d467acac3 (refs/remotes/git-svn)
First, rewinding head to replay your work on top of it...
Fast-forwarded master to refs/remotes/git-svn.

...
r1 = 7dee883be9054a94bd0a6304d25ef0d593a926df (refs/remotes/git-svn)
...
[test-rmdir e0fa682] remove another
 ...
 delete mode 100644 deeply/nested/directory/number/2/another
	...
	D	deeply/nested/directory/number/2/another
	D	deeply/nested/directory/number/2/
r2 = 310c46f15c233bebabe5738ec0b143b4de71b7ab (refs/remotes/git-svn)

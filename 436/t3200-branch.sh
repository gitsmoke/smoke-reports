...
[master (root-commit) f8d3343] Initial commit.
 Author: A U Thor <author@example.com>
 1 files changed, 1 insertions(+), 0 deletions(-)
 create mode 100644 A
[master 0f125df] Second commit.
 Author: A U Thor <author@example.com>
 1 files changed, 1 insertions(+), 0 deletions(-)
...
expecting success: git branch l/m &&
        git branch -d l/m &&
        git branch l
Deleted branch l/m (was 0f125df).
...
Deleted branch s/t (was 0f125df).
...
Deleted branch my7 (was 0f125df).
...
0f125df959e155d3c7375fe258908e31d26a5197
...
Deleted branch my8 (was 0f125df).

...
expecting success: echo "Not an empty file." > file &&
	 ...
	 git branch b
[master (root-commit) b54f87a] Initial commit.
...
expecting success: rm renamed_file &&
	 ...
	 gitweb_run "p=.git;a=commitdiff"
[master b4352d1] File to symlink.
 Author: A U Thor <author@example.com>
...
expecting success: echo "New line" >> file2 &&
	 ...
	 gitweb_run "p=.git;a=commitdiff"
[master 433204c] Mode change and modification.
 Author: A U Thor <author@example.com>
 1 files changed, 1 insertions(+), 0 deletions(-)
...
EOF
	 ...
	 gitweb_run "p=.git;a=commitdiff"
[master d42a906] File added.
 Author: A U Thor <author@example.com>
 1 files changed, 7 insertions(+), 2 deletions(-)
[master 1526193] File rename and modification.
 Author: A U Thor <author@example.com>
 1 files changed, 1 insertions(+), 0 deletions(-)
...
expecting success: git mv file3 file2 &&
	 ...
	 gitweb_run "p=.git;a=commitdiff"
[master 7df5538] File rename, mode change and modification.
 Author: A U Thor <author@example.com>
 1 files changed, 1 insertions(+), 0 deletions(-)
...
[master 955bd94] initial
 Author: A U Thor <author@example.com>
 2 files changed, 2 insertions(+), 0 deletions(-)
 create mode 100644 bar
 create mode 100644 foo
[master 7dfac39] foo symlinked to bar
 Author: A U Thor <author@example.com>
 1 files changed, 1 insertions(+), 1 deletions(-)
 rewrite foo (100%)
 mode change 100644 => 120000
[master 5f2e958] foo back to file
 Author: A U Thor <author@example.com>
 1 files changed, 1 insertions(+), 1 deletions(-)
 rewrite foo (100%)
 mode change 120000 => 100644
[master 7152dc7] foo becomes a directory
 Author: A U Thor <author@example.com>
 2 files changed, 1 insertions(+), 1 deletions(-)
 delete mode 100644 foo
 create mode 100644 foo/baz
[master e3274c1] foo/baz is the original foo
 Author: A U Thor <author@example.com>
 1 files changed, 1 insertions(+), 1 deletions(-)
...
Merging:
e3274c1 foo/baz is the original foo
virtual 3ef94a5b73bc85070dcf9465b338f5da837802bb
found 1 common ancestor(s):
b54f87a Initial commit.
...
expecting success: git checkout b &&
	 ...
	 git checkout master
[b b64839f] Prepare large commit
 Author: A U Thor <author@example.com>
...
[master 841ca24] Add file to be deleted
 Author: A U Thor <author@example.com>
 1 files changed, 1 insertions(+), 0 deletions(-)
 create mode 100644 deleted_file
rm 'deleted_file'
[master 068bd7d] Delete file
 Author: A U Thor <author@example.com>
 1 files changed, 0 insertions(+), 1 deletions(-)

...
expecting success: 
	...
	echo other >four &&
	echo other >five
[master (root-commit) a4ee237] First
 Author: A U Thor <author@example.com>
 1 files changed, 1 insertions(+), 0 deletions(-)
 create mode 100644 one
[branch 8eb7f1d] Second
 Author: A U Thor <author@example.com>
...
expecting success: 
	...
	git reset --hard HEAD^
Updating a4ee237..8eb7f1d
Aborting
[master 600ee57] empty
 Author: A U Thor <author@example.com>
Aborting
HEAD is now at a4ee237 First
...
[master (root-commit) df00da6] init
 Author: A U Thor <author@example.com>
...
rm 'rep/foo'
rm 'rep2/foo'
[branch b7bdece] added test as a file
 Author: A U Thor <author@example.com>

...
git checkout master
[master (root-commit) d876fa8] initial has A and M
 Author: A U Thor <author@example.com>
 2 files changed, 30 insertions(+), 0 deletions(-)
 create mode 100644 A
 create mode 100644 M
[master 930c90f] master updates A
 Author: A U Thor <author@example.com>
 1 files changed, 1 insertions(+), 1 deletions(-)
[yellow bfb6afe] yellow removes M
 Author: A U Thor <author@example.com>
 1 files changed, 0 insertions(+), 15 deletions(-)
 delete mode 100644 M
[white 762e2e7] white renames A->B, M->N
 Author: A U Thor <author@example.com>
 2 files changed, 2 insertions(+), 2 deletions(-)
 rename A => B (93%)
 rename M => N (93%)
[red d3896e9] red renames A->B, M->N
 Author: A U Thor <author@example.com>
 2 files changed, 2 insertions(+), 2 deletions(-)
 rename A => B (93%)
 rename M => N (93%)
[blue db00a58] blue renames A->C, M->N
 Author: A U Thor <author@example.com>
 2 files changed, 2 insertions(+), 2 deletions(-)
 rename A => C (93%)
 rename M => N (93%)
...
Merging:
930c90f master updates A
virtual 762e2e7f838b742cdd81fc6d5c549e87f43735fa
found 1 common ancestor(s):
d876fa8 initial has A and M
Auto-merging B
...
expecting success: 
	...
	git diff --exit-code white N
HEAD is now at 930c90f master updates A
Merging:
d3896e9 red renames A->B, M->N
virtual 762e2e7f838b742cdd81fc6d5c549e87f43735fa
found 1 common ancestor(s):
d876fa8 initial has A and M
Auto-merging B
...
expecting success: 
	...
	git diff --exit-code white N
HEAD is now at d3896e9 red renames A->B, M->N
! [blue] blue renames A->C, M->N
 ! [change] changed
  ! [change+rename] changed and renamed
   ! [master] master updates A
...
Merging:
d3896e9 red renames A->B, M->N
virtual 930c90f0cb32a5af4a620dc5248ac3096aa6ebe0
found 1 common ancestor(s):
d876fa8 initial has A and M
Auto-merging B
CONFLICT (content): Merge conflict in B
...
Merging:
d3896e9 red renames A->B, M->N
virtual db00a586e4c2c38cc9d3eeff4a2e5711f5e361f9
found 1 common ancestor(s):
d876fa8 initial has A and M
Skipped N (merged same as existing)
CONFLICT (rename/rename): Rename "A"->"B" in branch "HEAD" rename "A"->"C" in "db00a586e4c2c38cc9d3eeff4a2e5711f5e361f9"
Automatic merge failed; fix conflicts and then commit the result.
g : red changes a line
...
+++++*+ [yellow^] initial has A and M
Merging:
762e2e7 white renames A->B, M->N
virtual d3896e94f908adc16226cd293a5e4501fbb04954
found 1 common ancestor(s):
d876fa8 initial has A and M
Auto-merging B
CONFLICT (content): Merge conflict in B
...
HEAD is now at 762e2e7 white renames A->B, M->N
...
Merging:
930c90f master updates A
virtual bfb6afe86d4a8eebc868280362e6a49f06c24987
found 1 common ancestor(s):
d876fa8 initial has A and M
Removing M
...
expecting success: 
	...
	git reset --hard anchor
HEAD is now at 930c90f master updates A
Updated tag 'anchor' (was 930c90f)
! [blue] blue renames A->C, M->N
 ! [change] changed
  ! [change+rename] changed and renamed
   ! [master] master updates A
...
Merge made by recursive.
 A |    2 +-
 1 files changed, 1 insertions(+), 1 deletions(-)
HEAD is now at bfb6afe yellow removes M
...
HEAD is now at 3a440b9 changed and renamed
Skipped B (merged same as existing)
...
HEAD is now at 7996582 Merge branch 'change+rename' into change
rm 'B'
rm 'M'
[dir-in-way (root-commit) 26cede3] Common commmit
 Author: A U Thor <author@example.com>
...
[dir-in-way 82b536b] Commit to merge, with dir in the way
 Author: A U Thor <author@example.com>
 2 files changed, 2 insertions(+), 0 deletions(-)
rm 'dir/file-in-the-way'
[dir-not-in-way 2b3441a] Commit to merge, with dir removed
 Author: A U Thor <author@example.com>
 2 files changed, 1 insertions(+), 1 deletions(-)
 delete mode 100644 dir/file-in-the-way
rm 'dir/file-in-the-way'
rm 'sub/file'
[renamed-file-has-no-conflicts 083ed6b] Independent change
 Author: A U Thor <author@example.com>
 2 files changed, 1 insertions(+), 2 deletions(-)
 rename sub/file => dir (79%)
 delete mode 100644 dir/file-in-the-way
rm 'dir/file-in-the-way'
[renamed-file-has-conflicts 5a9dd8a] Conflicting change
 Author: A U Thor <author@example.com>
 2 files changed, 1 insertions(+), 1 deletions(-)
...
HEAD is now at 5a9dd8a Conflicting change
Merging:
083ed6b Independent change
virtual dir-not-in-way
found 1 common ancestor(s):
26cede3 Common commmit
...
HEAD is now at 1585c7a Merge branch 'dir-not-in-way' into HEAD
...
HEAD is now at 083ed6b Independent change
...
HEAD is now at 82b536b Commit to merge, with dir in the way
Merging:
5a9dd8a Conflicting change
virtual dir-not-in-way
found 1 common ancestor(s):
26cede3 Common commmit
Removing dir to make room for subdirectory; may re-add later.
...
HEAD is now at 5a9dd8a Conflicting change
Merging:
82b536b Commit to merge, with dir in the way
...
rm 'n.stages'
rm 'sub/file'
[rename-dest (root-commit) 9951527] Common commmit
 Author: A U Thor <author@example.com>
 1 files changed, 1 insertions(+), 0 deletions(-)
 create mode 100644 one/file
[rename-dest 750dcc2] Renamed to destdir
 Author: A U Thor <author@example.com>
 1 files changed, 0 insertions(+), 0 deletions(-)
 rename one/file => destdir (100%)
rm 'one/file'
[source-conflict 00a5a6d] Conflicts in the way
 Author: A U Thor <author@example.com>
...
HEAD is now at 00a5a6d Conflicts in the way
Merging:
750dcc2 Renamed to destdir
virtual source-conflict
found 1 common ancestor(s):
9951527 Common commmit
...
HEAD is now at 750dcc2 Renamed to destdir
rm 'destdir'
[rename-two (root-commit) c40f6f9] Common commmit
 Author: A U Thor <author@example.com>
 2 files changed, 2 insertions(+), 0 deletions(-)
 create mode 100644 one/file
 create mode 100644 two/file
rm 'one/file'
[rename-two 11f02a0] Rename two/file -> one
 Author: A U Thor <author@example.com>
 2 files changed, 0 insertions(+), 1 deletions(-)
 rename two/file => one (100%)
 delete mode 100644 one/file
rm 'two/file'
[rename-one 409b835] Rename one/file -> two
 Author: A U Thor <author@example.com>
 2 files changed, 0 insertions(+), 1 deletions(-)
...
Merging:
409b835 Rename one/file -> two
virtual rename-two
found 1 common ancestor(s):
c40f6f9 Common commmit
...
HEAD is now at 409b835 Rename one/file -> two
Merging:
409b835 Rename one/file -> two
virtual rename-two
found 1 common ancestor(s):
...
HEAD is now at 409b835 Rename one/file -> two
rm 'two'
[first-rename (root-commit) f3b4b90] Common commmit
 Author: A U Thor <author@example.com>
 1 files changed, 1 insertions(+), 0 deletions(-)
 create mode 100644 original
[first-rename 4eed436] Put two/file in the way, rename to one
 Author: A U Thor <author@example.com>
 1 files changed, 0 insertions(+), 0 deletions(-)
 rename original => one (100%)
 create mode 100644 two/file
[second-rename a228360] Put one/file in the way, rename to two
 Author: A U Thor <author@example.com>
 1 files changed, 0 insertions(+), 0 deletions(-)
 create mode 100644 one/file
...
Merging:
4eed436 Put two/file in the way, rename to one
virtual second-rename
found 1 common ancestor(s):
f3b4b90 Common commmit
...
HEAD is now at 4eed436 Put two/file in the way, rename to one
rm 'one'
rm 'two/file'
[first-rename-redo (root-commit) 343fc3f] Common commmit
 Author: A U Thor <author@example.com>
 1 files changed, 1 insertions(+), 0 deletions(-)
 create mode 100644 one/file
 create mode 100644 original
 create mode 100644 two/file
rm 'one/file'
[first-rename-redo 2d76c1b] Rename to one
 Author: A U Thor <author@example.com>
 1 files changed, 0 insertions(+), 0 deletions(-)
 rename original => one (100%)
 delete mode 100644 one/file
rm 'two/file'
[second-rename-redo 43e2920] Rename to two
 Author: A U Thor <author@example.com>
 1 files changed, 0 insertions(+), 0 deletions(-)
 rename original => two (100%)
 delete mode 100644 two/file
...
expecting success: 
	...
	! test -f original
Merging:
2d76c1b Rename to one
virtual second-rename-redo
found 1 common ancestor(s):
343fc3f Common commmit
Removing one to make room for subdirectory; may re-add later.
Removing two/file

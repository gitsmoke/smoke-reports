...
[master (root-commit) f7da36b] subject
...
expecting success: 
	...
	check_message diff
[master c5ffb32] This is an example commit message that contains a diff.
 Author: A U Thor <author@example.com>
 1 files changed, 1 insertions(+), 1 deletions(-)
...
[master 4d3aaa0] This is an example commit message that contains a diff.
 Author: A U Thor <author@example.com>
 1 files changed, 1 insertions(+), 1 deletions(-)
--- diff	2011-01-09 04:09:16.000000000 +0000
+++ actual	2011-01-09 04:09:16.000000000 +0000
@@ -1,9 +1,2 @@

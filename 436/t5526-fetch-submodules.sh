...
[master (root-commit) c15db16] new
...
[master (root-commit) 4fa7cb0] new
 Author: A U Thor <author@example.com>
...
[master (root-commit) 2fc57bd] initial
 Author: A U Thor <author@example.com>
...
Submodule path 'submodule': checked out '4fa7cb0352572c846bab7b7efd39785442a68313'
...
Submodule path 'deepsubmodule': checked out 'c15db1647c7ad3fbe758985f73a93cee594d3c10'

...
git checkout master
[master (root-commit) 764cff0] initial has A and M
 Author: A U Thor <author@example.com>
 2 files changed, 30 insertions(+), 0 deletions(-)
 create mode 100644 A
 create mode 100644 M
[white 7650ad4] white renames A->B, M->N
 Author: A U Thor <author@example.com>
 2 files changed, 2 insertions(+), 2 deletions(-)
 rename A => B (93%)
 rename M => N (93%)
[red e14d69e] red creates R
 Author: A U Thor <author@example.com>
 1 files changed, 1 insertions(+), 0 deletions(-)
 create mode 100644 R
[blue ada8cc4] blue modify A
 Author: A U Thor <author@example.com>
...
Merging:
e14d69e red creates R
virtual white
found 1 common ancestor(s):
764cff0 initial has A and M
Auto-merging B
Auto-merging N

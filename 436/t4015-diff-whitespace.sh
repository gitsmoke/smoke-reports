...
[master (root-commit) bb58ddf] snapshot
...
HEAD is now at 3ee0029 yet another
[master a70c009] hello 1
 Author: A U Thor <author@example.com>
 1 files changed, 1 insertions(+), 1 deletions(-)
...
expecting success: 
	...
	test_cmp expect actual
HEAD is now at a70c009 hello 1
[master 27c5bd0] base
 Author: A U Thor <author@example.com>
...
HEAD is now at 27c5bd0 base
[master 0aab6a2] empty
 Author: A U Thor <author@example.com>
...
expecting success: 
	...
	! grep "^-" actual
HEAD is now at 0aab6a2 empty
[master fe9187f] one side
 Author: A U Thor <author@example.com>
 1 files changed, 1 insertions(+), 9 deletions(-)
[detached HEAD 232e319] the other side
 Author: A U Thor <author@example.com>
 1 files changed, 1 insertions(+), 9 deletions(-)
Merging:
232e319 the other side
virtual master
...
expecting success: 
	...
	test_cmp expected current
HEAD is now at 232e319 the other side
[detached HEAD 7a42827] initial
 Author: A U Thor <author@example.com>
 1 files changed, 1 insertions(+), 1 deletions(-)

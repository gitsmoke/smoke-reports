...
[master (root-commit) 2e7df97] initial
 Author: A U Thor <author@example.com>
 0 files changed, 0 insertions(+), 0 deletions(-)
 create mode 100644 camelcase
[topic 76fee49] rename
 Author: A U Thor <author@example.com>
...
checking known breakage: 
	...
	git merge topic
HEAD is now at 2e7df97 initial
Updating 2e7df97..76fee49
Fast-forward
...
[master (root-commit) 0223bd4] initial
 Author: A U Thor <author@example.com>
 0 files changed, 0 insertions(+), 0 deletions(-)
 create mode 100644 "a\314\210"
[topic ba10081] rename
 Author: A U Thor <author@example.com>
 1 files changed, 0 insertions(+), 0 deletions(-)
...
checking known breakage: 
 ...
 git reset --hard initial &&
 git merge topic
HEAD is now at 0223bd4 initial
Updating 0223bd4..ba10081
Aborting

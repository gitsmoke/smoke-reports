...
expecting success: 
	...
	echo happy.
[master (root-commit) 8832fa2] initial
...
expecting success: 
	...
	git reset --hard HEAD^
HEAD is now at 8832fa2 initial
...
[master 73e1a88] Add .gitattributes
 Author: A U Thor <author@example.com>
...
[master cb07c37] initial
 Author: A U Thor <author@example.com>
 1 files changed, 1 insertions(+), 0 deletions(-)
[master 39888b3] second
 Author: A U Thor <author@example.com>
...
[master dea3052] alllf, allcrlf and mixed only
 Author: A U Thor <author@example.com>

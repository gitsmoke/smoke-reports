...
[master (root-commit) 0555892] initial
...
Merging:
2b4904d addition
virtual 75913a405966a2d847e410c88105c7c080497f9e
...
[master (root-commit) eae2733] initial
 Author: A U Thor <author@example.com>
 1 files changed, 1 insertions(+), 0 deletions(-)
 create mode 100644 file1

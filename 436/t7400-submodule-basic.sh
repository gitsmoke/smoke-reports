...
[master (root-commit) ce9d5bb] initial commit
...
[master (root-commit) 7692e76] submodule commit 1
 Author: A U Thor <author@example.com>
...
[master (root-commit) 3f17115] Ignore everything
 Author: A U Thor <author@example.com>
 1 files changed, 1 insertions(+), 0 deletions(-)
...
rev1: 7692e76fcc7979ef472755d6d5c467461d8a5c4c
...
expecting success: 
	git submodule status >lines &&
	grep "^-$rev1" lines
-7692e76fcc7979ef472755d6d5c467461d8a5c4c init
...
Submodule path 'init': checked out '7692e76fcc7979ef472755d6d5c467461d8a5c4c'
...
expecting success: 
 ...
 7692e76fcc7979ef472755d6d5c467461d8a5c4c init (rev-1)
...
[detached HEAD 55357fa] submodule commit 2
 Author: A U Thor <author@example.com>
 1 files changed, 1 insertions(+), 0 deletions(-)
 create mode 100644 b
+55357fa93c67b43e1c8a3ec0c87f626a9146f265 init (rev-1-1-g55357fa)
...
+Subproject commit 55357fa93c67b43e1c8a3ec0c87f626a9146f265
...
[detached HEAD 681f94c] change subproject
 Author: A U Thor <author@example.com>
 1 files changed, 1 insertions(+), 0 deletions(-)
 create mode 100644 s
[master 31fdd2a] change init
 Author: A U Thor <author@example.com>
...
Submodule path 'init': checked out '681f94c58611ca76e7c63cfb0b3071999f7b015f'
...
HEAD is now at 3bdd2f0 super commit 1
...
HEAD is now at 3bdd2f0 super commit 1
[second 7c4c45a] commit subproject
 Author: A U Thor <author@example.com>
 1 files changed, 1 insertions(+), 1 deletions(-)
diff --git a/init b/init
index 681f94c..527065a 160000
--- a/init
+++ b/init
@@ -1 +1 @@
-Subproject commit 681f94c58611ca76e7c63cfb0b3071999f7b015f
+Subproject commit 527065a9f0485efd8da09aeee9e3b94500656db3
...
expecting success: 
	...
	test ! -d init &&
	git checkout second
HEAD is now at 7c4c45a commit subproject
...
[master (root-commit) ccfd627] repo commit 1
 Author: A U Thor <author@example.com>
 1 files changed, 1 insertions(+), 0 deletions(-)

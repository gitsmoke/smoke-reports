...
expecting success: 
	...
	repo_fetched one &&
	repo_fetched two
[master (root-commit) 025cd2b] update-all
...
expecting success: 
	...
	repo_fetched one &&
	repo_fetched two
[master afb5625] fetch-group-all
 Author: A U Thor <author@example.com>
 1 files changed, 1 insertions(+), 0 deletions(-)
[master afb5625] fetch-group-all
 Author: A U Thor <author@example.com>
...
expecting success: 
	...
	repo_fetched one &&
	! repo_fetched two
[master 4b29b22] fetch-group-some
 Author: A U Thor <author@example.com>
 1 files changed, 1 insertions(+), 0 deletions(-)
[master 4b29b22] fetch-group-some
 Author: A U Thor <author@example.com>

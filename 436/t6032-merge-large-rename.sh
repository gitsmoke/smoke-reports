...
expecting success: 
	...
	git tag initial
[master (root-commit) 0156342] initial
...
HEAD is now at 0156342 initial
[master 1df9df5] add=5
 Author: A U Thor <author@example.com>
...
Deleted branch test5 (was 41562f9).
HEAD is now at 0156342 initial
[master 23038dd] add=5
 Author: A U Thor <author@example.com>
 5 files changed, 110 insertions(+), 0 deletions(-)
 create mode 100644 1
 create mode 100644 2
...
Deleted branch test5 (was ea36103).
HEAD is now at 0156342 initial
[master 40a30b9] add=5
 Author: A U Thor <author@example.com>
 5 files changed, 110 insertions(+), 0 deletions(-)
 create mode 100644 1
 create mode 100644 2
...
[simple-change 60a245d] unrelated-change
 Author: A U Thor <author@example.com>
 0 files changed, 0 insertions(+), 0 deletions(-)

...
[master (root-commit) e12472e] initial
...
[other 2ae27ae] changesimplefile
 Author: A U Thor <author@example.com>
 1 files changed, 1 insertions(+), 0 deletions(-)
rm 'sub1'
[main 9f828c9] changefiletodir
 Author: A U Thor <author@example.com>

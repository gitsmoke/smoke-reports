...
expecting success: 
	...
	git add hello &&
	git commit -m master
[master (root-commit) bed1f25] initial
...
[master (root-commit) 0caf652] initial git-gui
 Author: A U Thor <author@example.com>
 1 files changed, 1 insertions(+), 0 deletions(-)
...
[master (root-commit) 81ed91a] initial git
 Author: A U Thor <author@example.com>
 1 files changed, 1 insertions(+), 0 deletions(-)
...
Updating gui
[master a3a9076] Merge git-gui as our subdirectory
 Author: A U Thor <author@example.com>
ok 4 - initial merge
...
expecting success: 
	...
	test_cmp expected actual
M	git-gui.sh
[master2 0b3b217] update git-gui
 Author: A U Thor <author@example.com>
 1 files changed, 1 insertions(+), 1 deletions(-)
Merging:
a3a9076 Merge git-gui as our subdirectory
virtual 0b3b21702a68f00885305b51e0050bf41f7d0dba
found 1 common ancestor(s):
0caf652 initial git-gui
Merge made by subtree.
...
HEAD is now at a3a9076 Merge git-gui as our subdirectory
Already up-to-date.
[master2 602ed20] Merge git-gui2 as our subdirectory
 Author: A U Thor <author@example.com>
 1 files changed, 1 insertions(+), 0 deletions(-)
...
HEAD is now at 602ed20 Merge git-gui2 as our subdirectory
Merging:
602ed20 Merge git-gui2 as our subdirectory
virtual 0b3b21702a68f00885305b51e0050bf41f7d0dba
found 1 common ancestor(s):
0caf652 initial git-gui

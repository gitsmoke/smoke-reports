...
HEAD is now at da68779 dir to symlink
rm 'a/b'
[detached HEAD fae1c36] untracked symlink remains
 Author: A U Thor <author@example.com>
...
expecting success: 
	...
	git commit -m x &&
	git tag baseline
HEAD is now at a6e6a2b base
[detached HEAD 2e96c91] x
 Author: A U Thor <author@example.com>
 1 files changed, 1 insertions(+), 0 deletions(-)
...
HEAD is now at 0524e87 Merge branch 'master' into HEAD
Merging:
2e96c91 x
virtual master
...
expecting success: 
	...
	test -h a/b &&
	test -f a/b-2/c/d
HEAD is now at 4e3a59c Merge commit 'baseline^0' into HEAD
Merging:
da68779 dir to symlink
virtual baseline^0
found 1 common ancestor(s):
a6e6a2b base
...
HEAD is now at d7ef08f Merge branch 'master' into HEAD
Merging:
2e96c91 x
virtual master
found 1 common ancestor(s):
...
HEAD is now at 2e96c91 x
[detached HEAD e9bf6c6] dir a/b-2 to symlink
 Author: A U Thor <author@example.com>
...
HEAD is now at e9bf6c6 dir a/b-2 to symlink
Trying really trivial in-index merge...
Nope.
Trying simple merge.
Simple merge failed, trying Automatic merge.
...
HEAD is now at 2a7f078 Merge commit 'test2' into HEAD
Merging:
2e96c91 x
virtual test2
found 1 common ancestor(s):

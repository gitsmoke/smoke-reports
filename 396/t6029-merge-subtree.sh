...
expecting success: 
	...
	git add hello &&
	git commit -m master
[master (root-commit) 83ca6e7] initial
...
[master (root-commit) f9db036] initial git-gui
 Author: A U Thor <author@example.com>
 1 files changed, 1 insertions(+), 0 deletions(-)
...
[master (root-commit) 2b4c6d7] initial git
 Author: A U Thor <author@example.com>
 1 files changed, 1 insertions(+), 0 deletions(-)
...
Updating gui
[master 4f78007] Merge git-gui as our subdirectory
 Author: A U Thor <author@example.com>
...
expecting success: 
	...
	test_cmp expected actual
M	git-gui.sh
[master2 79ae7b5] update git-gui
 Author: A U Thor <author@example.com>
 1 files changed, 1 insertions(+), 1 deletions(-)
Merging:
4f78007 Merge git-gui as our subdirectory
virtual 79ae7b51abff1e5b00692fe93ac1a01a7a6db316
found 1 common ancestor(s):
f9db036 initial git-gui
Merge made by subtree.
...
expecting success: 
	...
	test_cmp expected actual
HEAD is now at 4f78007 Merge git-gui as our subdirectory
Already up-to-date.
[master2 2306beb] Merge git-gui2 as our subdirectory
 Author: A U Thor <author@example.com>
 1 files changed, 1 insertions(+), 0 deletions(-)
...
HEAD is now at 2306beb Merge git-gui2 as our subdirectory
Merging:
2306beb Merge git-gui2 as our subdirectory
virtual 79ae7b51abff1e5b00692fe93ac1a01a7a6db316
found 1 common ancestor(s):
f9db036 initial git-gui

...
expecting success: 
	...
	git tag initial
[master (root-commit) 1a6365f] initial
...
HEAD is now at 1a6365f initial
[master 745839b] add=5
 Author: A U Thor <author@example.com>
...
Deleted branch test5 (was 530756f).
HEAD is now at 1a6365f initial
[master 0e8bd8f] add=5
 Author: A U Thor <author@example.com>
 5 files changed, 110 insertions(+), 0 deletions(-)
 create mode 100644 1
 create mode 100644 2
...
Deleted branch test5 (was 801c43e).
HEAD is now at 1a6365f initial
[master 0f6f027] add=5
 Author: A U Thor <author@example.com>
 5 files changed, 110 insertions(+), 0 deletions(-)
 create mode 100644 1
 create mode 100644 2
...
[simple-change c24e27a] unrelated-change
 Author: A U Thor <author@example.com>
 0 files changed, 0 insertions(+), 0 deletions(-)

...
git checkout master
[master (root-commit) 2263b8f] initial has A and M
 Author: A U Thor <author@example.com>
 2 files changed, 30 insertions(+), 0 deletions(-)
 create mode 100644 A
 create mode 100644 M
[master 24dfb52] master updates A
 Author: A U Thor <author@example.com>
 1 files changed, 1 insertions(+), 1 deletions(-)
[yellow 35c9049] yellow removes M
 Author: A U Thor <author@example.com>
 1 files changed, 0 insertions(+), 15 deletions(-)
 delete mode 100644 M
[white 230a60b] white renames A->B, M->N
 Author: A U Thor <author@example.com>
 2 files changed, 2 insertions(+), 2 deletions(-)
 rename A => B (93%)
 rename M => N (93%)
[red facb2d2] red renames A->B, M->N
 Author: A U Thor <author@example.com>
 2 files changed, 2 insertions(+), 2 deletions(-)
 rename A => B (93%)
 rename M => N (93%)
[blue 156bc6e] blue renames A->C, M->N
 Author: A U Thor <author@example.com>
 2 files changed, 2 insertions(+), 2 deletions(-)
 rename A => C (93%)
 rename M => N (93%)
...
Merging:
24dfb52 master updates A
virtual 230a60b4a7158a0f08e5b1a9e0f9717e3f2e97cf
found 1 common ancestor(s):
2263b8f initial has A and M
Auto-merging B
...
expecting success: 
	...
	git diff --exit-code white N
HEAD is now at 24dfb52 master updates A
Merging:
facb2d2 red renames A->B, M->N
virtual 230a60b4a7158a0f08e5b1a9e0f9717e3f2e97cf
found 1 common ancestor(s):
2263b8f initial has A and M
Auto-merging B
...
expecting success: 
	...
	git diff --exit-code white N
HEAD is now at facb2d2 red renames A->B, M->N
! [blue] blue renames A->C, M->N
 ! [change] changed
  ! [change+rename] changed and renamed
   ! [master] master updates A
...
Merging:
facb2d2 red renames A->B, M->N
virtual 24dfb52533b10dad1968377d5b2b990fd16d1f06
found 1 common ancestor(s):
2263b8f initial has A and M
Auto-merging B
CONFLICT (content): Merge conflict in B
...
Merging:
facb2d2 red renames A->B, M->N
virtual 156bc6e95373839e5c40e6b9cf02acd060a4cb52
found 1 common ancestor(s):
2263b8f initial has A and M
Skipped N (merged same as existing)
CONFLICT (rename/rename): Rename "A"->"B" in branch "HEAD" rename "A"->"C" in "156bc6e95373839e5c40e6b9cf02acd060a4cb52"
Automatic merge failed; fix conflicts and then commit the result.
g : red changes a line
...
+++++*+ [yellow^] initial has A and M
Merging:
230a60b white renames A->B, M->N
virtual facb2d21aa995029a6ca505714db9b13556cd662
found 1 common ancestor(s):
2263b8f initial has A and M
Auto-merging B
CONFLICT (content): Merge conflict in B
...
HEAD is now at 230a60b white renames A->B, M->N
...
Merging:
24dfb52 master updates A
virtual 35c90490509c5dc47c977594f3fe91d86119bbd4
found 1 common ancestor(s):
2263b8f initial has A and M
Removing M
...
HEAD is now at 24dfb52 master updates A
Updated tag 'anchor' (was 24dfb52)
! [blue] blue renames A->C, M->N
 ! [change] changed
  ! [change+rename] changed and renamed
   ! [master] master updates A
...
Merge made by recursive.
 A |    2 +-
 1 files changed, 1 insertions(+), 1 deletions(-)
HEAD is now at 35c9049 yellow removes M
...
HEAD is now at f2a1b75 changed and renamed
Skipped B (merged same as existing)
...
HEAD is now at 8f45b65 Merge branch 'change+rename' into change
rm 'B'
rm 'M'
[dir-in-way (root-commit) 895440f] Common commmit
 Author: A U Thor <author@example.com>
...
[dir-in-way a504944] Commit to merge, with dir in the way
 Author: A U Thor <author@example.com>
 2 files changed, 2 insertions(+), 0 deletions(-)
rm 'dir/file-in-the-way'
[dir-not-in-way 075ff72] Commit to merge, with dir removed
 Author: A U Thor <author@example.com>
 2 files changed, 1 insertions(+), 1 deletions(-)
 delete mode 100644 dir/file-in-the-way
rm 'dir/file-in-the-way'
rm 'sub/file'
[renamed-file-has-no-conflicts de26d18] Independent change
 Author: A U Thor <author@example.com>
 2 files changed, 1 insertions(+), 2 deletions(-)
 rename sub/file => dir (79%)
 delete mode 100644 dir/file-in-the-way
rm 'dir/file-in-the-way'
[renamed-file-has-conflicts 1a95512] Conflicting change
 Author: A U Thor <author@example.com>
 2 files changed, 1 insertions(+), 1 deletions(-)
...
HEAD is now at 1a95512 Conflicting change
Merging:
de26d18 Independent change
virtual dir-not-in-way
found 1 common ancestor(s):
895440f Common commmit
...
HEAD is now at 1b1786d Merge branch 'dir-not-in-way' into HEAD
...
HEAD is now at de26d18 Independent change
...
HEAD is now at a504944 Commit to merge, with dir in the way
Merging:
1a95512 Conflicting change
virtual dir-not-in-way
found 1 common ancestor(s):
895440f Common commmit
Removing dir to make room for subdirectory; may re-add later.
...
HEAD is now at 1a95512 Conflicting change
Merging:
a504944 Commit to merge, with dir in the way
...
rm 'n.stages'
rm 'sub/file'
[rename-dest (root-commit) 6ae6ff8] Common commmit
 Author: A U Thor <author@example.com>
 1 files changed, 1 insertions(+), 0 deletions(-)
 create mode 100644 one/file
[rename-dest 38a14bb] Renamed to destdir
 Author: A U Thor <author@example.com>
 1 files changed, 0 insertions(+), 0 deletions(-)
 rename one/file => destdir (100%)
rm 'one/file'
[source-conflict b48f3a4] Conflicts in the way
 Author: A U Thor <author@example.com>
...
HEAD is now at b48f3a4 Conflicts in the way
Merging:
38a14bb Renamed to destdir
virtual source-conflict
found 1 common ancestor(s):
6ae6ff8 Common commmit
...
HEAD is now at 38a14bb Renamed to destdir
rm 'destdir'
[rename-two (root-commit) 68b2c57] Common commmit
 Author: A U Thor <author@example.com>
 2 files changed, 2 insertions(+), 0 deletions(-)
 create mode 100644 one/file
 create mode 100644 two/file
rm 'one/file'
[rename-two f027349] Rename two/file -> one
 Author: A U Thor <author@example.com>
 2 files changed, 0 insertions(+), 1 deletions(-)
 rename two/file => one (100%)
 delete mode 100644 one/file
rm 'two/file'
[rename-one e817ad2] Rename one/file -> two
 Author: A U Thor <author@example.com>
 2 files changed, 0 insertions(+), 1 deletions(-)
...
expecting success: 
	...
	test "stuff" = $(cat two)
Merging:
e817ad2 Rename one/file -> two
virtual rename-two
found 1 common ancestor(s):
68b2c57 Common commmit
...
expecting success: 
	...
	test "other" = $(cat one) &&
	test "stuff" = $(cat two)
HEAD is now at e817ad2 Rename one/file -> two
Merging:
e817ad2 Rename one/file -> two
virtual rename-two
found 1 common ancestor(s):
...
HEAD is now at e817ad2 Rename one/file -> two
rm 'two'
[first-rename (root-commit) f6ecb24] Common commmit
 Author: A U Thor <author@example.com>
 1 files changed, 1 insertions(+), 0 deletions(-)
 create mode 100644 original
[first-rename 3134930] Put two/file in the way, rename to one
 Author: A U Thor <author@example.com>
 1 files changed, 0 insertions(+), 0 deletions(-)
 rename original => one (100%)
 create mode 100644 two/file
[second-rename a796341] Put one/file in the way, rename to two
 Author: A U Thor <author@example.com>
 1 files changed, 0 insertions(+), 0 deletions(-)
 create mode 100644 one/file
...
Merging:
3134930 Put two/file in the way, rename to one
virtual second-rename
found 1 common ancestor(s):
f6ecb24 Common commmit
...
HEAD is now at 3134930 Put two/file in the way, rename to one
rm 'one'
rm 'two/file'
[first-rename-redo (root-commit) 69cb9d0] Common commmit
 Author: A U Thor <author@example.com>
 1 files changed, 1 insertions(+), 0 deletions(-)
 create mode 100644 one/file
 create mode 100644 original
 create mode 100644 two/file
rm 'one/file'
[first-rename-redo 673b9ba] Rename to one
 Author: A U Thor <author@example.com>
 1 files changed, 0 insertions(+), 0 deletions(-)
 rename original => one (100%)
 delete mode 100644 one/file
rm 'two/file'
[second-rename-redo 1714b19] Rename to two
 Author: A U Thor <author@example.com>
 1 files changed, 0 insertions(+), 0 deletions(-)
 rename original => two (100%)
 delete mode 100644 two/file
...
Merging:
673b9ba Rename to one
virtual second-rename-redo
found 1 common ancestor(s):
69cb9d0 Common commmit
Removing one to make room for subdirectory; may re-add later.
Removing two/file

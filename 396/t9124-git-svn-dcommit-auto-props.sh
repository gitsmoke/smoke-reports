...
Committed revision 1.
	A	foo
r1 = fec68cca87848599f928a8bcd038464402e62be8 (refs/remotes/git-svn)
...
[master 1f248a1] files for enabled auto-props
...
Committed r2
	...
	A	bar
	A	exec1.sh
r2 = ac961106f8953dd5f30d6e5e5f1842cf6c4fb778 (refs/remotes/git-svn)
...
[master b846b8f] files for disabled auto-props
 Author: A U Thor <author@example.com>
 3 files changed, 3 insertions(+), 0 deletions(-)
...
Committed r3
	...
	A	world.txt
	A	zot
r3 = 219465876d63d80add6049b252fce7db6f65f6d2 (refs/remotes/git-svn)
No changes between current HEAD and refs/remotes/git-svn
Resetting to the latest refs/remotes/git-svn
...
Committed r4
	D	foo
	A	foo.sh
r4 = 6305bcf0c37b601f5f53965bf983847ffd0d0918 (refs/remotes/git-svn)
No changes between current HEAD and refs/remotes/git-svn
Resetting to the latest refs/remotes/git-svn
D    foo
A    foo.sh

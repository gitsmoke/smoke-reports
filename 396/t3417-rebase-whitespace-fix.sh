...
[master (root-commit) 35e92f3] Initial empty commit
 Author: A U Thor <author@example.com>
[master 0db9700] first
 Author: A U Thor <author@example.com>
 1 files changed, 4 insertions(+), 0 deletions(-)
 create mode 100644 file
[master 7281ab4] second
 Author: A U Thor <author@example.com>

...
[master (root-commit) f98b20a] initial
 Author: A U Thor <author@example.com>
 1 files changed, 1 insertions(+), 0 deletions(-)
 create mode 100644 init
[master 7a02056] File: dir/foo
 Author: A U Thor <author@example.com>
 1 files changed, 1 insertions(+), 0 deletions(-)
...
expecting success: 
	...
	git merge master
HEAD is now at 0f7c09a File: dir
[master 90e288c] first
 Author: A U Thor <author@example.com>
...
rm 'dir~B'
rm 'init'
[modify (root-commit) 4412bf6] initial
 Author: A U Thor <author@example.com>
 1 files changed, 8 insertions(+), 0 deletions(-)
 create mode 100644 letters
[modify d20e023] modified
 Author: A U Thor <author@example.com>
 1 files changed, 1 insertions(+), 0 deletions(-)
rm 'letters'
[delete 6b5673c] deleted
 Author: A U Thor <author@example.com>
...
expecting success: 
	...
	test -f letters/file &&
	test -f letters~HEAD
HEAD is now at 6b5673c deleted

...
[master (root-commit) cc1fa60] initial
...
Updating cc1fa60..15dc9aa
Fast-forward
 file |    1 +
 1 files changed, 1 insertions(+), 0 deletions(-)
[master 4f34055] third
 Author: A U Thor <author@example.com>
...
[master 57a492b] sixth.1
 Author: A U Thor <author@example.com>
 1 files changed, 1 insertions(+), 1 deletions(-)
[master b6314dc] sixth.2
 Author: A U Thor <author@example.com>
 1 files changed, 1 insertions(+), 0 deletions(-)
[master 893b30a] sixth.3
 Author: A U Thor <author@example.com>
 1 files changed, 1 insertions(+), 0 deletions(-)
...
893b30a184a92ea05b2827eb8498099bef7dc18e
[master 2b5001f] seventh
 Author: A U Thor <author@example.com>
 1 files changed, 1 insertions(+), 1 deletions(-)

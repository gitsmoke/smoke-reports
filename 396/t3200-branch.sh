...
[master (root-commit) 94965d8] Initial commit.
 Author: A U Thor <author@example.com>
 1 files changed, 1 insertions(+), 0 deletions(-)
 create mode 100644 A
[master 3e7109e] Second commit.
 Author: A U Thor <author@example.com>
 1 files changed, 1 insertions(+), 0 deletions(-)
...
expecting success: git branch -d d/e/f &&
	 test ! -f .git/refs/heads/d/e/f &&
	 test ! -f .git/logs/refs/heads/d/e/f
Deleted branch d/e/f (was 3e7109e).
...
expecting success: git branch l/m &&
        git branch -d l/m &&
        git branch l
Deleted branch l/m (was 3e7109e).
...
Deleted branch s/t (was 3e7109e).
...
Deleted branch my7 (was 3e7109e).
...
3e7109edc554b24b2f0f761fc586a3e4d0771799
...
expecting success: 
	...
	git branch -d my8
Deleted branch my8 (was 3e7109e).

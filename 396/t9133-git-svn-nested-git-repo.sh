...
Initialized empty Git repository in /Users/trast/git-smoke/t/trash directory.t9133-git-svn-nested-git-repo/g/.git/
	A	a
r1 = 95dc03c0687522b630e21157840a38edd63e30ba (refs/remotes/git-svn)
r2 = f0401c8e0e550185f71b9920de4fb186a1576159 (refs/remotes/git-svn)
...
expecting success: 
	...
	M	a
r3 = e8a1a7e7d5ae1d0899ee2aa11b6077f14dfd902f (refs/remotes/git-svn)
...
[master (root-commit) d4c82b4] add a inside an SVN repo
 Author: A U Thor <author@example.com>
 1 files changed, 2 insertions(+), 0 deletions(-)
 create mode 100644 a
commit d4c82b441f9ec6b7f6e611ed2d89d8f5beaaba5a
Author: A U Thor <author@example.com>
Date:   Tue Dec 28 04:04:10 2010 +0000
...
A         .git/objects/d4
A         .git/objects/d4/c82b441f9ec6b7f6e611ed2d89d8f5beaaba5a
...
Adding         .git/objects/d4
Adding         .git/objects/d4/c82b441f9ec6b7f6e611ed2d89d8f5beaaba5a
...
r4 = ba1c847ce400140ee545d1bcaf9edc772e4ed44e (refs/remotes/git-svn)
First, rewinding head to replay your work on top of it...
Fast-forwarded master to refs/remotes/git-svn.
...
[master 7e579d5] add a inside an SVN repo
 Author: A U Thor <author@example.com>
...
expecting success: 
	...
	M	a
r5 = a0c8f7e6bdc50af17a217926ade7bf89a3662e7b (refs/remotes/git-svn)
First, rewinding head to replay your work on top of it...
Fast-forwarded master to refs/remotes/git-svn.

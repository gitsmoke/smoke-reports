...
expecting success: 
	...
	git tag b &&
	git checkout master
[master (root-commit) 46c90cb] Initial
 Author: A U Thor <author@example.com>
 1 files changed, 1 insertions(+), 0 deletions(-)
 create mode 100644 file
[master b2b4d49] add line from a
 Author: A U Thor <author@example.com>
 1 files changed, 1 insertions(+), 1 deletions(-)
[side c5f4190] add line from b
 Author: A U Thor <author@example.com>
 1 files changed, 1 insertions(+), 1 deletions(-)
...
HEAD is now at 46c90cb Initial
Merge made by ours.
...
HEAD is now at b2b4d49 add line from a
Merging:
b2b4d49 add line from a
virtual side

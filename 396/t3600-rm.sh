...
[master (root-commit) b58db71] add normal files
...
[master 9486cbc] add files with tabs and newlines
 Author: A U Thor <author@example.com>
 0 files changed, 0 insertions(+), 0 deletions(-)
...
[master f7868aa] add file for rm test
 Author: A U Thor <author@example.com>
...
[master e56d33e] remove file from rm test
 Author: A U Thor <author@example.com>
...
[master ebc80d7] add file for rm --quiet test
 Author: A U Thor <author@example.com>
 1 files changed, 1 insertions(+), 0 deletions(-)
 create mode 100644 test-file
[master bc3938f] remove file from rm --quiet test
 Author: A U Thor <author@example.com>
 1 files changed, 0 insertions(+), 1 deletions(-)
 delete mode 100644 test-file
...
[master (root-commit) 2ae6e38] add a file
 Author: A U Thor <author@example.com>
 1 files changed, 1 insertions(+), 0 deletions(-)
...
HEAD is now at 1270f6d subdir test
rm 'frotz/nitfol'

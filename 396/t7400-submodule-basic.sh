...
expecting success: 
	...
	git branch initial
[master (root-commit) d424316] initial commit
...
[master (root-commit) fc54ba8] submodule commit 1
 Author: A U Thor <author@example.com>
...
[master (root-commit) 60bc6a0] Ignore everything
 Author: A U Thor <author@example.com>
 1 files changed, 1 insertions(+), 0 deletions(-)
...
rev1: fc54ba8a97bd186e28048821c744f996cc7ead38
...
-fc54ba8a97bd186e28048821c744f996cc7ead38 init
...
Submodule path 'init': checked out 'fc54ba8a97bd186e28048821c744f996cc7ead38'
ok 23 - update should work when path is an empty dir

expecting success: 
	git submodule status >list &&
	grep "^ $rev1" list
 fc54ba8a97bd186e28048821c744f996cc7ead38 init (rev-1)
...
expecting success: 
	...
	grep "^+$rev2" list
[detached HEAD 7207cb1] submodule commit 2
 Author: A U Thor <author@example.com>
 1 files changed, 1 insertions(+), 0 deletions(-)
 create mode 100644 b
+7207cb13ecf9785071ae1734696b54799255cbcd init (rev-1-1-g7207cb1)
...
+Subproject commit 7207cb13ecf9785071ae1734696b54799255cbcd
...
[detached HEAD 4579b61] change subproject
 Author: A U Thor <author@example.com>
 1 files changed, 1 insertions(+), 0 deletions(-)
 create mode 100644 s
[master 65c88a6] change init
 Author: A U Thor <author@example.com>
...
Submodule path 'init': checked out '4579b61a4eb46a3a9d6d5e1eb6515a7dc62aecb6'
ok 32 - update --init
expecting success: 

	git reset --hard &&
	test_must_fail git add init/a
HEAD is now at 5045c4c super commit 1
...
expecting success: 
	...
	test $commit = $(git ls-files --stage |
		sed -n "s/^160000 \([^ ]*\).*/\1/p")
HEAD is now at 5045c4c super commit 1
[second 2e748b5] commit subproject
 Author: A U Thor <author@example.com>
 1 files changed, 1 insertions(+), 1 deletions(-)
diff --git a/init b/init
index 4579b61..65843b1 160000
--- a/init
+++ b/init
@@ -1 +1 @@
-Subproject commit 4579b61a4eb46a3a9d6d5e1eb6515a7dc62aecb6
+Subproject commit 65843b179ee679acf70692128e1fcd769b61988a
...
HEAD is now at 2e748b5 commit subproject
...
[master (root-commit) ba81ba7] repo commit 1
 Author: A U Thor <author@example.com>
 1 files changed, 1 insertions(+), 0 deletions(-)

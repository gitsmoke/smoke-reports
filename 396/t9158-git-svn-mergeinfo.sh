...
expecting success: 
	...
	git svn fetch
r1 = 6206f1b227c11db16b1575227005cedd79d1e029 (refs/remotes/git-svn)
	A	foo
r2 = 118ab3320b152c98d9c97a89228ccd266f37af21 (refs/remotes/git-svn)
ok 2 - clone svn repo
expecting success: 
	touch bar &&
	git add bar &&
...
Committed r3
	A	bar
r3 = 63106a77864a2629e3d7342dd26aaf0c3219b643 (refs/remotes/git-svn)

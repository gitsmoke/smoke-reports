...
HEAD is now at ce7b47c dir to symlink
rm 'a/b'
[detached HEAD e508605] untracked symlink remains
 Author: A U Thor <author@example.com>
...
expecting success: 
	...
	git commit -m x &&
	git tag baseline
HEAD is now at 6cfe50b base
[detached HEAD 4971254] x
 Author: A U Thor <author@example.com>
 1 files changed, 1 insertions(+), 0 deletions(-)
...
HEAD is now at 6af3355 Merge branch 'master' into HEAD
Merging:
4971254 x
virtual master
...
HEAD is now at 75d392a Merge commit 'baseline^0' into HEAD
Merging:
ce7b47c dir to symlink
virtual baseline^0
found 1 common ancestor(s):
6cfe50b base
...
HEAD is now at eebd08d Merge branch 'master' into HEAD
Merging:
4971254 x
virtual master
found 1 common ancestor(s):
...
expecting success: 
	...
	git tag test2
HEAD is now at 4971254 x
[detached HEAD f5a3cde] dir a/b-2 to symlink
 Author: A U Thor <author@example.com>
...
expecting success: 
	...
	test -h a/b-2 &&
	test -f a/b/c/d
HEAD is now at f5a3cde dir a/b-2 to symlink
Trying really trivial in-index merge...
Nope.
Trying simple merge.
Simple merge failed, trying Automatic merge.
...
HEAD is now at 130fe3b Merge commit 'test2' into HEAD
Merging:
4971254 x
virtual test2
found 1 common ancestor(s):

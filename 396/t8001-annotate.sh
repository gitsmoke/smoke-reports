...
[master (root-commit) 2d9baa2] Initial.
 Author: A <A@test.git>
...
Merging:
5f9423c Branch2-1
virtual 01986fc5421230a0b5aae79241e631a9b72c0112
...
expecting success: echo "evil merge." >>file &&
     git commit -a --amend
[branch2 9464cfc] Merge branch 'branch1' into branch2

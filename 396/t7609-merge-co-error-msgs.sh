...
expecting success: 
	...
	echo other >four &&
	echo other >five
[master (root-commit) 2ba1ace] First
 Author: A U Thor <author@example.com>
 1 files changed, 1 insertions(+), 0 deletions(-)
 create mode 100644 one
[branch ef36e81] Second
 Author: A U Thor <author@example.com>
...
Updating 2ba1ace..ef36e81
Aborting
[master 18d4047] empty
 Author: A U Thor <author@example.com>
Aborting
HEAD is now at 2ba1ace First
...
[master (root-commit) 6768a77] init
 Author: A U Thor <author@example.com>
...
rm 'rep/foo'
rm 'rep2/foo'
[branch 9dec358] added test as a file
 Author: A U Thor <author@example.com>

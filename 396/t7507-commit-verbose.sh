...
[master (root-commit) bcd4862] subject
...
[master a8abf89] This is an example commit message that contains a diff.
 Author: A U Thor <author@example.com>
 1 files changed, 1 insertions(+), 1 deletions(-)
...
[master 608fca5] This is an example commit message that contains a diff.
 Author: A U Thor <author@example.com>
 1 files changed, 1 insertions(+), 1 deletions(-)
--- diff	2010-12-28 04:02:53.000000000 +0000
+++ actual	2010-12-28 04:02:53.000000000 +0000
@@ -1,9 +1,2 @@

...
[master (root-commit) 26cd456] added file1
 Author: A U Thor <author@example.com>
 2 files changed, 2 insertions(+), 0 deletions(-)
 create mode 100644 file1
 create mode 100644 subdir/file3
[branch1 fc78383] branch1 changes
 Author: A U Thor <author@example.com>
 3 files changed, 3 insertions(+), 2 deletions(-)
 create mode 100644 file2
[master 689c247] master updates
 Author: A U Thor <author@example.com>
 3 files changed, 3 insertions(+), 2 deletions(-)
 create mode 100644 file2
...
[test1 32db553] branch1 resolved with mergetool
 Author: A U Thor <author@example.com>
...
x")" &&
    ...
    git reset --hard
[test2 ec36072] branch1 resolved with mergetool - autocrlf
 Author: A U Thor <author@example.com>
HEAD is now at ec36072 branch1 resolved with mergetool - autocrlf
...
[test3 76be54a] branch1 resolved with mergetool - subdir
 Author: A U Thor <author@example.com>
...
HEAD is now at fc78383 branch1 changes
...
Normal merge conflict for 'subdir/file3':
  {local}: modified
  {remote}: modified
[test4 f11e62a] branch2 resolved by mergetool from subdir
 Author: A U Thor <author@example.com>

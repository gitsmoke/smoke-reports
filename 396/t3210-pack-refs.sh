...
[master (root-commit) e39d0b6] Initial commit.
...
expecting success: git branch g/h &&
     ...
     git pack-refs --all &&
     git branch -d g
Deleted branch g/h (was e39d0b6).
Deleted branch g (was e39d0b6).
...
expecting success: git branch k/l &&
     ...
     git branch -d k/lm &&
     git branch k
Deleted branch k/l (was e39d0b6).
Deleted branch k/l/m (was e39d0b6).
Deleted branch k/lm (was e39d0b6).
...
expecting success: git branch n/o &&
     ...
     git branch -d n/o/p &&
     git branch n
Deleted branch n/o (was e39d0b6).
Deleted branch n/op (was e39d0b6).
Deleted branch n/o/p (was e39d0b6).

...
expecting success: 
	...
	echo happy.
[master (root-commit) 0a65f3a] initial
...
HEAD is now at 0a65f3a initial
...
[master e20e111] Add .gitattributes
 Author: A U Thor <author@example.com>
...
[master fd92903] initial
 Author: A U Thor <author@example.com>
 1 files changed, 1 insertions(+), 0 deletions(-)
[master d2f2a78] second
 Author: A U Thor <author@example.com>
...
[master c96b632] alllf, allcrlf and mixed only
 Author: A U Thor <author@example.com>

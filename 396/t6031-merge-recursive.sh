...
[master (root-commit) 4eb7761] initial
...
[other 516d2a3] changesimplefile
 Author: A U Thor <author@example.com>
 1 files changed, 1 insertions(+), 0 deletions(-)
rm 'sub1'
[main 4d518ab] changefiletodir
 Author: A U Thor <author@example.com>

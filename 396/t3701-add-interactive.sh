...
[master (root-commit) 5e80a48] commit
...
Unstaged changes after reset:
M	file
[master 50bba1d] commit
 Author: A U Thor <author@example.com>
 1 files changed, 1 insertions(+), 1 deletions(-)
HEAD is now at 5e80a48 commit
...
[master ca97b10] clear local changes
 Author: A U Thor <author@example.com>
 1 files changed, 1 insertions(+), 0 deletions(-)
...
HEAD is now at ca97b10 clear local changes
[master 7c2817f] non-empty
 Author: A U Thor <author@example.com>
 1 files changed, 1 insertions(+), 0 deletions(-)
...
HEAD is now at 7c2817f non-empty
[master bc043e2] empty
 Author: A U Thor <author@example.com>

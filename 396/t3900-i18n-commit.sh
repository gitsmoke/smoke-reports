...
[ISO-2022-JP 38d36c2] $B$O$l$R$[$U(B
 Author: A U Thor <author@example.com>
 1 files changed, 1 insertions(+), 0 deletions(-)
...
[eucJP-fixup 0d410a6] ¤Ï¤ì¤Ò¤Û¤Õ
 Author: A U Thor <author@example.com>
 1 files changed, 1 insertions(+), 0 deletions(-)
[eucJP-fixup a67fb9b] intermediate commit
 Author: A U Thor <author@example.com>
 1 files changed, 1 insertions(+), 0 deletions(-)
 create mode 100644 G
[eucJP-fixup 58de3a9] fixup! ¤Ï¤ì¤Ò¤Û¤Õ
 Author: A U Thor <author@example.com>
 1 files changed, 1 insertions(+), 0 deletions(-)
Rebasing (2/3)[detached HEAD ba9e053] ¤Ï¤ì¤Ò¤Û¤Õ
 Author: A U Thor <author@example.com>
...
[ISO-2022-JP-squash 5b567a0] $B$O$l$R$[$U(B
 Author: A U Thor <author@example.com>
 1 files changed, 1 insertions(+), 0 deletions(-)
[ISO-2022-JP-squash 5a029cd] intermediate commit
 Author: A U Thor <author@example.com>
 1 files changed, 1 insertions(+), 0 deletions(-)
 create mode 100644 G
[ISO-2022-JP-squash 05512d0] squash! $B$O$l$R$[$U(B
 Author: A U Thor <author@example.com>
 1 files changed, 1 insertions(+), 0 deletions(-)
Rebasing (2/3)[detached HEAD 67a52c6] $B$O$l$R$[$U(B
 Author: A U Thor <author@example.com>
 1 files changed, 2 insertions(+), 0 deletions(-)
Rebasing (3/3)

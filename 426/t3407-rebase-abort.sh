...
[master d889f01] c
 Author: A U Thor <author@example.com>
 1 files changed, 1 insertions(+), 1 deletions(-)
[to-rebase 47f28cc] merge should fail on this
 Author: A U Thor <author@example.com>
 1 files changed, 1 insertions(+), 1 deletions(-)
[to-rebase 44ca832] merge should fail on this, too
 Author: A U Thor <author@example.com>
 1 files changed, 1 insertions(+), 1 deletions(-)
...
HEAD is now at 44ca832 merge should fail on this, too
...
Merging HEAD with merge should fail on this, too
Merging:
f3f7668 merge should fail on this
virtual merge should fail on this, too
found 1 common ancestor(s):
virtual f788de73cfc81f8d734fa7efc658cc63ca083f50
Auto-merging a
...
Merging:
d889f01 c
47f28cc merge should fail on this
found 1 common ancestor(s):
1568641 a
Auto-merging a
CONFLICT (content): Merge conflict in a
...
Merging:
d889f01 c
44ca832 merge should fail on this, too
found 1 common ancestor(s):
47f28cc merge should fail on this
Auto-merging a
CONFLICT (content): Merge conflict in a
...
Auto-merging a
CONFLICT (content): Merge conflict in a
[detached HEAD e5c4503] merge should fail on this
 Author: A U Thor <author@example.com>
 1 files changed, 1 insertions(+), 0 deletions(-)
Committed: 0001 merge should fail on this
Merging master with HEAD~0
Merging:
e5c4503 merge should fail on this
44ca832 merge should fail on this, too
found 1 common ancestor(s):
47f28cc merge should fail on this
Auto-merging a

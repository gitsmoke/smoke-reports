...
[master (root-commit) 01f98eb] Initial.
 Author: A <A@test.git>
...
Merging:
1e6b312 Branch2-1
virtual cb2fdddab674de5ffaa8f61d7ae40e74baf52170
...
expecting success: echo "evil merge." >>file &&
     git commit -a --amend
[branch2 20e9d48] Merge branch 'branch1' into branch2

...
[master (root-commit) 320c9af]  Add bar
 Author: A U Thor <author@example.com>
 0 files changed, 0 insertions(+), 0 deletions(-)
 create mode 100644 bar
[master 48ae3e7]  Add foo
 Author: A U Thor <author@example.com>
 0 files changed, 0 insertions(+), 0 deletions(-)
 create mode 100644 foo
[master (root-commit) 2b841d3] Add submodule sub
 Author: A U Thor <author@example.com>
...
HEAD is now at 48ae3e7  Add foo
...
HEAD is now at 275ae87 next change
...
[master 678c4fc] added .real to .gitignore
 Author: A U Thor <author@example.com>
 1 files changed, 1 insertions(+), 0 deletions(-)

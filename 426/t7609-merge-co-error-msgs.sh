...
expecting success: 
	...
	echo other >four &&
	echo other >five
[master (root-commit) 276e947] First
 Author: A U Thor <author@example.com>
 1 files changed, 1 insertions(+), 0 deletions(-)
 create mode 100644 one
[branch 870222f] Second
 Author: A U Thor <author@example.com>
...
expecting success: 
	...
	git reset --hard HEAD^
Updating 276e947..870222f
Aborting
[master 78a8482] empty
 Author: A U Thor <author@example.com>
Aborting
HEAD is now at 276e947 First
...
[master (root-commit) 2d849d6] init
 Author: A U Thor <author@example.com>
...
rm 'rep/foo'
rm 'rep2/foo'
[branch 1d6c429] added test as a file
 Author: A U Thor <author@example.com>

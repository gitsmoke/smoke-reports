...
r1 = a680ce9bcb7594f82b8a1d049e2ae5722cce73da (refs/remotes/git-svn)
...
[mybranch 9ef4395] try a deep --rmdir with a commit
 ...
 rename dir/a/b/c/d/e/file => file (100%)
	...
	D	dir/a/
	A	dir/file
r2 = f05258dd45889666b18ffebb16eadbef50cf4796 (refs/remotes/git-svn)
...
[mybranch 3401eb0] detect node change from file to directory #1
 Author: A U Thor <author@example.com>
...
[mybranch2 8177f84] detect node change from directory to file #1
 Author: A U Thor <author@example.com>
 1 files changed, 0 insertions(+), 0 deletions(-)
...
[mybranch3 cb6051a] detect node change from file to directory #2
 Author: A U Thor <author@example.com>
...
[mybranch4 2110cc4] detect node change from directory to file #2
 Author: A U Thor <author@example.com>
 2 files changed, 1 insertions(+), 1 deletions(-)
...
[mybranch5 89208a6] remove executable bit from a file
 Author: A U Thor <author@example.com>
 0 files changed, 0 insertions(+), 0 deletions(-)
 mode change 100755 => 100644 exec.sh
	M	exec.sh
	M	exec.sh
r3 = d6d627c6fe7a28f7bc15c64e5ff9cab63f1990ab (refs/remotes/git-svn)
Done committing 1 revisions to SVN
...
expecting success: 
	...
	svn_cmd up "$SVN_TREE" &&
	test -x "$SVN_TREE"/exec.sh
[mybranch5 1b2114e] add executable bit back file
 Author: A U Thor <author@example.com>
 0 files changed, 0 insertions(+), 0 deletions(-)
 mode change 100644 => 100755 exec.sh
	M	exec.sh
	M	exec.sh
r4 = bb8860fe73cbaebdfc05c69fd52093579b50e633 (refs/remotes/git-svn)
Done committing 1 revisions to SVN
UU   /Users/trast/git-smoke/t/trash directory.t9100-git-svn-basic/.git/svn/refs/remotes/git-svn/svn-tree/exec.sh
...
[mybranch5 cbd3285] executable file becomes a symlink to bar/zzz (file)
 Author: A U Thor <author@example.com>
 ...
 mode change 100755 => 120000
	T	exec.sh
	M	exec.sh
r5 = 482ca6577e2b127a6c935ad2e13a5487f4c0f8d7 (refs/remotes/git-svn)
Done committing 1 revisions to SVN
UU   /Users/trast/git-smoke/t/trash directory.t9100-git-svn-basic/.git/svn/refs/remotes/git-svn/svn-tree/exec.sh
...
[mybranch5 34eb02b] new symlink is added to a file that was also just made executable
 Author: A U Thor <author@example.com>
 ...
 create mode 120000 exec-2.sh
	...
	M	bar/zzz
	A	exec-2.sh
r6 = e3197c03b25c0372cf4f56253ff30e577f708801 (refs/remotes/git-svn)
Done committing 1 revisions to SVN
...
[mybranch5 4fb090d] modify a symlink to become a file
 Author: A U Thor <author@example.com>
 1 files changed, 1 insertions(+), 1 deletions(-)
 ...
 mode change 120000 => 100644
	T	exec-2.sh
	M	exec-2.sh
r7 = 4495e16a5defc180d349a8f9c2d099017d0d5ac0 (refs/remotes/git-svn)
Done committing 1 revisions to SVN
...
expecting success: git svn init "$svnrepo" && git svn fetch &&
	...
	A	exec.sh
	A	dir/a/b/c/d/e/file
r1 = a680ce9bcb7594f82b8a1d049e2ae5722cce73da (refs/remotes/alt)
	A	file
	D	dir/a/b/c/d/e/file
	D	dir/a/
	A	dir/file
r2 = faca5cb4b8f967227a32d25e502c8dce3c92714e (refs/remotes/alt)
	M	exec.sh
r3 = fe453658bfa015274bc01f0b6f5afa94b3634ad6 (refs/remotes/alt)
	M	exec.sh
r4 = 2a055303d3433a54335aa27d0d523829cb1e1d53 (refs/remotes/alt)
	M	exec.sh
r5 = 1c96f4ed9300c396d4772a8afd8dfa212796cb26 (refs/remotes/alt)
	M	bar/zzz
	A	exec-2.sh
r6 = 46351cfb8dc2e2b2aed7dbafbb7b4771f68b7d8f (refs/remotes/alt)
	M	exec-2.sh
r7 = d7b09faa633ee926732155f58a96ee0a57eba9c4 (refs/remotes/alt)
...
expecting success: 
	...
	A	zzz
r1 = e475286d55b2502c67f9eed2fdb6995027bff860 (refs/remotes/bar)
	M	zzz
r6 = d80848f7bad88b31dc10bd12b0808eb8ce389dea (refs/remotes/bar)
[my-bar 1d659d3] change 1
 Author: A U Thor <author@example.com>
 1 files changed, 1 insertions(+), 0 deletions(-)
 create mode 100644 foo
[my-bar a696829] change 2
 Author: A U Thor <author@example.com>
 1 files changed, 1 insertions(+), 1 deletions(-)
...
Committed r8
	A	foo
r8 = c4c6f9e0cbc669b3461b7a3e6156417c867c8e46 (refs/remotes/bar)
...
The rewritten commit is: c4c6f9e0cbc669b3461b7a3e6156417c867c8e46
    change 1
Deleted branch my-bar (was a696829).
...
expecting success: 
	...
	A	bar/foo
r8 = bc14e76188714e3ca19e0a082c2f7c5e26b75b52 (refs/remotes/alt)
[my-bar f64e712] /bar/d should be in the log
 Author: A U Thor <author@example.com>
 1 files changed, 1 insertions(+), 0 deletions(-)
...
Committed r9
	A	d
r9 = 5a03e646d034d5a6c151efda3a18c69a77f7389d (refs/remotes/bar)
No changes between current HEAD and refs/remotes/bar
Resetting to the latest refs/remotes/bar
[my-bar 75575da] add a new directory
 Author: A U Thor <author@example.com>
 1 files changed, 1 insertions(+), 0 deletions(-)
...
Committed r10
	A	newdir/dir
r10 = 966bb21f6b023777f8eece56e851ee817f13a8ca (refs/remotes/bar)
No changes between current HEAD and refs/remotes/bar
Resetting to the latest refs/remotes/bar
[my-bar 18612f6] modify a file in new directory
 Author: A U Thor <author@example.com>
 1 files changed, 1 insertions(+), 0 deletions(-)
Committing to file:///Users/trast/git-smoke/t/trash directory.t9100-git-svn-basic/svnrepo/bar ...
	M	newdir/dir
Committed r11
	M	newdir/dir
r11 = 0d872e794708e8942ef12afcd990ac43aa802915 (refs/remotes/bar)
No changes between current HEAD and refs/remotes/bar
Resetting to the latest refs/remotes/bar
...
[my-bar cf92455] commit-new-file-foo2
 Author: A U Thor <author@example.com>
 1 files changed, 1 insertions(+), 0 deletions(-)
...
Committed r12
	A	foo2
r12 = decb068d5be503565105b35debc23b93af930a47 (refs/remotes/bar)
No changes between current HEAD and refs/remotes/bar
Resetting to the latest refs/remotes/bar
...
[my-bar ac8948a] update /bar/d
 Author: A U Thor <author@example.com>
 1 files changed, 1 insertions(+), 1 deletions(-)
	M	d
	M	d
r13 = 593b1ad5951623b3cdb20169c65af7ccacb35bb9 (refs/remotes/bar)
Done committing 1 revisions to SVN
...
r8 = bc14e76188714e3ca19e0a082c2f7c5e26b75b52 (refs/remotes/alt)
	A	bar/d
r9 = 2cc1a5f6cf7a08ec78556f1cbfe74e688ade046d (refs/remotes/alt)
	A	bar/newdir/dir
r10 = 759e0d6951faca83b8ef9f3d29d9df79574ed7d3 (refs/remotes/alt)
	M	bar/newdir/dir
r11 = 71b11e58999e60c77ec074f86e3d8aa076825233 (refs/remotes/alt)
	A	bar/foo2
r12 = 11a71f58be8d7494cfe046fec1a3efc68966f821 (refs/remotes/alt)
	M	bar/d
r13 = a9ee4e90769631de6349c4fdbe7c48099d69e768 (refs/remotes/alt)

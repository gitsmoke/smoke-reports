...
[master (root-commit) c8f7ab0] initial
...
Updating c8f7ab0..a763422
Fast-forward
 file |    1 +
 1 files changed, 1 insertions(+), 0 deletions(-)
[master 9beab92] third
 Author: A U Thor <author@example.com>
...
[master 7d5818a] sixth.1
 Author: A U Thor <author@example.com>
 1 files changed, 1 insertions(+), 1 deletions(-)
[master d19034e] sixth.2
 Author: A U Thor <author@example.com>
 1 files changed, 1 insertions(+), 0 deletions(-)
[master 2f20495] sixth.3
 Author: A U Thor <author@example.com>
 1 files changed, 1 insertions(+), 0 deletions(-)
...
2f204955e9582cb7e31084e6165f0d8fab923673
[master cb54778] seventh
 Author: A U Thor <author@example.com>
 1 files changed, 1 insertions(+), 1 deletions(-)

...
HEAD is now at f0a3125 dir to symlink
rm 'a/b'
[detached HEAD fcf3140] untracked symlink remains
 Author: A U Thor <author@example.com>
...
HEAD is now at 36df188 base
[detached HEAD f7fd2a4] x
 Author: A U Thor <author@example.com>
 1 files changed, 1 insertions(+), 0 deletions(-)
...
HEAD is now at e706f75 Merge branch 'master' into HEAD
Merging:
f7fd2a4 x
virtual master
...
HEAD is now at 7e00b69 Merge commit 'baseline^0' into HEAD
Merging:
f0a3125 dir to symlink
virtual baseline^0
found 1 common ancestor(s):
36df188 base
...
HEAD is now at f7fd2a4 x
[detached HEAD c969993] dir a/b-2 to symlink
 Author: A U Thor <author@example.com>
...
HEAD is now at c969993 dir a/b-2 to symlink
Trying really trivial in-index merge...
Nope.
Trying simple merge.
Simple merge failed, trying Automatic merge.
...
expecting success: 
	...
	test -h a/b-2 &&
	test -f a/b/c/d
HEAD is now at 66d8941 Merge commit 'test2' into HEAD
Merging:
f7fd2a4 x
virtual test2
found 1 common ancestor(s):

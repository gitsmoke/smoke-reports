...
[master (root-commit) 0ff59e6] A-initial
...
[master (root-commit) 2d292f6] B-super-initial
 Author: A U Thor <author@example.com>
 1 files changed, 1 insertions(+), 0 deletions(-)
...
Cloning into sub
Submodule path 'sub': checked out '0ff59e6b5ea168fdab46027cb8f2805ad5dd3c8c'

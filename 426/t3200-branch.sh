...
[master (root-commit) 7e1869e] Initial commit.
 Author: A U Thor <author@example.com>
 1 files changed, 1 insertions(+), 0 deletions(-)
 create mode 100644 A
[master 40e4d26] Second commit.
 Author: A U Thor <author@example.com>
 1 files changed, 1 insertions(+), 0 deletions(-)
...
expecting success: git branch -d d/e/f &&
	 test ! -f .git/refs/heads/d/e/f &&
	 test ! -f .git/logs/refs/heads/d/e/f
Deleted branch d/e/f (was 40e4d26).
...
expecting success: git branch l/m &&
        git branch -d l/m &&
        git branch l
Deleted branch l/m (was 40e4d26).
...
Deleted branch s/t (was 40e4d26).
...
Deleted branch my7 (was 40e4d26).
...
40e4d26cf6db77b878028e3387d6e858245cd12b
...
expecting success: 
	...
	git branch -d my8
Deleted branch my8 (was 40e4d26).

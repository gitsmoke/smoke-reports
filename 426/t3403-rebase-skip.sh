...
[master (root-commit) 4fc24c1] hello
 Author: A U Thor <author@example.com>
 1 files changed, 1 insertions(+), 0 deletions(-)
 create mode 100644 hello
[master 048e88a] hello world
 Author: A U Thor <author@example.com>
 1 files changed, 1 insertions(+), 0 deletions(-)
[master 98baa72] goodbye
 Author: A U Thor <author@example.com>
 1 files changed, 1 insertions(+), 0 deletions(-)
[skip-reference 1d950f1] we should skip this
 Author: A U Thor <author@example.com>
 1 files changed, 1 insertions(+), 1 deletions(-)
[skip-reference b4b35e6] this should not be skipped
 Author: A U Thor <author@example.com>
 1 files changed, 1 insertions(+), 0 deletions(-)
...
HEAD is now at b4b35e6 this should not be skipped
First, rewinding head to replay your work on top of it...
Applying: we should skip this
Using index info to reconstruct a base tree...
Falling back to patching base and 3-way merge...
...
Applying: we should skip this
Applying: this should not be skipped
HEAD is now at 2ef4bab this should not be skipped
...
Merging:
98baa72 goodbye
b4b35e6 this should not be skipped
found 1 common ancestor(s):
1d950f1 we should skip this
[detached HEAD 6cdf3f2] this should not be skipped
 Author: A U Thor <author@example.com>
 1 files changed, 1 insertions(+), 0 deletions(-)
 create mode 100644 cow
...
Merging:
6cdf3f2 this should not be skipped
b4b35e6 this should not be skipped
found 1 common ancestor(s):
1d950f1 we should skip this

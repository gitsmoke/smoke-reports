...
Initialized empty Git repository in /Users/trast/git-smoke/t/trash directory.t9134-git-svn-ignore-paths/g/.git/
	A	qqq/test_qqq.txt
r1 = 5d6e85190f1b74ba050a948823a560f3c113de02 (refs/remotes/git-svn)
r2 = 9e1270f9bdc31fd1f7ff1827a6743821445b3803 (refs/remotes/git-svn)
...
" > expect &&
	...
	M	qqq/test_qqq.txt
r3 = c49e3a2e0099945b63359240411829fea14fbd77 (refs/remotes/git-svn)
...
r4 = 53193df965c91d522ab739c56e12598c6fe759c0 (refs/remotes/git-svn)
First, rewinding head to replay your work on top of it...
Fast-forwarded master to refs/remotes/git-svn.
...
" > expect &&
	...
	M	qqq/test_qqq.txt
r5 = 4e41ee6a71ab0134d31c1b618511f1e0d090ff67 (refs/remotes/git-svn)
First, rewinding head to replay your work on top of it...
Fast-forwarded master to refs/remotes/git-svn.

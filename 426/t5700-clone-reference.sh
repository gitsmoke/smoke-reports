...
[master (root-commit) b62f758] initial
...
Merging:
fd279d4 addition
virtual a768ea9996479449c74eea38c3f5442b42740b85
...
[master (root-commit) d8928f8] initial
 Author: A U Thor <author@example.com>
 1 files changed, 1 insertions(+), 0 deletions(-)
 create mode 100644 file1

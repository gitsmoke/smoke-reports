...
[master (root-commit) 32c2a56] Initial commit.
...
expecting success: git branch g/h &&
     ...
     git pack-refs --all &&
     git branch -d g
Deleted branch g/h (was 32c2a56).
Deleted branch g (was 32c2a56).
...
expecting success: git branch k/l &&
     ...
     git branch -d k/lm &&
     git branch k
Deleted branch k/l (was 32c2a56).
Deleted branch k/l/m (was 32c2a56).
Deleted branch k/lm (was 32c2a56).
...
expecting success: git branch n/o &&
     ...
     git branch -d n/o/p &&
     git branch n
Deleted branch n/o (was 32c2a56).
Deleted branch n/op (was 32c2a56).
Deleted branch n/o/p (was 32c2a56).

...
expecting success: git svn fetch
	...
	A	ne_crlf
	A	empty
r1 = 02c65e2c00a7fbb45e4f9f37d725965381f50d65 (refs/remotes/git-svn)
	M	kw.c
r2 = f86f4292dfa08376d7c7bacc5dd78977356773f1 (refs/remotes/git-svn)
	M	kw.c
r3 = 94628e9b7490262d976ca7a15608b1afc52bea0e (refs/remotes/git-svn)
	M	kw.c
r4 = 77237ee1d47e2822f0889c665207de490c42c44c (refs/remotes/git-svn)
...
[mybranch e4d7d53] test keywords ignoring
 Author: A U Thor <author@example.com>
 1 files changed, 1 insertions(+), 0 deletions(-)
	M	kw.c
	M	kw.c
r5 = 443fd15a0eb71540bdee79649c01fbd13cf4ce61 (refs/remotes/git-svn)
Done committing 1 revisions to SVN
Updating e4d7d53..443fd15
Fast-forward
...
expecting success: git svn fetch &&
	...
	M	ne_crlf
	M	empty
r6 = 11a0b415e838254c1a10538354060f895077cb0e (refs/remotes/git-svn)
Updating 443fd15..11a0b41
Fast-forward
 crlf    |    3 +--
 ne_crlf |    3 +--
...
expecting success: git svn fetch && git pull . ${remotes_git_svn}
	M	cr
	M	ne_cr
r7 = a9e8f42d5cdecfce2af25d6789a5237cd7d4c407 (refs/remotes/git-svn)
Updating 11a0b41..a9e8f42
Fast-forward
 cr    |    4 +++-
 ne_cr |    4 +++-
...
expecting success: 
	...
	A	deeply/nested/directory/.keep
r8 = e5574ffc80be0e2b8ce07bcec50de794ef291021 (refs/remotes/git-svn)
Updating a9e8f42..e5574ff
Fast-forward

...
[master (root-commit) f8b2691] Initial empty commit
 Author: A U Thor <author@example.com>
[master 6b2635e] first
 Author: A U Thor <author@example.com>
 1 files changed, 4 insertions(+), 0 deletions(-)
 create mode 100644 file
[master 849113d] second
 Author: A U Thor <author@example.com>

...
[master (root-commit) 5e1c4dd] added file1
 Author: A U Thor <author@example.com>
 2 files changed, 2 insertions(+), 0 deletions(-)
 create mode 100644 file1
 create mode 100644 subdir/file3
[branch1 ced3634] branch1 changes
 Author: A U Thor <author@example.com>
 3 files changed, 3 insertions(+), 2 deletions(-)
 create mode 100644 file2
[master 86ae165] master updates
 Author: A U Thor <author@example.com>
 3 files changed, 3 insertions(+), 2 deletions(-)
 create mode 100644 file2
...
[test1 fcd1d5d] branch1 resolved with mergetool
 Author: A U Thor <author@example.com>
...
x")" &&
    ...
    git reset --hard
[test2 62c5e02] branch1 resolved with mergetool - autocrlf
 Author: A U Thor <author@example.com>
HEAD is now at 62c5e02 branch1 resolved with mergetool - autocrlf
...
[test3 c75967d] branch1 resolved with mergetool - subdir
 Author: A U Thor <author@example.com>
...
HEAD is now at ced3634 branch1 changes
...
Normal merge conflict for 'subdir/file3':
  {local}: modified
  {remote}: modified
[test4 cf920af] branch2 resolved by mergetool from subdir
 Author: A U Thor <author@example.com>

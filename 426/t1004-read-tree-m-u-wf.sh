...
[master (root-commit) c154a27] initial
...
[master 2dde316] master removes file2 and subdir/file2
 Author: A U Thor <author@example.com>
...
D	file2
D	subdir/file2
[side d8b9ed7] side adds file3 and removes file2
 Author: A U Thor <author@example.com>
...
HEAD is now at 2dde316 master removes file2 and subdir/file2
...
expecting success: 
	...
	git checkout side-a
HEAD is now at 2dde316 master removes file2 and subdir/file2
[side-a 9b1b900] side-a changes file1
 Author: A U Thor <author@example.com>
 1 files changed, 1 insertions(+), 0 deletions(-)
[side-b fd2d53e] side-b changes file2
 Author: A U Thor <author@example.com>
 1 files changed, 1 insertions(+), 0 deletions(-)
...
HEAD is now at 9b1b900 side-a changes file1
...
HEAD is now at 9b1b900 side-a changes file1
[sym-b 77289e4] side adds a/b
 Author: A U Thor <author@example.com>
 0 files changed, 0 insertions(+), 0 deletions(-)
 create mode 100644 a/b
[sym-a e448a59] we add a/b
 Author: A U Thor <author@example.com>
 1 files changed, 1 insertions(+), 0 deletions(-)
...
HEAD is now at e448a59 we add a/b
...
HEAD is now at e448a59 we add a/b
[side-a dd48202] side-a changes file2 to directory
 Author: A U Thor <author@example.com>
...
HEAD is now at fd2d53e side-b changes file2
Trying simple merge.
...
Merging:
fd2d53e side-b changes file2
dd48202 side-a changes file2 to directory

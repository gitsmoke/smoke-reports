...
[master (root-commit) 400085a] add normal files
...
[master 43a550a] add files with tabs and newlines
 Author: A U Thor <author@example.com>
 0 files changed, 0 insertions(+), 0 deletions(-)
...
[master 325557f] add file for rm test
 Author: A U Thor <author@example.com>
...
[master 452fae3] remove file from rm test
 Author: A U Thor <author@example.com>
...
[master e65d4c9] add file for rm --quiet test
 Author: A U Thor <author@example.com>
 1 files changed, 1 insertions(+), 0 deletions(-)
 create mode 100644 test-file
[master 322ecbf] remove file from rm --quiet test
 Author: A U Thor <author@example.com>
 1 files changed, 0 insertions(+), 1 deletions(-)
 delete mode 100644 test-file
...
[master (root-commit) b389a4a] add a file
 Author: A U Thor <author@example.com>
 1 files changed, 1 insertions(+), 0 deletions(-)
...
HEAD is now at 68f7934 subdir test
rm 'frotz/nitfol'

...
r1 = 49e3ab91a0541cedbab885d14869825cccdf59d2 (refs/remotes/git-svn)
...
[test-rmdir dc0f67c] remove another
 ...
 delete mode 100644 deeply/nested/directory/number/2/another
	...
	D	deeply/nested/directory/number/2/another
	D	deeply/nested/directory/number/2/
r2 = 3cc977c6f91cd7f30eec201d2538de3fff42aa2d (refs/remotes/git-svn)

...
expecting success: 
	...
	git branch initial
[master (root-commit) 6a30633] initial commit
...
[master (root-commit) 23fedb8] submodule commit 1
 Author: A U Thor <author@example.com>
...
[master (root-commit) 4273953] Ignore everything
 Author: A U Thor <author@example.com>
 1 files changed, 1 insertions(+), 0 deletions(-)
...
" "$rev1" &&
	test -n "$rev1"
rev1: 23fedb8448f070698991a17055871a7a36351f73

ok 18 - setup - fetch commit name from submodule
expecting success: 
	git submodule status >lines &&
	grep "^-$rev1" lines
-23fedb8448f070698991a17055871a7a36351f73 init
...
Submodule path 'init': checked out '23fedb8448f070698991a17055871a7a36351f73'
...
expecting success: 
	...
	grep "^ $rev1" list
 23fedb8448f070698991a17055871a7a36351f73 init (rev-1)
...
expecting success: 
	...
	grep "^+$rev2" list
[detached HEAD f8aeb10] submodule commit 2
 Author: A U Thor <author@example.com>
 1 files changed, 1 insertions(+), 0 deletions(-)
 create mode 100644 b
+f8aeb10561e0da08716969232762f1689157e152 init (rev-1-1-gf8aeb10)
...
+Subproject commit f8aeb10561e0da08716969232762f1689157e152
...
[detached HEAD cca4c1f] change subproject
 Author: A U Thor <author@example.com>
 1 files changed, 1 insertions(+), 0 deletions(-)
 create mode 100644 s
[master c752045] change init
 Author: A U Thor <author@example.com>
...
Submodule path 'init': checked out 'cca4c1f3579b8e286a0330fe4b64b293c11c16e6'
ok 32 - update --init
...
HEAD is now at 2179263 super commit 1
...
expecting success: 
	...
	test $commit = $(git ls-files --stage |
		sed -n "s/^160000 \([^ ]*\).*/\1/p")
HEAD is now at 2179263 super commit 1
[second 9a33692] commit subproject
 Author: A U Thor <author@example.com>
 1 files changed, 1 insertions(+), 1 deletions(-)
diff --git a/init b/init
index cca4c1f..f74d799 160000
--- a/init
+++ b/init
@@ -1 +1 @@
-Subproject commit cca4c1f3579b8e286a0330fe4b64b293c11c16e6
+Subproject commit f74d799847027e86de70f7838c3c405679307387
...
expecting success: 
	...
	test ! -d init &&
	git checkout second
HEAD is now at 9a33692 commit subproject
...
[master (root-commit) 58e68bc] repo commit 1
 Author: A U Thor <author@example.com>
 1 files changed, 1 insertions(+), 0 deletions(-)

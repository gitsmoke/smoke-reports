...
[ISO-2022-JP da78dc1] $B$O$l$R$[$U(B
 Author: A U Thor <author@example.com>
 1 files changed, 1 insertions(+), 0 deletions(-)
...
[eucJP-fixup a83d424] ¤Ï¤ì¤Ò¤Û¤Õ
 Author: A U Thor <author@example.com>
 1 files changed, 1 insertions(+), 0 deletions(-)
[eucJP-fixup e314566] intermediate commit
 Author: A U Thor <author@example.com>
 1 files changed, 1 insertions(+), 0 deletions(-)
 create mode 100644 G
[eucJP-fixup 15e919d] fixup! ¤Ï¤ì¤Ò¤Û¤Õ
 Author: A U Thor <author@example.com>
 1 files changed, 1 insertions(+), 0 deletions(-)
Rebasing (2/3)[detached HEAD e4c65b2] ¤Ï¤ì¤Ò¤Û¤Õ
 Author: A U Thor <author@example.com>
...
[ISO-2022-JP-squash fd4851d] $B$O$l$R$[$U(B
 Author: A U Thor <author@example.com>
 1 files changed, 1 insertions(+), 0 deletions(-)
[ISO-2022-JP-squash 2818a31] intermediate commit
 Author: A U Thor <author@example.com>
 1 files changed, 1 insertions(+), 0 deletions(-)
 create mode 100644 G
[ISO-2022-JP-squash e734946] squash! $B$O$l$R$[$U(B
 Author: A U Thor <author@example.com>
 1 files changed, 1 insertions(+), 0 deletions(-)
Rebasing (2/3)[detached HEAD 5532971] $B$O$l$R$[$U(B
 Author: A U Thor <author@example.com>
 1 files changed, 2 insertions(+), 0 deletions(-)
Rebasing (3/3)

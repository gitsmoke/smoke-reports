...
[master (root-commit) 785b7a2] commit
...
Unstaged changes after reset:
M	file
[master 205fb39] commit
 Author: A U Thor <author@example.com>
 1 files changed, 1 insertions(+), 1 deletions(-)
HEAD is now at 785b7a2 commit
...
expecting success: 
	...
	test_cmp expected diff
[master e4da831] clear local changes
 Author: A U Thor <author@example.com>
 1 files changed, 1 insertions(+), 0 deletions(-)
...
HEAD is now at e4da831 clear local changes
[master 5d302d1] non-empty
 Author: A U Thor <author@example.com>
 1 files changed, 1 insertions(+), 0 deletions(-)
...
HEAD is now at 5d302d1 non-empty
[master ca6314d] empty
 Author: A U Thor <author@example.com>

...
[master (root-commit) 299ac0e] original
...
[master 1481414] updated
 Author: A U Thor <author@example.com>
 1 files changed, 1 insertions(+), 1 deletions(-)
Your branch is behind 'master' by 1 commit, and can be fast-forwarded.
Updating 299ac0e..1481414
Fast-forward
 file |    2 +-
 1 files changed, 1 insertions(+), 1 deletions(-)
...
[second d080f9b] modified
 Author: A U Thor <author@example.com>
 1 files changed, 1 insertions(+), 1 deletions(-)
HEAD is now at 299ac0e original
Updating 299ac0e..d080f9b
Fast-forward
 file |    2 +-
 1 files changed, 1 insertions(+), 1 deletions(-)
...
HEAD is now at cbb58e9 new file
First, rewinding head to replay your work on top of it...
Applying: new file
...
HEAD is now at d080f9b modified
[copy 432c8bd] conflict
 Author: A U Thor <author@example.com>
 1 files changed, 1 insertions(+), 1 deletions(-)
[to-rebase 6846950] to-rebase
 Author: A U Thor <author@example.com>
 1 files changed, 1 insertions(+), 1 deletions(-)
First, rewinding head to replay your work on top of it...
Applying: new file
...
HEAD is now at 6846950 to-rebase
First, rewinding head to replay your work on top of it...
Applying: new file
Applying: to-rebase
...
[master (root-commit) 978f9df] Initial revision
 Author: A U Thor <author@example.com>
...
[master 8512a9f] 5->43
 Author: A U Thor <author@example.com>
 1 files changed, 1 insertions(+), 1 deletions(-)
[master 8924f60] Make it bigger
 Author: A U Thor <author@example.com>
 1 files changed, 1 insertions(+), 1 deletions(-)
[master dbfb860] Independent discovery of 5->43
 Author: A U Thor <author@example.com>
 1 files changed, 1 insertions(+), 1 deletions(-)
...
HEAD is now at 8924f60 Make it bigger
Cloning into bare repository src-replace.git
done.
[master 9e07f74] Change 2
 Author: A U Thor <author@example.com>
 1 files changed, 2 insertions(+), 2 deletions(-)
[master 4ce0d96] Change 3
 Author: A U Thor <author@example.com>
 1 files changed, 2 insertions(+), 2 deletions(-)
[master a755c9a] Change 4
 Author: A U Thor <author@example.com>
 1 files changed, 3 insertions(+), 3 deletions(-)
[master 103c0e4] Modified Change 4
 Author: A U Thor <author@example.com>
 1 files changed, 3 insertions(+), 3 deletions(-)

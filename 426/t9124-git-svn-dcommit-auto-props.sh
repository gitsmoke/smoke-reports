...
Committed revision 1.
	A	foo
r1 = c980cd01e1648f04801e50823c1fda5b26e217af (refs/remotes/git-svn)
...
[master 6201cad] files for enabled auto-props
...
Committed r2
	...
	A	bar
	A	exec1.sh
r2 = 7f1585e7233c22fd31fde8bc153dcf05b455a29d (refs/remotes/git-svn)
...
[master 341b6c7] files for disabled auto-props
 Author: A U Thor <author@example.com>
 3 files changed, 3 insertions(+), 0 deletions(-)
...
Committed r3
	...
	A	world.txt
	A	zot
r3 = e0527e02131721f1dcb03681a8603859738e9ec7 (refs/remotes/git-svn)
No changes between current HEAD and refs/remotes/git-svn
Resetting to the latest refs/remotes/git-svn
...
Committed r4
	D	foo
	A	foo.sh
r4 = 0609313f0ef2c0cbf5d99c89196c845f265f89f6 (refs/remotes/git-svn)
No changes between current HEAD and refs/remotes/git-svn
Resetting to the latest refs/remotes/git-svn
D    foo
A    foo.sh

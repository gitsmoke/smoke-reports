...
git checkout master
[master (root-commit) 80bcad4] initial has A and M
 Author: A U Thor <author@example.com>
 2 files changed, 30 insertions(+), 0 deletions(-)
 create mode 100644 A
 create mode 100644 M
[master edc6614] master updates A
 Author: A U Thor <author@example.com>
 1 files changed, 1 insertions(+), 1 deletions(-)
[yellow d5d4535] yellow removes M
 Author: A U Thor <author@example.com>
 1 files changed, 0 insertions(+), 15 deletions(-)
 delete mode 100644 M
[white 13f1358] white renames A->B, M->N
 Author: A U Thor <author@example.com>
 2 files changed, 2 insertions(+), 2 deletions(-)
 rename A => B (93%)
 rename M => N (93%)
[red 8916960] red renames A->B, M->N
 Author: A U Thor <author@example.com>
 2 files changed, 2 insertions(+), 2 deletions(-)
 rename A => B (93%)
 rename M => N (93%)
[blue a70dc31] blue renames A->C, M->N
 Author: A U Thor <author@example.com>
 2 files changed, 2 insertions(+), 2 deletions(-)
 rename A => C (93%)
 rename M => N (93%)
...
Merging:
edc6614 master updates A
virtual 13f1358b2292fbe7597963f9d1630bb06115b02f
found 1 common ancestor(s):
80bcad4 initial has A and M
Auto-merging B
...
HEAD is now at edc6614 master updates A
Merging:
8916960 red renames A->B, M->N
virtual 13f1358b2292fbe7597963f9d1630bb06115b02f
found 1 common ancestor(s):
80bcad4 initial has A and M
Auto-merging B
...
expecting success: 
	...
	git diff --exit-code white N
HEAD is now at 8916960 red renames A->B, M->N
! [blue] blue renames A->C, M->N
 ! [change] changed
  ! [change+rename] changed and renamed
   ! [master] master updates A
...
Merging:
8916960 red renames A->B, M->N
virtual edc66145727a51176f53e9d57ec10b88d31b4c8b
found 1 common ancestor(s):
80bcad4 initial has A and M
Auto-merging B
CONFLICT (content): Merge conflict in B
...
Merging:
8916960 red renames A->B, M->N
virtual a70dc3106c84f9886ccab6876a4cd2137ee3193c
found 1 common ancestor(s):
80bcad4 initial has A and M
Skipped N (merged same as existing)
CONFLICT (rename/rename): Rename "A"->"B" in branch "HEAD" rename "A"->"C" in "a70dc3106c84f9886ccab6876a4cd2137ee3193c"
Automatic merge failed; fix conflicts and then commit the result.
g : red changes a line
...
+++++*+ [yellow^] initial has A and M
Merging:
13f1358 white renames A->B, M->N
virtual 8916960177c96a972b215a7c03f048d893042a71
found 1 common ancestor(s):
80bcad4 initial has A and M
Auto-merging B
CONFLICT (content): Merge conflict in B
...
HEAD is now at 13f1358 white renames A->B, M->N
...
Merging:
edc6614 master updates A
virtual d5d45357aa6eb655a10ac58bd59e8e57effec08f
found 1 common ancestor(s):
80bcad4 initial has A and M
Removing M
...
expecting success: 
	...
	git reset --hard anchor
HEAD is now at edc6614 master updates A
Updated tag 'anchor' (was edc6614)
! [blue] blue renames A->C, M->N
 ! [change] changed
  ! [change+rename] changed and renamed
   ! [master] master updates A
...
Merge made by recursive.
 A |    2 +-
 1 files changed, 1 insertions(+), 1 deletions(-)
HEAD is now at d5d4535 yellow removes M
...
HEAD is now at a002cd8 changed and renamed
Skipped B (merged same as existing)
...
HEAD is now at b3980f5 Merge branch 'change+rename' into change
rm 'B'
rm 'M'
[dir-in-way (root-commit) 3885b2c] Common commmit
 Author: A U Thor <author@example.com>
...
[dir-in-way 50cfeb8] Commit to merge, with dir in the way
 Author: A U Thor <author@example.com>
 2 files changed, 2 insertions(+), 0 deletions(-)
rm 'dir/file-in-the-way'
[dir-not-in-way 5c5c166] Commit to merge, with dir removed
 Author: A U Thor <author@example.com>
 2 files changed, 1 insertions(+), 1 deletions(-)
 delete mode 100644 dir/file-in-the-way
rm 'dir/file-in-the-way'
rm 'sub/file'
[renamed-file-has-no-conflicts 48c70c7] Independent change
 Author: A U Thor <author@example.com>
 2 files changed, 1 insertions(+), 2 deletions(-)
 rename sub/file => dir (79%)
 delete mode 100644 dir/file-in-the-way
rm 'dir/file-in-the-way'
[renamed-file-has-conflicts 015931f] Conflicting change
 Author: A U Thor <author@example.com>
 2 files changed, 1 insertions(+), 1 deletions(-)
...
HEAD is now at 015931f Conflicting change
Merging:
48c70c7 Independent change
virtual dir-not-in-way
found 1 common ancestor(s):
3885b2c Common commmit
...
HEAD is now at 887c23b Merge branch 'dir-not-in-way' into HEAD
...
HEAD is now at 48c70c7 Independent change
...
HEAD is now at 50cfeb8 Commit to merge, with dir in the way
Merging:
015931f Conflicting change
virtual dir-not-in-way
found 1 common ancestor(s):
3885b2c Common commmit
Removing dir to make room for subdirectory; may re-add later.
...
HEAD is now at 015931f Conflicting change
Merging:
50cfeb8 Commit to merge, with dir in the way
...
rm 'n.stages'
rm 'sub/file'
[rename-dest (root-commit) 48dffe9] Common commmit
 Author: A U Thor <author@example.com>
 1 files changed, 1 insertions(+), 0 deletions(-)
 create mode 100644 one/file
[rename-dest e63b2d1] Renamed to destdir
 Author: A U Thor <author@example.com>
 1 files changed, 0 insertions(+), 0 deletions(-)
 rename one/file => destdir (100%)
rm 'one/file'
[source-conflict 475ec54] Conflicts in the way
 Author: A U Thor <author@example.com>
...
HEAD is now at 475ec54 Conflicts in the way
Merging:
e63b2d1 Renamed to destdir
virtual source-conflict
found 1 common ancestor(s):
48dffe9 Common commmit
...
HEAD is now at e63b2d1 Renamed to destdir
rm 'destdir'
[rename-two (root-commit) 2f73db9] Common commmit
 Author: A U Thor <author@example.com>
 2 files changed, 2 insertions(+), 0 deletions(-)
 create mode 100644 one/file
 create mode 100644 two/file
rm 'one/file'
[rename-two 437ebd4] Rename two/file -> one
 Author: A U Thor <author@example.com>
 2 files changed, 0 insertions(+), 1 deletions(-)
 rename two/file => one (100%)
 delete mode 100644 one/file
rm 'two/file'
[rename-one f52e085] Rename one/file -> two
 Author: A U Thor <author@example.com>
 2 files changed, 0 insertions(+), 1 deletions(-)
...
expecting success: 
	...
	test "stuff" = $(cat two)
Merging:
f52e085 Rename one/file -> two
virtual rename-two
found 1 common ancestor(s):
2f73db9 Common commmit
...
HEAD is now at f52e085 Rename one/file -> two
Merging:
f52e085 Rename one/file -> two
virtual rename-two
found 1 common ancestor(s):
...
HEAD is now at f52e085 Rename one/file -> two
rm 'two'
[first-rename (root-commit) 2653cbf] Common commmit
 Author: A U Thor <author@example.com>
 1 files changed, 1 insertions(+), 0 deletions(-)
 create mode 100644 original
[first-rename b944bb8] Put two/file in the way, rename to one
 Author: A U Thor <author@example.com>
 1 files changed, 0 insertions(+), 0 deletions(-)
 rename original => one (100%)
 create mode 100644 two/file
[second-rename 2a828bc] Put one/file in the way, rename to two
 Author: A U Thor <author@example.com>
 1 files changed, 0 insertions(+), 0 deletions(-)
 create mode 100644 one/file
...
expecting success: 
	...
	! test -f original
Merging:
b944bb8 Put two/file in the way, rename to one
virtual second-rename
found 1 common ancestor(s):
2653cbf Common commmit
...
HEAD is now at b944bb8 Put two/file in the way, rename to one
rm 'one'
rm 'two/file'
[first-rename-redo (root-commit) 8299db2] Common commmit
 Author: A U Thor <author@example.com>
 1 files changed, 1 insertions(+), 0 deletions(-)
 create mode 100644 one/file
 create mode 100644 original
 create mode 100644 two/file
rm 'one/file'
[first-rename-redo 627d648] Rename to one
 Author: A U Thor <author@example.com>
 1 files changed, 0 insertions(+), 0 deletions(-)
 rename original => one (100%)
 delete mode 100644 one/file
rm 'two/file'
[second-rename-redo 9b0bbae] Rename to two
 Author: A U Thor <author@example.com>
 1 files changed, 0 insertions(+), 0 deletions(-)
 rename original => two (100%)
 delete mode 100644 two/file
...
expecting success: 
	...
	! test -f original
Merging:
627d648 Rename to one
virtual second-rename-redo
found 1 common ancestor(s):
8299db2 Common commmit
Removing one to make room for subdirectory; may re-add later.
Removing two/file

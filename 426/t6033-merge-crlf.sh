...
expecting success: 
	...
	git tag b &&
	git checkout master
[master (root-commit) 63ca4c9] Initial
 Author: A U Thor <author@example.com>
 1 files changed, 1 insertions(+), 0 deletions(-)
 create mode 100644 file
[master 5bd96fe] add line from a
 Author: A U Thor <author@example.com>
 1 files changed, 1 insertions(+), 1 deletions(-)
[side e13cdce] add line from b
 Author: A U Thor <author@example.com>
 1 files changed, 1 insertions(+), 1 deletions(-)
...
HEAD is now at 63ca4c9 Initial
Merge made by ours.
...
expecting success: 
	...
	cat file | remove_cr | append_cr >file.temp &&
	test_cmp file file.temp
HEAD is now at 5bd96fe add line from a
Merging:
5bd96fe add line from a
virtual side

...
expecting success: 
	...
	git tag initial
[master (root-commit) 519cfe1] initial
...
HEAD is now at 519cfe1 initial
[master dcb2d83] add=5
 Author: A U Thor <author@example.com>
...
Deleted branch test5 (was ef7e91b).
HEAD is now at 519cfe1 initial
[master dcb2d83] add=5
 Author: A U Thor <author@example.com>
 5 files changed, 110 insertions(+), 0 deletions(-)
...
Deleted branch test5 (was cd5b4a2).
HEAD is now at 519cfe1 initial
[master 4ab3508] add=5
 Author: A U Thor <author@example.com>
 5 files changed, 110 insertions(+), 0 deletions(-)
 create mode 100644 1
 create mode 100644 2
...
[simple-change ccfd3fe] unrelated-change
 Author: A U Thor <author@example.com>
 0 files changed, 0 insertions(+), 0 deletions(-)

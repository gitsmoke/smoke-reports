...
[master (root-commit) f64a85e] initial
...
Merging:
c525a6c addition
virtual 6df87c907323fb0b075b7b6eac55f321144e9d8e
...
[master (root-commit) 82302dc] initial
 Author: A U Thor <author@example.com>
 1 files changed, 1 insertions(+), 0 deletions(-)
 create mode 100644 file1

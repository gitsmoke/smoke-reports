...
[master (root-commit) 7bb7c07] A-initial
...
[master (root-commit) 3115252] B-super-initial
 Author: A U Thor <author@example.com>
 1 files changed, 1 insertions(+), 0 deletions(-)
...
Cloning into sub...
Submodule path 'sub': checked out '7bb7c0725da284a9ad413803012597109626b9c1'

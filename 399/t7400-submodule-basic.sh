...
expecting success: 
	...
	git branch initial
[master (root-commit) ee898a5] initial commit
...
[master (root-commit) f345fb4] submodule commit 1
 Author: A U Thor <author@example.com>
...
[master (root-commit) c3a1339] Ignore everything
 Author: A U Thor <author@example.com>
 1 files changed, 1 insertions(+), 0 deletions(-)
...
rev1: f345fb41d9ce7e3ccedf8935f721d145bd0e1c24
...
expecting success: 
	git submodule status >lines &&
	grep "^-$rev1" lines
-f345fb41d9ce7e3ccedf8935f721d145bd0e1c24 init
...
Submodule path 'init': checked out 'f345fb41d9ce7e3ccedf8935f721d145bd0e1c24'
...
expecting success: 
 ...
 f345fb41d9ce7e3ccedf8935f721d145bd0e1c24 init (rev-1)
...
expecting success: 
	...
	grep "^+$rev2" list
[detached HEAD 7a8ac43] submodule commit 2
 Author: A U Thor <author@example.com>
 1 files changed, 1 insertions(+), 0 deletions(-)
 create mode 100644 b
+7a8ac433ff9eabf2f8da4a51fcfa0cfdc1092292 init (rev-1-1-g7a8ac43)
...
+Subproject commit 7a8ac433ff9eabf2f8da4a51fcfa0cfdc1092292
...
[detached HEAD c71c9f6] change subproject
 Author: A U Thor <author@example.com>
 1 files changed, 1 insertions(+), 0 deletions(-)
 create mode 100644 s
[master 48a38fe] change init
 Author: A U Thor <author@example.com>
...
Submodule path 'init': checked out 'c71c9f6917ee8076aae34282346421a18ae46940'
...
HEAD is now at ddbd09c super commit 1
...
expecting success: 
	...
	test $commit = $(git ls-files --stage |
		sed -n "s/^160000 \([^ ]*\).*/\1/p")
HEAD is now at ddbd09c super commit 1
[second bf85456] commit subproject
 Author: A U Thor <author@example.com>
 1 files changed, 1 insertions(+), 1 deletions(-)
diff --git a/init b/init
index c71c9f6..56a12aa 160000
--- a/init
+++ b/init
@@ -1 +1 @@
-Subproject commit c71c9f6917ee8076aae34282346421a18ae46940
+Subproject commit 56a12aa4c028f6869d4c1ededab2f8647ae36ba4
...
HEAD is now at bf85456 commit subproject
...
[master (root-commit) 8e30448] repo commit 1
 Author: A U Thor <author@example.com>
 1 files changed, 1 insertions(+), 0 deletions(-)

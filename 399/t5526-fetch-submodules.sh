...
[master (root-commit) 1c8cd7e] new
...
[master (root-commit) e9ef405] new
 Author: A U Thor <author@example.com>
...
[master (root-commit) 4702ff4] initial
 Author: A U Thor <author@example.com>
...
Submodule path 'submodule': checked out 'e9ef405e286a8b869b741cfd4189bab40ace08dd'
...
Submodule path 'deepsubmodule': checked out '1c8cd7ef918ca12872d20cad5d32b43825ed6b81'

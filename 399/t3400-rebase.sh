...
expecting success: 
	...
	git tag topic
[master (root-commit) 6cae809] Add A.
 Author: author@name <bogus@email@address>
 1 files changed, 1 insertions(+), 0 deletions(-)
 create mode 100644 A
[force-3way 6b890f1] Add Y.
 Author: author@name <bogus@email@address>
 1 files changed, 1 insertions(+), 0 deletions(-)
 create mode 100644 Y
[filemove 9b643b6] Move A.
 Author: author@name <bogus@email@address>
 2 files changed, 1 insertions(+), 0 deletions(-)
 rename A => D/A (100%)
 create mode 100644 Y
[my-topic-branch dc016c6] Add B.
 Author: author@name <bogus@email@address>
 1 files changed, 1 insertions(+), 0 deletions(-)
 create mode 100644 B
[master 37bd2bc] Modify A.
 Author: author@name <bogus@email@address>
 1 files changed, 1 insertions(+), 0 deletions(-)
[side f3368f6] Add C
 Author: author@name <bogus@email@address>
...
Merge made by recursive.
 ...
 create mode 100644 C
Merging:
b8fe084 Merge branch 'side' into nonlinear
virtual master
found 1 common ancestor(s):
6cae809 Add A.
Merge made by recursive.
...
[master 07419bd] prepare
 Author: author@name <bogus@email@address>
 1 files changed, 1 insertions(+), 0 deletions(-)
 create mode 100644 X
[modechange 7e635b7] modechange
 Author: author@name <bogus@email@address>
 1 files changed, 1 insertions(+), 0 deletions(-)
...
[quiet a430efb] A file with a line with CR
 Author: author@name <bogus@email@address>
...
[detached HEAD de29844] n1
 Author: author@name <bogus@email@address>
 1 files changed, 1 insertions(+), 0 deletions(-)
 create mode 100644 n1.t
[detached HEAD 180b1f6] n2
 Author: author@name <bogus@email@address>
 1 files changed, 1 insertions(+), 0 deletions(-)
 create mode 100644 n2.t
[detached HEAD 9c769e0] n3
 Author: author@name <bogus@email@address>
 1 files changed, 1 insertions(+), 0 deletions(-)

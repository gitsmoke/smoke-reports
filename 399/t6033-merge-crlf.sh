...
expecting success: 
	...
	git tag b &&
	git checkout master
[master (root-commit) 4b6282c] Initial
 Author: A U Thor <author@example.com>
 1 files changed, 1 insertions(+), 0 deletions(-)
 create mode 100644 file
[master ea985ac] add line from a
 Author: A U Thor <author@example.com>
 1 files changed, 1 insertions(+), 1 deletions(-)
[side a863623] add line from b
 Author: A U Thor <author@example.com>
 1 files changed, 1 insertions(+), 1 deletions(-)
ok 1 - setup
...
HEAD is now at 4b6282c Initial
Merge made by ours.
...
HEAD is now at ea985ac add line from a
Merging:
ea985ac add line from a
virtual side

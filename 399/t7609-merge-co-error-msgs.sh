...
expecting success: 
	...
	echo other >four &&
	echo other >five
[master (root-commit) 3b814c3] First
 Author: A U Thor <author@example.com>
 1 files changed, 1 insertions(+), 0 deletions(-)
 create mode 100644 one
[branch cf557e8] Second
 Author: A U Thor <author@example.com>
...
expecting success: 
	...
	git reset --hard HEAD^
Updating 3b814c3..cf557e8
Aborting
[master 066931f] empty
 Author: A U Thor <author@example.com>
Aborting
HEAD is now at 3b814c3 First
...
[master (root-commit) f692882] init
 Author: A U Thor <author@example.com>
...
rm 'rep/foo'
rm 'rep2/foo'
[branch 6bca3f1] added test as a file
 Author: A U Thor <author@example.com>

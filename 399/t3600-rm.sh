...
[master (root-commit) aa5b13a] add normal files
...
[master f64cfa5] add files with tabs and newlines
 Author: A U Thor <author@example.com>
 0 files changed, 0 insertions(+), 0 deletions(-)
...
[master 89e6a17] add file for rm test
 Author: A U Thor <author@example.com>
...
[master b6c3284] remove file from rm test
 Author: A U Thor <author@example.com>
...
[master f73138c] add file for rm --quiet test
 Author: A U Thor <author@example.com>
 1 files changed, 1 insertions(+), 0 deletions(-)
 create mode 100644 test-file
[master f5041df] remove file from rm --quiet test
 Author: A U Thor <author@example.com>
 1 files changed, 0 insertions(+), 1 deletions(-)
 delete mode 100644 test-file
...
[master (root-commit) e7c23f9] add a file
 Author: A U Thor <author@example.com>
 1 files changed, 1 insertions(+), 0 deletions(-)
...
HEAD is now at 6a0a2a2 subdir test
rm 'frotz/nitfol'

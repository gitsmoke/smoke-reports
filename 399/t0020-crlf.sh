...
expecting success: 
	...
	echo happy.
[master (root-commit) c4e748a] initial
...
expecting success: 
	...
	git reset --hard HEAD^
HEAD is now at c4e748a initial
...
[master 6753e7c] Add .gitattributes
 Author: A U Thor <author@example.com>
...
[master 5a8fbe1] initial
 Author: A U Thor <author@example.com>
 1 files changed, 1 insertions(+), 0 deletions(-)
[master 3b33793] second
 Author: A U Thor <author@example.com>
...
[master 9f0b3b8] alllf, allcrlf and mixed only
 Author: A U Thor <author@example.com>

...
HEAD is now at 3f4e4de dir to symlink
rm 'a/b'
[detached HEAD 1b8a6f6] untracked symlink remains
 Author: A U Thor <author@example.com>
...
HEAD is now at a9809fc base
[detached HEAD 1d876d5] x
 Author: A U Thor <author@example.com>
 1 files changed, 1 insertions(+), 0 deletions(-)
...
HEAD is now at 94311d2 Merge branch 'master' into HEAD
Merging:
1d876d5 x
virtual master
...
HEAD is now at ddb207a Merge commit 'baseline^0' into HEAD
Merging:
3f4e4de dir to symlink
virtual baseline^0
found 1 common ancestor(s):
a9809fc base
...
HEAD is now at 1d876d5 x
[detached HEAD c948c02] dir a/b-2 to symlink
 Author: A U Thor <author@example.com>
...
HEAD is now at c948c02 dir a/b-2 to symlink
Trying really trivial in-index merge...
Nope.
Trying simple merge.
Simple merge failed, trying Automatic merge.
...
HEAD is now at 8495053 Merge commit 'test2' into HEAD
Merging:
1d876d5 x
virtual test2
found 1 common ancestor(s):

...
[master (root-commit) f97e081] added file1
 Author: A U Thor <author@example.com>
 2 files changed, 2 insertions(+), 0 deletions(-)
 create mode 100644 file1
 create mode 100644 subdir/file3
[branch1 146faee] branch1 changes
 Author: A U Thor <author@example.com>
 3 files changed, 3 insertions(+), 2 deletions(-)
 create mode 100644 file2
[master c17d4d9] master updates
 Author: A U Thor <author@example.com>
 3 files changed, 3 insertions(+), 2 deletions(-)
 create mode 100644 file2
...
[test1 ea53322] branch1 resolved with mergetool
 Author: A U Thor <author@example.com>
...
x")" &&
    ...
    git reset --hard
[test2 1a46913] branch1 resolved with mergetool - autocrlf
 Author: A U Thor <author@example.com>
HEAD is now at 1a46913 branch1 resolved with mergetool - autocrlf
...
[test3 1f148fa] branch1 resolved with mergetool - subdir
 Author: A U Thor <author@example.com>
...
HEAD is now at 146faee branch1 changes
...
Normal merge conflict for 'subdir/file3':
  {local}: modified
  {remote}: modified
[test4 51a91b2] branch2 resolved by mergetool from subdir
 Author: A U Thor <author@example.com>

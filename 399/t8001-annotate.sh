...
[master (root-commit) 7e28db3] Initial.
 Author: A <A@test.git>
...
Merging:
5629771 Branch2-1
virtual 0f9e2cdd9900cbb85778cc6d4b699b741730ebbc
...
expecting success: echo "evil merge." >>file &&
     git commit -a --amend
[branch2 b9cf5f1] Merge branch 'branch1' into branch2

...
[master (root-commit) 09457d7] Initial.
 Author: A <A@test.git>
...
Merging:
15abcfb Branch2-1
virtual 837d0dd448bdbe04c8e713b048511cd9638b807c
...
expecting success: echo "evil merge." >>file &&
     git commit -a --amend
[branch2 e71a72c] Merge branch 'branch1' into branch2

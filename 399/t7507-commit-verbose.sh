...
[master (root-commit) 28256d4] subject
...
expecting success: 
	...
	check_message diff
[master 4a830c7] This is an example commit message that contains a diff.
 Author: A U Thor <author@example.com>
 1 files changed, 1 insertions(+), 1 deletions(-)
...
checking known breakage: 
	...
	check_message diff
[master 7aebc7e] This is an example commit message that contains a diff.
 Author: A U Thor <author@example.com>
 1 files changed, 1 insertions(+), 1 deletions(-)
--- diff	2010-12-29 04:02:49.000000000 +0000
+++ actual	2010-12-29 04:02:49.000000000 +0000
@@ -1,9 +1,2 @@

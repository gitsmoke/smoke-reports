...
Committed revision 1.
	A	foo
r1 = af60932c046fc9a83cff9864568e62ca23c5e221 (refs/remotes/git-svn)
...
[master d8b9430] files for enabled auto-props
...
Committed r2
	...
	A	bar
	A	exec1.sh
r2 = 654c5f04d98efa39580f8874ea252907d035a5e4 (refs/remotes/git-svn)
...
[master 44f39da] files for disabled auto-props
 Author: A U Thor <author@example.com>
 3 files changed, 3 insertions(+), 0 deletions(-)
...
Committed r3
	...
	A	world.txt
	A	zot
r3 = 986b4193f3aea955d624daf41c1197f696f460bf (refs/remotes/git-svn)
No changes between current HEAD and refs/remotes/git-svn
Resetting to the latest refs/remotes/git-svn
...
Committed r4
	D	foo
	A	foo.sh
r4 = 6c06876250cb531f52730ba579f54b6f60895440 (refs/remotes/git-svn)
No changes between current HEAD and refs/remotes/git-svn
Resetting to the latest refs/remotes/git-svn
D    foo
A    foo.sh

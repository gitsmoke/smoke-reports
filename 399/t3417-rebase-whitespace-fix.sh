...
[master (root-commit) 790fd7c] Initial empty commit
 Author: A U Thor <author@example.com>
[master 4c46880] first
 Author: A U Thor <author@example.com>
 1 files changed, 4 insertions(+), 0 deletions(-)
 create mode 100644 file
[master 0b0017a] second
 Author: A U Thor <author@example.com>

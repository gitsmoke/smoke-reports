...
[master (root-commit) 7ee4e6f] one
...
[master (root-commit) 7ee4e6f] one
 ...
 1 files changed, 1 insertions(+), 0 deletions(-)
 create mode 100644 foo
Deleted branch remove (was 7ee4e6f).
...
Initialized empty Git repository in /Users/trast/git-smoke/t/trash directory.t5517-push-mirror/mirror/.git/
Initialized empty Git repository in /Users/trast/git-smoke/t/trash directory.t5517-push-mirror/master/.git/
[master (root-commit) 9ff2075] one
 Author: A U Thor <author@example.com>
 1 files changed, 1 insertions(+), 0 deletions(-)
 create mode 100644 foo
Deleted branch remove (was 9ff2075).
[master da27dfd] two
 Author: A U Thor <author@example.com>
 1 files changed, 1 insertions(+), 1 deletions(-)
...
[master da27dfd] two
 Author: A U Thor <author@example.com>
 1 files changed, 1 insertions(+), 1 deletions(-)
Updated tag 'tmaster' (was 9ff2075)
...
Initialized empty Git repository in /Users/trast/git-smoke/t/trash directory.t5517-push-mirror/mirror/.git/
Initialized empty Git repository in /Users/trast/git-smoke/t/trash directory.t5517-push-mirror/master/.git/
[master (root-commit) 4b903fb] one
 Author: A U Thor <author@example.com>
 1 files changed, 1 insertions(+), 0 deletions(-)
 create mode 100644 foo
Updated tag 'tmaster' (was 0000000)
[master a9ed9ec] two
 Author: A U Thor <author@example.com>
 1 files changed, 1 insertions(+), 1 deletions(-)
Updated tag 'tmaster' (was 4b903fb)
HEAD is now at 4b903fb one
Updated tag 'tmaster' (was a9ed9ec)
...
Deleted tag 'tremove' (was 4b903fb)
...
Deleted branch remove (was 4b903fb).
4b903fb118cde7eff94cf26405bc69bfecfd4de5
...
[master (root-commit) 4b903fb] one
 ...
 1 files changed, 1 insertions(+), 0 deletions(-)
 create mode 100644 foo
Deleted branch keep (was 4b903fb).
4b903fb118cde7eff94cf26405bc69bfecfd4de5

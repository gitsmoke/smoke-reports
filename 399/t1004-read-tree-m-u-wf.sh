...
[master (root-commit) 3460bf7] initial
...
[master f9e116f] master removes file2 and subdir/file2
 Author: A U Thor <author@example.com>
...
D	file2
D	subdir/file2
[side b94584e] side adds file3 and removes file2
 Author: A U Thor <author@example.com>
...
HEAD is now at f9e116f master removes file2 and subdir/file2
...
expecting success: 
	...
	git checkout side-a
HEAD is now at f9e116f master removes file2 and subdir/file2
[side-a 48921ae] side-a changes file1
 Author: A U Thor <author@example.com>
 1 files changed, 1 insertions(+), 0 deletions(-)
[side-b 7a5ddb2] side-b changes file2
 Author: A U Thor <author@example.com>
 1 files changed, 1 insertions(+), 0 deletions(-)
...
HEAD is now at 48921ae side-a changes file1
...
HEAD is now at 48921ae side-a changes file1
[sym-b 2974b93] side adds a/b
 Author: A U Thor <author@example.com>
 0 files changed, 0 insertions(+), 0 deletions(-)
 create mode 100644 a/b
[sym-a 97d53e6] we add a/b
 Author: A U Thor <author@example.com>
 1 files changed, 1 insertions(+), 0 deletions(-)
...
HEAD is now at 97d53e6 we add a/b
...
HEAD is now at 97d53e6 we add a/b
[side-a 1bddfe3] side-a changes file2 to directory
 Author: A U Thor <author@example.com>
...
HEAD is now at 7a5ddb2 side-b changes file2
Trying simple merge.
...
Merging:
7a5ddb2 side-b changes file2
1bddfe3 side-a changes file2 to directory

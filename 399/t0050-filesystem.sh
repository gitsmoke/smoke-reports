...
[master (root-commit) d5a718e] initial
 Author: A U Thor <author@example.com>
 0 files changed, 0 insertions(+), 0 deletions(-)
 create mode 100644 camelcase
[topic 78e6465] rename
 Author: A U Thor <author@example.com>
...
checking known breakage: 
	...
	git merge topic
HEAD is now at d5a718e initial
Updating d5a718e..78e6465
Fast-forward
...
[master (root-commit) 07fdfd5] initial
 Author: A U Thor <author@example.com>
 0 files changed, 0 insertions(+), 0 deletions(-)
 create mode 100644 "a\314\210"
[topic 3dd120d] rename
 Author: A U Thor <author@example.com>
 1 files changed, 0 insertions(+), 0 deletions(-)
...
checking known breakage: 
 ...
 git reset --hard initial &&
 git merge topic
HEAD is now at 07fdfd5 initial
Updating 07fdfd5..3dd120d
Aborting

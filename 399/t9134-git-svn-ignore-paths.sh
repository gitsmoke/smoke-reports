...
Initialized empty Git repository in /Users/trast/git-smoke/t/trash directory.t9134-git-svn-ignore-paths/g/.git/
	A	qqq/test_qqq.txt
r1 = 77979dd39c81e77a98ea11ffb1f09fa8a4fa615f (refs/remotes/git-svn)
r2 = 63d3b6c3d8745ee1de8d344cf174062185fdb872 (refs/remotes/git-svn)
...
" > expect &&
	...
	M	qqq/test_qqq.txt
r3 = 6809b20a4e5a08a3687117560671837e13244ecb (refs/remotes/git-svn)
...
r4 = b3b390d4b4bb96cc1c75ab94ffaa7fa8316d88fb (refs/remotes/git-svn)
First, rewinding head to replay your work on top of it...
Fast-forwarded master to refs/remotes/git-svn.
...
" > expect &&
	...
	M	qqq/test_qqq.txt
r5 = 8408907e0d07af68b0670287c893e5e30adef14c (refs/remotes/git-svn)
First, rewinding head to replay your work on top of it...
Fast-forwarded master to refs/remotes/git-svn.

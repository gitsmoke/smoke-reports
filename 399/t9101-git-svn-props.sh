...
expecting success: git svn fetch
	...
	A	ne_crlf
	A	empty
r1 = ded63704cb4ca97bce9ca6224f94091689159c58 (refs/remotes/git-svn)
	M	kw.c
r2 = c804732f2d53569d504c2142f5ac9eabf2f5a307 (refs/remotes/git-svn)
	M	kw.c
r3 = 5f844047b31bed6debb166dcc4681563e1f4337e (refs/remotes/git-svn)
	M	kw.c
r4 = 6d912bcbe7e248a9f5c4538de8a9b2a704e6b285 (refs/remotes/git-svn)
...
[mybranch 49ef9ae] test keywords ignoring
 Author: A U Thor <author@example.com>
 1 files changed, 1 insertions(+), 0 deletions(-)
	M	kw.c
	M	kw.c
r5 = 1de3fe0600ba71e6d0497941d2fc517e63c7bee4 (refs/remotes/git-svn)
Done committing 1 revisions to SVN
Updating 49ef9ae..1de3fe0
Fast-forward
...
expecting success: git svn fetch &&
	...
	M	ne_crlf
	M	empty
r6 = 0fc58cb2919d7a24751dff5bdda8b7ad41047c25 (refs/remotes/git-svn)
Updating 1de3fe0..0fc58cb
Fast-forward
 crlf    |    3 +--
 ne_crlf |    3 +--
...
expecting success: git svn fetch && git pull . ${remotes_git_svn}
	M	cr
	M	ne_cr
r7 = 1108f0929582be7b67087a2da863c1f01885c49e (refs/remotes/git-svn)
Updating 0fc58cb..1108f09
Fast-forward
 cr    |    4 +++-
 ne_cr |    4 +++-
...
expecting success: 
	...
	A	deeply/nested/directory/.keep
r8 = 67af76e555a194a8bb065f30cff08111dca56869 (refs/remotes/git-svn)
Updating 1108f09..67af76e
Fast-forward

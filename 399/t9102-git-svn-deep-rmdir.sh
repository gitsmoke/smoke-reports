...
r1 = 77b3eea9dd681ef13ef85d280a52164fa15a58d3 (refs/remotes/git-svn)
...
[test-rmdir 7fa9238] remove another
 ...
 delete mode 100644 deeply/nested/directory/number/2/another
	...
	D	deeply/nested/directory/number/2/another
	D	deeply/nested/directory/number/2/
r2 = a621fb329e0f4922882bed94d69de56c7965f2a1 (refs/remotes/git-svn)

...
git checkout master
[master (root-commit) 7d172ed] initial has A and M
 Author: A U Thor <author@example.com>
 2 files changed, 30 insertions(+), 0 deletions(-)
 create mode 100644 A
 create mode 100644 M
[master ccd2ca9] master updates A
 Author: A U Thor <author@example.com>
 1 files changed, 1 insertions(+), 1 deletions(-)
[yellow 2373f11] yellow removes M
 Author: A U Thor <author@example.com>
 1 files changed, 0 insertions(+), 15 deletions(-)
 delete mode 100644 M
[white 175520a] white renames A->B, M->N
 Author: A U Thor <author@example.com>
 2 files changed, 2 insertions(+), 2 deletions(-)
 rename A => B (93%)
 rename M => N (93%)
[red a72a38d] red renames A->B, M->N
 Author: A U Thor <author@example.com>
 2 files changed, 2 insertions(+), 2 deletions(-)
 rename A => B (93%)
 rename M => N (93%)
[blue 7ab2bdf] blue renames A->C, M->N
 Author: A U Thor <author@example.com>
 2 files changed, 2 insertions(+), 2 deletions(-)
 rename A => C (93%)
 rename M => N (93%)
...
Merging:
ccd2ca9 master updates A
virtual 175520a40ab701b8134655e00395c58c6de32d0b
found 1 common ancestor(s):
7d172ed initial has A and M
Auto-merging B
...
expecting success: 
	...
	git diff --exit-code white N
HEAD is now at ccd2ca9 master updates A
Merging:
a72a38d red renames A->B, M->N
virtual 175520a40ab701b8134655e00395c58c6de32d0b
found 1 common ancestor(s):
7d172ed initial has A and M
Auto-merging B
...
expecting success: 
	...
	git diff --exit-code white N
HEAD is now at a72a38d red renames A->B, M->N
! [blue] blue renames A->C, M->N
 ! [change] changed
  ! [change+rename] changed and renamed
   ! [master] master updates A
...
Merging:
a72a38d red renames A->B, M->N
virtual ccd2ca9a986f63434a56e568e64d75c975a22b05
found 1 common ancestor(s):
7d172ed initial has A and M
Auto-merging B
CONFLICT (content): Merge conflict in B
...
Merging:
a72a38d red renames A->B, M->N
virtual 7ab2bdfda4666429cbc1aef45c1a96a180a692ab
found 1 common ancestor(s):
7d172ed initial has A and M
Skipped N (merged same as existing)
CONFLICT (rename/rename): Rename "A"->"B" in branch "HEAD" rename "A"->"C" in "7ab2bdfda4666429cbc1aef45c1a96a180a692ab"
Automatic merge failed; fix conflicts and then commit the result.
g : red changes a line
...
+++++*+ [yellow^] initial has A and M
Merging:
175520a white renames A->B, M->N
virtual a72a38debad9306d4e5cab2a4407783af161cad1
found 1 common ancestor(s):
7d172ed initial has A and M
Auto-merging B
CONFLICT (content): Merge conflict in B
...
HEAD is now at 175520a white renames A->B, M->N
...
Merging:
ccd2ca9 master updates A
virtual 2373f1143405001cb0f9288688f4a2ad775cbeda
found 1 common ancestor(s):
7d172ed initial has A and M
Removing M
...
expecting success: 
	...
	git reset --hard anchor
HEAD is now at ccd2ca9 master updates A
Updated tag 'anchor' (was ccd2ca9)
! [blue] blue renames A->C, M->N
 ! [change] changed
  ! [change+rename] changed and renamed
   ! [master] master updates A
...
Merge made by recursive.
 A |    2 +-
 1 files changed, 1 insertions(+), 1 deletions(-)
HEAD is now at 2373f11 yellow removes M
...
HEAD is now at f5610fe changed and renamed
Skipped B (merged same as existing)
...
HEAD is now at 0c8ad6e Merge branch 'change+rename' into change
rm 'B'
rm 'M'
[dir-in-way (root-commit) b21efd3] Common commmit
 Author: A U Thor <author@example.com>
...
[dir-in-way 5989875] Commit to merge, with dir in the way
 Author: A U Thor <author@example.com>
 2 files changed, 2 insertions(+), 0 deletions(-)
rm 'dir/file-in-the-way'
[dir-not-in-way 1dd1928] Commit to merge, with dir removed
 Author: A U Thor <author@example.com>
 2 files changed, 1 insertions(+), 1 deletions(-)
 delete mode 100644 dir/file-in-the-way
rm 'dir/file-in-the-way'
rm 'sub/file'
[renamed-file-has-no-conflicts 5395f71] Independent change
 Author: A U Thor <author@example.com>
 2 files changed, 1 insertions(+), 2 deletions(-)
 rename sub/file => dir (79%)
 delete mode 100644 dir/file-in-the-way
rm 'dir/file-in-the-way'
[renamed-file-has-conflicts 39b12d8] Conflicting change
 Author: A U Thor <author@example.com>
 2 files changed, 1 insertions(+), 1 deletions(-)
...
HEAD is now at 39b12d8 Conflicting change
Merging:
5395f71 Independent change
virtual dir-not-in-way
found 1 common ancestor(s):
b21efd3 Common commmit
...
HEAD is now at d5a4e37 Merge branch 'dir-not-in-way' into HEAD
...
HEAD is now at 5395f71 Independent change
...
HEAD is now at 5989875 Commit to merge, with dir in the way
Merging:
39b12d8 Conflicting change
virtual dir-not-in-way
found 1 common ancestor(s):
b21efd3 Common commmit
Removing dir to make room for subdirectory; may re-add later.
...
HEAD is now at 39b12d8 Conflicting change
Merging:
5989875 Commit to merge, with dir in the way
...
rm 'n.stages'
rm 'sub/file'
[rename-dest (root-commit) 1e4c1c3] Common commmit
 Author: A U Thor <author@example.com>
 1 files changed, 1 insertions(+), 0 deletions(-)
 create mode 100644 one/file
[rename-dest 7eb4586] Renamed to destdir
 Author: A U Thor <author@example.com>
 1 files changed, 0 insertions(+), 0 deletions(-)
 rename one/file => destdir (100%)
rm 'one/file'
[source-conflict 5957687] Conflicts in the way
 Author: A U Thor <author@example.com>
...
HEAD is now at 5957687 Conflicts in the way
Merging:
7eb4586 Renamed to destdir
virtual source-conflict
found 1 common ancestor(s):
1e4c1c3 Common commmit
...
HEAD is now at 7eb4586 Renamed to destdir
rm 'destdir'
[rename-two (root-commit) cfe9470] Common commmit
 Author: A U Thor <author@example.com>
 2 files changed, 2 insertions(+), 0 deletions(-)
 create mode 100644 one/file
 create mode 100644 two/file
rm 'one/file'
[rename-two 80b7ae3] Rename two/file -> one
 Author: A U Thor <author@example.com>
 2 files changed, 0 insertions(+), 1 deletions(-)
 rename two/file => one (100%)
 delete mode 100644 one/file
rm 'two/file'
[rename-one ebca1ba] Rename one/file -> two
 Author: A U Thor <author@example.com>
 2 files changed, 0 insertions(+), 1 deletions(-)
...
expecting success: 
	...
	test "stuff" = $(cat two)
Merging:
ebca1ba Rename one/file -> two
virtual rename-two
found 1 common ancestor(s):
cfe9470 Common commmit
...
HEAD is now at ebca1ba Rename one/file -> two
Merging:
ebca1ba Rename one/file -> two
virtual rename-two
found 1 common ancestor(s):
...
HEAD is now at ebca1ba Rename one/file -> two
rm 'two'
[first-rename (root-commit) 95b41f0] Common commmit
 Author: A U Thor <author@example.com>
 1 files changed, 1 insertions(+), 0 deletions(-)
 create mode 100644 original
[first-rename 55ad482] Put two/file in the way, rename to one
 Author: A U Thor <author@example.com>
 1 files changed, 0 insertions(+), 0 deletions(-)
 rename original => one (100%)
 create mode 100644 two/file
[second-rename 4220263] Put one/file in the way, rename to two
 Author: A U Thor <author@example.com>
 1 files changed, 0 insertions(+), 0 deletions(-)
 create mode 100644 one/file
...
expecting success: 
	...
	! test -f original
Merging:
55ad482 Put two/file in the way, rename to one
virtual second-rename
found 1 common ancestor(s):
95b41f0 Common commmit
...
HEAD is now at 55ad482 Put two/file in the way, rename to one
rm 'one'
rm 'two/file'
[first-rename-redo (root-commit) ffe25bf] Common commmit
 Author: A U Thor <author@example.com>
 1 files changed, 1 insertions(+), 0 deletions(-)
 create mode 100644 one/file
 create mode 100644 original
 create mode 100644 two/file
rm 'one/file'
[first-rename-redo 080a169] Rename to one
 Author: A U Thor <author@example.com>
 1 files changed, 0 insertions(+), 0 deletions(-)
 rename original => one (100%)
 delete mode 100644 one/file
rm 'two/file'
[second-rename-redo f4197ac] Rename to two
 Author: A U Thor <author@example.com>
 1 files changed, 0 insertions(+), 0 deletions(-)
 rename original => two (100%)
 delete mode 100644 two/file
...
Merging:
080a169 Rename to one
virtual second-rename-redo
found 1 common ancestor(s):
ffe25bf Common commmit
Removing one to make room for subdirectory; may re-add later.
Removing two/file

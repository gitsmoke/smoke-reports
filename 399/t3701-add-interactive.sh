...
[master (root-commit) e7fefe1] commit
...
Unstaged changes after reset:
M	file
[master 77e94a9] commit
 Author: A U Thor <author@example.com>
 1 files changed, 1 insertions(+), 1 deletions(-)
HEAD is now at e7fefe1 commit
...
[master 078f874] clear local changes
 Author: A U Thor <author@example.com>
 1 files changed, 1 insertions(+), 0 deletions(-)
...
HEAD is now at 078f874 clear local changes
[master baa8f95] non-empty
 Author: A U Thor <author@example.com>
 1 files changed, 1 insertions(+), 0 deletions(-)
...
HEAD is now at baa8f95 non-empty
[master 62ac5c7] empty
 Author: A U Thor <author@example.com>

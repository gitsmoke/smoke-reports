...
expecting success: 
	...
	git add hello &&
	git commit -m master
[master (root-commit) 0c722b6] initial
...
[master (root-commit) 394942a] initial git-gui
 Author: A U Thor <author@example.com>
 1 files changed, 1 insertions(+), 0 deletions(-)
...
[master (root-commit) 0ce69c8] initial git
 Author: A U Thor <author@example.com>
 1 files changed, 1 insertions(+), 0 deletions(-)
...
Updating gui
[master 12610b0] Merge git-gui as our subdirectory
 Author: A U Thor <author@example.com>
ok 4 - initial merge
...
expecting success: 
	...
	test_cmp expected actual
M	git-gui.sh
[master2 89bc5ef] update git-gui
 Author: A U Thor <author@example.com>
 1 files changed, 1 insertions(+), 1 deletions(-)
Merging:
12610b0 Merge git-gui as our subdirectory
virtual 89bc5ef5482b3f3c249c18d166aa16655f695291
found 1 common ancestor(s):
394942a initial git-gui
Merge made by subtree.
...
HEAD is now at 12610b0 Merge git-gui as our subdirectory
Already up-to-date.
[master2 ed44d0b] Merge git-gui2 as our subdirectory
 Author: A U Thor <author@example.com>
 1 files changed, 1 insertions(+), 0 deletions(-)
...
HEAD is now at ed44d0b Merge git-gui2 as our subdirectory
Merging:
ed44d0b Merge git-gui2 as our subdirectory
virtual 89bc5ef5482b3f3c249c18d166aa16655f695291
found 1 common ancestor(s):
394942a initial git-gui

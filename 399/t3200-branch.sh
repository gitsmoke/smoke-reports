...
[master (root-commit) 93ddd2c] Initial commit.
 Author: A U Thor <author@example.com>
 1 files changed, 1 insertions(+), 0 deletions(-)
 create mode 100644 A
[master 352a1bb] Second commit.
 Author: A U Thor <author@example.com>
 1 files changed, 1 insertions(+), 0 deletions(-)
...
expecting success: git branch l/m &&
        git branch -d l/m &&
        git branch l
Deleted branch l/m (was 352a1bb).
...
Deleted branch s/t (was 352a1bb).
...
Deleted branch my7 (was 352a1bb).
...
352a1bb587a776e053184989af542e3e5b144daa
...
expecting success: 
	...
	git branch -d my8
Deleted branch my8 (was 352a1bb).

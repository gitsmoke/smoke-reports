...
expecting success: 
	...
	git tag initial
[master (root-commit) f03a667] initial
...
HEAD is now at f03a667 initial
[master 06f0b4c] add=5
 Author: A U Thor <author@example.com>
...
Deleted branch test5 (was c24a1bd).
HEAD is now at f03a667 initial
[master 6e22606] add=5
 Author: A U Thor <author@example.com>
 5 files changed, 110 insertions(+), 0 deletions(-)
 create mode 100644 1
 create mode 100644 2
...
Deleted branch test5 (was eb10af7).
HEAD is now at f03a667 initial
[master 831e99d] add=5
 Author: A U Thor <author@example.com>
 5 files changed, 110 insertions(+), 0 deletions(-)
 create mode 100644 1
 create mode 100644 2
...
[simple-change c0f018a] unrelated-change
 Author: A U Thor <author@example.com>
 0 files changed, 0 insertions(+), 0 deletions(-)

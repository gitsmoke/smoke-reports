...
expecting success: git branch g/h &&
     ...
     git pack-refs --all &&
     git branch -d g
Deleted branch g/h (was 93ddd2c).
Deleted branch g (was 93ddd2c).
...
expecting success: git branch k/l &&
     ...
     git branch -d k/lm &&
     git branch k
Deleted branch k/l (was 93ddd2c).
Deleted branch k/l/m (was 93ddd2c).
Deleted branch k/lm (was 93ddd2c).
...
expecting success: git branch n/o &&
     ...
     git branch -d n/o/p &&
     git branch n
Deleted branch n/o (was 93ddd2c).
Deleted branch n/op (was 93ddd2c).
Deleted branch n/o/p (was 93ddd2c).

...
expecting success: 
	...
	echo "foo();" > x &&
	git diff --check
[master (root-commit) 38cc810] snapshot
...
HEAD is now at cf0b194 yet another
[master d1676d2] hello 1
 Author: A U Thor <author@example.com>
 1 files changed, 1 insertions(+), 1 deletions(-)
...
HEAD is now at d1676d2 hello 1
[master 2b62850] base
 Author: A U Thor <author@example.com>
...
HEAD is now at 2b62850 base
[master b371daf] empty
 Author: A U Thor <author@example.com>
...
expecting success: 
	...
	! grep "^-" actual
HEAD is now at b371daf empty
[master 640a410] one side
 Author: A U Thor <author@example.com>
 1 files changed, 1 insertions(+), 9 deletions(-)
[detached HEAD 757fb14] the other side
 Author: A U Thor <author@example.com>
 1 files changed, 1 insertions(+), 9 deletions(-)
Merging:
757fb14 the other side
virtual master
...
expecting success: 
	...
	test_cmp expected current
HEAD is now at 757fb14 the other side
[detached HEAD 5a6120a] initial
 Author: A U Thor <author@example.com>
 1 files changed, 1 insertions(+), 1 deletions(-)

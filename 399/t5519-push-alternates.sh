...
[master (root-commit) eb9fca1] initial
...
Updating eb9fca1..e162b19
Fast-forward
 file |    1 +
 1 files changed, 1 insertions(+), 0 deletions(-)
[master 6378710] third
 Author: A U Thor <author@example.com>
...
[master c55b9b4] sixth.1
 Author: A U Thor <author@example.com>
 1 files changed, 1 insertions(+), 1 deletions(-)
[master 3d77812] sixth.2
 Author: A U Thor <author@example.com>
 1 files changed, 1 insertions(+), 0 deletions(-)
[master 0117c74] sixth.3
 Author: A U Thor <author@example.com>
 1 files changed, 1 insertions(+), 0 deletions(-)
...
0117c74f6bdc3e51bf60ab9e44e617d96365c912
[master fc4200c] seventh
 Author: A U Thor <author@example.com>
 1 files changed, 1 insertions(+), 1 deletions(-)

...
[master (root-commit) 8a62331] initial
...
[other 1a0f520] changesimplefile
 Author: A U Thor <author@example.com>
 1 files changed, 1 insertions(+), 0 deletions(-)
rm 'sub1'
[main 913e7f6] changefiletodir
 Author: A U Thor <author@example.com>

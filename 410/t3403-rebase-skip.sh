...
[master (root-commit) 25d5ddf] hello
 Author: A U Thor <author@example.com>
 1 files changed, 1 insertions(+), 0 deletions(-)
 create mode 100644 hello
[master 256b198] hello world
 Author: A U Thor <author@example.com>
 1 files changed, 1 insertions(+), 0 deletions(-)
[master d2d404d] goodbye
 Author: A U Thor <author@example.com>
 1 files changed, 1 insertions(+), 0 deletions(-)
[skip-reference 5f9f681] we should skip this
 Author: A U Thor <author@example.com>
 1 files changed, 1 insertions(+), 1 deletions(-)
[skip-reference cd2baa3] this should not be skipped
 Author: A U Thor <author@example.com>
 1 files changed, 1 insertions(+), 0 deletions(-)
...
HEAD is now at d2d404d goodbye
...
HEAD is now at cd2baa3 this should not be skipped
First, rewinding head to replay your work on top of it...
Applying: we should skip this
Using index info to reconstruct a base tree...
Falling back to patching base and 3-way merge...
...
Applying: we should skip this
Applying: this should not be skipped
HEAD is now at 8b0433b this should not be skipped
...
Merging:
d2d404d goodbye
cd2baa3 this should not be skipped
found 1 common ancestor(s):
5f9f681 we should skip this
[detached HEAD 19da4e4] this should not be skipped
 Author: A U Thor <author@example.com>
 1 files changed, 1 insertions(+), 0 deletions(-)
 create mode 100644 cow
...
Merging:
19da4e4 this should not be skipped
cd2baa3 this should not be skipped
found 1 common ancestor(s):
5f9f681 we should skip this

...
expecting success: 
	...
	git tag six
[master (root-commit) 459e983] Initial
 Author: A U Thor <author@example.com>
 2 files changed, 361 insertions(+), 0 deletions(-)
 create mode 120000 bar
 create mode 100644 foo
[master eeebdad] Second
 Author: A U Thor <author@example.com>
 2 files changed, 0 insertions(+), 0 deletions(-)
 rename foo => bar (100%)
 rename bar => foo (100%)
[master 58b6ac2] Third
 Author: A U Thor <author@example.com>
 1 files changed, 0 insertions(+), 0 deletions(-)
 rename bar => foo (100%)
[master 7e4055c] Fourth
 Author: A U Thor <author@example.com>
 2 files changed, 1 insertions(+), 360 deletions(-)
 rename foo => bar (100%)
 rewrite foo (100%)
 mode change 100644 => 120000
[master 300dbf2] Fifth
 Author: A U Thor <author@example.com>
 2 files changed, 2453 insertions(+), 360 deletions(-)
 rewrite bar (98%)
 rename bar => foo (100%)
[master 1bd9b22] Sixth
 Author: A U Thor <author@example.com>
 2 files changed, 0 insertions(+), 0 deletions(-)
 rename foo => bar (100%)
 rename bar => foo (100%)

...
[master (root-commit) b8ac5fb] original
...
[master 2fcf7f4] updated
 Author: A U Thor <author@example.com>
 1 files changed, 1 insertions(+), 1 deletions(-)
Your branch is behind 'master' by 1 commit, and can be fast-forwarded.
Updating b8ac5fb..2fcf7f4
Fast-forward
 file |    2 +-
 1 files changed, 1 insertions(+), 1 deletions(-)
...
[second 7af1789] modified
 Author: A U Thor <author@example.com>
 1 files changed, 1 insertions(+), 1 deletions(-)
HEAD is now at b8ac5fb original
Updating b8ac5fb..7af1789
Fast-forward
 file |    2 +-
 1 files changed, 1 insertions(+), 1 deletions(-)
...
expecting success: 
	...
	test $(git rev-parse HEAD^) = $(git rev-parse copy) &&
	test new = $(git show HEAD:file2)
HEAD is now at 2f2df2f new file
First, rewinding head to replay your work on top of it...
Applying: new file
...
HEAD is now at 7af1789 modified
[copy 499135c] conflict
 Author: A U Thor <author@example.com>
 1 files changed, 1 insertions(+), 1 deletions(-)
[to-rebase d848847] to-rebase
 Author: A U Thor <author@example.com>
 1 files changed, 1 insertions(+), 1 deletions(-)
First, rewinding head to replay your work on top of it...
Applying: new file
...
HEAD is now at d848847 to-rebase
First, rewinding head to replay your work on top of it...
Applying: new file
Applying: to-rebase
...
[master (root-commit) 91ace22] Initial revision
 Author: A U Thor <author@example.com>
...
[master b4df96e] 5->43
 Author: A U Thor <author@example.com>
 1 files changed, 1 insertions(+), 1 deletions(-)
[master 03a4cab] Make it bigger
 Author: A U Thor <author@example.com>
 1 files changed, 1 insertions(+), 1 deletions(-)
[master 554dd6e] Independent discovery of 5->43
 Author: A U Thor <author@example.com>
 1 files changed, 1 insertions(+), 1 deletions(-)
...
HEAD is now at 03a4cab Make it bigger
Cloning into bare repository src-replace.git...
done.
[master f4bbc86] Change 2
 Author: A U Thor <author@example.com>
 1 files changed, 2 insertions(+), 2 deletions(-)
[master 9ba6441] Change 3
 Author: A U Thor <author@example.com>
 1 files changed, 2 insertions(+), 2 deletions(-)
[master 54a4585] Change 4
 Author: A U Thor <author@example.com>
 1 files changed, 3 insertions(+), 3 deletions(-)
[master 76533e5] Modified Change 4
 Author: A U Thor <author@example.com>
 1 files changed, 3 insertions(+), 3 deletions(-)

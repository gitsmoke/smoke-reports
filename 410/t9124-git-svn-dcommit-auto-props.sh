...
Committed revision 1.
	A	foo
r1 = 20964dd913deb22237318c79620006a3b323bf3c (refs/remotes/git-svn)
...
[master 8ddb884] files for enabled auto-props
...
Committed r2
	...
	A	bar
	A	exec1.sh
r2 = 8e32c0427d5847571b11f0ef7ec15f5319f9122d (refs/remotes/git-svn)
...
[master 7810176] files for disabled auto-props
 Author: A U Thor <author@example.com>
 3 files changed, 3 insertions(+), 0 deletions(-)
...
Committed r3
	...
	A	world.txt
	A	zot
r3 = 4c9d4026ff63c7c16be5e1fef64c9d2b92345983 (refs/remotes/git-svn)
No changes between current HEAD and refs/remotes/git-svn
Resetting to the latest refs/remotes/git-svn
...
Committed r4
	D	foo
	A	foo.sh
r4 = 1e1e0ff00dcc049d895fb43ea774bd11573d5100 (refs/remotes/git-svn)
No changes between current HEAD and refs/remotes/git-svn
Resetting to the latest refs/remotes/git-svn
D    foo
A    foo.sh

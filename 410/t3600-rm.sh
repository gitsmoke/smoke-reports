...
[master (root-commit) 56789b4] add normal files
...
[master 490c2ea] add files with tabs and newlines
 Author: A U Thor <author@example.com>
 0 files changed, 0 insertions(+), 0 deletions(-)
...
[master e91b997] add file for rm test
 Author: A U Thor <author@example.com>
...
[master fc603dd] remove file from rm test
 Author: A U Thor <author@example.com>
...
[master 19f9c72] add file for rm --quiet test
 Author: A U Thor <author@example.com>
 1 files changed, 1 insertions(+), 0 deletions(-)
 create mode 100644 test-file
[master 7eb8daa] remove file from rm --quiet test
 Author: A U Thor <author@example.com>
 1 files changed, 0 insertions(+), 1 deletions(-)
 delete mode 100644 test-file
...
[master (root-commit) c3b3896] add a file
 Author: A U Thor <author@example.com>
 1 files changed, 1 insertions(+), 0 deletions(-)
...
expecting success: 
	...
	git rm frotz/nitfol &&
	test ! -f frotz/nitfol
HEAD is now at a79663c subdir test
rm 'frotz/nitfol'

...
[master (root-commit) 2ed82af] Initial commit.
 Author: A U Thor <author@example.com>
 1 files changed, 1 insertions(+), 0 deletions(-)
 create mode 100644 A
[master a1b3db7] Second commit.
 Author: A U Thor <author@example.com>
 1 files changed, 1 insertions(+), 0 deletions(-)
...
expecting success: git branch -d d/e/f &&
	 test ! -f .git/refs/heads/d/e/f &&
	 test ! -f .git/logs/refs/heads/d/e/f
Deleted branch d/e/f (was a1b3db7).
...
expecting success: git branch l/m &&
        git branch -d l/m &&
        git branch l
Deleted branch l/m (was a1b3db7).
...
Deleted branch s/t (was a1b3db7).
...
Deleted branch my7 (was a1b3db7).
...
a1b3db7f197ec5bca94f200836bec3313a366067
...
expecting success: 
	...
	git branch -d my8
Deleted branch my8 (was a1b3db7).

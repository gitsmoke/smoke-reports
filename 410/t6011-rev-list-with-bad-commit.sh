...
[master (root-commit) 7ee8054] first commit
 Author: A U Thor <author@example.com>
 1 files changed, 1 insertions(+), 0 deletions(-)
 create mode 100644 foo
[master 0e2e90b] second commit
 Author: A U Thor <author@example.com>
 1 files changed, 1 insertions(+), 0 deletions(-)
 create mode 100644 bar
[master 4069640] third commit
 Author: A U Thor <author@example.com>
 1 files changed, 1 insertions(+), 0 deletions(-)
 create mode 100644 baz
[master 2d517eb] fourth commit
 Author: A U Thor <author@example.com>
 1 files changed, 1 insertions(+), 0 deletions(-)
...
commit 7ee8054df7f7cd4de8ccbb60cb05ca86d48dc118
Author: A U Thor <author@example.com>
Date:   Sat Jan 1 04:02:21 2011 +0000

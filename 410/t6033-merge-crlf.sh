...
expecting success: 
	...
	git tag b &&
	git checkout master
[master (root-commit) 99e0775] Initial
 Author: A U Thor <author@example.com>
 1 files changed, 1 insertions(+), 0 deletions(-)
 create mode 100644 file
[master f85ce85] add line from a
 Author: A U Thor <author@example.com>
 1 files changed, 1 insertions(+), 1 deletions(-)
[side 1a6708a] add line from b
 Author: A U Thor <author@example.com>
 1 files changed, 1 insertions(+), 1 deletions(-)
...
HEAD is now at 99e0775 Initial
Merge made by ours.
...
HEAD is now at f85ce85 add line from a
Merging:
f85ce85 add line from a
virtual side

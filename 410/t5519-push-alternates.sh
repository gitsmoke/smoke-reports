...
[master (root-commit) e2b075e] initial
...
Updating e2b075e..fd3bce2
Fast-forward
 file |    1 +
 1 files changed, 1 insertions(+), 0 deletions(-)
[master 70962c7] third
 Author: A U Thor <author@example.com>
...
[master 3dc4610] sixth.1
 Author: A U Thor <author@example.com>
 1 files changed, 1 insertions(+), 1 deletions(-)
[master c205e6c] sixth.2
 Author: A U Thor <author@example.com>
 1 files changed, 1 insertions(+), 0 deletions(-)
[master 29b4a92] sixth.3
 Author: A U Thor <author@example.com>
 1 files changed, 1 insertions(+), 0 deletions(-)
...
29b4a92e08279b8913420895d0fa13858dc05c00
[master 60f71b7] seventh
 Author: A U Thor <author@example.com>
 1 files changed, 1 insertions(+), 1 deletions(-)

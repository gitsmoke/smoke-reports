...
[master (root-commit) cd2c3d2] initial
 Author: A U Thor <author@example.com>
 1 files changed, 1 insertions(+), 0 deletions(-)
 create mode 100644 init
[master 8bd4e93] File: dir/foo
 Author: A U Thor <author@example.com>
 1 files changed, 1 insertions(+), 0 deletions(-)
...
expecting success: 
	...
	git merge master
HEAD is now at a3808c9 File: dir
[master 0523ddb] first
 Author: A U Thor <author@example.com>
...
rm 'dir~B'
rm 'init'
[modify (root-commit) bbd566e] initial
 Author: A U Thor <author@example.com>
 1 files changed, 8 insertions(+), 0 deletions(-)
 create mode 100644 letters
[modify 3521cf3] modified
 Author: A U Thor <author@example.com>
 1 files changed, 1 insertions(+), 0 deletions(-)
rm 'letters'
[delete 3e3a61a] deleted
 Author: A U Thor <author@example.com>
...
expecting success: 
	...
	test -f letters/file &&
	test -f letters~HEAD
HEAD is now at 3e3a61a deleted

...
[master (root-commit) 382481d] subject
...
expecting success: 
	...
	check_message diff
[master 859e607] This is an example commit message that contains a diff.
 Author: A U Thor <author@example.com>
 1 files changed, 1 insertions(+), 1 deletions(-)
...
checking known breakage: 
	...
	check_message diff
[master 23413da] This is an example commit message that contains a diff.
 Author: A U Thor <author@example.com>
 1 files changed, 1 insertions(+), 1 deletions(-)
--- diff	2011-01-01 04:02:58.000000000 +0000
+++ actual	2011-01-01 04:02:58.000000000 +0000
@@ -1,9 +1,2 @@

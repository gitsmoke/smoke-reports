...
[master (root-commit) 9699b37] Initial.
 Author: A <A@test.git>
...
Merging:
194f64e Branch2-1
virtual cfd6d9ae97d66c272a901ac30cd3e1e9da22a28b
...
expecting success: echo "evil merge." >>file &&
     git commit -a --amend
[branch2 7d85aa5] Merge branch 'branch1' into branch2

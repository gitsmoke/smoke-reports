...
[master 80fbbc4] c
 Author: A U Thor <author@example.com>
 1 files changed, 1 insertions(+), 1 deletions(-)
[to-rebase fefdd2f] merge should fail on this
 Author: A U Thor <author@example.com>
 1 files changed, 1 insertions(+), 1 deletions(-)
[to-rebase a84270c] merge should fail on this, too
 Author: A U Thor <author@example.com>
 1 files changed, 1 insertions(+), 1 deletions(-)
...
HEAD is now at a84270c merge should fail on this, too
...
Merging HEAD with merge should fail on this, too
Merging:
a2d4b49 merge should fail on this
virtual merge should fail on this, too
found 1 common ancestor(s):
virtual f788de73cfc81f8d734fa7efc658cc63ca083f50
Auto-merging a
...
Merging:
80fbbc4 c
fefdd2f merge should fail on this
found 1 common ancestor(s):
4c2b42c a
Auto-merging a
CONFLICT (content): Merge conflict in a
...
Merging:
80fbbc4 c
a84270c merge should fail on this, too
found 1 common ancestor(s):
fefdd2f merge should fail on this
Auto-merging a
CONFLICT (content): Merge conflict in a
...
Auto-merging a
CONFLICT (content): Merge conflict in a
[detached HEAD 4fd557c] merge should fail on this
 Author: A U Thor <author@example.com>
 1 files changed, 1 insertions(+), 0 deletions(-)
Committed: 0001 merge should fail on this
Merging master with HEAD~0
Merging:
4fd557c merge should fail on this
a84270c merge should fail on this, too
found 1 common ancestor(s):
fefdd2f merge should fail on this
Auto-merging a

...
[master (root-commit) 7a35bd9] initial commit
...
[master (root-commit) 46db3cc] submodule commit 1
 Author: A U Thor <author@example.com>
...
[master (root-commit) 172adef] Ignore everything
 Author: A U Thor <author@example.com>
 1 files changed, 1 insertions(+), 0 deletions(-)
...
" "$rev1" &&
	test -n "$rev1"
rev1: 46db3ccc77a4e387ac91927a9fc0824d8d686bb0
...
-46db3ccc77a4e387ac91927a9fc0824d8d686bb0 init
...
Submodule path 'init': checked out '46db3ccc77a4e387ac91927a9fc0824d8d686bb0'
...
expecting success: 
	...
	grep "^ $rev1" list
 46db3ccc77a4e387ac91927a9fc0824d8d686bb0 init (rev-1)
...
[detached HEAD 2dc844e] submodule commit 2
 Author: A U Thor <author@example.com>
 1 files changed, 1 insertions(+), 0 deletions(-)
 create mode 100644 b
+2dc844e5a2871ea5e6a1d3d345217c7e491642bb init (rev-1-1-g2dc844e)
...
+Subproject commit 2dc844e5a2871ea5e6a1d3d345217c7e491642bb
...
[detached HEAD 7104386] change subproject
 Author: A U Thor <author@example.com>
 1 files changed, 1 insertions(+), 0 deletions(-)
 create mode 100644 s
[master bf4fa43] change init
 Author: A U Thor <author@example.com>
...
Submodule path 'init': checked out '7104386072d194cab3cb5246072c70a4eb03afd3'
...
HEAD is now at 6f8a90c super commit 1
...
HEAD is now at 6f8a90c super commit 1
[second 66afc58] commit subproject
 Author: A U Thor <author@example.com>
 1 files changed, 1 insertions(+), 1 deletions(-)
diff --git a/init b/init
index 7104386..713c164 160000
--- a/init
+++ b/init
@@ -1 +1 @@
-Subproject commit 7104386072d194cab3cb5246072c70a4eb03afd3
+Subproject commit 713c164452253d847ccffc4585e5a2136bcbf8ea
...
expecting success: 
	...
	test ! -d init &&
	git checkout second
HEAD is now at 66afc58 commit subproject
...
[master (root-commit) b553945] repo commit 1
 Author: A U Thor <author@example.com>
 1 files changed, 1 insertions(+), 0 deletions(-)

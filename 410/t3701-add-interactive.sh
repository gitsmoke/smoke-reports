...
[master (root-commit) 72e8ecc] commit
...
Unstaged changes after reset:
M	file
[master a52d397] commit
 Author: A U Thor <author@example.com>
 1 files changed, 1 insertions(+), 1 deletions(-)
HEAD is now at 72e8ecc commit
...
[master 94331c9] clear local changes
 Author: A U Thor <author@example.com>
 1 files changed, 1 insertions(+), 0 deletions(-)
...
HEAD is now at 94331c9 clear local changes
[master f5e4bc6] non-empty
 Author: A U Thor <author@example.com>
 1 files changed, 1 insertions(+), 0 deletions(-)
...
HEAD is now at f5e4bc6 non-empty
[master b2aba17] empty
 Author: A U Thor <author@example.com>

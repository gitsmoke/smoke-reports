...
expecting success: 
	...
	git tag initial
[master (root-commit) acbd6b1] initial
...
HEAD is now at acbd6b1 initial
[master 7cc6c4f] add=5
 Author: A U Thor <author@example.com>
...
Deleted branch test5 (was 5a7e9ac).
HEAD is now at acbd6b1 initial
[master 06a73b9] add=5
 Author: A U Thor <author@example.com>
 5 files changed, 110 insertions(+), 0 deletions(-)
 create mode 100644 1
 create mode 100644 2
...
Deleted branch test5 (was ddf4e16).
HEAD is now at acbd6b1 initial
[master 49dfd57] add=5
 Author: A U Thor <author@example.com>
 5 files changed, 110 insertions(+), 0 deletions(-)
 create mode 100644 1
 create mode 100644 2
...
[simple-change 5e48d37] unrelated-change
 Author: A U Thor <author@example.com>
 0 files changed, 0 insertions(+), 0 deletions(-)

...
expecting success: 
	...
	echo "foo();" > x &&
	git diff --check
[master (root-commit) 45febd3] snapshot
...
HEAD is now at 55f390c yet another
[master 8da0d04] hello 1
 Author: A U Thor <author@example.com>
 1 files changed, 1 insertions(+), 1 deletions(-)
...
expecting success: 
	...
	test_cmp expect actual
HEAD is now at 8da0d04 hello 1
[master 8e61ac5] base
 Author: A U Thor <author@example.com>
...
HEAD is now at 8e61ac5 base
[master dae6fb0] empty
 Author: A U Thor <author@example.com>
...
HEAD is now at dae6fb0 empty
[master f7092d2] one side
 Author: A U Thor <author@example.com>
 1 files changed, 1 insertions(+), 9 deletions(-)
[detached HEAD 197f8f5] the other side
 Author: A U Thor <author@example.com>
 1 files changed, 1 insertions(+), 9 deletions(-)
Merging:
197f8f5 the other side
virtual master
...
HEAD is now at 197f8f5 the other side
[detached HEAD c907b41] initial
 Author: A U Thor <author@example.com>
 1 files changed, 1 insertions(+), 1 deletions(-)

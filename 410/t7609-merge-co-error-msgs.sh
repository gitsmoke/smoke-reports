...
expecting success: 
	...
	echo other >four &&
	echo other >five
[master (root-commit) b10df91] First
 Author: A U Thor <author@example.com>
 1 files changed, 1 insertions(+), 0 deletions(-)
 create mode 100644 one
[branch 89a4c2a] Second
 Author: A U Thor <author@example.com>
...
Updating b10df91..89a4c2a
Aborting
[master bcc597e] empty
 Author: A U Thor <author@example.com>
Aborting
HEAD is now at b10df91 First
...
[master (root-commit) 3dfcc6a] init
 Author: A U Thor <author@example.com>
...
rm 'rep/foo'
rm 'rep2/foo'
[branch 83f2d80] added test as a file
 Author: A U Thor <author@example.com>

...
[master (root-commit) be70e2e] initial
...
[master 521c36f] master removes file2 and subdir/file2
 Author: A U Thor <author@example.com>
...
D	file2
D	subdir/file2
[side ce5b115] side adds file3 and removes file2
 Author: A U Thor <author@example.com>
...
HEAD is now at 521c36f master removes file2 and subdir/file2
...
expecting success: 
	...
	git checkout side-a
HEAD is now at 521c36f master removes file2 and subdir/file2
[side-a 09b167e] side-a changes file1
 Author: A U Thor <author@example.com>
 1 files changed, 1 insertions(+), 0 deletions(-)
[side-b 6f464f7] side-b changes file2
 Author: A U Thor <author@example.com>
 1 files changed, 1 insertions(+), 0 deletions(-)
...
HEAD is now at 09b167e side-a changes file1
...
HEAD is now at 09b167e side-a changes file1
[sym-b 80dd0a5] side adds a/b
 Author: A U Thor <author@example.com>
 0 files changed, 0 insertions(+), 0 deletions(-)
 create mode 100644 a/b
[sym-a aa15215] we add a/b
 Author: A U Thor <author@example.com>
 1 files changed, 1 insertions(+), 0 deletions(-)
...
HEAD is now at aa15215 we add a/b
...
HEAD is now at aa15215 we add a/b
[side-a 48a6fd9] side-a changes file2 to directory
 Author: A U Thor <author@example.com>
...
HEAD is now at 6f464f7 side-b changes file2
Trying simple merge.
...
Merging:
6f464f7 side-b changes file2
48a6fd9 side-a changes file2 to directory

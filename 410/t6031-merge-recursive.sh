...
[master (root-commit) 9248f5e] initial
...
[other ecec1ca] changesimplefile
 Author: A U Thor <author@example.com>
 1 files changed, 1 insertions(+), 0 deletions(-)
rm 'sub1'
[main b12eb3e] changefiletodir
 Author: A U Thor <author@example.com>

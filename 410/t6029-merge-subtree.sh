...
expecting success: 
	...
	git add hello &&
	git commit -m master
[master (root-commit) 42cf945] initial
...
[master (root-commit) 407c1d7] initial git-gui
 Author: A U Thor <author@example.com>
 1 files changed, 1 insertions(+), 0 deletions(-)
...
[master (root-commit) 81d6ca1] initial git
 Author: A U Thor <author@example.com>
 1 files changed, 1 insertions(+), 0 deletions(-)
...
Updating gui
[master ddaee22] Merge git-gui as our subdirectory
 Author: A U Thor <author@example.com>
...
M	git-gui.sh
[master2 af53673] update git-gui
 Author: A U Thor <author@example.com>
 1 files changed, 1 insertions(+), 1 deletions(-)
Merging:
ddaee22 Merge git-gui as our subdirectory
virtual af5367345a22a04220292f28c0f91eadeae43f79
found 1 common ancestor(s):
407c1d7 initial git-gui
Merge made by subtree.
...
HEAD is now at ddaee22 Merge git-gui as our subdirectory
Already up-to-date.
[master2 5cdbd84] Merge git-gui2 as our subdirectory
 Author: A U Thor <author@example.com>
 1 files changed, 1 insertions(+), 0 deletions(-)
...
expecting success: 
	...
	test_cmp expected actual
HEAD is now at 5cdbd84 Merge git-gui2 as our subdirectory
Merging:
5cdbd84 Merge git-gui2 as our subdirectory
virtual af5367345a22a04220292f28c0f91eadeae43f79
found 1 common ancestor(s):
407c1d7 initial git-gui

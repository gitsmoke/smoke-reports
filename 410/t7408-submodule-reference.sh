...
[master (root-commit) 11e9364] A-initial
...
[master (root-commit) b3619da] B-super-initial
 Author: A U Thor <author@example.com>
 1 files changed, 1 insertions(+), 0 deletions(-)
...
Cloning into sub...
Submodule path 'sub': checked out '11e93642f177e98035a68bef851669bcd6febe87'

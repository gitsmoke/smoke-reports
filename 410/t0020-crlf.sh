...
expecting success: 
	...
	echo happy.
[master (root-commit) edd66c0] initial
...
HEAD is now at edd66c0 initial
...
[master 20cc1d6] Add .gitattributes
 Author: A U Thor <author@example.com>
...
[master e4dfcd3] initial
 Author: A U Thor <author@example.com>
 1 files changed, 1 insertions(+), 0 deletions(-)
[master a1a24bc] second
 Author: A U Thor <author@example.com>
...
[master 4a863ff] alllf, allcrlf and mixed only
 Author: A U Thor <author@example.com>

...
expecting success: 
	...
	git commit -m "untracked symlink remains" &&
	 ...
	 test -f a/b-2/c/d
HEAD is now at 1987f86 dir to symlink
rm 'a/b'
[detached HEAD 1df12e4] untracked symlink remains
 Author: A U Thor <author@example.com>
...
HEAD is now at 729c742 base
[detached HEAD 275f6a2] x
 Author: A U Thor <author@example.com>
 1 files changed, 1 insertions(+), 0 deletions(-)
...
HEAD is now at 570e651 Merge branch 'master' into HEAD
Merging:
275f6a2 x
virtual master
...
HEAD is now at c87a8d0 Merge commit 'baseline^0' into HEAD
Merging:
1987f86 dir to symlink
virtual baseline^0
found 1 common ancestor(s):
729c742 base
...
expecting success: 
	...
	git tag test2
HEAD is now at 275f6a2 x
[detached HEAD 98564a8] dir a/b-2 to symlink
 Author: A U Thor <author@example.com>
...
HEAD is now at 98564a8 dir a/b-2 to symlink
Trying really trivial in-index merge...
Nope.
Trying simple merge.
Simple merge failed, trying Automatic merge.
...
HEAD is now at c5e47df Merge commit 'test2' into HEAD
Merging:
275f6a2 x
virtual test2
found 1 common ancestor(s):

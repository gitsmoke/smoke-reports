...
Initialized empty Git repository in /Users/trast/git-smoke/t/trash directory.t9134-git-svn-ignore-paths/g/.git/
	A	qqq/test_qqq.txt
r1 = 91b8fc4dbb11e131c2b610ff47c7bd36f719b99b (refs/remotes/git-svn)
r2 = 794196f1383f618e09aed49c838e5c75ca8ebc8d (refs/remotes/git-svn)
...
" > expect &&
	...
	M	qqq/test_qqq.txt
r3 = 804df6a1c07720772580adebba58421e2e3344a0 (refs/remotes/git-svn)
...
r4 = 9625797c4cc4596900415e305bd49b4d7d56ba3b (refs/remotes/git-svn)
First, rewinding head to replay your work on top of it...
Fast-forwarded master to refs/remotes/git-svn.
...
" > expect &&
	...
	M	qqq/test_qqq.txt
r5 = 750e8e0d551c97d3a070d10f0e16ae936e7dc739 (refs/remotes/git-svn)
First, rewinding head to replay your work on top of it...
Fast-forwarded master to refs/remotes/git-svn.

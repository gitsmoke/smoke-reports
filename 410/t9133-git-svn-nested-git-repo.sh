...
Initialized empty Git repository in /Users/trast/git-smoke/t/trash directory.t9133-git-svn-nested-git-repo/g/.git/
	A	a
r1 = 4a0a3135f64bce93b264a36e1091e7981db4707a (refs/remotes/git-svn)
r2 = 2541ae384d53d845a996f429888342fe25cada5a (refs/remotes/git-svn)
...
expecting success: 
	...
	M	a
r3 = b6ec861e9965d567a725a4a577d20d7ce751327f (refs/remotes/git-svn)
...
[master (root-commit) 8ff5972] add a inside an SVN repo
 Author: A U Thor <author@example.com>
 1 files changed, 2 insertions(+), 0 deletions(-)
 create mode 100644 a
commit 8ff59722c53404f7633839893974498e66c8b3e2
Author: A U Thor <author@example.com>
Date:   Sat Jan 1 04:04:15 2011 +0000
...
A         .git/objects/8f
A         .git/objects/8f/f59722c53404f7633839893974498e66c8b3e2
A         .git/objects/a3
...
Adding         .git/objects/8f/f59722c53404f7633839893974498e66c8b3e2
...
r4 = 519d93d1f936d119edf27d9169553edf446b749a (refs/remotes/git-svn)
First, rewinding head to replay your work on top of it...
Fast-forwarded master to refs/remotes/git-svn.
...
[master 3c9eafb] add a inside an SVN repo
 Author: A U Thor <author@example.com>
...
expecting success: 
	...
	M	a
r5 = 9869ecff73036ef390d97501c0a7e46d7cd59696 (refs/remotes/git-svn)
First, rewinding head to replay your work on top of it...
Fast-forwarded master to refs/remotes/git-svn.

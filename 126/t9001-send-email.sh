...
ok 79 - setup expect
ok 80 - setup expect
ok 81 - asks about and fixes 8bit encodings
ok 82 - sendemail.8bitEncoding works
ok 83 - --8bit-encoding overrides sendemail.8bitEncoding
ok 84 - setup expect
ok 85 - setup expect
ok 86 - --8bit-encoding also treats subject
ok 87 - refusing to send cover letter template
ok 88 - --force sends cover letter template anyway

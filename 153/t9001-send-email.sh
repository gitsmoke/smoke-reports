...
ok 81 - To headers from files reset each patch
ok 82 - setup expect
ok 83 - setup expect
ok 84 - asks about and fixes 8bit encodings
ok 85 - sendemail.8bitEncoding works
ok 86 - --8bit-encoding overrides sendemail.8bitEncoding
ok 87 - setup expect
ok 88 - setup expect
ok 89 - --8bit-encoding also treats subject
ok 90 - refusing to send cover letter template
ok 91 - --force sends cover letter template anyway

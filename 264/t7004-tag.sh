...
ok 86 - creating a signed tag with rfc1991
ok 87 - reediting a signed tag body omits signature
ok 88 - verifying rfc1991 signature
ok 89 - list tag with rfc1991 signature
ok 90 - git tag -s fails if gpg is misconfigured
ok 91 - verify signed tag fails when public key is not present
ok 92 - git tag -a fails if tag annotation is empty
ok 93 - message in editor has initial comment
ok 94 - message in editor has initial comment: first line
ok 95 - message in editor has initial comment: remainder
ok 96 - overwriting an annoted tag should use its previous body
ok 97 - filename for the message is relative to cwd
ok 98 - filename for the message is relative to cwd
ok 99 - creating second commit and tag
ok 100 - creating third commit without tag
ok 101 - checking that first commit is in all tags (hash)
ok 102 - checking that first commit is in all tags (tag)
ok 103 - checking that first commit is in all tags (relative)
ok 104 - checking that second commit only has one tag
ok 105 - checking that third commit has no tags
ok 106 - creating simple branch
ok 107 - checking that branch head only has one tag
ok 108 - merging original branch into this branch
ok 109 - checking that original branch head has one tag now
ok 110 - checking that initial commit is in all tags
ok 111 - mixing incompatibles modes and options is forbidden

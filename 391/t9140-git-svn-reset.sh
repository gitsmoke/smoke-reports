...
Initialized empty Git repository in /Users/trast/git-smoke/t/trash directory.t9140-git-svn-reset/g/.git/
	A	vis/vis.txt
r1 = 54aec5718a7040defa90661c327d7d71e2efeb96 (refs/remotes/git-svn)
r2 = 272ded22b620e02a659b43d1cb40a0cf27a2bdd8 (refs/remotes/git-svn)
	M	vis/vis.txt
r3 = 00093c92c7e2aec37b5124ea1b69a1e3849468b9 (refs/remotes/git-svn)
...
hid/hid.txt was not found in commit 00093c92c7e2aec37b5124ea1b69a1e3849468b9 (r3)
...
expecting success: 
	...
	A	hid/hid.txt
r2 = f4f608c6917fe076e368d80ea318bff9c17e01c1 (refs/remotes/git-svn)
	M	vis/vis.txt
r3 = 0daeadd27d2356e8ab6abf1a5cfb9e5be4f02c77 (refs/remotes/git-svn)
	M	hid/hid.txt
r4 = ee266be709444763b422824432ce7a0a54f35629 (refs/remotes/git-svn)

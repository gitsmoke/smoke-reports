...
[master faca350] c
 Author: A U Thor <author@example.com>
 1 files changed, 1 insertions(+), 1 deletions(-)
[to-rebase 5cf212d] merge should fail on this
 Author: A U Thor <author@example.com>
 1 files changed, 1 insertions(+), 1 deletions(-)
[to-rebase 3dfca74] merge should fail on this, too
 Author: A U Thor <author@example.com>
 1 files changed, 1 insertions(+), 1 deletions(-)
...
HEAD is now at 3dfca74 merge should fail on this, too
...
Merging HEAD with merge should fail on this, too
Merging:
e6b3922 merge should fail on this
virtual merge should fail on this, too
found 1 common ancestor(s):
virtual f788de73cfc81f8d734fa7efc658cc63ca083f50
Auto-merging a
...
Merging:
faca350 c
5cf212d merge should fail on this
found 1 common ancestor(s):
4fb511f a
Auto-merging a
CONFLICT (content): Merge conflict in a
...
Merging:
faca350 c
3dfca74 merge should fail on this, too
found 1 common ancestor(s):
5cf212d merge should fail on this
Auto-merging a
CONFLICT (content): Merge conflict in a
...
Auto-merging a
CONFLICT (content): Merge conflict in a
[detached HEAD 72aa752] merge should fail on this
 Author: A U Thor <author@example.com>
 1 files changed, 1 insertions(+), 0 deletions(-)
Committed: 0001 merge should fail on this
Merging master with HEAD~0
Merging:
72aa752 merge should fail on this
3dfca74 merge should fail on this, too
found 1 common ancestor(s):
5cf212d merge should fail on this
Auto-merging a

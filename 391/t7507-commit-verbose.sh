...
[master (root-commit) a23b5d9] subject
...
expecting success: 
	...
	check_message diff
[master da01ddc] This is an example commit message that contains a diff.
 Author: A U Thor <author@example.com>
 1 files changed, 1 insertions(+), 1 deletions(-)
...
checking known breakage: 
	...
	check_message diff
[master 8b2f7f6] This is an example commit message that contains a diff.
 Author: A U Thor <author@example.com>
 1 files changed, 1 insertions(+), 1 deletions(-)
--- diff	2010-12-26 04:02:43.000000000 +0000
+++ actual	2010-12-26 04:02:43.000000000 +0000
@@ -1,9 +1,2 @@

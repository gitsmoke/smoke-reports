...
[master (root-commit) 7bda63c] Initial.
 Author: A <A@test.git>
...
Merging:
95decd8 Branch2-1
virtual 89efec2a6de90727734dc500aecb8907cff91787
...
expecting success: echo "evil merge." >>file &&
     git commit -a --amend
[branch2 95dd48c] Merge branch 'branch1' into branch2

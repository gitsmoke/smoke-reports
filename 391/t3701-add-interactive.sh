...
[master (root-commit) 916df19] commit
...
Unstaged changes after reset:
M	file
[master 1b92892] commit
 Author: A U Thor <author@example.com>
 1 files changed, 1 insertions(+), 1 deletions(-)
HEAD is now at 916df19 commit
...
[master 760b1f8] clear local changes
 Author: A U Thor <author@example.com>
 1 files changed, 1 insertions(+), 0 deletions(-)
...
HEAD is now at 760b1f8 clear local changes
[master a414679] non-empty
 Author: A U Thor <author@example.com>
 1 files changed, 1 insertions(+), 0 deletions(-)
...
HEAD is now at a414679 non-empty
[master 8cde3ed] empty
 Author: A U Thor <author@example.com>

...
[master (root-commit) 55a8a13] snapshot
...
HEAD is now at d66573b yet another
[master eb6516b] hello 1
 Author: A U Thor <author@example.com>
 1 files changed, 1 insertions(+), 1 deletions(-)
...
expecting success: 
	...
	test_cmp expect actual
HEAD is now at eb6516b hello 1
[master afca3b0] base
 Author: A U Thor <author@example.com>
...
HEAD is now at afca3b0 base
[master cacea28] empty
 Author: A U Thor <author@example.com>
...
expecting success: 
	...
	! grep "^-" actual
HEAD is now at cacea28 empty
[master 62f0281] one side
 Author: A U Thor <author@example.com>
 1 files changed, 1 insertions(+), 9 deletions(-)
[detached HEAD 9351e65] the other side
 Author: A U Thor <author@example.com>
 1 files changed, 1 insertions(+), 9 deletions(-)
Merging:
9351e65 the other side
virtual master
...
expecting success: 
	...
	test_cmp expected current
HEAD is now at 9351e65 the other side
[detached HEAD 49f0395] initial
 Author: A U Thor <author@example.com>
 1 files changed, 1 insertions(+), 1 deletions(-)

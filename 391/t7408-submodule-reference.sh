...
[master (root-commit) c36357c] A-initial
...
[master (root-commit) ab1be3c] B-super-initial
 Author: A U Thor <author@example.com>
 1 files changed, 1 insertions(+), 0 deletions(-)
...
Cloning into sub...
Submodule path 'sub': checked out 'c36357c47ad7d7f72ebae3ee0cddbd76cef08e41'

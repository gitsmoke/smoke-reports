...
Initialized empty Git repository in /Users/trast/git-smoke/t/trash directory.t9134-git-svn-ignore-paths/g/.git/
	A	qqq/test_qqq.txt
r1 = 3cd260d4d7a792c3964be4bc0dbf0dbdfe20d4d4 (refs/remotes/git-svn)
r2 = 9655c12b3febc7c7ab9d65839cfe7f396f02fe35 (refs/remotes/git-svn)
...
" > expect &&
	...
	M	qqq/test_qqq.txt
r3 = c5ed8bb6e9e86f99c9dd9f2ed3146e938c949030 (refs/remotes/git-svn)
...
r4 = 3b51be622e720561f764c2398ce064160aa6727f (refs/remotes/git-svn)
First, rewinding head to replay your work on top of it...
Fast-forwarded master to refs/remotes/git-svn.
...
" > expect &&
	...
	M	qqq/test_qqq.txt
r5 = 19e21b28fe3ad6fa21214dcc320fc6c136b3a6f1 (refs/remotes/git-svn)
First, rewinding head to replay your work on top of it...
Fast-forwarded master to refs/remotes/git-svn.

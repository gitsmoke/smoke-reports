...
expecting success: echo "Not an empty file." > file &&
	 ...
	 git branch b
[master (root-commit) 3f9fb06] Initial commit.
...
expecting success: rm renamed_file &&
	 ...
	 gitweb_run "p=.git;a=commitdiff"
[master 8983b30] File to symlink.
 Author: A U Thor <author@example.com>
...
expecting success: echo "New line" >> file2 &&
	 ...
	 gitweb_run "p=.git;a=commitdiff"
[master 2f03073] Mode change and modification.
 Author: A U Thor <author@example.com>
 1 files changed, 1 insertions(+), 0 deletions(-)
...
EOF
	 ...
	 gitweb_run "p=.git;a=commitdiff"
[master 415c2f4] File added.
 Author: A U Thor <author@example.com>
 1 files changed, 7 insertions(+), 2 deletions(-)
[master ea91f9c] File rename and modification.
 Author: A U Thor <author@example.com>
 1 files changed, 1 insertions(+), 0 deletions(-)
...
expecting success: git mv file3 file2 &&
	 ...
	 gitweb_run "p=.git;a=commitdiff"
[master aff9264] File rename, mode change and modification.
 Author: A U Thor <author@example.com>
 1 files changed, 1 insertions(+), 0 deletions(-)
...
[master 223ac1f] initial
 Author: A U Thor <author@example.com>
 2 files changed, 2 insertions(+), 0 deletions(-)
 create mode 100644 bar
 create mode 100644 foo
[master 0ed3868] foo symlinked to bar
 Author: A U Thor <author@example.com>
 1 files changed, 1 insertions(+), 1 deletions(-)
 rewrite foo (100%)
 mode change 100644 => 120000
[master b768a2a] foo back to file
 Author: A U Thor <author@example.com>
 1 files changed, 1 insertions(+), 1 deletions(-)
 rewrite foo (100%)
 mode change 120000 => 100644
[master 30b4e79] foo becomes a directory
 Author: A U Thor <author@example.com>
 2 files changed, 1 insertions(+), 1 deletions(-)
 delete mode 100644 foo
 create mode 100644 foo/baz
[master 96c7aac] foo/baz is the original foo
 Author: A U Thor <author@example.com>
 1 files changed, 1 insertions(+), 1 deletions(-)
...
Merging:
96c7aac foo/baz is the original foo
virtual 2684fb1a58193c1f18e309f17f0da339fb5661d6
found 1 common ancestor(s):
3f9fb06 Initial commit.
...
expecting success: git checkout b &&
	 ...
	 git checkout master
[b 60c9a80] Prepare large commit
 Author: A U Thor <author@example.com>
...
[master b780dd1] Add file to be deleted
 Author: A U Thor <author@example.com>
 1 files changed, 1 insertions(+), 0 deletions(-)
 create mode 100644 deleted_file
rm 'deleted_file'
[master a110928] Delete file
 Author: A U Thor <author@example.com>
 1 files changed, 0 insertions(+), 1 deletions(-)

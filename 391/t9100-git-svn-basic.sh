...
r1 = 98776405203370bbb2bf06de69292c9cd07df81c (refs/remotes/git-svn)
...
[mybranch 1da9181] try a deep --rmdir with a commit
 ...
 rename dir/a/b/c/d/e/file => file (100%)
	...
	D	dir/a/
	A	dir/file
r2 = fdc6bf27f0c94d87859360edc3e37d9a0fef5f67 (refs/remotes/git-svn)
...
[mybranch 96afb8c] detect node change from file to directory #1
 Author: A U Thor <author@example.com>
...
[mybranch2 705de6b] detect node change from directory to file #1
 Author: A U Thor <author@example.com>
 1 files changed, 0 insertions(+), 0 deletions(-)
...
[mybranch3 669fadb] detect node change from file to directory #2
 Author: A U Thor <author@example.com>
...
[mybranch4 3a7f3a2] detect node change from directory to file #2
 Author: A U Thor <author@example.com>
 2 files changed, 1 insertions(+), 1 deletions(-)
...
[mybranch5 454cb05] remove executable bit from a file
 Author: A U Thor <author@example.com>
 0 files changed, 0 insertions(+), 0 deletions(-)
 mode change 100755 => 100644 exec.sh
	M	exec.sh
	M	exec.sh
r3 = 4f29c2e44b14407732e16d12dcf8ce38f06cb9f4 (refs/remotes/git-svn)
Done committing 1 revisions to SVN
...
expecting success: 
	...
	svn_cmd up "$SVN_TREE" &&
	test -x "$SVN_TREE"/exec.sh
[mybranch5 34cc696] add executable bit back file
 Author: A U Thor <author@example.com>
 0 files changed, 0 insertions(+), 0 deletions(-)
 mode change 100644 => 100755 exec.sh
	M	exec.sh
	M	exec.sh
r4 = 9c8dda7c9886317cd5984b111f4c1a94fdd17e70 (refs/remotes/git-svn)
Done committing 1 revisions to SVN
UU   /Users/trast/git-smoke/t/trash directory.t9100-git-svn-basic/.git/svn/refs/remotes/git-svn/svn-tree/exec.sh
...
[mybranch5 4efea68] executable file becomes a symlink to bar/zzz (file)
 Author: A U Thor <author@example.com>
 ...
 mode change 100755 => 120000
	T	exec.sh
	M	exec.sh
r5 = dfc88cb61949d44447d7ab0c62b6bd77f472b9e5 (refs/remotes/git-svn)
Done committing 1 revisions to SVN
UU   /Users/trast/git-smoke/t/trash directory.t9100-git-svn-basic/.git/svn/refs/remotes/git-svn/svn-tree/exec.sh
...
[mybranch5 b38fbd6] new symlink is added to a file that was also just made executable
 Author: A U Thor <author@example.com>
 ...
 create mode 120000 exec-2.sh
	...
	M	bar/zzz
	A	exec-2.sh
r6 = d19d92d61b13e678075470db15c01362a97ac06c (refs/remotes/git-svn)
Done committing 1 revisions to SVN
...
[mybranch5 d1d9896] modify a symlink to become a file
 Author: A U Thor <author@example.com>
 1 files changed, 1 insertions(+), 1 deletions(-)
 ...
 mode change 120000 => 100644
	T	exec-2.sh
	M	exec-2.sh
r7 = ba07c9533db636458380625d229f082269ebfad6 (refs/remotes/git-svn)
Done committing 1 revisions to SVN
...
expecting success: git svn init "$svnrepo" && git svn fetch &&
	...
	A	exec.sh
	A	dir/a/b/c/d/e/file
r1 = 98776405203370bbb2bf06de69292c9cd07df81c (refs/remotes/alt)
	A	file
	D	dir/a/b/c/d/e/file
	D	dir/a/
	A	dir/file
r2 = d5551641f5f59f1ea8a754966df5b9e445f1f67a (refs/remotes/alt)
	M	exec.sh
r3 = 3b1c6142ebf02b7a7edf853646b7d35da56b9a13 (refs/remotes/alt)
	M	exec.sh
r4 = 4d27af06295413bd57ab87c95b1dce255ed33e29 (refs/remotes/alt)
	M	exec.sh
r5 = 9a30da419d59183421229ed9d4d9e5a83a17081f (refs/remotes/alt)
	M	bar/zzz
	A	exec-2.sh
r6 = 965587226fdd28a185a7baf6469ba3a65dffcc09 (refs/remotes/alt)
	M	exec-2.sh
r7 = 2cc7634e7e85ee55ffcd14a85f91cb0ae5b79c0a (refs/remotes/alt)
...
expecting success: 
	...
	A	zzz
r1 = 4ce05766d5c3000b23fb2833a959882b2454a883 (refs/remotes/bar)
	M	zzz
r6 = 8bdb5516620b2c9484f9259b4ed76d1b5c0396e7 (refs/remotes/bar)
[my-bar ec07fac] change 1
 Author: A U Thor <author@example.com>
 1 files changed, 1 insertions(+), 0 deletions(-)
 create mode 100644 foo
[my-bar f1ea6c5] change 2
 Author: A U Thor <author@example.com>
 1 files changed, 1 insertions(+), 1 deletions(-)
...
Committed r8
	A	foo
r8 = 1ac550a477e384936632d9dc485c4fd47b57aff0 (refs/remotes/bar)
...
The rewritten commit is: 1ac550a477e384936632d9dc485c4fd47b57aff0
    change 1
Deleted branch my-bar (was f1ea6c5).
...
expecting success: 
	...
	A	bar/foo
r8 = 7221dfef33312d0cf2122d57a1bbc3e05c38cbaa (refs/remotes/alt)
[my-bar 03499f9] /bar/d should be in the log
 Author: A U Thor <author@example.com>
 1 files changed, 1 insertions(+), 0 deletions(-)
...
Committed r9
	A	d
r9 = 9fdb4e27a570125e1bdab343aac8721450180fae (refs/remotes/bar)
No changes between current HEAD and refs/remotes/bar
Resetting to the latest refs/remotes/bar
[my-bar afaec01] add a new directory
 Author: A U Thor <author@example.com>
 1 files changed, 1 insertions(+), 0 deletions(-)
...
Committed r10
	A	newdir/dir
r10 = bad9fa2501995faf5582de3e4eaf5afacfafaef6 (refs/remotes/bar)
No changes between current HEAD and refs/remotes/bar
Resetting to the latest refs/remotes/bar
[my-bar 78933fd] modify a file in new directory
 Author: A U Thor <author@example.com>
 1 files changed, 1 insertions(+), 0 deletions(-)
Committing to file:///Users/trast/git-smoke/t/trash directory.t9100-git-svn-basic/svnrepo/bar ...
	M	newdir/dir
Committed r11
	M	newdir/dir
r11 = 96686c48ec2a49d3dcf4a2edf99083a8e3a1c543 (refs/remotes/bar)
No changes between current HEAD and refs/remotes/bar
Resetting to the latest refs/remotes/bar
...
[my-bar 30a7f59] commit-new-file-foo2
 Author: A U Thor <author@example.com>
 1 files changed, 1 insertions(+), 0 deletions(-)
...
Committed r12
	A	foo2
r12 = 50ca5ce9eecfa8aac210bc7319bdd31d3561ec74 (refs/remotes/bar)
No changes between current HEAD and refs/remotes/bar
Resetting to the latest refs/remotes/bar
...
[my-bar 42deaf7] update /bar/d
 Author: A U Thor <author@example.com>
 1 files changed, 1 insertions(+), 1 deletions(-)
	M	d
	M	d
r13 = 674e8de657c49c070eeef7909fd9135e03f3cc9c (refs/remotes/bar)
Done committing 1 revisions to SVN
...
r8 = 7221dfef33312d0cf2122d57a1bbc3e05c38cbaa (refs/remotes/alt)
	A	bar/d
r9 = e24ecca175c41aa3b0beddf73731c49719c6469a (refs/remotes/alt)
	A	bar/newdir/dir
r10 = f1fe91889b4097e08977573221e8d905f77624c8 (refs/remotes/alt)
	M	bar/newdir/dir
r11 = e7fe9586716c155e88d02563ef3761547b7168c7 (refs/remotes/alt)
	A	bar/foo2
r12 = dc3ca4e0ed487ee12e6e44c0ec78fd6387d851ac (refs/remotes/alt)
	M	bar/d
r13 = ce1e7e552e007f4763de779d639b5fe8e30daa88 (refs/remotes/alt)

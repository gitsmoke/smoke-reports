...
Committed revision 1.
	A	foo
r1 = 683fd8ae2900d4b1ba7f08074264a4cd2cf78371 (refs/remotes/git-svn)
...
[master 272a68c] files for enabled auto-props
...
Committed r2
	...
	A	bar
	A	exec1.sh
r2 = 44335282b0656cc54d85ad83827d91f784572425 (refs/remotes/git-svn)
...
[master 88be699] files for disabled auto-props
 Author: A U Thor <author@example.com>
 3 files changed, 3 insertions(+), 0 deletions(-)
...
Committed r3
	...
	A	world.txt
	A	zot
r3 = 29e6f11cffbc6cda55481fbfe559d8a19025170c (refs/remotes/git-svn)
No changes between current HEAD and refs/remotes/git-svn
Resetting to the latest refs/remotes/git-svn
...
Committed r4
	D	foo
	A	foo.sh
r4 = 919dfbd8677e522102a43f2def711ca7e349bb4e (refs/remotes/git-svn)
No changes between current HEAD and refs/remotes/git-svn
Resetting to the latest refs/remotes/git-svn
D    foo
A    foo.sh

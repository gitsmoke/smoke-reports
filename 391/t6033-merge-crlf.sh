...
[master (root-commit) 6594435] Initial
 Author: A U Thor <author@example.com>
 1 files changed, 1 insertions(+), 0 deletions(-)
 create mode 100644 file
[master 71d7d57] add line from a
 Author: A U Thor <author@example.com>
 1 files changed, 1 insertions(+), 1 deletions(-)
[side 3243fdd] add line from b
 Author: A U Thor <author@example.com>
 1 files changed, 1 insertions(+), 1 deletions(-)
...
HEAD is now at 6594435 Initial
Merge made by ours.
...
HEAD is now at 71d7d57 add line from a
Merging:
71d7d57 add line from a
virtual side

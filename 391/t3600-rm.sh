...
[master (root-commit) 6277b93] add normal files
...
[master 56f030f] add files with tabs and newlines
 Author: A U Thor <author@example.com>
 0 files changed, 0 insertions(+), 0 deletions(-)
...
[master e314a40] add file for rm test
 Author: A U Thor <author@example.com>
...
[master 18df194] remove file from rm test
 Author: A U Thor <author@example.com>
...
[master fd8b523] add file for rm --quiet test
 Author: A U Thor <author@example.com>
 1 files changed, 1 insertions(+), 0 deletions(-)
 create mode 100644 test-file
[master c5bb251] remove file from rm --quiet test
 Author: A U Thor <author@example.com>
 1 files changed, 0 insertions(+), 1 deletions(-)
 delete mode 100644 test-file
...
[master (root-commit) 135275c] add a file
 Author: A U Thor <author@example.com>
 1 files changed, 1 insertions(+), 0 deletions(-)
...
HEAD is now at 005b361 subdir test
rm 'frotz/nitfol'

...
[master (root-commit) 68337ba] new
...
[master (root-commit) e66a56e] new
 Author: A U Thor <author@example.com>
...
[master (root-commit) 32c5e43] initial
 Author: A U Thor <author@example.com>
...
Submodule path 'submodule': checked out 'e66a56e91558bed155070f331a0f3d795a0cdd28'
...
Submodule path 'deepsubmodule': checked out '68337ba68bbfd99d96e11818238391d7c0990f42'

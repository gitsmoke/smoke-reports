...
[master (root-commit) c9c39d4] initial
 Author: A U Thor <author@example.com>
 0 files changed, 0 insertions(+), 0 deletions(-)
 create mode 100644 camelcase
[topic ee3e91d] rename
 Author: A U Thor <author@example.com>
...
checking known breakage: 
	...
	git merge topic
HEAD is now at c9c39d4 initial
Updating c9c39d4..ee3e91d
Fast-forward
...
[master (root-commit) e45c7c4] initial
 Author: A U Thor <author@example.com>
 0 files changed, 0 insertions(+), 0 deletions(-)
 create mode 100644 "a\314\210"
[topic b1f81c7] rename
 Author: A U Thor <author@example.com>
 1 files changed, 0 insertions(+), 0 deletions(-)
...
checking known breakage: 
 ...
 git reset --hard initial &&
 git merge topic
HEAD is now at e45c7c4 initial
Updating e45c7c4..b1f81c7
Aborting

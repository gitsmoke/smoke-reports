...
[master (root-commit) 1ebd45f] initial
...
Merging:
324e007 addition
virtual b0adaa2df111990202003e748f740c8aff43f1a4
...
[master (root-commit) ec9e7cd] initial
 Author: A U Thor <author@example.com>
 1 files changed, 1 insertions(+), 0 deletions(-)
 create mode 100644 file1

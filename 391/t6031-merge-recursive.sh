...
[master (root-commit) e8eac45] initial
...
[other f677f5c] changesimplefile
 Author: A U Thor <author@example.com>
 1 files changed, 1 insertions(+), 0 deletions(-)
rm 'sub1'
[main dd5f82e] changefiletodir
 Author: A U Thor <author@example.com>

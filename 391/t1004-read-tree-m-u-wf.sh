...
[master (root-commit) 7883b5a] initial
...
[master 163bb56] master removes file2 and subdir/file2
 Author: A U Thor <author@example.com>
...
D	file2
D	subdir/file2
[side c291443] side adds file3 and removes file2
 Author: A U Thor <author@example.com>
...
HEAD is now at 163bb56 master removes file2 and subdir/file2
...
expecting success: 
	...
	git checkout side-a
HEAD is now at 163bb56 master removes file2 and subdir/file2
[side-a 65b290b] side-a changes file1
 Author: A U Thor <author@example.com>
 1 files changed, 1 insertions(+), 0 deletions(-)
[side-b a4090f9] side-b changes file2
 Author: A U Thor <author@example.com>
 1 files changed, 1 insertions(+), 0 deletions(-)
...
HEAD is now at 65b290b side-a changes file1
...
HEAD is now at 65b290b side-a changes file1
[sym-b cedf6a9] side adds a/b
 Author: A U Thor <author@example.com>
 0 files changed, 0 insertions(+), 0 deletions(-)
 create mode 100644 a/b
[sym-a e17a1ef] we add a/b
 Author: A U Thor <author@example.com>
 1 files changed, 1 insertions(+), 0 deletions(-)
...
HEAD is now at e17a1ef we add a/b
...
HEAD is now at e17a1ef we add a/b
[side-a 656a998] side-a changes file2 to directory
 Author: A U Thor <author@example.com>
...
HEAD is now at a4090f9 side-b changes file2
Trying simple merge.
...
Merging:
a4090f9 side-b changes file2
656a998 side-a changes file2 to directory

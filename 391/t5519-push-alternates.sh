...
[master (root-commit) 2399cbc] initial
...
Updating 2399cbc..3546224
Fast-forward
 file |    1 +
 1 files changed, 1 insertions(+), 0 deletions(-)
[master bb352c1] third
 Author: A U Thor <author@example.com>
...
[master 78fdffb] sixth.1
 Author: A U Thor <author@example.com>
 1 files changed, 1 insertions(+), 1 deletions(-)
[master c1c2333] sixth.2
 Author: A U Thor <author@example.com>
 1 files changed, 1 insertions(+), 0 deletions(-)
[master 53f432b] sixth.3
 Author: A U Thor <author@example.com>
 1 files changed, 1 insertions(+), 0 deletions(-)
...
53f432b45aae03c9a261f2d697fba6353ee256ad
[master f10dd87] seventh
 Author: A U Thor <author@example.com>
 1 files changed, 1 insertions(+), 1 deletions(-)

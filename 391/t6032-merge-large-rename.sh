...
[master (root-commit) 1f70d5f] initial
...
HEAD is now at 1f70d5f initial
[master e19a8f4] add=5
 Author: A U Thor <author@example.com>
...
Deleted branch test5 (was 64f67eb).
HEAD is now at 1f70d5f initial
[master 0def63b] add=5
 Author: A U Thor <author@example.com>
 5 files changed, 110 insertions(+), 0 deletions(-)
 create mode 100644 1
 create mode 100644 2
...
Deleted branch test5 (was 023857a).
HEAD is now at 1f70d5f initial
[master 0def63b] add=5
 Author: A U Thor <author@example.com>
 5 files changed, 110 insertions(+), 0 deletions(-)
...
[simple-change 0792188] unrelated-change
 Author: A U Thor <author@example.com>
 0 files changed, 0 insertions(+), 0 deletions(-)

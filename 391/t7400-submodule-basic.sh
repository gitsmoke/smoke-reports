...
expecting success: 
	...
	git branch initial
[master (root-commit) a9db5db] initial commit
...
[master (root-commit) 8cef6fe] submodule commit 1
 Author: A U Thor <author@example.com>
...
[master (root-commit) 40e6b21] Ignore everything
 Author: A U Thor <author@example.com>
 1 files changed, 1 insertions(+), 0 deletions(-)
...
rev1: 8cef6feda2508ec6b3d8648453a8628ba18fcbb4
...
expecting success: 
	git submodule status >lines &&
	grep "^-$rev1" lines
-8cef6feda2508ec6b3d8648453a8628ba18fcbb4 init
...
Submodule path 'init': checked out '8cef6feda2508ec6b3d8648453a8628ba18fcbb4'
...
expecting success: 
 ...
 8cef6feda2508ec6b3d8648453a8628ba18fcbb4 init (rev-1)
...
[detached HEAD 6a4eab4] submodule commit 2
 Author: A U Thor <author@example.com>
 1 files changed, 1 insertions(+), 0 deletions(-)
 create mode 100644 b
+6a4eab4f6f439116bee24a25d3a0e80dcae50198 init (rev-1-1-g6a4eab4)
...
+Subproject commit 6a4eab4f6f439116bee24a25d3a0e80dcae50198
...
[detached HEAD 9ae2d65] change subproject
 Author: A U Thor <author@example.com>
 1 files changed, 1 insertions(+), 0 deletions(-)
 create mode 100644 s
[master 4d308ec] change init
 Author: A U Thor <author@example.com>
...
Submodule path 'init': checked out '9ae2d654dbd6287e21a0cd20017c189e3857f24c'
...
HEAD is now at 8b3b954 super commit 1
...
HEAD is now at 8b3b954 super commit 1
[second 391a0da] commit subproject
 Author: A U Thor <author@example.com>
 1 files changed, 1 insertions(+), 1 deletions(-)
diff --git a/init b/init
index 9ae2d65..7914f74 160000
--- a/init
+++ b/init
@@ -1 +1 @@
-Subproject commit 9ae2d654dbd6287e21a0cd20017c189e3857f24c
+Subproject commit 7914f74be390c41d7c1545571de0a3680c6b1db7
...
expecting success: 
	...
	test ! -d init &&
	git checkout second
HEAD is now at 391a0da commit subproject
...
[master (root-commit) 6203f08] repo commit 1
 Author: A U Thor <author@example.com>
 1 files changed, 1 insertions(+), 0 deletions(-)

...
HEAD is now at 7115573 dir to symlink
rm 'a/b'
[detached HEAD f3ac6f2] untracked symlink remains
 Author: A U Thor <author@example.com>
...
HEAD is now at a73e298 base
[detached HEAD afee50c] x
 Author: A U Thor <author@example.com>
 1 files changed, 1 insertions(+), 0 deletions(-)
...
HEAD is now at 1a1446f Merge branch 'master' into HEAD
Merging:
afee50c x
virtual master
...
HEAD is now at 5f96333 Merge commit 'baseline^0' into HEAD
Merging:
7115573 dir to symlink
virtual baseline^0
found 1 common ancestor(s):
a73e298 base
...
checking known breakage: 
	...
	test -f a/b/c/e &&
	test -f a/b-2/c/d
HEAD is now at 5adaf76 Merge commit 'baseline^0' into HEAD
Trying really trivial in-index merge...
Nope.
Trying simple merge.
Simple merge failed, trying Automatic merge.
...
expecting success: 
	...
	test -f a/b/c/e &&
	test -f a/b-2/c/d
HEAD is now at eaa76f7 Merge branch 'master' into HEAD
Merging:
afee50c x
virtual master
found 1 common ancestor(s):
...
HEAD is now at afee50c x
[detached HEAD 0e7f8c4] dir a/b-2 to symlink
 Author: A U Thor <author@example.com>
...
HEAD is now at 0e7f8c4 dir a/b-2 to symlink
Trying really trivial in-index merge...
Nope.
Trying simple merge.
Simple merge failed, trying Automatic merge.
...
HEAD is now at 6331b2d Merge commit 'test2' into HEAD
Merging:
afee50c x
virtual test2
found 1 common ancestor(s):
...
expecting success: 
	...
	test -h a/b-2 &&
	test -f a/b/c/d
HEAD is now at 8adb22a Merge commit 'test2' into HEAD
Merging:
0e7f8c4 dir a/b-2 to symlink
virtual baseline^0
found 1 common ancestor(s):
a73e298 base

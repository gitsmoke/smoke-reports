...
git checkout master
[master (root-commit) fc061df] initial has A and M
 Author: A U Thor <author@example.com>
 2 files changed, 30 insertions(+), 0 deletions(-)
 create mode 100644 A
 create mode 100644 M
[master 66f5d19] master updates A
 Author: A U Thor <author@example.com>
 1 files changed, 1 insertions(+), 1 deletions(-)
[yellow 1e9fc37] yellow removes M
 Author: A U Thor <author@example.com>
 1 files changed, 0 insertions(+), 15 deletions(-)
 delete mode 100644 M
[white f350e65] white renames A->B, M->N
 Author: A U Thor <author@example.com>
 2 files changed, 2 insertions(+), 2 deletions(-)
 rename A => B (93%)
 rename M => N (93%)
[red 333adec] red renames A->B, M->N
 Author: A U Thor <author@example.com>
 2 files changed, 2 insertions(+), 2 deletions(-)
 rename A => B (93%)
 rename M => N (93%)
[blue d1033ad] blue renames A->C, M->N
 Author: A U Thor <author@example.com>
 2 files changed, 2 insertions(+), 2 deletions(-)
 rename A => C (93%)
 rename M => N (93%)
...
Merging:
66f5d19 master updates A
virtual f350e659ae34086fba16b34a2ada233cef3abcdb
found 1 common ancestor(s):
fc061df initial has A and M
Auto-merging B
...
expecting success: 
	...
	git diff --exit-code white N
HEAD is now at 66f5d19 master updates A
Merging:
333adec red renames A->B, M->N
virtual f350e659ae34086fba16b34a2ada233cef3abcdb
found 1 common ancestor(s):
fc061df initial has A and M
Auto-merging B
...
HEAD is now at 333adec red renames A->B, M->N
! [blue] blue renames A->C, M->N
 ! [change] changed
  ! [change+rename] changed and renamed
   ! [master] master updates A
...
Merging:
333adec red renames A->B, M->N
virtual 66f5d1927560ef657d6d653adff11e12a1e69cd7
found 1 common ancestor(s):
fc061df initial has A and M
Auto-merging B
CONFLICT (content): Merge conflict in B
...
Merging:
333adec red renames A->B, M->N
virtual d1033ad1bbf7d8fcc37863705d4c2b6a5ac206d5
found 1 common ancestor(s):
fc061df initial has A and M
Skipped N (merged same as existing)
CONFLICT (rename/rename): Rename "A"->"B" in branch "HEAD" rename "A"->"C" in "d1033ad1bbf7d8fcc37863705d4c2b6a5ac206d5"
Automatic merge failed; fix conflicts and then commit the result.
g : red changes a line
...
+++++*+ [red^] initial has A and M
Merging:
f350e65 white renames A->B, M->N
virtual 333adec3e282eb00e34f88735c94cc7f2d7095de
found 1 common ancestor(s):
fc061df initial has A and M
Auto-merging B
CONFLICT (content): Merge conflict in B
...
HEAD is now at f350e65 white renames A->B, M->N
...
Merging:
66f5d19 master updates A
virtual 1e9fc371b5e5428add26708c3ab1a44f63aef4bb
found 1 common ancestor(s):
fc061df initial has A and M
Removing M
...
expecting success: 
	...
	git reset --hard anchor
HEAD is now at 66f5d19 master updates A
Updated tag 'anchor' (was 66f5d19)
! [blue] blue renames A->C, M->N
 ! [change] changed
  ! [change+rename] changed and renamed
   ! [master] master updates A
...
Merge made by recursive.
 A |    2 +-
 1 files changed, 1 insertions(+), 1 deletions(-)
HEAD is now at 1e9fc37 yellow removes M
...
HEAD is now at fa2acd0 changed and renamed
Skipped B (merged same as existing)
...
HEAD is now at c67dba6 Merge branch 'change+rename' into change
rm 'B'
rm 'M'
[dir-in-way (root-commit) b3b7895] Common commmit
 Author: A U Thor <author@example.com>
...
[dir-in-way 98a22ee] Commit to merge, with dir in the way
 Author: A U Thor <author@example.com>
 2 files changed, 2 insertions(+), 0 deletions(-)
rm 'dir/file-in-the-way'
[dir-not-in-way 6e17cdd] Commit to merge, with dir removed
 Author: A U Thor <author@example.com>
 2 files changed, 1 insertions(+), 1 deletions(-)
 delete mode 100644 dir/file-in-the-way
rm 'dir/file-in-the-way'
rm 'sub/file'
[renamed-file-has-no-conflicts 4139d6f] Independent change
 Author: A U Thor <author@example.com>
 2 files changed, 1 insertions(+), 2 deletions(-)
 rename sub/file => dir (79%)
 delete mode 100644 dir/file-in-the-way
rm 'dir/file-in-the-way'
[renamed-file-has-conflicts 3648ba7] Conflicting change
 Author: A U Thor <author@example.com>
 2 files changed, 1 insertions(+), 1 deletions(-)
...
HEAD is now at 3648ba7 Conflicting change
Merging:
4139d6f Independent change
virtual dir-not-in-way
found 1 common ancestor(s):
b3b7895 Common commmit
...
HEAD is now at 784f9c5 Merge branch 'dir-not-in-way' into HEAD
...
HEAD is now at 4139d6f Independent change
...
HEAD is now at 98a22ee Commit to merge, with dir in the way
Merging:
3648ba7 Conflicting change
virtual dir-not-in-way
found 1 common ancestor(s):
b3b7895 Common commmit
Removing dir to make room for subdirectory; may re-add later.
...
HEAD is now at 3648ba7 Conflicting change
Merging:
98a22ee Commit to merge, with dir in the way
...
rm 'n.stages'
rm 'sub/file'
[rename-dest (root-commit) d350b5e] Common commmit
 Author: A U Thor <author@example.com>
 1 files changed, 1 insertions(+), 0 deletions(-)
 create mode 100644 one/file
[rename-dest 1428988] Renamed to destdir
 Author: A U Thor <author@example.com>
 1 files changed, 0 insertions(+), 0 deletions(-)
 rename one/file => destdir (100%)
rm 'one/file'
[source-conflict f476901] Conflicts in the way
 Author: A U Thor <author@example.com>
...
HEAD is now at f476901 Conflicts in the way
Merging:
1428988 Renamed to destdir
virtual source-conflict
found 1 common ancestor(s):
d350b5e Common commmit
...
HEAD is now at 1428988 Renamed to destdir
rm 'destdir'
[rename-two (root-commit) d727df9] Common commmit
 Author: A U Thor <author@example.com>
 2 files changed, 2 insertions(+), 0 deletions(-)
 create mode 100644 one/file
 create mode 100644 two/file
rm 'one/file'
[rename-two 9077f91] Rename two/file -> one
 Author: A U Thor <author@example.com>
 2 files changed, 0 insertions(+), 1 deletions(-)
 rename two/file => one (100%)
 delete mode 100644 one/file
rm 'two/file'
[rename-one 452ce95] Rename one/file -> two
 Author: A U Thor <author@example.com>
 2 files changed, 0 insertions(+), 1 deletions(-)
...
Merging:
452ce95 Rename one/file -> two
virtual rename-two
found 1 common ancestor(s):
d727df9 Common commmit
...
expecting success: 
	...
	test "other" = $(cat one) &&
	test "stuff" = $(cat two)
HEAD is now at 452ce95 Rename one/file -> two
Merging:
452ce95 Rename one/file -> two
virtual rename-two
found 1 common ancestor(s):
...
HEAD is now at 452ce95 Rename one/file -> two
rm 'two'
[first-rename (root-commit) 29cf2ca] Common commmit
 Author: A U Thor <author@example.com>
 1 files changed, 1 insertions(+), 0 deletions(-)
 create mode 100644 original
[first-rename 3971608] Put two/file in the way, rename to one
 Author: A U Thor <author@example.com>
 1 files changed, 0 insertions(+), 0 deletions(-)
 rename original => one (100%)
 create mode 100644 two/file
[second-rename c393b99] Put one/file in the way, rename to two
 Author: A U Thor <author@example.com>
 1 files changed, 0 insertions(+), 0 deletions(-)
 create mode 100644 one/file
...
expecting success: 
	...
	! test -f original
Merging:
3971608 Put two/file in the way, rename to one
virtual second-rename
found 1 common ancestor(s):
29cf2ca Common commmit
...
HEAD is now at 3971608 Put two/file in the way, rename to one
rm 'one'
rm 'two/file'
[first-rename-redo (root-commit) b7793cf] Common commmit
 Author: A U Thor <author@example.com>
 1 files changed, 1 insertions(+), 0 deletions(-)
 create mode 100644 one/file
 create mode 100644 original
 create mode 100644 two/file
rm 'one/file'
[first-rename-redo 5430071] Rename to one
 Author: A U Thor <author@example.com>
 1 files changed, 0 insertions(+), 0 deletions(-)
 rename original => one (100%)
 delete mode 100644 one/file
rm 'two/file'
[second-rename-redo fdec46a] Rename to two
 Author: A U Thor <author@example.com>
 1 files changed, 0 insertions(+), 0 deletions(-)
 rename original => two (100%)
 delete mode 100644 two/file
...
expecting success: 
	...
	! test -f original
Merging:
5430071 Rename to one
virtual second-rename-redo
found 1 common ancestor(s):
b7793cf Common commmit
Removing one to make room for subdirectory; may re-add later.
Removing two/file

...
expecting success: 
	...
	git add hello &&
	git commit -m master
[master (root-commit) 05d3203] initial
...
[master (root-commit) 437da51] initial git-gui
 Author: A U Thor <author@example.com>
 1 files changed, 1 insertions(+), 0 deletions(-)
...
[master (root-commit) ff19377] initial git
 Author: A U Thor <author@example.com>
 1 files changed, 1 insertions(+), 0 deletions(-)
...
Updating gui
[master 56e13a4] Merge git-gui as our subdirectory
 Author: A U Thor <author@example.com>
ok 4 - initial merge
...
expecting success: 
	...
	test_cmp expected actual
M	git-gui.sh
[master2 6121d9e] update git-gui
 Author: A U Thor <author@example.com>
 1 files changed, 1 insertions(+), 1 deletions(-)
Merging:
56e13a4 Merge git-gui as our subdirectory
virtual 6121d9e4e1fca60b44d0a442814d481fb08a830c
found 1 common ancestor(s):
437da51 initial git-gui
Merge made by subtree.
...
HEAD is now at 56e13a4 Merge git-gui as our subdirectory
Already up-to-date.
[master2 dfa49e7] Merge git-gui2 as our subdirectory
 Author: A U Thor <author@example.com>
 1 files changed, 1 insertions(+), 0 deletions(-)
...
HEAD is now at dfa49e7 Merge git-gui2 as our subdirectory
Merging:
dfa49e7 Merge git-gui2 as our subdirectory
virtual 6121d9e4e1fca60b44d0a442814d481fb08a830c
found 1 common ancestor(s):
437da51 initial git-gui

...
[master (root-commit) 323f047] Initial commit.
 Author: A U Thor <author@example.com>
 1 files changed, 1 insertions(+), 0 deletions(-)
 create mode 100644 A
[master 71bc051] Second commit.
 Author: A U Thor <author@example.com>
 1 files changed, 1 insertions(+), 0 deletions(-)
...
expecting success: git branch -d d/e/f &&
	 test ! -f .git/refs/heads/d/e/f &&
	 test ! -f .git/logs/refs/heads/d/e/f
Deleted branch d/e/f (was 71bc051).
...
expecting success: git branch l/m &&
        git branch -d l/m &&
        git branch l
Deleted branch l/m (was 71bc051).
...
Deleted branch s/t (was 71bc051).
...
Deleted branch my7 (was 71bc051).
...
71bc0518b1540d4d9e9c158f6f7deca9148ac20e
...
expecting success: 
	...
	git branch -d my8
Deleted branch my8 (was 71bc051).

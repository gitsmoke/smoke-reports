...
expecting success: 
	...
	echo happy.
[master (root-commit) 52811d8] initial
...
expecting success: 
	...
	git reset --hard HEAD^
HEAD is now at 52811d8 initial
...
[master ab397f9] Add .gitattributes
 Author: A U Thor <author@example.com>
...
[master 3fba744] initial
 Author: A U Thor <author@example.com>
 1 files changed, 1 insertions(+), 0 deletions(-)
[master a1207b3] second
 Author: A U Thor <author@example.com>
...
[master 94231f4] alllf, allcrlf and mixed only
 Author: A U Thor <author@example.com>

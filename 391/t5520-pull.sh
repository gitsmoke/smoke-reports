...
[master (root-commit) 52ec45d] original
...
[master 1b8831d] updated
 Author: A U Thor <author@example.com>
 1 files changed, 1 insertions(+), 1 deletions(-)
Your branch is behind 'master' by 1 commit, and can be fast-forwarded.
Updating 52ec45d..1b8831d
Fast-forward
 file |    2 +-
 1 files changed, 1 insertions(+), 1 deletions(-)
...
[second d57c5fb] modified
 Author: A U Thor <author@example.com>
 1 files changed, 1 insertions(+), 1 deletions(-)
HEAD is now at 52ec45d original
Updating 52ec45d..d57c5fb
Fast-forward
 file |    2 +-
 1 files changed, 1 insertions(+), 1 deletions(-)
...
HEAD is now at 52862ec new file
First, rewinding head to replay your work on top of it...
Applying: new file
...
HEAD is now at d57c5fb modified
[copy 5d6dfe6] conflict
 Author: A U Thor <author@example.com>
 1 files changed, 1 insertions(+), 1 deletions(-)
[to-rebase 2ab9cbe] to-rebase
 Author: A U Thor <author@example.com>
 1 files changed, 1 insertions(+), 1 deletions(-)
First, rewinding head to replay your work on top of it...
Applying: new file
...
HEAD is now at 2ab9cbe to-rebase
First, rewinding head to replay your work on top of it...
Applying: new file
Applying: to-rebase
...
[master (root-commit) 98934e6] Initial revision
 Author: A U Thor <author@example.com>
...
[master 8571b93] 5->43
 Author: A U Thor <author@example.com>
 1 files changed, 1 insertions(+), 1 deletions(-)
[master 503ae71] Make it bigger
 Author: A U Thor <author@example.com>
 1 files changed, 1 insertions(+), 1 deletions(-)
[master cdba60b] Independent discovery of 5->43
 Author: A U Thor <author@example.com>
 1 files changed, 1 insertions(+), 1 deletions(-)
...
HEAD is now at 503ae71 Make it bigger
Cloning into bare repository src-replace.git...
done.
[master f9f32af] Change 2
 Author: A U Thor <author@example.com>
 1 files changed, 2 insertions(+), 2 deletions(-)
[master ba05dba] Change 3
 Author: A U Thor <author@example.com>
 1 files changed, 2 insertions(+), 2 deletions(-)
[master 99b53d4] Change 4
 Author: A U Thor <author@example.com>
 1 files changed, 3 insertions(+), 3 deletions(-)
[master 3d1b39b] Modified Change 4
 Author: A U Thor <author@example.com>
 1 files changed, 3 insertions(+), 3 deletions(-)

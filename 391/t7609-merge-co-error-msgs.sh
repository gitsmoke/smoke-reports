...
expecting success: 
	...
	echo other >four &&
	echo other >five
[master (root-commit) f5c36d3] First
 Author: A U Thor <author@example.com>
 1 files changed, 1 insertions(+), 0 deletions(-)
 create mode 100644 one
[branch 7f6a65d] Second
 Author: A U Thor <author@example.com>
...
expecting success: 
	...
	git reset --hard HEAD^
Updating f5c36d3..7f6a65d
Aborting
[master a1724d3] empty
 Author: A U Thor <author@example.com>
Aborting
HEAD is now at f5c36d3 First
...
[master (root-commit) e95b366] init
 Author: A U Thor <author@example.com>
...
rm 'rep/foo'
rm 'rep2/foo'
[branch 60e75c5] added test as a file
 Author: A U Thor <author@example.com>

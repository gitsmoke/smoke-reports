...
[master (root-commit) fc701b8] hello
 Author: A U Thor <author@example.com>
 1 files changed, 1 insertions(+), 0 deletions(-)
 create mode 100644 hello
[master fd77aa1] hello world
 Author: A U Thor <author@example.com>
 1 files changed, 1 insertions(+), 0 deletions(-)
[master 14c3a4c] goodbye
 Author: A U Thor <author@example.com>
 1 files changed, 1 insertions(+), 0 deletions(-)
[skip-reference 5c3f9f5] we should skip this
 Author: A U Thor <author@example.com>
 1 files changed, 1 insertions(+), 1 deletions(-)
[skip-reference a3fa9a1] this should not be skipped
 Author: A U Thor <author@example.com>
 1 files changed, 1 insertions(+), 0 deletions(-)
...
HEAD is now at 14c3a4c goodbye
...
HEAD is now at a3fa9a1 this should not be skipped
First, rewinding head to replay your work on top of it...
Applying: we should skip this
Using index info to reconstruct a base tree...
Falling back to patching base and 3-way merge...
...
Applying: we should skip this
Applying: this should not be skipped
HEAD is now at b72ef8b this should not be skipped
...
Merging:
14c3a4c goodbye
a3fa9a1 this should not be skipped
found 1 common ancestor(s):
5c3f9f5 we should skip this
[detached HEAD b35e7e0] this should not be skipped
 Author: A U Thor <author@example.com>
 1 files changed, 1 insertions(+), 0 deletions(-)
 create mode 100644 cow
...
Merging:
b35e7e0 this should not be skipped
a3fa9a1 this should not be skipped
found 1 common ancestor(s):
5c3f9f5 we should skip this

...
[master (root-commit) 5c48e24] Initial
 Author: A U Thor <author@example.com>
 1 files changed, 1 insertions(+), 0 deletions(-)
 create mode 100644 file
[master bc8e2d3] add line from a
 Author: A U Thor <author@example.com>
 1 files changed, 1 insertions(+), 1 deletions(-)
[side c7c288a] add line from b
 Author: A U Thor <author@example.com>
 1 files changed, 1 insertions(+), 1 deletions(-)
...
HEAD is now at 5c48e24 Initial
Merge made by ours.
...
HEAD is now at bc8e2d3 add line from a
Merging:
bc8e2d3 add line from a
virtual side

...
Merging:
2fe990f Branch2-1
virtual 6064465e0aa47a5e51610ae28dafbff3cb8476aa
...
expecting success: echo "evil merge." >>file &&
     git commit -a --amend
[branch2 17691f4] Merge branch 'branch1' into branch2

...
[master (root-commit) 3722b78] added file1
 Author: A U Thor <author@example.com>
 2 files changed, 2 insertions(+), 0 deletions(-)
 create mode 100644 file1
 create mode 100644 subdir/file3
[branch1 da15886] branch1 changes
 Author: A U Thor <author@example.com>
 3 files changed, 3 insertions(+), 2 deletions(-)
 create mode 100644 file2
[master 4c1913b] master updates
 Author: A U Thor <author@example.com>
 3 files changed, 3 insertions(+), 2 deletions(-)
 create mode 100644 file2
...
[test1 1e02c71] branch1 resolved with mergetool
 Author: A U Thor <author@example.com>
...
x")" &&
    ...
    git reset --hard
[test2 8f27157] branch1 resolved with mergetool - autocrlf
 Author: A U Thor <author@example.com>
HEAD is now at 8f27157 branch1 resolved with mergetool - autocrlf
...
[test3 65de1ba] branch1 resolved with mergetool - subdir
 Author: A U Thor <author@example.com>
...
HEAD is now at da15886 branch1 changes
...
Normal merge conflict for 'subdir/file3':
  {local}: modified
  {remote}: modified
[test4 45d646b] branch2 resolved by mergetool from subdir
 Author: A U Thor <author@example.com>

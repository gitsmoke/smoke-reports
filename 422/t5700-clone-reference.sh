...
[master (root-commit) e27b80d] initial
...
Merging:
95c387b addition
virtual 8300438d0b0f78395ec356977d7de64731c2e85f
...
[master (root-commit) a4d5345] initial
 Author: A U Thor <author@example.com>
 1 files changed, 1 insertions(+), 0 deletions(-)
 create mode 100644 file1

...
git checkout master
[master (root-commit) a79435a] initial has A and M
 Author: A U Thor <author@example.com>
 2 files changed, 30 insertions(+), 0 deletions(-)
 create mode 100644 A
 create mode 100644 M
[white 2995cba] white renames A->B, M->N
 Author: A U Thor <author@example.com>
 2 files changed, 2 insertions(+), 2 deletions(-)
 rename A => B (93%)
 rename M => N (93%)
[red b7bb128] red creates R
 Author: A U Thor <author@example.com>
 1 files changed, 1 insertions(+), 0 deletions(-)
 create mode 100644 R
[blue b2217d1] blue modify A
 Author: A U Thor <author@example.com>
...
Merging:
b7bb128 red creates R
virtual white
found 1 common ancestor(s):
a79435a initial has A and M
Auto-merging B
Auto-merging N

...
r1 = 081ff15a2ecf4802f535d57fbc569f49f4398aa7 (refs/remotes/git-svn)
...
[test-rmdir 81859b3] remove another
 ...
 delete mode 100644 deeply/nested/directory/number/2/another
	...
	D	deeply/nested/directory/number/2/another
	D	deeply/nested/directory/number/2/
r2 = 7267f55a13499fff7f01966e302a806fc80bfcad (refs/remotes/git-svn)

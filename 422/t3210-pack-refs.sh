...
expecting success: git branch g/h &&
     ...
     git pack-refs --all &&
     git branch -d g
Deleted branch g/h (was 6033b5b).
Deleted branch g (was 6033b5b).
...
expecting success: git branch k/l &&
     ...
     git branch -d k/lm &&
     git branch k
Deleted branch k/l (was 6033b5b).
Deleted branch k/l/m (was 6033b5b).
Deleted branch k/lm (was 6033b5b).
...
expecting success: git branch n/o &&
     ...
     git branch -d n/o/p &&
     git branch n
Deleted branch n/o (was 6033b5b).
Deleted branch n/op (was 6033b5b).
Deleted branch n/o/p (was 6033b5b).

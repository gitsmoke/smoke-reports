...
[master (root-commit) 6033b5b] Initial commit.
 Author: A U Thor <author@example.com>
 1 files changed, 1 insertions(+), 0 deletions(-)
 create mode 100644 A
[master f8d9d1b] Second commit.
 Author: A U Thor <author@example.com>
 1 files changed, 1 insertions(+), 0 deletions(-)
...
expecting success: git branch -d d/e/f &&
	 test ! -f .git/refs/heads/d/e/f &&
	 test ! -f .git/logs/refs/heads/d/e/f
Deleted branch d/e/f (was f8d9d1b).
...
expecting success: git branch l/m &&
        git branch -d l/m &&
        git branch l
Deleted branch l/m (was f8d9d1b).
...
Deleted branch s/t (was f8d9d1b).
...
Deleted branch my7 (was f8d9d1b).
...
f8d9d1be27b36a51372970d44f33a0a5c1106af8
...
expecting success: 
	...
	git branch -d my8
Deleted branch my8 (was f8d9d1b).

...
[master (root-commit) 6d3a9dd] snapshot
...
HEAD is now at d6da120 yet another
[master 03e7230] hello 1
 Author: A U Thor <author@example.com>
 1 files changed, 1 insertions(+), 1 deletions(-)
...
HEAD is now at 03e7230 hello 1
[master 203acbf] base
 Author: A U Thor <author@example.com>
...
HEAD is now at 203acbf base
[master 8a8683c] empty
 Author: A U Thor <author@example.com>
...
HEAD is now at 8a8683c empty
[master 8e15c92] one side
 Author: A U Thor <author@example.com>
 1 files changed, 1 insertions(+), 9 deletions(-)
[detached HEAD 7c9c3a7] the other side
 Author: A U Thor <author@example.com>
 1 files changed, 1 insertions(+), 9 deletions(-)
Merging:
7c9c3a7 the other side
virtual master
...
expecting success: 
	...
	test_cmp expected current
HEAD is now at 7c9c3a7 the other side
[detached HEAD 5ada178] initial
 Author: A U Thor <author@example.com>
 1 files changed, 1 insertions(+), 1 deletions(-)

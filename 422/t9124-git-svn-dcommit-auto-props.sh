...
Committed revision 1.
	A	foo
r1 = 7a058492748030cf3a9f6678bdcb837042748fea (refs/remotes/git-svn)
...
[master 25da61b] files for enabled auto-props
...
Committed r2
	...
	A	bar
	A	exec1.sh
r2 = 420ba860842a05be2a74b4b69dc04372f01d4979 (refs/remotes/git-svn)
...
[master e0f955b] files for disabled auto-props
 Author: A U Thor <author@example.com>
 3 files changed, 3 insertions(+), 0 deletions(-)
...
Committed r3
	...
	A	world.txt
	A	zot
r3 = 2fbd189896fa9f7282ad2c5ad002872ba3e6eaf5 (refs/remotes/git-svn)
No changes between current HEAD and refs/remotes/git-svn
Resetting to the latest refs/remotes/git-svn
...
Committed r4
	D	foo
	A	foo.sh
r4 = 0f2d33200e466bd5b8a75cf2122cc82483c1d531 (refs/remotes/git-svn)
No changes between current HEAD and refs/remotes/git-svn
Resetting to the latest refs/remotes/git-svn
D    foo
A    foo.sh

...
[master (root-commit) cda3bd4] Initial.
 Author: A <A@test.git>
...
Merging:
25b1376 Branch2-1
virtual 933e2b6fb49c2ce7c749064d51effa14d8bb6156
...
expecting success: echo "evil merge." >>file &&
     git commit -a --amend
[branch2 a239711] Merge branch 'branch1' into branch2

...
[master (root-commit) feec9ae] initial
...
[master 73285e9] master removes file2 and subdir/file2
 Author: A U Thor <author@example.com>
...
D	file2
D	subdir/file2
[side de90180] side adds file3 and removes file2
 Author: A U Thor <author@example.com>
...
HEAD is now at 73285e9 master removes file2 and subdir/file2
...
expecting success: 
	...
	git checkout side-a
HEAD is now at 73285e9 master removes file2 and subdir/file2
[side-a 2e8ee94] side-a changes file1
 Author: A U Thor <author@example.com>
 1 files changed, 1 insertions(+), 0 deletions(-)
[side-b eb7438d] side-b changes file2
 Author: A U Thor <author@example.com>
 1 files changed, 1 insertions(+), 0 deletions(-)
...
HEAD is now at 2e8ee94 side-a changes file1
...
HEAD is now at 2e8ee94 side-a changes file1
[sym-b a966781] side adds a/b
 Author: A U Thor <author@example.com>
 0 files changed, 0 insertions(+), 0 deletions(-)
 create mode 100644 a/b
[sym-a f5d3590] we add a/b
 Author: A U Thor <author@example.com>
 1 files changed, 1 insertions(+), 0 deletions(-)
...
HEAD is now at f5d3590 we add a/b
...
HEAD is now at f5d3590 we add a/b
[side-a 5eef313] side-a changes file2 to directory
 Author: A U Thor <author@example.com>
...
HEAD is now at eb7438d side-b changes file2
Trying simple merge.
...
Merging:
eb7438d side-b changes file2
5eef313 side-a changes file2 to directory

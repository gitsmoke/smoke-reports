...
git checkout master
[master (root-commit) 3b50fb4] initial has A and M
 Author: A U Thor <author@example.com>
 2 files changed, 30 insertions(+), 0 deletions(-)
 create mode 100644 A
 create mode 100644 M
[master 3c4879c] master updates A
 Author: A U Thor <author@example.com>
 1 files changed, 1 insertions(+), 1 deletions(-)
[yellow 33ae91c] yellow removes M
 Author: A U Thor <author@example.com>
 1 files changed, 0 insertions(+), 15 deletions(-)
 delete mode 100644 M
[white 7ef5a9e] white renames A->B, M->N
 Author: A U Thor <author@example.com>
 2 files changed, 2 insertions(+), 2 deletions(-)
 rename A => B (93%)
 rename M => N (93%)
[red df37a73] red renames A->B, M->N
 Author: A U Thor <author@example.com>
 2 files changed, 2 insertions(+), 2 deletions(-)
 rename A => B (93%)
 rename M => N (93%)
[blue 307b662] blue renames A->C, M->N
 Author: A U Thor <author@example.com>
 2 files changed, 2 insertions(+), 2 deletions(-)
 rename A => C (93%)
 rename M => N (93%)
...
Merging:
3c4879c master updates A
virtual 7ef5a9e1577107ef3a5b47367deb19977deda7b2
found 1 common ancestor(s):
3b50fb4 initial has A and M
Auto-merging B
...
expecting success: 
	...
	git diff --exit-code white N
HEAD is now at 3c4879c master updates A
Merging:
df37a73 red renames A->B, M->N
virtual 7ef5a9e1577107ef3a5b47367deb19977deda7b2
found 1 common ancestor(s):
3b50fb4 initial has A and M
Auto-merging B
...
expecting success: 
	...
	git diff --exit-code white N
HEAD is now at df37a73 red renames A->B, M->N
! [blue] blue renames A->C, M->N
 ! [change] changed
  ! [change+rename] changed and renamed
   ! [master] master updates A
...
Merging:
df37a73 red renames A->B, M->N
virtual 3c4879cb0d436a29920d87d58546d57be4b216a1
found 1 common ancestor(s):
3b50fb4 initial has A and M
Auto-merging B
CONFLICT (content): Merge conflict in B
...
Merging:
df37a73 red renames A->B, M->N
virtual 307b6629adcbd1e756840b57db9aff025d9465f2
found 1 common ancestor(s):
3b50fb4 initial has A and M
Skipped N (merged same as existing)
CONFLICT (rename/rename): Rename "A"->"B" in branch "HEAD" rename "A"->"C" in "307b6629adcbd1e756840b57db9aff025d9465f2"
Automatic merge failed; fix conflicts and then commit the result.
g : red changes a line
...
+++++*+ [yellow^] initial has A and M
Merging:
7ef5a9e white renames A->B, M->N
virtual df37a73b3c7158fe2d9583dc6309165eef6b80a2
found 1 common ancestor(s):
3b50fb4 initial has A and M
Auto-merging B
CONFLICT (content): Merge conflict in B
...
HEAD is now at 7ef5a9e white renames A->B, M->N
...
Merging:
3c4879c master updates A
virtual 33ae91cdcff697aa4a2911f66af4ce867f9df475
found 1 common ancestor(s):
3b50fb4 initial has A and M
Removing M
...
HEAD is now at 3c4879c master updates A
Updated tag 'anchor' (was 3c4879c)
! [blue] blue renames A->C, M->N
 ! [change] changed
  ! [change+rename] changed and renamed
   ! [master] master updates A
...
Merge made by recursive.
 A |    2 +-
 1 files changed, 1 insertions(+), 1 deletions(-)
HEAD is now at 33ae91c yellow removes M
...
HEAD is now at 6a13c35 changed and renamed
Skipped B (merged same as existing)
...
HEAD is now at 5551252 Merge branch 'change+rename' into change
rm 'B'
rm 'M'
[dir-in-way (root-commit) 7ff9e59] Common commmit
 Author: A U Thor <author@example.com>
...
[dir-in-way 4788360] Commit to merge, with dir in the way
 Author: A U Thor <author@example.com>
 2 files changed, 2 insertions(+), 0 deletions(-)
rm 'dir/file-in-the-way'
[dir-not-in-way b0bd4db] Commit to merge, with dir removed
 Author: A U Thor <author@example.com>
 2 files changed, 1 insertions(+), 1 deletions(-)
 delete mode 100644 dir/file-in-the-way
rm 'dir/file-in-the-way'
rm 'sub/file'
[renamed-file-has-no-conflicts e9063d9] Independent change
 Author: A U Thor <author@example.com>
 2 files changed, 1 insertions(+), 2 deletions(-)
 rename sub/file => dir (79%)
 delete mode 100644 dir/file-in-the-way
rm 'dir/file-in-the-way'
[renamed-file-has-conflicts ecaa100] Conflicting change
 Author: A U Thor <author@example.com>
 2 files changed, 1 insertions(+), 1 deletions(-)
...
HEAD is now at ecaa100 Conflicting change
Merging:
e9063d9 Independent change
virtual dir-not-in-way
found 1 common ancestor(s):
7ff9e59 Common commmit
...
HEAD is now at d75b18b Merge branch 'dir-not-in-way' into HEAD
...
HEAD is now at e9063d9 Independent change
...
HEAD is now at 4788360 Commit to merge, with dir in the way
Merging:
ecaa100 Conflicting change
virtual dir-not-in-way
found 1 common ancestor(s):
7ff9e59 Common commmit
Removing dir to make room for subdirectory; may re-add later.
...
HEAD is now at ecaa100 Conflicting change
Merging:
4788360 Commit to merge, with dir in the way
...
rm 'n.stages'
rm 'sub/file'
[rename-dest (root-commit) 6e44a52] Common commmit
 Author: A U Thor <author@example.com>
 1 files changed, 1 insertions(+), 0 deletions(-)
 create mode 100644 one/file
[rename-dest de564db] Renamed to destdir
 Author: A U Thor <author@example.com>
 1 files changed, 0 insertions(+), 0 deletions(-)
 rename one/file => destdir (100%)
rm 'one/file'
[source-conflict ec072a8] Conflicts in the way
 Author: A U Thor <author@example.com>
...
HEAD is now at ec072a8 Conflicts in the way
Merging:
de564db Renamed to destdir
virtual source-conflict
found 1 common ancestor(s):
6e44a52 Common commmit
...
HEAD is now at de564db Renamed to destdir
rm 'destdir'
[rename-two (root-commit) b74f57c] Common commmit
 Author: A U Thor <author@example.com>
 2 files changed, 2 insertions(+), 0 deletions(-)
 create mode 100644 one/file
 create mode 100644 two/file
rm 'one/file'
[rename-two 9688140] Rename two/file -> one
 Author: A U Thor <author@example.com>
 2 files changed, 0 insertions(+), 1 deletions(-)
 rename two/file => one (100%)
 delete mode 100644 one/file
rm 'two/file'
[rename-one f69b915] Rename one/file -> two
 Author: A U Thor <author@example.com>
 2 files changed, 0 insertions(+), 1 deletions(-)
...
Merging:
f69b915 Rename one/file -> two
virtual rename-two
found 1 common ancestor(s):
b74f57c Common commmit
...
HEAD is now at f69b915 Rename one/file -> two
Merging:
f69b915 Rename one/file -> two
virtual rename-two
found 1 common ancestor(s):
...
HEAD is now at f69b915 Rename one/file -> two
rm 'two'
[first-rename (root-commit) c4de586] Common commmit
 Author: A U Thor <author@example.com>
 1 files changed, 1 insertions(+), 0 deletions(-)
 create mode 100644 original
[first-rename afafe0b] Put two/file in the way, rename to one
 Author: A U Thor <author@example.com>
 1 files changed, 0 insertions(+), 0 deletions(-)
 rename original => one (100%)
 create mode 100644 two/file
[second-rename 2620f0c] Put one/file in the way, rename to two
 Author: A U Thor <author@example.com>
 1 files changed, 0 insertions(+), 0 deletions(-)
 create mode 100644 one/file
...
expecting success: 
	...
	! test -f original
Merging:
afafe0b Put two/file in the way, rename to one
virtual second-rename
found 1 common ancestor(s):
c4de586 Common commmit
...
HEAD is now at afafe0b Put two/file in the way, rename to one
rm 'one'
rm 'two/file'
[first-rename-redo (root-commit) c715846] Common commmit
 Author: A U Thor <author@example.com>
 1 files changed, 1 insertions(+), 0 deletions(-)
 create mode 100644 one/file
 create mode 100644 original
 create mode 100644 two/file
rm 'one/file'
[first-rename-redo 3228fd7] Rename to one
 Author: A U Thor <author@example.com>
 1 files changed, 0 insertions(+), 0 deletions(-)
 rename original => one (100%)
 delete mode 100644 one/file
rm 'two/file'
[second-rename-redo fc7713b] Rename to two
 Author: A U Thor <author@example.com>
 1 files changed, 0 insertions(+), 0 deletions(-)
 rename original => two (100%)
 delete mode 100644 two/file
...
expecting success: 
	...
	! test -f original
Merging:
3228fd7 Rename to one
virtual second-rename-redo
found 1 common ancestor(s):
c715846 Common commmit
Removing one to make room for subdirectory; may re-add later.
Removing two/file

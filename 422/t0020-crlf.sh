...
expecting success: 
	...
	echo happy.
[master (root-commit) fef692c] initial
...
HEAD is now at fef692c initial
...
[master 5b1b399] Add .gitattributes
 Author: A U Thor <author@example.com>
...
[master 611b09d] initial
 Author: A U Thor <author@example.com>
 1 files changed, 1 insertions(+), 0 deletions(-)
[master a01c180] second
 Author: A U Thor <author@example.com>
...
[master 8c09607] alllf, allcrlf and mixed only
 Author: A U Thor <author@example.com>

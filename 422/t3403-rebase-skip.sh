...
[master (root-commit) fac9272] hello
 Author: A U Thor <author@example.com>
 1 files changed, 1 insertions(+), 0 deletions(-)
 create mode 100644 hello
[master bad3b9c] hello world
 Author: A U Thor <author@example.com>
 1 files changed, 1 insertions(+), 0 deletions(-)
[master e0eb5a7] goodbye
 Author: A U Thor <author@example.com>
 1 files changed, 1 insertions(+), 0 deletions(-)
[skip-reference f3bc20d] we should skip this
 Author: A U Thor <author@example.com>
 1 files changed, 1 insertions(+), 1 deletions(-)
[skip-reference 865e3dd] this should not be skipped
 Author: A U Thor <author@example.com>
 1 files changed, 1 insertions(+), 0 deletions(-)
...
HEAD is now at e0eb5a7 goodbye
...
HEAD is now at 865e3dd this should not be skipped
First, rewinding head to replay your work on top of it...
Applying: we should skip this
Using index info to reconstruct a base tree...
Falling back to patching base and 3-way merge...
...
Applying: we should skip this
Applying: this should not be skipped
HEAD is now at 727bfec this should not be skipped
...
Merging:
e0eb5a7 goodbye
865e3dd this should not be skipped
found 1 common ancestor(s):
f3bc20d we should skip this
[detached HEAD 4c6b1fc] this should not be skipped
 Author: A U Thor <author@example.com>
 1 files changed, 1 insertions(+), 0 deletions(-)
 create mode 100644 cow
...
Merging:
4c6b1fc this should not be skipped
865e3dd this should not be skipped
found 1 common ancestor(s):
f3bc20d we should skip this

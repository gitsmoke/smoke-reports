...
[master (root-commit) 8441bc8] update-all
...
expecting success: 
	...
	repo_fetched one &&
	repo_fetched two
[master 1908860] fetch-group-all
 Author: A U Thor <author@example.com>
 1 files changed, 1 insertions(+), 0 deletions(-)
[master 1908860] fetch-group-all
 Author: A U Thor <author@example.com>
...
[master 39c9f5a] fetch-group-some
 Author: A U Thor <author@example.com>
 1 files changed, 1 insertions(+), 0 deletions(-)
[master 39c9f5a] fetch-group-some
 Author: A U Thor <author@example.com>

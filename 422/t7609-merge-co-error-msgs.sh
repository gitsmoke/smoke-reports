...
expecting success: 
	...
	echo other >four &&
	echo other >five
[master (root-commit) dd5c48c] First
 Author: A U Thor <author@example.com>
 1 files changed, 1 insertions(+), 0 deletions(-)
 create mode 100644 one
[branch a316ed9] Second
 Author: A U Thor <author@example.com>
...
expecting success: 
	...
	git reset --hard HEAD^
Updating dd5c48c..a316ed9
Aborting
[master 688748b] empty
 Author: A U Thor <author@example.com>
Aborting
HEAD is now at dd5c48c First
...
[master (root-commit) 106e83e] init
 Author: A U Thor <author@example.com>
...
rm 'rep/foo'
rm 'rep2/foo'
[branch fba3f8b] added test as a file
 Author: A U Thor <author@example.com>

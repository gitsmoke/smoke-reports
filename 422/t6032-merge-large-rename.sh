...
expecting success: 
	...
	git tag initial
[master (root-commit) c6f776c] initial
...
HEAD is now at c6f776c initial
[master d1bbd69] add=5
 Author: A U Thor <author@example.com>
...
Deleted branch test5 (was a3c83dc).
HEAD is now at c6f776c initial
[master 6e194b1] add=5
 Author: A U Thor <author@example.com>
 5 files changed, 110 insertions(+), 0 deletions(-)
 create mode 100644 1
 create mode 100644 2
...
Deleted branch test5 (was 63a3187).
HEAD is now at c6f776c initial
[master 6e194b1] add=5
 Author: A U Thor <author@example.com>
 5 files changed, 110 insertions(+), 0 deletions(-)
...
[simple-change 13d79ed] unrelated-change
 Author: A U Thor <author@example.com>
 0 files changed, 0 insertions(+), 0 deletions(-)

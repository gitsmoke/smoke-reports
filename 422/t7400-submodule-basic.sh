...
expecting success: 
	...
	git branch initial
[master (root-commit) 7367fd5] initial commit
...
[master (root-commit) cb8d40f] submodule commit 1
 Author: A U Thor <author@example.com>
...
[master (root-commit) cfe99e9] Ignore everything
 Author: A U Thor <author@example.com>
 1 files changed, 1 insertions(+), 0 deletions(-)
...
rev1: cb8d40f70a9b15cb3bdaba189bdcd4eb2aee4fde
...
expecting success: 
	git submodule status >lines &&
	grep "^-$rev1" lines
-cb8d40f70a9b15cb3bdaba189bdcd4eb2aee4fde init
...
Submodule path 'init': checked out 'cb8d40f70a9b15cb3bdaba189bdcd4eb2aee4fde'
...
expecting success: 
 ...
 cb8d40f70a9b15cb3bdaba189bdcd4eb2aee4fde init (rev-1)
...
expecting success: 
	...
	grep "^+$rev2" list
[detached HEAD 7fd330f] submodule commit 2
 Author: A U Thor <author@example.com>
 1 files changed, 1 insertions(+), 0 deletions(-)
 create mode 100644 b
+7fd330fb830790aee608bcca0145fbc139764db4 init (rev-1-1-g7fd330f)
...
+Subproject commit 7fd330fb830790aee608bcca0145fbc139764db4
...
[detached HEAD f61b1a1] change subproject
 Author: A U Thor <author@example.com>
 1 files changed, 1 insertions(+), 0 deletions(-)
 create mode 100644 s
[master 8bc222b] change init
 Author: A U Thor <author@example.com>
...
Submodule path 'init': checked out 'f61b1a1ffc0c49672413a79384781e123d5ffa66'
...
HEAD is now at e8274b8 super commit 1
...
HEAD is now at e8274b8 super commit 1
[second eab451e] commit subproject
 Author: A U Thor <author@example.com>
 1 files changed, 1 insertions(+), 1 deletions(-)
diff --git a/init b/init
index f61b1a1..1dc6948 160000
--- a/init
+++ b/init
@@ -1 +1 @@
-Subproject commit f61b1a1ffc0c49672413a79384781e123d5ffa66
+Subproject commit 1dc6948ddb6ae22485d31073976027087c0059a4
...
HEAD is now at eab451e commit subproject
...
[master (root-commit) 6eafd64] repo commit 1
 Author: A U Thor <author@example.com>
 1 files changed, 1 insertions(+), 0 deletions(-)

...
[master (root-commit) 668b2d7] commit
...
Unstaged changes after reset:
M	file
[master 2d91ebd] commit
 Author: A U Thor <author@example.com>
 1 files changed, 1 insertions(+), 1 deletions(-)
HEAD is now at 668b2d7 commit
...
[master 016a6c7] clear local changes
 Author: A U Thor <author@example.com>
 1 files changed, 1 insertions(+), 0 deletions(-)
...
HEAD is now at 016a6c7 clear local changes
[master 3937955] non-empty
 Author: A U Thor <author@example.com>
 1 files changed, 1 insertions(+), 0 deletions(-)
...
HEAD is now at 3937955 non-empty
[master cc8b997] empty
 Author: A U Thor <author@example.com>

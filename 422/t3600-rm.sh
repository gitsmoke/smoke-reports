...
[master (root-commit) 514a01b] add normal files
...
[master c953c02] add files with tabs and newlines
 Author: A U Thor <author@example.com>
 0 files changed, 0 insertions(+), 0 deletions(-)
...
[master bb58012] add file for rm test
 Author: A U Thor <author@example.com>
...
[master c99108e] remove file from rm test
 Author: A U Thor <author@example.com>
...
[master bb95389] add file for rm --quiet test
 Author: A U Thor <author@example.com>
 1 files changed, 1 insertions(+), 0 deletions(-)
 create mode 100644 test-file
[master feb86ab] remove file from rm --quiet test
 Author: A U Thor <author@example.com>
 1 files changed, 0 insertions(+), 1 deletions(-)
 delete mode 100644 test-file
...
[master (root-commit) 6a88492] add a file
 Author: A U Thor <author@example.com>
 1 files changed, 1 insertions(+), 0 deletions(-)
...
HEAD is now at 624dacc subdir test
rm 'frotz/nitfol'

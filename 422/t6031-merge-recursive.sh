...
[master (root-commit) c3dd229] initial
...
[other e17619e] changesimplefile
 Author: A U Thor <author@example.com>
 1 files changed, 1 insertions(+), 0 deletions(-)
rm 'sub1'
[main 0040e01] changefiletodir
 Author: A U Thor <author@example.com>

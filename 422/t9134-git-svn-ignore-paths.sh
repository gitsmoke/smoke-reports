...
Initialized empty Git repository in /Users/trast/git-smoke/t/trash directory.t9134-git-svn-ignore-paths/g/.git/
	A	qqq/test_qqq.txt
r1 = 09f71bb6bb406b16f518053eda1f8ef34a41d042 (refs/remotes/git-svn)
r2 = fc3c5eef3f5443522522331fd434a9cf7fd27a49 (refs/remotes/git-svn)
...
" > expect &&
	...
	M	qqq/test_qqq.txt
r3 = b30880341759007472f5315e09d7193ac686b492 (refs/remotes/git-svn)
...
r4 = ad547e7a5e62bb2fbf85cd54647a517cc0ef2d76 (refs/remotes/git-svn)
First, rewinding head to replay your work on top of it...
Fast-forwarded master to refs/remotes/git-svn.
...
" > expect &&
	...
	M	qqq/test_qqq.txt
r5 = 4bc3217f46d1d5cf7b5e0d71c53bc285ddd93fbb (refs/remotes/git-svn)
First, rewinding head to replay your work on top of it...
Fast-forwarded master to refs/remotes/git-svn.

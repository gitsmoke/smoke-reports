...
HEAD is now at 8952331 dir to symlink
rm 'a/b'
[detached HEAD 9d682b8] untracked symlink remains
 Author: A U Thor <author@example.com>
...
HEAD is now at bd9320b base
[detached HEAD ba15228] x
 Author: A U Thor <author@example.com>
 1 files changed, 1 insertions(+), 0 deletions(-)
...
HEAD is now at 1ea9ff5 Merge branch 'master' into HEAD
Merging:
ba15228 x
virtual master
...
HEAD is now at 55cec34 Merge commit 'baseline^0' into HEAD
Merging:
8952331 dir to symlink
virtual baseline^0
found 1 common ancestor(s):
bd9320b base
...
HEAD is now at ba15228 x
[detached HEAD aea6e84] dir a/b-2 to symlink
 Author: A U Thor <author@example.com>
...
HEAD is now at aea6e84 dir a/b-2 to symlink
Trying really trivial in-index merge...
Nope.
Trying simple merge.
Simple merge failed, trying Automatic merge.
...
HEAD is now at 115cb58 Merge commit 'test2' into HEAD
Merging:
ba15228 x
virtual test2
found 1 common ancestor(s):

...
[master 7c55a02] new file in ugly parent
...
Committed r2
	A	#{bad_directory_name}/ foo
r2 = 25e08217967e492ddf9460def55c8210468eef46 (refs/remotes/git-svn)
...
[master 46b03ea] rename ugly file
 Author: A U Thor <author@example.com>
...
r3 = c5974c91e0ef86f4a8e014950b1639df91f4c911 (refs/remotes/git-svn)
No changes between current HEAD and refs/remotes/git-svn
Resetting to the latest refs/remotes/git-svn
...
Committed r4
	A	pretty
r4 = 33e5e4e3aeb33c03276f6efcce3df9004471338c (refs/remotes/git-svn)
No changes between current HEAD and refs/remotes/git-svn
Resetting to the latest refs/remotes/git-svn
[master ffbd5a3] moved pretty file
 Author: A U Thor <author@example.com>
 1 files changed, 0 insertions(+), 0 deletions(-)
...
r5 = b5f93f83f82239874f4e684a7382db29218e5891 (refs/remotes/git-svn)
No changes between current HEAD and refs/remotes/git-svn
Resetting to the latest refs/remotes/git-svn
...
r6 = c61236d94ee68cda2500b0912dff68a67bd59ca4 (refs/remotes/git-svn)
No changes between current HEAD and refs/remotes/git-svn
Resetting to the latest refs/remotes/git-svn
...
Committed r7
	A	+_+
r7 = 1899ff67063961cf996bbe1fddfcdd690a3641f0 (refs/remotes/git-svn)
No changes between current HEAD and refs/remotes/git-svn
Resetting to the latest refs/remotes/git-svn
...
Committed r8
	D	+_+
	A	gtk+/_+_
r8 = c0af74c45f270076ff3faec775ff3e7e83bf457b (refs/remotes/git-svn)
No changes between current HEAD and refs/remotes/git-svn
Resetting to the latest refs/remotes/git-svn
...
[master 56d8409] test-rebase-main
 Author: A U Thor <author@example.com>
 1 files changed, 1 insertions(+), 0 deletions(-)
...
Committed r9
	A	test-rebase-main
r9 = e0c7ba8642f1bc237c8bb36ca8de69ed0d29095f (refs/remotes/git-svn)
No changes between current HEAD and refs/remotes/git-svn
Resetting to the latest refs/remotes/git-svn

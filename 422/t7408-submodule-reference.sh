...
[master (root-commit) f0c6626] A-initial
...
[master (root-commit) d40f431] B-super-initial
 Author: A U Thor <author@example.com>
 1 files changed, 1 insertions(+), 0 deletions(-)
...
Cloning into sub
Submodule path 'sub': checked out 'f0c6626deedef52eb4678da926708922c1e9e79f'

...
[master (root-commit) 1965e97] initial
...
Updating 1965e97..2cf7436
Fast-forward
 file |    1 +
 1 files changed, 1 insertions(+), 0 deletions(-)
[master e1f4c28] third
 Author: A U Thor <author@example.com>
...
[master e30b1ab] sixth.1
 Author: A U Thor <author@example.com>
 1 files changed, 1 insertions(+), 1 deletions(-)
[master f438a76] sixth.2
 Author: A U Thor <author@example.com>
 1 files changed, 1 insertions(+), 0 deletions(-)
[master b79fc8b] sixth.3
 Author: A U Thor <author@example.com>
 1 files changed, 1 insertions(+), 0 deletions(-)
...
b79fc8b3afcfe3d6a45d37c01de9332d6cf19ac1
[master 82bb006] seventh
 Author: A U Thor <author@example.com>
 1 files changed, 1 insertions(+), 1 deletions(-)

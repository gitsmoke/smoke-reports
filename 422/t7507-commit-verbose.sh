...
[master (root-commit) 09ccc82] subject
...
expecting success: 
	...
	check_message diff
[master d2477b1] This is an example commit message that contains a diff.
 Author: A U Thor <author@example.com>
 1 files changed, 1 insertions(+), 1 deletions(-)
...
checking known breakage: 
	...
	check_message diff
[master 20ed712] This is an example commit message that contains a diff.
 Author: A U Thor <author@example.com>
 1 files changed, 1 insertions(+), 1 deletions(-)
--- diff	2011-01-05 04:08:30.000000000 +0000
+++ actual	2011-01-05 04:08:31.000000000 +0000
@@ -1,9 +1,2 @@

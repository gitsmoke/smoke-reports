...
ok 16 - Show verbose error when HEAD could not be detached
ok 17 - dump usage when upstream arg is missing
ok 18 - rebase -q is quiet
ok 19 - Rebase a commit that sprinkles CRs in
ok 20 - rebase can copy notes
ok 21 - rebase -m can copy notes

...
not ok - 85 git notes copy --for-rewrite (append)
#	
...
#	
not ok - 86 git notes copy --for-rewrite (append two to one)
#	
...
#		test_cmp expect output
#	
not ok - 87 git notes copy --for-rewrite (append empty)
#	
...
not ok - 92 git notes get-ref (no overrides)
#	
#		git config --unset core.notesRef &&
#		sane_unset GIT_NOTES_REF &&
#		test "$(git notes get-ref)" = "refs/notes/commits"
#	
not ok - 93 git notes get-ref (core.notesRef)
#	
#		git config core.notesRef refs/notes/foo &&
#		test "$(git notes get-ref)" = "refs/notes/foo"
#	
not ok - 94 git notes get-ref (GIT_NOTES_REF)
#	
#		test "$(GIT_NOTES_REF=refs/notes/bar git notes get-ref)" = "refs/notes/bar"
#	
not ok - 95 git notes get-ref (--ref)
#	
#		test "$(GIT_NOTES_REF=refs/notes/bar git notes --ref=baz get-ref)" = "refs/notes/baz"
#	
# failed 7 among 95 test(s)
1..95

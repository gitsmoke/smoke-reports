...
[master (root-commit) 80a22ef] Initial.
 Author: A <A@test.git>
...
Merging:
6cb1254 Branch2-1
virtual f9163d4a281c7732dcfeb911d782001dac161a65
...
expecting success: echo "evil merge." >>file &&
     git commit -a --amend
[branch2 2a9e8d9] Merge branch 'branch1' into branch2

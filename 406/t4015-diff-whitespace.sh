...
[master (root-commit) 4bd4edd] snapshot
...
HEAD is now at c1bb63b yet another
[master 20433a5] hello 1
 Author: A U Thor <author@example.com>
 1 files changed, 1 insertions(+), 1 deletions(-)
...
HEAD is now at 20433a5 hello 1
[master 0ffeaf3] base
 Author: A U Thor <author@example.com>
...
HEAD is now at 0ffeaf3 base
[master 19da86d] empty
 Author: A U Thor <author@example.com>
...
HEAD is now at 19da86d empty
[master e805978] one side
 Author: A U Thor <author@example.com>
 1 files changed, 1 insertions(+), 9 deletions(-)
[detached HEAD e17f054] the other side
 Author: A U Thor <author@example.com>
 1 files changed, 1 insertions(+), 9 deletions(-)
Merging:
e17f054 the other side
virtual master
...
HEAD is now at e17f054 the other side
[detached HEAD 0f3fe6a] initial
 Author: A U Thor <author@example.com>
 1 files changed, 1 insertions(+), 1 deletions(-)

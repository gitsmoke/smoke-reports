...
[master (root-commit) 5eb5395] added file1
 Author: A U Thor <author@example.com>
 2 files changed, 2 insertions(+), 0 deletions(-)
 create mode 100644 file1
 create mode 100644 subdir/file3
[branch1 a529931] branch1 changes
 Author: A U Thor <author@example.com>
 3 files changed, 3 insertions(+), 2 deletions(-)
 create mode 100644 file2
[master f496645] master updates
 Author: A U Thor <author@example.com>
 3 files changed, 3 insertions(+), 2 deletions(-)
 create mode 100644 file2
...
[test1 8176338] branch1 resolved with mergetool
 Author: A U Thor <author@example.com>
...
x")" &&
    ...
    git reset --hard
[test2 dbd50f1] branch1 resolved with mergetool - autocrlf
 Author: A U Thor <author@example.com>
HEAD is now at dbd50f1 branch1 resolved with mergetool - autocrlf
...
[test3 eaafaef] branch1 resolved with mergetool - subdir
 Author: A U Thor <author@example.com>
...
HEAD is now at a529931 branch1 changes
...
Normal merge conflict for 'subdir/file3':
  {local}: modified
  {remote}: modified
[test4 bf97a5e] branch2 resolved by mergetool from subdir
 Author: A U Thor <author@example.com>

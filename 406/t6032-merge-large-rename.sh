...
expecting success: 
	...
	git tag initial
[master (root-commit) 9583354] initial
...
HEAD is now at 9583354 initial
[master 439bd15] add=5
 Author: A U Thor <author@example.com>
...
Deleted branch test5 (was a12a506).
HEAD is now at 9583354 initial
[master af0611e] add=5
 Author: A U Thor <author@example.com>
 5 files changed, 110 insertions(+), 0 deletions(-)
 create mode 100644 1
 create mode 100644 2
...
Deleted branch test5 (was 5f46d8b).
HEAD is now at 9583354 initial
[master e92d521] add=5
 Author: A U Thor <author@example.com>
 5 files changed, 110 insertions(+), 0 deletions(-)
 create mode 100644 1
 create mode 100644 2
...
[simple-change a176742] unrelated-change
 Author: A U Thor <author@example.com>
 0 files changed, 0 insertions(+), 0 deletions(-)

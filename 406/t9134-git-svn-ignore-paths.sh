...
Initialized empty Git repository in /Users/trast/git-smoke/t/trash directory.t9134-git-svn-ignore-paths/g/.git/
	A	qqq/test_qqq.txt
r1 = 7b45675d1fa1a30742c56b42c2eb92decbf9f303 (refs/remotes/git-svn)
r2 = 6f3476dca2502d89299cfb8405ab8ace1fb2208f (refs/remotes/git-svn)
...
" > expect &&
	...
	M	qqq/test_qqq.txt
r3 = 8762005d424133a9c6e8ff477f14101850248281 (refs/remotes/git-svn)
...
r4 = 4f4c1c838da324446f662990d498603ee2a0a5a9 (refs/remotes/git-svn)
First, rewinding head to replay your work on top of it...
Fast-forwarded master to refs/remotes/git-svn.
...
" > expect &&
	...
	M	qqq/test_qqq.txt
r5 = 55cf50e78da2c42ab5ddbd659cba59390c98cce2 (refs/remotes/git-svn)
First, rewinding head to replay your work on top of it...
Fast-forwarded master to refs/remotes/git-svn.

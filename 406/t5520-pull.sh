...
[master (root-commit) 3d843da] original
...
[master 093bd35] updated
 Author: A U Thor <author@example.com>
 1 files changed, 1 insertions(+), 1 deletions(-)
Your branch is behind 'master' by 1 commit, and can be fast-forwarded.
Updating 3d843da..093bd35
Fast-forward
 file |    2 +-
 1 files changed, 1 insertions(+), 1 deletions(-)
...
[second c0f7ccb] modified
 Author: A U Thor <author@example.com>
 1 files changed, 1 insertions(+), 1 deletions(-)
HEAD is now at 3d843da original
Updating 3d843da..c0f7ccb
Fast-forward
 file |    2 +-
 1 files changed, 1 insertions(+), 1 deletions(-)
...
expecting success: 
	...
	test $(git rev-parse HEAD^) = $(git rev-parse copy) &&
	test new = $(git show HEAD:file2)
HEAD is now at 5fde522 new file
First, rewinding head to replay your work on top of it...
Applying: new file
...
HEAD is now at c0f7ccb modified
[copy 6a9e8e4] conflict
 Author: A U Thor <author@example.com>
 1 files changed, 1 insertions(+), 1 deletions(-)
[to-rebase 93fa6bd] to-rebase
 Author: A U Thor <author@example.com>
 1 files changed, 1 insertions(+), 1 deletions(-)
First, rewinding head to replay your work on top of it...
Applying: new file
...
HEAD is now at 93fa6bd to-rebase
First, rewinding head to replay your work on top of it...
Applying: new file
Applying: to-rebase
...
[master (root-commit) 2d06e71] Initial revision
 Author: A U Thor <author@example.com>
...
[master 71d6af0] 5->43
 Author: A U Thor <author@example.com>
 1 files changed, 1 insertions(+), 1 deletions(-)
[master d4f12e1] Make it bigger
 Author: A U Thor <author@example.com>
 1 files changed, 1 insertions(+), 1 deletions(-)
[master 5cc0b18] Independent discovery of 5->43
 Author: A U Thor <author@example.com>
 1 files changed, 1 insertions(+), 1 deletions(-)
...
HEAD is now at d4f12e1 Make it bigger
Cloning into bare repository src-replace.git...
done.
[master 3e090f8] Change 2
 Author: A U Thor <author@example.com>
 1 files changed, 2 insertions(+), 2 deletions(-)
[master 34e9155] Change 3
 Author: A U Thor <author@example.com>
 1 files changed, 2 insertions(+), 2 deletions(-)
[master 1acdef9] Change 4
 Author: A U Thor <author@example.com>
 1 files changed, 3 insertions(+), 3 deletions(-)
[master 0723adf] Modified Change 4
 Author: A U Thor <author@example.com>
 1 files changed, 3 insertions(+), 3 deletions(-)

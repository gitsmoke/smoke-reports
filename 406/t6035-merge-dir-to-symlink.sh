...
HEAD is now at b5d7aec dir to symlink
rm 'a/b'
[detached HEAD 8c01c7d] untracked symlink remains
 Author: A U Thor <author@example.com>
...
HEAD is now at b6e0652 base
[detached HEAD e0f8b5b] x
 Author: A U Thor <author@example.com>
 1 files changed, 1 insertions(+), 0 deletions(-)
...
expecting success: 
	...
	test -h a/b &&
	test -f a/b-2/c/d
HEAD is now at 3727bef Merge branch 'master' into HEAD
Merging:
e0f8b5b x
virtual master
...
HEAD is now at 4a6ce85 Merge branch 'master' into HEAD
Trying really trivial in-index merge...
Nope.
Trying simple merge.
Simple merge failed, trying Automatic merge.
...
HEAD is now at 068e527 Merge commit 'baseline^0' into HEAD
Merging:
b5d7aec dir to symlink
virtual baseline^0
found 1 common ancestor(s):
b6e0652 base
...
expecting success: 
	...
	git tag test2
HEAD is now at e0f8b5b x
[detached HEAD 086d7db] dir a/b-2 to symlink
 Author: A U Thor <author@example.com>
...
expecting success: 
	...
	test -h a/b-2 &&
	test -f a/b/c/d
HEAD is now at 086d7db dir a/b-2 to symlink
Trying really trivial in-index merge...
Nope.
Trying simple merge.
Simple merge failed, trying Automatic merge.
...
HEAD is now at cbf0293 Merge commit 'test2' into HEAD
Merging:
e0f8b5b x
virtual test2
found 1 common ancestor(s):
...
HEAD is now at f93129f Merge commit 'test2' into HEAD
Merging:
086d7db dir a/b-2 to symlink
virtual baseline^0
found 1 common ancestor(s):
b6e0652 base

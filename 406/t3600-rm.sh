...
[master (root-commit) aa3f6c7] add normal files
...
[master 76c41e8] add files with tabs and newlines
 Author: A U Thor <author@example.com>
 0 files changed, 0 insertions(+), 0 deletions(-)
...
[master b45d4af] add file for rm test
 Author: A U Thor <author@example.com>
...
[master 801751e] remove file from rm test
 Author: A U Thor <author@example.com>
...
[master 9087cc6] add file for rm --quiet test
 Author: A U Thor <author@example.com>
 1 files changed, 1 insertions(+), 0 deletions(-)
 create mode 100644 test-file
[master 4eebeef] remove file from rm --quiet test
 Author: A U Thor <author@example.com>
 1 files changed, 0 insertions(+), 1 deletions(-)
 delete mode 100644 test-file
...
[master (root-commit) 27b2dbb] add a file
 Author: A U Thor <author@example.com>
 1 files changed, 1 insertions(+), 0 deletions(-)
...
expecting success: 
	...
	git rm frotz/nitfol &&
	test ! -f frotz/nitfol
HEAD is now at b2eddc2 subdir test
rm 'frotz/nitfol'

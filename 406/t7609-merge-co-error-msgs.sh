...
expecting success: 
	...
	echo other >four &&
	echo other >five
[master (root-commit) 49a40a6] First
 Author: A U Thor <author@example.com>
 1 files changed, 1 insertions(+), 0 deletions(-)
 create mode 100644 one
[branch 34be031] Second
 Author: A U Thor <author@example.com>
...
expecting success: 
	...
	git reset --hard HEAD^
Updating 49a40a6..34be031
Aborting
[master 6d4ae97] empty
 Author: A U Thor <author@example.com>
Aborting
HEAD is now at 49a40a6 First
...
[master (root-commit) 241d00f] init
 Author: A U Thor <author@example.com>
...
rm 'rep/foo'
rm 'rep2/foo'
[branch 47f60cc] added test as a file
 Author: A U Thor <author@example.com>

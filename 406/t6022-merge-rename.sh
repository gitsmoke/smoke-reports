...
git checkout master
[master (root-commit) 11d39ab] initial has A and M
 Author: A U Thor <author@example.com>
 2 files changed, 30 insertions(+), 0 deletions(-)
 create mode 100644 A
 create mode 100644 M
[master 4f08a68] master updates A
 Author: A U Thor <author@example.com>
 1 files changed, 1 insertions(+), 1 deletions(-)
[yellow d3778be] yellow removes M
 Author: A U Thor <author@example.com>
 1 files changed, 0 insertions(+), 15 deletions(-)
 delete mode 100644 M
[white 2e96dc2] white renames A->B, M->N
 Author: A U Thor <author@example.com>
 2 files changed, 2 insertions(+), 2 deletions(-)
 rename A => B (93%)
 rename M => N (93%)
[red 1f78be2] red renames A->B, M->N
 Author: A U Thor <author@example.com>
 2 files changed, 2 insertions(+), 2 deletions(-)
 rename A => B (93%)
 rename M => N (93%)
[blue 5c9026a] blue renames A->C, M->N
 Author: A U Thor <author@example.com>
 2 files changed, 2 insertions(+), 2 deletions(-)
 rename A => C (93%)
 rename M => N (93%)
...
Merging:
4f08a68 master updates A
virtual 2e96dc2c62c58bfb8f5f2275dc50273b87e2d1a3
found 1 common ancestor(s):
11d39ab initial has A and M
Auto-merging B
...
HEAD is now at 4f08a68 master updates A
Merging:
1f78be2 red renames A->B, M->N
virtual 2e96dc2c62c58bfb8f5f2275dc50273b87e2d1a3
found 1 common ancestor(s):
11d39ab initial has A and M
Auto-merging B
...
expecting success: 
	...
	git diff --exit-code white N
HEAD is now at 1f78be2 red renames A->B, M->N
! [blue] blue renames A->C, M->N
 ! [change] changed
  ! [change+rename] changed and renamed
   ! [master] master updates A
...
Merging:
1f78be2 red renames A->B, M->N
virtual 4f08a6827be7f247840d805b3db3a445a861ff53
found 1 common ancestor(s):
11d39ab initial has A and M
Auto-merging B
CONFLICT (content): Merge conflict in B
...
Merging:
1f78be2 red renames A->B, M->N
virtual 5c9026a9aa3dde41620cde1b23fe52ed453c711f
found 1 common ancestor(s):
11d39ab initial has A and M
Skipped N (merged same as existing)
CONFLICT (rename/rename): Rename "A"->"B" in branch "HEAD" rename "A"->"C" in "5c9026a9aa3dde41620cde1b23fe52ed453c711f"
Automatic merge failed; fix conflicts and then commit the result.
g : red changes a line
...
+++++*+ [change+rename^] initial has A and M
Merging:
2e96dc2 white renames A->B, M->N
virtual 1f78be2f147877e7994650fdf0c8c246b06f232a
found 1 common ancestor(s):
11d39ab initial has A and M
Auto-merging B
CONFLICT (content): Merge conflict in B
...
HEAD is now at 2e96dc2 white renames A->B, M->N
...
Merging:
4f08a68 master updates A
virtual d3778be91c9acad7c85359bd2ca19db3e2dd8b60
found 1 common ancestor(s):
11d39ab initial has A and M
Removing M
...
HEAD is now at 4f08a68 master updates A
Updated tag 'anchor' (was 4f08a68)
! [blue] blue renames A->C, M->N
 ! [change] changed
  ! [change+rename] changed and renamed
   ! [master] master updates A
...
Merge made by recursive.
 A |    2 +-
 1 files changed, 1 insertions(+), 1 deletions(-)
HEAD is now at d3778be yellow removes M
...
HEAD is now at 286568e changed and renamed
Skipped B (merged same as existing)
...
HEAD is now at 9632eb5 Merge branch 'change+rename' into change
rm 'B'
rm 'M'
[dir-in-way (root-commit) 087d301] Common commmit
 Author: A U Thor <author@example.com>
...
[dir-in-way 3db3a70] Commit to merge, with dir in the way
 Author: A U Thor <author@example.com>
 2 files changed, 2 insertions(+), 0 deletions(-)
rm 'dir/file-in-the-way'
[dir-not-in-way 2badc54] Commit to merge, with dir removed
 Author: A U Thor <author@example.com>
 2 files changed, 1 insertions(+), 1 deletions(-)
 delete mode 100644 dir/file-in-the-way
rm 'dir/file-in-the-way'
rm 'sub/file'
[renamed-file-has-no-conflicts d8e40f5] Independent change
 Author: A U Thor <author@example.com>
 2 files changed, 1 insertions(+), 2 deletions(-)
 rename sub/file => dir (79%)
 delete mode 100644 dir/file-in-the-way
rm 'dir/file-in-the-way'
[renamed-file-has-conflicts a04f6a5] Conflicting change
 Author: A U Thor <author@example.com>
 2 files changed, 1 insertions(+), 1 deletions(-)
...
HEAD is now at a04f6a5 Conflicting change
Merging:
d8e40f5 Independent change
virtual dir-not-in-way
found 1 common ancestor(s):
087d301 Common commmit
...
HEAD is now at b45abfb Merge branch 'dir-not-in-way' into HEAD
...
HEAD is now at d8e40f5 Independent change
...
expecting success: 
	...
	test -f dir &&
	test_cmp expected dir
HEAD is now at 3db3a70 Commit to merge, with dir in the way
Merging:
a04f6a5 Conflicting change
virtual dir-not-in-way
found 1 common ancestor(s):
087d301 Common commmit
Removing dir to make room for subdirectory; may re-add later.
...
HEAD is now at a04f6a5 Conflicting change
Merging:
3db3a70 Commit to merge, with dir in the way
...
rm 'n.stages'
rm 'sub/file'
[rename-dest (root-commit) dd26c45] Common commmit
 Author: A U Thor <author@example.com>
 1 files changed, 1 insertions(+), 0 deletions(-)
 create mode 100644 one/file
[rename-dest fd9be32] Renamed to destdir
 Author: A U Thor <author@example.com>
 1 files changed, 0 insertions(+), 0 deletions(-)
 rename one/file => destdir (100%)
rm 'one/file'
[source-conflict 2acd4cb] Conflicts in the way
 Author: A U Thor <author@example.com>
...
HEAD is now at 2acd4cb Conflicts in the way
Merging:
fd9be32 Renamed to destdir
virtual source-conflict
found 1 common ancestor(s):
dd26c45 Common commmit
...
HEAD is now at fd9be32 Renamed to destdir
rm 'destdir'
[rename-two (root-commit) cbb8418] Common commmit
 Author: A U Thor <author@example.com>
 2 files changed, 2 insertions(+), 0 deletions(-)
 create mode 100644 one/file
 create mode 100644 two/file
rm 'one/file'
[rename-two 14146ed] Rename two/file -> one
 Author: A U Thor <author@example.com>
 2 files changed, 0 insertions(+), 1 deletions(-)
 rename two/file => one (100%)
 delete mode 100644 one/file
rm 'two/file'
[rename-one 7d28a6e] Rename one/file -> two
 Author: A U Thor <author@example.com>
 2 files changed, 0 insertions(+), 1 deletions(-)
...
Merging:
7d28a6e Rename one/file -> two
virtual rename-two
found 1 common ancestor(s):
cbb8418 Common commmit
...
HEAD is now at 7d28a6e Rename one/file -> two
Merging:
7d28a6e Rename one/file -> two
virtual rename-two
found 1 common ancestor(s):
...
HEAD is now at 7d28a6e Rename one/file -> two
rm 'two'
[first-rename (root-commit) c9272a2] Common commmit
 Author: A U Thor <author@example.com>
 1 files changed, 1 insertions(+), 0 deletions(-)
 create mode 100644 original
[first-rename a2be81a] Put two/file in the way, rename to one
 Author: A U Thor <author@example.com>
 1 files changed, 0 insertions(+), 0 deletions(-)
 rename original => one (100%)
 create mode 100644 two/file
[second-rename 44e5d45] Put one/file in the way, rename to two
 Author: A U Thor <author@example.com>
 1 files changed, 0 insertions(+), 0 deletions(-)
 create mode 100644 one/file
...
expecting success: 
	...
	! test -f original
Merging:
a2be81a Put two/file in the way, rename to one
virtual second-rename
found 1 common ancestor(s):
c9272a2 Common commmit
...
HEAD is now at a2be81a Put two/file in the way, rename to one
rm 'one'
rm 'two/file'
[first-rename-redo (root-commit) bdc3464] Common commmit
 Author: A U Thor <author@example.com>
 1 files changed, 1 insertions(+), 0 deletions(-)
 create mode 100644 one/file
 create mode 100644 original
 create mode 100644 two/file
rm 'one/file'
[first-rename-redo a1eae2f] Rename to one
 Author: A U Thor <author@example.com>
 1 files changed, 0 insertions(+), 0 deletions(-)
 rename original => one (100%)
 delete mode 100644 one/file
rm 'two/file'
[second-rename-redo f998d50] Rename to two
 Author: A U Thor <author@example.com>
 1 files changed, 0 insertions(+), 0 deletions(-)
 rename original => two (100%)
 delete mode 100644 two/file
...
Merging:
a1eae2f Rename to one
virtual second-rename-redo
found 1 common ancestor(s):
bdc3464 Common commmit
Removing one to make room for subdirectory; may re-add later.
Removing two/file

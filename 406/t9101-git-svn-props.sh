...
expecting success: git svn fetch
	...
	A	ne_crlf
	A	empty
r1 = 20e089dece325cb11663d1856330558a8d83d110 (refs/remotes/git-svn)
	M	kw.c
r2 = f2a4a840e2efc83606eb5bcbe1df843dea09bdce (refs/remotes/git-svn)
	M	kw.c
r3 = aae7e7800e415ac65a32c3bc580bbf73bb5f65e5 (refs/remotes/git-svn)
	M	kw.c
r4 = 19fb5c7a5e2f002c63fed67b6a0616f953cb4035 (refs/remotes/git-svn)
...
[mybranch 5cbf8ae] test keywords ignoring
 Author: A U Thor <author@example.com>
 1 files changed, 1 insertions(+), 0 deletions(-)
	M	kw.c
	M	kw.c
r5 = 179c77087de5a11f2ca72ecf47769653ffab870e (refs/remotes/git-svn)
Done committing 1 revisions to SVN
Updating 5cbf8ae..179c770
Fast-forward
...
expecting success: git svn fetch &&
	...
	M	ne_crlf
	M	empty
r6 = e963c5e9fcefeb2d427635e534c97727987f0af6 (refs/remotes/git-svn)
Updating 179c770..e963c5e
Fast-forward
 crlf    |    3 +--
 ne_crlf |    3 +--
...
expecting success: git svn fetch && git pull . ${remotes_git_svn}
	M	cr
	M	ne_cr
r7 = 3c7acfca566f52d66f7c6b57f59bd1898552ce33 (refs/remotes/git-svn)
Updating e963c5e..3c7acfc
Fast-forward
 cr    |    4 +++-
 ne_cr |    4 +++-
...
expecting success: 
	...
	A	deeply/nested/directory/.keep
r8 = 0fc5e26f2673a04e33ad9d31a836e8ef019a9a14 (refs/remotes/git-svn)
Updating 3c7acfc..0fc5e26
Fast-forward

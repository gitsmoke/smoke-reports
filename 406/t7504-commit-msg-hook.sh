...
expecting success: 
	...
	git add file &&
	git commit -m "first"
[master (root-commit) c670af2] first
...
[master 314f190] even more content
 Author: A U Thor <author@example.com>
 1 files changed, 1 insertions(+), 0 deletions(-)

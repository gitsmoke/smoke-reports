...
[master (root-commit) 4c16f6f] initial
...
[master 66cf20d] master removes file2 and subdir/file2
 Author: A U Thor <author@example.com>
...
D	file2
D	subdir/file2
[side 27370ed] side adds file3 and removes file2
 Author: A U Thor <author@example.com>
...
HEAD is now at 66cf20d master removes file2 and subdir/file2
...
expecting success: 
	...
	git checkout side-a
HEAD is now at 66cf20d master removes file2 and subdir/file2
[side-a a545cf0] side-a changes file1
 Author: A U Thor <author@example.com>
 1 files changed, 1 insertions(+), 0 deletions(-)
[side-b d9f3289] side-b changes file2
 Author: A U Thor <author@example.com>
 1 files changed, 1 insertions(+), 0 deletions(-)
...
HEAD is now at a545cf0 side-a changes file1
...
HEAD is now at a545cf0 side-a changes file1
[sym-b 7403b05] side adds a/b
 Author: A U Thor <author@example.com>
 0 files changed, 0 insertions(+), 0 deletions(-)
 create mode 100644 a/b
[sym-a 5540e56] we add a/b
 Author: A U Thor <author@example.com>
 1 files changed, 1 insertions(+), 0 deletions(-)
...
HEAD is now at 5540e56 we add a/b
...
HEAD is now at 5540e56 we add a/b
[side-a b60f135] side-a changes file2 to directory
 Author: A U Thor <author@example.com>
...
HEAD is now at d9f3289 side-b changes file2
Trying simple merge.
...
Merging:
d9f3289 side-b changes file2
b60f135 side-a changes file2 to directory

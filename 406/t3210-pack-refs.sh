...
expecting success: git branch g/h &&
     ...
     git pack-refs --all &&
     git branch -d g
Deleted branch g/h (was cebb63a).
Deleted branch g (was cebb63a).
...
expecting success: git branch k/l &&
     ...
     git branch -d k/lm &&
     git branch k
Deleted branch k/l (was cebb63a).
Deleted branch k/l/m (was cebb63a).
Deleted branch k/lm (was cebb63a).
...
expecting success: git branch n/o &&
     ...
     git branch -d n/o/p &&
     git branch n
Deleted branch n/o (was cebb63a).
Deleted branch n/op (was cebb63a).
Deleted branch n/o/p (was cebb63a).

...
[master (root-commit) 015344f] initial
...
Updating 015344f..76b1bf5
Fast-forward
 file |    1 +
 1 files changed, 1 insertions(+), 0 deletions(-)
[master 1155d7e] third
 Author: A U Thor <author@example.com>
...
[master 22c0dbf] sixth.1
 Author: A U Thor <author@example.com>
 1 files changed, 1 insertions(+), 1 deletions(-)
[master 3b47818] sixth.2
 Author: A U Thor <author@example.com>
 1 files changed, 1 insertions(+), 0 deletions(-)
[master 6e3f178] sixth.3
 Author: A U Thor <author@example.com>
 1 files changed, 1 insertions(+), 0 deletions(-)
...
6e3f178fc33e204e311ee70ae52973906a177897
[master 8ac07d2] seventh
 Author: A U Thor <author@example.com>
 1 files changed, 1 insertions(+), 1 deletions(-)

...
Committed revision 1.
	A	foo
r1 = e45cf1b00d01b6c467c9e291fe8982659fd334c3 (refs/remotes/git-svn)
...
[master 5fa0808] files for enabled auto-props
...
Committed r2
	...
	A	bar
	A	exec1.sh
r2 = 321eeb230aebe8c916ad9d802376aaf646859ebc (refs/remotes/git-svn)
...
[master b4b1922] files for disabled auto-props
 Author: A U Thor <author@example.com>
 3 files changed, 3 insertions(+), 0 deletions(-)
...
Committed r3
	...
	A	world.txt
	A	zot
r3 = 22243ec0f8c59c5cc392f061fa0b0fecbd401582 (refs/remotes/git-svn)
No changes between current HEAD and refs/remotes/git-svn
Resetting to the latest refs/remotes/git-svn
...
Committed r4
	D	foo
	A	foo.sh
r4 = 38bb591d7ddc3988328982b3bc9241761d7477ee (refs/remotes/git-svn)
No changes between current HEAD and refs/remotes/git-svn
Resetting to the latest refs/remotes/git-svn
D    foo
A    foo.sh

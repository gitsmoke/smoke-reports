...
expecting success: 
	...
	echo happy.
[master (root-commit) 1a49fba] initial
...
expecting success: 
	...
	git reset --hard HEAD^
HEAD is now at 1a49fba initial
...
[master f81363b] Add .gitattributes
 Author: A U Thor <author@example.com>
...
[master 176b731] initial
 Author: A U Thor <author@example.com>
 1 files changed, 1 insertions(+), 0 deletions(-)
[master 7770356] second
 Author: A U Thor <author@example.com>
...
[master 85992f8] alllf, allcrlf and mixed only
 Author: A U Thor <author@example.com>

...
[master (root-commit) 7dd3482] initial
 Author: A U Thor <author@example.com>
 0 files changed, 0 insertions(+), 0 deletions(-)
 create mode 100644 camelcase
[topic 9972ba2] rename
 Author: A U Thor <author@example.com>
...
checking known breakage: 
	...
	git merge topic
HEAD is now at 7dd3482 initial
Updating 7dd3482..9972ba2
Fast-forward
...
[master (root-commit) dbec6b2] initial
 Author: A U Thor <author@example.com>
 0 files changed, 0 insertions(+), 0 deletions(-)
 create mode 100644 "a\314\210"
[topic 109b6ff] rename
 Author: A U Thor <author@example.com>
 1 files changed, 0 insertions(+), 0 deletions(-)
...
HEAD is now at dbec6b2 initial
Updating dbec6b2..109b6ff
Aborting

...
expecting success: 
	...
	git add hello &&
	git commit -m master
[master (root-commit) 8bc3dae] initial
...
[master (root-commit) 23ef65c] initial git-gui
 Author: A U Thor <author@example.com>
 1 files changed, 1 insertions(+), 0 deletions(-)
...
[master (root-commit) ddddab7] initial git
 Author: A U Thor <author@example.com>
 1 files changed, 1 insertions(+), 0 deletions(-)
...
Updating gui
[master bc37de1] Merge git-gui as our subdirectory
 Author: A U Thor <author@example.com>
...
M	git-gui.sh
[master2 22ff429] update git-gui
 Author: A U Thor <author@example.com>
 1 files changed, 1 insertions(+), 1 deletions(-)
Merging:
bc37de1 Merge git-gui as our subdirectory
virtual 22ff429d8a99a719f303b21f60c159216e3bfe3e
found 1 common ancestor(s):
23ef65c initial git-gui
Merge made by subtree.
...
HEAD is now at bc37de1 Merge git-gui as our subdirectory
Already up-to-date.
[master2 556798e] Merge git-gui2 as our subdirectory
 Author: A U Thor <author@example.com>
 1 files changed, 1 insertions(+), 0 deletions(-)
...
expecting success: 
	...
	test_cmp expected actual
HEAD is now at 556798e Merge git-gui2 as our subdirectory
Merging:
556798e Merge git-gui2 as our subdirectory
virtual 22ff429d8a99a719f303b21f60c159216e3bfe3e
found 1 common ancestor(s):
23ef65c initial git-gui

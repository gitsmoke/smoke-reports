...
[master (root-commit) 34c1264]  Add bar
 Author: A U Thor <author@example.com>
 0 files changed, 0 insertions(+), 0 deletions(-)
 create mode 100644 bar
[master e2d278c]  Add foo
 Author: A U Thor <author@example.com>
 0 files changed, 0 insertions(+), 0 deletions(-)
 create mode 100644 foo
[master (root-commit) a8112b0] Add submodule sub
 Author: A U Thor <author@example.com>
...
HEAD is now at e2d278c  Add foo
...
HEAD is now at 7fa1e56 next change
...
[master 24fe2c2] added .real to .gitignore
 Author: A U Thor <author@example.com>
 1 files changed, 1 insertions(+), 0 deletions(-)

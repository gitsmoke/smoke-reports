...
[master (root-commit) cebb63a] Initial commit.
 Author: A U Thor <author@example.com>
 1 files changed, 1 insertions(+), 0 deletions(-)
 create mode 100644 A
[master c4884d1] Second commit.
 Author: A U Thor <author@example.com>
 1 files changed, 1 insertions(+), 0 deletions(-)
...
expecting success: git branch l/m &&
        git branch -d l/m &&
        git branch l
Deleted branch l/m (was c4884d1).
...
Deleted branch s/t (was c4884d1).
...
Deleted branch my7 (was c4884d1).
...
c4884d116fd5e8063b5fc3a1acc22c8c68c93550
...
expecting success: 
	...
	git branch -d my8
Deleted branch my8 (was c4884d1).

...
ok 12 - submodule update --merge  - ignores --merge  for new submodules
ok 13 - submodule update --rebase - ignores --rebase for new submodules
ok 14 - submodule update ignores update=merge config for new submodules
ok 15 - submodule update ignores update=rebase config for new submodules

...
ok 91 - forks: prepare
ok 92 - forks: projects list
ok 93 - forks: forks action
ok 94 - ctags: tag cloud in projects list
ok 95 - ctags: search projects by existing tag
ok 96 - ctags: search projects by non existent tag
ok 97 - categories: projects list, only default category

...
[master (root-commit) 59c57d2] A-initial
...
[master (root-commit) ea32f6a] B-super-initial
 Author: A U Thor <author@example.com>
 1 files changed, 1 insertions(+), 0 deletions(-)
...
Cloning into sub...
Submodule path 'sub': checked out '59c57d28c3a891954b003b10d8d5a168240cd8e2'

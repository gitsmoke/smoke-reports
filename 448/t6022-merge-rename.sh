...
git checkout master
[master (root-commit) 17e6c4b] initial has A and M
 Author: A U Thor <author@example.com>
 2 files changed, 30 insertions(+), 0 deletions(-)
 create mode 100644 A
 create mode 100644 M
[master 99997ef] master updates A
 Author: A U Thor <author@example.com>
 1 files changed, 1 insertions(+), 1 deletions(-)
[yellow 95449ec] yellow removes M
 Author: A U Thor <author@example.com>
 1 files changed, 0 insertions(+), 15 deletions(-)
 delete mode 100644 M
[white 6c1c809] white renames A->B, M->N
 Author: A U Thor <author@example.com>
 2 files changed, 2 insertions(+), 2 deletions(-)
 rename A => B (93%)
 rename M => N (93%)
[red 057520f] red renames A->B, M->N
 Author: A U Thor <author@example.com>
 2 files changed, 2 insertions(+), 2 deletions(-)
 rename A => B (93%)
 rename M => N (93%)
[blue da6dbd0] blue renames A->C, M->N
 Author: A U Thor <author@example.com>
 2 files changed, 2 insertions(+), 2 deletions(-)
 rename A => C (93%)
 rename M => N (93%)
...
Merging:
99997ef master updates A
virtual 6c1c809b89fb7050495d3a7fb504d11b7b7adb77
found 1 common ancestor(s):
17e6c4b initial has A and M
Auto-merging B
...
expecting success: 
	...
	git diff --exit-code white N
HEAD is now at 99997ef master updates A
Merging:
057520f red renames A->B, M->N
virtual 6c1c809b89fb7050495d3a7fb504d11b7b7adb77
found 1 common ancestor(s):
17e6c4b initial has A and M
Auto-merging B
...
expecting success: 
	...
	git diff --exit-code white N
HEAD is now at 057520f red renames A->B, M->N
! [blue] blue renames A->C, M->N
 ! [change] changed
  ! [change+rename] changed and renamed
   ! [master] master updates A
...
Merging:
057520f red renames A->B, M->N
virtual 99997efcda0d5fad235b8da715352929ae143420
found 1 common ancestor(s):
17e6c4b initial has A and M
Auto-merging B
CONFLICT (content): Merge conflict in B
...
Merging:
057520f red renames A->B, M->N
virtual da6dbd07f147de1c0e416b9968485aac7ccb56ca
found 1 common ancestor(s):
17e6c4b initial has A and M
Skipped N (merged same as existing)
CONFLICT (rename/rename): Rename "A"->"B" in branch "HEAD" rename "A"->"C" in "da6dbd07f147de1c0e416b9968485aac7ccb56ca"
Automatic merge failed; fix conflicts and then commit the result.
g : red changes a line
...
+++++*+ [yellow^] initial has A and M
Merging:
6c1c809 white renames A->B, M->N
virtual 057520f962c44f384787942dfc14ef7c50b48397
found 1 common ancestor(s):
17e6c4b initial has A and M
Auto-merging B
CONFLICT (content): Merge conflict in B
...
HEAD is now at 6c1c809 white renames A->B, M->N
...
Merging:
99997ef master updates A
virtual 95449ec53922c3511ff9907a064faf864c836eea
found 1 common ancestor(s):
17e6c4b initial has A and M
Removing M
...
HEAD is now at 99997ef master updates A
Updated tag 'anchor' (was 99997ef)
! [blue] blue renames A->C, M->N
 ! [change] changed
  ! [change+rename] changed and renamed
   ! [master] master updates A
...
Merge made by recursive.
 A |    2 +-
 1 files changed, 1 insertions(+), 1 deletions(-)
HEAD is now at 95449ec yellow removes M
...
HEAD is now at 56426f2 changed and renamed
Skipped B (merged same as existing)
...
HEAD is now at b9267af Merge branch 'change+rename' into change
rm 'B'
rm 'M'
[dir-in-way (root-commit) 3cdb016] Common commmit
 Author: A U Thor <author@example.com>
...
[dir-in-way bc0d0f7] Commit to merge, with dir in the way
 Author: A U Thor <author@example.com>
 2 files changed, 2 insertions(+), 0 deletions(-)
rm 'dir/file-in-the-way'
[dir-not-in-way 0a34d61] Commit to merge, with dir removed
 Author: A U Thor <author@example.com>
 2 files changed, 1 insertions(+), 1 deletions(-)
 delete mode 100644 dir/file-in-the-way
rm 'dir/file-in-the-way'
rm 'sub/file'
[renamed-file-has-no-conflicts c5614b2] Independent change
 Author: A U Thor <author@example.com>
 2 files changed, 1 insertions(+), 2 deletions(-)
 rename sub/file => dir (79%)
 delete mode 100644 dir/file-in-the-way
rm 'dir/file-in-the-way'
[renamed-file-has-conflicts 3714b71] Conflicting change
 Author: A U Thor <author@example.com>
 2 files changed, 1 insertions(+), 1 deletions(-)
...
HEAD is now at 3714b71 Conflicting change
Merging:
c5614b2 Independent change
virtual dir-not-in-way
found 1 common ancestor(s):
3cdb016 Common commmit
...
HEAD is now at abdfe0c Merge branch 'dir-not-in-way' into HEAD
...
HEAD is now at c5614b2 Independent change
...
expecting success: 
	...
	test -f dir &&
	test_cmp expected dir
HEAD is now at bc0d0f7 Commit to merge, with dir in the way
Merging:
3714b71 Conflicting change
virtual dir-not-in-way
found 1 common ancestor(s):
3cdb016 Common commmit
Removing dir to make room for subdirectory; may re-add later.
...
HEAD is now at 3714b71 Conflicting change
Merging:
bc0d0f7 Commit to merge, with dir in the way
...
rm 'n.stages'
rm 'sub/file'
[rename-dest (root-commit) 93f5270] Common commmit
 Author: A U Thor <author@example.com>
 1 files changed, 1 insertions(+), 0 deletions(-)
 create mode 100644 one/file
[rename-dest 9729031] Renamed to destdir
 Author: A U Thor <author@example.com>
 1 files changed, 0 insertions(+), 0 deletions(-)
 rename one/file => destdir (100%)
rm 'one/file'
[source-conflict 9d3d11a] Conflicts in the way
 Author: A U Thor <author@example.com>
...
HEAD is now at 9d3d11a Conflicts in the way
Merging:
9729031 Renamed to destdir
virtual source-conflict
found 1 common ancestor(s):
93f5270 Common commmit
...
HEAD is now at 9729031 Renamed to destdir
rm 'destdir'
[rename-two (root-commit) c8fb056] Common commmit
 Author: A U Thor <author@example.com>
 2 files changed, 2 insertions(+), 0 deletions(-)
 create mode 100644 one/file
 create mode 100644 two/file
rm 'one/file'
[rename-two bd1a296] Rename two/file -> one
 Author: A U Thor <author@example.com>
 2 files changed, 0 insertions(+), 1 deletions(-)
 rename two/file => one (100%)
 delete mode 100644 one/file
rm 'two/file'
[rename-one 90f033f] Rename one/file -> two
 Author: A U Thor <author@example.com>
 2 files changed, 0 insertions(+), 1 deletions(-)
...
Merging:
90f033f Rename one/file -> two
virtual rename-two
found 1 common ancestor(s):
c8fb056 Common commmit
...
expecting success: 
	...
	test "other" = $(cat one) &&
	test "stuff" = $(cat two)
HEAD is now at 90f033f Rename one/file -> two
Merging:
90f033f Rename one/file -> two
virtual rename-two
found 1 common ancestor(s):
...
HEAD is now at 90f033f Rename one/file -> two
rm 'two'
[first-rename (root-commit) 8f337f3] Common commmit
 Author: A U Thor <author@example.com>
 1 files changed, 1 insertions(+), 0 deletions(-)
 create mode 100644 original
[first-rename fd9afae] Put two/file in the way, rename to one
 Author: A U Thor <author@example.com>
 1 files changed, 0 insertions(+), 0 deletions(-)
 rename original => one (100%)
 create mode 100644 two/file
[second-rename 6dda19c] Put one/file in the way, rename to two
 Author: A U Thor <author@example.com>
 1 files changed, 0 insertions(+), 0 deletions(-)
 create mode 100644 one/file
...
expecting success: 
	...
	! test -f original
Merging:
fd9afae Put two/file in the way, rename to one
virtual second-rename
found 1 common ancestor(s):
8f337f3 Common commmit
...
HEAD is now at fd9afae Put two/file in the way, rename to one
rm 'one'
rm 'two/file'
[first-rename-redo (root-commit) fa7e762] Common commmit
 Author: A U Thor <author@example.com>
 1 files changed, 1 insertions(+), 0 deletions(-)
 create mode 100644 one/file
 create mode 100644 original
 create mode 100644 two/file
rm 'one/file'
[first-rename-redo d1abd67] Rename to one
 Author: A U Thor <author@example.com>
 1 files changed, 0 insertions(+), 0 deletions(-)
 rename original => one (100%)
 delete mode 100644 one/file
rm 'two/file'
[second-rename-redo bc8c44d] Rename to two
 Author: A U Thor <author@example.com>
 1 files changed, 0 insertions(+), 0 deletions(-)
 rename original => two (100%)
 delete mode 100644 two/file
...
Merging:
d1abd67 Rename to one
virtual second-rename-redo
found 1 common ancestor(s):
fa7e762 Common commmit
Removing one to make room for subdirectory; may re-add later.
Removing two/file

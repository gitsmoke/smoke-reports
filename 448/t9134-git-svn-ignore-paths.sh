...
Initialized empty Git repository in /Users/trast/git-smoke/t/trash directory.t9134-git-svn-ignore-paths/g/.git/
	A	qqq/test_qqq.txt
r1 = 8ee2d965054101ece09585cc9d9095baf9568943 (refs/remotes/git-svn)
r2 = fa5a9a115ba63379207021aec4757127e32edbcb (refs/remotes/git-svn)
...
" > expect &&
	...
	M	qqq/test_qqq.txt
r3 = c8e0fedafde54a7bd0dd17bb7424474bbdcf3b4c (refs/remotes/git-svn)
...
r4 = afe092bd577b47b8643bef250f7bea8813fd7cd0 (refs/remotes/git-svn)
First, rewinding head to replay your work on top of it...
Fast-forwarded master to refs/remotes/git-svn.
...
" > expect &&
	...
	M	qqq/test_qqq.txt
r5 = 4e84c4c0247a53b4c3cdfa942dc750c884ae8614 (refs/remotes/git-svn)
First, rewinding head to replay your work on top of it...
Fast-forwarded master to refs/remotes/git-svn.

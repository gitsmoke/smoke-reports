...
[master (root-commit) fda501d] add normal files
...
[master 6b41528] add files with tabs and newlines
 Author: A U Thor <author@example.com>
 0 files changed, 0 insertions(+), 0 deletions(-)
...
[master 2e8a047] add file for rm test
 Author: A U Thor <author@example.com>
...
[master 0513e67] remove file from rm test
 Author: A U Thor <author@example.com>
...
[master 2010d04] add file for rm --quiet test
 Author: A U Thor <author@example.com>
 1 files changed, 1 insertions(+), 0 deletions(-)
 create mode 100644 test-file
[master 6f4b7fd] remove file from rm --quiet test
 Author: A U Thor <author@example.com>
 1 files changed, 0 insertions(+), 1 deletions(-)
 delete mode 100644 test-file
...
[master (root-commit) 5f320f4] add a file
 Author: A U Thor <author@example.com>
 1 files changed, 1 insertions(+), 0 deletions(-)
...
HEAD is now at 47b696c subdir test
rm 'frotz/nitfol'

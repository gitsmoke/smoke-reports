...
[master (root-commit) d952b97] subject
...
expecting success: 
	...
	check_message diff
[master 27a0069] This is an example commit message that contains a diff.
 Author: A U Thor <author@example.com>
 1 files changed, 1 insertions(+), 1 deletions(-)
...
checking known breakage: 
	...
	check_message diff
[master cf0621b] This is an example commit message that contains a diff.
 Author: A U Thor <author@example.com>
 1 files changed, 1 insertions(+), 1 deletions(-)
--- diff	2011-01-13 04:02:52.000000000 +0000
+++ actual	2011-01-13 04:02:53.000000000 +0000
@@ -1,9 +1,2 @@

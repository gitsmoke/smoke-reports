...
r1 = 4fa543f533cf65f2418c5cccf31e8f3b6e1494b8 (refs/remotes/git-svn)
...
[mybranch 17fdebf] try a deep --rmdir with a commit
 ...
 rename dir/a/b/c/d/e/file => file (100%)
	...
	D	dir/a/
	A	dir/file
r2 = 3479a4681580183bb33f0726f2eb50717dc81dbb (refs/remotes/git-svn)
...
[mybranch 495488f] detect node change from file to directory #1
 Author: A U Thor <author@example.com>
...
[mybranch2 4aec79d] detect node change from directory to file #1
 Author: A U Thor <author@example.com>
 1 files changed, 0 insertions(+), 0 deletions(-)
...
[mybranch3 7c51b2a] detect node change from file to directory #2
 Author: A U Thor <author@example.com>
...
[mybranch4 3311148] detect node change from directory to file #2
 Author: A U Thor <author@example.com>
 2 files changed, 1 insertions(+), 1 deletions(-)
...
[mybranch5 0847a50] remove executable bit from a file
 Author: A U Thor <author@example.com>
 0 files changed, 0 insertions(+), 0 deletions(-)
 mode change 100755 => 100644 exec.sh
	M	exec.sh
	M	exec.sh
r3 = 374f88ea12b8f653fde9bf8ee137085d3608027c (refs/remotes/git-svn)
Done committing 1 revisions to SVN
...
expecting success: 
	...
	svn_cmd up "$SVN_TREE" &&
	test -x "$SVN_TREE"/exec.sh
[mybranch5 6a1e17e] add executable bit back file
 Author: A U Thor <author@example.com>
 0 files changed, 0 insertions(+), 0 deletions(-)
 mode change 100644 => 100755 exec.sh
	M	exec.sh
	M	exec.sh
r4 = 284696e83b8878f3534fb3eef7aaa25d2bbc1ede (refs/remotes/git-svn)
Done committing 1 revisions to SVN
UU   /Users/trast/git-smoke/t/trash directory.t9100-git-svn-basic/.git/svn/refs/remotes/git-svn/svn-tree/exec.sh
...
[mybranch5 8db2dcf] executable file becomes a symlink to bar/zzz (file)
 Author: A U Thor <author@example.com>
 ...
 mode change 100755 => 120000
	T	exec.sh
	M	exec.sh
r5 = 564c0230cac68eeb4d5a88a2743922327024ef44 (refs/remotes/git-svn)
Done committing 1 revisions to SVN
UU   /Users/trast/git-smoke/t/trash directory.t9100-git-svn-basic/.git/svn/refs/remotes/git-svn/svn-tree/exec.sh
...
[mybranch5 cef4537] new symlink is added to a file that was also just made executable
 Author: A U Thor <author@example.com>
 ...
 create mode 120000 exec-2.sh
	...
	M	bar/zzz
	A	exec-2.sh
r6 = 7c3157f3ac8d528dcc62711bea6775a603c0483a (refs/remotes/git-svn)
Done committing 1 revisions to SVN
...
[mybranch5 51c9205] modify a symlink to become a file
 Author: A U Thor <author@example.com>
 1 files changed, 1 insertions(+), 1 deletions(-)
 ...
 mode change 120000 => 100644
	T	exec-2.sh
	M	exec-2.sh
r7 = 7736d40909df201a68cd51fbbe20f3d8c43dbd71 (refs/remotes/git-svn)
Done committing 1 revisions to SVN
...
expecting success: git svn init "$svnrepo" && git svn fetch &&
	...
	A	exec.sh
	A	dir/a/b/c/d/e/file
r1 = 4fa543f533cf65f2418c5cccf31e8f3b6e1494b8 (refs/remotes/alt)
	A	file
	D	dir/a/b/c/d/e/file
	D	dir/a/
	A	dir/file
r2 = 272eb9d8d033c6db2a58c7eff1d0dbdd6aa538e1 (refs/remotes/alt)
	M	exec.sh
r3 = 91feefc4fc39e3bd937be2d119b4685283d51f02 (refs/remotes/alt)
	M	exec.sh
r4 = f6b7df37516873765fa00975c1bb0d73a64e3b5e (refs/remotes/alt)
	M	exec.sh
r5 = 668b72f62afbd25400f1ac10e648264e8a3bbd49 (refs/remotes/alt)
	M	bar/zzz
	A	exec-2.sh
r6 = 7fb77366398ac7678db5e7126ca167761a7cd363 (refs/remotes/alt)
	M	exec-2.sh
r7 = ba1121e5ae03a02b8168b2f15affe4f86a5e2d0c (refs/remotes/alt)
...
expecting success: 
	...
	A	zzz
r1 = a4d32bf76bb27103e5b88036d1ba384274b4b9ef (refs/remotes/bar)
	M	zzz
r6 = 0df8c52b7ed01b705a510926399d23bbc0917c09 (refs/remotes/bar)
[my-bar e2e1d2b] change 1
 Author: A U Thor <author@example.com>
 1 files changed, 1 insertions(+), 0 deletions(-)
 create mode 100644 foo
[my-bar 038310e] change 2
 Author: A U Thor <author@example.com>
 1 files changed, 1 insertions(+), 1 deletions(-)
...
Committed r8
	A	foo
r8 = 8d46dc45d6f8af64774153e7b4d110a4d818e54a (refs/remotes/bar)
...
The rewritten commit is: 8d46dc45d6f8af64774153e7b4d110a4d818e54a
    change 1
Deleted branch my-bar (was 038310e).
...
expecting success: 
	...
	A	bar/foo
r8 = 524aad7a0276b49d3443c409903a2925ab21de1d (refs/remotes/alt)
[my-bar cc91a99] /bar/d should be in the log
 Author: A U Thor <author@example.com>
 1 files changed, 1 insertions(+), 0 deletions(-)
...
Committed r9
	A	d
r9 = b9131517921b1dc2acc5b31895ebf07e31f6ef8f (refs/remotes/bar)
No changes between current HEAD and refs/remotes/bar
Resetting to the latest refs/remotes/bar
[my-bar d3274c4] add a new directory
 Author: A U Thor <author@example.com>
 1 files changed, 1 insertions(+), 0 deletions(-)
...
Committed r10
	A	newdir/dir
r10 = e4ee67c3d8b94a6b26f5ca39eda4b729da585f3d (refs/remotes/bar)
No changes between current HEAD and refs/remotes/bar
Resetting to the latest refs/remotes/bar
[my-bar 9fcd264] modify a file in new directory
 Author: A U Thor <author@example.com>
 1 files changed, 1 insertions(+), 0 deletions(-)
Committing to file:///Users/trast/git-smoke/t/trash directory.t9100-git-svn-basic/svnrepo/bar ...
	M	newdir/dir
Committed r11
	M	newdir/dir
r11 = c98da5949b6ab19407bc1009bad24d0f524522e7 (refs/remotes/bar)
No changes between current HEAD and refs/remotes/bar
Resetting to the latest refs/remotes/bar
...
[my-bar db930b2] commit-new-file-foo2
 Author: A U Thor <author@example.com>
 1 files changed, 1 insertions(+), 0 deletions(-)
...
Committed r12
	A	foo2
r12 = 8363b27be96a601e7fd34fcfce5175b2c24f5bad (refs/remotes/bar)
No changes between current HEAD and refs/remotes/bar
Resetting to the latest refs/remotes/bar
...
[my-bar 5722865] update /bar/d
 Author: A U Thor <author@example.com>
 1 files changed, 1 insertions(+), 1 deletions(-)
	M	d
	M	d
r13 = b2c7f8a657e1e5f76d9467cd31e07af49485e75a (refs/remotes/bar)
Done committing 1 revisions to SVN
...
r8 = 524aad7a0276b49d3443c409903a2925ab21de1d (refs/remotes/alt)
	A	bar/d
r9 = 18422613b2da0693588ea949a286a2a29737f50b (refs/remotes/alt)
	A	bar/newdir/dir
r10 = 95438c0570b2f625aaeb817e6f9c51dd9302dedf (refs/remotes/alt)
	M	bar/newdir/dir
r11 = ae3e1a2a4c81def3a7b2cbaba2da163b1195dba8 (refs/remotes/alt)
	A	bar/foo2
r12 = 15f20dce0812c3381ba9227d5c377c15c08a361f (refs/remotes/alt)
	M	bar/d
r13 = 466ce87f0cfb502b040343f394642dfb827ba794 (refs/remotes/alt)

...
expecting success: 
	...
	git tag initial
[master (root-commit) 1c15883] initial
...
HEAD is now at 1c15883 initial
[master 2aeced6] add=5
 Author: A U Thor <author@example.com>
...
Deleted branch test5 (was f7d2c7a).
HEAD is now at 1c15883 initial
[master 27ac141] add=5
 Author: A U Thor <author@example.com>
 5 files changed, 110 insertions(+), 0 deletions(-)
 create mode 100644 1
 create mode 100644 2
...
Deleted branch test5 (was 3f9a542).
HEAD is now at 1c15883 initial
[master 01b1ffb] add=5
 Author: A U Thor <author@example.com>
 5 files changed, 110 insertions(+), 0 deletions(-)
 create mode 100644 1
 create mode 100644 2
...
[simple-change 6677a3c] unrelated-change
 Author: A U Thor <author@example.com>
 0 files changed, 0 insertions(+), 0 deletions(-)

...
Committed revision 1.
	A	foo
r1 = 8397d6eeb636e3f713572904ef8197c254701e48 (refs/remotes/git-svn)
...
[master 7d6fa73] files for enabled auto-props
...
Committed r2
	...
	A	bar
	A	exec1.sh
r2 = 5966e3fab2902bd5f5a2757662de7f6f70c8a221 (refs/remotes/git-svn)
...
[master 3380782] files for disabled auto-props
 Author: A U Thor <author@example.com>
 3 files changed, 3 insertions(+), 0 deletions(-)
...
Committed r3
	...
	A	world.txt
	A	zot
r3 = 6182112534ef809a1b9738aa11b2b5f20b1506e4 (refs/remotes/git-svn)
No changes between current HEAD and refs/remotes/git-svn
Resetting to the latest refs/remotes/git-svn
...
Committed r4
	D	foo
	A	foo.sh
r4 = 1c5d49592b3f017131809f5d91faefcbe5e56cdf (refs/remotes/git-svn)
No changes between current HEAD and refs/remotes/git-svn
Resetting to the latest refs/remotes/git-svn
D    foo
A    foo.sh

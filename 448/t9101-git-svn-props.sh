...
expecting success: git svn fetch
	...
	A	ne_crlf
	A	empty
r1 = dc41efcbf5a77c26a76c59eb882d967d025dc2af (refs/remotes/git-svn)
	M	kw.c
r2 = 2ad564fa09c3c12aa1289774bf88cc35036cd2b5 (refs/remotes/git-svn)
	M	kw.c
r3 = 175acb1974d42f4ff44d9af9d0388503cfe4e4ad (refs/remotes/git-svn)
	M	kw.c
r4 = 151120f8ddbb56026dc3b360038641745da45d3b (refs/remotes/git-svn)
...
[mybranch f36322e] test keywords ignoring
 Author: A U Thor <author@example.com>
 1 files changed, 1 insertions(+), 0 deletions(-)
	M	kw.c
	M	kw.c
r5 = f3f14a8726d5f2b8cfdc5a18630c17b2f6d2a684 (refs/remotes/git-svn)
Done committing 1 revisions to SVN
Updating f36322e..f3f14a8
Fast-forward
...
expecting success: git svn fetch &&
	...
	M	ne_crlf
	M	empty
r6 = 4aec1d62d2768b246168c3dfd202e81844cb57f7 (refs/remotes/git-svn)
Updating f3f14a8..4aec1d6
Fast-forward
 crlf    |    3 +--
 ne_crlf |    3 +--
...
expecting success: git svn fetch && git pull . ${remotes_git_svn}
	M	cr
	M	ne_cr
r7 = f9d63fc535ced2f356f372430a6403a194514ec3 (refs/remotes/git-svn)
Updating 4aec1d6..f9d63fc
Fast-forward
 cr    |    4 +++-
 ne_cr |    4 +++-
...
expecting success: 
	...
	A	deeply/nested/directory/.keep
r8 = 4bfa9f97c9e8121ae3256c2a142f78c1e50d1e52 (refs/remotes/git-svn)
Updating f9d63fc..4bfa9f9
Fast-forward

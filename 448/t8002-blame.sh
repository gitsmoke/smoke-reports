...
[master (root-commit) 28d13ae] Initial.
 Author: A <A@test.git>
...
Merging:
e0a2d0b Branch2-1
virtual aa4b8163d6ce6eddbd31bdba2142b157061d9e4c
...
expecting success: echo "evil merge." >>file &&
     git commit -a --amend
[branch2 8250dc0] Merge branch 'branch1' into branch2

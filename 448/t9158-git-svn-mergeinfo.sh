...
expecting success: 
	...
	git svn fetch
r1 = 9cabe7332a1c2d760a6021d62b4716dce237059b (refs/remotes/git-svn)
	A	foo
r2 = c18d2c12f3cedb90cd9bd03e12807018bc367697 (refs/remotes/git-svn)
...
Committed r3
	A	bar
r3 = 50d2d43dccc4ba553b3a8d50acf4cd464694cba2 (refs/remotes/git-svn)

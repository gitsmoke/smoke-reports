...
expecting success: git branch g/h &&
     ...
     git pack-refs --all &&
     git branch -d g
Deleted branch g/h (was ce1e6f3).
Deleted branch g (was ce1e6f3).
...
expecting success: git branch k/l &&
     ...
     git branch -d k/lm &&
     git branch k
Deleted branch k/l (was ce1e6f3).
Deleted branch k/l/m (was ce1e6f3).
Deleted branch k/lm (was ce1e6f3).
...
expecting success: git branch n/o &&
     ...
     git branch -d n/o/p &&
     git branch n
Deleted branch n/o (was ce1e6f3).
Deleted branch n/op (was ce1e6f3).
Deleted branch n/o/p (was ce1e6f3).

...
expecting success: 
	...
	A	README
r1 = 53fd8aefeb6d19fe28572c33e8ca28e834698bd6 (refs/remotes/trunk)
Branch svn set up to track local ref refs/remotes/trunk.
[merge 043fba8] New file
...
Merging:
909b000 friend
virtual dcc9fad22083cb85942be8fcb5de95dfb37580d3
found 1 common ancestor(s):
53fd8ae first commit
Auto-merging README
...
Committed r2
	M	README
r2 = 4a1eb1ae8def78c1df5079ec305e3e41c75068a3 (refs/remotes/trunk)
...
Committed r3
	A	new_file
	M	README
r3 = 0b501f88cf84e9a82f2ba52cf930d0c47569a635 (refs/remotes/trunk)
No changes between current HEAD and refs/remotes/trunk
Resetting to the latest refs/remotes/trunk

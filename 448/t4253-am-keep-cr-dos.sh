...
[master (root-commit) 2e3ecdb] Initial
 Author: A U Thor <author@example.com>
 1 files changed, 1 insertions(+), 0 deletions(-)
 create mode 100644 file
[master de3d514] Second
 Author: A U Thor <author@example.com>
 1 files changed, 1 insertions(+), 0 deletions(-)
[master 67c747b] Third
 Author: A U Thor <author@example.com>
 1 files changed, 1 insertions(+), 0 deletions(-)
...
0001-Second.patch
0002-Third.patch
[dosfiles-keep-cr-continue f71297d] different patch
 Author: A U Thor <author@example.com>
 1 files changed, 1 insertions(+), 0 deletions(-)
Applying: Second
Using index info to reconstruct a base tree...
...
[unixfiles-conf-keepcr-override 0d204da] line ending to unix
 Author: A U Thor <author@example.com>

...
[master (root-commit) ce1e6f3] Initial commit.
 Author: A U Thor <author@example.com>
 1 files changed, 1 insertions(+), 0 deletions(-)
 create mode 100644 A
[master e05c564] Second commit.
 Author: A U Thor <author@example.com>
 1 files changed, 1 insertions(+), 0 deletions(-)
...
expecting success: git branch -d d/e/f &&
	 test ! -f .git/refs/heads/d/e/f &&
	 test ! -f .git/logs/refs/heads/d/e/f
Deleted branch d/e/f (was e05c564).
...
expecting success: git branch l/m &&
        git branch -d l/m &&
        git branch l
Deleted branch l/m (was e05c564).
...
Deleted branch s/t (was e05c564).
...
Deleted branch my7 (was e05c564).
...
e05c56445b6d9778020bf48fa15d2f87694c25ea
...
expecting success: 
	...
	git branch -d my8
Deleted branch my8 (was e05c564).

...
[master (root-commit) cbdeafe] initial
...
Merging:
f1a3afc addition
virtual 3269569d28ea6fab507634f7f005ab91f923fb91
...
[master (root-commit) c1e0e3c] initial
 Author: A U Thor <author@example.com>
 1 files changed, 1 insertions(+), 0 deletions(-)
 create mode 100644 file1

...
expecting success: 
	...
	echo happy.
[master (root-commit) 6e8aa1e] initial
...
HEAD is now at 6e8aa1e initial
...
[master 2c3ea97] Add .gitattributes
 Author: A U Thor <author@example.com>
...
[master 742e0e7] initial
 Author: A U Thor <author@example.com>
 1 files changed, 1 insertions(+), 0 deletions(-)
[master 36ec75b] second
 Author: A U Thor <author@example.com>
...
[master b6e7866] alllf, allcrlf and mixed only
 Author: A U Thor <author@example.com>

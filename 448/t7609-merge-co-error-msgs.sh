...
expecting success: 
	...
	echo other >four &&
	echo other >five
[master (root-commit) 2e58e13] First
 Author: A U Thor <author@example.com>
 1 files changed, 1 insertions(+), 0 deletions(-)
 create mode 100644 one
[branch 113ce99] Second
 Author: A U Thor <author@example.com>
...
Updating 2e58e13..113ce99
Aborting
[master 673e7ad] empty
 Author: A U Thor <author@example.com>
Aborting
HEAD is now at 2e58e13 First
...
[master (root-commit) d1d4770] init
 Author: A U Thor <author@example.com>
...
rm 'rep/foo'
rm 'rep2/foo'
[branch a490213] added test as a file
 Author: A U Thor <author@example.com>

...
expecting success: 
	...
	git commit -m "untracked symlink remains" &&
	 ...
	 test -f a/b-2/c/d
HEAD is now at e00c11e dir to symlink
rm 'a/b'
[detached HEAD 944e835] untracked symlink remains
 Author: A U Thor <author@example.com>
...
expecting success: 
	...
	git commit -m x &&
	git tag baseline
HEAD is now at 1c02bf4 base
[detached HEAD 8b8315c] x
 Author: A U Thor <author@example.com>
 1 files changed, 1 insertions(+), 0 deletions(-)
...
HEAD is now at 28419a3 Merge branch 'master' into HEAD
Merging:
8b8315c x
virtual master
...
expecting success: 
	...
	test -h a/b &&
	test -f a/b-2/c/d
HEAD is now at c8e0fb9 Merge commit 'baseline^0' into HEAD
Merging:
e00c11e dir to symlink
virtual baseline^0
found 1 common ancestor(s):
1c02bf4 base
...
HEAD is now at 8b8315c x
[detached HEAD 4ba58f4] dir a/b-2 to symlink
 Author: A U Thor <author@example.com>
...
HEAD is now at 4ba58f4 dir a/b-2 to symlink
Trying really trivial in-index merge...
Nope.
Trying simple merge.
Simple merge failed, trying Automatic merge.
...
HEAD is now at 1cd4e13 Merge commit 'test2' into HEAD
Merging:
8b8315c x
virtual test2
found 1 common ancestor(s):

...
expecting success: 
	...
	repo_fetched one &&
	repo_fetched two
[master (root-commit) 2bf4b80] update-all
...
[master e39ee2c] fetch-group-all
 Author: A U Thor <author@example.com>
 1 files changed, 1 insertions(+), 0 deletions(-)
[master e39ee2c] fetch-group-all
 Author: A U Thor <author@example.com>
...
[master 3c64d83] fetch-group-some
 Author: A U Thor <author@example.com>
 1 files changed, 1 insertions(+), 0 deletions(-)
[master 3c64d83] fetch-group-some
 Author: A U Thor <author@example.com>

...
[master (root-commit) 7f389aa] added file1
 Author: A U Thor <author@example.com>
 2 files changed, 2 insertions(+), 0 deletions(-)
 create mode 100644 file1
 create mode 100644 subdir/file3
[branch1 65fbd7c] branch1 changes
 Author: A U Thor <author@example.com>
 3 files changed, 3 insertions(+), 2 deletions(-)
 create mode 100644 file2
[master 26dfa48] master updates
 Author: A U Thor <author@example.com>
 3 files changed, 3 insertions(+), 2 deletions(-)
 create mode 100644 file2
...
[test1 e432b32] branch1 resolved with mergetool
 Author: A U Thor <author@example.com>
...
x")" &&
    ...
    git reset --hard
[test2 950fb90] branch1 resolved with mergetool - autocrlf
 Author: A U Thor <author@example.com>
HEAD is now at 950fb90 branch1 resolved with mergetool - autocrlf
...
[test3 2eef479] branch1 resolved with mergetool - subdir
 Author: A U Thor <author@example.com>
...
HEAD is now at 65fbd7c branch1 changes
...
Normal merge conflict for 'subdir/file3':
  {local}: modified
  {remote}: modified
[test4 d1977de] branch2 resolved by mergetool from subdir
 Author: A U Thor <author@example.com>

...
[master (root-commit) 17ca1e8] initial
...
[master d15d20f] master removes file2 and subdir/file2
 Author: A U Thor <author@example.com>
...
D	file2
D	subdir/file2
[side 5793a93] side adds file3 and removes file2
 Author: A U Thor <author@example.com>
...
HEAD is now at d15d20f master removes file2 and subdir/file2
...
expecting success: 
	...
	git checkout side-a
HEAD is now at d15d20f master removes file2 and subdir/file2
[side-a 55db06f] side-a changes file1
 Author: A U Thor <author@example.com>
 1 files changed, 1 insertions(+), 0 deletions(-)
[side-b c4f8482] side-b changes file2
 Author: A U Thor <author@example.com>
 1 files changed, 1 insertions(+), 0 deletions(-)
...
HEAD is now at 55db06f side-a changes file1
...
HEAD is now at 55db06f side-a changes file1
[sym-b e56d841] side adds a/b
 Author: A U Thor <author@example.com>
 0 files changed, 0 insertions(+), 0 deletions(-)
 create mode 100644 a/b
[sym-a 6ed31a8] we add a/b
 Author: A U Thor <author@example.com>
 1 files changed, 1 insertions(+), 0 deletions(-)
...
HEAD is now at 6ed31a8 we add a/b
...
HEAD is now at 6ed31a8 we add a/b
[side-a 62feeb9] side-a changes file2 to directory
 Author: A U Thor <author@example.com>
...
HEAD is now at c4f8482 side-b changes file2
Trying simple merge.
...
Merging:
c4f8482 side-b changes file2
62feeb9 side-a changes file2 to directory

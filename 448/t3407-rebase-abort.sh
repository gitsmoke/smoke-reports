...
[master d878688] c
 Author: A U Thor <author@example.com>
 1 files changed, 1 insertions(+), 1 deletions(-)
[to-rebase fe62033] merge should fail on this
 Author: A U Thor <author@example.com>
 1 files changed, 1 insertions(+), 1 deletions(-)
[to-rebase f280531] merge should fail on this, too
 Author: A U Thor <author@example.com>
 1 files changed, 1 insertions(+), 1 deletions(-)
...
HEAD is now at f280531 merge should fail on this, too
...
Merging HEAD with merge should fail on this, too
Merging:
c9e8e79 merge should fail on this
virtual merge should fail on this, too
found 1 common ancestor(s):
virtual f788de73cfc81f8d734fa7efc658cc63ca083f50
Auto-merging a
...
Merging:
d878688 c
fe62033 merge should fail on this
found 1 common ancestor(s):
a19d7d5 a
Auto-merging a
CONFLICT (content): Merge conflict in a
...
Merging:
d878688 c
f280531 merge should fail on this, too
found 1 common ancestor(s):
fe62033 merge should fail on this
Auto-merging a
CONFLICT (content): Merge conflict in a
...
Auto-merging a
CONFLICT (content): Merge conflict in a
[detached HEAD c9046a4] merge should fail on this
 Author: A U Thor <author@example.com>
 1 files changed, 1 insertions(+), 0 deletions(-)
Committed: 0001 merge should fail on this
Merging master with HEAD~0
Merging:
c9046a4 merge should fail on this
f280531 merge should fail on this, too
found 1 common ancestor(s):
fe62033 merge should fail on this
Auto-merging a

...
[master (root-commit) fc418e3] commit
...
Unstaged changes after reset:
M	file
[master 663a1cd] commit
 Author: A U Thor <author@example.com>
 1 files changed, 1 insertions(+), 1 deletions(-)
HEAD is now at fc418e3 commit
...
[master 82d3e23] clear local changes
 Author: A U Thor <author@example.com>
 1 files changed, 1 insertions(+), 0 deletions(-)
...
HEAD is now at 82d3e23 clear local changes
[master 35681eb] non-empty
 Author: A U Thor <author@example.com>
 1 files changed, 1 insertions(+), 0 deletions(-)
...
HEAD is now at 35681eb non-empty
[master 4e9404f] empty
 Author: A U Thor <author@example.com>

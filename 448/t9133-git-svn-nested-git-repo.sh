...
Initialized empty Git repository in /Users/trast/git-smoke/t/trash directory.t9133-git-svn-nested-git-repo/g/.git/
	A	a
r1 = 2177118edec08cbe155d92dd2fd10d6a07f9ea38 (refs/remotes/git-svn)
r2 = 10f65c4558f1b6134a9b2f858141e1890fda9e87 (refs/remotes/git-svn)
...
expecting success: 
	...
	M	a
r3 = 3a6b971c726d33cb61b92da4ab327ab538bfa442 (refs/remotes/git-svn)
...
[master (root-commit) 87bdd06] add a inside an SVN repo
 Author: A U Thor <author@example.com>
 1 files changed, 2 insertions(+), 0 deletions(-)
 create mode 100644 a
commit 87bdd0697ca449f0b251c0bd5946153cd0636f69
Author: A U Thor <author@example.com>
Date:   Thu Jan 13 04:04:12 2011 +0000
...
A         .git/objects/87
A         .git/objects/87/bdd0697ca449f0b251c0bd5946153cd0636f69
A         .git/objects/a3
...
Adding         .git/objects/87
Adding         .git/objects/87/bdd0697ca449f0b251c0bd5946153cd0636f69
...
r4 = 35f5b0893ded6b3a10a67ad7591024004ae08a14 (refs/remotes/git-svn)
First, rewinding head to replay your work on top of it...
Fast-forwarded master to refs/remotes/git-svn.
...
[master d95cafa] add a inside an SVN repo
 Author: A U Thor <author@example.com>
...
expecting success: 
	...
	M	a
r5 = 0d92e8d564384f74be76d0896cc2997b067764af (refs/remotes/git-svn)
First, rewinding head to replay your work on top of it...
Fast-forwarded master to refs/remotes/git-svn.

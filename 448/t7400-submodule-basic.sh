...
[master (root-commit) 127c82d] initial commit
...
[master (root-commit) 9791de2] submodule commit 1
 Author: A U Thor <author@example.com>
...
[master (root-commit) 75fb058] Ignore everything
 Author: A U Thor <author@example.com>
 1 files changed, 1 insertions(+), 0 deletions(-)
...
rev1: 9791de251f3637a04c34d7165a55ce6be19b883b
...
-9791de251f3637a04c34d7165a55ce6be19b883b init
...
Submodule path 'init': checked out '9791de251f3637a04c34d7165a55ce6be19b883b'
...
expecting success: 
	...
	grep "^ $rev1" list
 9791de251f3637a04c34d7165a55ce6be19b883b init (rev-1)
...
expecting success: 
	...
	grep "^+$rev2" list
[detached HEAD 586f598] submodule commit 2
 Author: A U Thor <author@example.com>
 1 files changed, 1 insertions(+), 0 deletions(-)
 create mode 100644 b
+586f59872361ed2c4d2bfe00fbe4c366b32668ba init (rev-1-1-g586f598)
...
+Subproject commit 586f59872361ed2c4d2bfe00fbe4c366b32668ba
...
[detached HEAD beec96e] change subproject
 Author: A U Thor <author@example.com>
 1 files changed, 1 insertions(+), 0 deletions(-)
 create mode 100644 s
[master 358d5c1] change init
 Author: A U Thor <author@example.com>
...
Submodule path 'init': checked out 'beec96e9a1408c559e4f7601636fbd682735f66d'
...
HEAD is now at c4ac5e1 super commit 1
...
HEAD is now at c4ac5e1 super commit 1
[second 0d3c272] commit subproject
 Author: A U Thor <author@example.com>
 1 files changed, 1 insertions(+), 1 deletions(-)
diff --git a/init b/init
index beec96e..8350b41 160000
--- a/init
+++ b/init
@@ -1 +1 @@
-Subproject commit beec96e9a1408c559e4f7601636fbd682735f66d
+Subproject commit 8350b41e35a9784dfb79e347a2e5ef663af3faee
...
HEAD is now at 0d3c272 commit subproject
...
[master (root-commit) 6ee73f2] repo commit 1
 Author: A U Thor <author@example.com>
 1 files changed, 1 insertions(+), 0 deletions(-)
...
Initialized empty Git repository in /Users/trast/git-smoke/t/trash directory.t7400-submodule-basic/reltest/.git/
Initialized empty Git repository in /Users/trast/git-smoke/t/trash directory.t7400-submodule-basic/reltest/sub/.git/
...
ok 43 - relative path works with user@host:path

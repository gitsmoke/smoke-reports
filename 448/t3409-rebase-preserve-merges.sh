...
[master (root-commit) a24c908] Add A1
 Author: A U Thor <bogus_email_address>
 1 files changed, 1 insertions(+), 0 deletions(-)
 create mode 100644 A
[topic 90799f4] Add B1
 Author: A U Thor <bogus_email_address>
 1 files changed, 1 insertions(+), 0 deletions(-)
 create mode 100644 B
[master 3f3fe5c] Modify A2
 Author: A U Thor <bogus_email_address>
 1 files changed, 1 insertions(+), 0 deletions(-)
Cloning into clone1...
done.
...
Merge made by recursive.
 A |    1 +
 1 files changed, 1 insertions(+), 0 deletions(-)
[master 27c7cb4] Add different B
 Author: A U Thor <bogus_email_address>
 1 files changed, 1 insertions(+), 0 deletions(-)
 create mode 100644 B
Cloning into clone2...
...
[topic 7988d04] Merge origin/master into topic
 Author: A U Thor <bogus_email_address>
[topic 2632eb8] Modify B2
 Author: A U Thor <bogus_email_address>
 1 files changed, 1 insertions(+), 0 deletions(-)
...
Rebasing (1/1)Merging:
2632eb8 Modify B2
virtual 27c7cb4042a0d2ff3fb2cc271969c9003fa43fce
found 1 common ancestor(s):
a24c908 Add A1
Auto-merging B
CONFLICT (add/add): Merge conflict in B
...
B: needs merge
@@@ -1,1 -1,1 +1,1 @@@
[detached HEAD 7c33342] Merge origin/master into topic
 Author: A U Thor <bogus_email_address>
Rebasing (1/1)

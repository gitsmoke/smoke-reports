...
[master (root-commit) 961b25a] Initial empty commit
 Author: A U Thor <author@example.com>
[master e356222] first
 Author: A U Thor <author@example.com>
 1 files changed, 4 insertions(+), 0 deletions(-)
 create mode 100644 file
[master c094d50] second
 Author: A U Thor <author@example.com>

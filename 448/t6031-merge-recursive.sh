...
[master (root-commit) 5667ecc] initial
...
[other 7079df7] changesimplefile
 Author: A U Thor <author@example.com>
 1 files changed, 1 insertions(+), 0 deletions(-)
rm 'sub1'
[main c7f848a] changefiletodir
 Author: A U Thor <author@example.com>

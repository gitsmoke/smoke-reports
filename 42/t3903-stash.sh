...
ok 36 - stash drop - bad stash ref
ok 37 - stash pop - bad stash ref
ok 38 - stash apply - bad stash ref
ok 39 - stash show - bad stash ref
ok 40 - stash drop - invalid stash reference

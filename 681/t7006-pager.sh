...
ok 20 # skip git log - default pager is used by default (missing TTY of SIMPLEPAGER,TTY)
...
ok 25 # skip git -p log - default pager is used by default (missing TTY of SIMPLEPAGER,TTY)
...
ok 30 # skip git aliasedlog - default pager is used by default (missing TTY of SIMPLEPAGER,TTY)
...
ok 35 # skip git -p aliasedlog - default pager is used by default (missing TTY of SIMPLEPAGER,TTY)
...
ok 40 # skip git -p true - default pager is used by default (missing TTY of SIMPLEPAGER,TTY)
...
ok 45 # skip git -p request-pull - default pager is used by default (missing TTY of SIMPLEPAGER,TTY)
...
ok 50 # skip git -p - default pager is used by default (missing TTY of SIMPLEPAGER,TTY)
...
ok 56 # skip git shortlog - default pager is used by default (missing TTY of SIMPLEPAGER,TTY)
...
ok 64 # skip git -p shortlog - default pager is used by default (missing TTY of SIMPLEPAGER,TTY)
...
ok 67 # skip command-specific pager (missing TTY)
ok 68 # skip command-specific pager overrides core.pager (missing TTY)
ok 69 # skip command-specific pager overridden by environment (missing TTY)

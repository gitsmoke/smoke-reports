...
ok 90 - verifying rfc1991 signature without --rfc1991
ok 91 - list tag with rfc1991 signature without --rfc1991
ok 92 - reediting a signed tag body omits signature
ok 93 - git tag -s fails if gpg is misconfigured
ok 94 - verify signed tag fails when public key is not present
ok 95 - git tag -a fails if tag annotation is empty
ok 96 - message in editor has initial comment
ok 97 - overwriting an annoted tag should use its previous body
ok 98 - filename for the message is relative to cwd
ok 99 - filename for the message is relative to cwd
ok 100 - creating second commit and tag
ok 101 - creating third commit without tag
ok 102 - checking that first commit is in all tags (hash)
ok 103 - checking that first commit is in all tags (tag)
ok 104 - checking that first commit is in all tags (relative)
ok 105 - checking that second commit only has one tag
ok 106 - checking that third commit has no tags
ok 107 - creating simple branch
ok 108 - checking that branch head only has one tag
ok 109 - merging original branch into this branch
ok 110 - checking that original branch head has one tag now
ok 111 - checking that initial commit is in all tags
ok 112 - mixing incompatibles modes and options is forbidden

...
ok 77 - grep -e -- -- path
ok 78 # skip grep --perl-regexp pattern (missing LIBPCRE)
ok 79 # skip grep -P pattern (missing LIBPCRE)
ok 80 # skip grep -P -i pattern (missing LIBPCRE)
ok 81 # skip grep -P -w pattern (missing LIBPCRE)
ok 82 # skip grep -P -F returns error (missing LIBPCRE)
ok 83 # skip grep -P -E returns error (missing LIBPCRE)
ok 84 # skip grep -P -G returns error (missing LIBPCRE)
ok 85 # skip grep -P -E -G returns error (missing LIBPCRE)

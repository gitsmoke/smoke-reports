...
# run 1: Perl Git::I18N API (/usr/bin/perl /tmp/build-and-install-git-2010-11-18-srQa/t/t0202/test.pl)
1..9
ok 1 - Testing Git::I18N version 0.01 with Locale::Messages version 1.20
ok 2 - Git::I18N is located at /tmp/build-and-install-git-2010-11-18-srQa/t/../perl/blib/lib/Git/I18N.pm

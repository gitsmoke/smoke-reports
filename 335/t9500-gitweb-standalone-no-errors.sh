...
ok 92 - caching enabled (project summary, first run, generating cache)
ok 93 - caching enabled (project summary, second run, cached version)
ok 94 - caching enabled (non-existent commit, non-cache error page)

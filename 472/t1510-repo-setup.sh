...
ok 2 - #1: GIT_WORK_TREE without explicit GIT_DIR is reluctantly accepted
...
ok 12 - #4: core.worktree without GIT_DIR set is reluctantly accepted
ok 13 - #5: core.worktree + GIT_WORK_TREE is reluctantly accepted
...
ok 28 - #9: GIT_WORK_TREE reluctantly accepted with gitfile
...
ok 38 - #12: core.worktree with gitfile is reluctantly accepted
ok 39 - #13: core.worktree+GIT_WORK_TREE relucantly accepted (with gitfile)
...
ok 52 - #17: GIT_WORK_TREE without explicit GIT_DIR is reluctantly accepted (bare case)
...
ok 61 - #20a: core.worktree without GIT_DIR reluctantly accepted (inside .git)
...
ok 82 - #25: GIT_WORK_TREE accepted reluctantly if GIT_DIR unset (bare gitfile case)

...
[master (root-commit) 91aedff] initial
...
[master b7348d3] master removes file2 and subdir/file2
 Author: A U Thor <author@example.com>
...
D	file2
D	subdir/file2
[side b44287f] side adds file3 and removes file2
 Author: A U Thor <author@example.com>
...
HEAD is now at b7348d3 master removes file2 and subdir/file2
...
expecting success: 
	...
	git checkout side-a
HEAD is now at b7348d3 master removes file2 and subdir/file2
[side-a 46fbfff] side-a changes file1
 Author: A U Thor <author@example.com>
 1 files changed, 1 insertions(+), 0 deletions(-)
[side-b db3151b] side-b changes file2
 Author: A U Thor <author@example.com>
 1 files changed, 1 insertions(+), 0 deletions(-)
...
HEAD is now at 46fbfff side-a changes file1
...
HEAD is now at 46fbfff side-a changes file1
[sym-b b061bbf] side adds a/b
 Author: A U Thor <author@example.com>
 0 files changed, 0 insertions(+), 0 deletions(-)
 create mode 100644 a/b
[sym-a 105bf66] we add a/b
 Author: A U Thor <author@example.com>
 1 files changed, 1 insertions(+), 0 deletions(-)
...
HEAD is now at 105bf66 we add a/b
...
HEAD is now at 105bf66 we add a/b
[side-a f4482f0] side-a changes file2 to directory
 Author: A U Thor <author@example.com>
...
HEAD is now at db3151b side-b changes file2
Trying simple merge.
...
Merging:
db3151b side-b changes file2
f4482f0 side-a changes file2 to directory

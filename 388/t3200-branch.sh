...
[master (root-commit) 1c732a7] Initial commit.
 Author: A U Thor <author@example.com>
 1 files changed, 1 insertions(+), 0 deletions(-)
 create mode 100644 A
[master 20bd30b] Second commit.
 Author: A U Thor <author@example.com>
 1 files changed, 1 insertions(+), 0 deletions(-)
...
expecting success: git branch -d d/e/f &&
	 test ! -f .git/refs/heads/d/e/f &&
	 test ! -f .git/logs/refs/heads/d/e/f
Deleted branch d/e/f (was 20bd30b).
...
Deleted branch s/t (was 20bd30b).
...
Deleted branch my7 (was 20bd30b).
...
20bd30be79f503cc89df2df2654893ff8dd4dc4b
...
expecting success: 
	...
	git branch -d my8
Deleted branch my8 (was 20bd30b).

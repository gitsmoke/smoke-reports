...
Committed revision 1.
	A	foo
r1 = 26a62425360eb266e79857cf165835d97fd132d1 (refs/remotes/git-svn)
...
[master bde2bfb] files for enabled auto-props
...
Committed r2
	...
	A	bar
	A	exec1.sh
r2 = e65abd86e498e32b1371386b8fa105a00919ba98 (refs/remotes/git-svn)
...
[master b9a913c] files for disabled auto-props
 Author: A U Thor <author@example.com>
 3 files changed, 3 insertions(+), 0 deletions(-)
...
Committed r3
	...
	A	world.txt
	A	zot
r3 = 70f33bceba7214ae31ee1190d49416b24498f4d6 (refs/remotes/git-svn)
No changes between current HEAD and refs/remotes/git-svn
Resetting to the latest refs/remotes/git-svn
...
Committed r4
	D	foo
	A	foo.sh
r4 = cfc7813fdf74f1764c2d9d98d5ddb63acbe34e65 (refs/remotes/git-svn)
No changes between current HEAD and refs/remotes/git-svn
Resetting to the latest refs/remotes/git-svn
D    foo
A    foo.sh

...
r1 = 4f6a99aaf776c4f055bb48bf050e473a12211f77 (refs/remotes/git-svn)
...
[mybranch 62bdad3] try a deep --rmdir with a commit
 ...
 rename dir/a/b/c/d/e/file => file (100%)
	...
	D	dir/a/
	A	dir/file
r2 = 47e4ca0cdd3190b70fc8f16b016366f52ac7bb7b (refs/remotes/git-svn)
...
[mybranch 7d23e44] detect node change from file to directory #1
 Author: A U Thor <author@example.com>
...
[mybranch2 d5f531e] detect node change from directory to file #1
 Author: A U Thor <author@example.com>
 1 files changed, 0 insertions(+), 0 deletions(-)
...
[mybranch3 a6ec5f5] detect node change from file to directory #2
 Author: A U Thor <author@example.com>
...
[mybranch4 9811bfe] detect node change from directory to file #2
 Author: A U Thor <author@example.com>
 2 files changed, 1 insertions(+), 1 deletions(-)
...
[mybranch5 87da377] remove executable bit from a file
 Author: A U Thor <author@example.com>
 0 files changed, 0 insertions(+), 0 deletions(-)
 mode change 100755 => 100644 exec.sh
	M	exec.sh
	M	exec.sh
r3 = 14ef2acfe9fc28f4be98e859722bedfcc244cd6b (refs/remotes/git-svn)
Done committing 1 revisions to SVN
...
expecting success: 
	...
	svn_cmd up "$SVN_TREE" &&
	test -x "$SVN_TREE"/exec.sh
[mybranch5 c535a51] add executable bit back file
 Author: A U Thor <author@example.com>
 0 files changed, 0 insertions(+), 0 deletions(-)
 mode change 100644 => 100755 exec.sh
	M	exec.sh
	M	exec.sh
r4 = 468791548cb15af5e2c6a98b219e1c256bf92e11 (refs/remotes/git-svn)
Done committing 1 revisions to SVN
UU   /Users/trast/git-smoke/t/trash directory.t9100-git-svn-basic/.git/svn/refs/remotes/git-svn/svn-tree/exec.sh
...
[mybranch5 03eca4b] executable file becomes a symlink to bar/zzz (file)
 Author: A U Thor <author@example.com>
 ...
 mode change 100755 => 120000
	T	exec.sh
	M	exec.sh
r5 = 4c4e20bba7c0705ce2a191579998fe5c80b87f27 (refs/remotes/git-svn)
Done committing 1 revisions to SVN
UU   /Users/trast/git-smoke/t/trash directory.t9100-git-svn-basic/.git/svn/refs/remotes/git-svn/svn-tree/exec.sh
...
[mybranch5 b00ae17] new symlink is added to a file that was also just made executable
 Author: A U Thor <author@example.com>
 ...
 create mode 120000 exec-2.sh
	...
	M	bar/zzz
	A	exec-2.sh
r6 = e3032d386a6fdadec7a985a9bc518b9c106602c8 (refs/remotes/git-svn)
Done committing 1 revisions to SVN
...
[mybranch5 bb91956] modify a symlink to become a file
 Author: A U Thor <author@example.com>
 1 files changed, 1 insertions(+), 1 deletions(-)
 ...
 mode change 120000 => 100644
	T	exec-2.sh
	M	exec-2.sh
r7 = e04bd5b102f76311a03d3a4659ba703eb125d865 (refs/remotes/git-svn)
Done committing 1 revisions to SVN
...
expecting success: git svn init "$svnrepo" && git svn fetch &&
	...
	A	exec.sh
	A	dir/a/b/c/d/e/file
r1 = 4f6a99aaf776c4f055bb48bf050e473a12211f77 (refs/remotes/alt)
	A	file
	D	dir/a/b/c/d/e/file
	D	dir/a/
	A	dir/file
r2 = 8c780bdde22faa1d990851662680e3e22a398cb0 (refs/remotes/alt)
	M	exec.sh
r3 = 4714c0b4f19f2b8c62bcb0599b9195bdd1ed4b7e (refs/remotes/alt)
	M	exec.sh
r4 = a76d88826cae8fcdbc993afd0568a68cfab5354d (refs/remotes/alt)
	M	exec.sh
r5 = 19a09932f9254090767823a227691b1e5f08784b (refs/remotes/alt)
	M	bar/zzz
	A	exec-2.sh
r6 = 40234385493befbd5e2287a50497afaf1d229772 (refs/remotes/alt)
	M	exec-2.sh
r7 = 32e9755792f2e113b667446764d884fde66eaee6 (refs/remotes/alt)
...
expecting success: 
	...
	A	zzz
r1 = 3e09af706fc3d0a69f3813a5e0218cc5d3b2f496 (refs/remotes/bar)
	M	zzz
r6 = db88f09f9192fb26eec7f919c9dab8b945f4129f (refs/remotes/bar)
[my-bar 197dc90] change 1
 Author: A U Thor <author@example.com>
 1 files changed, 1 insertions(+), 0 deletions(-)
 create mode 100644 foo
[my-bar a6e8877] change 2
 Author: A U Thor <author@example.com>
 1 files changed, 1 insertions(+), 1 deletions(-)
...
Committed r8
	A	foo
r8 = e0b64f4ba3a42fbb85e604cbeda027da0d39fa28 (refs/remotes/bar)
...
The rewritten commit is: e0b64f4ba3a42fbb85e604cbeda027da0d39fa28
    change 1
Deleted branch my-bar (was a6e8877).
...
expecting success: 
	...
	A	bar/foo
r8 = 1a0d19dd9a0e0375872bf1fcdb77c6d063831ec6 (refs/remotes/alt)
[my-bar 41823f3] /bar/d should be in the log
 Author: A U Thor <author@example.com>
 1 files changed, 1 insertions(+), 0 deletions(-)
...
Committed r9
	A	d
r9 = 74eec347896d1b758dc249acbdf1828d2d8fc553 (refs/remotes/bar)
No changes between current HEAD and refs/remotes/bar
Resetting to the latest refs/remotes/bar
[my-bar 8625663] add a new directory
 Author: A U Thor <author@example.com>
 1 files changed, 1 insertions(+), 0 deletions(-)
...
Committed r10
	A	newdir/dir
r10 = e70347fa5d0b969f20fde9e44d8627fa9fd04d94 (refs/remotes/bar)
No changes between current HEAD and refs/remotes/bar
Resetting to the latest refs/remotes/bar
[my-bar 131de6c] modify a file in new directory
 Author: A U Thor <author@example.com>
 1 files changed, 1 insertions(+), 0 deletions(-)
Committing to file:///Users/trast/git-smoke/t/trash directory.t9100-git-svn-basic/svnrepo/bar ...
	M	newdir/dir
Committed r11
	M	newdir/dir
r11 = 06f7efd17fe8ae2f36633266645f9285bafe08dc (refs/remotes/bar)
No changes between current HEAD and refs/remotes/bar
Resetting to the latest refs/remotes/bar
...
[my-bar 1110787] commit-new-file-foo2
 Author: A U Thor <author@example.com>
 1 files changed, 1 insertions(+), 0 deletions(-)
...
Committed r12
	A	foo2
r12 = b6dc95b008552fea2acf8c5a53ca3e8a2404c617 (refs/remotes/bar)
No changes between current HEAD and refs/remotes/bar
Resetting to the latest refs/remotes/bar
...
[my-bar 8c509fb] update /bar/d
 Author: A U Thor <author@example.com>
 1 files changed, 1 insertions(+), 1 deletions(-)
	M	d
	M	d
r13 = 447b59f8d4050f1de3ff8160d8026516fbc4a975 (refs/remotes/bar)
Done committing 1 revisions to SVN
...
r8 = 1a0d19dd9a0e0375872bf1fcdb77c6d063831ec6 (refs/remotes/alt)
	A	bar/d
r9 = 4cc3af5925321b6f4aecee3051af6c3e2b829929 (refs/remotes/alt)
	A	bar/newdir/dir
r10 = bc02e8d0b8dc8300404c7b47c855b233af6c04fa (refs/remotes/alt)
	M	bar/newdir/dir
r11 = 4df591e63e17f5d8a8a9c81ba779e0a93239cd04 (refs/remotes/alt)
	A	bar/foo2
r12 = 6691db1f57e00eda156a55f211fa4aad75321cc3 (refs/remotes/alt)
	M	bar/d
r13 = f70ef77b7a9250c5eafc67272710c0d7666526a5 (refs/remotes/alt)

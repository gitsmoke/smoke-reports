...
[master (root-commit) 47e2aa9] added file1
 Author: A U Thor <author@example.com>
 2 files changed, 2 insertions(+), 0 deletions(-)
 create mode 100644 file1
 create mode 100644 subdir/file3
[branch1 279c5b5] branch1 changes
 Author: A U Thor <author@example.com>
 3 files changed, 3 insertions(+), 2 deletions(-)
 create mode 100644 file2
[master 74f7aff] master updates
 Author: A U Thor <author@example.com>
 3 files changed, 3 insertions(+), 2 deletions(-)
 create mode 100644 file2
...
[test1 5686e0a] branch1 resolved with mergetool
 Author: A U Thor <author@example.com>
...
x")" &&
    ...
    git reset --hard
[test2 a69b5d1] branch1 resolved with mergetool - autocrlf
 Author: A U Thor <author@example.com>
HEAD is now at a69b5d1 branch1 resolved with mergetool - autocrlf
ok 3 - mergetool crlf
expecting success: 
...
[test3 f9446c7] branch1 resolved with mergetool - subdir
 Author: A U Thor <author@example.com>
...
HEAD is now at 279c5b5 branch1 changes
...
Normal merge conflict for 'subdir/file3':
  {local}: modified
  {remote}: modified
[test4 2583a8b] branch2 resolved by mergetool from subdir
 Author: A U Thor <author@example.com>

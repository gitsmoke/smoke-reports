...
[master 3a04a21] c
 Author: A U Thor <author@example.com>
 1 files changed, 1 insertions(+), 1 deletions(-)
[to-rebase 8ba6a23] merge should fail on this
 Author: A U Thor <author@example.com>
 1 files changed, 1 insertions(+), 1 deletions(-)
[to-rebase b32dc8f] merge should fail on this, too
 Author: A U Thor <author@example.com>
 1 files changed, 1 insertions(+), 1 deletions(-)
...
HEAD is now at b32dc8f merge should fail on this, too
...
Merging HEAD with merge should fail on this, too
Merging:
4df3886 merge should fail on this
virtual merge should fail on this, too
found 1 common ancestor(s):
virtual f788de73cfc81f8d734fa7efc658cc63ca083f50
Auto-merging a
...
Merging:
3a04a21 c
8ba6a23 merge should fail on this
found 1 common ancestor(s):
1f326b2 a
Auto-merging a
CONFLICT (content): Merge conflict in a
...
Merging:
3a04a21 c
b32dc8f merge should fail on this, too
found 1 common ancestor(s):
8ba6a23 merge should fail on this
Auto-merging a
CONFLICT (content): Merge conflict in a
...
Auto-merging a
CONFLICT (content): Merge conflict in a
[detached HEAD 9232a5a] merge should fail on this
 Author: A U Thor <author@example.com>
 1 files changed, 1 insertions(+), 0 deletions(-)
Committed: 0001 merge should fail on this
Merging master with HEAD~0
Merging:
9232a5a merge should fail on this
b32dc8f merge should fail on this, too
found 1 common ancestor(s):
8ba6a23 merge should fail on this
Auto-merging a

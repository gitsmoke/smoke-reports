...
expecting success: 
	...
	git tag six
[master (root-commit) d3c6660] Initial
 Author: A U Thor <author@example.com>
 2 files changed, 361 insertions(+), 0 deletions(-)
 create mode 120000 bar
 create mode 100644 foo
[master ed37dea] Second
 Author: A U Thor <author@example.com>
 2 files changed, 0 insertions(+), 0 deletions(-)
 rename foo => bar (100%)
 rename bar => foo (100%)
[master 854def5] Third
 Author: A U Thor <author@example.com>
 1 files changed, 0 insertions(+), 0 deletions(-)
 rename bar => foo (100%)
[master d1604c5] Fourth
 Author: A U Thor <author@example.com>
 2 files changed, 1 insertions(+), 360 deletions(-)
 rename foo => bar (100%)
 rewrite foo (100%)
 mode change 100644 => 120000
[master 46bcc6d] Fifth
 Author: A U Thor <author@example.com>
 2 files changed, 2452 insertions(+), 360 deletions(-)
 rewrite bar (98%)
 rename bar => foo (100%)
[master 023e8e8] Sixth
 Author: A U Thor <author@example.com>
 2 files changed, 0 insertions(+), 0 deletions(-)
 rename foo => bar (100%)
 rename bar => foo (100%)

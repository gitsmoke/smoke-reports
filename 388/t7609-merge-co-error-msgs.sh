...
expecting success: 
	...
	echo other >four &&
	echo other >five
[master (root-commit) 450f3af] First
 Author: A U Thor <author@example.com>
 1 files changed, 1 insertions(+), 0 deletions(-)
 create mode 100644 one
[branch f285e5c] Second
 Author: A U Thor <author@example.com>
...
expecting success: 
	...
	git reset --hard HEAD^
Updating 450f3af..f285e5c
Aborting
[master 31e85ce] empty
 Author: A U Thor <author@example.com>
Aborting
HEAD is now at 450f3af First
...
[master (root-commit) 644b87f] init
 Author: A U Thor <author@example.com>
...
rm 'rep/foo'
rm 'rep2/foo'
[branch f1a7d9b] added test as a file
 Author: A U Thor <author@example.com>

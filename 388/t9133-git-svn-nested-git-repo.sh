...
Initialized empty Git repository in /Users/trast/git-smoke/t/trash directory.t9133-git-svn-nested-git-repo/g/.git/
	A	a
r1 = bc19f2ce9da2b40ad8598e231c823c6cb26564b3 (refs/remotes/git-svn)
r2 = e989f1f613e077e25927e5cfd70235482687abe8 (refs/remotes/git-svn)
...
expecting success: 
	...
	M	a
r3 = 849b0814b1588fcb2f5dfe07db1cb9da3ca3cd07 (refs/remotes/git-svn)
...
[master (root-commit) 389db39] add a inside an SVN repo
 Author: A U Thor <author@example.com>
 1 files changed, 2 insertions(+), 0 deletions(-)
 create mode 100644 a
commit 389db39c446270ffb795131b47c96727b754d56c
Author: A U Thor <author@example.com>
Date:   Sat Dec 25 04:04:01 2010 +0000
...
A         .git/objects/38
A         .git/objects/38/9db39c446270ffb795131b47c96727b754d56c
A         .git/objects/42
...
Adding         .git/objects/38
Adding         .git/objects/38/9db39c446270ffb795131b47c96727b754d56c
...
r4 = 4c4c7a321093f8245b88eabd305a3cc6507ba96e (refs/remotes/git-svn)
First, rewinding head to replay your work on top of it...
Fast-forwarded master to refs/remotes/git-svn.
...
[master a390adf] add a inside an SVN repo
 Author: A U Thor <author@example.com>
...
expecting success: 
	...
	M	a
r5 = b036c5518a58d5a24a2b18245e5c5d4f141df636 (refs/remotes/git-svn)
First, rewinding head to replay your work on top of it...
Fast-forwarded master to refs/remotes/git-svn.

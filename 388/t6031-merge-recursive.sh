...
[master (root-commit) ffaf5f4] initial
...
[other dc2afb7] changesimplefile
 Author: A U Thor <author@example.com>
 1 files changed, 1 insertions(+), 0 deletions(-)
rm 'sub1'
[main 1ad6a3d] changefiletodir
 Author: A U Thor <author@example.com>

...
[master (root-commit) d24ab8e] initial
...
Merging:
9b6f1b5 addition
virtual 1de40aed81a08343837b3456b98c60019af1c2b1
...
[master (root-commit) e4658cd] initial
 Author: A U Thor <author@example.com>
 1 files changed, 1 insertions(+), 0 deletions(-)
 create mode 100644 file1

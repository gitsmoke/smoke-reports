...
HEAD is now at 4f4fc60 dir to symlink
rm 'a/b'
[detached HEAD 51595a2] untracked symlink remains
 Author: A U Thor <author@example.com>
...
HEAD is now at cfc863f base
[detached HEAD 6e2f51c] x
 Author: A U Thor <author@example.com>
 1 files changed, 1 insertions(+), 0 deletions(-)
...
expecting success: 
	...
	test -h a/b &&
	test -f a/b-2/c/d
HEAD is now at 076a738 Merge branch 'master' into HEAD
Merging:
6e2f51c x
virtual master
...
expecting success: 
	...
	test -h a/b &&
	test -f a/b-2/c/d
HEAD is now at 10083c8 Merge commit 'baseline^0' into HEAD
Merging:
4f4fc60 dir to symlink
virtual baseline^0
found 1 common ancestor(s):
cfc863f base
...
expecting success: 
	...
	git tag test2
HEAD is now at 6e2f51c x
[detached HEAD fa148ef] dir a/b-2 to symlink
 Author: A U Thor <author@example.com>
...
HEAD is now at fa148ef dir a/b-2 to symlink
Trying really trivial in-index merge...
Nope.
Trying simple merge.
Simple merge failed, trying Automatic merge.
...
HEAD is now at 37e9e32 Merge commit 'test2' into HEAD
Merging:
6e2f51c x
virtual test2
found 1 common ancestor(s):
...
expecting success: 
	...
	test -h a/b-2 &&
	test -f a/b/c/d
HEAD is now at 7081b2e Merge commit 'test2' into HEAD
Merging:
fa148ef dir a/b-2 to symlink
virtual baseline^0
found 1 common ancestor(s):
cfc863f base

...
expecting success: 
	...
	echo happy.
[master (root-commit) 5ed271a] initial
...
HEAD is now at 5ed271a initial
...
[master ee4ddff] Add .gitattributes
 Author: A U Thor <author@example.com>
...
[master 431c5bd] initial
 Author: A U Thor <author@example.com>
 1 files changed, 1 insertions(+), 0 deletions(-)
[master 6ab290c] second
 Author: A U Thor <author@example.com>
...
[master 6714c47] alllf, allcrlf and mixed only
 Author: A U Thor <author@example.com>

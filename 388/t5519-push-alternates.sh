...
[master (root-commit) 06c844a] initial
...
Updating 06c844a..3fdd7d4
Fast-forward
 file |    1 +
 1 files changed, 1 insertions(+), 0 deletions(-)
[master 7d5403a] third
 Author: A U Thor <author@example.com>
...
[master e18a31d] sixth.1
 Author: A U Thor <author@example.com>
 1 files changed, 1 insertions(+), 1 deletions(-)
[master 331b58f] sixth.2
 Author: A U Thor <author@example.com>
 1 files changed, 1 insertions(+), 0 deletions(-)
[master 98f845f] sixth.3
 Author: A U Thor <author@example.com>
 1 files changed, 1 insertions(+), 0 deletions(-)
...
98f845f9af8e33be773e6feb603bc5d835cca5d8
[master b9f3bfa] seventh
 Author: A U Thor <author@example.com>
 1 files changed, 1 insertions(+), 1 deletions(-)

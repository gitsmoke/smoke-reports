...
git checkout master
[master (root-commit) fc79a05] initial has A and M
 Author: A U Thor <author@example.com>
 2 files changed, 30 insertions(+), 0 deletions(-)
 create mode 100644 A
 create mode 100644 M
[master 3ea8007] master updates A
 Author: A U Thor <author@example.com>
 1 files changed, 1 insertions(+), 1 deletions(-)
[yellow f087951] yellow removes M
 Author: A U Thor <author@example.com>
 1 files changed, 0 insertions(+), 15 deletions(-)
 delete mode 100644 M
[white 790880a] white renames A->B, M->N
 Author: A U Thor <author@example.com>
 2 files changed, 2 insertions(+), 2 deletions(-)
 rename A => B (93%)
 rename M => N (93%)
[red 21f99ba] red renames A->B, M->N
 Author: A U Thor <author@example.com>
 2 files changed, 2 insertions(+), 2 deletions(-)
 rename A => B (93%)
 rename M => N (93%)
[blue 957dbf9] blue renames A->C, M->N
 Author: A U Thor <author@example.com>
 2 files changed, 2 insertions(+), 2 deletions(-)
 rename A => C (93%)
 rename M => N (93%)
...
Merging:
3ea8007 master updates A
virtual 790880a7a5be6ec1637881f5072a2c13a3c91b6a
found 1 common ancestor(s):
fc79a05 initial has A and M
Auto-merging B
...
HEAD is now at 3ea8007 master updates A
Merging:
21f99ba red renames A->B, M->N
virtual 790880a7a5be6ec1637881f5072a2c13a3c91b6a
found 1 common ancestor(s):
fc79a05 initial has A and M
Auto-merging B
...
expecting success: 
	...
	git diff --exit-code white N
HEAD is now at 21f99ba red renames A->B, M->N
! [blue] blue renames A->C, M->N
 ! [change] changed
  ! [change+rename] changed and renamed
   ! [master] master updates A
...
Merging:
21f99ba red renames A->B, M->N
virtual 3ea8007197e00e418888dc2c81f54621dde659cb
found 1 common ancestor(s):
fc79a05 initial has A and M
Auto-merging B
CONFLICT (content): Merge conflict in B
...
Merging:
21f99ba red renames A->B, M->N
virtual 957dbf95701af71a82bd0da06a30bb4c1cfa2eb9
found 1 common ancestor(s):
fc79a05 initial has A and M
Skipped N (merged same as existing)
CONFLICT (rename/rename): Rename "A"->"B" in branch "HEAD" rename "A"->"C" in "957dbf95701af71a82bd0da06a30bb4c1cfa2eb9"
Automatic merge failed; fix conflicts and then commit the result.
g : red changes a line
...
+++++*+ [white^] initial has A and M
Merging:
790880a white renames A->B, M->N
virtual 21f99ba43527f3641f671f7e8ab08877a4d28c21
found 1 common ancestor(s):
fc79a05 initial has A and M
Auto-merging B
CONFLICT (content): Merge conflict in B
...
HEAD is now at 790880a white renames A->B, M->N
...
Merging:
3ea8007 master updates A
virtual f0879514ce3cda283113d35fed747ef0a6c4db0d
found 1 common ancestor(s):
fc79a05 initial has A and M
Removing M
...
HEAD is now at 3ea8007 master updates A
Updated tag 'anchor' (was 3ea8007)
! [blue] blue renames A->C, M->N
 ! [change] changed
  ! [change+rename] changed and renamed
   ! [master] master updates A
...
Merge made by recursive.
 A |    2 +-
 1 files changed, 1 insertions(+), 1 deletions(-)
HEAD is now at f087951 yellow removes M
...
HEAD is now at 9eddce4 changed and renamed
Skipped B (merged same as existing)
...
HEAD is now at e46e650 Merge branch 'change+rename' into change
rm 'B'
rm 'M'
[dir-in-way (root-commit) c98fbc9] Common commmit
 Author: A U Thor <author@example.com>
...
[dir-in-way b391573] Commit to merge, with dir in the way
 Author: A U Thor <author@example.com>
 2 files changed, 2 insertions(+), 0 deletions(-)
rm 'dir/file-in-the-way'
[dir-not-in-way bc990d5] Commit to merge, with dir removed
 Author: A U Thor <author@example.com>
 2 files changed, 1 insertions(+), 1 deletions(-)
 delete mode 100644 dir/file-in-the-way
rm 'dir/file-in-the-way'
rm 'sub/file'
[renamed-file-has-no-conflicts 923d47c] Independent change
 Author: A U Thor <author@example.com>
 2 files changed, 1 insertions(+), 2 deletions(-)
 rename sub/file => dir (79%)
 delete mode 100644 dir/file-in-the-way
rm 'dir/file-in-the-way'
[renamed-file-has-conflicts 6b6a1f6] Conflicting change
 Author: A U Thor <author@example.com>
 2 files changed, 1 insertions(+), 1 deletions(-)
...
HEAD is now at 6b6a1f6 Conflicting change
Merging:
923d47c Independent change
virtual dir-not-in-way
found 1 common ancestor(s):
c98fbc9 Common commmit
...
HEAD is now at f2f404d Merge branch 'dir-not-in-way' into HEAD
...
HEAD is now at 923d47c Independent change
...
HEAD is now at b391573 Commit to merge, with dir in the way
Merging:
6b6a1f6 Conflicting change
virtual dir-not-in-way
found 1 common ancestor(s):
c98fbc9 Common commmit
Removing dir to make room for subdirectory; may re-add later.
...
HEAD is now at 6b6a1f6 Conflicting change
Merging:
b391573 Commit to merge, with dir in the way
...
rm 'n.stages'
rm 'sub/file'
[rename-dest (root-commit) 2c78b95] Common commmit
 Author: A U Thor <author@example.com>
 1 files changed, 1 insertions(+), 0 deletions(-)
 create mode 100644 one/file
[rename-dest 1addd05] Renamed to destdir
 Author: A U Thor <author@example.com>
 1 files changed, 0 insertions(+), 0 deletions(-)
 rename one/file => destdir (100%)
rm 'one/file'
[source-conflict edb3e45] Conflicts in the way
 Author: A U Thor <author@example.com>
...
HEAD is now at edb3e45 Conflicts in the way
Merging:
1addd05 Renamed to destdir
virtual source-conflict
found 1 common ancestor(s):
2c78b95 Common commmit
...
HEAD is now at 1addd05 Renamed to destdir
rm 'destdir'
[rename-two (root-commit) 32ba270] Common commmit
 Author: A U Thor <author@example.com>
 2 files changed, 2 insertions(+), 0 deletions(-)
 create mode 100644 one/file
 create mode 100644 two/file
rm 'one/file'
[rename-two 0889909] Rename two/file -> one
 Author: A U Thor <author@example.com>
 2 files changed, 0 insertions(+), 1 deletions(-)
 rename two/file => one (100%)
 delete mode 100644 one/file
rm 'two/file'
[rename-one 548aca5] Rename one/file -> two
 Author: A U Thor <author@example.com>
 2 files changed, 0 insertions(+), 1 deletions(-)
...
expecting success: 
	...
	test "stuff" = $(cat two)
Merging:
548aca5 Rename one/file -> two
virtual rename-two
found 1 common ancestor(s):
32ba270 Common commmit
...
HEAD is now at 548aca5 Rename one/file -> two
Merging:
548aca5 Rename one/file -> two
virtual rename-two
found 1 common ancestor(s):
...
HEAD is now at 548aca5 Rename one/file -> two
rm 'two'
[first-rename (root-commit) f46ca3a] Common commmit
 Author: A U Thor <author@example.com>
 1 files changed, 1 insertions(+), 0 deletions(-)
 create mode 100644 original
[first-rename 64aa4d4] Put two/file in the way, rename to one
 Author: A U Thor <author@example.com>
 1 files changed, 0 insertions(+), 0 deletions(-)
 rename original => one (100%)
 create mode 100644 two/file
[second-rename 4ef43dc] Put one/file in the way, rename to two
 Author: A U Thor <author@example.com>
 1 files changed, 0 insertions(+), 0 deletions(-)
 create mode 100644 one/file
...
expecting success: 
	...
	! test -f original
Merging:
64aa4d4 Put two/file in the way, rename to one
virtual second-rename
found 1 common ancestor(s):
f46ca3a Common commmit
...
HEAD is now at 64aa4d4 Put two/file in the way, rename to one
rm 'one'
rm 'two/file'
[first-rename-redo (root-commit) 1d44824] Common commmit
 Author: A U Thor <author@example.com>
 1 files changed, 1 insertions(+), 0 deletions(-)
 create mode 100644 one/file
 create mode 100644 original
 create mode 100644 two/file
rm 'one/file'
[first-rename-redo a25b1c2] Rename to one
 Author: A U Thor <author@example.com>
 1 files changed, 0 insertions(+), 0 deletions(-)
 rename original => one (100%)
 delete mode 100644 one/file
rm 'two/file'
[second-rename-redo 8fad32e] Rename to two
 Author: A U Thor <author@example.com>
 1 files changed, 0 insertions(+), 0 deletions(-)
 rename original => two (100%)
 delete mode 100644 two/file
...
expecting success: 
	...
	! test -f original
Merging:
a25b1c2 Rename to one
virtual second-rename-redo
found 1 common ancestor(s):
1d44824 Common commmit
Removing one to make room for subdirectory; may re-add later.
Removing two/file

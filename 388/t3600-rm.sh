...
[master (root-commit) ea0fa41] add normal files
...
[master 45c0372] add files with tabs and newlines
 Author: A U Thor <author@example.com>
 0 files changed, 0 insertions(+), 0 deletions(-)
...
[master a8a8ac6] add file for rm test
 Author: A U Thor <author@example.com>
...
[master 82dd7d0] remove file from rm test
 Author: A U Thor <author@example.com>
...
[master b9452f7] add file for rm --quiet test
 Author: A U Thor <author@example.com>
 1 files changed, 1 insertions(+), 0 deletions(-)
 create mode 100644 test-file
[master 4f072cd] remove file from rm --quiet test
 Author: A U Thor <author@example.com>
 1 files changed, 0 insertions(+), 1 deletions(-)
 delete mode 100644 test-file
...
[master (root-commit) 4bf16bd] add a file
 Author: A U Thor <author@example.com>
 1 files changed, 1 insertions(+), 0 deletions(-)
...
HEAD is now at 00994ac subdir test
rm 'frotz/nitfol'

...
expecting success: 
	...
	git tag initial
[master (root-commit) 56d1997] initial
...
HEAD is now at 56d1997 initial
[master 6d29b34] add=5
 Author: A U Thor <author@example.com>
...
Deleted branch test5 (was b5a5be3).
HEAD is now at 56d1997 initial
[master 7d43a93] add=5
 Author: A U Thor <author@example.com>
 5 files changed, 110 insertions(+), 0 deletions(-)
 create mode 100644 1
 create mode 100644 2
...
Deleted branch test5 (was 3a08233).
HEAD is now at 56d1997 initial
[master 7d43a93] add=5
 Author: A U Thor <author@example.com>
 5 files changed, 110 insertions(+), 0 deletions(-)
...
[simple-change 2ff567f] unrelated-change
 Author: A U Thor <author@example.com>
 0 files changed, 0 insertions(+), 0 deletions(-)

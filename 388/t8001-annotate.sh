...
[master (root-commit) ab38c58] Initial.
 Author: A <A@test.git>
...
Merging:
9dffc59 Branch2-1
virtual c314a47b9a15974e1e6d0a87c21d0716bd63d89a
...
expecting success: echo "evil merge." >>file &&
     git commit -a --amend
[branch2 c3df776] Merge branch 'branch1' into branch2

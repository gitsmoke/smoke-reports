...
[master (root-commit) c699e48] subject
...
expecting success: 
	...
	check_message diff
[master 82971db] This is an example commit message that contains a diff.
 Author: A U Thor <author@example.com>
 1 files changed, 1 insertions(+), 1 deletions(-)
...
checking known breakage: 
	...
	check_message diff
[master 9383ab5] This is an example commit message that contains a diff.
 Author: A U Thor <author@example.com>
 1 files changed, 1 insertions(+), 1 deletions(-)
--- diff	2010-12-25 04:02:48.000000000 +0000
+++ actual	2010-12-25 04:02:48.000000000 +0000
@@ -1,9 +1,2 @@

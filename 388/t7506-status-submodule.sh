...
[master (root-commit) c67bbad]  Add bar
 Author: A U Thor <author@example.com>
 0 files changed, 0 insertions(+), 0 deletions(-)
 create mode 100644 bar
[master 595b59d]  Add foo
 Author: A U Thor <author@example.com>
 0 files changed, 0 insertions(+), 0 deletions(-)
 create mode 100644 foo
[master (root-commit) d4557bb] Add submodule sub
 Author: A U Thor <author@example.com>
...
HEAD is now at 595b59d  Add foo
...
expecting success: 
	...
	diff output - <<-\EOF
	 M sub
	EOF
HEAD is now at 24c3fcf next change
...
[master 86ed7ef] added .real to .gitignore
 Author: A U Thor <author@example.com>
 1 files changed, 1 insertions(+), 0 deletions(-)

...
[master (root-commit) a87bbf9] Add A1
 Author: A U Thor <bogus_email_address>
 1 files changed, 1 insertions(+), 0 deletions(-)
 create mode 100644 A
[topic 1df3f83] Add B1
 Author: A U Thor <bogus_email_address>
 1 files changed, 1 insertions(+), 0 deletions(-)
 create mode 100644 B
[master 54aa581] Modify A2
 Author: A U Thor <bogus_email_address>
 1 files changed, 1 insertions(+), 0 deletions(-)
Cloning into clone1...
done.
...
Merge made by recursive.
 A |    1 +
 1 files changed, 1 insertions(+), 0 deletions(-)
[master 59d7bc9] Add different B
 Author: A U Thor <bogus_email_address>
 1 files changed, 1 insertions(+), 0 deletions(-)
 create mode 100644 B
Cloning into clone2...
...
[topic 99582c0] Merge origin/master into topic
 Author: A U Thor <bogus_email_address>
[topic 8b25449] Modify B2
 Author: A U Thor <bogus_email_address>
 1 files changed, 1 insertions(+), 0 deletions(-)
...
Rebasing (1/1)Merging:
8b25449 Modify B2
virtual 59d7bc9cef224697ff07b36ae12a1475b06f5cd1
found 1 common ancestor(s):
a87bbf9 Add A1
Auto-merging B
CONFLICT (add/add): Merge conflict in B
...
B: needs merge
@@@ -1,1 -1,1 +1,1 @@@
[detached HEAD f1a6fb8] Merge origin/master into topic
 Author: A U Thor <bogus_email_address>
Rebasing (1/1)

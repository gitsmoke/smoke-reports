...
[master 0c519fc] new file in ugly parent
...
Committed r2
	A	#{bad_directory_name}/ foo
r2 = 1653c18647f6b66d1eb696baca1cbb8283070019 (refs/remotes/git-svn)
...
[master bcdd4e4] rename ugly file
 Author: A U Thor <author@example.com>
...
r3 = 4e02ebacb487347af071b31e5681edbd42427a08 (refs/remotes/git-svn)
No changes between current HEAD and refs/remotes/git-svn
Resetting to the latest refs/remotes/git-svn
...
Committed r4
	A	pretty
r4 = 13c84c143f0721577d852ed9123f3748f48c84bf (refs/remotes/git-svn)
No changes between current HEAD and refs/remotes/git-svn
Resetting to the latest refs/remotes/git-svn
[master 72743e1] moved pretty file
 Author: A U Thor <author@example.com>
 1 files changed, 0 insertions(+), 0 deletions(-)
...
r5 = 9e23ab91f954e9487a5f8e52ddf5ff3c43f458b1 (refs/remotes/git-svn)
No changes between current HEAD and refs/remotes/git-svn
Resetting to the latest refs/remotes/git-svn
...
r6 = 5e90fa963bd63d1b167889a69ddd04fd4f95ea19 (refs/remotes/git-svn)
No changes between current HEAD and refs/remotes/git-svn
Resetting to the latest refs/remotes/git-svn
...
Committed r7
	A	+_+
r7 = 44dba211fbffdf0dd66dbf934cd3db4803a0e085 (refs/remotes/git-svn)
No changes between current HEAD and refs/remotes/git-svn
Resetting to the latest refs/remotes/git-svn
...
Committed r8
	D	+_+
	A	gtk+/_+_
r8 = 3e6636ef9056281d62886bd8697319098d10f180 (refs/remotes/git-svn)
No changes between current HEAD and refs/remotes/git-svn
Resetting to the latest refs/remotes/git-svn
...
[master dabebb4] test-rebase-main
 Author: A U Thor <author@example.com>
 1 files changed, 1 insertions(+), 0 deletions(-)
...
Committed r9
	A	test-rebase-main
r9 = be3cfba0c954ca0f352ded4d2f855e1eb28845d5 (refs/remotes/git-svn)
No changes between current HEAD and refs/remotes/git-svn
Resetting to the latest refs/remotes/git-svn

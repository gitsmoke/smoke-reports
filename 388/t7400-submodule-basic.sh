...
[master (root-commit) e088ed1] initial commit
...
[master (root-commit) c7cae29] submodule commit 1
 Author: A U Thor <author@example.com>
...
[master (root-commit) 2d057b6] Ignore everything
 Author: A U Thor <author@example.com>
 1 files changed, 1 insertions(+), 0 deletions(-)
...
rev1: c7cae29d26b3dcdff5b13e368a6e2e1999f05a7c
...
expecting success: 
	git submodule status >lines &&
	grep "^-$rev1" lines
-c7cae29d26b3dcdff5b13e368a6e2e1999f05a7c init
...
Submodule path 'init': checked out 'c7cae29d26b3dcdff5b13e368a6e2e1999f05a7c'
ok 23 - update should work when path is an empty dir
expecting success: 
	git submodule status >list &&
	grep "^ $rev1" list
 c7cae29d26b3dcdff5b13e368a6e2e1999f05a7c init (rev-1)
...
[detached HEAD 2c02f47] submodule commit 2
 Author: A U Thor <author@example.com>
 1 files changed, 1 insertions(+), 0 deletions(-)
 create mode 100644 b
+2c02f478b09cbfdbe519e4f8d7952f827211caea init (rev-1-1-g2c02f47)
...
+Subproject commit 2c02f478b09cbfdbe519e4f8d7952f827211caea
...
[detached HEAD 2c6d937] change subproject
 Author: A U Thor <author@example.com>
 1 files changed, 1 insertions(+), 0 deletions(-)
 create mode 100644 s
[master d34a6f3] change init
 Author: A U Thor <author@example.com>
...
Submodule path 'init': checked out '2c6d9378fcb6210c778113cdb29f9e040ff87198'
...
HEAD is now at 8c43aa2 super commit 1
...
HEAD is now at 8c43aa2 super commit 1
[second f28c709] commit subproject
 Author: A U Thor <author@example.com>
 1 files changed, 1 insertions(+), 1 deletions(-)
diff --git a/init b/init
index 2c6d937..c1ce5a4 160000
--- a/init
+++ b/init
@@ -1 +1 @@
-Subproject commit 2c6d9378fcb6210c778113cdb29f9e040ff87198
+Subproject commit c1ce5a4bcd43fa1f814d6e7e8f1a7badeba306b6
...
HEAD is now at f28c709 commit subproject
...
[master (root-commit) 124cd4a] repo commit 1
 Author: A U Thor <author@example.com>
 1 files changed, 1 insertions(+), 0 deletions(-)

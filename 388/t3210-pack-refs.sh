...
[master (root-commit) 91f4974] Initial commit.
...
expecting success: git branch g/h &&
     ...
     git pack-refs --all &&
     git branch -d g
Deleted branch g/h (was 91f4974).
Deleted branch g (was 91f4974).
...
expecting success: git branch k/l &&
     ...
     git branch -d k/lm &&
     git branch k
Deleted branch k/l (was 91f4974).
Deleted branch k/l/m (was 91f4974).
Deleted branch k/lm (was 91f4974).
...
expecting success: git branch n/o &&
     ...
     git branch -d n/o/p &&
     git branch n
Deleted branch n/o (was 91f4974).
Deleted branch n/op (was 91f4974).
Deleted branch n/o/p (was 91f4974).

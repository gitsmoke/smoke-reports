...
[master (root-commit) 9495e93] Initial
 Author: A U Thor <author@example.com>
 1 files changed, 1 insertions(+), 0 deletions(-)
 create mode 100644 file
[master c23ddf9] add line from a
 Author: A U Thor <author@example.com>
 1 files changed, 1 insertions(+), 1 deletions(-)
[side a9d6810] add line from b
 Author: A U Thor <author@example.com>
 1 files changed, 1 insertions(+), 1 deletions(-)
ok 1 - setup
expecting success: 
...
HEAD is now at 9495e93 Initial
Merge made by ours.
...
expecting success: 
	...
	cat file | remove_cr | append_cr >file.temp &&
	test_cmp file file.temp
HEAD is now at c23ddf9 add line from a
Merging:
c23ddf9 add line from a
virtual side

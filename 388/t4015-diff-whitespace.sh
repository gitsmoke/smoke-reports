...
[master (root-commit) 40da9e1] snapshot
...
HEAD is now at 3b48ce3 yet another
[master b76682a] hello 1
 Author: A U Thor <author@example.com>
 1 files changed, 1 insertions(+), 1 deletions(-)
...
HEAD is now at b76682a hello 1
[master 47695f4] base
 Author: A U Thor <author@example.com>
...
HEAD is now at 47695f4 base
[master 80b7d4a] empty
 Author: A U Thor <author@example.com>
...
HEAD is now at 80b7d4a empty
[master 094b64e] one side
 Author: A U Thor <author@example.com>
 1 files changed, 1 insertions(+), 9 deletions(-)
[detached HEAD 00921e3] the other side
 Author: A U Thor <author@example.com>
 1 files changed, 1 insertions(+), 9 deletions(-)
Merging:
00921e3 the other side
virtual master
...
HEAD is now at 00921e3 the other side
[detached HEAD 9469ee1] initial
 Author: A U Thor <author@example.com>
 1 files changed, 1 insertions(+), 1 deletions(-)

...
expecting success: 
	...
	git add hello &&
	git commit -m master
[master (root-commit) a65a5df] initial
...
[master (root-commit) 5029ad1] initial git-gui
 Author: A U Thor <author@example.com>
 1 files changed, 1 insertions(+), 0 deletions(-)
...
[master (root-commit) 8217882] initial git
 Author: A U Thor <author@example.com>
 1 files changed, 1 insertions(+), 0 deletions(-)
...
Updating gui
[master 9977235] Merge git-gui as our subdirectory
 Author: A U Thor <author@example.com>
...
M	git-gui.sh
[master2 1650042] update git-gui
 Author: A U Thor <author@example.com>
 1 files changed, 1 insertions(+), 1 deletions(-)
Merging:
9977235 Merge git-gui as our subdirectory
virtual 1650042fe6f77dd755d68e99dc8b2b21f4360646
found 1 common ancestor(s):
5029ad1 initial git-gui
Merge made by subtree.
...
HEAD is now at 9977235 Merge git-gui as our subdirectory
Already up-to-date.
[master2 50edf5b] Merge git-gui2 as our subdirectory
 Author: A U Thor <author@example.com>
 1 files changed, 1 insertions(+), 0 deletions(-)
...
expecting success: 
	...
	test_cmp expected actual
HEAD is now at 50edf5b Merge git-gui2 as our subdirectory
Merging:
50edf5b Merge git-gui2 as our subdirectory
virtual 1650042fe6f77dd755d68e99dc8b2b21f4360646
found 1 common ancestor(s):
5029ad1 initial git-gui

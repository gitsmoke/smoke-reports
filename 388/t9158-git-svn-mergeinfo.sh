...
expecting success: 
	...
	git svn fetch
r1 = 593b699e299f1ed2cf73f32527bd27991e4a97e8 (refs/remotes/git-svn)
	A	foo
r2 = e25ddf4399b298e982706d5f39431c4586b9bb66 (refs/remotes/git-svn)
ok 2 - clone svn repo
expecting success: 
	touch bar &&
	git add bar &&
...
Committed r3
	A	bar
r3 = d7aba7a85e3ba8eda5649636018e41a5cdfc7776 (refs/remotes/git-svn)

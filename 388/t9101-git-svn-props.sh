...
expecting success: git svn fetch
	...
	A	ne_crlf
	A	empty
r1 = 22e8c2fc9c4d6df101fc5d9dbda2d6a3b78964cc (refs/remotes/git-svn)
	M	kw.c
r2 = 2e8931b74470f2d270d43301768eeedfbc65e647 (refs/remotes/git-svn)
	M	kw.c
r3 = 31c7f22c54f456c84087be393aa873540dabf2ed (refs/remotes/git-svn)
	M	kw.c
r4 = b376700abb3f79520f1ff7029088320807722121 (refs/remotes/git-svn)
...
[mybranch 858b0a9] test keywords ignoring
 Author: A U Thor <author@example.com>
 1 files changed, 1 insertions(+), 0 deletions(-)
	M	kw.c
	M	kw.c
r5 = 9f2555dafdac8d5eaf534ef8ed9f597465524184 (refs/remotes/git-svn)
Done committing 1 revisions to SVN
Updating 858b0a9..9f2555d
Fast-forward
...
expecting success: git svn fetch &&
	...
	M	ne_crlf
	M	empty
r6 = 2bdb58841143b71aae5fdf38bc579d6970dac396 (refs/remotes/git-svn)
Updating 9f2555d..2bdb588
Fast-forward
 crlf    |    3 +--
 ne_crlf |    3 +--
...
expecting success: git svn fetch && git pull . ${remotes_git_svn}
	M	cr
	M	ne_cr
r7 = 65ba8153c16d73d7c0d77cb8289c620ce19b1761 (refs/remotes/git-svn)
Updating 2bdb588..65ba815
Fast-forward
 cr    |    4 +++-
 ne_cr |    4 +++-
...
expecting success: 
	...
	A	deeply/nested/directory/.keep
r8 = e0933dae86d634c77c106fee1ffc2d662bf637dd (refs/remotes/git-svn)
Updating 65ba815..e0933da
Fast-forward

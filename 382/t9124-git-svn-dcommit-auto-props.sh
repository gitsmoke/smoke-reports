...
Committed revision 1.
	A	foo
r1 = 21575e7dd6660181cd3e347c5be6e68c6a6b7040 (refs/remotes/git-svn)
...
[master 770d71c] files for enabled auto-props
...
Committed r2
	...
	A	bar
	A	exec1.sh
r2 = 946bcb87121f54d4de7a814510f799b487d05747 (refs/remotes/git-svn)
...
[master f5109cb] files for disabled auto-props
 Author: A U Thor <author@example.com>
 3 files changed, 3 insertions(+), 0 deletions(-)
...
Committed r3
	...
	A	world.txt
	A	zot
r3 = ff4bf4503af891bfa8adc8251a3fccf3d961c904 (refs/remotes/git-svn)
No changes between current HEAD and refs/remotes/git-svn
Resetting to the latest refs/remotes/git-svn
...
Committed r4
	D	foo
	A	foo.sh
r4 = 52c6196c531081de86a94147031f9a05007f84e4 (refs/remotes/git-svn)
No changes between current HEAD and refs/remotes/git-svn
Resetting to the latest refs/remotes/git-svn
D    foo
A    foo.sh

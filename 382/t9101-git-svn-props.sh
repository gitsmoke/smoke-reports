...
expecting success: git svn fetch
	...
	A	ne_crlf
	A	empty
r1 = d2885040697650ef84b2be472e4d9d4375edf24b (refs/remotes/git-svn)
	M	kw.c
r2 = dc98b4b9639965dee68e30086ace8d529196ebaf (refs/remotes/git-svn)
	M	kw.c
r3 = fd79f138df34d3b23572a8fbf63bd53949958bff (refs/remotes/git-svn)
	M	kw.c
r4 = 0094d0e086532068169c9ab6dfbf0a0e309552ee (refs/remotes/git-svn)
...
[mybranch 9ecc3b7] test keywords ignoring
 Author: A U Thor <author@example.com>
 1 files changed, 1 insertions(+), 0 deletions(-)
	M	kw.c
	M	kw.c
r5 = a7e5b8e99f462f3bd969fcc81c0eb13d72e7d169 (refs/remotes/git-svn)
Done committing 1 revisions to SVN
Updating 9ecc3b7..a7e5b8e
Fast-forward
...
expecting success: git svn fetch &&
	...
	M	ne_crlf
	M	empty
r6 = 70276ac2c00c988077c2f0c0ac5b181ccce4d06c (refs/remotes/git-svn)
Updating a7e5b8e..70276ac
Fast-forward
 crlf    |    3 +--
 ne_crlf |    3 +--
...
expecting success: git svn fetch && git pull . ${remotes_git_svn}
	M	cr
	M	ne_cr
r7 = bc97e87e5ac970985f0947cf15abd78d504379c7 (refs/remotes/git-svn)
Updating 70276ac..bc97e87
Fast-forward
 cr    |    4 +++-
 ne_cr |    4 +++-
...
expecting success: 
	...
	A	deeply/nested/directory/.keep
r8 = 34e6efff77d89727a37232ad1d61f5b5b6759ae2 (refs/remotes/git-svn)
Updating bc97e87..34e6eff
Fast-forward

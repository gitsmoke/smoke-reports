...
[master (root-commit) 3658582] Initial.
 Author: A <A@test.git>
...
Merging:
b73cca3 Branch2-1
virtual cb6974af1961ed233e1b723862697e173d87a035
...
expecting success: echo "evil merge." >>file &&
     git commit -a --amend
[branch2 1202be6] Merge branch 'branch1' into branch2

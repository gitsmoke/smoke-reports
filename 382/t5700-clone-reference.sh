...
[master (root-commit) 20da484] initial
...
Merging:
4f263da addition
virtual 7f42acbc901b2c647d9025ebefde70b21cbe6e4a
...
[master (root-commit) 326a9f8] initial
 Author: A U Thor <author@example.com>
 1 files changed, 1 insertions(+), 0 deletions(-)
 create mode 100644 file1

...
[master (root-commit) 1ec023e] initial
 Author: A U Thor <author@example.com>
 0 files changed, 0 insertions(+), 0 deletions(-)
 create mode 100644 camelcase
[topic d3d90e3] rename
 Author: A U Thor <author@example.com>
...
checking known breakage: 
	...
	git merge topic
HEAD is now at 1ec023e initial
Updating 1ec023e..d3d90e3
Fast-forward
...
[master (root-commit) 79920a0] initial
 Author: A U Thor <author@example.com>
 0 files changed, 0 insertions(+), 0 deletions(-)
 create mode 100644 "a\314\210"
[topic 7a5b959] rename
 Author: A U Thor <author@example.com>
 1 files changed, 0 insertions(+), 0 deletions(-)
...
checking known breakage: 
 ...
 git reset --hard initial &&
 git merge topic
HEAD is now at 79920a0 initial
Updating 79920a0..7a5b959
Aborting

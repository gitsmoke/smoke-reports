...
[master (root-commit) 2ccb9fd] Initial
 Author: A U Thor <author@example.com>
 1 files changed, 1 insertions(+), 0 deletions(-)
 create mode 100644 file
[master a945f4d] Second
 Author: A U Thor <author@example.com>
 1 files changed, 1 insertions(+), 0 deletions(-)
[master 179b628] Third
 Author: A U Thor <author@example.com>
 1 files changed, 1 insertions(+), 0 deletions(-)
...
0001-Second.patch
0002-Third.patch
[dosfiles-keep-cr-continue 8ebfb9e] different patch
 Author: A U Thor <author@example.com>
 1 files changed, 1 insertions(+), 0 deletions(-)
Applying: Second
Using index info to reconstruct a base tree...
...
[unixfiles-conf-keepcr-override 4e80f18] line ending to unix
 Author: A U Thor <author@example.com>

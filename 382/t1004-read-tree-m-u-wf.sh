...
[master (root-commit) 8664616] initial
...
[master feb9916] master removes file2 and subdir/file2
 Author: A U Thor <author@example.com>
...
D	file2
D	subdir/file2
[side b1eb027] side adds file3 and removes file2
 Author: A U Thor <author@example.com>
...
HEAD is now at feb9916 master removes file2 and subdir/file2
...
expecting success: 
	...
	git checkout side-a
HEAD is now at feb9916 master removes file2 and subdir/file2
[side-a 85ee5aa] side-a changes file1
 Author: A U Thor <author@example.com>
 1 files changed, 1 insertions(+), 0 deletions(-)
[side-b d335619] side-b changes file2
 Author: A U Thor <author@example.com>
 1 files changed, 1 insertions(+), 0 deletions(-)
...
HEAD is now at 85ee5aa side-a changes file1
...
HEAD is now at 85ee5aa side-a changes file1
[sym-b 49e4623] side adds a/b
 Author: A U Thor <author@example.com>
 0 files changed, 0 insertions(+), 0 deletions(-)
 create mode 100644 a/b
[sym-a 7c25a4a] we add a/b
 Author: A U Thor <author@example.com>
 1 files changed, 1 insertions(+), 0 deletions(-)
...
HEAD is now at 7c25a4a we add a/b
...
HEAD is now at 7c25a4a we add a/b
[side-a 99feaa8] side-a changes file2 to directory
 Author: A U Thor <author@example.com>
...
HEAD is now at d335619 side-b changes file2
Trying simple merge.
...
Merging:
d335619 side-b changes file2
99feaa8 side-a changes file2 to directory

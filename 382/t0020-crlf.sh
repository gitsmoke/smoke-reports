...
expecting success: 
	...
	echo happy.
[master (root-commit) 73759cf] initial
...
HEAD is now at 73759cf initial
...
[master 1b43aa0] Add .gitattributes
 Author: A U Thor <author@example.com>
...
[master ab84b9b] initial
 Author: A U Thor <author@example.com>
 1 files changed, 1 insertions(+), 0 deletions(-)
[master 89d7bee] second
 Author: A U Thor <author@example.com>
...
[master 3974196] alllf, allcrlf and mixed only
 Author: A U Thor <author@example.com>

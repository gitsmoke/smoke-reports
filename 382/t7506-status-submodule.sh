...
[master (root-commit) f1faa31]  Add bar
 Author: A U Thor <author@example.com>
 0 files changed, 0 insertions(+), 0 deletions(-)
 create mode 100644 bar
[master 8b611b9]  Add foo
 Author: A U Thor <author@example.com>
 0 files changed, 0 insertions(+), 0 deletions(-)
 create mode 100644 foo
[master (root-commit) 6c334de] Add submodule sub
 Author: A U Thor <author@example.com>
...
HEAD is now at 8b611b9  Add foo
...
expecting success: 
	...
	diff output - <<-\EOF
	 M sub
	EOF
HEAD is now at b30afb6 next change
...
[master 4440f1f] added .real to .gitignore
 Author: A U Thor <author@example.com>
 1 files changed, 1 insertions(+), 0 deletions(-)

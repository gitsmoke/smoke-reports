...
[master (root-commit) 2e046e7] initial
...
Updating 2e046e7..411cd1a
Fast-forward
 file |    1 +
 1 files changed, 1 insertions(+), 0 deletions(-)
[master 3ed6264] third
 Author: A U Thor <author@example.com>
...
[master 0310605] sixth.1
 Author: A U Thor <author@example.com>
 1 files changed, 1 insertions(+), 1 deletions(-)
[master d36fbf8] sixth.2
 Author: A U Thor <author@example.com>
 1 files changed, 1 insertions(+), 0 deletions(-)
[master 76a429a] sixth.3
 Author: A U Thor <author@example.com>
 1 files changed, 1 insertions(+), 0 deletions(-)
...
76a429a3103765adc6270e26e925829067b2dea3
[master 9185aea] seventh
 Author: A U Thor <author@example.com>
 1 files changed, 1 insertions(+), 1 deletions(-)

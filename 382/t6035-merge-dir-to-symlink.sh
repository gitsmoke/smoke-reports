...
HEAD is now at 4f54b01 dir to symlink
rm 'a/b'
[detached HEAD 91ef6d5] untracked symlink remains
 Author: A U Thor <author@example.com>
...
HEAD is now at 6382e67 base
[detached HEAD f238163] x
 Author: A U Thor <author@example.com>
 1 files changed, 1 insertions(+), 0 deletions(-)
...
HEAD is now at d5e259d Merge branch 'master' into HEAD
Merging:
f238163 x
virtual master
...
HEAD is now at a36d22d Merge branch 'master' into HEAD
Trying really trivial in-index merge...
Nope.
Trying simple merge.
Simple merge failed, trying Automatic merge.
...
HEAD is now at 2efbe0d Merge commit 'baseline^0' into HEAD
Merging:
4f54b01 dir to symlink
virtual baseline^0
found 1 common ancestor(s):
6382e67 base
...
HEAD is now at f238163 x
[detached HEAD 5fd1a08] dir a/b-2 to symlink
 Author: A U Thor <author@example.com>
...
HEAD is now at 5fd1a08 dir a/b-2 to symlink
Trying really trivial in-index merge...
Nope.
Trying simple merge.
Simple merge failed, trying Automatic merge.
...
HEAD is now at db67bc3 Merge commit 'test2' into HEAD
Merging:
f238163 x
virtual test2
found 1 common ancestor(s):

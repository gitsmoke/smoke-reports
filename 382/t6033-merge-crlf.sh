...
[master (root-commit) fa21837] Initial
 Author: A U Thor <author@example.com>
 1 files changed, 1 insertions(+), 0 deletions(-)
 create mode 100644 file
[master 8129b00] add line from a
 Author: A U Thor <author@example.com>
 1 files changed, 1 insertions(+), 1 deletions(-)
[side 55d066a] add line from b
 Author: A U Thor <author@example.com>
 1 files changed, 1 insertions(+), 1 deletions(-)
...
HEAD is now at fa21837 Initial
Merge made by ours.
...
HEAD is now at 8129b00 add line from a
Merging:
8129b00 add line from a
virtual side

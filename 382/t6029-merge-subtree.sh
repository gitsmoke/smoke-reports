...
expecting success: 
	...
	git add hello &&
	git commit -m master
[master (root-commit) 34323e7] initial
...
[master (root-commit) 874efad] initial git-gui
 Author: A U Thor <author@example.com>
 1 files changed, 1 insertions(+), 0 deletions(-)
...
[master (root-commit) 7ba776a] initial git
 Author: A U Thor <author@example.com>
 1 files changed, 1 insertions(+), 0 deletions(-)
...
Updating gui
[master 45df49f] Merge git-gui as our subdirectory
 Author: A U Thor <author@example.com>
ok 4 - initial merge
...
expecting success: 
	...
	test_cmp expected actual
M	git-gui.sh
[master2 320cf36] update git-gui
 Author: A U Thor <author@example.com>
 1 files changed, 1 insertions(+), 1 deletions(-)
Merging:
45df49f Merge git-gui as our subdirectory
virtual 320cf362b416b3109580638c21ff6c2a6e88cd22
found 1 common ancestor(s):
874efad initial git-gui
Merge made by subtree.
...
expecting success: 
	...
	test_cmp expected actual
HEAD is now at 45df49f Merge git-gui as our subdirectory
Already up-to-date.
[master2 16f58b6] Merge git-gui2 as our subdirectory
 Author: A U Thor <author@example.com>
 1 files changed, 1 insertions(+), 0 deletions(-)
...
HEAD is now at 16f58b6 Merge git-gui2 as our subdirectory
Merging:
16f58b6 Merge git-gui2 as our subdirectory
virtual 320cf362b416b3109580638c21ff6c2a6e88cd22
found 1 common ancestor(s):
874efad initial git-gui

...
[master (root-commit) 7dc6cbf] A-initial
...
[master (root-commit) be0fc41] B-super-initial
 Author: A U Thor <author@example.com>
 1 files changed, 1 insertions(+), 0 deletions(-)
...
Cloning into sub...
Submodule path 'sub': checked out '7dc6cbf8ccbbf3aad2b9d4ee780da1f9b4a1bb33'

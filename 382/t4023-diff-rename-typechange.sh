...
expecting success: 
	...
	git tag six
[master (root-commit) 5c3cbcb] Initial
 Author: A U Thor <author@example.com>
 2 files changed, 361 insertions(+), 0 deletions(-)
 create mode 120000 bar
 create mode 100644 foo
[master c75cfa7] Second
 Author: A U Thor <author@example.com>
 2 files changed, 0 insertions(+), 0 deletions(-)
 rename foo => bar (100%)
 rename bar => foo (100%)
[master 038b706] Third
 Author: A U Thor <author@example.com>
 1 files changed, 0 insertions(+), 0 deletions(-)
 rename bar => foo (100%)
[master 91763bb] Fourth
 Author: A U Thor <author@example.com>
 2 files changed, 1 insertions(+), 360 deletions(-)
 rename foo => bar (100%)
 rewrite foo (100%)
 mode change 100644 => 120000
[master 48f5a6e] Fifth
 Author: A U Thor <author@example.com>
 2 files changed, 2450 insertions(+), 360 deletions(-)
 rewrite bar (98%)
 rename bar => foo (100%)
[master 548781f] Sixth
 Author: A U Thor <author@example.com>
 2 files changed, 0 insertions(+), 0 deletions(-)
 rename foo => bar (100%)
 rename bar => foo (100%)

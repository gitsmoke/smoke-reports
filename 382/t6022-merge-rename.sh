...
git checkout master
[master (root-commit) 1546d07] initial has A and M
 Author: A U Thor <author@example.com>
 2 files changed, 30 insertions(+), 0 deletions(-)
 create mode 100644 A
 create mode 100644 M
[master 7a348b2] master updates A
 Author: A U Thor <author@example.com>
 1 files changed, 1 insertions(+), 1 deletions(-)
[yellow d984027] yellow removes M
 Author: A U Thor <author@example.com>
 1 files changed, 0 insertions(+), 15 deletions(-)
 delete mode 100644 M
[white 4c8d0bc] white renames A->B, M->N
 Author: A U Thor <author@example.com>
 2 files changed, 2 insertions(+), 2 deletions(-)
 rename A => B (93%)
 rename M => N (93%)
[red 7978a16] red renames A->B, M->N
 Author: A U Thor <author@example.com>
 2 files changed, 2 insertions(+), 2 deletions(-)
 rename A => B (93%)
 rename M => N (93%)
[blue 833fc4c] blue renames A->C, M->N
 Author: A U Thor <author@example.com>
 2 files changed, 2 insertions(+), 2 deletions(-)
 rename A => C (93%)
 rename M => N (93%)
...
Merging:
7a348b2 master updates A
virtual 4c8d0bc9b2166c578118b36681025d8cf438393b
found 1 common ancestor(s):
1546d07 initial has A and M
Auto-merging B
...
expecting success: 
	...
	git diff --exit-code white N
HEAD is now at 7a348b2 master updates A
Merging:
7978a16 red renames A->B, M->N
virtual 4c8d0bc9b2166c578118b36681025d8cf438393b
found 1 common ancestor(s):
1546d07 initial has A and M
Auto-merging B
...
expecting success: 
	...
	git diff --exit-code white N
HEAD is now at 7978a16 red renames A->B, M->N
! [blue] blue renames A->C, M->N
 ! [change] changed
  ! [change+rename] changed and renamed
   ! [master] master updates A
...
Merging:
7978a16 red renames A->B, M->N
virtual 7a348b28c20df4a292f3648dde356c3997cd8924
found 1 common ancestor(s):
1546d07 initial has A and M
Auto-merging B
CONFLICT (content): Merge conflict in B
...
Merging:
7978a16 red renames A->B, M->N
virtual 833fc4c2cbad92b7fa1dba00ec9cda59105d43b3
found 1 common ancestor(s):
1546d07 initial has A and M
Skipped N (merged same as existing)
CONFLICT (rename/rename): Rename "A"->"B" in branch "HEAD" rename "A"->"C" in "833fc4c2cbad92b7fa1dba00ec9cda59105d43b3"
Automatic merge failed; fix conflicts and then commit the result.
g : red changes a line
...
+++++*+ [yellow^] initial has A and M
Merging:
4c8d0bc white renames A->B, M->N
virtual 7978a166d5f5bba8f14fd919f671033fd7f90d63
found 1 common ancestor(s):
1546d07 initial has A and M
Auto-merging B
CONFLICT (content): Merge conflict in B
...
HEAD is now at 4c8d0bc white renames A->B, M->N
...
Merging:
7a348b2 master updates A
virtual d9840273de83ab891c27ed2e59c5bd813a46ca03
found 1 common ancestor(s):
1546d07 initial has A and M
Removing M
...
expecting success: 
	...
	git reset --hard anchor
HEAD is now at 7a348b2 master updates A
Updated tag 'anchor' (was 7a348b2)
! [blue] blue renames A->C, M->N
 ! [change] changed
  ! [change+rename] changed and renamed
   ! [master] master updates A
...
Merge made by recursive.
 A |    2 +-
 1 files changed, 1 insertions(+), 1 deletions(-)
HEAD is now at d984027 yellow removes M
...
HEAD is now at 1c9ded7 changed and renamed
Skipped B (merged same as existing)
...
HEAD is now at 3b3d39a Merge branch 'change+rename' into change
rm 'B'
rm 'M'
[dir-in-way (root-commit) d97ba6f] Common commmit
 Author: A U Thor <author@example.com>
...
[dir-in-way eaa8d22] Commit to merge, with dir in the way
 Author: A U Thor <author@example.com>
 2 files changed, 2 insertions(+), 0 deletions(-)
rm 'dir/file-in-the-way'
[dir-not-in-way 2ca87e6] Commit to merge, with dir removed
 Author: A U Thor <author@example.com>
 2 files changed, 1 insertions(+), 1 deletions(-)
 delete mode 100644 dir/file-in-the-way
rm 'dir/file-in-the-way'
rm 'sub/file'
[renamed-file-has-no-conflicts 211db94] Independent change
 Author: A U Thor <author@example.com>
 2 files changed, 1 insertions(+), 2 deletions(-)
 rename sub/file => dir (79%)
 delete mode 100644 dir/file-in-the-way
rm 'dir/file-in-the-way'
[renamed-file-has-conflicts 873e007] Conflicting change
 Author: A U Thor <author@example.com>
 2 files changed, 1 insertions(+), 1 deletions(-)
...
HEAD is now at 873e007 Conflicting change
Merging:
211db94 Independent change
virtual dir-not-in-way
found 1 common ancestor(s):
d97ba6f Common commmit
...
HEAD is now at f180036 Merge branch 'dir-not-in-way' into HEAD
...
HEAD is now at 211db94 Independent change
...
HEAD is now at eaa8d22 Commit to merge, with dir in the way
Merging:
873e007 Conflicting change
virtual dir-not-in-way
found 1 common ancestor(s):
d97ba6f Common commmit
Removing dir to make room for subdirectory; may re-add later.
...
HEAD is now at 873e007 Conflicting change
Merging:
eaa8d22 Commit to merge, with dir in the way
...
rm 'n.stages'
rm 'sub/file'
[rename-dest (root-commit) f64bc55] Common commmit
 Author: A U Thor <author@example.com>
 1 files changed, 1 insertions(+), 0 deletions(-)
 create mode 100644 one/file
[rename-dest 326ff9b] Renamed to destdir
 Author: A U Thor <author@example.com>
 1 files changed, 0 insertions(+), 0 deletions(-)
 rename one/file => destdir (100%)
rm 'one/file'
[source-conflict 9911e28] Conflicts in the way
 Author: A U Thor <author@example.com>
...
HEAD is now at 9911e28 Conflicts in the way
Merging:
326ff9b Renamed to destdir
virtual source-conflict
found 1 common ancestor(s):
f64bc55 Common commmit
...
HEAD is now at 326ff9b Renamed to destdir
rm 'destdir'
[rename-two (root-commit) 22b3b4d] Common commmit
 Author: A U Thor <author@example.com>
 2 files changed, 2 insertions(+), 0 deletions(-)
 create mode 100644 one/file
 create mode 100644 two/file
rm 'one/file'
[rename-two 9050bd3] Rename two/file -> one
 Author: A U Thor <author@example.com>
 2 files changed, 0 insertions(+), 1 deletions(-)
 rename two/file => one (100%)
 delete mode 100644 one/file
rm 'two/file'
[rename-one 25c3cce] Rename one/file -> two
 Author: A U Thor <author@example.com>
 2 files changed, 0 insertions(+), 1 deletions(-)
...
expecting success: 
	...
	test "stuff" = $(cat two)
Merging:
25c3cce Rename one/file -> two
virtual rename-two
found 1 common ancestor(s):
22b3b4d Common commmit
...
expecting success: 
	...
	test "other" = $(cat one) &&
	test "stuff" = $(cat two)
HEAD is now at 25c3cce Rename one/file -> two
Merging:
25c3cce Rename one/file -> two
virtual rename-two
found 1 common ancestor(s):
...
HEAD is now at 25c3cce Rename one/file -> two
rm 'two'
[first-rename (root-commit) 7e948c3] Common commmit
 Author: A U Thor <author@example.com>
 1 files changed, 1 insertions(+), 0 deletions(-)
 create mode 100644 original
[first-rename 6067623] Put two/file in the way, rename to one
 Author: A U Thor <author@example.com>
 1 files changed, 0 insertions(+), 0 deletions(-)
 rename original => one (100%)
 create mode 100644 two/file
[second-rename 1263da9] Put one/file in the way, rename to two
 Author: A U Thor <author@example.com>
 1 files changed, 0 insertions(+), 0 deletions(-)
 create mode 100644 one/file
...
expecting success: 
	...
	! test -f original
Merging:
6067623 Put two/file in the way, rename to one
virtual second-rename
found 1 common ancestor(s):
7e948c3 Common commmit
...
HEAD is now at 6067623 Put two/file in the way, rename to one
rm 'one'
rm 'two/file'
[first-rename-redo (root-commit) 6a77d57] Common commmit
 Author: A U Thor <author@example.com>
 1 files changed, 1 insertions(+), 0 deletions(-)
 create mode 100644 one/file
 create mode 100644 original
 create mode 100644 two/file
rm 'one/file'
[first-rename-redo 15e628a] Rename to one
 Author: A U Thor <author@example.com>
 1 files changed, 0 insertions(+), 0 deletions(-)
 rename original => one (100%)
 delete mode 100644 one/file
rm 'two/file'
[second-rename-redo 4321439] Rename to two
 Author: A U Thor <author@example.com>
 1 files changed, 0 insertions(+), 0 deletions(-)
 rename original => two (100%)
 delete mode 100644 two/file
...
Merging:
15e628a Rename to one
virtual second-rename-redo
found 1 common ancestor(s):
6a77d57 Common commmit
Removing one to make room for subdirectory; may re-add later.
Removing two/file

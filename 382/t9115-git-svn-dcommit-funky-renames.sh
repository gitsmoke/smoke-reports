...
[master 803540e] new file in ugly parent
...
Committed r2
	A	#{bad_directory_name}/ foo
r2 = ab37656316f19b7af495324637e7bf7b1b88d062 (refs/remotes/git-svn)
...
[master 9f9dfcc] rename ugly file
 Author: A U Thor <author@example.com>
...
r3 = a1b9e0bca9445b7abe7f67a94868a047b55a74f5 (refs/remotes/git-svn)
No changes between current HEAD and refs/remotes/git-svn
Resetting to the latest refs/remotes/git-svn
...
Committed r4
	A	pretty
r4 = a2ca3cf743f5072c525298adbb02a66d45ea1c02 (refs/remotes/git-svn)
No changes between current HEAD and refs/remotes/git-svn
Resetting to the latest refs/remotes/git-svn
[master 40c7188] moved pretty file
 Author: A U Thor <author@example.com>
 1 files changed, 0 insertions(+), 0 deletions(-)
...
r5 = ae1b1315265d6b9cf9cecf8f9dc83aea32f0431d (refs/remotes/git-svn)
No changes between current HEAD and refs/remotes/git-svn
Resetting to the latest refs/remotes/git-svn
...
r6 = 09cc09a97bf74f13fcac756b71f406b080d754d4 (refs/remotes/git-svn)
No changes between current HEAD and refs/remotes/git-svn
Resetting to the latest refs/remotes/git-svn
...
Committed r7
	A	+_+
r7 = 79dde296425e09e1caef75ad405392deb19a9a05 (refs/remotes/git-svn)
No changes between current HEAD and refs/remotes/git-svn
Resetting to the latest refs/remotes/git-svn
...
Committed r8
	D	+_+
	A	gtk+/_+_
r8 = eefb7fbd1cc8868493d95ff92b582247a5ddb830 (refs/remotes/git-svn)
No changes between current HEAD and refs/remotes/git-svn
Resetting to the latest refs/remotes/git-svn
...
[master 0b067cb] test-rebase-main
 Author: A U Thor <author@example.com>
 1 files changed, 1 insertions(+), 0 deletions(-)
...
Committed r9
	A	test-rebase-main
r9 = 256ab581efc6bbb6c48886630694cce68515de99 (refs/remotes/git-svn)
No changes between current HEAD and refs/remotes/git-svn
Resetting to the latest refs/remotes/git-svn

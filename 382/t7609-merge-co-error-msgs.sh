...
expecting success: 
	...
	echo other >four &&
	echo other >five
[master (root-commit) ad38a8f] First
 Author: A U Thor <author@example.com>
 1 files changed, 1 insertions(+), 0 deletions(-)
 create mode 100644 one
[branch e00b2b2] Second
 Author: A U Thor <author@example.com>
...
expecting success: 
	...
	git reset --hard HEAD^
Updating ad38a8f..e00b2b2
Aborting
[master c64dc20] empty
 Author: A U Thor <author@example.com>
Aborting
HEAD is now at ad38a8f First
...
[master (root-commit) 7ee4701] init
 Author: A U Thor <author@example.com>
...
rm 'rep/foo'
rm 'rep2/foo'
[branch 1fb7985] added test as a file
 Author: A U Thor <author@example.com>

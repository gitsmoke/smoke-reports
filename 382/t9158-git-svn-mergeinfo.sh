...
expecting success: 
	...
	git svn fetch
r1 = a57f5c351b147f66d9aa63cdd2e2ee1895c3234a (refs/remotes/git-svn)
	A	foo
r2 = 621f57ae77773d043d5970a65d4a7d6892f534bb (refs/remotes/git-svn)
ok 2 - clone svn repo
...
Committed r3
	A	bar
r3 = 578b7bae3e09cacc098cd054433c22ebe5a9f0ec (refs/remotes/git-svn)

...
[master (root-commit) 08882c8] Initial.
 Author: A <A@test.git>
...
Merging:
7e7921a Branch2-1
virtual 91dc3684983e0db3370ba007ddea823ddd35020e
...
expecting success: echo "evil merge." >>file &&
     git commit -a --amend
[branch2 ff70aff] Merge branch 'branch1' into branch2

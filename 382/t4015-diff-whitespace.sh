...
expecting success: 
	...
	echo "foo();" > x &&
	git diff --check
[master (root-commit) bf24c06] snapshot
...
HEAD is now at 33b75c7 yet another
[master 366143d] hello 1
 Author: A U Thor <author@example.com>
 1 files changed, 1 insertions(+), 1 deletions(-)
...
HEAD is now at 366143d hello 1
[master 4dd87bb] base
 Author: A U Thor <author@example.com>
...
HEAD is now at 4dd87bb base
[master 39d8c36] empty
 Author: A U Thor <author@example.com>
...
HEAD is now at 39d8c36 empty
[master 131574f] one side
 Author: A U Thor <author@example.com>
 1 files changed, 1 insertions(+), 9 deletions(-)
[detached HEAD ba86786] the other side
 Author: A U Thor <author@example.com>
 1 files changed, 1 insertions(+), 9 deletions(-)
Merging:
ba86786 the other side
virtual master
...
HEAD is now at ba86786 the other side
[detached HEAD a291932] initial
 Author: A U Thor <author@example.com>
 1 files changed, 1 insertions(+), 1 deletions(-)

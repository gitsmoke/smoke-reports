...
expecting success: 
	...
	git branch initial
[master (root-commit) a1fe74c] initial commit
...
[master (root-commit) 0dde65a] submodule commit 1
 Author: A U Thor <author@example.com>
...
[master (root-commit) d82b203] Ignore everything
 Author: A U Thor <author@example.com>
 1 files changed, 1 insertions(+), 0 deletions(-)
...
" "$rev1" &&
	test -n "$rev1"
rev1: 0dde65ad7fdd1177c55a571a99ca5aeb03e620c7
...
expecting success: 
	git submodule status >lines &&
	grep "^-$rev1" lines
-0dde65ad7fdd1177c55a571a99ca5aeb03e620c7 init
...
Submodule path 'init': checked out '0dde65ad7fdd1177c55a571a99ca5aeb03e620c7'
...
expecting success: 
	...
	grep "^ $rev1" list
 0dde65ad7fdd1177c55a571a99ca5aeb03e620c7 init (rev-1)
...
[detached HEAD 1ef0d33] submodule commit 2
 Author: A U Thor <author@example.com>
 1 files changed, 1 insertions(+), 0 deletions(-)
 create mode 100644 b
+1ef0d33116f06a4a3708c82c72d34105ddb05f8d init (rev-1-1-g1ef0d33)
...
+Subproject commit 1ef0d33116f06a4a3708c82c72d34105ddb05f8d
...
[detached HEAD 0de3792] change subproject
 Author: A U Thor <author@example.com>
 1 files changed, 1 insertions(+), 0 deletions(-)
 create mode 100644 s
[master e6f373c] change init
 Author: A U Thor <author@example.com>
...
Submodule path 'init': checked out '0de379295d91972a3ba0530ac9b7cf41cbd28113'
ok 32 - update --init
expecting success: 

	git reset --hard &&
	test_must_fail git add init/a
HEAD is now at 8c0cf7f super commit 1
...
HEAD is now at 8c0cf7f super commit 1
[second 746dca0] commit subproject
 Author: A U Thor <author@example.com>
 1 files changed, 1 insertions(+), 1 deletions(-)
diff --git a/init b/init
index 0de3792..9305531 160000
--- a/init
+++ b/init
@@ -1 +1 @@
-Subproject commit 0de379295d91972a3ba0530ac9b7cf41cbd28113
+Subproject commit 93055318aa300f93295dd15d956d7cc0888b6adf
...
HEAD is now at 746dca0 commit subproject
...
[master (root-commit) df42fb3] repo commit 1
 Author: A U Thor <author@example.com>
 1 files changed, 1 insertions(+), 0 deletions(-)

...
Initialized empty Git repository in /Users/trast/git-smoke/t/trash directory.t9134-git-svn-ignore-paths/g/.git/
	A	qqq/test_qqq.txt
r1 = 8b28f9de1e5d12b2aa74e6ec625b2228207b23aa (refs/remotes/git-svn)
r2 = afa5ebce76ab2cd45b62b05477989ba2a8627af3 (refs/remotes/git-svn)
...
" > expect &&
	...
	M	qqq/test_qqq.txt
r3 = c261c5d071e84554a1d1f5494863e53a7696f55a (refs/remotes/git-svn)
...
r4 = a19404f87266c32a62204544bb4da4e77935c55e (refs/remotes/git-svn)
First, rewinding head to replay your work on top of it...
Fast-forwarded master to refs/remotes/git-svn.
...
" > expect &&
	...
	M	qqq/test_qqq.txt
r5 = f27180c03e189014ad46bce6d01d147080c4c8ea (refs/remotes/git-svn)
First, rewinding head to replay your work on top of it...
Fast-forwarded master to refs/remotes/git-svn.

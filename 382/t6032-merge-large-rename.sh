...
expecting success: 
	...
	git tag initial
[master (root-commit) 5071860] initial
...
HEAD is now at 5071860 initial
[master da69a1b] add=5
 Author: A U Thor <author@example.com>
...
Deleted branch test5 (was e8c9632).
HEAD is now at 5071860 initial
[master da69a1b] add=5
 Author: A U Thor <author@example.com>
 5 files changed, 110 insertions(+), 0 deletions(-)
...
Deleted branch test5 (was 1f19b29).
HEAD is now at 5071860 initial
[master da69a1b] add=5
 Author: A U Thor <author@example.com>
 5 files changed, 110 insertions(+), 0 deletions(-)
...
[simple-change 0325e03] unrelated-change
 Author: A U Thor <author@example.com>
 0 files changed, 0 insertions(+), 0 deletions(-)

...
not ok - 91 caching enabled (project summary, first run, generating cache)
#	gitweb_run "p=.git;a=summary"
not ok - 92 caching enabled (project summary, second run, cached version)
#	gitweb_run "p=.git;a=summary"
# failed 86 among 92 test(s)
1..92

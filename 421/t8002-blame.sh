...
[master (root-commit) 1dc772e] Initial.
 Author: A <A@test.git>
...
Merging:
980d3aa Branch2-1
virtual 6cf0e668c6dd942d727b98251d35709aab71a19e
...
expecting success: echo "evil merge." >>file &&
     git commit -a --amend
[branch2 b7b3ae5] Merge branch 'branch1' into branch2

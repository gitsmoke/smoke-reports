...
[master (root-commit) b7ec35d] initial
 Author: A U Thor <author@example.com>
 1 files changed, 1 insertions(+), 0 deletions(-)
 create mode 100644 init
[master 3235df3] File: dir/foo
 Author: A U Thor <author@example.com>
 1 files changed, 1 insertions(+), 0 deletions(-)
...
HEAD is now at 8061120 File: dir
[master 5cc2f0d] first
 Author: A U Thor <author@example.com>
...
rm 'dir~B'
rm 'init'
[modify (root-commit) ff4472f] initial
 Author: A U Thor <author@example.com>
 1 files changed, 8 insertions(+), 0 deletions(-)
 create mode 100644 letters
[modify 1a65a40] modified
 Author: A U Thor <author@example.com>
 1 files changed, 1 insertions(+), 0 deletions(-)
rm 'letters'
[delete 8814c6c] deleted
 Author: A U Thor <author@example.com>
...
expecting success: 
	...
	test -f letters/file &&
	test -f letters~HEAD
HEAD is now at 8814c6c deleted

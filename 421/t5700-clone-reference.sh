...
[master (root-commit) 92a0440] initial
...
Merging:
d5886fd addition
virtual c43b624eb03dc8c1573a118e4f13ae40077eee4c
...
[master (root-commit) 616416d] initial
 Author: A U Thor <author@example.com>
 1 files changed, 1 insertions(+), 0 deletions(-)
 create mode 100644 file1

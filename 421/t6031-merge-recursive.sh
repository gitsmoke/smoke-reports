...
[master (root-commit) abbfc05] initial
...
[other 590fd87] changesimplefile
 Author: A U Thor <author@example.com>
 1 files changed, 1 insertions(+), 0 deletions(-)
rm 'sub1'
[main dc19851] changefiletodir
 Author: A U Thor <author@example.com>

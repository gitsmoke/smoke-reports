...
[master (root-commit) 0222087] A-initial
...
[master (root-commit) b4d6bb7] B-super-initial
 Author: A U Thor <author@example.com>
 1 files changed, 1 insertions(+), 0 deletions(-)
...
Cloning into sub...
Submodule path 'sub': checked out '02220876f1a778c5fdb890a772f1e63a9e93176f'

...
expecting success: 
	...
	echo other >four &&
	echo other >five
[master (root-commit) 75dc77a] First
 Author: A U Thor <author@example.com>
 1 files changed, 1 insertions(+), 0 deletions(-)
 create mode 100644 one
[branch 2d9e93b] Second
 Author: A U Thor <author@example.com>
...
expecting success: 
	...
	git reset --hard HEAD^
Updating 75dc77a..2d9e93b
Aborting
[master 608f759] empty
 Author: A U Thor <author@example.com>
Aborting
HEAD is now at 75dc77a First
...
[master (root-commit) eedbdbf] init
 Author: A U Thor <author@example.com>
...
rm 'rep/foo'
rm 'rep2/foo'
[branch f201b30] added test as a file
 Author: A U Thor <author@example.com>

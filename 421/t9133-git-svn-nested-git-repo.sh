...
Initialized empty Git repository in /Users/trast/git-smoke/t/trash directory.t9133-git-svn-nested-git-repo/g/.git/
	A	a
r1 = 9f265b611364cae7d918d110afab0443d070797c (refs/remotes/git-svn)
r2 = 88d3adb6ab028f3ad4e451afa9be71d7576466b7 (refs/remotes/git-svn)
...
expecting success: 
	...
	M	a
r3 = 699cfa95fd881aae665eb62be94e451992c9cb34 (refs/remotes/git-svn)
...
[master (root-commit) 7a141e6] add a inside an SVN repo
 Author: A U Thor <author@example.com>
 1 files changed, 2 insertions(+), 0 deletions(-)
 create mode 100644 a
commit 7a141e6c6783922746948b50ffe9ce62fc48d945
Author: A U Thor <author@example.com>
Date:   Wed Jan 5 04:04:13 2011 +0000
...
A         .git/objects/7a
A  (bin)  .git/objects/7a/141e6c6783922746948b50ffe9ce62fc48d945
A         .git/objects/a3
...
Adding         .git/objects/7a
Adding  (bin)  .git/objects/7a/141e6c6783922746948b50ffe9ce62fc48d945
...
r4 = 05ece8f64698b3cd19fbe60dd28f74125fdb8e9d (refs/remotes/git-svn)
First, rewinding head to replay your work on top of it...
Fast-forwarded master to refs/remotes/git-svn.
...
[master 21e7f10] add a inside an SVN repo
 Author: A U Thor <author@example.com>
...
expecting success: 
	...
	M	a
r5 = 6c8a1eacfdb52ffc9090994f022ca6ffc8c7fb7e (refs/remotes/git-svn)
First, rewinding head to replay your work on top of it...
Fast-forwarded master to refs/remotes/git-svn.

...
[master (root-commit) 8c3bef0] Initial empty commit
 Author: A U Thor <author@example.com>
[master b626bc4] first
 Author: A U Thor <author@example.com>
 1 files changed, 4 insertions(+), 0 deletions(-)
 create mode 100644 file
[master 9762100] second
 Author: A U Thor <author@example.com>

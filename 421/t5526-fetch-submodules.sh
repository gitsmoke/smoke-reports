...
[master (root-commit) f5515fd] new
...
[master (root-commit) f00d6e8] new
 Author: A U Thor <author@example.com>
...
[master (root-commit) 72363b9] initial
 Author: A U Thor <author@example.com>
...
Submodule path 'submodule': checked out 'f00d6e88752a745a6cad34bab2a22ab74f9b9889'
...
Submodule path 'deepsubmodule': checked out 'f5515fda301d3d385395eed13652bc1ee11526c8'

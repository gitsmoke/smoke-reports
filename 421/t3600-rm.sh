...
[master (root-commit) 57dade6] add normal files
...
[master 485b55e] add files with tabs and newlines
 Author: A U Thor <author@example.com>
 0 files changed, 0 insertions(+), 0 deletions(-)
...
[master 166f4f8] add file for rm test
 Author: A U Thor <author@example.com>
...
[master 0af3f89] remove file from rm test
 Author: A U Thor <author@example.com>
...
[master 59e6faf] add file for rm --quiet test
 Author: A U Thor <author@example.com>
 1 files changed, 1 insertions(+), 0 deletions(-)
 create mode 100644 test-file
[master ecd8b6b] remove file from rm --quiet test
 Author: A U Thor <author@example.com>
 1 files changed, 0 insertions(+), 1 deletions(-)
 delete mode 100644 test-file
...
[master (root-commit) 6ad5ec9] add a file
 Author: A U Thor <author@example.com>
 1 files changed, 1 insertions(+), 0 deletions(-)
...
HEAD is now at dce3e01 subdir test
rm 'frotz/nitfol'

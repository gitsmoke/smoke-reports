...
[master (root-commit) be87a2f] subject
...
expecting success: 
	...
	check_message diff
[master 69148dd] This is an example commit message that contains a diff.
 Author: A U Thor <author@example.com>
 1 files changed, 1 insertions(+), 1 deletions(-)
...
checking known breakage: 
	...
	check_message diff
[master cd02f20] This is an example commit message that contains a diff.
 Author: A U Thor <author@example.com>
 1 files changed, 1 insertions(+), 1 deletions(-)
--- diff	2011-01-05 04:02:53.000000000 +0000
+++ actual	2011-01-05 04:02:53.000000000 +0000
@@ -1,9 +1,2 @@

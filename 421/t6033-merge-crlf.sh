...
expecting success: 
	...
	git tag b &&
	git checkout master
[master (root-commit) d4fbc1e] Initial
 Author: A U Thor <author@example.com>
 1 files changed, 1 insertions(+), 0 deletions(-)
 create mode 100644 file
[master cfc82af] add line from a
 Author: A U Thor <author@example.com>
 1 files changed, 1 insertions(+), 1 deletions(-)
[side adf385b] add line from b
 Author: A U Thor <author@example.com>
 1 files changed, 1 insertions(+), 1 deletions(-)
ok 1 - setup
expecting success: 
...
HEAD is now at d4fbc1e Initial
Merge made by ours.
...
HEAD is now at cfc82af add line from a
Merging:
cfc82af add line from a
virtual side

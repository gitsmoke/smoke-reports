...
[master (root-commit) f6b6e2a]  Add bar
 Author: A U Thor <author@example.com>
 0 files changed, 0 insertions(+), 0 deletions(-)
 create mode 100644 bar
[master 2041ecc]  Add foo
 Author: A U Thor <author@example.com>
 0 files changed, 0 insertions(+), 0 deletions(-)
 create mode 100644 foo
[master (root-commit) f45d552] Add submodule sub
 Author: A U Thor <author@example.com>
...
HEAD is now at 2041ecc  Add foo
...
expecting success: 
	...
	diff output - <<-\EOF
	 M sub
	EOF
HEAD is now at ed3e634 next change
...
[master 38fb196] added .real to .gitignore
 Author: A U Thor <author@example.com>
 1 files changed, 1 insertions(+), 0 deletions(-)

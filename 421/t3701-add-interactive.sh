...
expecting success: 
	...
	echo more >>file &&
	echo lines >>file
[master (root-commit) 6c4bfde] commit
...
Unstaged changes after reset:
M	file
[master cfcb473] commit
 Author: A U Thor <author@example.com>
 1 files changed, 1 insertions(+), 1 deletions(-)
HEAD is now at 6c4bfde commit
...
expecting success: 
	...
	test_cmp expected diff
[master ec3f88d] clear local changes
 Author: A U Thor <author@example.com>
 1 files changed, 1 insertions(+), 0 deletions(-)
...
expecting success: 
	...
	git diff --cached >diff &&
	test_cmp expected diff
HEAD is now at ec3f88d clear local changes
[master 08dc4cf] non-empty
 Author: A U Thor <author@example.com>
 1 files changed, 1 insertions(+), 0 deletions(-)
...
HEAD is now at 08dc4cf non-empty
[master 0de7abc] empty
 Author: A U Thor <author@example.com>

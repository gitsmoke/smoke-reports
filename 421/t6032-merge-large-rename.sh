...
expecting success: 
	...
	git tag initial
[master (root-commit) cd7764f] initial
...
HEAD is now at cd7764f initial
[master cdb1335] add=5
 Author: A U Thor <author@example.com>
...
Deleted branch test5 (was 54d5f8c).
HEAD is now at cd7764f initial
[master 8ba2c9b] add=5
 Author: A U Thor <author@example.com>
 5 files changed, 110 insertions(+), 0 deletions(-)
 create mode 100644 1
 create mode 100644 2
...
Deleted branch test5 (was f7dd395).
HEAD is now at cd7764f initial
[master 0c4e61d] add=5
 Author: A U Thor <author@example.com>
 5 files changed, 110 insertions(+), 0 deletions(-)
 create mode 100644 1
 create mode 100644 2
...
[simple-change 480f2ff] unrelated-change
 Author: A U Thor <author@example.com>
 0 files changed, 0 insertions(+), 0 deletions(-)

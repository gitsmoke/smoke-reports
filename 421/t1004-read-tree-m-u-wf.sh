...
[master (root-commit) 60f986e] initial
...
[master ed9e950] master removes file2 and subdir/file2
 Author: A U Thor <author@example.com>
...
D	file2
D	subdir/file2
[side a41cbcb] side adds file3 and removes file2
 Author: A U Thor <author@example.com>
...
HEAD is now at ed9e950 master removes file2 and subdir/file2
...
expecting success: 
	...
	git checkout side-a
HEAD is now at ed9e950 master removes file2 and subdir/file2
[side-a 5bdbbed] side-a changes file1
 Author: A U Thor <author@example.com>
 1 files changed, 1 insertions(+), 0 deletions(-)
[side-b ff592e0] side-b changes file2
 Author: A U Thor <author@example.com>
 1 files changed, 1 insertions(+), 0 deletions(-)
...
HEAD is now at 5bdbbed side-a changes file1
...
HEAD is now at 5bdbbed side-a changes file1
[sym-b 4de9965] side adds a/b
 Author: A U Thor <author@example.com>
 0 files changed, 0 insertions(+), 0 deletions(-)
 create mode 100644 a/b
[sym-a 681c660] we add a/b
 Author: A U Thor <author@example.com>
 1 files changed, 1 insertions(+), 0 deletions(-)
...
HEAD is now at 681c660 we add a/b
...
HEAD is now at 681c660 we add a/b
[side-a 29c13b4] side-a changes file2 to directory
 Author: A U Thor <author@example.com>
...
HEAD is now at ff592e0 side-b changes file2
Trying simple merge.
...
Merging:
ff592e0 side-b changes file2
29c13b4 side-a changes file2 to directory

...
[master (root-commit) 93c0852] initial
 Author: A U Thor <author@example.com>
 0 files changed, 0 insertions(+), 0 deletions(-)
 create mode 100644 camelcase
[topic 9cf581b] rename
 Author: A U Thor <author@example.com>
...
HEAD is now at 93c0852 initial
Updating 93c0852..9cf581b
Fast-forward
...
[master (root-commit) c6eea74] initial
 Author: A U Thor <author@example.com>
 0 files changed, 0 insertions(+), 0 deletions(-)
 create mode 100644 "a\314\210"
[topic 7c7af41] rename
 Author: A U Thor <author@example.com>
 1 files changed, 0 insertions(+), 0 deletions(-)
...
checking known breakage: 
 ...
 git reset --hard initial &&
 git merge topic
HEAD is now at c6eea74 initial
Updating c6eea74..7c7af41
Aborting

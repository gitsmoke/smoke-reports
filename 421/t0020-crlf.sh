...
expecting success: 
	...
	echo happy.
[master (root-commit) 9e4fd5b] initial
...
HEAD is now at 9e4fd5b initial
...
[master dff7bf2] Add .gitattributes
 Author: A U Thor <author@example.com>
...
[master 504d1a2] initial
 Author: A U Thor <author@example.com>
 1 files changed, 1 insertions(+), 0 deletions(-)
[master 9cfa30b] second
 Author: A U Thor <author@example.com>
...
[master f80b5c0] alllf, allcrlf and mixed only
 Author: A U Thor <author@example.com>

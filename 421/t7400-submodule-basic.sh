...
[master (root-commit) 7c35fa5] initial commit
...
[master (root-commit) bc29abc] submodule commit 1
 Author: A U Thor <author@example.com>
...
[master (root-commit) ecb484c] Ignore everything
 Author: A U Thor <author@example.com>
 1 files changed, 1 insertions(+), 0 deletions(-)
...
" "$rev1" &&
	test -n "$rev1"
rev1: bc29abc08d77ed8137f356cd9d7dc61839f3b8de
...
expecting success: 
	git submodule status >lines &&
	grep "^-$rev1" lines
-bc29abc08d77ed8137f356cd9d7dc61839f3b8de init
...
Submodule path 'init': checked out 'bc29abc08d77ed8137f356cd9d7dc61839f3b8de'
...
expecting success: 
	...
	grep "^ $rev1" list
 bc29abc08d77ed8137f356cd9d7dc61839f3b8de init (rev-1)
...
expecting success: 
	...
	grep "^+$rev2" list
[detached HEAD 87ca44b] submodule commit 2
 Author: A U Thor <author@example.com>
 1 files changed, 1 insertions(+), 0 deletions(-)
 create mode 100644 b
+87ca44b5bfe11bf07e2ac3bae09f1ac31a75867d init (rev-1-1-g87ca44b)
...
+Subproject commit 87ca44b5bfe11bf07e2ac3bae09f1ac31a75867d
...
[detached HEAD be05167] change subproject
 Author: A U Thor <author@example.com>
 1 files changed, 1 insertions(+), 0 deletions(-)
 create mode 100644 s
[master 91f2402] change init
 Author: A U Thor <author@example.com>
...
Submodule path 'init': checked out 'be05167f3942c7d1d45451878cf726b44074e951'
...
HEAD is now at 60171d8 super commit 1
...
HEAD is now at 60171d8 super commit 1
[second a51e2a2] commit subproject
 Author: A U Thor <author@example.com>
 1 files changed, 1 insertions(+), 1 deletions(-)
diff --git a/init b/init
index be05167..b3cdc00 160000
--- a/init
+++ b/init
@@ -1 +1 @@
-Subproject commit be05167f3942c7d1d45451878cf726b44074e951
+Subproject commit b3cdc001ae59eb6d1d7cb6ddda2d099930e83864
...
expecting success: 
	...
	test ! -d init &&
	git checkout second
HEAD is now at a51e2a2 commit subproject
...
[master (root-commit) 13b6f53] repo commit 1
 Author: A U Thor <author@example.com>
 1 files changed, 1 insertions(+), 0 deletions(-)

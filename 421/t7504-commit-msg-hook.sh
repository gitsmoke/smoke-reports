...
expecting success: 
	...
	GIT_EDITOR="\"\$FAKE_EDITOR\"" git commit --no-verify
[master 21b9178] even more content
 Author: A U Thor <author@example.com>
 1 files changed, 1 insertions(+), 0 deletions(-)

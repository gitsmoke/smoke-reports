...
HEAD is now at 9eaa0f1 dir to symlink
rm 'a/b'
[detached HEAD 94c272b] untracked symlink remains
 Author: A U Thor <author@example.com>
...
HEAD is now at 88e2bd9 base
[detached HEAD bad4d6e] x
 Author: A U Thor <author@example.com>
 1 files changed, 1 insertions(+), 0 deletions(-)
...
HEAD is now at 2e87da3 Merge branch 'master' into HEAD
Merging:
bad4d6e x
virtual master
...
HEAD is now at dd5a743 Merge commit 'baseline^0' into HEAD
Merging:
9eaa0f1 dir to symlink
virtual baseline^0
found 1 common ancestor(s):
88e2bd9 base
...
expecting success: 
	...
	git tag test2
HEAD is now at bad4d6e x
[detached HEAD fb84dcf] dir a/b-2 to symlink
 Author: A U Thor <author@example.com>
...
HEAD is now at fb84dcf dir a/b-2 to symlink
Trying really trivial in-index merge...
Nope.
Trying simple merge.
Simple merge failed, trying Automatic merge.
...
HEAD is now at 98f2edd Merge commit 'test2' into HEAD
Merging:
bad4d6e x
virtual test2
found 1 common ancestor(s):

...
expecting success: echo "Not an empty file." > file &&
	 ...
	 git branch b
[master (root-commit) 92768c4] Initial commit.
...
expecting success: rm renamed_file &&
	 ...
	 gitweb_run "p=.git;a=commitdiff"
[master fdf7c31] File to symlink.
 Author: A U Thor <author@example.com>
...
expecting success: echo "New line" >> file2 &&
	 ...
	 gitweb_run "p=.git;a=commitdiff"
[master fdc039c] Mode change and modification.
 Author: A U Thor <author@example.com>
 1 files changed, 1 insertions(+), 0 deletions(-)
...
EOF
	 ...
	 gitweb_run "p=.git;a=commitdiff"
[master 423836d] File added.
 Author: A U Thor <author@example.com>
 1 files changed, 7 insertions(+), 2 deletions(-)
[master dae678c] File rename and modification.
 Author: A U Thor <author@example.com>
 1 files changed, 1 insertions(+), 0 deletions(-)
...
expecting success: git mv file3 file2 &&
	 ...
	 gitweb_run "p=.git;a=commitdiff"
[master 8d7a620] File rename, mode change and modification.
 Author: A U Thor <author@example.com>
 1 files changed, 1 insertions(+), 0 deletions(-)
...
[master ba68137] initial
 Author: A U Thor <author@example.com>
 2 files changed, 2 insertions(+), 0 deletions(-)
 create mode 100644 bar
 create mode 100644 foo
[master 93d4b06] foo symlinked to bar
 Author: A U Thor <author@example.com>
 1 files changed, 1 insertions(+), 1 deletions(-)
 rewrite foo (100%)
 mode change 100644 => 120000
[master 4dc83f9] foo back to file
 Author: A U Thor <author@example.com>
 1 files changed, 1 insertions(+), 1 deletions(-)
 rewrite foo (100%)
 mode change 120000 => 100644
[master a6eb878] foo becomes a directory
 Author: A U Thor <author@example.com>
 2 files changed, 1 insertions(+), 1 deletions(-)
 delete mode 100644 foo
 create mode 100644 foo/baz
[master db62b16] foo/baz is the original foo
 Author: A U Thor <author@example.com>
 1 files changed, 1 insertions(+), 1 deletions(-)
...
Merging:
db62b16 foo/baz is the original foo
virtual 0d5a150d4216568dd2b01437a7c70f422163cb95
found 1 common ancestor(s):
92768c4 Initial commit.
...
expecting success: git checkout b &&
	 ...
	 git checkout master
[b 42591b0] Prepare large commit
 Author: A U Thor <author@example.com>
...
[master 9130e2b] Add file to be deleted
 Author: A U Thor <author@example.com>
 1 files changed, 1 insertions(+), 0 deletions(-)
 create mode 100644 deleted_file
rm 'deleted_file'
[master eb24f75] Delete file
 Author: A U Thor <author@example.com>
 1 files changed, 0 insertions(+), 1 deletions(-)

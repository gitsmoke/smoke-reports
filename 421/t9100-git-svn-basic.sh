...
r1 = e8aff360a1f8d770fbdce4846d7fd9db6c30c2c6 (refs/remotes/git-svn)
...
[mybranch 5633932] try a deep --rmdir with a commit
 ...
 rename dir/a/b/c/d/e/file => file (100%)
	...
	D	dir/a/
	A	dir/file
r2 = ffc2e691eaaac8a010cbe2928e3e6c90ad224742 (refs/remotes/git-svn)
...
[mybranch 4f0364d] detect node change from file to directory #1
 Author: A U Thor <author@example.com>
...
[mybranch2 78c75e7] detect node change from directory to file #1
 Author: A U Thor <author@example.com>
 1 files changed, 0 insertions(+), 0 deletions(-)
...
[mybranch3 daed7ca] detect node change from file to directory #2
 Author: A U Thor <author@example.com>
...
[mybranch4 b9a7b82] detect node change from directory to file #2
 Author: A U Thor <author@example.com>
 2 files changed, 1 insertions(+), 1 deletions(-)
...
[mybranch5 c731380] remove executable bit from a file
 Author: A U Thor <author@example.com>
 0 files changed, 0 insertions(+), 0 deletions(-)
 mode change 100755 => 100644 exec.sh
	M	exec.sh
	M	exec.sh
r3 = 9f822a3ec3092328c197c554df1cec263d48fa9e (refs/remotes/git-svn)
Done committing 1 revisions to SVN
...
expecting success: 
	...
	svn_cmd up "$SVN_TREE" &&
	test -x "$SVN_TREE"/exec.sh
[mybranch5 6b912a4] add executable bit back file
 Author: A U Thor <author@example.com>
 0 files changed, 0 insertions(+), 0 deletions(-)
 mode change 100644 => 100755 exec.sh
	M	exec.sh
	M	exec.sh
r4 = 958bdb7168424b83b9b725851a03066f8d085350 (refs/remotes/git-svn)
Done committing 1 revisions to SVN
UU   /Users/trast/git-smoke/t/trash directory.t9100-git-svn-basic/.git/svn/refs/remotes/git-svn/svn-tree/exec.sh
...
[mybranch5 c000bf7] executable file becomes a symlink to bar/zzz (file)
 Author: A U Thor <author@example.com>
 ...
 mode change 100755 => 120000
	T	exec.sh
	M	exec.sh
r5 = 5e2a7fdef68b5b34ff374a0b87579727f1a9f8e7 (refs/remotes/git-svn)
Done committing 1 revisions to SVN
UU   /Users/trast/git-smoke/t/trash directory.t9100-git-svn-basic/.git/svn/refs/remotes/git-svn/svn-tree/exec.sh
...
[mybranch5 24e2cee] new symlink is added to a file that was also just made executable
 Author: A U Thor <author@example.com>
 ...
 create mode 120000 exec-2.sh
	...
	M	bar/zzz
	A	exec-2.sh
r6 = 5639f445ef4dfab31c1ef8794e5bd5562e31c1a6 (refs/remotes/git-svn)
Done committing 1 revisions to SVN
...
[mybranch5 bfc63e2] modify a symlink to become a file
 Author: A U Thor <author@example.com>
 1 files changed, 1 insertions(+), 1 deletions(-)
 ...
 mode change 120000 => 100644
	T	exec-2.sh
	M	exec-2.sh
r7 = 30a5809af23d5a77dab8546683d9ccc0c6d9db5b (refs/remotes/git-svn)
Done committing 1 revisions to SVN
...
expecting success: git svn init "$svnrepo" && git svn fetch &&
	...
	A	exec.sh
	A	dir/a/b/c/d/e/file
r1 = e8aff360a1f8d770fbdce4846d7fd9db6c30c2c6 (refs/remotes/alt)
	A	file
	D	dir/a/b/c/d/e/file
	D	dir/a/
	A	dir/file
r2 = 34f2d81e4087af64677dc67986782e6af1ea9a33 (refs/remotes/alt)
	M	exec.sh
r3 = 443f0d2ef325573598d6e6e4c6711685c9dada6c (refs/remotes/alt)
	M	exec.sh
r4 = a64dbdfd0802b63af2b152a44332014bf7fe0f7c (refs/remotes/alt)
	M	exec.sh
r5 = e8abb88cce26dc02107faae63bae3355b2242819 (refs/remotes/alt)
	M	bar/zzz
	A	exec-2.sh
r6 = f8ae13774295f70940f33fe0cad1d996bb76fd33 (refs/remotes/alt)
	M	exec-2.sh
r7 = 0bd88bcaac4e92d170a21244f5a974355e41ded9 (refs/remotes/alt)
...
expecting success: 
	...
	A	zzz
r1 = 050aa8571a14590c2a6c59cca736bba71d67ec23 (refs/remotes/bar)
	M	zzz
r6 = 06c842e3303403176883d4b496e759dbd1926f11 (refs/remotes/bar)
[my-bar ace604f] change 1
 Author: A U Thor <author@example.com>
 1 files changed, 1 insertions(+), 0 deletions(-)
 create mode 100644 foo
[my-bar 94d1c56] change 2
 Author: A U Thor <author@example.com>
 1 files changed, 1 insertions(+), 1 deletions(-)
...
Committed r8
	A	foo
r8 = 0f886761b0ba876023c1797a3e86f65009528874 (refs/remotes/bar)
...
The rewritten commit is: 0f886761b0ba876023c1797a3e86f65009528874
    change 1
Deleted branch my-bar (was 94d1c56).
...
expecting success: 
	...
	A	bar/foo
r8 = 9b0a642a2f024c04c834dd9ef0e7f0c7a550b460 (refs/remotes/alt)
[my-bar d43c55b] /bar/d should be in the log
 Author: A U Thor <author@example.com>
 1 files changed, 1 insertions(+), 0 deletions(-)
...
Committed r9
	A	d
r9 = 981feb37ce417ac26eecc54df62a843ade24bc69 (refs/remotes/bar)
No changes between current HEAD and refs/remotes/bar
Resetting to the latest refs/remotes/bar
[my-bar 51fcc7d] add a new directory
 Author: A U Thor <author@example.com>
 1 files changed, 1 insertions(+), 0 deletions(-)
...
Committed r10
	A	newdir/dir
r10 = a0426dd32be17232d25a73e6ca8efb07df268ac5 (refs/remotes/bar)
No changes between current HEAD and refs/remotes/bar
Resetting to the latest refs/remotes/bar
[my-bar 1db6d24] modify a file in new directory
 Author: A U Thor <author@example.com>
 1 files changed, 1 insertions(+), 0 deletions(-)
Committing to file:///Users/trast/git-smoke/t/trash directory.t9100-git-svn-basic/svnrepo/bar ...
	M	newdir/dir
Committed r11
	M	newdir/dir
r11 = 0d2b29d773073c331eec9c5e05657312b381f43a (refs/remotes/bar)
No changes between current HEAD and refs/remotes/bar
Resetting to the latest refs/remotes/bar
...
expecting success: 
	...
	test-chmtime =-60 foo &&
	git svn dcommit
[my-bar 466ff48] commit-new-file-foo2
 Author: A U Thor <author@example.com>
 1 files changed, 1 insertions(+), 0 deletions(-)
...
Committed r12
	A	foo2
r12 = 38166418481359e77deb8338d6c474d7c9ab64e7 (refs/remotes/bar)
No changes between current HEAD and refs/remotes/bar
Resetting to the latest refs/remotes/bar
...
[my-bar 7aef8f0] update /bar/d
 Author: A U Thor <author@example.com>
 1 files changed, 1 insertions(+), 1 deletions(-)
	M	d
	M	d
r13 = d82194fbb7ec744f3cf21f046d569e344f94e3fb (refs/remotes/bar)
Done committing 1 revisions to SVN
...
r8 = 9b0a642a2f024c04c834dd9ef0e7f0c7a550b460 (refs/remotes/alt)
	A	bar/d
r9 = 3657302fd4e839411b8c802a93e373c3cb06b3d9 (refs/remotes/alt)
	A	bar/newdir/dir
r10 = 53e3d21e32b0fe58c19a3e6127eb653c6036933c (refs/remotes/alt)
	M	bar/newdir/dir
r11 = e8c496272107b58bbc63668026c0437154808b28 (refs/remotes/alt)
	A	bar/foo2
r12 = ca9ded27a7c9a562fa1b6f91d832723d424638f6 (refs/remotes/alt)
	M	bar/d
r13 = c04414aa3bdb0b52f763befbd64e12e5030e2269 (refs/remotes/alt)

...
git checkout master
[master (root-commit) 63a8035] initial has A and M
 Author: A U Thor <author@example.com>
 2 files changed, 30 insertions(+), 0 deletions(-)
 create mode 100644 A
 create mode 100644 M
[master 51f03f0] master updates A
 Author: A U Thor <author@example.com>
 1 files changed, 1 insertions(+), 1 deletions(-)
[yellow ebb7668] yellow removes M
 Author: A U Thor <author@example.com>
 1 files changed, 0 insertions(+), 15 deletions(-)
 delete mode 100644 M
[white 445f6b5] white renames A->B, M->N
 Author: A U Thor <author@example.com>
 2 files changed, 2 insertions(+), 2 deletions(-)
 rename A => B (93%)
 rename M => N (93%)
[red 348d0cb] red renames A->B, M->N
 Author: A U Thor <author@example.com>
 2 files changed, 2 insertions(+), 2 deletions(-)
 rename A => B (93%)
 rename M => N (93%)
[blue f8975b7] blue renames A->C, M->N
 Author: A U Thor <author@example.com>
 2 files changed, 2 insertions(+), 2 deletions(-)
 rename A => C (93%)
 rename M => N (93%)
...
+       [blue] blue renames A->C, M->N
     ...
     +  [white] white renames A->B, M->N
   *    [master] master updates A
+++*+++ [red^] initial has A and M
Merging:
51f03f0 master updates A
virtual 445f6b5ef17e189ccd21dcf8f7d4afedfe2a15e1
found 1 common ancestor(s):
63a8035 initial has A and M
Auto-merging B
...
HEAD is now at 51f03f0 master updates A
Merging:
348d0cb red renames A->B, M->N
virtual 445f6b5ef17e189ccd21dcf8f7d4afedfe2a15e1
found 1 common ancestor(s):
63a8035 initial has A and M
Auto-merging B
...
HEAD is now at 348d0cb red renames A->B, M->N
! [blue] blue renames A->C, M->N
 ! [change] changed
  ! [change+rename] changed and renamed
   ! [master] master updates A
...
Merging:
348d0cb red renames A->B, M->N
virtual 51f03f0d122a659c3e57a3326f7046d2107b2e9f
found 1 common ancestor(s):
63a8035 initial has A and M
Auto-merging B
CONFLICT (content): Merge conflict in B
...
Merging:
348d0cb red renames A->B, M->N
virtual f8975b72cbcc593091282e6ab17b0f90f6c2edce
found 1 common ancestor(s):
63a8035 initial has A and M
Skipped N (merged same as existing)
CONFLICT (rename/rename): Rename "A"->"B" in branch "HEAD" rename "A"->"C" in "f8975b72cbcc593091282e6ab17b0f90f6c2edce"
Automatic merge failed; fix conflicts and then commit the result.
g : red changes a line
...
+++++*+ [red^] initial has A and M
Merging:
445f6b5 white renames A->B, M->N
virtual 348d0cbf92ee38b57b20fe9a3df74ad904663ecc
found 1 common ancestor(s):
63a8035 initial has A and M
Auto-merging B
CONFLICT (content): Merge conflict in B
...
HEAD is now at 445f6b5 white renames A->B, M->N
...
Merging:
51f03f0 master updates A
virtual ebb7668553b6d2e599357d2960323ed8c262a8e0
found 1 common ancestor(s):
63a8035 initial has A and M
Removing M
...
HEAD is now at 51f03f0 master updates A
Updated tag 'anchor' (was 51f03f0)
! [blue] blue renames A->C, M->N
 ! [change] changed
  ! [change+rename] changed and renamed
   ! [master] master updates A
...
Merge made by recursive.
 A |    2 +-
 1 files changed, 1 insertions(+), 1 deletions(-)
HEAD is now at ebb7668 yellow removes M
...
HEAD is now at 735e949 changed and renamed
Skipped B (merged same as existing)
...
HEAD is now at a1ee276 Merge branch 'change+rename' into change
rm 'B'
rm 'M'
[dir-in-way (root-commit) 823a56e] Common commmit
 Author: A U Thor <author@example.com>
...
[dir-in-way 6477102] Commit to merge, with dir in the way
 Author: A U Thor <author@example.com>
 2 files changed, 2 insertions(+), 0 deletions(-)
rm 'dir/file-in-the-way'
[dir-not-in-way fb81caf] Commit to merge, with dir removed
 Author: A U Thor <author@example.com>
 2 files changed, 1 insertions(+), 1 deletions(-)
 delete mode 100644 dir/file-in-the-way
rm 'dir/file-in-the-way'
rm 'sub/file'
[renamed-file-has-no-conflicts 4bce18e] Independent change
 Author: A U Thor <author@example.com>
 2 files changed, 1 insertions(+), 2 deletions(-)
 rename sub/file => dir (79%)
 delete mode 100644 dir/file-in-the-way
rm 'dir/file-in-the-way'
[renamed-file-has-conflicts 17d7479] Conflicting change
 Author: A U Thor <author@example.com>
 2 files changed, 1 insertions(+), 1 deletions(-)
...
HEAD is now at 17d7479 Conflicting change
Merging:
4bce18e Independent change
virtual dir-not-in-way
found 1 common ancestor(s):
823a56e Common commmit
...
HEAD is now at 2424069 Merge branch 'dir-not-in-way' into HEAD
...
HEAD is now at 4bce18e Independent change
...
expecting success: 
	...
	test -f dir &&
	test_cmp expected dir
HEAD is now at 6477102 Commit to merge, with dir in the way
Merging:
17d7479 Conflicting change
virtual dir-not-in-way
found 1 common ancestor(s):
823a56e Common commmit
Removing dir to make room for subdirectory; may re-add later.
...
HEAD is now at 17d7479 Conflicting change
Merging:
6477102 Commit to merge, with dir in the way
...
rm 'n.stages'
rm 'sub/file'
[rename-dest (root-commit) f48d041] Common commmit
 Author: A U Thor <author@example.com>
 1 files changed, 1 insertions(+), 0 deletions(-)
 create mode 100644 one/file
[rename-dest b66f3d4] Renamed to destdir
 Author: A U Thor <author@example.com>
 1 files changed, 0 insertions(+), 0 deletions(-)
 rename one/file => destdir (100%)
rm 'one/file'
[source-conflict 14606b1] Conflicts in the way
 Author: A U Thor <author@example.com>
...
HEAD is now at 14606b1 Conflicts in the way
Merging:
b66f3d4 Renamed to destdir
virtual source-conflict
found 1 common ancestor(s):
f48d041 Common commmit
...
HEAD is now at b66f3d4 Renamed to destdir
rm 'destdir'
[rename-two (root-commit) 71b8714] Common commmit
 Author: A U Thor <author@example.com>
 2 files changed, 2 insertions(+), 0 deletions(-)
 create mode 100644 one/file
 create mode 100644 two/file
rm 'one/file'
[rename-two 063467b] Rename two/file -> one
 Author: A U Thor <author@example.com>
 2 files changed, 0 insertions(+), 1 deletions(-)
 rename two/file => one (100%)
 delete mode 100644 one/file
rm 'two/file'
[rename-one caeff9c] Rename one/file -> two
 Author: A U Thor <author@example.com>
 2 files changed, 0 insertions(+), 1 deletions(-)
...
expecting success: 
	...
	test "stuff" = $(cat two)
Merging:
caeff9c Rename one/file -> two
virtual rename-two
found 1 common ancestor(s):
71b8714 Common commmit
...
HEAD is now at caeff9c Rename one/file -> two
Merging:
caeff9c Rename one/file -> two
virtual rename-two
found 1 common ancestor(s):
...
HEAD is now at caeff9c Rename one/file -> two
rm 'two'
[first-rename (root-commit) 1692e72] Common commmit
 Author: A U Thor <author@example.com>
 1 files changed, 1 insertions(+), 0 deletions(-)
 create mode 100644 original
[first-rename b4aa1ff] Put two/file in the way, rename to one
 Author: A U Thor <author@example.com>
 1 files changed, 0 insertions(+), 0 deletions(-)
 rename original => one (100%)
 create mode 100644 two/file
[second-rename 2770082] Put one/file in the way, rename to two
 Author: A U Thor <author@example.com>
 1 files changed, 0 insertions(+), 0 deletions(-)
 create mode 100644 one/file
...
expecting success: 
	...
	! test -f original
Merging:
b4aa1ff Put two/file in the way, rename to one
virtual second-rename
found 1 common ancestor(s):
1692e72 Common commmit
...
HEAD is now at b4aa1ff Put two/file in the way, rename to one
rm 'one'
rm 'two/file'
[first-rename-redo (root-commit) 0644295] Common commmit
 Author: A U Thor <author@example.com>
 1 files changed, 1 insertions(+), 0 deletions(-)
 create mode 100644 one/file
 create mode 100644 original
 create mode 100644 two/file
rm 'one/file'
[first-rename-redo a803063] Rename to one
 Author: A U Thor <author@example.com>
 1 files changed, 0 insertions(+), 0 deletions(-)
 rename original => one (100%)
 delete mode 100644 one/file
rm 'two/file'
[second-rename-redo 5c35b49] Rename to two
 Author: A U Thor <author@example.com>
 1 files changed, 0 insertions(+), 0 deletions(-)
 rename original => two (100%)
 delete mode 100644 two/file
...
expecting success: 
	...
	! test -f original
Merging:
a803063 Rename to one
virtual second-rename-redo
found 1 common ancestor(s):
0644295 Common commmit
Removing one to make room for subdirectory; may re-add later.
Removing two/file

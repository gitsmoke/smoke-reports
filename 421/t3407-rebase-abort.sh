...
[master bdcecdd] c
 Author: A U Thor <author@example.com>
 1 files changed, 1 insertions(+), 1 deletions(-)
[to-rebase c934002] merge should fail on this
 Author: A U Thor <author@example.com>
 1 files changed, 1 insertions(+), 1 deletions(-)
[to-rebase 50bc60b] merge should fail on this, too
 Author: A U Thor <author@example.com>
 1 files changed, 1 insertions(+), 1 deletions(-)
...
HEAD is now at 50bc60b merge should fail on this, too
...
Merging HEAD with merge should fail on this, too
Merging:
131ad75 merge should fail on this
virtual merge should fail on this, too
found 1 common ancestor(s):
virtual f788de73cfc81f8d734fa7efc658cc63ca083f50
Auto-merging a
...
Merging:
bdcecdd c
c934002 merge should fail on this
found 1 common ancestor(s):
b1fcc6e a
Auto-merging a
CONFLICT (content): Merge conflict in a
...
Merging:
bdcecdd c
50bc60b merge should fail on this, too
found 1 common ancestor(s):
c934002 merge should fail on this
Auto-merging a
CONFLICT (content): Merge conflict in a
...
Auto-merging a
CONFLICT (content): Merge conflict in a
[detached HEAD f5c33ed] merge should fail on this
 Author: A U Thor <author@example.com>
 1 files changed, 1 insertions(+), 0 deletions(-)
Committed: 0001 merge should fail on this
Merging master with HEAD~0
Merging:
f5c33ed merge should fail on this
50bc60b merge should fail on this, too
found 1 common ancestor(s):
c934002 merge should fail on this
Auto-merging a

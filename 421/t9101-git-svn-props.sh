...
expecting success: git svn fetch
	...
	A	ne_crlf
	A	empty
r1 = 06c4555c0f769296332608b1015783d46d1c089a (refs/remotes/git-svn)
	M	kw.c
r2 = 0f5945198eef749656a2aec497e0ade06762cb38 (refs/remotes/git-svn)
	M	kw.c
r3 = a0b3f8b2753ea3ec9563d8ca926dbec6c81147e4 (refs/remotes/git-svn)
	M	kw.c
r4 = d64e56fc199975b734f6fc48e88d1c114c4266f8 (refs/remotes/git-svn)
...
[mybranch e424989] test keywords ignoring
 Author: A U Thor <author@example.com>
 1 files changed, 1 insertions(+), 0 deletions(-)
	M	kw.c
	M	kw.c
r5 = 9ab19974d8c06a0f65aee86c7d95167028f0d4a1 (refs/remotes/git-svn)
Done committing 1 revisions to SVN
Updating e424989..9ab1997
Fast-forward
...
expecting success: git svn fetch &&
	...
	M	ne_crlf
	M	empty
r6 = 03d0d5ba325128e105e9fd01a01130535cc941ea (refs/remotes/git-svn)
Updating 9ab1997..03d0d5b
Fast-forward
 crlf    |    3 +--
 ne_crlf |    3 +--
...
expecting success: git svn fetch && git pull . ${remotes_git_svn}
	M	cr
	M	ne_cr
r7 = 582181307569ac3916773cf3a359d8cfb721fb1d (refs/remotes/git-svn)
Updating 03d0d5b..5821813
Fast-forward
 cr    |    4 +++-
 ne_cr |    4 +++-
...
expecting success: 
	...
	A	deeply/nested/directory/.keep
r8 = 0f8c42d9bddbd5b2be9e10e021c85ae2c7165f5a (refs/remotes/git-svn)
Updating 5821813..0f8c42d
Fast-forward

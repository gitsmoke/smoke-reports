...
[master (root-commit) 2d321ff] added file1
 Author: A U Thor <author@example.com>
 2 files changed, 2 insertions(+), 0 deletions(-)
 create mode 100644 file1
 create mode 100644 subdir/file3
[branch1 ea06d96] branch1 changes
 Author: A U Thor <author@example.com>
 3 files changed, 3 insertions(+), 2 deletions(-)
 create mode 100644 file2
[master 010d8df] master updates
 Author: A U Thor <author@example.com>
 3 files changed, 3 insertions(+), 2 deletions(-)
 create mode 100644 file2
...
[test1 8713586] branch1 resolved with mergetool
 Author: A U Thor <author@example.com>
...
x")" &&
    ...
    git reset --hard
[test2 290d4bc] branch1 resolved with mergetool - autocrlf
 Author: A U Thor <author@example.com>
HEAD is now at 290d4bc branch1 resolved with mergetool - autocrlf
ok 3 - mergetool crlf
expecting success: 
...
[test3 4de0a24] branch1 resolved with mergetool - subdir
 Author: A U Thor <author@example.com>
...
HEAD is now at ea06d96 branch1 changes
...
Normal merge conflict for 'subdir/file3':
  {local}: modified
  {remote}: modified
[test4 0ee5ef1] branch2 resolved by mergetool from subdir
 Author: A U Thor <author@example.com>

...
[master (root-commit) 8032741] Initial commit.
 Author: A U Thor <author@example.com>
 1 files changed, 1 insertions(+), 0 deletions(-)
 create mode 100644 A
[master 6228520] Second commit.
 Author: A U Thor <author@example.com>
 1 files changed, 1 insertions(+), 0 deletions(-)
...
expecting success: git branch -d d/e/f &&
	 test ! -f .git/refs/heads/d/e/f &&
	 test ! -f .git/logs/refs/heads/d/e/f
Deleted branch d/e/f (was 6228520).
...
expecting success: git branch l/m &&
        git branch -d l/m &&
        git branch l
Deleted branch l/m (was 6228520).
...
Deleted branch s/t (was 6228520).
...
Deleted branch my7 (was 6228520).
...
6228520fd026f4a051cf10d6d0167a5fd342e8b1
...
expecting success: 
	...
	git branch -d my8
Deleted branch my8 (was 6228520).

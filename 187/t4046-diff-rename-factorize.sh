...
ok 15 - setup move without a subdir
ok 16 - moving files but not subdirs is not mistaken for dir move
ok 17 - setup move of files and subdirs to different places
ok 18 - moving subdirs into one dir and files into another is not mistaken for dir move
...
ok 21 - setup move of dir with only subdirs
not ok 22 - moving a dir with no direct children files # TODO known breakage
ok 23 - setup move from toplevel to subdir
ok 24 - --detect-bulk-moves everything from toplevel.

...
ok 101 - R: catch typo in marks file name
ok 102 - R: import and output marks can be the same file
ok 103 - R: --import-marks=foo --output-marks=foo to create foo fails
ok 104 - R: --import-marks-if-exists
ok 105 - R: import to output marks works without any content
ok 106 - R: import marks prefers commandline marks file over the stream
ok 107 - R: multiple --import-marks= should be honoured
ok 108 - R: feature relative-marks should be honoured
ok 109 - R: feature no-relative-marks should be honoured
ok 110 - R: feature cat-blob supported
ok 111 - R: cat-blob-fd must be a nonnegative integer
ok 112 - R: print old blob
ok 113 - R: in-stream cat-blob-fd not respected
ok 114 - R: print new blob
ok 115 - R: print new blob by sha1
ok 116 - setup: big file
ok 117 - R: print two blobs to stdout
ok 118 - setup: have pipes?
ok 119 - R: copy using cat-file
ok 120 - R: print blob mid-commit
ok 121 - R: print staged blob within commit
ok 122 - R: quiet option results in no stats being output
ok 123 - R: die on unknown option
ok 124 - R: unknown commandline options are rejected
ok 125 - R: die on invalid option argument
ok 126 - R: ignore non-git options
ok 127 - R: blob bigger than threshold
ok 128 - R: verify created pack
ok 129 - R: verify written objects
ok 130 - R: blob appears only once

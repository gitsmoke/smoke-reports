...
expecting success: 
	...
	echo other >four &&
	echo other >five
[master (root-commit) 15da1a5] First
 Author: A U Thor <author@example.com>
 1 files changed, 1 insertions(+), 0 deletions(-)
 create mode 100644 one
[branch df5fd36] Second
 Author: A U Thor <author@example.com>
...
Updating 15da1a5..df5fd36
Aborting
[master 9d4e833] empty
 Author: A U Thor <author@example.com>
Aborting
HEAD is now at 15da1a5 First
...
[master (root-commit) e7c01c9] init
 Author: A U Thor <author@example.com>
...
rm 'rep/foo'
rm 'rep2/foo'
[branch 5bdecba] added test as a file
 Author: A U Thor <author@example.com>

...
[master (root-commit) 64a9388] Initial.
 Author: A <A@test.git>
...
Merging:
26937dd Branch2-1
virtual ae3ce56249004cfb9d95362f93531f9d4afad6c1
...
expecting success: echo "evil merge." >>file &&
     git commit -a --amend
[branch2 d8c47c8] Merge branch 'branch1' into branch2

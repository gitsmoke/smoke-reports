...
[master (root-commit) 3d2f54f] initial
...
HEAD is now at 3d2f54f initial
[master de07574] add=5
 Author: A U Thor <author@example.com>
...
Deleted branch test5 (was ec0d2df).
HEAD is now at 3d2f54f initial
[master 4e47530] add=5
 Author: A U Thor <author@example.com>
 5 files changed, 110 insertions(+), 0 deletions(-)
 create mode 100644 1
 create mode 100644 2
...
Deleted branch test5 (was 6c2d86d).
HEAD is now at 3d2f54f initial
[master 4e47530] add=5
 Author: A U Thor <author@example.com>
 5 files changed, 110 insertions(+), 0 deletions(-)
...
[simple-change 894eff4] unrelated-change
 Author: A U Thor <author@example.com>
 0 files changed, 0 insertions(+), 0 deletions(-)

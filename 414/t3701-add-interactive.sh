...
expecting success: 
	...
	echo more >>file &&
	echo lines >>file
[master (root-commit) 1741ad7] commit
...
Unstaged changes after reset:
M	file
[master 680e4a2] commit
 Author: A U Thor <author@example.com>
 1 files changed, 1 insertions(+), 1 deletions(-)
HEAD is now at 1741ad7 commit
...
[master 8bfb18a] clear local changes
 Author: A U Thor <author@example.com>
 1 files changed, 1 insertions(+), 0 deletions(-)
...
HEAD is now at 8bfb18a clear local changes
[master 1f799f8] non-empty
 Author: A U Thor <author@example.com>
 1 files changed, 1 insertions(+), 0 deletions(-)
...
HEAD is now at 1f799f8 non-empty
[master 483b638] empty
 Author: A U Thor <author@example.com>

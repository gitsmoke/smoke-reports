...
[master (root-commit) c6f2c4c] add normal files
...
[master 03c46ed] add files with tabs and newlines
 Author: A U Thor <author@example.com>
 0 files changed, 0 insertions(+), 0 deletions(-)
...
[master 41c0486] add file for rm test
 Author: A U Thor <author@example.com>
...
[master 5f947bf] remove file from rm test
 Author: A U Thor <author@example.com>
...
[master b7e5680] add file for rm --quiet test
 Author: A U Thor <author@example.com>
 1 files changed, 1 insertions(+), 0 deletions(-)
 create mode 100644 test-file
[master b17b86e] remove file from rm --quiet test
 Author: A U Thor <author@example.com>
 1 files changed, 0 insertions(+), 1 deletions(-)
 delete mode 100644 test-file
...
[master (root-commit) a1035a6] add a file
 Author: A U Thor <author@example.com>
 1 files changed, 1 insertions(+), 0 deletions(-)
...
HEAD is now at 287f303 subdir test
rm 'frotz/nitfol'

...
[master (root-commit) 6f271e9] initial
...
[master 51189d3] master removes file2 and subdir/file2
 Author: A U Thor <author@example.com>
...
D	file2
D	subdir/file2
[side a4ffc12] side adds file3 and removes file2
 Author: A U Thor <author@example.com>
...
HEAD is now at 51189d3 master removes file2 and subdir/file2
...
expecting success: 
	...
	git checkout side-a
HEAD is now at 51189d3 master removes file2 and subdir/file2
[side-a 78373de] side-a changes file1
 Author: A U Thor <author@example.com>
 1 files changed, 1 insertions(+), 0 deletions(-)
[side-b da87a82] side-b changes file2
 Author: A U Thor <author@example.com>
 1 files changed, 1 insertions(+), 0 deletions(-)
...
HEAD is now at 78373de side-a changes file1
...
HEAD is now at 78373de side-a changes file1
[sym-b b963cea] side adds a/b
 Author: A U Thor <author@example.com>
 0 files changed, 0 insertions(+), 0 deletions(-)
 create mode 100644 a/b
[sym-a d73929d] we add a/b
 Author: A U Thor <author@example.com>
 1 files changed, 1 insertions(+), 0 deletions(-)
...
HEAD is now at d73929d we add a/b
...
HEAD is now at d73929d we add a/b
[side-a add8090] side-a changes file2 to directory
 Author: A U Thor <author@example.com>
...
HEAD is now at da87a82 side-b changes file2
Trying simple merge.
...
Merging:
da87a82 side-b changes file2
add8090 side-a changes file2 to directory

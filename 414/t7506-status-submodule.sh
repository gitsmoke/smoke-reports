...
[master (root-commit) 6215da1]  Add bar
 Author: A U Thor <author@example.com>
 0 files changed, 0 insertions(+), 0 deletions(-)
 create mode 100644 bar
[master ea9c1a8]  Add foo
 Author: A U Thor <author@example.com>
 0 files changed, 0 insertions(+), 0 deletions(-)
 create mode 100644 foo
[master (root-commit) 708fc02] Add submodule sub
 Author: A U Thor <author@example.com>
...
HEAD is now at ea9c1a8  Add foo
...
expecting success: 
	...
	diff output - <<-\EOF
	 M sub
	EOF
HEAD is now at b5cd7a8 next change
...
[master ce7b3e5] added .real to .gitignore
 Author: A U Thor <author@example.com>
 1 files changed, 1 insertions(+), 0 deletions(-)

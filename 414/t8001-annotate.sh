...
[master (root-commit) c4cf91f] Initial.
 Author: A <A@test.git>
...
Merging:
0971230 Branch2-1
virtual e321d1ec41ae0cbc4c62d8740254792a7bedb704
...
expecting success: echo "evil merge." >>file &&
     git commit -a --amend
[branch2 dc4b301] Merge branch 'branch1' into branch2

...
expecting success: 
	...
	git add file &&
	git commit -m "first"
[master (root-commit) dbb2ebd] first
...
expecting success: 
	...
	GIT_EDITOR="\"\$FAKE_EDITOR\"" git commit --no-verify
[master c4f8b4e] even more content
 Author: A U Thor <author@example.com>
 1 files changed, 1 insertions(+), 0 deletions(-)

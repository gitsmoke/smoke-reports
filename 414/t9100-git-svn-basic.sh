...
r1 = a52be5aaeea5b99edad5b4c6d57623180b073949 (refs/remotes/git-svn)
...
[mybranch 29af344] try a deep --rmdir with a commit
 ...
 rename dir/a/b/c/d/e/file => file (100%)
	...
	D	dir/a/
	A	dir/file
r2 = d69eaa79e1d7f12a8d20ff4c0303fbff393a9967 (refs/remotes/git-svn)
...
[mybranch 62469a8] detect node change from file to directory #1
 Author: A U Thor <author@example.com>
...
[mybranch2 c4afde2] detect node change from directory to file #1
 Author: A U Thor <author@example.com>
 1 files changed, 0 insertions(+), 0 deletions(-)
...
[mybranch3 112b49b] detect node change from file to directory #2
 Author: A U Thor <author@example.com>
...
[mybranch4 8187618] detect node change from directory to file #2
 Author: A U Thor <author@example.com>
 2 files changed, 1 insertions(+), 1 deletions(-)
...
[mybranch5 b796e83] remove executable bit from a file
 Author: A U Thor <author@example.com>
 0 files changed, 0 insertions(+), 0 deletions(-)
 mode change 100755 => 100644 exec.sh
	M	exec.sh
	M	exec.sh
r3 = 42093620c801a22319eeef29c2ac1e6b512d9199 (refs/remotes/git-svn)
Done committing 1 revisions to SVN
...
expecting success: 
	...
	svn_cmd up "$SVN_TREE" &&
	test -x "$SVN_TREE"/exec.sh
[mybranch5 8363a92] add executable bit back file
 Author: A U Thor <author@example.com>
 0 files changed, 0 insertions(+), 0 deletions(-)
 mode change 100644 => 100755 exec.sh
	M	exec.sh
	M	exec.sh
r4 = 76a95b3ecc8ba0c9dfc35c51b070e2a7886bec54 (refs/remotes/git-svn)
Done committing 1 revisions to SVN
UU   /Users/trast/git-smoke/t/trash directory.t9100-git-svn-basic/.git/svn/refs/remotes/git-svn/svn-tree/exec.sh
...
[mybranch5 a464611] executable file becomes a symlink to bar/zzz (file)
 Author: A U Thor <author@example.com>
 ...
 mode change 100755 => 120000
	T	exec.sh
	M	exec.sh
r5 = eaade1a2d512eca5b3203d7d8793ad628beb3036 (refs/remotes/git-svn)
Done committing 1 revisions to SVN
UU   /Users/trast/git-smoke/t/trash directory.t9100-git-svn-basic/.git/svn/refs/remotes/git-svn/svn-tree/exec.sh
...
[mybranch5 0fbcfd7] new symlink is added to a file that was also just made executable
 Author: A U Thor <author@example.com>
 ...
 create mode 120000 exec-2.sh
	...
	M	bar/zzz
	A	exec-2.sh
r6 = f7d2d658b9f14474a52822d8d4278250dab6b454 (refs/remotes/git-svn)
Done committing 1 revisions to SVN
...
[mybranch5 9d4d03b] modify a symlink to become a file
 Author: A U Thor <author@example.com>
 1 files changed, 1 insertions(+), 1 deletions(-)
 ...
 mode change 120000 => 100644
	T	exec-2.sh
	M	exec-2.sh
r7 = fea1256b001c03cbb2de6575a1e4f7c736e7dd4c (refs/remotes/git-svn)
Done committing 1 revisions to SVN
...
expecting success: git svn init "$svnrepo" && git svn fetch &&
	...
	A	exec.sh
	A	dir/a/b/c/d/e/file
r1 = a52be5aaeea5b99edad5b4c6d57623180b073949 (refs/remotes/alt)
	A	file
	D	dir/a/b/c/d/e/file
	D	dir/a/
	A	dir/file
r2 = c4b38c6179b37a10081fdc15535ba0b7ca026d36 (refs/remotes/alt)
	M	exec.sh
r3 = f43a7172117956323cbfcaed621cc92aeafa8f33 (refs/remotes/alt)
	M	exec.sh
r4 = ba5a2a5479704f862c01b10d4a0e35d506cf232a (refs/remotes/alt)
	M	exec.sh
r5 = 169a5a16cd74068c1c54c532f2046f18d6eaa1a8 (refs/remotes/alt)
	M	bar/zzz
	A	exec-2.sh
r6 = 4828a3c4ddf09352d98e5271ba955d633bc2c16b (refs/remotes/alt)
	M	exec-2.sh
r7 = e004193a0ac09422fc3be7b5fe80fabfdfdeba5b (refs/remotes/alt)
...
expecting success: 
	...
	A	zzz
r1 = 517f75a9c97d96452d0c947177c269863d4a5fd4 (refs/remotes/bar)
	M	zzz
r6 = 68edcc5894120a7a0807e67f42366c59d3eca20f (refs/remotes/bar)
[my-bar ff2077c] change 1
 Author: A U Thor <author@example.com>
 1 files changed, 1 insertions(+), 0 deletions(-)
 create mode 100644 foo
[my-bar 1884943] change 2
 Author: A U Thor <author@example.com>
 1 files changed, 1 insertions(+), 1 deletions(-)
...
Committed r8
	A	foo
r8 = b10c483b5c9f95f84297201d4d1bfa1ef8c2c6b5 (refs/remotes/bar)
...
The rewritten commit is: b10c483b5c9f95f84297201d4d1bfa1ef8c2c6b5
    change 1
Deleted branch my-bar (was 1884943).
...
expecting success: 
	...
	A	bar/foo
r8 = d3a38d1c72d368bf5ac52be8c9d6a619491cda70 (refs/remotes/alt)
[my-bar e032324] /bar/d should be in the log
 Author: A U Thor <author@example.com>
 1 files changed, 1 insertions(+), 0 deletions(-)
...
Committed r9
	A	d
r9 = edb3c3b8b1ef6302bec6b9210e0f260dd299661e (refs/remotes/bar)
No changes between current HEAD and refs/remotes/bar
Resetting to the latest refs/remotes/bar
[my-bar 3682402] add a new directory
 Author: A U Thor <author@example.com>
 1 files changed, 1 insertions(+), 0 deletions(-)
...
Committed r10
	A	newdir/dir
r10 = 4e764b12ee96f16970627b1c9c36bbe8042a281a (refs/remotes/bar)
No changes between current HEAD and refs/remotes/bar
Resetting to the latest refs/remotes/bar
[my-bar 18cc01b] modify a file in new directory
 Author: A U Thor <author@example.com>
 1 files changed, 1 insertions(+), 0 deletions(-)
Committing to file:///Users/trast/git-smoke/t/trash directory.t9100-git-svn-basic/svnrepo/bar ...
	M	newdir/dir
Committed r11
	M	newdir/dir
r11 = e19e91bbf0ea828f6338a402507c2547e11fb535 (refs/remotes/bar)
No changes between current HEAD and refs/remotes/bar
Resetting to the latest refs/remotes/bar
...
[my-bar 2cb48c3] commit-new-file-foo2
 Author: A U Thor <author@example.com>
 1 files changed, 1 insertions(+), 0 deletions(-)
...
Committed r12
	A	foo2
r12 = 5bc4912e0ea84cc8bc68eb1b8ed779e6cbd35f80 (refs/remotes/bar)
No changes between current HEAD and refs/remotes/bar
Resetting to the latest refs/remotes/bar
...
[my-bar 5730001] update /bar/d
 Author: A U Thor <author@example.com>
 1 files changed, 1 insertions(+), 1 deletions(-)
	M	d
	M	d
r13 = f3c8106274a237afb7381cf33791947dcebd1f76 (refs/remotes/bar)
Done committing 1 revisions to SVN
...
r8 = d3a38d1c72d368bf5ac52be8c9d6a619491cda70 (refs/remotes/alt)
	A	bar/d
r9 = 7e978278d9711e3b3f501f01b7bab64e29cd1272 (refs/remotes/alt)
	A	bar/newdir/dir
r10 = bf78148079afdcab4c864cfbb9239fe634332f4c (refs/remotes/alt)
	M	bar/newdir/dir
r11 = d7fd8bf5324fc19843488ec2c23c2e0bf5eebc3e (refs/remotes/alt)
	A	bar/foo2
r12 = b89d908368a1efcd92e3d501797f595e07c80a06 (refs/remotes/alt)
	M	bar/d
r13 = aa76518a76750aad41a917126bce03249279b49d (refs/remotes/alt)

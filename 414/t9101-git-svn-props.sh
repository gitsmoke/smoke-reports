...
expecting success: git svn fetch
	...
	A	ne_crlf
	A	empty
r1 = c77473cba723413c40474c0c9cb6902f7858808a (refs/remotes/git-svn)
	M	kw.c
r2 = 0b1a49a23e6e0eef2878de150b795410cecba91a (refs/remotes/git-svn)
	M	kw.c
r3 = c17e7cbaf55cef718ea2d9aa87096bd87ec7e94f (refs/remotes/git-svn)
	M	kw.c
r4 = 9328fcdac40d80c3a432f5bce02bd936ce2daea0 (refs/remotes/git-svn)
...
[mybranch 6b907b6] test keywords ignoring
 Author: A U Thor <author@example.com>
 1 files changed, 1 insertions(+), 0 deletions(-)
	M	kw.c
	M	kw.c
r5 = a1e22bf3f4b8bcf59238d96a32e5ef6024824df1 (refs/remotes/git-svn)
Done committing 1 revisions to SVN
Updating 6b907b6..a1e22bf
Fast-forward
...
expecting success: git svn fetch &&
	...
	M	ne_crlf
	M	empty
r6 = 929d1351f5defc2beea95b50b266b8e79ad6881e (refs/remotes/git-svn)
Updating a1e22bf..929d135
Fast-forward
 crlf    |    3 +--
 ne_crlf |    3 +--
...
expecting success: git svn fetch && git pull . ${remotes_git_svn}
	M	cr
	M	ne_cr
r7 = 745a032f25bd934113d61e0718b86affdc70b013 (refs/remotes/git-svn)
Updating 929d135..745a032
Fast-forward
 cr    |    4 +++-
 ne_cr |    4 +++-
...
expecting success: 
	...
	A	deeply/nested/directory/.keep
r8 = 11fed07cb1e4db6b7ccf21e264658018d631f4d0 (refs/remotes/git-svn)
Updating 745a032..11fed07
Fast-forward

...
expecting success: 
	...
	repo_fetched one &&
	repo_fetched two
[master (root-commit) e9ddbbc] update-all
...
expecting success: 
	...
	repo_fetched one &&
	repo_fetched two
[master 41da2d9] fetch-group-all
 Author: A U Thor <author@example.com>
 1 files changed, 1 insertions(+), 0 deletions(-)
[master 41da2d9] fetch-group-all
 Author: A U Thor <author@example.com>
...
expecting success: 
	...
	repo_fetched one &&
	! repo_fetched two
[master f623082] fetch-group-some
 Author: A U Thor <author@example.com>
 1 files changed, 1 insertions(+), 0 deletions(-)
[master f623082] fetch-group-some
 Author: A U Thor <author@example.com>
...
expecting success: 
	...
	repo_fetched one &&
	! repo_fetched two
[master a0f5cb4] remote-name
 Author: A U Thor <author@example.com>
 1 files changed, 1 insertions(+), 0 deletions(-)
[master 16f6ccf] remote-name
 Author: A U Thor <author@example.com>
 1 files changed, 1 insertions(+), 0 deletions(-)
Fetching one

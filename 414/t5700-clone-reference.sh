...
[master (root-commit) c057751] initial
...
Merging:
d603d4b addition
virtual f0833558e167cd6aacd30e0a1b256a9bed03c72e
...
[master (root-commit) 360cc34] initial
 Author: A U Thor <author@example.com>
 1 files changed, 1 insertions(+), 0 deletions(-)
 create mode 100644 file1

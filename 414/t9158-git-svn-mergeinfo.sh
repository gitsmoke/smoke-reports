...
expecting success: 
	...
	git svn fetch
r1 = 63bfc3c9d746d7cfd2bd76eaecb3f54a01cd2d46 (refs/remotes/git-svn)
	A	foo
r2 = 72a4c5608a75d586af3ecf2896db5612a550f1ed (refs/remotes/git-svn)
...
Committed r3
	A	bar
r3 = e687040bffecb6ea875bb5ebf12e62dc12035dc7 (refs/remotes/git-svn)

...
HEAD is now at efd5783 dir to symlink
rm 'a/b'
[detached HEAD 9816412] untracked symlink remains
 Author: A U Thor <author@example.com>
...
HEAD is now at 4fa63d2 base
[detached HEAD 805f156] x
 Author: A U Thor <author@example.com>
 1 files changed, 1 insertions(+), 0 deletions(-)
...
HEAD is now at 4a1a58c Merge branch 'master' into HEAD
Merging:
805f156 x
virtual master
...
HEAD is now at 744e833 Merge commit 'baseline^0' into HEAD
Merging:
efd5783 dir to symlink
virtual baseline^0
found 1 common ancestor(s):
4fa63d2 base
...
HEAD is now at 805f156 x
[detached HEAD eb8fd15] dir a/b-2 to symlink
 Author: A U Thor <author@example.com>
...
HEAD is now at eb8fd15 dir a/b-2 to symlink
Trying really trivial in-index merge...
Nope.
Trying simple merge.
Simple merge failed, trying Automatic merge.
...
HEAD is now at c5e63ab Merge commit 'test2' into HEAD
Merging:
805f156 x
virtual test2
found 1 common ancestor(s):

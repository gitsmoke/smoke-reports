...
expecting success: 
	...
	git branch initial
[master (root-commit) ab3105e] initial commit
...
[master (root-commit) 0b261e5] submodule commit 1
 Author: A U Thor <author@example.com>
...
[master (root-commit) f63c59d] Ignore everything
 Author: A U Thor <author@example.com>
 1 files changed, 1 insertions(+), 0 deletions(-)
...
rev1: 0b261e5f85b4a341f03e127d55c3962bcfb4e0ed
...
-0b261e5f85b4a341f03e127d55c3962bcfb4e0ed init
...
Submodule path 'init': checked out '0b261e5f85b4a341f03e127d55c3962bcfb4e0ed'
...
expecting success: 
 ...
 0b261e5f85b4a341f03e127d55c3962bcfb4e0ed init (rev-1)
...
[detached HEAD bc2c7cd] submodule commit 2
 Author: A U Thor <author@example.com>
 1 files changed, 1 insertions(+), 0 deletions(-)
 create mode 100644 b
+bc2c7cde8695dee08d6ad9ab87e9e2df4b5b5520 init (rev-1-1-gbc2c7cd)
...
+Subproject commit bc2c7cde8695dee08d6ad9ab87e9e2df4b5b5520
...
[detached HEAD 186ac58] change subproject
 Author: A U Thor <author@example.com>
 1 files changed, 1 insertions(+), 0 deletions(-)
 create mode 100644 s
[master 81274b3] change init
 Author: A U Thor <author@example.com>
...
Submodule path 'init': checked out '186ac586275efb9124393ef4d2c5158271b5ec39'
...
HEAD is now at 1d62022 super commit 1
...
HEAD is now at 1d62022 super commit 1
[second cba25e7] commit subproject
 Author: A U Thor <author@example.com>
 1 files changed, 1 insertions(+), 1 deletions(-)
diff --git a/init b/init
index 186ac58..58ef535 160000
--- a/init
+++ b/init
@@ -1 +1 @@
-Subproject commit 186ac586275efb9124393ef4d2c5158271b5ec39
+Subproject commit 58ef535560b470ba77eea344e53a6c8ad1e53611
...
expecting success: 
	...
	test ! -d init &&
	git checkout second
HEAD is now at cba25e7 commit subproject
...
[master (root-commit) 3236422] repo commit 1
 Author: A U Thor <author@example.com>
 1 files changed, 1 insertions(+), 0 deletions(-)

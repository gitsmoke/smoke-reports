...
r1 = ca43b83cd900acfe87076a79b2de802d291d0320 (refs/remotes/git-svn)
...
[test-rmdir d361b32] remove another
 ...
 delete mode 100644 deeply/nested/directory/number/2/another
	...
	D	deeply/nested/directory/number/2/another
	D	deeply/nested/directory/number/2/
r2 = f8ccd5fa57f54171410ea28a4192de6070128b53 (refs/remotes/git-svn)

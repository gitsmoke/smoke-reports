...
expecting success: echo "Not an empty file." > file &&
	 ...
	 git branch b
[master (root-commit) 0a56766] Initial commit.
...
expecting success: rm renamed_file &&
	 ...
	 gitweb_run "p=.git;a=commitdiff"
[master 86a3c05] File to symlink.
 Author: A U Thor <author@example.com>
...
expecting success: echo "New line" >> file2 &&
	 ...
	 gitweb_run "p=.git;a=commitdiff"
[master 54bed77] Mode change and modification.
 Author: A U Thor <author@example.com>
 1 files changed, 1 insertions(+), 0 deletions(-)
...
EOF
	 ...
	 gitweb_run "p=.git;a=commitdiff"
[master f91b0da] File added.
 Author: A U Thor <author@example.com>
 1 files changed, 7 insertions(+), 2 deletions(-)
[master 742befd] File rename and modification.
 Author: A U Thor <author@example.com>
 1 files changed, 1 insertions(+), 0 deletions(-)
...
expecting success: git mv file3 file2 &&
	 ...
	 gitweb_run "p=.git;a=commitdiff"
[master 7a6840c] File rename, mode change and modification.
 Author: A U Thor <author@example.com>
 1 files changed, 1 insertions(+), 0 deletions(-)
...
[master e727869] initial
 Author: A U Thor <author@example.com>
 2 files changed, 2 insertions(+), 0 deletions(-)
 create mode 100644 bar
 create mode 100644 foo
[master 9c7072e] foo symlinked to bar
 Author: A U Thor <author@example.com>
 1 files changed, 1 insertions(+), 1 deletions(-)
 rewrite foo (100%)
 mode change 100644 => 120000
[master e01197e] foo back to file
 Author: A U Thor <author@example.com>
 1 files changed, 1 insertions(+), 1 deletions(-)
 rewrite foo (100%)
 mode change 120000 => 100644
[master 7b9b49b] foo becomes a directory
 Author: A U Thor <author@example.com>
 2 files changed, 1 insertions(+), 1 deletions(-)
 delete mode 100644 foo
 create mode 100644 foo/baz
[master 90e8746] foo/baz is the original foo
 Author: A U Thor <author@example.com>
 1 files changed, 1 insertions(+), 1 deletions(-)
...
Merging:
90e8746 foo/baz is the original foo
virtual 682032d278eb2a2ce97c0e0bf54c2d9cf4c54e66
found 1 common ancestor(s):
0a56766 Initial commit.
...
expecting success: git checkout b &&
	 ...
	 git checkout master
[b 778ceb8] Prepare large commit
 Author: A U Thor <author@example.com>
...
[master d16dc85] Add file to be deleted
 Author: A U Thor <author@example.com>
 1 files changed, 1 insertions(+), 0 deletions(-)
 create mode 100644 deleted_file
rm 'deleted_file'
[master bf1f140] Delete file
 Author: A U Thor <author@example.com>
 1 files changed, 0 insertions(+), 1 deletions(-)

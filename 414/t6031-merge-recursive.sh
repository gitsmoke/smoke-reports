...
[master (root-commit) f3c99ea] initial
...
[other 1fcedba] changesimplefile
 Author: A U Thor <author@example.com>
 1 files changed, 1 insertions(+), 0 deletions(-)
rm 'sub1'
[main 548daf2] changefiletodir
 Author: A U Thor <author@example.com>

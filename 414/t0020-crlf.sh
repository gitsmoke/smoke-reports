...
expecting success: 
	...
	echo happy.
[master (root-commit) bba1d0e] initial
...
expecting success: 
	...
	git reset --hard HEAD^
HEAD is now at bba1d0e initial
...
[master 9508d11] Add .gitattributes
 Author: A U Thor <author@example.com>
...
[master efb7a21] initial
 Author: A U Thor <author@example.com>
 1 files changed, 1 insertions(+), 0 deletions(-)
[master 5e304b7] second
 Author: A U Thor <author@example.com>
...
[master 22dbf83] alllf, allcrlf and mixed only
 Author: A U Thor <author@example.com>

...
[master (root-commit) aa66e4f] Initial commit.
 Author: A U Thor <author@example.com>
 1 files changed, 1 insertions(+), 0 deletions(-)
 create mode 100644 A
[master 45c7820] Second commit.
 Author: A U Thor <author@example.com>
 1 files changed, 1 insertions(+), 0 deletions(-)
...
expecting success: git branch l/m &&
        git branch -d l/m &&
        git branch l
Deleted branch l/m (was 45c7820).
...
Deleted branch s/t (was 45c7820).
...
Deleted branch my7 (was 45c7820).
...
45c7820a9fc745c8758a1055e6118d845885dda8
...
expecting success: 
	...
	git branch -d my8
Deleted branch my8 (was 45c7820).

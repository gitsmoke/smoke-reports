...
[master (root-commit) e3cbfc4] subject
...
expecting success: 
	...
	check_message diff
[master d9c53ea] This is an example commit message that contains a diff.
 Author: A U Thor <author@example.com>
 1 files changed, 1 insertions(+), 1 deletions(-)
...
checking known breakage: 
	...
	check_message diff
[master b8829d3] This is an example commit message that contains a diff.
 Author: A U Thor <author@example.com>
 1 files changed, 1 insertions(+), 1 deletions(-)
--- diff	2011-01-02 04:08:33.000000000 +0000
+++ actual	2011-01-02 04:08:33.000000000 +0000
@@ -1,9 +1,2 @@

...
expecting success: 
	...
	git tag b &&
	git checkout master
[master (root-commit) f626e77] Initial
 Author: A U Thor <author@example.com>
 1 files changed, 1 insertions(+), 0 deletions(-)
 create mode 100644 file
[master 554b768] add line from a
 Author: A U Thor <author@example.com>
 1 files changed, 1 insertions(+), 1 deletions(-)
[side 1b08662] add line from b
 Author: A U Thor <author@example.com>
 1 files changed, 1 insertions(+), 1 deletions(-)
...
HEAD is now at f626e77 Initial
Merge made by ours.
...
HEAD is now at 554b768 add line from a
Merging:
554b768 add line from a
virtual side

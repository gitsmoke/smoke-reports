...
[master 26616e4] Test: Remove, add and update
 Author: A U Thor <author@example.com>
...
[master ef26353] generatiion 1
 Author: A U Thor <author@example.com>
 1 files changed, 0 insertions(+), 0 deletions(-)
[master efd9b24] generation 2
 Author: A U Thor <author@example.com>
 1 files changed, 0 insertions(+), 0 deletions(-)
Checking if patch will apply
Applying
...
HEAD is now at 26616e4 Test: Remove, add and update
[master b389221] test: remove only a binary file
 Author: A U Thor <author@example.com>
 1 files changed, 0 insertions(+), 0 deletions(-)
...
[master 7d24947] test: remove only a binary file
 Author: A U Thor <author@example.com>
...
[master f5c6083] Update with spaces
 Author: A U Thor <author@example.com>
 2 files changed, 1 insertions(+), 0 deletions(-)
Checking if patch will apply
Applying
...
[master 357f58d] Update one
 Author: A U Thor <author@example.com>
 1 files changed, 1 insertions(+), 0 deletions(-)
[master 6d74dae] Update two
 Author: A U Thor <author@example.com>
 1 files changed, 1 insertions(+), 0 deletions(-)
Checking if patch will apply
Applying
...
[master 7eba251] Add release notes
 Author: A U Thor <author@example.com>
 1 files changed, 1 insertions(+), 0 deletions(-)
...
initial revision: 1.1
Committed successfully to CVS
[master 2647c75] Add two files with the same basename
 Author: A U Thor <author@example.com>
...
[master 48f42b4] Added attic_gremlin
 Author: A U Thor <author@example.com>
 1 files changed, 1 insertions(+), 0 deletions(-)
...
[master cf3682e] Add a file with a leading space
 Author: A U Thor <author@example.com>
 1 files changed, 1 insertions(+), 0 deletions(-)
...
[master (root-commit) fa02cc2] fake initial commit
 Author: A U Thor <author@example.com>
 1 files changed, 1 insertions(+), 0 deletions(-)
 create mode 100644  space
[master fe6140e] Another change
 Author: A U Thor <author@example.com>
 1 files changed, 1 insertions(+), 0 deletions(-)
Checking if patch will apply
Applying

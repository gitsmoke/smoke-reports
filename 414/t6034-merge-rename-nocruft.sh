...
git checkout master
[master (root-commit) 7f8ea9a] initial has A and M
 Author: A U Thor <author@example.com>
 2 files changed, 30 insertions(+), 0 deletions(-)
 create mode 100644 A
 create mode 100644 M
[white 5c87388] white renames A->B, M->N
 Author: A U Thor <author@example.com>
 2 files changed, 2 insertions(+), 2 deletions(-)
 rename A => B (93%)
 rename M => N (93%)
[red 0f1eb70] red creates R
 Author: A U Thor <author@example.com>
 1 files changed, 1 insertions(+), 0 deletions(-)
 create mode 100644 R
[blue a52be89] blue modify A
 Author: A U Thor <author@example.com>
...
expecting success: 
	...
	return 0
Merging:
0f1eb70 red creates R
virtual white
found 1 common ancestor(s):
7f8ea9a initial has A and M
Auto-merging B
Auto-merging N

...
[master (root-commit) 3254b44] A-initial
...
[master (root-commit) 60852a6] B-super-initial
 Author: A U Thor <author@example.com>
 1 files changed, 1 insertions(+), 0 deletions(-)
...
Cloning into sub
Submodule path 'sub': checked out '3254b444eaac8a74d84bb7190f6909db2c1149a5'

...
git checkout master
[master (root-commit) 47c13ee] initial has A and M
 Author: A U Thor <author@example.com>
 2 files changed, 30 insertions(+), 0 deletions(-)
 create mode 100644 A
 create mode 100644 M
[master f63dd2a] master updates A
 Author: A U Thor <author@example.com>
 1 files changed, 1 insertions(+), 1 deletions(-)
[yellow d2b7d85] yellow removes M
 Author: A U Thor <author@example.com>
 1 files changed, 0 insertions(+), 15 deletions(-)
 delete mode 100644 M
[white 604f312] white renames A->B, M->N
 Author: A U Thor <author@example.com>
 2 files changed, 2 insertions(+), 2 deletions(-)
 rename A => B (93%)
 rename M => N (93%)
[red 0f4f0ce] red renames A->B, M->N
 Author: A U Thor <author@example.com>
 2 files changed, 2 insertions(+), 2 deletions(-)
 rename A => B (93%)
 rename M => N (93%)
[blue eda7840] blue renames A->C, M->N
 Author: A U Thor <author@example.com>
 2 files changed, 2 insertions(+), 2 deletions(-)
 rename A => C (93%)
 rename M => N (93%)
...
Merging:
f63dd2a master updates A
virtual 604f31217325c16fc2a046f1dfed9e971c8b52ea
found 1 common ancestor(s):
47c13ee initial has A and M
Auto-merging B
...
expecting success: 
	...
	git diff --exit-code white N
HEAD is now at f63dd2a master updates A
Merging:
0f4f0ce red renames A->B, M->N
virtual 604f31217325c16fc2a046f1dfed9e971c8b52ea
found 1 common ancestor(s):
47c13ee initial has A and M
Auto-merging B
...
expecting success: 
	...
	git diff --exit-code white N
HEAD is now at 0f4f0ce red renames A->B, M->N
! [blue] blue renames A->C, M->N
 ! [change] changed
  ! [change+rename] changed and renamed
   ! [master] master updates A
...
Merging:
0f4f0ce red renames A->B, M->N
virtual f63dd2a0b1f4d888ce8d3cf04b020218c7b4d387
found 1 common ancestor(s):
47c13ee initial has A and M
Auto-merging B
CONFLICT (content): Merge conflict in B
...
Merging:
0f4f0ce red renames A->B, M->N
virtual eda784086448020d9969ce48ca7b7665919413db
found 1 common ancestor(s):
47c13ee initial has A and M
Skipped N (merged same as existing)
CONFLICT (rename/rename): Rename "A"->"B" in branch "HEAD" rename "A"->"C" in "eda784086448020d9969ce48ca7b7665919413db"
Automatic merge failed; fix conflicts and then commit the result.
g : red changes a line
...
+++++*+ [yellow^] initial has A and M
Merging:
604f312 white renames A->B, M->N
virtual 0f4f0ceee89d2ea9a1456b707466c7bbd8b7eea6
found 1 common ancestor(s):
47c13ee initial has A and M
Auto-merging B
CONFLICT (content): Merge conflict in B
...
HEAD is now at 604f312 white renames A->B, M->N
...
Merging:
f63dd2a master updates A
virtual d2b7d857f52fbf4faf9913ad015cc67232bb78de
found 1 common ancestor(s):
47c13ee initial has A and M
Removing M
...
HEAD is now at f63dd2a master updates A
Updated tag 'anchor' (was f63dd2a)
! [blue] blue renames A->C, M->N
 ! [change] changed
  ! [change+rename] changed and renamed
   ! [master] master updates A
...
Merge made by recursive.
 A |    2 +-
 1 files changed, 1 insertions(+), 1 deletions(-)
HEAD is now at d2b7d85 yellow removes M
...
HEAD is now at 0a3567b changed and renamed
Skipped B (merged same as existing)
...
HEAD is now at 264ee30 Merge branch 'change+rename' into change
rm 'B'
rm 'M'
[dir-in-way (root-commit) 0535a12] Common commmit
 Author: A U Thor <author@example.com>
...
[dir-in-way a687bdc] Commit to merge, with dir in the way
 Author: A U Thor <author@example.com>
 2 files changed, 2 insertions(+), 0 deletions(-)
rm 'dir/file-in-the-way'
[dir-not-in-way b4e096a] Commit to merge, with dir removed
 Author: A U Thor <author@example.com>
 2 files changed, 1 insertions(+), 1 deletions(-)
 delete mode 100644 dir/file-in-the-way
rm 'dir/file-in-the-way'
rm 'sub/file'
[renamed-file-has-no-conflicts 545a80f] Independent change
 Author: A U Thor <author@example.com>
 2 files changed, 1 insertions(+), 2 deletions(-)
 rename sub/file => dir (79%)
 delete mode 100644 dir/file-in-the-way
rm 'dir/file-in-the-way'
[renamed-file-has-conflicts 51734d0] Conflicting change
 Author: A U Thor <author@example.com>
 2 files changed, 1 insertions(+), 1 deletions(-)
...
HEAD is now at 51734d0 Conflicting change
Merging:
545a80f Independent change
virtual dir-not-in-way
found 1 common ancestor(s):
0535a12 Common commmit
...
HEAD is now at caa9d27 Merge branch 'dir-not-in-way' into HEAD
...
HEAD is now at 545a80f Independent change
...
expecting success: 
	...
	test -f dir &&
	test_cmp expected dir
HEAD is now at a687bdc Commit to merge, with dir in the way
Merging:
51734d0 Conflicting change
virtual dir-not-in-way
found 1 common ancestor(s):
0535a12 Common commmit
Removing dir to make room for subdirectory; may re-add later.
...
HEAD is now at 51734d0 Conflicting change
Merging:
a687bdc Commit to merge, with dir in the way
...
rm 'n.stages'
rm 'sub/file'
[rename-dest (root-commit) 78d8813] Common commmit
 Author: A U Thor <author@example.com>
 1 files changed, 1 insertions(+), 0 deletions(-)
 create mode 100644 one/file
[rename-dest 70c27c4] Renamed to destdir
 Author: A U Thor <author@example.com>
 1 files changed, 0 insertions(+), 0 deletions(-)
 rename one/file => destdir (100%)
rm 'one/file'
[source-conflict bfcaa99] Conflicts in the way
 Author: A U Thor <author@example.com>
...
HEAD is now at bfcaa99 Conflicts in the way
Merging:
70c27c4 Renamed to destdir
virtual source-conflict
found 1 common ancestor(s):
78d8813 Common commmit
...
HEAD is now at 70c27c4 Renamed to destdir
rm 'destdir'
[rename-two (root-commit) fb28eed] Common commmit
 Author: A U Thor <author@example.com>
 2 files changed, 2 insertions(+), 0 deletions(-)
 create mode 100644 one/file
 create mode 100644 two/file
rm 'one/file'
[rename-two 815bc2e] Rename two/file -> one
 Author: A U Thor <author@example.com>
 2 files changed, 0 insertions(+), 1 deletions(-)
 rename two/file => one (100%)
 delete mode 100644 one/file
rm 'two/file'
[rename-one 4d6ab91] Rename one/file -> two
 Author: A U Thor <author@example.com>
 2 files changed, 0 insertions(+), 1 deletions(-)
...
expecting success: 
	...
	test "stuff" = $(cat two)
Merging:
4d6ab91 Rename one/file -> two
virtual rename-two
found 1 common ancestor(s):
fb28eed Common commmit
...
HEAD is now at 4d6ab91 Rename one/file -> two
Merging:
4d6ab91 Rename one/file -> two
virtual rename-two
found 1 common ancestor(s):
...
HEAD is now at 4d6ab91 Rename one/file -> two
rm 'two'
[first-rename (root-commit) 9b744fc] Common commmit
 Author: A U Thor <author@example.com>
 1 files changed, 1 insertions(+), 0 deletions(-)
 create mode 100644 original
[first-rename 3a4e171] Put two/file in the way, rename to one
 Author: A U Thor <author@example.com>
 1 files changed, 0 insertions(+), 0 deletions(-)
 rename original => one (100%)
 create mode 100644 two/file
[second-rename c84cf35] Put one/file in the way, rename to two
 Author: A U Thor <author@example.com>
 1 files changed, 0 insertions(+), 0 deletions(-)
 create mode 100644 one/file
...
expecting success: 
	...
	! test -f original
Merging:
3a4e171 Put two/file in the way, rename to one
virtual second-rename
found 1 common ancestor(s):
9b744fc Common commmit
...
HEAD is now at 3a4e171 Put two/file in the way, rename to one
rm 'one'
rm 'two/file'
[first-rename-redo (root-commit) 483d72e] Common commmit
 Author: A U Thor <author@example.com>
 1 files changed, 1 insertions(+), 0 deletions(-)
 create mode 100644 one/file
 create mode 100644 original
 create mode 100644 two/file
rm 'one/file'
[first-rename-redo 05052bb] Rename to one
 Author: A U Thor <author@example.com>
 1 files changed, 0 insertions(+), 0 deletions(-)
 rename original => one (100%)
 delete mode 100644 one/file
rm 'two/file'
[second-rename-redo a2e2498] Rename to two
 Author: A U Thor <author@example.com>
 1 files changed, 0 insertions(+), 0 deletions(-)
 rename original => two (100%)
 delete mode 100644 two/file
...
expecting success: 
	...
	! test -f original
Merging:
05052bb Rename to one
virtual second-rename-redo
found 1 common ancestor(s):
483d72e Common commmit
Removing one to make room for subdirectory; may re-add later.
Removing two/file

...
[master (root-commit) c1912bc] added file1
 Author: A U Thor <author@example.com>
 2 files changed, 2 insertions(+), 0 deletions(-)
 create mode 100644 file1
 create mode 100644 subdir/file3
[branch1 59f56da] branch1 changes
 Author: A U Thor <author@example.com>
 3 files changed, 3 insertions(+), 2 deletions(-)
 create mode 100644 file2
[master 929e692] master updates
 Author: A U Thor <author@example.com>
 3 files changed, 3 insertions(+), 2 deletions(-)
 create mode 100644 file2
...
[test1 fae58b1] branch1 resolved with mergetool
 Author: A U Thor <author@example.com>
...
x")" &&
    ...
    git reset --hard
[test2 bc7eec8] branch1 resolved with mergetool - autocrlf
 Author: A U Thor <author@example.com>
HEAD is now at bc7eec8 branch1 resolved with mergetool - autocrlf
...
[test3 fdfb8d7] branch1 resolved with mergetool - subdir
 Author: A U Thor <author@example.com>
...
HEAD is now at 59f56da branch1 changes
...
Normal merge conflict for 'subdir/file3':
  {local}: modified
  {remote}: modified
[test4 a0b793d] branch2 resolved by mergetool from subdir
 Author: A U Thor <author@example.com>

...
[master (root-commit) 000642c] initial
...
Updating 000642c..4d4dfec
Fast-forward
 file |    1 +
 1 files changed, 1 insertions(+), 0 deletions(-)
[master a416628] third
 Author: A U Thor <author@example.com>
...
[master 604424a] sixth.1
 Author: A U Thor <author@example.com>
 1 files changed, 1 insertions(+), 1 deletions(-)
[master d6a2f14] sixth.2
 Author: A U Thor <author@example.com>
 1 files changed, 1 insertions(+), 0 deletions(-)
[master 3785ae1] sixth.3
 Author: A U Thor <author@example.com>
 1 files changed, 1 insertions(+), 0 deletions(-)
...
3785ae1a9a3a6aa0cfff330cfa0d16c15c9a7179
[master 92128b7] seventh
 Author: A U Thor <author@example.com>
 1 files changed, 1 insertions(+), 1 deletions(-)

...
[master (root-commit) ffdb88b] Initial commit.
...
expecting success: git branch g/h &&
     ...
     git pack-refs --all &&
     git branch -d g
Deleted branch g/h (was ffdb88b).
Deleted branch g (was ffdb88b).
...
expecting success: git branch k/l &&
     ...
     git branch -d k/lm &&
     git branch k
Deleted branch k/l (was ffdb88b).
Deleted branch k/l/m (was ffdb88b).
Deleted branch k/lm (was ffdb88b).
...
expecting success: git branch n/o &&
     ...
     git branch -d n/o/p &&
     git branch n
Deleted branch n/o (was ffdb88b).
Deleted branch n/op (was ffdb88b).
Deleted branch n/o/p (was ffdb88b).

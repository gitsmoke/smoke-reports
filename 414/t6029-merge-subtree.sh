...
expecting success: 
	...
	git add hello &&
	git commit -m master
[master (root-commit) 802612e] initial
...
[master (root-commit) 5719719] initial git-gui
 Author: A U Thor <author@example.com>
 1 files changed, 1 insertions(+), 0 deletions(-)
...
[master (root-commit) 8add546] initial git
 Author: A U Thor <author@example.com>
 1 files changed, 1 insertions(+), 0 deletions(-)
...
Updating gui
[master 40e6253] Merge git-gui as our subdirectory
 Author: A U Thor <author@example.com>
...
expecting success: 
	...
	test_cmp expected actual
M	git-gui.sh
[master2 001e8f2] update git-gui
 Author: A U Thor <author@example.com>
 1 files changed, 1 insertions(+), 1 deletions(-)
Merging:
40e6253 Merge git-gui as our subdirectory
virtual 001e8f292d6bf2db7317c392bdba79dc465dd02c
found 1 common ancestor(s):
5719719 initial git-gui
Merge made by subtree.
...
expecting success: 
	...
	test_cmp expected actual
HEAD is now at 40e6253 Merge git-gui as our subdirectory
Already up-to-date.
[master2 a4fa6ca] Merge git-gui2 as our subdirectory
 Author: A U Thor <author@example.com>
 1 files changed, 1 insertions(+), 0 deletions(-)
...
HEAD is now at a4fa6ca Merge git-gui2 as our subdirectory
Merging:
a4fa6ca Merge git-gui2 as our subdirectory
virtual 001e8f292d6bf2db7317c392bdba79dc465dd02c
found 1 common ancestor(s):
5719719 initial git-gui

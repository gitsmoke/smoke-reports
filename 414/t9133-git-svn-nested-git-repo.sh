...
Initialized empty Git repository in /Users/trast/git-smoke/t/trash directory.t9133-git-svn-nested-git-repo/g/.git/
	A	a
r1 = ecb3e41fe217b459e293e5e03f71b41ea7597c91 (refs/remotes/git-svn)
r2 = 189f6074149d531b20ce6e5e5cd3b9ca5a6b0f4e (refs/remotes/git-svn)
...
expecting success: 
	...
	M	a
r3 = f4e3fa3983fa1d702330eaded19477df274c109e (refs/remotes/git-svn)
...
[master (root-commit) bceefb6] add a inside an SVN repo
 Author: A U Thor <author@example.com>
 1 files changed, 2 insertions(+), 0 deletions(-)
 create mode 100644 a
commit bceefb613a2a7ca38f733eed317a18d3b0c60098
Author: A U Thor <author@example.com>
Date:   Sun Jan 2 04:09:56 2011 +0000
...
A         .git/objects/bc
A         .git/objects/bc/eefb613a2a7ca38f733eed317a18d3b0c60098
...
Adding         .git/objects/bc
Adding         .git/objects/bc/eefb613a2a7ca38f733eed317a18d3b0c60098
...
r4 = aedf1720419ad0ef977199d3b84325ee621a97d2 (refs/remotes/git-svn)
First, rewinding head to replay your work on top of it...
Fast-forwarded master to refs/remotes/git-svn.
...
[master 0d81114] add a inside an SVN repo
 Author: A U Thor <author@example.com>
...
expecting success: 
	...
	M	a
r5 = e2e1120126093915a97d924109ae450c07cb34c6 (refs/remotes/git-svn)
First, rewinding head to replay your work on top of it...
Fast-forwarded master to refs/remotes/git-svn.

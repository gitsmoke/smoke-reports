...
Committed revision 1.
	A	foo
r1 = b20c1d3063c052c0976e8eb1b02ba4e3d9d9a0b1 (refs/remotes/git-svn)
...
[master ab050cb] files for enabled auto-props
...
Committed r2
	...
	A	bar
	A	exec1.sh
r2 = c16157bd682f56053ee42157d901e77fe4e4545a (refs/remotes/git-svn)
...
[master be01235] files for disabled auto-props
 Author: A U Thor <author@example.com>
 3 files changed, 3 insertions(+), 0 deletions(-)
...
Committed r3
	...
	A	world.txt
	A	zot
r3 = 111490324e1683d8bba025d5983e9d7f64619f3e (refs/remotes/git-svn)
No changes between current HEAD and refs/remotes/git-svn
Resetting to the latest refs/remotes/git-svn
...
Committed r4
	D	foo
	A	foo.sh
r4 = e5708f2f7c67b04fe46f957a15dcdf9c5dbb507d (refs/remotes/git-svn)
No changes between current HEAD and refs/remotes/git-svn
Resetting to the latest refs/remotes/git-svn
D    foo
A    foo.sh

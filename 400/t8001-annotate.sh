...
[master (root-commit) beb9e04] Initial.
 Author: A <A@test.git>
...
Merging:
21b9815 Branch2-1
virtual 43239dda9546d5727f9302b6f3cfb5790769cb6e
...
expecting success: echo "evil merge." >>file &&
     git commit -a --amend
[branch2 2ed641e] Merge branch 'branch1' into branch2

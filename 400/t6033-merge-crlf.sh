...
expecting success: 
	...
	git tag b &&
	git checkout master
[master (root-commit) 57d2827] Initial
 Author: A U Thor <author@example.com>
 1 files changed, 1 insertions(+), 0 deletions(-)
 create mode 100644 file
[master 687878e] add line from a
 Author: A U Thor <author@example.com>
 1 files changed, 1 insertions(+), 1 deletions(-)
[side 7d8b53c] add line from b
 Author: A U Thor <author@example.com>
 1 files changed, 1 insertions(+), 1 deletions(-)
...
HEAD is now at 57d2827 Initial
Merge made by ours.
...
HEAD is now at 687878e add line from a
Merging:
687878e add line from a
virtual side

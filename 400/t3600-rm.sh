...
[master (root-commit) f4005e0] add normal files
...
[master 2f1578c] add files with tabs and newlines
 Author: A U Thor <author@example.com>
 0 files changed, 0 insertions(+), 0 deletions(-)
...
[master adaefdd] add file for rm test
 Author: A U Thor <author@example.com>
...
[master d5cdfc4] remove file from rm test
 Author: A U Thor <author@example.com>
...
[master b0a2f80] add file for rm --quiet test
 Author: A U Thor <author@example.com>
 1 files changed, 1 insertions(+), 0 deletions(-)
 create mode 100644 test-file
[master b9293c7] remove file from rm --quiet test
 Author: A U Thor <author@example.com>
 1 files changed, 0 insertions(+), 1 deletions(-)
 delete mode 100644 test-file
...
[master (root-commit) 4487195] add a file
 Author: A U Thor <author@example.com>
 1 files changed, 1 insertions(+), 0 deletions(-)
...
HEAD is now at 99bd0a9 subdir test
rm 'frotz/nitfol'

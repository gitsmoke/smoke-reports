...
[master (root-commit) fbe0a27] initial
...
[master 978a810] master removes file2 and subdir/file2
 Author: A U Thor <author@example.com>
...
D	file2
D	subdir/file2
[side 8b1845e] side adds file3 and removes file2
 Author: A U Thor <author@example.com>
...
HEAD is now at 978a810 master removes file2 and subdir/file2
...
expecting success: 
	...
	git checkout side-a
HEAD is now at 978a810 master removes file2 and subdir/file2
[side-a 5a1022b] side-a changes file1
 Author: A U Thor <author@example.com>
 1 files changed, 1 insertions(+), 0 deletions(-)
[side-b fad89e5] side-b changes file2
 Author: A U Thor <author@example.com>
 1 files changed, 1 insertions(+), 0 deletions(-)
...
HEAD is now at 5a1022b side-a changes file1
...
HEAD is now at 5a1022b side-a changes file1
[sym-b 1cb5c3d] side adds a/b
 Author: A U Thor <author@example.com>
 0 files changed, 0 insertions(+), 0 deletions(-)
 create mode 100644 a/b
[sym-a 9d72195] we add a/b
 Author: A U Thor <author@example.com>
 1 files changed, 1 insertions(+), 0 deletions(-)
...
HEAD is now at 9d72195 we add a/b
...
HEAD is now at 9d72195 we add a/b
[side-a b8b98e0] side-a changes file2 to directory
 Author: A U Thor <author@example.com>
...
HEAD is now at fad89e5 side-b changes file2
Trying simple merge.
...
Merging:
fad89e5 side-b changes file2
b8b98e0 side-a changes file2 to directory

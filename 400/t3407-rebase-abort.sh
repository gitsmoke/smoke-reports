...
[master 0f35002] c
 Author: A U Thor <author@example.com>
 1 files changed, 1 insertions(+), 1 deletions(-)
[to-rebase c217d2e] merge should fail on this
 Author: A U Thor <author@example.com>
 1 files changed, 1 insertions(+), 1 deletions(-)
[to-rebase abb98a8] merge should fail on this, too
 Author: A U Thor <author@example.com>
 1 files changed, 1 insertions(+), 1 deletions(-)
...
HEAD is now at abb98a8 merge should fail on this, too
...
Merging HEAD with merge should fail on this, too
Merging:
49e0688 merge should fail on this
virtual merge should fail on this, too
found 1 common ancestor(s):
virtual f788de73cfc81f8d734fa7efc658cc63ca083f50
Auto-merging a
...
Merging:
0f35002 c
c217d2e merge should fail on this
found 1 common ancestor(s):
9441dee a
Auto-merging a
CONFLICT (content): Merge conflict in a
...
Merging:
0f35002 c
abb98a8 merge should fail on this, too
found 1 common ancestor(s):
c217d2e merge should fail on this
Auto-merging a
CONFLICT (content): Merge conflict in a
...
Auto-merging a
CONFLICT (content): Merge conflict in a
[detached HEAD 535c1f3] merge should fail on this
 Author: A U Thor <author@example.com>
 1 files changed, 1 insertions(+), 0 deletions(-)
Committed: 0001 merge should fail on this
Merging master with HEAD~0
Merging:
535c1f3 merge should fail on this
abb98a8 merge should fail on this, too
found 1 common ancestor(s):
c217d2e merge should fail on this
Auto-merging a

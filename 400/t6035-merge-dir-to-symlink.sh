...
HEAD is now at 5d41aa9 dir to symlink
rm 'a/b'
[detached HEAD 1cf81a5] untracked symlink remains
 Author: A U Thor <author@example.com>
...
HEAD is now at ce4a712 base
[detached HEAD ddb25ab] x
 Author: A U Thor <author@example.com>
 1 files changed, 1 insertions(+), 0 deletions(-)
...
HEAD is now at 1506f48 Merge branch 'master' into HEAD
Merging:
ddb25ab x
virtual master
...
expecting success: 
	...
	test -h a/b &&
	test -f a/b-2/c/d
HEAD is now at e2d0224 Merge branch 'master' into HEAD
Trying really trivial in-index merge...
Nope.
Trying simple merge.
Simple merge failed, trying Automatic merge.
...
expecting success: 
	...
	test -h a/b &&
	test -f a/b-2/c/d
HEAD is now at ebf7d2b Merge commit 'baseline^0' into HEAD
Merging:
5d41aa9 dir to symlink
virtual baseline^0
found 1 common ancestor(s):
ce4a712 base
...
expecting success: 
	...
	test -f a/b/c/e &&
	test -f a/b-2/c/d
HEAD is now at f3d72e2 Merge branch 'master' into HEAD
Merging:
ddb25ab x
virtual master
found 1 common ancestor(s):
...
expecting success: 
	...
	git tag test2
HEAD is now at ddb25ab x
[detached HEAD 4684b76] dir a/b-2 to symlink
 Author: A U Thor <author@example.com>
...
expecting success: 
	...
	test -h a/b-2 &&
	test -f a/b/c/d
HEAD is now at 4684b76 dir a/b-2 to symlink
Trying really trivial in-index merge...
Nope.
Trying simple merge.
Simple merge failed, trying Automatic merge.
...
HEAD is now at 6a9493b Merge commit 'test2' into HEAD
Merging:
ddb25ab x
virtual test2
found 1 common ancestor(s):

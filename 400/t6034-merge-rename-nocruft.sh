...
git checkout master
[master (root-commit) dfc7a16] initial has A and M
 Author: A U Thor <author@example.com>
 2 files changed, 30 insertions(+), 0 deletions(-)
 create mode 100644 A
 create mode 100644 M
[white 1734d02] white renames A->B, M->N
 Author: A U Thor <author@example.com>
 2 files changed, 2 insertions(+), 2 deletions(-)
 rename A => B (93%)
 rename M => N (93%)
[red da2bd25] red creates R
 Author: A U Thor <author@example.com>
 1 files changed, 1 insertions(+), 0 deletions(-)
 create mode 100644 R
[blue 0811009] blue modify A
 Author: A U Thor <author@example.com>
...
Merging:
da2bd25 red creates R
virtual white
found 1 common ancestor(s):
dfc7a16 initial has A and M
Auto-merging B
Auto-merging N

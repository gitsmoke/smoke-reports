...
r1 = 9caec7be1edcc6d8ebc36df8946cff0f94eccae5 (refs/remotes/git-svn)
...
[test-rmdir c5f3d6b] remove another
 ...
 delete mode 100644 deeply/nested/directory/number/2/another
	...
	D	deeply/nested/directory/number/2/another
	D	deeply/nested/directory/number/2/
r2 = 4ca5c41c50dc07d3687a4e8da0241de3b2d90822 (refs/remotes/git-svn)

...
[master (root-commit) 25f0d2f] first commit
 Author: A U Thor <author@example.com>
 1 files changed, 1 insertions(+), 0 deletions(-)
 create mode 100644 foo
[master 4d955eb] second commit
 Author: A U Thor <author@example.com>
 1 files changed, 1 insertions(+), 0 deletions(-)
 create mode 100644 bar
[master 0e52fe2] third commit
 Author: A U Thor <author@example.com>
 1 files changed, 1 insertions(+), 0 deletions(-)
 create mode 100644 baz
[master 8e82da0] fourth commit
 Author: A U Thor <author@example.com>
 1 files changed, 1 insertions(+), 0 deletions(-)
...
commit 25f0d2f4290656154dc1a8cac5c060bc70416c8b
Author: A U Thor <author@example.com>
Date:   Wed Dec 29 04:08:04 2010 +0000

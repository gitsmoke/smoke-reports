...
[master (root-commit) 3c8a2d0] Initial commit.
 Author: A U Thor <author@example.com>
 1 files changed, 1 insertions(+), 0 deletions(-)
 create mode 100644 A
[master 25f6cef] Second commit.
 Author: A U Thor <author@example.com>
 1 files changed, 1 insertions(+), 0 deletions(-)
...
expecting success: git branch l/m &&
        git branch -d l/m &&
        git branch l
Deleted branch l/m (was 25f6cef).
...
Deleted branch s/t (was 25f6cef).
...
Deleted branch my7 (was 25f6cef).
...
25f6cef03124c2662b65edc4c67dffb4dda2ad5d
...
Deleted branch my8 (was 25f6cef).

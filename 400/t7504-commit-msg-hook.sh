...
expecting success: 
	...
	git add file &&
	git commit -m "first"
[master (root-commit) 23b51e7] first
...
[master c757424] even more content
 Author: A U Thor <author@example.com>
 1 files changed, 1 insertions(+), 0 deletions(-)

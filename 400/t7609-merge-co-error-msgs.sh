...
expecting success: 
	...
	echo other >four &&
	echo other >five
[master (root-commit) a47b47a] First
 Author: A U Thor <author@example.com>
 1 files changed, 1 insertions(+), 0 deletions(-)
 create mode 100644 one
[branch b60d7fa] Second
 Author: A U Thor <author@example.com>
...
Updating a47b47a..b60d7fa
Aborting
[master e379015] empty
 Author: A U Thor <author@example.com>
Aborting
HEAD is now at a47b47a First
...
[master (root-commit) 09180a4] init
 Author: A U Thor <author@example.com>
...
rm 'rep/foo'
rm 'rep2/foo'
[branch 60a7bf7] added test as a file
 Author: A U Thor <author@example.com>

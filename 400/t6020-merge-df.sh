...
[master (root-commit) 1363c8c] initial
 Author: A U Thor <author@example.com>
 1 files changed, 1 insertions(+), 0 deletions(-)
 create mode 100644 init
[master 91590cb] File: dir/foo
 Author: A U Thor <author@example.com>
 1 files changed, 1 insertions(+), 0 deletions(-)
...
HEAD is now at ebe6838 File: dir
[master 1ee89a9] first
 Author: A U Thor <author@example.com>
...
rm 'dir~B'
rm 'init'
[modify (root-commit) a44b5d6] initial
 Author: A U Thor <author@example.com>
 1 files changed, 8 insertions(+), 0 deletions(-)
 create mode 100644 letters
[modify 2091f47] modified
 Author: A U Thor <author@example.com>
 1 files changed, 1 insertions(+), 0 deletions(-)
rm 'letters'
[delete 410235d] deleted
 Author: A U Thor <author@example.com>
...
HEAD is now at 410235d deleted

...
[master (root-commit) 730f0d6] Initial.
 Author: A <A@test.git>
...
Merging:
b0f1e4a Branch2-1
virtual bbf43a5b2539d7cb84610ad660073656073f1e07
...
expecting success: echo "evil merge." >>file &&
     git commit -a --amend
[branch2 41ca311] Merge branch 'branch1' into branch2

...
Committed revision 1.
	A	foo
r1 = eabf9f1c9ac4af1795c097ca1e6b6398cf30e265 (refs/remotes/git-svn)
...
[master b423761] files for enabled auto-props
...
Committed r2
	...
	A	bar
	A	exec1.sh
r2 = 4c5ff7262097e65018e78c7eb4461477a92f3681 (refs/remotes/git-svn)
...
[master 20b9006] files for disabled auto-props
 Author: A U Thor <author@example.com>
 3 files changed, 3 insertions(+), 0 deletions(-)
...
Committed r3
	...
	A	world.txt
	A	zot
r3 = 9266179e2d2f7d83125e8644dddd079f8b46faf6 (refs/remotes/git-svn)
No changes between current HEAD and refs/remotes/git-svn
Resetting to the latest refs/remotes/git-svn
...
Committed r4
	D	foo
	A	foo.sh
r4 = f465712c2fb72087fd0ed5d654d73242676e04bb (refs/remotes/git-svn)
No changes between current HEAD and refs/remotes/git-svn
Resetting to the latest refs/remotes/git-svn
D    foo
A    foo.sh

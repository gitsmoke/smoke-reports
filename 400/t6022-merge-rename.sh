...
git checkout master
[master (root-commit) a9f78d8] initial has A and M
 Author: A U Thor <author@example.com>
 2 files changed, 30 insertions(+), 0 deletions(-)
 create mode 100644 A
 create mode 100644 M
[master bef4054] master updates A
 Author: A U Thor <author@example.com>
 1 files changed, 1 insertions(+), 1 deletions(-)
[yellow d74d175] yellow removes M
 Author: A U Thor <author@example.com>
 1 files changed, 0 insertions(+), 15 deletions(-)
 delete mode 100644 M
[white 410b620] white renames A->B, M->N
 Author: A U Thor <author@example.com>
 2 files changed, 2 insertions(+), 2 deletions(-)
 rename A => B (93%)
 rename M => N (93%)
[red 6a54a9a] red renames A->B, M->N
 Author: A U Thor <author@example.com>
 2 files changed, 2 insertions(+), 2 deletions(-)
 rename A => B (93%)
 rename M => N (93%)
[blue 54e78ec] blue renames A->C, M->N
 Author: A U Thor <author@example.com>
 2 files changed, 2 insertions(+), 2 deletions(-)
 rename A => C (93%)
 rename M => N (93%)
...
Merging:
bef4054 master updates A
virtual 410b6207d187b0bdc59c9a9ec73609b2a08281ad
found 1 common ancestor(s):
a9f78d8 initial has A and M
Auto-merging B
...
expecting success: 
	...
	git diff --exit-code white N
HEAD is now at bef4054 master updates A
Merging:
6a54a9a red renames A->B, M->N
virtual 410b6207d187b0bdc59c9a9ec73609b2a08281ad
found 1 common ancestor(s):
a9f78d8 initial has A and M
Auto-merging B
...
expecting success: 
	...
	git diff --exit-code white N
HEAD is now at 6a54a9a red renames A->B, M->N
! [blue] blue renames A->C, M->N
 ! [change] changed
  ! [change+rename] changed and renamed
   ! [master] master updates A
...
Merging:
6a54a9a red renames A->B, M->N
virtual bef4054d2d6ec474412ea4722132314180aa187a
found 1 common ancestor(s):
a9f78d8 initial has A and M
Auto-merging B
CONFLICT (content): Merge conflict in B
...
Merging:
6a54a9a red renames A->B, M->N
virtual 54e78ec3612bbff82ad38ae45e08375c602111ac
found 1 common ancestor(s):
a9f78d8 initial has A and M
Skipped N (merged same as existing)
CONFLICT (rename/rename): Rename "A"->"B" in branch "HEAD" rename "A"->"C" in "54e78ec3612bbff82ad38ae45e08375c602111ac"
Automatic merge failed; fix conflicts and then commit the result.
g : red changes a line
...
+++++*+ [yellow^] initial has A and M
Merging:
410b620 white renames A->B, M->N
virtual 6a54a9a0169e4b243f6fe5b5035dfdf7fd624b9f
found 1 common ancestor(s):
a9f78d8 initial has A and M
Auto-merging B
CONFLICT (content): Merge conflict in B
...
HEAD is now at 410b620 white renames A->B, M->N
...
Merging:
bef4054 master updates A
virtual d74d175e34f918c5b7fc4747f3a0c6e12bed6ac1
found 1 common ancestor(s):
a9f78d8 initial has A and M
Removing M
...
HEAD is now at bef4054 master updates A
Updated tag 'anchor' (was bef4054)
! [blue] blue renames A->C, M->N
 ! [change] changed
  ! [change+rename] changed and renamed
   ! [master] master updates A
...
Merge made by recursive.
 A |    2 +-
 1 files changed, 1 insertions(+), 1 deletions(-)
HEAD is now at d74d175 yellow removes M
...
HEAD is now at f97ac68 changed and renamed
Skipped B (merged same as existing)
...
HEAD is now at dffe8d3 Merge branch 'change+rename' into change
rm 'B'
rm 'M'
[dir-in-way (root-commit) 278feb2] Common commmit
 Author: A U Thor <author@example.com>
...
[dir-in-way 4246776] Commit to merge, with dir in the way
 Author: A U Thor <author@example.com>
 2 files changed, 2 insertions(+), 0 deletions(-)
rm 'dir/file-in-the-way'
[dir-not-in-way fd97bfd] Commit to merge, with dir removed
 Author: A U Thor <author@example.com>
 2 files changed, 1 insertions(+), 1 deletions(-)
 delete mode 100644 dir/file-in-the-way
rm 'dir/file-in-the-way'
rm 'sub/file'
[renamed-file-has-no-conflicts 4f272e7] Independent change
 Author: A U Thor <author@example.com>
 2 files changed, 1 insertions(+), 2 deletions(-)
 rename sub/file => dir (79%)
 delete mode 100644 dir/file-in-the-way
rm 'dir/file-in-the-way'
[renamed-file-has-conflicts 380ace2] Conflicting change
 Author: A U Thor <author@example.com>
 2 files changed, 1 insertions(+), 1 deletions(-)
...
HEAD is now at 380ace2 Conflicting change
Merging:
4f272e7 Independent change
virtual dir-not-in-way
found 1 common ancestor(s):
278feb2 Common commmit
...
HEAD is now at bb88e0d Merge branch 'dir-not-in-way' into HEAD
...
HEAD is now at 4f272e7 Independent change
...
HEAD is now at 4246776 Commit to merge, with dir in the way
Merging:
380ace2 Conflicting change
virtual dir-not-in-way
found 1 common ancestor(s):
278feb2 Common commmit
Removing dir to make room for subdirectory; may re-add later.
...
HEAD is now at 380ace2 Conflicting change
Merging:
4246776 Commit to merge, with dir in the way
...
rm 'n.stages'
rm 'sub/file'
[rename-dest (root-commit) 345e3e6] Common commmit
 Author: A U Thor <author@example.com>
 1 files changed, 1 insertions(+), 0 deletions(-)
 create mode 100644 one/file
[rename-dest 4fb89c5] Renamed to destdir
 Author: A U Thor <author@example.com>
 1 files changed, 0 insertions(+), 0 deletions(-)
 rename one/file => destdir (100%)
rm 'one/file'
[source-conflict 45a42cd] Conflicts in the way
 Author: A U Thor <author@example.com>
...
HEAD is now at 45a42cd Conflicts in the way
Merging:
4fb89c5 Renamed to destdir
virtual source-conflict
found 1 common ancestor(s):
345e3e6 Common commmit
...
HEAD is now at 4fb89c5 Renamed to destdir
rm 'destdir'
[rename-two (root-commit) c23b7c3] Common commmit
 Author: A U Thor <author@example.com>
 2 files changed, 2 insertions(+), 0 deletions(-)
 create mode 100644 one/file
 create mode 100644 two/file
rm 'one/file'
[rename-two 568b709] Rename two/file -> one
 Author: A U Thor <author@example.com>
 2 files changed, 0 insertions(+), 1 deletions(-)
 rename two/file => one (100%)
 delete mode 100644 one/file
rm 'two/file'
[rename-one b1e6cc4] Rename one/file -> two
 Author: A U Thor <author@example.com>
 2 files changed, 0 insertions(+), 1 deletions(-)
...
Merging:
b1e6cc4 Rename one/file -> two
virtual rename-two
found 1 common ancestor(s):
c23b7c3 Common commmit
...
HEAD is now at b1e6cc4 Rename one/file -> two
Merging:
b1e6cc4 Rename one/file -> two
virtual rename-two
found 1 common ancestor(s):
...
HEAD is now at b1e6cc4 Rename one/file -> two
rm 'two'
[first-rename (root-commit) c96e62b] Common commmit
 Author: A U Thor <author@example.com>
 1 files changed, 1 insertions(+), 0 deletions(-)
 create mode 100644 original
[first-rename 5b49a59] Put two/file in the way, rename to one
 Author: A U Thor <author@example.com>
 1 files changed, 0 insertions(+), 0 deletions(-)
 rename original => one (100%)
 create mode 100644 two/file
[second-rename 1d6d50b] Put one/file in the way, rename to two
 Author: A U Thor <author@example.com>
 1 files changed, 0 insertions(+), 0 deletions(-)
 create mode 100644 one/file
...
expecting success: 
	...
	! test -f original
Merging:
5b49a59 Put two/file in the way, rename to one
virtual second-rename
found 1 common ancestor(s):
c96e62b Common commmit
...
HEAD is now at 5b49a59 Put two/file in the way, rename to one
rm 'one'
rm 'two/file'
[first-rename-redo (root-commit) 44d4aef] Common commmit
 Author: A U Thor <author@example.com>
 1 files changed, 1 insertions(+), 0 deletions(-)
 create mode 100644 one/file
 create mode 100644 original
 create mode 100644 two/file
rm 'one/file'
[first-rename-redo 7eaeae0] Rename to one
 Author: A U Thor <author@example.com>
 1 files changed, 0 insertions(+), 0 deletions(-)
 rename original => one (100%)
 delete mode 100644 one/file
rm 'two/file'
[second-rename-redo 833ac2e] Rename to two
 Author: A U Thor <author@example.com>
 1 files changed, 0 insertions(+), 0 deletions(-)
 rename original => two (100%)
 delete mode 100644 two/file
...
Merging:
7eaeae0 Rename to one
virtual second-rename-redo
found 1 common ancestor(s):
44d4aef Common commmit
Removing one to make room for subdirectory; may re-add later.
Removing two/file

...
[master (root-commit) 5b29026] A-initial
...
[master (root-commit) 28b0f1e] B-super-initial
 Author: A U Thor <author@example.com>
 1 files changed, 1 insertions(+), 0 deletions(-)
...
Cloning into sub
Submodule path 'sub': checked out '5b290264f5ffae4f4ef44999c4158eba1fad7c90'

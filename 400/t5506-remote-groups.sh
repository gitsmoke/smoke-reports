...
expecting success: 
	...
	repo_fetched one &&
	repo_fetched two
[master (root-commit) 3efd3e9] update-all
...
expecting success: 
	...
	repo_fetched one &&
	repo_fetched two
[master a3a61f6] fetch-group-all
 Author: A U Thor <author@example.com>
 1 files changed, 1 insertions(+), 0 deletions(-)
[master a3a61f6] fetch-group-all
 Author: A U Thor <author@example.com>
...
expecting success: 
	...
	repo_fetched one &&
	! repo_fetched two
[master 38b5abc] group-some
 Author: A U Thor <author@example.com>
 1 files changed, 1 insertions(+), 0 deletions(-)
[master 90c3c66] group-some
 Author: A U Thor <author@example.com>
 1 files changed, 1 insertions(+), 0 deletions(-)
Fetching one
...
expecting success: 
	...
	repo_fetched one &&
	! repo_fetched two
[master 8f6c218] fetch-group-some
 Author: A U Thor <author@example.com>
 1 files changed, 1 insertions(+), 0 deletions(-)
[master 8e68549] fetch-group-some
 Author: A U Thor <author@example.com>
 1 files changed, 1 insertions(+), 0 deletions(-)
Fetching one
Fetching one
...
[master cbec49a] remote-name
 Author: A U Thor <author@example.com>
 1 files changed, 1 insertions(+), 0 deletions(-)
[master cf57728] remote-name
 Author: A U Thor <author@example.com>
 1 files changed, 1 insertions(+), 0 deletions(-)
Fetching one

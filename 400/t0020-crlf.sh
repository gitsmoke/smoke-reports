...
expecting success: 
	...
	echo happy.
[master (root-commit) 5e827af] initial
...
expecting success: 
	...
	git reset --hard HEAD^
HEAD is now at 5e827af initial
...
[master c2bec28] Add .gitattributes
 Author: A U Thor <author@example.com>
...
[master 2603971] initial
 Author: A U Thor <author@example.com>
 1 files changed, 1 insertions(+), 0 deletions(-)
[master b0d8113] second
 Author: A U Thor <author@example.com>
...
[master f6e0249] alllf, allcrlf and mixed only
 Author: A U Thor <author@example.com>

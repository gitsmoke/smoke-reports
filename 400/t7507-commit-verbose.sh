...
[master (root-commit) f51aa1d] subject
...
[master de15a3f] This is an example commit message that contains a diff.
 Author: A U Thor <author@example.com>
 1 files changed, 1 insertions(+), 1 deletions(-)
...
[master cf42728] This is an example commit message that contains a diff.
 Author: A U Thor <author@example.com>
 1 files changed, 1 insertions(+), 1 deletions(-)
--- diff	2010-12-29 04:08:44.000000000 +0000
+++ actual	2010-12-29 04:08:44.000000000 +0000
@@ -1,9 +1,2 @@

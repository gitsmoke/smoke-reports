...
Initialized empty Git repository in /Users/trast/git-smoke/t/trash directory.t9134-git-svn-ignore-paths/g/.git/
	A	qqq/test_qqq.txt
r1 = 90a6a77ec62f3e58a844880cd25628f27132d194 (refs/remotes/git-svn)
r2 = bd7e5bbdaef7254b5cd9c9a90280ab609822ebbc (refs/remotes/git-svn)
...
" > expect &&
	...
	M	qqq/test_qqq.txt
r3 = 4f86deb87f5f38bef323e7a3a26b82ba22024258 (refs/remotes/git-svn)
...
r4 = 86ac0d8967d5d81e87b663da0021c45132a5f5bc (refs/remotes/git-svn)
First, rewinding head to replay your work on top of it...
Fast-forwarded master to refs/remotes/git-svn.
...
" > expect &&
	...
	M	qqq/test_qqq.txt
r5 = 41de9a1fd7fc47f6e27886aca11e122101ec0bd7 (refs/remotes/git-svn)
First, rewinding head to replay your work on top of it...
Fast-forwarded master to refs/remotes/git-svn.

...
[master (root-commit) 9a8969f] commit
...
Unstaged changes after reset:
M	file
[master 5a4dad7] commit
 Author: A U Thor <author@example.com>
 1 files changed, 1 insertions(+), 1 deletions(-)
HEAD is now at 9a8969f commit
...
expecting success: 
	...
	test_cmp expected diff
[master 089cf54] clear local changes
 Author: A U Thor <author@example.com>
 1 files changed, 1 insertions(+), 0 deletions(-)
...
HEAD is now at 089cf54 clear local changes
[master af8ec42] non-empty
 Author: A U Thor <author@example.com>
 1 files changed, 1 insertions(+), 0 deletions(-)
...
HEAD is now at af8ec42 non-empty
[master eb73894] empty
 Author: A U Thor <author@example.com>

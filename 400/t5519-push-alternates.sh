...
[master (root-commit) 9cbc17b] initial
...
Updating 9cbc17b..f39d666
Fast-forward
 file |    1 +
 1 files changed, 1 insertions(+), 0 deletions(-)
[master 857aa9a] third
 Author: A U Thor <author@example.com>
...
[master 1b86f10] sixth.1
 Author: A U Thor <author@example.com>
 1 files changed, 1 insertions(+), 1 deletions(-)
[master 1251a3e] sixth.2
 Author: A U Thor <author@example.com>
 1 files changed, 1 insertions(+), 0 deletions(-)
[master ddf6347] sixth.3
 Author: A U Thor <author@example.com>
 1 files changed, 1 insertions(+), 0 deletions(-)
...
ddf6347dedbb600cc422f1c0726665013c680705
[master e33a57d] seventh
 Author: A U Thor <author@example.com>
 1 files changed, 1 insertions(+), 1 deletions(-)

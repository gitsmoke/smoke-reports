...
[master (root-commit) 2f5625b] initial
...
[other 0f0eea4] changesimplefile
 Author: A U Thor <author@example.com>
 1 files changed, 1 insertions(+), 0 deletions(-)
rm 'sub1'
[main 49b2b25] changefiletodir
 Author: A U Thor <author@example.com>

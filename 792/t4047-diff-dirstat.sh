...
ok 37 - --dirstat=future_param,lines,0 should fail loudly
ok 38 - diff.dirstat=future_param,0,lines should warn, but still work
ok 39 - various ways to misspell --dirstat

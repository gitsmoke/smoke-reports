...
ok 54 # skip trying to verify an annotated non-signed tag should fail
ok 55 # skip trying to verify a file-annotated non-signed tag should fail
ok 56 # skip trying to verify two annotated non-signed tags should fail
ok 57 # skip creating a signed tag with -m message should succeed
ok 58 # skip sign with a given key id
ok 59 # skip sign with an unknown id (1)
ok 60 # skip sign with an unknown id (2)
ok 61 # skip -u implies signed tag
ok 62 # skip creating a signed tag with -F messagefile should succeed
ok 63 # skip creating a signed tag with -F - should succeed
ok 64 # skip -s implies annotated tag
ok 65 # skip trying to create a signed tag with non-existing -F file should fail
ok 66 # skip verifying a signed tag should succeed
ok 67 # skip verifying two signed tags in one command should succeed
ok 68 # skip verifying many signed and non-signed tags should fail
ok 69 # skip verifying a forged tag should fail
ok 70 # skip creating a signed tag with an empty -m message should succeed
ok 71 # skip creating a signed tag with an empty -F messagefile should succeed
ok 72 # skip extra blanks in the message for a signed tag should be removed
ok 73 # skip creating a signed tag with a blank -m message should succeed
ok 74 # skip creating a signed tag with blank -F file with spaces should succeed
ok 75 # skip creating a signed tag with spaces and no newline should succeed
ok 76 # skip creating a signed tag with a -F file with #comments should succeed
ok 77 # skip creating a signed tag with #commented -m message should succeed
ok 78 # skip creating a signed tag with #commented -F messagefile should succeed
ok 79 # skip creating a signed tag with a #comment and no newline should succeed
ok 80 # skip listing the one-line message of a signed tag should succeed
ok 81 # skip listing the zero-lines message of a signed tag should succeed
ok 82 # skip listing many message lines of a signed tag should succeed
ok 83 # skip creating a signed tag pointing to a tree should succeed
ok 84 # skip creating a signed tag pointing to a blob should succeed
ok 85 # skip creating a signed tag pointing to another tag should succeed
ok 86 # skip git tag -s fails if gpg is misconfigured
ok 87 # skip verify signed tag fails when public key is not present

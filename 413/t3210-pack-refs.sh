...
[master (root-commit) 0ef3f23] Initial commit.
...
expecting success: git branch g/h &&
     ...
     git pack-refs --all &&
     git branch -d g
Deleted branch g/h (was 0ef3f23).
Deleted branch g (was 0ef3f23).
...
expecting success: git branch k/l &&
     ...
     git branch -d k/lm &&
     git branch k
Deleted branch k/l (was 0ef3f23).
Deleted branch k/l/m (was 0ef3f23).
Deleted branch k/lm (was 0ef3f23).
...
expecting success: git branch n/o &&
     ...
     git branch -d n/o/p &&
     git branch n
Deleted branch n/o (was 0ef3f23).
Deleted branch n/op (was 0ef3f23).
Deleted branch n/o/p (was 0ef3f23).

...
[master (root-commit) 9a46154] initial
...
[master f9058f5] master removes file2 and subdir/file2
 Author: A U Thor <author@example.com>
...
D	file2
D	subdir/file2
[side 93e3e69] side adds file3 and removes file2
 Author: A U Thor <author@example.com>
...
HEAD is now at f9058f5 master removes file2 and subdir/file2
...
expecting success: 
	...
	git checkout side-a
HEAD is now at f9058f5 master removes file2 and subdir/file2
[side-a 71c1e3c] side-a changes file1
 Author: A U Thor <author@example.com>
 1 files changed, 1 insertions(+), 0 deletions(-)
[side-b 1cbdd08] side-b changes file2
 Author: A U Thor <author@example.com>
 1 files changed, 1 insertions(+), 0 deletions(-)
...
HEAD is now at 71c1e3c side-a changes file1
...
HEAD is now at 71c1e3c side-a changes file1
[sym-b 2255145] side adds a/b
 Author: A U Thor <author@example.com>
 0 files changed, 0 insertions(+), 0 deletions(-)
 create mode 100644 a/b
[sym-a 1c1ced2] we add a/b
 Author: A U Thor <author@example.com>
 1 files changed, 1 insertions(+), 0 deletions(-)
...
HEAD is now at 1c1ced2 we add a/b
...
HEAD is now at 1c1ced2 we add a/b
[side-a 02f3fe2] side-a changes file2 to directory
 Author: A U Thor <author@example.com>
...
HEAD is now at 1cbdd08 side-b changes file2
Trying simple merge.
...
Merging:
1cbdd08 side-b changes file2
02f3fe2 side-a changes file2 to directory

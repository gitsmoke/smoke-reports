...
expecting success: echo "Not an empty file." > file &&
	 ...
	 git branch b
[master (root-commit) fb4de4c] Initial commit.
...
expecting success: rm renamed_file &&
	 ...
	 gitweb_run "p=.git;a=commitdiff"
[master 2ef1cd3] File to symlink.
 Author: A U Thor <author@example.com>
...
expecting success: echo "New line" >> file2 &&
	 ...
	 gitweb_run "p=.git;a=commitdiff"
[master 6814c48] Mode change and modification.
 Author: A U Thor <author@example.com>
 1 files changed, 1 insertions(+), 0 deletions(-)
...
EOF
	 ...
	 gitweb_run "p=.git;a=commitdiff"
[master e669414] File added.
 Author: A U Thor <author@example.com>
 1 files changed, 7 insertions(+), 2 deletions(-)
[master 8b918ba] File rename and modification.
 Author: A U Thor <author@example.com>
 1 files changed, 1 insertions(+), 0 deletions(-)
...
expecting success: git mv file3 file2 &&
	 ...
	 gitweb_run "p=.git;a=commitdiff"
[master 89bfd43] File rename, mode change and modification.
 Author: A U Thor <author@example.com>
 1 files changed, 1 insertions(+), 0 deletions(-)
...
[master 2bcc96a] initial
 Author: A U Thor <author@example.com>
 2 files changed, 2 insertions(+), 0 deletions(-)
 create mode 100644 bar
 create mode 100644 foo
[master f13838a] foo symlinked to bar
 Author: A U Thor <author@example.com>
 1 files changed, 1 insertions(+), 1 deletions(-)
 rewrite foo (100%)
 mode change 100644 => 120000
[master d9bbcc9] foo back to file
 Author: A U Thor <author@example.com>
 1 files changed, 1 insertions(+), 1 deletions(-)
 rewrite foo (100%)
 mode change 120000 => 100644
[master 6d10d5e] foo becomes a directory
 Author: A U Thor <author@example.com>
 2 files changed, 1 insertions(+), 1 deletions(-)
 delete mode 100644 foo
 create mode 100644 foo/baz
[master 529b6ee] foo/baz is the original foo
 Author: A U Thor <author@example.com>
 1 files changed, 1 insertions(+), 1 deletions(-)
...
Merging:
529b6ee foo/baz is the original foo
virtual 1d3cdce5e0af05deaaebe03fd6a016d910f89c30
found 1 common ancestor(s):
fb4de4c Initial commit.
...
expecting success: git checkout b &&
	 ...
	 git checkout master
[b 24185f5] Prepare large commit
 Author: A U Thor <author@example.com>
...
[master 2e7c136] Add file to be deleted
 Author: A U Thor <author@example.com>
 1 files changed, 1 insertions(+), 0 deletions(-)
 create mode 100644 deleted_file
rm 'deleted_file'
[master 7c4c032] Delete file
 Author: A U Thor <author@example.com>
 1 files changed, 0 insertions(+), 1 deletions(-)

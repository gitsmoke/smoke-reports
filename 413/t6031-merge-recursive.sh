...
[master (root-commit) 73b447c] initial
...
[other 296337c] changesimplefile
 Author: A U Thor <author@example.com>
 1 files changed, 1 insertions(+), 0 deletions(-)
rm 'sub1'
[main 7b572a7] changefiletodir
 Author: A U Thor <author@example.com>

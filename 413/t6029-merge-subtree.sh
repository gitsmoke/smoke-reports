...
expecting success: 
	...
	git add hello &&
	git commit -m master
[master (root-commit) 8bdcead] initial
...
[master (root-commit) 4bf86ff] initial git-gui
 Author: A U Thor <author@example.com>
 1 files changed, 1 insertions(+), 0 deletions(-)
...
[master (root-commit) 533b524] initial git
 Author: A U Thor <author@example.com>
 1 files changed, 1 insertions(+), 0 deletions(-)
...
Updating gui
[master d0b4b49] Merge git-gui as our subdirectory
 Author: A U Thor <author@example.com>
ok 4 - initial merge
...
expecting success: 
	...
	test_cmp expected actual
M	git-gui.sh
[master2 c8b6eca] update git-gui
 Author: A U Thor <author@example.com>
 1 files changed, 1 insertions(+), 1 deletions(-)
Merging:
d0b4b49 Merge git-gui as our subdirectory
virtual c8b6eca3aafbdf99dcff86c673d57f5cee92dc5f
found 1 common ancestor(s):
4bf86ff initial git-gui
Merge made by subtree.
...
expecting success: 
	...
	test_cmp expected actual
HEAD is now at d0b4b49 Merge git-gui as our subdirectory
Already up-to-date.
[master2 1dd79ad] Merge git-gui2 as our subdirectory
 Author: A U Thor <author@example.com>
 1 files changed, 1 insertions(+), 0 deletions(-)
...
expecting success: 
	...
	test_cmp expected actual
HEAD is now at 1dd79ad Merge git-gui2 as our subdirectory
Merging:
1dd79ad Merge git-gui2 as our subdirectory
virtual c8b6eca3aafbdf99dcff86c673d57f5cee92dc5f
found 1 common ancestor(s):
4bf86ff initial git-gui

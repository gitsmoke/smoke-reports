...
[master (root-commit) e389b06] A-initial
...
[master (root-commit) 64a5490] B-super-initial
 Author: A U Thor <author@example.com>
 1 files changed, 1 insertions(+), 0 deletions(-)
...
Cloning into sub...
Submodule path 'sub': checked out 'e389b0618f33a534607636ea4729684fc1047dc9'

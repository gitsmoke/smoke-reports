...
Initialized empty Git repository in /Users/trast/git-smoke/t/trash directory.t9103-git-svn-tracked-directory-removed/x/.git/
	A	README
r1 = ea84f709bbd97ba43ffbe0efb828cb28b4eaf80f (refs/remotes/trunk)
	D	README
	A	FOLLOWME
r3 = 93d22602fa16201c7883d17cd18a9d46b53cb9a8 (refs/remotes/trunk)
...
HEAD is now at ea84f70 initial

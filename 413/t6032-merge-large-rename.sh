...
expecting success: 
	...
	git tag initial
[master (root-commit) b9b74ff] initial
...
HEAD is now at b9b74ff initial
[master a589bf7] add=5
 Author: A U Thor <author@example.com>
...
Deleted branch test5 (was 8f76a61).
HEAD is now at b9b74ff initial
[master e66e657] add=5
 Author: A U Thor <author@example.com>
 5 files changed, 110 insertions(+), 0 deletions(-)
 create mode 100644 1
 create mode 100644 2
...
Deleted branch test5 (was b1a9751).
HEAD is now at b9b74ff initial
[master e66e657] add=5
 Author: A U Thor <author@example.com>
 5 files changed, 110 insertions(+), 0 deletions(-)
...
[simple-change 423126a] unrelated-change
 Author: A U Thor <author@example.com>
 0 files changed, 0 insertions(+), 0 deletions(-)

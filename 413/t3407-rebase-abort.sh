...
[master ec45af9] c
 Author: A U Thor <author@example.com>
 1 files changed, 1 insertions(+), 1 deletions(-)
[to-rebase b6d50be] merge should fail on this
 Author: A U Thor <author@example.com>
 1 files changed, 1 insertions(+), 1 deletions(-)
[to-rebase 0000989] merge should fail on this, too
 Author: A U Thor <author@example.com>
 1 files changed, 1 insertions(+), 1 deletions(-)
...
HEAD is now at 0000989 merge should fail on this, too
...
Merging HEAD with merge should fail on this, too
Merging:
1a23f95 merge should fail on this
virtual merge should fail on this, too
found 1 common ancestor(s):
virtual f788de73cfc81f8d734fa7efc658cc63ca083f50
Auto-merging a
...
Merging:
ec45af9 c
b6d50be merge should fail on this
found 1 common ancestor(s):
edc8293 a
Auto-merging a
CONFLICT (content): Merge conflict in a
...
Merging:
ec45af9 c
0000989 merge should fail on this, too
found 1 common ancestor(s):
b6d50be merge should fail on this
Auto-merging a
CONFLICT (content): Merge conflict in a
...
Auto-merging a
CONFLICT (content): Merge conflict in a
[detached HEAD fd6a7e6] merge should fail on this
 Author: A U Thor <author@example.com>
 1 files changed, 1 insertions(+), 0 deletions(-)
Committed: 0001 merge should fail on this
Merging master with HEAD~0
Merging:
fd6a7e6 merge should fail on this
0000989 merge should fail on this, too
found 1 common ancestor(s):
b6d50be merge should fail on this
Auto-merging a

...
expecting success: 
	...
	repo_fetched one &&
	repo_fetched two
[master (root-commit) 01d76d1] update-all
...
[master 72fed0d] fetch-group-all
 Author: A U Thor <author@example.com>
 1 files changed, 1 insertions(+), 0 deletions(-)
[master 72fed0d] fetch-group-all
 Author: A U Thor <author@example.com>
...
[master dc52d96] fetch-group-some
 Author: A U Thor <author@example.com>
 1 files changed, 1 insertions(+), 0 deletions(-)
[master dc52d96] fetch-group-some
 Author: A U Thor <author@example.com>

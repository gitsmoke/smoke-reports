...
git checkout master
[master (root-commit) b49944f] initial has A and M
 Author: A U Thor <author@example.com>
 2 files changed, 30 insertions(+), 0 deletions(-)
 create mode 100644 A
 create mode 100644 M
[master 4117f89] master updates A
 Author: A U Thor <author@example.com>
 1 files changed, 1 insertions(+), 1 deletions(-)
[yellow b0c22ee] yellow removes M
 Author: A U Thor <author@example.com>
 1 files changed, 0 insertions(+), 15 deletions(-)
 delete mode 100644 M
[white 3a54401] white renames A->B, M->N
 Author: A U Thor <author@example.com>
 2 files changed, 2 insertions(+), 2 deletions(-)
 rename A => B (93%)
 rename M => N (93%)
[red fb6b25e] red renames A->B, M->N
 Author: A U Thor <author@example.com>
 2 files changed, 2 insertions(+), 2 deletions(-)
 rename A => B (93%)
 rename M => N (93%)
[blue b45f6c9] blue renames A->C, M->N
 Author: A U Thor <author@example.com>
 2 files changed, 2 insertions(+), 2 deletions(-)
 rename A => C (93%)
 rename M => N (93%)
...
Merging:
4117f89 master updates A
virtual 3a54401b4f4b12b365c3801b25c28195eb8a2beb
found 1 common ancestor(s):
b49944f initial has A and M
Auto-merging B
...
expecting success: 
	...
	git diff --exit-code white N
HEAD is now at 4117f89 master updates A
Merging:
fb6b25e red renames A->B, M->N
virtual 3a54401b4f4b12b365c3801b25c28195eb8a2beb
found 1 common ancestor(s):
b49944f initial has A and M
Auto-merging B
...
expecting success: 
	...
	git diff --exit-code white N
HEAD is now at fb6b25e red renames A->B, M->N
! [blue] blue renames A->C, M->N
 ! [change] changed
  ! [change+rename] changed and renamed
   ! [master] master updates A
...
Merging:
fb6b25e red renames A->B, M->N
virtual 4117f893bf155b24561d5b4014d7399fb0b5b6b9
found 1 common ancestor(s):
b49944f initial has A and M
Auto-merging B
CONFLICT (content): Merge conflict in B
...
Merging:
fb6b25e red renames A->B, M->N
virtual b45f6c916495b0583c13b8bc0792ba4f961356b2
found 1 common ancestor(s):
b49944f initial has A and M
Skipped N (merged same as existing)
CONFLICT (rename/rename): Rename "A"->"B" in branch "HEAD" rename "A"->"C" in "b45f6c916495b0583c13b8bc0792ba4f961356b2"
Automatic merge failed; fix conflicts and then commit the result.
g : red changes a line
...
+++++*+ [yellow^] initial has A and M
Merging:
3a54401 white renames A->B, M->N
virtual fb6b25eb2429ca0d1ca4b447f79b8b6985771dcf
found 1 common ancestor(s):
b49944f initial has A and M
Auto-merging B
CONFLICT (content): Merge conflict in B
...
HEAD is now at 3a54401 white renames A->B, M->N
...
Merging:
4117f89 master updates A
virtual b0c22eeeef462f2460ac22898bf889750908c87f
found 1 common ancestor(s):
b49944f initial has A and M
Removing M
...
expecting success: 
	...
	git reset --hard anchor
HEAD is now at 4117f89 master updates A
Updated tag 'anchor' (was 4117f89)
! [blue] blue renames A->C, M->N
 ! [change] changed
  ! [change+rename] changed and renamed
   ! [master] master updates A
...
Merge made by recursive.
 A |    2 +-
 1 files changed, 1 insertions(+), 1 deletions(-)
HEAD is now at b0c22ee yellow removes M
...
HEAD is now at a442e00 changed and renamed
Skipped B (merged same as existing)
...
HEAD is now at 349c8b1 Merge branch 'change+rename' into change
rm 'B'
rm 'M'
[dir-in-way (root-commit) 4ecf902] Common commmit
 Author: A U Thor <author@example.com>
...
[dir-in-way 4ef684e] Commit to merge, with dir in the way
 Author: A U Thor <author@example.com>
 2 files changed, 2 insertions(+), 0 deletions(-)
rm 'dir/file-in-the-way'
[dir-not-in-way 5781cb8] Commit to merge, with dir removed
 Author: A U Thor <author@example.com>
 2 files changed, 1 insertions(+), 1 deletions(-)
 delete mode 100644 dir/file-in-the-way
rm 'dir/file-in-the-way'
rm 'sub/file'
[renamed-file-has-no-conflicts dcf120b] Independent change
 Author: A U Thor <author@example.com>
 2 files changed, 1 insertions(+), 2 deletions(-)
 rename sub/file => dir (79%)
 delete mode 100644 dir/file-in-the-way
rm 'dir/file-in-the-way'
[renamed-file-has-conflicts 4882c6b] Conflicting change
 Author: A U Thor <author@example.com>
 2 files changed, 1 insertions(+), 1 deletions(-)
...
HEAD is now at 4882c6b Conflicting change
Merging:
dcf120b Independent change
virtual dir-not-in-way
found 1 common ancestor(s):
4ecf902 Common commmit
...
HEAD is now at dccda5c Merge branch 'dir-not-in-way' into HEAD
...
HEAD is now at dcf120b Independent change
...
HEAD is now at 4ef684e Commit to merge, with dir in the way
Merging:
4882c6b Conflicting change
virtual dir-not-in-way
found 1 common ancestor(s):
4ecf902 Common commmit
Removing dir to make room for subdirectory; may re-add later.
...
HEAD is now at 4882c6b Conflicting change
Merging:
4ef684e Commit to merge, with dir in the way
...
rm 'n.stages'
rm 'sub/file'
[rename-dest (root-commit) a7d2c28] Common commmit
 Author: A U Thor <author@example.com>
 1 files changed, 1 insertions(+), 0 deletions(-)
 create mode 100644 one/file
[rename-dest 5ad15c0] Renamed to destdir
 Author: A U Thor <author@example.com>
 1 files changed, 0 insertions(+), 0 deletions(-)
 rename one/file => destdir (100%)
rm 'one/file'
[source-conflict c5c2e2c] Conflicts in the way
 Author: A U Thor <author@example.com>
...
HEAD is now at c5c2e2c Conflicts in the way
Merging:
5ad15c0 Renamed to destdir
virtual source-conflict
found 1 common ancestor(s):
a7d2c28 Common commmit
...
HEAD is now at 5ad15c0 Renamed to destdir
rm 'destdir'
[rename-two (root-commit) 950bfde] Common commmit
 Author: A U Thor <author@example.com>
 2 files changed, 2 insertions(+), 0 deletions(-)
 create mode 100644 one/file
 create mode 100644 two/file
rm 'one/file'
[rename-two c01270b] Rename two/file -> one
 Author: A U Thor <author@example.com>
 2 files changed, 0 insertions(+), 1 deletions(-)
 rename two/file => one (100%)
 delete mode 100644 one/file
rm 'two/file'
[rename-one 223fa66] Rename one/file -> two
 Author: A U Thor <author@example.com>
 2 files changed, 0 insertions(+), 1 deletions(-)
...
expecting success: 
	...
	test "stuff" = $(cat two)
Merging:
223fa66 Rename one/file -> two
virtual rename-two
found 1 common ancestor(s):
950bfde Common commmit
...
expecting success: 
	...
	test "other" = $(cat one) &&
	test "stuff" = $(cat two)
HEAD is now at 223fa66 Rename one/file -> two
Merging:
223fa66 Rename one/file -> two
virtual rename-two
found 1 common ancestor(s):
...
HEAD is now at 223fa66 Rename one/file -> two
rm 'two'
[first-rename (root-commit) ccdb752] Common commmit
 Author: A U Thor <author@example.com>
 1 files changed, 1 insertions(+), 0 deletions(-)
 create mode 100644 original
[first-rename 308d124] Put two/file in the way, rename to one
 Author: A U Thor <author@example.com>
 1 files changed, 0 insertions(+), 0 deletions(-)
 rename original => one (100%)
 create mode 100644 two/file
[second-rename 74d0f95] Put one/file in the way, rename to two
 Author: A U Thor <author@example.com>
 1 files changed, 0 insertions(+), 0 deletions(-)
 create mode 100644 one/file
...
expecting success: 
	...
	! test -f original
Merging:
308d124 Put two/file in the way, rename to one
virtual second-rename
found 1 common ancestor(s):
ccdb752 Common commmit
...
HEAD is now at 308d124 Put two/file in the way, rename to one
rm 'one'
rm 'two/file'
[first-rename-redo (root-commit) cf89bb0] Common commmit
 Author: A U Thor <author@example.com>
 1 files changed, 1 insertions(+), 0 deletions(-)
 create mode 100644 one/file
 create mode 100644 original
 create mode 100644 two/file
rm 'one/file'
[first-rename-redo 9f15961] Rename to one
 Author: A U Thor <author@example.com>
 1 files changed, 0 insertions(+), 0 deletions(-)
 rename original => one (100%)
 delete mode 100644 one/file
rm 'two/file'
[second-rename-redo d24f604] Rename to two
 Author: A U Thor <author@example.com>
 1 files changed, 0 insertions(+), 0 deletions(-)
 rename original => two (100%)
 delete mode 100644 two/file
...
expecting success: 
	...
	! test -f original
Merging:
9f15961 Rename to one
virtual second-rename-redo
found 1 common ancestor(s):
cf89bb0 Common commmit
Removing one to make room for subdirectory; may re-add later.
Removing two/file

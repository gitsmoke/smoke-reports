...
HEAD is now at a0a6ddc dir to symlink
rm 'a/b'
[detached HEAD 2888932] untracked symlink remains
 Author: A U Thor <author@example.com>
...
HEAD is now at a2d471b base
[detached HEAD 2005bdb] x
 Author: A U Thor <author@example.com>
 1 files changed, 1 insertions(+), 0 deletions(-)
...
HEAD is now at bc3bee0 Merge branch 'master' into HEAD
Merging:
2005bdb x
virtual master
...
HEAD is now at c5aaf81 Merge branch 'master' into HEAD
Trying really trivial in-index merge...
Nope.
Trying simple merge.
Simple merge failed, trying Automatic merge.
...
HEAD is now at 1058cfc Merge commit 'baseline^0' into HEAD
Merging:
a0a6ddc dir to symlink
virtual baseline^0
found 1 common ancestor(s):
a2d471b base
...
expecting success: 
	...
	git tag test2
HEAD is now at 2005bdb x
[detached HEAD ad7145f] dir a/b-2 to symlink
 Author: A U Thor <author@example.com>
...
HEAD is now at ad7145f dir a/b-2 to symlink
Trying really trivial in-index merge...
Nope.
Trying simple merge.
Simple merge failed, trying Automatic merge.
...
HEAD is now at 8c18b83 Merge commit 'test2' into HEAD
Merging:
2005bdb x
virtual test2
found 1 common ancestor(s):

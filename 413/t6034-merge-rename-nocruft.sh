...
git checkout master
[master (root-commit) c4d53df] initial has A and M
 Author: A U Thor <author@example.com>
 2 files changed, 30 insertions(+), 0 deletions(-)
 create mode 100644 A
 create mode 100644 M
[white 533d0e2] white renames A->B, M->N
 Author: A U Thor <author@example.com>
 2 files changed, 2 insertions(+), 2 deletions(-)
 rename A => B (93%)
 rename M => N (93%)
[red aca42fb] red creates R
 Author: A U Thor <author@example.com>
 1 files changed, 1 insertions(+), 0 deletions(-)
 create mode 100644 R
[blue 1488918] blue modify A
 Author: A U Thor <author@example.com>
...
Merging:
aca42fb red creates R
virtual white
found 1 common ancestor(s):
c4d53df initial has A and M
Auto-merging B
Auto-merging N

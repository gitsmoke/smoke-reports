...
expecting success: 
	...
	echo happy.
[master (root-commit) fafd908] initial
...
HEAD is now at fafd908 initial
...
[master 8cc4cbf] Add .gitattributes
 Author: A U Thor <author@example.com>
...
[master 2d1b244] initial
 Author: A U Thor <author@example.com>
 1 files changed, 1 insertions(+), 0 deletions(-)
[master 725e8f5] second
 Author: A U Thor <author@example.com>
...
[master 2d0b4ff] alllf, allcrlf and mixed only
 Author: A U Thor <author@example.com>

...
[master (root-commit) 81c3dad] Add A.
 Author: author@name <bogus@email@address>
 1 files changed, 1 insertions(+), 0 deletions(-)
 create mode 100644 A
[force-3way 0ce6a1f] Add Y.
 Author: author@name <bogus@email@address>
 1 files changed, 1 insertions(+), 0 deletions(-)
 create mode 100644 Y
[filemove 1d134ad] Move A.
 Author: author@name <bogus@email@address>
 2 files changed, 1 insertions(+), 0 deletions(-)
 rename A => D/A (100%)
 create mode 100644 Y
[my-topic-branch 741a759] Add B.
 Author: author@name <bogus@email@address>
 1 files changed, 1 insertions(+), 0 deletions(-)
 create mode 100644 B
[master 795ce86] Modify A.
 Author: author@name <bogus@email@address>
 1 files changed, 1 insertions(+), 0 deletions(-)
[side 8055084] Add C
 Author: author@name <bogus@email@address>
...
Merge made by recursive.
 ...
 create mode 100644 C
Merging:
17b4552 Merge branch 'side' into nonlinear
virtual master
found 1 common ancestor(s):
81c3dad Add A.
Merge made by recursive.
...
[master 2e418d5] prepare
 Author: author@name <bogus@email@address>
 1 files changed, 1 insertions(+), 0 deletions(-)
 create mode 100644 X
[modechange 896fddb] modechange
 Author: author@name <bogus@email@address>
 1 files changed, 1 insertions(+), 0 deletions(-)
...
[quiet 40dc9d1] A file with a line with CR
 Author: author@name <bogus@email@address>
...
[detached HEAD d54720e] n1
 Author: author@name <bogus@email@address>
 1 files changed, 1 insertions(+), 0 deletions(-)
 create mode 100644 n1.t
[detached HEAD 3feffce] n2
 Author: author@name <bogus@email@address>
 1 files changed, 1 insertions(+), 0 deletions(-)
 create mode 100644 n2.t
[detached HEAD 535d550] n3
 Author: author@name <bogus@email@address>
 1 files changed, 1 insertions(+), 0 deletions(-)

...
[master (root-commit) d5eef67] add normal files
...
[master 60c3493] add files with tabs and newlines
 Author: A U Thor <author@example.com>
 0 files changed, 0 insertions(+), 0 deletions(-)
...
[master 823f59e] add file for rm test
 Author: A U Thor <author@example.com>
...
[master 9c9ac3e] remove file from rm test
 Author: A U Thor <author@example.com>
...
[master aa39ee7] add file for rm --quiet test
 Author: A U Thor <author@example.com>
 1 files changed, 1 insertions(+), 0 deletions(-)
 create mode 100644 test-file
[master 0bbf295] remove file from rm --quiet test
 Author: A U Thor <author@example.com>
 1 files changed, 0 insertions(+), 1 deletions(-)
 delete mode 100644 test-file
...
[master (root-commit) 1309ffd] add a file
 Author: A U Thor <author@example.com>
 1 files changed, 1 insertions(+), 0 deletions(-)
...
HEAD is now at c518a72 subdir test
rm 'frotz/nitfol'

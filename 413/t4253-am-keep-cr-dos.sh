...
[master (root-commit) 86b50fe] Initial
 Author: A U Thor <author@example.com>
 1 files changed, 1 insertions(+), 0 deletions(-)
 create mode 100644 file
[master b937e1a] Second
 Author: A U Thor <author@example.com>
 1 files changed, 1 insertions(+), 0 deletions(-)
[master 4d1b66d] Third
 Author: A U Thor <author@example.com>
 1 files changed, 1 insertions(+), 0 deletions(-)
...
0001-Second.patch
0002-Third.patch
[dosfiles-keep-cr-continue e6ab57f] different patch
 Author: A U Thor <author@example.com>
 1 files changed, 1 insertions(+), 0 deletions(-)
Applying: Second
Using index info to reconstruct a base tree...
...
[unixfiles-conf-keepcr-override a8577a7] line ending to unix
 Author: A U Thor <author@example.com>

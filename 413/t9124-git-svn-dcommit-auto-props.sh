...
Committed revision 1.
	A	foo
r1 = 513ebac3fdb7ed055e32cf56c0bd452442c403b6 (refs/remotes/git-svn)
...
[master 9720efc] files for enabled auto-props
...
Committed r2
	...
	A	bar
	A	exec1.sh
r2 = cb6af91cef478d695a66c456f22934083977178a (refs/remotes/git-svn)
...
[master 8dca39c] files for disabled auto-props
 Author: A U Thor <author@example.com>
 3 files changed, 3 insertions(+), 0 deletions(-)
...
Committed r3
	...
	A	world.txt
	A	zot
r3 = 3e880d474460596985aed44fccbee2d8ebfe28df (refs/remotes/git-svn)
No changes between current HEAD and refs/remotes/git-svn
Resetting to the latest refs/remotes/git-svn
...
Committed r4
	D	foo
	A	foo.sh
r4 = ff1895cfdef68b1c733af59e0a75188f907ddfe8 (refs/remotes/git-svn)
No changes between current HEAD and refs/remotes/git-svn
Resetting to the latest refs/remotes/git-svn
D    foo
A    foo.sh

...
[master (root-commit) 829cbcd] Initial commit.
 Author: A U Thor <author@example.com>
 1 files changed, 1 insertions(+), 0 deletions(-)
 create mode 100644 A
[master 1207b63] Second commit.
 Author: A U Thor <author@example.com>
 1 files changed, 1 insertions(+), 0 deletions(-)
...
expecting success: git branch l/m &&
        git branch -d l/m &&
        git branch l
Deleted branch l/m (was 1207b63).
...
Deleted branch s/t (was 1207b63).
...
Deleted branch my7 (was 1207b63).
...
1207b63a3fcabe52c228ab53ca0f32b80d76fb5f
...
expecting success: 
	...
	git branch -d my8
Deleted branch my8 (was 1207b63).

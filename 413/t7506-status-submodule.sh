...
[master (root-commit) 2eecc85]  Add bar
 Author: A U Thor <author@example.com>
 0 files changed, 0 insertions(+), 0 deletions(-)
 create mode 100644 bar
[master 7f47e0e]  Add foo
 Author: A U Thor <author@example.com>
 0 files changed, 0 insertions(+), 0 deletions(-)
 create mode 100644 foo
[master (root-commit) 4a0b208] Add submodule sub
 Author: A U Thor <author@example.com>
...
HEAD is now at 7f47e0e  Add foo
...
expecting success: 
	...
	diff output - <<-\EOF
	 M sub
	EOF
HEAD is now at b25235a next change
...
[master 95cc945] added .real to .gitignore
 Author: A U Thor <author@example.com>
 1 files changed, 1 insertions(+), 0 deletions(-)

...
[master (root-commit) 8d44379] initial
...
Updating 8d44379..ca565f1
Fast-forward
 file |    1 +
 1 files changed, 1 insertions(+), 0 deletions(-)
[master f285299] third
 Author: A U Thor <author@example.com>
...
[master 0d56319] sixth.1
 Author: A U Thor <author@example.com>
 1 files changed, 1 insertions(+), 1 deletions(-)
[master ab4aee5] sixth.2
 Author: A U Thor <author@example.com>
 1 files changed, 1 insertions(+), 0 deletions(-)
[master 4c91f34] sixth.3
 Author: A U Thor <author@example.com>
 1 files changed, 1 insertions(+), 0 deletions(-)
...
4c91f34d6f4933aeef94ea3ca278dbf26a9ed014
[master e67813d] seventh
 Author: A U Thor <author@example.com>
 1 files changed, 1 insertions(+), 1 deletions(-)

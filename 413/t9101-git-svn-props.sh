...
expecting success: git svn fetch
	...
	A	ne_crlf
	A	empty
r1 = 9a7b9de848fff9a5584d2193a07b928f9ac256e9 (refs/remotes/git-svn)
	M	kw.c
r2 = 6c0c50287b04f9e76402bc72972837954f233708 (refs/remotes/git-svn)
	M	kw.c
r3 = dbbd4a15cdc6f01d43b8909bacc90b38357740c3 (refs/remotes/git-svn)
	M	kw.c
r4 = baf7de3d9e57823814e64e84eda82efb4ef445db (refs/remotes/git-svn)
...
[mybranch 0b51525] test keywords ignoring
 Author: A U Thor <author@example.com>
 1 files changed, 1 insertions(+), 0 deletions(-)
	M	kw.c
	M	kw.c
r5 = 71135dde2c064202d79278fde83a0191326c3b2b (refs/remotes/git-svn)
Done committing 1 revisions to SVN
Updating 0b51525..71135dd
Fast-forward
...
expecting success: git svn fetch &&
	...
	M	ne_crlf
	M	empty
r6 = 12aa4d8952dad50812a2b46c3efbb231cbd0004a (refs/remotes/git-svn)
Updating 71135dd..12aa4d8
Fast-forward
 crlf    |    3 +--
 ne_crlf |    3 +--
...
expecting success: git svn fetch && git pull . ${remotes_git_svn}
	M	cr
	M	ne_cr
r7 = 1b5dae25346a87f77d1420a402609c2b41d278c6 (refs/remotes/git-svn)
Updating 12aa4d8..1b5dae2
Fast-forward
 cr    |    4 +++-
 ne_cr |    4 +++-
...
expecting success: 
	...
	A	deeply/nested/directory/.keep
r8 = 72e9a4a11950b71d495ebaea58378ec5ff8509a0 (refs/remotes/git-svn)
Updating 1b5dae2..72e9a4a
Fast-forward

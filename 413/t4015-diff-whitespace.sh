...
expecting success: 
	...
	echo "foo();" > x &&
	git diff --check
[master (root-commit) 7379ea9] snapshot
...
HEAD is now at e9a663d yet another
[master e917921] hello 1
 Author: A U Thor <author@example.com>
 1 files changed, 1 insertions(+), 1 deletions(-)
...
HEAD is now at e917921 hello 1
[master 5ed6f85] base
 Author: A U Thor <author@example.com>
...
HEAD is now at 5ed6f85 base
[master dd4b459] empty
 Author: A U Thor <author@example.com>
...
HEAD is now at dd4b459 empty
[master 5921a0e] one side
 Author: A U Thor <author@example.com>
 1 files changed, 1 insertions(+), 9 deletions(-)
[detached HEAD ae4b4dd] the other side
 Author: A U Thor <author@example.com>
 1 files changed, 1 insertions(+), 9 deletions(-)
Merging:
ae4b4dd the other side
virtual master
...
HEAD is now at ae4b4dd the other side
[detached HEAD cd40382] initial
 Author: A U Thor <author@example.com>
 1 files changed, 1 insertions(+), 1 deletions(-)

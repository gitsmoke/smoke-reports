...
r1 = 37ba780a73d87ec365855acf214fd7e97ed4ec08 (refs/remotes/git-svn)
...
[mybranch 10559d9] try a deep --rmdir with a commit
 ...
 rename dir/a/b/c/d/e/file => file (100%)
	...
	D	dir/a/
	A	dir/file
r2 = 878574b88a239049cba44c3f30a6b6e89f313717 (refs/remotes/git-svn)
...
[mybranch 2128180] detect node change from file to directory #1
 Author: A U Thor <author@example.com>
...
[mybranch2 1db170f] detect node change from directory to file #1
 Author: A U Thor <author@example.com>
 1 files changed, 0 insertions(+), 0 deletions(-)
...
[mybranch3 46ec7c2] detect node change from file to directory #2
 Author: A U Thor <author@example.com>
...
[mybranch4 e68bc5f] detect node change from directory to file #2
 Author: A U Thor <author@example.com>
 2 files changed, 1 insertions(+), 1 deletions(-)
...
[mybranch5 470094b] remove executable bit from a file
 Author: A U Thor <author@example.com>
 0 files changed, 0 insertions(+), 0 deletions(-)
 mode change 100755 => 100644 exec.sh
	M	exec.sh
	M	exec.sh
r3 = 8781a966c09b2563977a911b73aeaa268fb199aa (refs/remotes/git-svn)
Done committing 1 revisions to SVN
...
expecting success: 
	...
	svn_cmd up "$SVN_TREE" &&
	test -x "$SVN_TREE"/exec.sh
[mybranch5 2c80db5] add executable bit back file
 Author: A U Thor <author@example.com>
 0 files changed, 0 insertions(+), 0 deletions(-)
 mode change 100644 => 100755 exec.sh
	M	exec.sh
	M	exec.sh
r4 = 0cdc1df1b2a75686f0c6c0738b4b2755a35b92ae (refs/remotes/git-svn)
Done committing 1 revisions to SVN
UU   /Users/trast/git-smoke/t/trash directory.t9100-git-svn-basic/.git/svn/refs/remotes/git-svn/svn-tree/exec.sh
...
[mybranch5 b1d113d] executable file becomes a symlink to bar/zzz (file)
 Author: A U Thor <author@example.com>
 ...
 mode change 100755 => 120000
	T	exec.sh
	M	exec.sh
r5 = ecf5bd4cbb488f40339d29e6050988e814107a92 (refs/remotes/git-svn)
Done committing 1 revisions to SVN
UU   /Users/trast/git-smoke/t/trash directory.t9100-git-svn-basic/.git/svn/refs/remotes/git-svn/svn-tree/exec.sh
...
[mybranch5 e5495aa] new symlink is added to a file that was also just made executable
 Author: A U Thor <author@example.com>
 ...
 create mode 120000 exec-2.sh
	...
	M	bar/zzz
	A	exec-2.sh
r6 = 559cc9c46940ffa319ed2c17fe2e74cf8b40c5cc (refs/remotes/git-svn)
Done committing 1 revisions to SVN
...
[mybranch5 61b8c3c] modify a symlink to become a file
 Author: A U Thor <author@example.com>
 1 files changed, 1 insertions(+), 1 deletions(-)
 ...
 mode change 120000 => 100644
	T	exec-2.sh
	M	exec-2.sh
r7 = 1060934017dc9dc9df4443b25a9e30548fa4fcc5 (refs/remotes/git-svn)
Done committing 1 revisions to SVN
...
expecting success: git svn init "$svnrepo" && git svn fetch &&
	...
	A	exec.sh
	A	dir/a/b/c/d/e/file
r1 = 37ba780a73d87ec365855acf214fd7e97ed4ec08 (refs/remotes/alt)
	A	file
	D	dir/a/b/c/d/e/file
	D	dir/a/
	A	dir/file
r2 = 1a24ef6f758b82a13539e6720af35849d95c92b8 (refs/remotes/alt)
	M	exec.sh
r3 = b292e46c54bebee6c080cd8d0e841c692cbb9bc0 (refs/remotes/alt)
	M	exec.sh
r4 = 5e572610f9622b6f8fc7fd72ccec58146b78f411 (refs/remotes/alt)
	M	exec.sh
r5 = 14608b6e760e64ebd527df6bc0d6beae218175b5 (refs/remotes/alt)
	M	bar/zzz
	A	exec-2.sh
r6 = 87b2c173efc77416eb747ca68080ffbac0387f19 (refs/remotes/alt)
	M	exec-2.sh
r7 = c65fbd000f7673635e44be74afd52632eacb9555 (refs/remotes/alt)
...
expecting success: 
	...
	A	zzz
r1 = d96222d2a00c2cf3d8734cb52d8954e24415024e (refs/remotes/bar)
	M	zzz
r6 = c0162adae765cb07f4e76acb568d401fa34e5386 (refs/remotes/bar)
[my-bar 1062804] change 1
 Author: A U Thor <author@example.com>
 1 files changed, 1 insertions(+), 0 deletions(-)
 create mode 100644 foo
[my-bar 2d8867f] change 2
 Author: A U Thor <author@example.com>
 1 files changed, 1 insertions(+), 1 deletions(-)
...
Committed r8
	A	foo
r8 = 289957aab0d6f2326dcbfff7b6f62d133ceeb2ed (refs/remotes/bar)
...
The rewritten commit is: 289957aab0d6f2326dcbfff7b6f62d133ceeb2ed
    change 1
Deleted branch my-bar (was 2d8867f).
...
expecting success: 
	...
	A	bar/foo
r8 = f99a77b5d1d30ec3b6cbe10b66169b4414c4ff73 (refs/remotes/alt)
[my-bar 4e00e0c] /bar/d should be in the log
 Author: A U Thor <author@example.com>
 1 files changed, 1 insertions(+), 0 deletions(-)
...
Committed r9
	A	d
r9 = 27af8e0c9db61942245cbc4c2db0d3a2f34723f4 (refs/remotes/bar)
No changes between current HEAD and refs/remotes/bar
Resetting to the latest refs/remotes/bar
[my-bar 66dc2a4] add a new directory
 Author: A U Thor <author@example.com>
 1 files changed, 1 insertions(+), 0 deletions(-)
...
Committed r10
	A	newdir/dir
r10 = 91bb9055aac9d05cfc70145f790bad3ecbe37e1c (refs/remotes/bar)
No changes between current HEAD and refs/remotes/bar
Resetting to the latest refs/remotes/bar
[my-bar 28fe2ea] modify a file in new directory
 Author: A U Thor <author@example.com>
 1 files changed, 1 insertions(+), 0 deletions(-)
Committing to file:///Users/trast/git-smoke/t/trash directory.t9100-git-svn-basic/svnrepo/bar ...
	M	newdir/dir
Committed r11
	M	newdir/dir
r11 = 9c7f01e4e3f5e6d2a5f1dfe31ff0ffbf5dcd9ba3 (refs/remotes/bar)
No changes between current HEAD and refs/remotes/bar
Resetting to the latest refs/remotes/bar
...
expecting success: 
	...
	test-chmtime =-60 foo &&
	git svn dcommit
[my-bar 5e3f651] commit-new-file-foo2
 Author: A U Thor <author@example.com>
 1 files changed, 1 insertions(+), 0 deletions(-)
...
Committed r12
	A	foo2
r12 = d83ef2dad124b79db906a9c90bf932de7a8d83b8 (refs/remotes/bar)
No changes between current HEAD and refs/remotes/bar
Resetting to the latest refs/remotes/bar
...
[my-bar 5615b91] update /bar/d
 Author: A U Thor <author@example.com>
 1 files changed, 1 insertions(+), 1 deletions(-)
	M	d
	M	d
r13 = b03a5c3bf6aabcaa2d695bce63b4be770dbbb0e5 (refs/remotes/bar)
Done committing 1 revisions to SVN
...
r8 = f99a77b5d1d30ec3b6cbe10b66169b4414c4ff73 (refs/remotes/alt)
	A	bar/d
r9 = 9fa151255454d25ccad90f257a61142f2d5f8c7d (refs/remotes/alt)
	A	bar/newdir/dir
r10 = 4c55e0e2ce443ba3b165ddf61ca9dce227ee84db (refs/remotes/alt)
	M	bar/newdir/dir
r11 = 68ad917e9c1a1b2dc32375e5b79674f5eaab1e04 (refs/remotes/alt)
	A	bar/foo2
r12 = df0f71674a35fe3d4df45f722bbfa3a7122edef6 (refs/remotes/alt)
	M	bar/d
r13 = 8ab0773174153480c7159dfca55c976171e433e7 (refs/remotes/alt)

...
expecting success: 
	...
	git add file &&
	git commit -m "first"
[master (root-commit) 81d85ea] first
...
[master be522b4] even more content
 Author: A U Thor <author@example.com>
 1 files changed, 1 insertions(+), 0 deletions(-)

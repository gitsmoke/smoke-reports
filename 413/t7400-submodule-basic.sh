...
expecting success: 
	...
	git branch initial
[master (root-commit) 0ce9224] initial commit
...
[master (root-commit) ebaad16] submodule commit 1
 Author: A U Thor <author@example.com>
...
[master (root-commit) 0fc9949] Ignore everything
 Author: A U Thor <author@example.com>
 1 files changed, 1 insertions(+), 0 deletions(-)
...
rev1: ebaad1662950f02080e43c0627f5ca74de554d37
...
-ebaad1662950f02080e43c0627f5ca74de554d37 init
...
Submodule path 'init': checked out 'ebaad1662950f02080e43c0627f5ca74de554d37'
...
expecting success: 
	...
	grep "^ $rev1" list
 ebaad1662950f02080e43c0627f5ca74de554d37 init (rev-1)
...
expecting success: 
	...
	grep "^+$rev2" list
[detached HEAD c55ac0e] submodule commit 2
 Author: A U Thor <author@example.com>
 1 files changed, 1 insertions(+), 0 deletions(-)
 create mode 100644 b
+c55ac0ef2105fef0d319360c16dd54ac045b6e59 init (rev-1-1-gc55ac0e)
...
+Subproject commit c55ac0ef2105fef0d319360c16dd54ac045b6e59
...
[detached HEAD f89d706] change subproject
 Author: A U Thor <author@example.com>
 1 files changed, 1 insertions(+), 0 deletions(-)
 create mode 100644 s
[master 6efd48e] change init
 Author: A U Thor <author@example.com>
...
Submodule path 'init': checked out 'f89d7063dd1c4eaf30aff9539f7caa39edc98575'
ok 32 - update --init

expecting success: 
	git reset --hard &&
	test_must_fail git add init/a
HEAD is now at 00e1630 super commit 1
...
expecting success: 
	...
	test $commit = $(git ls-files --stage |
		sed -n "s/^160000 \([^ ]*\).*/\1/p")
HEAD is now at 00e1630 super commit 1
[second e0bf2a2] commit subproject
 Author: A U Thor <author@example.com>
 1 files changed, 1 insertions(+), 1 deletions(-)
diff --git a/init b/init
index f89d706..8033f99 160000
--- a/init
+++ b/init
@@ -1 +1 @@
-Subproject commit f89d7063dd1c4eaf30aff9539f7caa39edc98575
+Subproject commit 8033f99b5a771245f8eec0e2684609886db3e3e4
...
HEAD is now at e0bf2a2 commit subproject
...
[master (root-commit) 14a4a9b] repo commit 1
 Author: A U Thor <author@example.com>
 1 files changed, 1 insertions(+), 0 deletions(-)

...
Initialized empty Git repository in /Users/trast/git-smoke/t/trash directory.t9133-git-svn-nested-git-repo/g/.git/
	A	a
r1 = df4d089145df44c924cb06595973e55cffd9b705 (refs/remotes/git-svn)
r2 = 64fc32e31d5370b37d483145be20a234e7580d3b (refs/remotes/git-svn)
...
expecting success: 
	...
	M	a
r3 = c795c58dbe7c9bf74a0c221eda0aa133f0b6ef38 (refs/remotes/git-svn)
...
[master (root-commit) 8fd5714] add a inside an SVN repo
 Author: A U Thor <author@example.com>
 1 files changed, 2 insertions(+), 0 deletions(-)
 create mode 100644 a
commit 8fd5714589c6e785530e164a5a01f15f06e0447a
Author: A U Thor <author@example.com>
Date:   Sun Jan 2 04:04:06 2011 +0000
...
A         .git/objects/8f
A         .git/objects/8f/d5714589c6e785530e164a5a01f15f06e0447a
A         .git/objects/a3
...
Adding         .git/objects/8f
Adding         .git/objects/8f/d5714589c6e785530e164a5a01f15f06e0447a
...
r4 = c3d8e81be054565e22248b753d82de55fd5baed1 (refs/remotes/git-svn)
First, rewinding head to replay your work on top of it...
Fast-forwarded master to refs/remotes/git-svn.
...
[master ce65241] add a inside an SVN repo
 Author: A U Thor <author@example.com>
...
expecting success: 
	...
	M	a
r5 = 782ca05f72e849b0ef299cfb14e39fef5eb53205 (refs/remotes/git-svn)
First, rewinding head to replay your work on top of it...
Fast-forwarded master to refs/remotes/git-svn.

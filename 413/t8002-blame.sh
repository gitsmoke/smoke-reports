...
[master (root-commit) cb1c6ec] Initial.
 Author: A <A@test.git>
...
Merging:
a4009d5 Branch2-1
virtual 84aaba3d2138db9ece860eab5a41fc78658e3b5a
...
expecting success: echo "evil merge." >>file &&
     git commit -a --amend
[branch2 24fe6c7] Merge branch 'branch1' into branch2

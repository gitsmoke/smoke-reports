...
[master (root-commit) bc2afb6] commit
...
Unstaged changes after reset:
M	file
[master a8a2a75] commit
 Author: A U Thor <author@example.com>
 1 files changed, 1 insertions(+), 1 deletions(-)
HEAD is now at bc2afb6 commit
...
[master 78c81ff] clear local changes
 Author: A U Thor <author@example.com>
 1 files changed, 1 insertions(+), 0 deletions(-)
...
HEAD is now at 78c81ff clear local changes
[master c9267c8] non-empty
 Author: A U Thor <author@example.com>
 1 files changed, 1 insertions(+), 0 deletions(-)
...
HEAD is now at c9267c8 non-empty
[master 44b477e] empty
 Author: A U Thor <author@example.com>

...
[master (root-commit) cd24e32] added file1
 Author: A U Thor <author@example.com>
 2 files changed, 2 insertions(+), 0 deletions(-)
 create mode 100644 file1
 create mode 100644 subdir/file3
[branch1 d770372] branch1 changes
 Author: A U Thor <author@example.com>
 3 files changed, 3 insertions(+), 2 deletions(-)
 create mode 100644 file2
[master 757c971] master updates
 Author: A U Thor <author@example.com>
 3 files changed, 3 insertions(+), 2 deletions(-)
 create mode 100644 file2
...
[test1 8912ef5] branch1 resolved with mergetool
 Author: A U Thor <author@example.com>
...
x")" &&
    ...
    git reset --hard
[test2 b37b093] branch1 resolved with mergetool - autocrlf
 Author: A U Thor <author@example.com>
HEAD is now at b37b093 branch1 resolved with mergetool - autocrlf
ok 3 - mergetool crlf
expecting success: 
...
[test3 293bcd8] branch1 resolved with mergetool - subdir
 Author: A U Thor <author@example.com>
...
HEAD is now at d770372 branch1 changes
...
Normal merge conflict for 'subdir/file3':
  {local}: modified
  {remote}: modified
[test4 704a83f] branch2 resolved by mergetool from subdir
 Author: A U Thor <author@example.com>

...
expecting success: 
	...
	repo_fetched one &&
	repo_fetched two
[master (root-commit) f4d0ce9] update-all
...
expecting success: 
	...
	repo_fetched one &&
	repo_fetched two
[master aaf14a4] fetch-group-all
 Author: A U Thor <author@example.com>
 1 files changed, 1 insertions(+), 0 deletions(-)
[master aaf14a4] fetch-group-all
 Author: A U Thor <author@example.com>
...
[master 8861d9f] fetch-group-some
 Author: A U Thor <author@example.com>
 1 files changed, 1 insertions(+), 0 deletions(-)
[master 8861d9f] fetch-group-some
 Author: A U Thor <author@example.com>

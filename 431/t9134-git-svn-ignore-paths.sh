...
Initialized empty Git repository in /Users/trast/git-smoke/t/trash directory.t9134-git-svn-ignore-paths/g/.git/
	A	qqq/test_qqq.txt
r1 = 53e6fff167cca7fbea04ded2c28eecd81d8b11fe (refs/remotes/git-svn)
r2 = 53aae03057bb8adfb5286db2b87216eff284f1fc (refs/remotes/git-svn)
...
" > expect &&
	...
	M	qqq/test_qqq.txt
r3 = c1d9428e5d4ec83d27bbf052a1509f560c3c48a5 (refs/remotes/git-svn)
...
r4 = 6cf6ee1ecab38414a74a847a6768071fef4a1a1b (refs/remotes/git-svn)
First, rewinding head to replay your work on top of it...
Fast-forwarded master to refs/remotes/git-svn.
...
" > expect &&
	...
	M	qqq/test_qqq.txt
r5 = afc1eb121475bfcf420fbc579ab3e3f3a540da89 (refs/remotes/git-svn)
First, rewinding head to replay your work on top of it...
Fast-forwarded master to refs/remotes/git-svn.

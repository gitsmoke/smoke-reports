...
[master (root-commit) c9f7abc] initial
...
Merging:
44961d4 addition
virtual aa4dda8aa7d99d084823ce9c6e1b2d2e91684d40
...
[master (root-commit) 94ecafd] initial
 Author: A U Thor <author@example.com>
 1 files changed, 1 insertions(+), 0 deletions(-)
 create mode 100644 file1

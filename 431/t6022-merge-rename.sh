...
git checkout master
[master (root-commit) d7c8349] initial has A and M
 Author: A U Thor <author@example.com>
 2 files changed, 30 insertions(+), 0 deletions(-)
 create mode 100644 A
 create mode 100644 M
[master dd19617] master updates A
 Author: A U Thor <author@example.com>
 1 files changed, 1 insertions(+), 1 deletions(-)
[yellow 20e1990] yellow removes M
 Author: A U Thor <author@example.com>
 1 files changed, 0 insertions(+), 15 deletions(-)
 delete mode 100644 M
[white c436a66] white renames A->B, M->N
 Author: A U Thor <author@example.com>
 2 files changed, 2 insertions(+), 2 deletions(-)
 rename A => B (93%)
 rename M => N (93%)
[red 3e9563a] red renames A->B, M->N
 Author: A U Thor <author@example.com>
 2 files changed, 2 insertions(+), 2 deletions(-)
 rename A => B (93%)
 rename M => N (93%)
[blue 421c11b] blue renames A->C, M->N
 Author: A U Thor <author@example.com>
 2 files changed, 2 insertions(+), 2 deletions(-)
 rename A => C (93%)
 rename M => N (93%)
...
Merging:
dd19617 master updates A
virtual c436a66f8323d6a269962cdc8761a9e36ce32647
found 1 common ancestor(s):
d7c8349 initial has A and M
Auto-merging B
...
expecting success: 
	...
	git diff --exit-code white N
HEAD is now at dd19617 master updates A
Merging:
3e9563a red renames A->B, M->N
virtual c436a66f8323d6a269962cdc8761a9e36ce32647
found 1 common ancestor(s):
d7c8349 initial has A and M
Auto-merging B
...
expecting success: 
	...
	git diff --exit-code white N
HEAD is now at 3e9563a red renames A->B, M->N
! [blue] blue renames A->C, M->N
 ! [change] changed
  ! [change+rename] changed and renamed
   ! [master] master updates A
...
Merging:
3e9563a red renames A->B, M->N
virtual dd19617632ef84e26e719c1b04e5c8b2173da2e4
found 1 common ancestor(s):
d7c8349 initial has A and M
Auto-merging B
CONFLICT (content): Merge conflict in B
...
Merging:
3e9563a red renames A->B, M->N
virtual 421c11b8feba47602d0952b7a0e6defbd90a5c9d
found 1 common ancestor(s):
d7c8349 initial has A and M
Skipped N (merged same as existing)
CONFLICT (rename/rename): Rename "A"->"B" in branch "HEAD" rename "A"->"C" in "421c11b8feba47602d0952b7a0e6defbd90a5c9d"
Automatic merge failed; fix conflicts and then commit the result.
g : red changes a line
...
+++++*+ [change+rename^] initial has A and M
Merging:
c436a66 white renames A->B, M->N
virtual 3e9563ad8b42af005081fbfbc9dde00b84b50c03
found 1 common ancestor(s):
d7c8349 initial has A and M
Auto-merging B
CONFLICT (content): Merge conflict in B
...
HEAD is now at c436a66 white renames A->B, M->N
...
Merging:
dd19617 master updates A
virtual 20e1990d01db5d88b30116eed604da0c869ff74b
found 1 common ancestor(s):
d7c8349 initial has A and M
Removing M
...
HEAD is now at dd19617 master updates A
Updated tag 'anchor' (was dd19617)
! [blue] blue renames A->C, M->N
 ! [change] changed
  ! [change+rename] changed and renamed
   ! [master] master updates A
...
Merge made by recursive.
 A |    2 +-
 1 files changed, 1 insertions(+), 1 deletions(-)
HEAD is now at 20e1990 yellow removes M
...
HEAD is now at 1978769 changed and renamed
Skipped B (merged same as existing)
...
HEAD is now at 94b4b94 Merge branch 'change+rename' into change
rm 'B'
rm 'M'
[dir-in-way (root-commit) 52bdd4e] Common commmit
 Author: A U Thor <author@example.com>
...
[dir-in-way 8b0cc65] Commit to merge, with dir in the way
 Author: A U Thor <author@example.com>
 2 files changed, 2 insertions(+), 0 deletions(-)
rm 'dir/file-in-the-way'
[dir-not-in-way a868ffa] Commit to merge, with dir removed
 Author: A U Thor <author@example.com>
 2 files changed, 1 insertions(+), 1 deletions(-)
 delete mode 100644 dir/file-in-the-way
rm 'dir/file-in-the-way'
rm 'sub/file'
[renamed-file-has-no-conflicts 0c92439] Independent change
 Author: A U Thor <author@example.com>
 2 files changed, 1 insertions(+), 2 deletions(-)
 rename sub/file => dir (79%)
 delete mode 100644 dir/file-in-the-way
rm 'dir/file-in-the-way'
[renamed-file-has-conflicts 2e65632] Conflicting change
 Author: A U Thor <author@example.com>
 2 files changed, 1 insertions(+), 1 deletions(-)
...
HEAD is now at 2e65632 Conflicting change
Merging:
0c92439 Independent change
virtual dir-not-in-way
found 1 common ancestor(s):
52bdd4e Common commmit
...
HEAD is now at 9acaecc Merge branch 'dir-not-in-way' into HEAD
...
HEAD is now at 0c92439 Independent change
...
HEAD is now at 8b0cc65 Commit to merge, with dir in the way
Merging:
2e65632 Conflicting change
virtual dir-not-in-way
found 1 common ancestor(s):
52bdd4e Common commmit
Removing dir to make room for subdirectory; may re-add later.
...
HEAD is now at 2e65632 Conflicting change
Merging:
8b0cc65 Commit to merge, with dir in the way
...
rm 'n.stages'
rm 'sub/file'
[rename-dest (root-commit) 689aa13] Common commmit
 Author: A U Thor <author@example.com>
 1 files changed, 1 insertions(+), 0 deletions(-)
 create mode 100644 one/file
[rename-dest fa2aea0] Renamed to destdir
 Author: A U Thor <author@example.com>
 1 files changed, 0 insertions(+), 0 deletions(-)
 rename one/file => destdir (100%)
rm 'one/file'
[source-conflict db6335f] Conflicts in the way
 Author: A U Thor <author@example.com>
...
HEAD is now at db6335f Conflicts in the way
Merging:
fa2aea0 Renamed to destdir
virtual source-conflict
found 1 common ancestor(s):
689aa13 Common commmit
...
HEAD is now at fa2aea0 Renamed to destdir
rm 'destdir'
[rename-two (root-commit) e754940] Common commmit
 Author: A U Thor <author@example.com>
 2 files changed, 2 insertions(+), 0 deletions(-)
 create mode 100644 one/file
 create mode 100644 two/file
rm 'one/file'
[rename-two bfa1aad] Rename two/file -> one
 Author: A U Thor <author@example.com>
 2 files changed, 0 insertions(+), 1 deletions(-)
 rename two/file => one (100%)
 delete mode 100644 one/file
rm 'two/file'
[rename-one 26d2be2] Rename one/file -> two
 Author: A U Thor <author@example.com>
 2 files changed, 0 insertions(+), 1 deletions(-)
...
Merging:
26d2be2 Rename one/file -> two
virtual rename-two
found 1 common ancestor(s):
e754940 Common commmit
...
HEAD is now at 26d2be2 Rename one/file -> two
Merging:
26d2be2 Rename one/file -> two
virtual rename-two
found 1 common ancestor(s):
...
HEAD is now at 26d2be2 Rename one/file -> two
rm 'two'
[first-rename (root-commit) 47c3529] Common commmit
 Author: A U Thor <author@example.com>
 1 files changed, 1 insertions(+), 0 deletions(-)
 create mode 100644 original
[first-rename 1511fd4] Put two/file in the way, rename to one
 Author: A U Thor <author@example.com>
 1 files changed, 0 insertions(+), 0 deletions(-)
 rename original => one (100%)
 create mode 100644 two/file
[second-rename a55d3b3] Put one/file in the way, rename to two
 Author: A U Thor <author@example.com>
 1 files changed, 0 insertions(+), 0 deletions(-)
 create mode 100644 one/file
...
expecting success: 
	...
	! test -f original
Merging:
1511fd4 Put two/file in the way, rename to one
virtual second-rename
found 1 common ancestor(s):
47c3529 Common commmit
...
HEAD is now at 1511fd4 Put two/file in the way, rename to one
rm 'one'
rm 'two/file'
[first-rename-redo (root-commit) 7aa4f28] Common commmit
 Author: A U Thor <author@example.com>
 1 files changed, 1 insertions(+), 0 deletions(-)
 create mode 100644 one/file
 create mode 100644 original
 create mode 100644 two/file
rm 'one/file'
[first-rename-redo 5e945ee] Rename to one
 Author: A U Thor <author@example.com>
 1 files changed, 0 insertions(+), 0 deletions(-)
 rename original => one (100%)
 delete mode 100644 one/file
rm 'two/file'
[second-rename-redo 6dd5774] Rename to two
 Author: A U Thor <author@example.com>
 1 files changed, 0 insertions(+), 0 deletions(-)
 rename original => two (100%)
 delete mode 100644 two/file
...
expecting success: 
	...
	! test -f original
Merging:
5e945ee Rename to one
virtual second-rename-redo
found 1 common ancestor(s):
7aa4f28 Common commmit
Removing one to make room for subdirectory; may re-add later.
Removing two/file

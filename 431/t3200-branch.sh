...
[master (root-commit) decb09f] Initial commit.
 Author: A U Thor <author@example.com>
 1 files changed, 1 insertions(+), 0 deletions(-)
 create mode 100644 A
[master 9891690] Second commit.
 Author: A U Thor <author@example.com>
 1 files changed, 1 insertions(+), 0 deletions(-)
...
Deleted branch s/t (was 9891690).
...
Deleted branch my7 (was 9891690).
...
9891690d93a38a887b5bcebb3bb728901daba27c
...
expecting success: 
	...
	git branch -d my8
Deleted branch my8 (was 9891690).

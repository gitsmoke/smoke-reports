...
expecting success: 
	...
	git tag six
[master (root-commit) 6001808] Initial
 Author: A U Thor <author@example.com>
 2 files changed, 361 insertions(+), 0 deletions(-)
 create mode 120000 bar
 create mode 100644 foo
[master 3e84469] Second
 Author: A U Thor <author@example.com>
 2 files changed, 0 insertions(+), 0 deletions(-)
 rename foo => bar (100%)
 rename bar => foo (100%)
[master ce3bebc] Third
 Author: A U Thor <author@example.com>
 1 files changed, 0 insertions(+), 0 deletions(-)
 rename bar => foo (100%)
[master f7e1307] Fourth
 Author: A U Thor <author@example.com>
 2 files changed, 1 insertions(+), 360 deletions(-)
 rename foo => bar (100%)
 rewrite foo (100%)
 mode change 100644 => 120000
[master 8812450] Fifth
 Author: A U Thor <author@example.com>
 2 files changed, 2454 insertions(+), 360 deletions(-)
 rewrite bar (98%)
 rename bar => foo (100%)
[master 488b351] Sixth
 Author: A U Thor <author@example.com>
 2 files changed, 0 insertions(+), 0 deletions(-)
 rename foo => bar (100%)
 rename bar => foo (100%)

...
[master (root-commit) a6159d9] initial
...
[other 60a101c] changesimplefile
 Author: A U Thor <author@example.com>
 1 files changed, 1 insertions(+), 0 deletions(-)
rm 'sub1'
[main 44cd91c] changefiletodir
 Author: A U Thor <author@example.com>

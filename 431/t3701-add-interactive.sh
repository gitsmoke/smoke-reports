...
[master (root-commit) 96fd266] commit
...
Unstaged changes after reset:
M	file
[master 9ef5b0c] commit
 Author: A U Thor <author@example.com>
 1 files changed, 1 insertions(+), 1 deletions(-)
HEAD is now at 96fd266 commit
...
[master f8e22a5] clear local changes
 Author: A U Thor <author@example.com>
 1 files changed, 1 insertions(+), 0 deletions(-)
...
HEAD is now at f8e22a5 clear local changes
[master 7e1f9a1] non-empty
 Author: A U Thor <author@example.com>
 1 files changed, 1 insertions(+), 0 deletions(-)
...
HEAD is now at 7e1f9a1 non-empty
[master 13b4851] empty
 Author: A U Thor <author@example.com>

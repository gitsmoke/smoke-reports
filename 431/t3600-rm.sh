...
[master (root-commit) d3df514] add normal files
...
[master d883611] add files with tabs and newlines
 Author: A U Thor <author@example.com>
 0 files changed, 0 insertions(+), 0 deletions(-)
...
[master ca6cd33] add file for rm test
 Author: A U Thor <author@example.com>
...
[master 9d67032] remove file from rm test
 Author: A U Thor <author@example.com>
...
[master c553d47] add file for rm --quiet test
 Author: A U Thor <author@example.com>
 1 files changed, 1 insertions(+), 0 deletions(-)
 create mode 100644 test-file
[master 9d35117] remove file from rm --quiet test
 Author: A U Thor <author@example.com>
 1 files changed, 0 insertions(+), 1 deletions(-)
 delete mode 100644 test-file
...
[master (root-commit) d7310c3] add a file
 Author: A U Thor <author@example.com>
 1 files changed, 1 insertions(+), 0 deletions(-)
...
HEAD is now at 7073fcd subdir test
rm 'frotz/nitfol'

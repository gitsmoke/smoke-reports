...
expecting success: git branch g/h &&
     ...
     git pack-refs --all &&
     git branch -d g
Deleted branch g/h (was decb09f).
Deleted branch g (was decb09f).
...
expecting success: git branch k/l &&
     ...
     git branch -d k/lm &&
     git branch k
Deleted branch k/l (was decb09f).
Deleted branch k/l/m (was decb09f).
Deleted branch k/lm (was decb09f).
...
expecting success: git branch n/o &&
     ...
     git branch -d n/o/p &&
     git branch n
Deleted branch n/o (was decb09f).
Deleted branch n/op (was decb09f).
Deleted branch n/o/p (was decb09f).

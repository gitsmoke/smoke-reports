...
[master (root-commit) 41ee567] snapshot
...
HEAD is now at d1f9775 yet another
[master f2d73f7] hello 1
 Author: A U Thor <author@example.com>
 1 files changed, 1 insertions(+), 1 deletions(-)
...
HEAD is now at f2d73f7 hello 1
[master dda7a06] base
 Author: A U Thor <author@example.com>
...
HEAD is now at dda7a06 base
[master e03c05d] empty
 Author: A U Thor <author@example.com>
...
HEAD is now at e03c05d empty
[master 5cf7aa4] one side
 Author: A U Thor <author@example.com>
 1 files changed, 1 insertions(+), 9 deletions(-)
[detached HEAD accff8a] the other side
 Author: A U Thor <author@example.com>
 1 files changed, 1 insertions(+), 9 deletions(-)
Merging:
accff8a the other side
virtual master
...
HEAD is now at accff8a the other side
[detached HEAD 4e10ec6] initial
 Author: A U Thor <author@example.com>
 1 files changed, 1 insertions(+), 1 deletions(-)

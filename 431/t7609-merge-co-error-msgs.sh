...
expecting success: 
	...
	echo other >four &&
	echo other >five
[master (root-commit) f868276] First
 Author: A U Thor <author@example.com>
 1 files changed, 1 insertions(+), 0 deletions(-)
 create mode 100644 one
[branch 9221dce] Second
 Author: A U Thor <author@example.com>
...
Updating f868276..9221dce
Aborting
[master 1233078] empty
 Author: A U Thor <author@example.com>
Aborting
HEAD is now at f868276 First
...
[master (root-commit) 1d7f16a] init
 Author: A U Thor <author@example.com>
...
rm 'rep/foo'
rm 'rep2/foo'
[branch 39ee18f] added test as a file
 Author: A U Thor <author@example.com>

...
expecting success: 
	...
	git branch initial
[master (root-commit) db3122a] initial commit
...
[master (root-commit) 7b53145] submodule commit 1
 Author: A U Thor <author@example.com>
...
[master (root-commit) 21dc963] Ignore everything
 Author: A U Thor <author@example.com>
 1 files changed, 1 insertions(+), 0 deletions(-)
...
rev1: 7b53145b277af3a2c2255ffb5b5f1b6648932400
...
expecting success: 
	git submodule status >lines &&
	grep "^-$rev1" lines
-7b53145b277af3a2c2255ffb5b5f1b6648932400 init
...
Submodule path 'init': checked out '7b53145b277af3a2c2255ffb5b5f1b6648932400'
...
expecting success: 
 ...
 7b53145b277af3a2c2255ffb5b5f1b6648932400 init (rev-1)
...
[detached HEAD 837f807] submodule commit 2
 Author: A U Thor <author@example.com>
 1 files changed, 1 insertions(+), 0 deletions(-)
 create mode 100644 b
+837f80731c780808036737736e000bbb7f1c1d27 init (rev-1-1-g837f807)
...
+Subproject commit 837f80731c780808036737736e000bbb7f1c1d27
...
[detached HEAD d95cc42] change subproject
 Author: A U Thor <author@example.com>
 1 files changed, 1 insertions(+), 0 deletions(-)
 create mode 100644 s
[master 3f0c972] change init
 Author: A U Thor <author@example.com>
...
Submodule path 'init': checked out 'd95cc42795eae42c0c2187084c60c826f86b39a2'
...
HEAD is now at e9e6e9a super commit 1
...
HEAD is now at e9e6e9a super commit 1
[second abde864] commit subproject
 Author: A U Thor <author@example.com>
 1 files changed, 1 insertions(+), 1 deletions(-)
diff --git a/init b/init
index d95cc42..c822caa 160000
--- a/init
+++ b/init
@@ -1 +1 @@
-Subproject commit d95cc42795eae42c0c2187084c60c826f86b39a2
+Subproject commit c822caa71e7b67bd94fe8ac812c281cef95759f3
...
HEAD is now at abde864 commit subproject
...
[master (root-commit) fb183cb] repo commit 1
 Author: A U Thor <author@example.com>
 1 files changed, 1 insertions(+), 0 deletions(-)

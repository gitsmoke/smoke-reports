...
[master 8632fe5] c
 Author: A U Thor <author@example.com>
 1 files changed, 1 insertions(+), 1 deletions(-)
[to-rebase 7b76aec] merge should fail on this
 Author: A U Thor <author@example.com>
 1 files changed, 1 insertions(+), 1 deletions(-)
[to-rebase f8a899d] merge should fail on this, too
 Author: A U Thor <author@example.com>
 1 files changed, 1 insertions(+), 1 deletions(-)
...
HEAD is now at f8a899d merge should fail on this, too
...
Merging HEAD with merge should fail on this, too
Merging:
7e390ab merge should fail on this
virtual merge should fail on this, too
found 1 common ancestor(s):
virtual f788de73cfc81f8d734fa7efc658cc63ca083f50
Auto-merging a
...
Merging:
8632fe5 c
7b76aec merge should fail on this
found 1 common ancestor(s):
ee4947f a
Auto-merging a
CONFLICT (content): Merge conflict in a
...
Merging:
8632fe5 c
f8a899d merge should fail on this, too
found 1 common ancestor(s):
7b76aec merge should fail on this
Auto-merging a
CONFLICT (content): Merge conflict in a
...
Auto-merging a
CONFLICT (content): Merge conflict in a
[detached HEAD e3f87b6] merge should fail on this
 Author: A U Thor <author@example.com>
 1 files changed, 1 insertions(+), 0 deletions(-)
Committed: 0001 merge should fail on this
Merging master with HEAD~0
Merging:
e3f87b6 merge should fail on this
f8a899d merge should fail on this, too
found 1 common ancestor(s):
7b76aec merge should fail on this
Auto-merging a

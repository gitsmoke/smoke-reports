...
expecting success: 
	...
	git add hello &&
	git commit -m master
[master (root-commit) efa28f8] initial
...
[master (root-commit) 2e913b2] initial git-gui
 Author: A U Thor <author@example.com>
 1 files changed, 1 insertions(+), 0 deletions(-)
...
[master (root-commit) ad6d148] initial git
 Author: A U Thor <author@example.com>
 1 files changed, 1 insertions(+), 0 deletions(-)
...
Updating gui
[master 1317084] Merge git-gui as our subdirectory
 Author: A U Thor <author@example.com>
ok 4 - initial merge
expecting success: 
	cd ../git-gui &&
	...
	test_cmp expected actual
M	git-gui.sh
[master2 c6aa390] update git-gui
 Author: A U Thor <author@example.com>
 1 files changed, 1 insertions(+), 1 deletions(-)
Merging:
1317084 Merge git-gui as our subdirectory
virtual c6aa39001524a79f963a7f1494209a64f65303a3
found 1 common ancestor(s):
2e913b2 initial git-gui
Merge made by subtree.
...
expecting success: 
	...
	test_cmp expected actual
HEAD is now at 1317084 Merge git-gui as our subdirectory
Already up-to-date.
[master2 523f20d] Merge git-gui2 as our subdirectory
 Author: A U Thor <author@example.com>
 1 files changed, 1 insertions(+), 0 deletions(-)
...
HEAD is now at 523f20d Merge git-gui2 as our subdirectory
Merging:
523f20d Merge git-gui2 as our subdirectory
virtual c6aa39001524a79f963a7f1494209a64f65303a3
found 1 common ancestor(s):
2e913b2 initial git-gui

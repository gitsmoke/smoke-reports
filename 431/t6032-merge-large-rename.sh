...
expecting success: 
	...
	git tag initial
[master (root-commit) 14f0970] initial
...
HEAD is now at 14f0970 initial
[master 1643d85] add=5
 Author: A U Thor <author@example.com>
...
Deleted branch test5 (was 16f9e83).
HEAD is now at 14f0970 initial
[master e4c0778] add=5
 Author: A U Thor <author@example.com>
 5 files changed, 110 insertions(+), 0 deletions(-)
 create mode 100644 1
 create mode 100644 2
...
Deleted branch test5 (was c1f3efc).
HEAD is now at 14f0970 initial
[master e4c0778] add=5
 Author: A U Thor <author@example.com>
 5 files changed, 110 insertions(+), 0 deletions(-)
...
[simple-change 4ccef37] unrelated-change
 Author: A U Thor <author@example.com>
 0 files changed, 0 insertions(+), 0 deletions(-)

...
Committed revision 1.
	A	foo
r1 = 775ad9018facdd1bc8cd875c960b19c9bca39d07 (refs/remotes/git-svn)
...
[master 9f639d7] files for enabled auto-props
...
Committed r2
	...
	A	bar
	A	exec1.sh
r2 = 6dd8d1afdb504f3d7371d4005fce6417bbc0b097 (refs/remotes/git-svn)
...
[master 74c0665] files for disabled auto-props
 Author: A U Thor <author@example.com>
 3 files changed, 3 insertions(+), 0 deletions(-)
...
Committed r3
	...
	A	world.txt
	A	zot
r3 = 6171c6cd385022509662d4fc80f0b2a9479f5815 (refs/remotes/git-svn)
No changes between current HEAD and refs/remotes/git-svn
Resetting to the latest refs/remotes/git-svn
...
Committed r4
	D	foo
	A	foo.sh
r4 = 947c3a379d8ce08350b3cbae4dda68fa30e3f1bc (refs/remotes/git-svn)
No changes between current HEAD and refs/remotes/git-svn
Resetting to the latest refs/remotes/git-svn
D    foo
A    foo.sh

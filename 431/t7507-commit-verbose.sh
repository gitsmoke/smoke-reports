...
[master (root-commit) d1c1721] subject
...
[master 63e069a] This is an example commit message that contains a diff.
 Author: A U Thor <author@example.com>
 1 files changed, 1 insertions(+), 1 deletions(-)
...
[master 752da3b] This is an example commit message that contains a diff.
 Author: A U Thor <author@example.com>
 1 files changed, 1 insertions(+), 1 deletions(-)
--- diff	2011-01-08 04:02:53.000000000 +0000
+++ actual	2011-01-08 04:02:53.000000000 +0000
@@ -1,9 +1,2 @@

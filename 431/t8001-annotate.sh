...
[master (root-commit) b720080] Initial.
 Author: A <A@test.git>
...
Merging:
906bfaf Branch2-1
virtual 5e4b6bdc6fce7ac868355ac3eea473fcf53d8f01
...
expecting success: echo "evil merge." >>file &&
     git commit -a --amend
[branch2 cb535fd] Merge branch 'branch1' into branch2

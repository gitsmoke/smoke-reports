...
[master (root-commit) 8ba5356] Add A1
 Author: A U Thor <bogus_email_address>
 1 files changed, 1 insertions(+), 0 deletions(-)
 create mode 100644 A
[topic ca728d5] Add B1
 Author: A U Thor <bogus_email_address>
 1 files changed, 1 insertions(+), 0 deletions(-)
 create mode 100644 B
[master a7a39d3] Modify A2
 Author: A U Thor <bogus_email_address>
 1 files changed, 1 insertions(+), 0 deletions(-)
Cloning into clone1...
done.
...
Merge made by recursive.
 A |    1 +
 1 files changed, 1 insertions(+), 0 deletions(-)
[master 9ee1dae] Add different B
 Author: A U Thor <bogus_email_address>
 1 files changed, 1 insertions(+), 0 deletions(-)
 create mode 100644 B
Cloning into clone2...
...
[topic 2ecde18] Merge origin/master into topic
 Author: A U Thor <bogus_email_address>
[topic 5c5fe7f] Modify B2
 Author: A U Thor <bogus_email_address>
 1 files changed, 1 insertions(+), 0 deletions(-)
...
Rebasing (1/1)Merging:
5c5fe7f Modify B2
virtual 9ee1dae44a848de4a284dca430ae611c89135c17
found 1 common ancestor(s):
8ba5356 Add A1
Auto-merging B
CONFLICT (add/add): Merge conflict in B
...
B: needs merge
@@@ -1,1 -1,1 +1,1 @@@
[detached HEAD c1032fc] Merge origin/master into topic
 Author: A U Thor <bogus_email_address>
Rebasing (1/1)

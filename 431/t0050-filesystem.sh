...
[master (root-commit) 150f790] initial
 Author: A U Thor <author@example.com>
 0 files changed, 0 insertions(+), 0 deletions(-)
 create mode 100644 camelcase
[topic ca71c90] rename
 Author: A U Thor <author@example.com>
...
HEAD is now at 150f790 initial
Updating 150f790..ca71c90
Fast-forward
...
[master (root-commit) 4ebafc1] initial
 Author: A U Thor <author@example.com>
 0 files changed, 0 insertions(+), 0 deletions(-)
 create mode 100644 "a\314\210"
[topic 941c3cb] rename
 Author: A U Thor <author@example.com>
 1 files changed, 0 insertions(+), 0 deletions(-)
...
HEAD is now at 4ebafc1 initial
Updating 4ebafc1..941c3cb
Aborting

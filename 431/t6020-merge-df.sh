...
[master (root-commit) a5e10d3] initial
 Author: A U Thor <author@example.com>
 1 files changed, 1 insertions(+), 0 deletions(-)
 create mode 100644 init
[master 2133b21] File: dir/foo
 Author: A U Thor <author@example.com>
 1 files changed, 1 insertions(+), 0 deletions(-)
...
expecting success: 
	...
	git merge master
HEAD is now at ab87912 File: dir
[master 04695c1] first
 Author: A U Thor <author@example.com>
...
rm 'dir~B'
rm 'init'
[modify (root-commit) b7f087f] initial
 Author: A U Thor <author@example.com>
 1 files changed, 8 insertions(+), 0 deletions(-)
 create mode 100644 letters
[modify db90d34] modified
 Author: A U Thor <author@example.com>
 1 files changed, 1 insertions(+), 0 deletions(-)
rm 'letters'
[delete 9b2ff78] deleted
 Author: A U Thor <author@example.com>
...
HEAD is now at 9b2ff78 deleted

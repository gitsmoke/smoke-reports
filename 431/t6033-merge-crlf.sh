...
expecting success: 
	...
	git tag b &&
	git checkout master
[master (root-commit) 374adfe] Initial
 Author: A U Thor <author@example.com>
 1 files changed, 1 insertions(+), 0 deletions(-)
 create mode 100644 file
[master 238480a] add line from a
 Author: A U Thor <author@example.com>
 1 files changed, 1 insertions(+), 1 deletions(-)
[side 8b292f0] add line from b
 Author: A U Thor <author@example.com>
 1 files changed, 1 insertions(+), 1 deletions(-)
ok 1 - setup
...
HEAD is now at 374adfe Initial
Merge made by ours.
...
HEAD is now at 238480a add line from a
Merging:
238480a add line from a
virtual side

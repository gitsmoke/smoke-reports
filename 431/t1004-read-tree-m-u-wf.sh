...
[master (root-commit) d20d35d] initial
...
[master 34b32c0] master removes file2 and subdir/file2
 Author: A U Thor <author@example.com>
...
D	file2
D	subdir/file2
[side 8e6ff77] side adds file3 and removes file2
 Author: A U Thor <author@example.com>
...
HEAD is now at 34b32c0 master removes file2 and subdir/file2
...
expecting success: 
	...
	git checkout side-a
HEAD is now at 34b32c0 master removes file2 and subdir/file2
[side-a a0a7754] side-a changes file1
 Author: A U Thor <author@example.com>
 1 files changed, 1 insertions(+), 0 deletions(-)
[side-b a2e6b0f] side-b changes file2
 Author: A U Thor <author@example.com>
 1 files changed, 1 insertions(+), 0 deletions(-)
...
HEAD is now at a0a7754 side-a changes file1
...
HEAD is now at a0a7754 side-a changes file1
[sym-b 8b5c47f] side adds a/b
 Author: A U Thor <author@example.com>
 0 files changed, 0 insertions(+), 0 deletions(-)
 create mode 100644 a/b
[sym-a 69aa869] we add a/b
 Author: A U Thor <author@example.com>
 1 files changed, 1 insertions(+), 0 deletions(-)
...
HEAD is now at 69aa869 we add a/b
...
HEAD is now at 69aa869 we add a/b
[side-a fbf1be0] side-a changes file2 to directory
 Author: A U Thor <author@example.com>
...
HEAD is now at a2e6b0f side-b changes file2
Trying simple merge.
...
Merging:
a2e6b0f side-b changes file2
fbf1be0 side-a changes file2 to directory

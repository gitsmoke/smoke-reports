...
[master (root-commit) ed68251] Initial.
 Author: A <A@test.git>
...
Merging:
df65872 Branch2-1
virtual 0763b5673faf220a65f062f50693b831406a6ea6
...
expecting success: echo "evil merge." >>file &&
     git commit -a --amend
[branch2 ec95875] Merge branch 'branch1' into branch2

...
[master (root-commit) 980b27d] initial
...
Updating 980b27d..6aadfdf
Fast-forward
 file |    1 +
 1 files changed, 1 insertions(+), 0 deletions(-)
[master b2a65cf] third
 Author: A U Thor <author@example.com>
...
[master 2c78c9e] sixth.1
 Author: A U Thor <author@example.com>
 1 files changed, 1 insertions(+), 1 deletions(-)
[master 53d6476] sixth.2
 Author: A U Thor <author@example.com>
 1 files changed, 1 insertions(+), 0 deletions(-)
[master bf907e1] sixth.3
 Author: A U Thor <author@example.com>
 1 files changed, 1 insertions(+), 0 deletions(-)
...
bf907e1ddceff4a5172e1709cb62d8798de33719
[master 38a75b0] seventh
 Author: A U Thor <author@example.com>
 1 files changed, 1 insertions(+), 1 deletions(-)

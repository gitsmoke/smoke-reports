...
[master (root-commit) 776cb68] Initial commit.
 Author: A U Thor <author@example.com>
 1 files changed, 1 insertions(+), 0 deletions(-)
 create mode 100644 A
[master 0606b23] Second commit.
 Author: A U Thor <author@example.com>
 1 files changed, 1 insertions(+), 0 deletions(-)
...
Deleted branch s/t (was 0606b23).
...
Deleted branch my7 (was 0606b23).
...
0606b2367201284a8d319048a2e2886945850738
...
ok 56 - autosetuprebase always on detached HEAD

expecting success: 
	git config branch.autosetuprebase garbage &&
	test_must_fail git branch
ok 57 - detect misconfigured autosetuprebase (bad value)
expecting success: 
	git config --unset branch.autosetuprebase &&
...
ok 58 - detect misconfigured autosetuprebase (no value)

expecting success: 
	git checkout my9 &&
	git config --unset branch.my8.merge &&
	test_must_fail git branch -d my8
ok 59 - attempt to delete a branch without base and unmerged to HEAD
...
expecting success: 
	...
	git branch -d my8
Deleted branch my8 (was 0606b23).

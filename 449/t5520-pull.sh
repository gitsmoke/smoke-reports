...
[master (root-commit) f4bfdcc] original
...
[master 6d3008d] updated
 Author: A U Thor <author@example.com>
 1 files changed, 1 insertions(+), 1 deletions(-)
Your branch is behind 'master' by 1 commit, and can be fast-forwarded.
Updating f4bfdcc..6d3008d
Fast-forward
 file |    2 +-
 1 files changed, 1 insertions(+), 1 deletions(-)
...
[second 31de186] modified
 Author: A U Thor <author@example.com>
 1 files changed, 1 insertions(+), 1 deletions(-)
HEAD is now at f4bfdcc original
Updating f4bfdcc..31de186
Fast-forward
 file |    2 +-
 1 files changed, 1 insertions(+), 1 deletions(-)
...
HEAD is now at a4e5865 new file
First, rewinding head to replay your work on top of it...
Applying: new file
...
HEAD is now at 31de186 modified
[copy 299ea8b] conflict
 Author: A U Thor <author@example.com>
 1 files changed, 1 insertions(+), 1 deletions(-)
[to-rebase fca3960] to-rebase
 Author: A U Thor <author@example.com>
 1 files changed, 1 insertions(+), 1 deletions(-)
First, rewinding head to replay your work on top of it...
Applying: new file
...
HEAD is now at fca3960 to-rebase
First, rewinding head to replay your work on top of it...
Applying: new file
Applying: to-rebase
...
[master (root-commit) e55d50a] Initial revision
 Author: A U Thor <author@example.com>
...
[master 7036634] 5->43
 Author: A U Thor <author@example.com>
 1 files changed, 1 insertions(+), 1 deletions(-)
[master f731e69] Make it bigger
 Author: A U Thor <author@example.com>
 1 files changed, 1 insertions(+), 1 deletions(-)
[master 058dd4b] Independent discovery of 5->43
 Author: A U Thor <author@example.com>
 1 files changed, 1 insertions(+), 1 deletions(-)
...
HEAD is now at f731e69 Make it bigger
Cloning into bare repository src-replace.git
done.
[master bc555ac] Change 2
 Author: A U Thor <author@example.com>
 1 files changed, 2 insertions(+), 2 deletions(-)
[master b5c8ade] Change 3
 Author: A U Thor <author@example.com>
 1 files changed, 2 insertions(+), 2 deletions(-)
[master 70782fe] Change 4
 Author: A U Thor <author@example.com>
 1 files changed, 3 insertions(+), 3 deletions(-)
[master bc15f85] Modified Change 4
 Author: A U Thor <author@example.com>
 1 files changed, 3 insertions(+), 3 deletions(-)

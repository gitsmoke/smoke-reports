...
[master (root-commit) 3f07c73] initial
...
Merging:
9670154 addition
virtual e0ae62b9d4bc69a2eb2a9d31c8a7d908710e8cf0
...
[master (root-commit) a6ec33a] initial
 Author: A U Thor <author@example.com>
 1 files changed, 1 insertions(+), 0 deletions(-)
 create mode 100644 file1

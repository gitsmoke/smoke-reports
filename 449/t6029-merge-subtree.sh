...
expecting success: 
	...
	git add hello &&
	git commit -m master
[master (root-commit) 3646af0] initial
...
[master (root-commit) f8d5ac7] initial git-gui
 Author: A U Thor <author@example.com>
 1 files changed, 1 insertions(+), 0 deletions(-)
...
[master (root-commit) 32bf56f] initial git
 Author: A U Thor <author@example.com>
 1 files changed, 1 insertions(+), 0 deletions(-)
...
Updating gui
[master cd5492d] Merge git-gui as our subdirectory
 Author: A U Thor <author@example.com>
...
M	git-gui.sh
[master2 1b17e88] update git-gui
 Author: A U Thor <author@example.com>
 1 files changed, 1 insertions(+), 1 deletions(-)
Merging:
cd5492d Merge git-gui as our subdirectory
virtual 1b17e88c57f3315dc6b7017dd03f517cc09c6287
found 1 common ancestor(s):
f8d5ac7 initial git-gui
Merge made by subtree.
...
HEAD is now at cd5492d Merge git-gui as our subdirectory
Already up-to-date.
[master2 156daba] Merge git-gui2 as our subdirectory
 Author: A U Thor <author@example.com>
 1 files changed, 1 insertions(+), 0 deletions(-)
...
HEAD is now at 156daba Merge git-gui2 as our subdirectory
Merging:
156daba Merge git-gui2 as our subdirectory
virtual 1b17e88c57f3315dc6b7017dd03f517cc09c6287
found 1 common ancestor(s):
f8d5ac7 initial git-gui

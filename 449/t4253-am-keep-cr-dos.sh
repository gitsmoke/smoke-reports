...
[master (root-commit) c8f3dbf] Initial
 Author: A U Thor <author@example.com>
 1 files changed, 1 insertions(+), 0 deletions(-)
 create mode 100644 file
[master f126646] Second
 Author: A U Thor <author@example.com>
 1 files changed, 1 insertions(+), 0 deletions(-)
[master 1f9b9d8] Third
 Author: A U Thor <author@example.com>
 1 files changed, 1 insertions(+), 0 deletions(-)
...
0001-Second.patch
0002-Third.patch
[dosfiles-keep-cr-continue fb58720] different patch
 Author: A U Thor <author@example.com>
 1 files changed, 1 insertions(+), 0 deletions(-)
Applying: Second
Using index info to reconstruct a base tree...
...
[unixfiles-conf-keepcr-override bd92a8c] line ending to unix
 Author: A U Thor <author@example.com>

...
git checkout master
[master (root-commit) a813f29] initial has A and M
 Author: A U Thor <author@example.com>
 2 files changed, 30 insertions(+), 0 deletions(-)
 create mode 100644 A
 create mode 100644 M
[master 092ea49] master updates A
 Author: A U Thor <author@example.com>
 1 files changed, 1 insertions(+), 1 deletions(-)
[yellow 19171cd] yellow removes M
 Author: A U Thor <author@example.com>
 1 files changed, 0 insertions(+), 15 deletions(-)
 delete mode 100644 M
[white 65494fc] white renames A->B, M->N
 Author: A U Thor <author@example.com>
 2 files changed, 2 insertions(+), 2 deletions(-)
 rename A => B (93%)
 rename M => N (93%)
[red 121fc8c] red renames A->B, M->N
 Author: A U Thor <author@example.com>
 2 files changed, 2 insertions(+), 2 deletions(-)
 rename A => B (93%)
 rename M => N (93%)
[blue 785255c] blue renames A->C, M->N
 Author: A U Thor <author@example.com>
 2 files changed, 2 insertions(+), 2 deletions(-)
 rename A => C (93%)
 rename M => N (93%)
...
Merging:
092ea49 master updates A
virtual 65494fc64691157caed9488933e33ccf8871874a
found 1 common ancestor(s):
a813f29 initial has A and M
Auto-merging B
...
HEAD is now at 092ea49 master updates A
Merging:
121fc8c red renames A->B, M->N
virtual 65494fc64691157caed9488933e33ccf8871874a
found 1 common ancestor(s):
a813f29 initial has A and M
Auto-merging B
...
expecting success: 
	...
	git diff --exit-code white N
HEAD is now at 121fc8c red renames A->B, M->N
! [blue] blue renames A->C, M->N
 ! [change] changed
  ! [change+rename] changed and renamed
   ! [master] master updates A
...
Merging:
121fc8c red renames A->B, M->N
virtual 092ea4939324351e3d98f62ce9f5d07a1e23c541
found 1 common ancestor(s):
a813f29 initial has A and M
Auto-merging B
CONFLICT (content): Merge conflict in B
...
Merging:
121fc8c red renames A->B, M->N
virtual 785255c34ca9e32841a52be2d50a6811ab3e17e1
found 1 common ancestor(s):
a813f29 initial has A and M
Skipped N (merged same as existing)
CONFLICT (rename/rename): Rename "A"->"B" in branch "HEAD" rename "A"->"C" in "785255c34ca9e32841a52be2d50a6811ab3e17e1"
Automatic merge failed; fix conflicts and then commit the result.
g : red changes a line
...
+++++*+ [change+rename^] initial has A and M
Merging:
65494fc white renames A->B, M->N
virtual 121fc8c381476807085696cef7e3dd30b3743f18
found 1 common ancestor(s):
a813f29 initial has A and M
Auto-merging B
CONFLICT (content): Merge conflict in B
...
HEAD is now at 65494fc white renames A->B, M->N
...
Merging:
092ea49 master updates A
virtual 19171cd1c704172397ecb73638742d2510da5c40
found 1 common ancestor(s):
a813f29 initial has A and M
Removing M
...
HEAD is now at 092ea49 master updates A
Updated tag 'anchor' (was 092ea49)
! [blue] blue renames A->C, M->N
 ! [change] changed
  ! [change+rename] changed and renamed
   ! [master] master updates A
...
Merge made by recursive.
 A |    2 +-
 1 files changed, 1 insertions(+), 1 deletions(-)
HEAD is now at 19171cd yellow removes M
...
HEAD is now at 263bffb changed and renamed
Skipped B (merged same as existing)
...
HEAD is now at f133a8c Merge branch 'change+rename' into change
rm 'B'
rm 'M'
[dir-in-way (root-commit) 9fcf240] Common commmit
 Author: A U Thor <author@example.com>
...
[dir-in-way 40ddf1e] Commit to merge, with dir in the way
 Author: A U Thor <author@example.com>
 2 files changed, 2 insertions(+), 0 deletions(-)
rm 'dir/file-in-the-way'
[dir-not-in-way 2b7f638] Commit to merge, with dir removed
 Author: A U Thor <author@example.com>
 2 files changed, 1 insertions(+), 1 deletions(-)
 delete mode 100644 dir/file-in-the-way
rm 'dir/file-in-the-way'
rm 'sub/file'
[renamed-file-has-no-conflicts 02ef200] Independent change
 Author: A U Thor <author@example.com>
 2 files changed, 1 insertions(+), 2 deletions(-)
 rename sub/file => dir (79%)
 delete mode 100644 dir/file-in-the-way
rm 'dir/file-in-the-way'
[renamed-file-has-conflicts a6585b4] Conflicting change
 Author: A U Thor <author@example.com>
 2 files changed, 1 insertions(+), 1 deletions(-)
...
HEAD is now at a6585b4 Conflicting change
Merging:
02ef200 Independent change
virtual dir-not-in-way
found 1 common ancestor(s):
9fcf240 Common commmit
...
HEAD is now at d302937 Merge branch 'dir-not-in-way' into HEAD
...
HEAD is now at 02ef200 Independent change
...
HEAD is now at 40ddf1e Commit to merge, with dir in the way
Merging:
a6585b4 Conflicting change
virtual dir-not-in-way
found 1 common ancestor(s):
9fcf240 Common commmit
Removing dir to make room for subdirectory; may re-add later.
...
HEAD is now at a6585b4 Conflicting change
Merging:
40ddf1e Commit to merge, with dir in the way
...
rm 'n.stages'
rm 'sub/file'
[rename-dest (root-commit) 5ef5806] Common commmit
 Author: A U Thor <author@example.com>
 1 files changed, 1 insertions(+), 0 deletions(-)
 create mode 100644 one/file
[rename-dest 17c9735] Renamed to destdir
 Author: A U Thor <author@example.com>
 1 files changed, 0 insertions(+), 0 deletions(-)
 rename one/file => destdir (100%)
rm 'one/file'
[source-conflict e9d543e] Conflicts in the way
 Author: A U Thor <author@example.com>
...
HEAD is now at e9d543e Conflicts in the way
Merging:
17c9735 Renamed to destdir
virtual source-conflict
found 1 common ancestor(s):
5ef5806 Common commmit
...
HEAD is now at 17c9735 Renamed to destdir
rm 'destdir'
[rename-two (root-commit) 1a55eec] Common commmit
 Author: A U Thor <author@example.com>
 2 files changed, 2 insertions(+), 0 deletions(-)
 create mode 100644 one/file
 create mode 100644 two/file
rm 'one/file'
[rename-two 495a42d] Rename two/file -> one
 Author: A U Thor <author@example.com>
 2 files changed, 0 insertions(+), 1 deletions(-)
 rename two/file => one (100%)
 delete mode 100644 one/file
rm 'two/file'
[rename-one 13056f8] Rename one/file -> two
 Author: A U Thor <author@example.com>
 2 files changed, 0 insertions(+), 1 deletions(-)
...
Merging:
13056f8 Rename one/file -> two
virtual rename-two
found 1 common ancestor(s):
1a55eec Common commmit
...
expecting success: 
	...
	test "other" = $(cat one) &&
	test "stuff" = $(cat two)
HEAD is now at 13056f8 Rename one/file -> two
Merging:
13056f8 Rename one/file -> two
virtual rename-two
found 1 common ancestor(s):
...
HEAD is now at 13056f8 Rename one/file -> two
rm 'two'
[first-rename (root-commit) b0d48a8] Common commmit
 Author: A U Thor <author@example.com>
 1 files changed, 1 insertions(+), 0 deletions(-)
 create mode 100644 original
[first-rename 4827310] Put two/file in the way, rename to one
 Author: A U Thor <author@example.com>
 1 files changed, 0 insertions(+), 0 deletions(-)
 rename original => one (100%)
 create mode 100644 two/file
[second-rename d3a61bc] Put one/file in the way, rename to two
 Author: A U Thor <author@example.com>
 1 files changed, 0 insertions(+), 0 deletions(-)
 create mode 100644 one/file
...
expecting success: 
	...
	! test -f original
Merging:
4827310 Put two/file in the way, rename to one
virtual second-rename
found 1 common ancestor(s):
b0d48a8 Common commmit
...
HEAD is now at 4827310 Put two/file in the way, rename to one
rm 'one'
rm 'two/file'
[first-rename-redo (root-commit) 59c1509] Common commmit
 Author: A U Thor <author@example.com>
 1 files changed, 1 insertions(+), 0 deletions(-)
 create mode 100644 one/file
 create mode 100644 original
 create mode 100644 two/file
rm 'one/file'
[first-rename-redo 6600da3] Rename to one
 Author: A U Thor <author@example.com>
 1 files changed, 0 insertions(+), 0 deletions(-)
 rename original => one (100%)
 delete mode 100644 one/file
rm 'two/file'
[second-rename-redo 5b26ffa] Rename to two
 Author: A U Thor <author@example.com>
 1 files changed, 0 insertions(+), 0 deletions(-)
 rename original => two (100%)
 delete mode 100644 two/file
...
expecting success: 
	...
	! test -f original
Merging:
6600da3 Rename to one
virtual second-rename-redo
found 1 common ancestor(s):
59c1509 Common commmit
Removing one to make room for subdirectory; may re-add later.
Removing two/file

...
r1 = 22e087d23f6c18977a5625ec1303128a2f26cb43 (refs/remotes/git-svn)
...
[mybranch 4938c6d] try a deep --rmdir with a commit
 ...
 rename dir/a/b/c/d/e/file => file (100%)
	...
	D	dir/a/
	A	dir/file
r2 = 0ab52c5a40ebfa3bb26bf3a5ca10c3ed89d12c96 (refs/remotes/git-svn)
...
[mybranch fb51384] detect node change from file to directory #1
 Author: A U Thor <author@example.com>
...
[mybranch2 a00e609] detect node change from directory to file #1
 Author: A U Thor <author@example.com>
 1 files changed, 0 insertions(+), 0 deletions(-)
...
[mybranch3 7a4612f] detect node change from file to directory #2
 Author: A U Thor <author@example.com>
...
[mybranch4 eb5b660] detect node change from directory to file #2
 Author: A U Thor <author@example.com>
 2 files changed, 1 insertions(+), 1 deletions(-)
...
[mybranch5 9a8046d] remove executable bit from a file
 Author: A U Thor <author@example.com>
 0 files changed, 0 insertions(+), 0 deletions(-)
 mode change 100755 => 100644 exec.sh
	M	exec.sh
	M	exec.sh
r3 = 93ff429a5294c021530bcd906a637db1572b7777 (refs/remotes/git-svn)
Done committing 1 revisions to SVN
...
expecting success: 
	...
	svn_cmd up "$SVN_TREE" &&
	test -x "$SVN_TREE"/exec.sh
[mybranch5 37c4ce9] add executable bit back file
 Author: A U Thor <author@example.com>
 0 files changed, 0 insertions(+), 0 deletions(-)
 mode change 100644 => 100755 exec.sh
	M	exec.sh
	M	exec.sh
r4 = 04b7313d5cc2690f47b3ec5c1f76391817d3e0c8 (refs/remotes/git-svn)
Done committing 1 revisions to SVN
UU   /Users/trast/git-smoke/t/trash directory.t9100-git-svn-basic/.git/svn/refs/remotes/git-svn/svn-tree/exec.sh
...
[mybranch5 50ea64a] executable file becomes a symlink to bar/zzz (file)
 Author: A U Thor <author@example.com>
 ...
 mode change 100755 => 120000
	T	exec.sh
	M	exec.sh
r5 = 50eb42c09cf23863e5862fbf15335828fb4b4c69 (refs/remotes/git-svn)
Done committing 1 revisions to SVN
UU   /Users/trast/git-smoke/t/trash directory.t9100-git-svn-basic/.git/svn/refs/remotes/git-svn/svn-tree/exec.sh
...
[mybranch5 11966b8] new symlink is added to a file that was also just made executable
 Author: A U Thor <author@example.com>
 ...
 create mode 120000 exec-2.sh
	...
	M	bar/zzz
	A	exec-2.sh
r6 = f739fd9f7e43d318e238515fabf0b9f108a428ae (refs/remotes/git-svn)
Done committing 1 revisions to SVN
...
[mybranch5 186b71f] modify a symlink to become a file
 Author: A U Thor <author@example.com>
 1 files changed, 1 insertions(+), 1 deletions(-)
 ...
 mode change 120000 => 100644
	T	exec-2.sh
	M	exec-2.sh
r7 = 9d13db2a2347c93ae0909a1d4c400adeb720f5e2 (refs/remotes/git-svn)
Done committing 1 revisions to SVN
...
expecting success: git svn init "$svnrepo" && git svn fetch &&
	...
	A	exec.sh
	A	dir/a/b/c/d/e/file
r1 = 22e087d23f6c18977a5625ec1303128a2f26cb43 (refs/remotes/alt)
	A	file
	D	dir/a/b/c/d/e/file
	D	dir/a/
	A	dir/file
r2 = 36fceed57f79cce8019f8a1cc48867c22a619ce1 (refs/remotes/alt)
	M	exec.sh
r3 = f314697f8f534123952283644ea0c87e44fc7537 (refs/remotes/alt)
	M	exec.sh
r4 = db8c58688619f65dd022b305b325d32a5b2777be (refs/remotes/alt)
	M	exec.sh
r5 = c758f1348395e0a0f1c4f8e7b7933b47ca8af18b (refs/remotes/alt)
	M	bar/zzz
	A	exec-2.sh
r6 = 006a35295f38f63d277540cc7cdfb4ecfb7b5a5e (refs/remotes/alt)
	M	exec-2.sh
r7 = 944828a295362c51c3ed3b2a94edd44bd6109b2b (refs/remotes/alt)
...
expecting success: 
	...
	A	zzz
r1 = 4ca41a6f7d5fa248278bb58cbacdecfac716b071 (refs/remotes/bar)
	M	zzz
r6 = bd56918afe3e3c93e8cbef5406ca6145d8cf95c7 (refs/remotes/bar)
[my-bar a772b1b] change 1
 Author: A U Thor <author@example.com>
 1 files changed, 1 insertions(+), 0 deletions(-)
 create mode 100644 foo
[my-bar 0aec51d] change 2
 Author: A U Thor <author@example.com>
 1 files changed, 1 insertions(+), 1 deletions(-)
...
Committed r8
	A	foo
r8 = 0b902ef573d701b05f55622e97e560c42134611e (refs/remotes/bar)
...
The rewritten commit is: 0b902ef573d701b05f55622e97e560c42134611e
    change 1
Deleted branch my-bar (was 0aec51d).
...
expecting success: 
	...
	A	bar/foo
r8 = 8c2c1d64f2d19d451b3ed16e1104a9f11923efea (refs/remotes/alt)
[my-bar 3dafdf9] /bar/d should be in the log
 Author: A U Thor <author@example.com>
 1 files changed, 1 insertions(+), 0 deletions(-)
...
Committed r9
	A	d
r9 = 64c095e9275c53e85d16afd90d3c571008bb236d (refs/remotes/bar)
No changes between current HEAD and refs/remotes/bar
Resetting to the latest refs/remotes/bar
[my-bar 9cd6f68] add a new directory
 Author: A U Thor <author@example.com>
 1 files changed, 1 insertions(+), 0 deletions(-)
...
Committed r10
	A	newdir/dir
r10 = 85ca43d55335c1db8c8c650087c34cc4267a03bf (refs/remotes/bar)
No changes between current HEAD and refs/remotes/bar
Resetting to the latest refs/remotes/bar
[my-bar 5d0d6b6] modify a file in new directory
 Author: A U Thor <author@example.com>
 1 files changed, 1 insertions(+), 0 deletions(-)
Committing to file:///Users/trast/git-smoke/t/trash directory.t9100-git-svn-basic/svnrepo/bar ...
	M	newdir/dir
Committed r11
	M	newdir/dir
r11 = 202556353c4935c00fcf7de710ef6ad55c23356a (refs/remotes/bar)
No changes between current HEAD and refs/remotes/bar
Resetting to the latest refs/remotes/bar
...
[my-bar 3b6ed90] commit-new-file-foo2
 Author: A U Thor <author@example.com>
 1 files changed, 1 insertions(+), 0 deletions(-)
...
Committed r12
	A	foo2
r12 = 49c7160c53e40d98682c20e824b5b66c5d6fe463 (refs/remotes/bar)
No changes between current HEAD and refs/remotes/bar
Resetting to the latest refs/remotes/bar
...
[my-bar f792b65] update /bar/d
 Author: A U Thor <author@example.com>
 1 files changed, 1 insertions(+), 1 deletions(-)
	M	d
	M	d
r13 = 3ded84a8536fe983e16c44cbe3887f0ea3a3f117 (refs/remotes/bar)
Done committing 1 revisions to SVN
...
r8 = 8c2c1d64f2d19d451b3ed16e1104a9f11923efea (refs/remotes/alt)
	A	bar/d
r9 = 2741c1cfa98c008dfc7cbd72b486569be6334c8e (refs/remotes/alt)
	A	bar/newdir/dir
r10 = 27b1b0017447a7d4ae80d58ba4136234208204ab (refs/remotes/alt)
	M	bar/newdir/dir
r11 = 55147bb3aae4c18efb18d9b43a1ececabe11d77c (refs/remotes/alt)
	A	bar/foo2
r12 = 38547ce48b779730ae6a5d1fc2d3651b019c4021 (refs/remotes/alt)
	M	bar/d
r13 = fd9d59d9d354dcb3decb94f0bcc73f625df29f98 (refs/remotes/alt)

...
expecting success: 
	...
	echo other >four &&
	echo other >five
[master (root-commit) 96d8c0b] First
 Author: A U Thor <author@example.com>
 1 files changed, 1 insertions(+), 0 deletions(-)
 create mode 100644 one
[branch 496558b] Second
 Author: A U Thor <author@example.com>
...
expecting success: 
	...
	git reset --hard HEAD^
Updating 96d8c0b..496558b
Aborting
[master 469abae] empty
 Author: A U Thor <author@example.com>
Aborting
HEAD is now at 96d8c0b First
...
[master (root-commit) 802b3aa] init
 Author: A U Thor <author@example.com>
...
rm 'rep/foo'
rm 'rep2/foo'
[branch 9776971] added test as a file
 Author: A U Thor <author@example.com>

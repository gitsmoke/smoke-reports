...
[master (root-commit) d63dca0] added file1
 Author: A U Thor <author@example.com>
 2 files changed, 2 insertions(+), 0 deletions(-)
 create mode 100644 file1
 create mode 100644 subdir/file3
[branch1 d9e37c6] branch1 changes
 Author: A U Thor <author@example.com>
 3 files changed, 3 insertions(+), 2 deletions(-)
 create mode 100644 file2
[master cb23091] master updates
 Author: A U Thor <author@example.com>
 3 files changed, 3 insertions(+), 2 deletions(-)
 create mode 100644 file2
...
[test1 74201ab] branch1 resolved with mergetool
 Author: A U Thor <author@example.com>
...
x")" &&
    ...
    git reset --hard
[test2 574fad2] branch1 resolved with mergetool - autocrlf
 Author: A U Thor <author@example.com>
HEAD is now at 574fad2 branch1 resolved with mergetool - autocrlf
...
[test3 6d3d38c] branch1 resolved with mergetool - subdir
 Author: A U Thor <author@example.com>
...
HEAD is now at d9e37c6 branch1 changes
...
Normal merge conflict for 'subdir/file3':
  {local}: modified
  {remote}: modified
[test4 ad2e7e4] branch2 resolved by mergetool from subdir
 Author: A U Thor <author@example.com>

...
[master (root-commit) 2ff3a58] Initial commit.
...
expecting success: git branch g/h &&
     ...
     git pack-refs --all &&
     git branch -d g
Deleted branch g/h (was 2ff3a58).
Deleted branch g (was 2ff3a58).
...
expecting success: git branch k/l &&
     ...
     git branch -d k/lm &&
     git branch k
Deleted branch k/l (was 2ff3a58).
Deleted branch k/l/m (was 2ff3a58).
Deleted branch k/lm (was 2ff3a58).
...
expecting success: git branch n/o &&
     ...
     git branch -d n/o/p &&
     git branch n
Deleted branch n/o (was 2ff3a58).
Deleted branch n/op (was 2ff3a58).
Deleted branch n/o/p (was 2ff3a58).

...
Committed revision 1.
	A	foo
r1 = 52cc55384477b0ed47e17922bb64f24d50a2dc56 (refs/remotes/git-svn)
...
[master 57fbe0b] files for enabled auto-props
...
Committed r2
	...
	A	bar
	A	exec1.sh
r2 = 25e87087fbcf36ba0ff2df8c0caf3dc160a88a7f (refs/remotes/git-svn)
...
[master e4af3b8] files for disabled auto-props
 Author: A U Thor <author@example.com>
 3 files changed, 3 insertions(+), 0 deletions(-)
...
Committed r3
	...
	A	world.txt
	A	zot
r3 = 53f59529a73cb803c4d5c2739e6c35ca2bc708ec (refs/remotes/git-svn)
No changes between current HEAD and refs/remotes/git-svn
Resetting to the latest refs/remotes/git-svn
...
Committed r4
	D	foo
	A	foo.sh
r4 = e5bc3d3a13f2821843d386936aac674b395fc687 (refs/remotes/git-svn)
No changes between current HEAD and refs/remotes/git-svn
Resetting to the latest refs/remotes/git-svn
D    foo
A    foo.sh

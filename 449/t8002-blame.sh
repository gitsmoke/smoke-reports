...
[master (root-commit) 0d2c460] Initial.
 Author: A <A@test.git>
...
Merging:
184efc2 Branch2-1
virtual 9c1c7fba08b1f25cef9366060df83a34b3cda361
...
expecting success: echo "evil merge." >>file &&
     git commit -a --amend
[branch2 8ec9826] Merge branch 'branch1' into branch2

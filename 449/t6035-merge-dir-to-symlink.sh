...
expecting success: 
	...
	git commit -m "untracked symlink remains" &&
	 ...
	 test -f a/b-2/c/d
HEAD is now at 731ece0 dir to symlink
rm 'a/b'
[detached HEAD 63ecffa] untracked symlink remains
 Author: A U Thor <author@example.com>
...
HEAD is now at cf85413 base
[detached HEAD 9721d81] x
 Author: A U Thor <author@example.com>
 1 files changed, 1 insertions(+), 0 deletions(-)
...
HEAD is now at 007e02c Merge branch 'master' into HEAD
Merging:
9721d81 x
virtual master
...
HEAD is now at 657d9e7 Merge commit 'baseline^0' into HEAD
Merging:
731ece0 dir to symlink
virtual baseline^0
found 1 common ancestor(s):
cf85413 base
...
HEAD is now at 9721d81 x
[detached HEAD c70e2f6] dir a/b-2 to symlink
 Author: A U Thor <author@example.com>
...
HEAD is now at c70e2f6 dir a/b-2 to symlink
Trying really trivial in-index merge...
Nope.
Trying simple merge.
Simple merge failed, trying Automatic merge.
...
expecting success: 
	...
	test -h a/b-2 &&
	test -f a/b/c/d
HEAD is now at efc0c19 Merge commit 'test2' into HEAD
Merging:
9721d81 x
virtual test2
found 1 common ancestor(s):

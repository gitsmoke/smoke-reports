...
expecting success: 
	...
	git tag b &&
	git checkout master
[master (root-commit) 56e4856] Initial
 Author: A U Thor <author@example.com>
 1 files changed, 1 insertions(+), 0 deletions(-)
 create mode 100644 file
[master 559301d] add line from a
 Author: A U Thor <author@example.com>
 1 files changed, 1 insertions(+), 1 deletions(-)
[side 6c2e860] add line from b
 Author: A U Thor <author@example.com>
 1 files changed, 1 insertions(+), 1 deletions(-)
...
HEAD is now at 56e4856 Initial
Merge made by ours.
...
HEAD is now at 559301d add line from a
Merging:
559301d add line from a
virtual side

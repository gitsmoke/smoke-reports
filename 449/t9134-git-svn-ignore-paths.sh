...
Initialized empty Git repository in /Users/trast/git-smoke/t/trash directory.t9134-git-svn-ignore-paths/g/.git/
	A	qqq/test_qqq.txt
r1 = 1d83e6d8cc56c527fbe10d4f6a7fc0509f8e6041 (refs/remotes/git-svn)
r2 = e12785e603508d5261f63f40c0b8cce19d6fd8e4 (refs/remotes/git-svn)
...
" > expect &&
	...
	M	qqq/test_qqq.txt
r3 = 448cafd617986d1da9f2fa897b7ed50117d4a58c (refs/remotes/git-svn)
...
r4 = b6a489e53bc9e4e2d734c2d62bc3cfa8ffb4216d (refs/remotes/git-svn)
First, rewinding head to replay your work on top of it...
Fast-forwarded master to refs/remotes/git-svn.
...
" > expect &&
	...
	M	qqq/test_qqq.txt
r5 = c8130f5068b3196291827dbf1a7949f143e712b8 (refs/remotes/git-svn)
First, rewinding head to replay your work on top of it...
Fast-forwarded master to refs/remotes/git-svn.

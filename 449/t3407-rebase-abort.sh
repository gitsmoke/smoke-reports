...
[master dbe9cf6] c
 Author: A U Thor <author@example.com>
 1 files changed, 1 insertions(+), 1 deletions(-)
[to-rebase 3b378d7] merge should fail on this
 Author: A U Thor <author@example.com>
 1 files changed, 1 insertions(+), 1 deletions(-)
[to-rebase fcdf8e1] merge should fail on this, too
 Author: A U Thor <author@example.com>
 1 files changed, 1 insertions(+), 1 deletions(-)
...
HEAD is now at fcdf8e1 merge should fail on this, too
...
Merging HEAD with merge should fail on this, too
Merging:
b24340e merge should fail on this
virtual merge should fail on this, too
found 1 common ancestor(s):
virtual f788de73cfc81f8d734fa7efc658cc63ca083f50
Auto-merging a
...
Merging:
dbe9cf6 c
3b378d7 merge should fail on this
found 1 common ancestor(s):
4e800b7 a
Auto-merging a
CONFLICT (content): Merge conflict in a
...
Merging:
dbe9cf6 c
fcdf8e1 merge should fail on this, too
found 1 common ancestor(s):
3b378d7 merge should fail on this
Auto-merging a
CONFLICT (content): Merge conflict in a
...
Auto-merging a
CONFLICT (content): Merge conflict in a
[detached HEAD 0a8fb76] merge should fail on this
 Author: A U Thor <author@example.com>
 1 files changed, 1 insertions(+), 0 deletions(-)
Committed: 0001 merge should fail on this
Merging master with HEAD~0
Merging:
0a8fb76 merge should fail on this
fcdf8e1 merge should fail on this, too
found 1 common ancestor(s):
3b378d7 merge should fail on this
Auto-merging a

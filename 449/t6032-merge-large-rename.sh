...
[master (root-commit) 923d2d5] initial
...
HEAD is now at 923d2d5 initial
[master 5ae4991] add=5
 Author: A U Thor <author@example.com>
...
Deleted branch test5 (was 201d31d).
HEAD is now at 923d2d5 initial
[master 957e8d1] add=5
 Author: A U Thor <author@example.com>
 5 files changed, 110 insertions(+), 0 deletions(-)
 create mode 100644 1
 create mode 100644 2
...
Deleted branch test5 (was 7e19359).
HEAD is now at 923d2d5 initial
[master 957e8d1] add=5
 Author: A U Thor <author@example.com>
 5 files changed, 110 insertions(+), 0 deletions(-)
...
[simple-change dc3f7a6] unrelated-change
 Author: A U Thor <author@example.com>
 0 files changed, 0 insertions(+), 0 deletions(-)

...
[master 3b77263] Test: Remove, add and update
 Author: A U Thor <author@example.com>
...
[master 1f1fa7a] generatiion 1
 Author: A U Thor <author@example.com>
 1 files changed, 0 insertions(+), 0 deletions(-)
[master a8b504f] generation 2
 Author: A U Thor <author@example.com>
 1 files changed, 0 insertions(+), 0 deletions(-)
Checking if patch will apply
Applying
...
HEAD is now at 3b77263 Test: Remove, add and update
[master 9460559] test: remove only a binary file
 Author: A U Thor <author@example.com>
 1 files changed, 0 insertions(+), 0 deletions(-)
...
[master d9f95ab] test: remove only a binary file
 Author: A U Thor <author@example.com>
...
[master e7c0338] Update with spaces
 Author: A U Thor <author@example.com>
 2 files changed, 1 insertions(+), 0 deletions(-)
Checking if patch will apply
Applying
...
[master e9a1e7c] Update one
 Author: A U Thor <author@example.com>
 1 files changed, 1 insertions(+), 0 deletions(-)
[master a0596ec] Update two
 Author: A U Thor <author@example.com>
 1 files changed, 1 insertions(+), 0 deletions(-)
Checking if patch will apply
Applying
...
[master 49e92a2] Add release notes
 Author: A U Thor <author@example.com>
 1 files changed, 1 insertions(+), 0 deletions(-)
...
initial revision: 1.1
Committed successfully to CVS
[master e7e0678] Add two files with the same basename
 Author: A U Thor <author@example.com>
...
[master 6cefb15] Added attic_gremlin
 Author: A U Thor <author@example.com>
 1 files changed, 1 insertions(+), 0 deletions(-)
...
[master 8ba40e5] Add a file with a leading space
 Author: A U Thor <author@example.com>
 1 files changed, 1 insertions(+), 0 deletions(-)
...
[master (root-commit) 43c3508] fake initial commit
 Author: A U Thor <author@example.com>
 1 files changed, 1 insertions(+), 0 deletions(-)
 create mode 100644  space
[master 9478426] Another change
 Author: A U Thor <author@example.com>
 1 files changed, 1 insertions(+), 0 deletions(-)
Checking if patch will apply
Applying

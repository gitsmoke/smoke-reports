...
[master (root-commit) ebe160f] initial
...
[other bc08f3d] changesimplefile
 Author: A U Thor <author@example.com>
 1 files changed, 1 insertions(+), 0 deletions(-)
rm 'sub1'
[main 543df59] changefiletodir
 Author: A U Thor <author@example.com>

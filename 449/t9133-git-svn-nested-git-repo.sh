...
Initialized empty Git repository in /Users/trast/git-smoke/t/trash directory.t9133-git-svn-nested-git-repo/g/.git/
	A	a
r1 = e5b3a4842a8415f44c51796901295ed7323c57d3 (refs/remotes/git-svn)
r2 = dbe36e8a9f7d14ed575a125f6a77ebec0c78a001 (refs/remotes/git-svn)
...
expecting success: 
	...
	M	a
r3 = 805608a4d874bb92e7cbc61ff0dfcbe3fb0d23ca (refs/remotes/git-svn)
...
[master (root-commit) 35f6ac8] add a inside an SVN repo
 Author: A U Thor <author@example.com>
 1 files changed, 2 insertions(+), 0 deletions(-)
 create mode 100644 a
commit 35f6ac8383a01df282987744ead8b26777510ecf
Author: A U Thor <author@example.com>
Date:   Thu Jan 13 04:10:13 2011 +0000
...
A         .git/objects/35
A  (bin)  .git/objects/35/f6ac8383a01df282987744ead8b26777510ecf
A         .git/objects/42
...
Adding         .git/objects/35
Adding  (bin)  .git/objects/35/f6ac8383a01df282987744ead8b26777510ecf
...
r4 = 7ca23d2f9cc80d7b377767bb1de1b757fff90fed (refs/remotes/git-svn)
First, rewinding head to replay your work on top of it...
Fast-forwarded master to refs/remotes/git-svn.
...
[master 3bf0268] add a inside an SVN repo
 Author: A U Thor <author@example.com>
...
expecting success: 
	...
	M	a
r5 = b608ca6f85d7dd11e6da22800f118504d76c88cb (refs/remotes/git-svn)
First, rewinding head to replay your work on top of it...
Fast-forwarded master to refs/remotes/git-svn.

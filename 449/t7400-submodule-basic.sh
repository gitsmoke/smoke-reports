...
expecting success: 
	...
	git branch initial
[master (root-commit) 962fb35] initial commit
...
[master (root-commit) 065660f] submodule commit 1
 Author: A U Thor <author@example.com>
...
[master (root-commit) 6f36837] Ignore everything
 Author: A U Thor <author@example.com>
 1 files changed, 1 insertions(+), 0 deletions(-)
...
rev1: 065660ff27cd8dcae6633797cdbdc118d08cefbc
...
-065660ff27cd8dcae6633797cdbdc118d08cefbc init
...
Submodule path 'init': checked out '065660ff27cd8dcae6633797cdbdc118d08cefbc'
...
expecting success: 
 ...
 065660ff27cd8dcae6633797cdbdc118d08cefbc init (rev-1)
...
[detached HEAD 9f26499] submodule commit 2
 Author: A U Thor <author@example.com>
 1 files changed, 1 insertions(+), 0 deletions(-)
 create mode 100644 b
+9f26499f94d9d3d019cdf3758514e1d085d83974 init (rev-1-1-g9f26499)
...
+Subproject commit 9f26499f94d9d3d019cdf3758514e1d085d83974
...
[detached HEAD 3916b6a] change subproject
 Author: A U Thor <author@example.com>
 1 files changed, 1 insertions(+), 0 deletions(-)
 create mode 100644 s
[master 0552358] change init
 Author: A U Thor <author@example.com>
...
Submodule path 'init': checked out '3916b6afb0b1b02fa2bc2eed22b5f39f0ad8c4f0'
...
HEAD is now at 912d450 super commit 1
...
HEAD is now at 912d450 super commit 1
[second 91f2a01] commit subproject
 Author: A U Thor <author@example.com>
 1 files changed, 1 insertions(+), 1 deletions(-)
diff --git a/init b/init
index 3916b6a..bc17b5c 160000
--- a/init
+++ b/init
@@ -1 +1 @@
-Subproject commit 3916b6afb0b1b02fa2bc2eed22b5f39f0ad8c4f0
+Subproject commit bc17b5cf546897d798a89f69d0584ccf8370e426
...
expecting success: 
	...
	test ! -d init &&
	git checkout second
HEAD is now at 91f2a01 commit subproject
...
[master (root-commit) 25e1552] repo commit 1
 Author: A U Thor <author@example.com>
 1 files changed, 1 insertions(+), 0 deletions(-)

...
expecting success: 
	...
	echo happy.
[master (root-commit) fb7ed72] initial
...
expecting success: 
	...
	git reset --hard HEAD^
HEAD is now at fb7ed72 initial
...
[master 79ebcf9] Add .gitattributes
 Author: A U Thor <author@example.com>
...
[master 7469831] initial
 Author: A U Thor <author@example.com>
 1 files changed, 1 insertions(+), 0 deletions(-)
[master 2eac29d] second
 Author: A U Thor <author@example.com>
...
[master 68e406b] alllf, allcrlf and mixed only
 Author: A U Thor <author@example.com>

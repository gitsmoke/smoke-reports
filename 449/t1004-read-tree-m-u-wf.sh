...
[master (root-commit) 9a342d4] initial
...
[master 5774287] master removes file2 and subdir/file2
 Author: A U Thor <author@example.com>
...
D	file2
D	subdir/file2
[side 941d5bb] side adds file3 and removes file2
 Author: A U Thor <author@example.com>
...
HEAD is now at 5774287 master removes file2 and subdir/file2
...
expecting success: 
	...
	git checkout side-a
HEAD is now at 5774287 master removes file2 and subdir/file2
[side-a 4175662] side-a changes file1
 Author: A U Thor <author@example.com>
 1 files changed, 1 insertions(+), 0 deletions(-)
[side-b 79e1bb1] side-b changes file2
 Author: A U Thor <author@example.com>
 1 files changed, 1 insertions(+), 0 deletions(-)
...
HEAD is now at 4175662 side-a changes file1
...
HEAD is now at 4175662 side-a changes file1
[sym-b e7b7d06] side adds a/b
 Author: A U Thor <author@example.com>
 0 files changed, 0 insertions(+), 0 deletions(-)
 create mode 100644 a/b
[sym-a 9b2de71] we add a/b
 Author: A U Thor <author@example.com>
 1 files changed, 1 insertions(+), 0 deletions(-)
...
HEAD is now at 9b2de71 we add a/b
...
HEAD is now at 9b2de71 we add a/b
[side-a 9d5ec29] side-a changes file2 to directory
 Author: A U Thor <author@example.com>
...
HEAD is now at 79e1bb1 side-b changes file2
Trying simple merge.
...
Merging:
79e1bb1 side-b changes file2
9d5ec29 side-a changes file2 to directory

...
[master (root-commit) 6a7edaa] commit
...
Unstaged changes after reset:
M	file
[master 0033e90] commit
 Author: A U Thor <author@example.com>
 1 files changed, 1 insertions(+), 1 deletions(-)
HEAD is now at 6a7edaa commit
...
[master 8e81682] clear local changes
 Author: A U Thor <author@example.com>
 1 files changed, 1 insertions(+), 0 deletions(-)
...
expecting success: 
	...
	git diff --cached >diff &&
	test_cmp expected diff
HEAD is now at 8e81682 clear local changes
[master d86660b] non-empty
 Author: A U Thor <author@example.com>
 1 files changed, 1 insertions(+), 0 deletions(-)
...
HEAD is now at d86660b non-empty
[master 9470dcc] empty
 Author: A U Thor <author@example.com>

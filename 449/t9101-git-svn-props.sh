...
expecting success: git svn fetch
	...
	A	ne_crlf
	A	empty
r1 = dc73ca313276fd9f72f521f9794e57abb0db7268 (refs/remotes/git-svn)
	M	kw.c
r2 = 332b6fb92310cddf705fb30b5591366bfc25ecaa (refs/remotes/git-svn)
	M	kw.c
r3 = 10d5ae716daab44440e893080ab40cdfbe808fa3 (refs/remotes/git-svn)
	M	kw.c
r4 = 8a97b364eb5112530004a8083809471a27bf87da (refs/remotes/git-svn)
...
[mybranch 136ffeb] test keywords ignoring
 Author: A U Thor <author@example.com>
 1 files changed, 1 insertions(+), 0 deletions(-)
	M	kw.c
	M	kw.c
r5 = 1c1364a560871bf5aba277538b0820da792a92e5 (refs/remotes/git-svn)
Done committing 1 revisions to SVN
Updating 136ffeb..1c1364a
Fast-forward
...
expecting success: git svn fetch &&
	...
	M	ne_crlf
	M	empty
r6 = f933d8701b893f12eff2acb97e041e3f15e7261d (refs/remotes/git-svn)
Updating 1c1364a..f933d87
Fast-forward
 crlf    |    3 +--
 ne_crlf |    3 +--
...
expecting success: git svn fetch && git pull . ${remotes_git_svn}
	M	cr
	M	ne_cr
r7 = abd3fa3fe8077784a2fb7e14555d85f124e51cf5 (refs/remotes/git-svn)
Updating f933d87..abd3fa3
Fast-forward
 cr    |    4 +++-
 ne_cr |    4 +++-
...
expecting success: 
	...
	A	deeply/nested/directory/.keep
r8 = 28268f01a165bca3c865071569a468bc0bdb7fd6 (refs/remotes/git-svn)
Updating abd3fa3..28268f0
Fast-forward

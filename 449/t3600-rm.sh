...
[master (root-commit) bcaa3e7] add normal files
...
[master 107edf7] add files with tabs and newlines
 Author: A U Thor <author@example.com>
 0 files changed, 0 insertions(+), 0 deletions(-)
...
[master c737954] add file for rm test
 Author: A U Thor <author@example.com>
...
[master 4961e0a] remove file from rm test
 Author: A U Thor <author@example.com>
...
[master 3652229] add file for rm --quiet test
 Author: A U Thor <author@example.com>
 1 files changed, 1 insertions(+), 0 deletions(-)
 create mode 100644 test-file
[master 5414056] remove file from rm --quiet test
 Author: A U Thor <author@example.com>
 1 files changed, 0 insertions(+), 1 deletions(-)
 delete mode 100644 test-file
...
[master (root-commit) 667b87d] add a file
 Author: A U Thor <author@example.com>
 1 files changed, 1 insertions(+), 0 deletions(-)
...
HEAD is now at ff5a03c subdir test
rm 'frotz/nitfol'

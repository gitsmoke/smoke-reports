...
Merging:
184efc2 Branch2-1
virtual a87cf599503cb40de36d087c6706a5ef9f21b7fb
...
expecting success: echo "evil merge." >>file &&
     git commit -a --amend
[branch2 fe39a8e] Merge branch 'branch1' into branch2

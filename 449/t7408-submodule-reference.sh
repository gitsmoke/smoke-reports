...
[master (root-commit) f7482d0] A-initial
...
[master (root-commit) 017b2ce] B-super-initial
 Author: A U Thor <author@example.com>
 1 files changed, 1 insertions(+), 0 deletions(-)
...
Cloning into sub
Submodule path 'sub': checked out 'f7482d0c6c7ca2d14308755f86652f8b72e29c27'

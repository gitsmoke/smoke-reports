...
r1 = f83843cd5a1271922354d7450a28cde6dd9f3b8e (refs/remotes/git-svn)
...
[test-rmdir 0f4601d] remove another
 ...
 delete mode 100644 deeply/nested/directory/number/2/another
	...
	D	deeply/nested/directory/number/2/another
	D	deeply/nested/directory/number/2/
r2 = 967a72326dd1e614ed26fdf19d37141cb9d6e620 (refs/remotes/git-svn)

...
expecting success: 
	...
	git svn fetch
r1 = 182d436ce0610f681fee93bd2582614f8a1dc32d (refs/remotes/git-svn)
	A	foo
r2 = fc9f2c7ab83104a550946a5f8348c23b51c1da0d (refs/remotes/git-svn)
...
Committed r3
	A	bar
r3 = 4fd5b29b565a19c7cbc8efaf4a1e3f60b89d7776 (refs/remotes/git-svn)

...
[master (root-commit) 12accea]  Add bar
 Author: A U Thor <author@example.com>
 0 files changed, 0 insertions(+), 0 deletions(-)
 create mode 100644 bar
[master eb02304]  Add foo
 Author: A U Thor <author@example.com>
 0 files changed, 0 insertions(+), 0 deletions(-)
 create mode 100644 foo
[master (root-commit) 76f95ef] Add submodule sub
 Author: A U Thor <author@example.com>
...
HEAD is now at eb02304  Add foo
...
HEAD is now at 0a15820 next change
...
[master dbce516] added .real to .gitignore
 Author: A U Thor <author@example.com>
 1 files changed, 1 insertions(+), 0 deletions(-)

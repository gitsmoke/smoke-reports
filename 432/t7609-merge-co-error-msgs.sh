...
expecting success: 
	...
	echo other >four &&
	echo other >five
[master (root-commit) d161126] First
 Author: A U Thor <author@example.com>
 1 files changed, 1 insertions(+), 0 deletions(-)
 create mode 100644 one
[branch ae571e4] Second
 Author: A U Thor <author@example.com>
...
expecting success: 
	...
	git reset --hard HEAD^
Updating d161126..ae571e4
Aborting
[master 34a3aba] empty
 Author: A U Thor <author@example.com>
Aborting
HEAD is now at d161126 First
...
[master (root-commit) a777c9e] init
 Author: A U Thor <author@example.com>
...
rm 'rep/foo'
rm 'rep2/foo'
[branch 1bb3100] added test as a file
 Author: A U Thor <author@example.com>

...
expecting success: 
	...
	echo happy.
[master (root-commit) 303acac] initial
...
expecting success: 
	...
	git reset --hard HEAD^
HEAD is now at 303acac initial
...
[master d5e3446] Add .gitattributes
 Author: A U Thor <author@example.com>
...
[master 7282039] initial
 Author: A U Thor <author@example.com>
 1 files changed, 1 insertions(+), 0 deletions(-)
[master bff3e73] second
 Author: A U Thor <author@example.com>
...
[master 41cc9c9] alllf, allcrlf and mixed only
 Author: A U Thor <author@example.com>

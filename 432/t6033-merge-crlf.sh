...
[master (root-commit) ae7f170] Initial
 Author: A U Thor <author@example.com>
 1 files changed, 1 insertions(+), 0 deletions(-)
 create mode 100644 file
[master 608a67f] add line from a
 Author: A U Thor <author@example.com>
 1 files changed, 1 insertions(+), 1 deletions(-)
[side 3b3e034] add line from b
 Author: A U Thor <author@example.com>
 1 files changed, 1 insertions(+), 1 deletions(-)
...
HEAD is now at ae7f170 Initial
Merge made by ours.
...
HEAD is now at 608a67f add line from a
Merging:
608a67f add line from a
virtual side

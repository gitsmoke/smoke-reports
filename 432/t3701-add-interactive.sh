...
[master (root-commit) 272d014] commit
...
Unstaged changes after reset:
M	file
[master 7209bbb] commit
 Author: A U Thor <author@example.com>
 1 files changed, 1 insertions(+), 1 deletions(-)
HEAD is now at 272d014 commit
...
expecting success: 
	...
	test_cmp expected diff
[master 9c95429] clear local changes
 Author: A U Thor <author@example.com>
 1 files changed, 1 insertions(+), 0 deletions(-)
...
HEAD is now at 9c95429 clear local changes
[master e510cf7] non-empty
 Author: A U Thor <author@example.com>
 1 files changed, 1 insertions(+), 0 deletions(-)
...
expecting success: 
	...
	git diff --cached >diff &&
	test_cmp expected diff
HEAD is now at e510cf7 non-empty
[master 96a68bf] empty
 Author: A U Thor <author@example.com>

...
[master (root-commit) dbba74d] Initial commit.
 Author: A U Thor <author@example.com>
 1 files changed, 1 insertions(+), 0 deletions(-)
 create mode 100644 A
[master 7e598b2] Second commit.
 Author: A U Thor <author@example.com>
 1 files changed, 1 insertions(+), 0 deletions(-)
...
expecting success: git branch -d d/e/f &&
	 test ! -f .git/refs/heads/d/e/f &&
	 test ! -f .git/logs/refs/heads/d/e/f
Deleted branch d/e/f (was 7e598b2).
...
expecting success: git branch l/m &&
        git branch -d l/m &&
        git branch l
Deleted branch l/m (was 7e598b2).
...
Deleted branch s/t (was 7e598b2).
...
Deleted branch my7 (was 7e598b2).
...
7e598b25e14f0c17438bf4f60f7b9eee63c8ed36
...
expecting success: 
	...
	git branch -d my8
Deleted branch my8 (was 7e598b2).

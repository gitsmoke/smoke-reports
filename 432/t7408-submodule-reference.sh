...
[master (root-commit) 6df49a6] A-initial
...
[master (root-commit) 90fe2a2] B-super-initial
 Author: A U Thor <author@example.com>
 1 files changed, 1 insertions(+), 0 deletions(-)
...
Cloning into sub
Submodule path 'sub': checked out '6df49a6f45f82c5f73061cddbae5927eee9ae4c6'

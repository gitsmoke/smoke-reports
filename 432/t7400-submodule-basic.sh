...
[master (root-commit) 7893674] initial commit
...
[master (root-commit) ed5c394] submodule commit 1
 Author: A U Thor <author@example.com>
...
[master (root-commit) 5fb8762] Ignore everything
 Author: A U Thor <author@example.com>
 1 files changed, 1 insertions(+), 0 deletions(-)
...
rev1: ed5c394661fbe764d400afafbc5d93f52a571cf2
...
expecting success: 
	git submodule status >lines &&
	grep "^-$rev1" lines
-ed5c394661fbe764d400afafbc5d93f52a571cf2 init
...
Submodule path 'init': checked out 'ed5c394661fbe764d400afafbc5d93f52a571cf2'
...
expecting success: 
 ...
 ed5c394661fbe764d400afafbc5d93f52a571cf2 init (rev-1)
...
expecting success: 
	...
	grep "^+$rev2" list
[detached HEAD 9d44f79] submodule commit 2
 Author: A U Thor <author@example.com>
 1 files changed, 1 insertions(+), 0 deletions(-)
 create mode 100644 b
+9d44f7960fd431620c0dd7ca06843ed83d8a979b init (rev-1-1-g9d44f79)
...
+Subproject commit 9d44f7960fd431620c0dd7ca06843ed83d8a979b
...
[detached HEAD b0ad9fa] change subproject
 Author: A U Thor <author@example.com>
 1 files changed, 1 insertions(+), 0 deletions(-)
 create mode 100644 s
[master b099414] change init
 Author: A U Thor <author@example.com>
...
Submodule path 'init': checked out 'b0ad9fae8d165a5d78eda3a29e858ce6bb67f65e'
...
HEAD is now at 20ab3fb super commit 1
...
expecting success: 
	...
	test $commit = $(git ls-files --stage |
		sed -n "s/^160000 \([^ ]*\).*/\1/p")
HEAD is now at 20ab3fb super commit 1
[second a2736fe] commit subproject
 Author: A U Thor <author@example.com>
 1 files changed, 1 insertions(+), 1 deletions(-)
diff --git a/init b/init
index b0ad9fa..8924ef0 160000
--- a/init
+++ b/init
@@ -1 +1 @@
-Subproject commit b0ad9fae8d165a5d78eda3a29e858ce6bb67f65e
+Subproject commit 8924ef0f48287f0add91655ab9e51515b30d7d2d
...
HEAD is now at a2736fe commit subproject
...
[master (root-commit) f5afb12] repo commit 1
 Author: A U Thor <author@example.com>
 1 files changed, 1 insertions(+), 0 deletions(-)

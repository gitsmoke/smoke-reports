...
expecting success: git svn fetch
	...
	A	ne_crlf
	A	empty
r1 = 07500ccefce4afeeda0b52daa260a72ece9ef778 (refs/remotes/git-svn)
	M	kw.c
r2 = 5e2681b05ab684415814dee8ef532983c38aef2e (refs/remotes/git-svn)
	M	kw.c
r3 = 8daf7aa80022a4e1c6c29233a74a75af4df14ad7 (refs/remotes/git-svn)
	M	kw.c
r4 = 83c39c52589b041c4ec7f99bfb9a340a22e928dc (refs/remotes/git-svn)
...
[mybranch 4386d5b] test keywords ignoring
 Author: A U Thor <author@example.com>
 1 files changed, 1 insertions(+), 0 deletions(-)
	M	kw.c
	M	kw.c
r5 = 0827f368eda92b3d5c9cf0f6b553d9e2b4ec6171 (refs/remotes/git-svn)
Done committing 1 revisions to SVN
Updating 4386d5b..0827f36
Fast-forward
...
expecting success: git svn fetch &&
	...
	M	ne_crlf
	M	empty
r6 = f4b55c168cdbf3201f6fa837799c5d07d11818f8 (refs/remotes/git-svn)
Updating 0827f36..f4b55c1
Fast-forward
 crlf    |    3 +--
 ne_crlf |    3 +--
...
expecting success: git svn fetch && git pull . ${remotes_git_svn}
	M	cr
	M	ne_cr
r7 = e5e7af6098991b0f00786a499dade18b8505a379 (refs/remotes/git-svn)
Updating f4b55c1..e5e7af6
Fast-forward
 cr    |    4 +++-
 ne_cr |    4 +++-
...
expecting success: 
	...
	A	deeply/nested/directory/.keep
r8 = 5ad095784ea756509dd4df0f789cbfdfef5b7d80 (refs/remotes/git-svn)
Updating e5e7af6..5ad0957
Fast-forward

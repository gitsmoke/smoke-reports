...
[master (root-commit) c2a43af] initial
...
Updating c2a43af..cb3d384
Fast-forward
 file |    1 +
 1 files changed, 1 insertions(+), 0 deletions(-)
[master 737013f] third
 Author: A U Thor <author@example.com>
...
[master 92a09ca] sixth.1
 Author: A U Thor <author@example.com>
 1 files changed, 1 insertions(+), 1 deletions(-)
[master 0cc85fd] sixth.2
 Author: A U Thor <author@example.com>
 1 files changed, 1 insertions(+), 0 deletions(-)
[master 31bce3c] sixth.3
 Author: A U Thor <author@example.com>
 1 files changed, 1 insertions(+), 0 deletions(-)
...
31bce3c4fd2fa0d9e6dd69bc692f5dafefe8ce31
[master fbecfe9] seventh
 Author: A U Thor <author@example.com>
 1 files changed, 1 insertions(+), 1 deletions(-)

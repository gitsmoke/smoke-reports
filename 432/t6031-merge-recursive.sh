...
[master (root-commit) aaf4339] initial
...
[other 8767c45] changesimplefile
 Author: A U Thor <author@example.com>
 1 files changed, 1 insertions(+), 0 deletions(-)
rm 'sub1'
[main 3149b3b] changefiletodir
 Author: A U Thor <author@example.com>

...
Committed revision 1.
	A	foo
r1 = d9cad342eb5b7916dc72bcc40f4bd62632093eab (refs/remotes/git-svn)
...
[master b832655] files for enabled auto-props
...
Committed r2
	...
	A	bar
	A	exec1.sh
r2 = 10fcfc3b3d4221296d97aac6ae3ffcb5add82982 (refs/remotes/git-svn)
...
[master 941e8f6] files for disabled auto-props
 Author: A U Thor <author@example.com>
 3 files changed, 3 insertions(+), 0 deletions(-)
...
Committed r3
	...
	A	world.txt
	A	zot
r3 = e24acbf259e7b4cfb5cfc2d91aeb8111302dd40d (refs/remotes/git-svn)
No changes between current HEAD and refs/remotes/git-svn
Resetting to the latest refs/remotes/git-svn
...
Committed r4
	D	foo
	A	foo.sh
r4 = 1fdce7b986b7d6489ca95ccfd5fce6c78d7f732d (refs/remotes/git-svn)
No changes between current HEAD and refs/remotes/git-svn
Resetting to the latest refs/remotes/git-svn
D    foo
A    foo.sh

...
[master (root-commit) 01d256c] Initial.
 Author: A <A@test.git>
...
Merging:
22b986b Branch2-1
virtual caedc842f65623600acd18bf3a35c3ea8d146c02
...
expecting success: echo "evil merge." >>file &&
     git commit -a --amend
[branch2 c729c45] Merge branch 'branch1' into branch2

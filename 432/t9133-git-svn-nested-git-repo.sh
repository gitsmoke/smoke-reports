...
Initialized empty Git repository in /Users/trast/git-smoke/t/trash directory.t9133-git-svn-nested-git-repo/g/.git/
	A	a
r1 = b459fadcc3bf06b2dabae96d179395d89751f9eb (refs/remotes/git-svn)
r2 = 9f62104fa1c79e5632083130e03fba259740245f (refs/remotes/git-svn)
...
expecting success: 
	...
	M	a
r3 = ec16a059d8b41721f71548e3b36e7092ad664da9 (refs/remotes/git-svn)
...
[master (root-commit) 1bbe853] add a inside an SVN repo
 Author: A U Thor <author@example.com>
 1 files changed, 2 insertions(+), 0 deletions(-)
 create mode 100644 a
commit 1bbe8537425b9cc6d0a9b50946f136dc19b9c860
Author: A U Thor <author@example.com>
Date:   Sat Jan 8 04:10:06 2011 +0000
...
A         .git/objects/1b
A         .git/objects/1b/be8537425b9cc6d0a9b50946f136dc19b9c860
A         .git/objects/42
...
Adding         .git/objects/1b
Adding         .git/objects/1b/be8537425b9cc6d0a9b50946f136dc19b9c860
...
r4 = 0b3e63cd369eba77e08e1abfc554b50a65a7491e (refs/remotes/git-svn)
First, rewinding head to replay your work on top of it...
Fast-forwarded master to refs/remotes/git-svn.
...
[master fe52921] add a inside an SVN repo
 Author: A U Thor <author@example.com>
...
expecting success: 
	...
	M	a
r5 = 0d6372e178c597c4ec8ee044b71e0fde5580cac1 (refs/remotes/git-svn)
First, rewinding head to replay your work on top of it...
Fast-forwarded master to refs/remotes/git-svn.

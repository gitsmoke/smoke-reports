...
[master (root-commit) 106b3b8] add normal files
...
[master 4f682d2] add files with tabs and newlines
 Author: A U Thor <author@example.com>
 0 files changed, 0 insertions(+), 0 deletions(-)
...
[master 6aa26f2] add file for rm test
 Author: A U Thor <author@example.com>
...
[master 6fa3b6d] remove file from rm test
 Author: A U Thor <author@example.com>
...
[master 1fee89d] add file for rm --quiet test
 Author: A U Thor <author@example.com>
 1 files changed, 1 insertions(+), 0 deletions(-)
 create mode 100644 test-file
[master a603b63] remove file from rm --quiet test
 Author: A U Thor <author@example.com>
 1 files changed, 0 insertions(+), 1 deletions(-)
 delete mode 100644 test-file
...
[master (root-commit) 5d84529] add a file
 Author: A U Thor <author@example.com>
 1 files changed, 1 insertions(+), 0 deletions(-)
...
HEAD is now at 0b49a47 subdir test
rm 'frotz/nitfol'

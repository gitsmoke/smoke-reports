...
expecting success: 
	...
	repo_fetched one &&
	repo_fetched two
[master (root-commit) fe9ecf8] update-all
...
expecting success: 
	...
	repo_fetched one &&
	repo_fetched two
[master 31f13e4] fetch-group-all
 Author: A U Thor <author@example.com>
 1 files changed, 1 insertions(+), 0 deletions(-)
[master 31f13e4] fetch-group-all
 Author: A U Thor <author@example.com>
...
[master 6ed192c] fetch-group-some
 Author: A U Thor <author@example.com>
 1 files changed, 1 insertions(+), 0 deletions(-)
[master 6ed192c] fetch-group-some
 Author: A U Thor <author@example.com>

...
expecting success: 
	...
	git tag initial
[master (root-commit) 679c173] initial
...
HEAD is now at 679c173 initial
[master 590d2fe] add=5
 Author: A U Thor <author@example.com>
...
Deleted branch test5 (was 5e92fb5).
HEAD is now at 679c173 initial
[master c657d7d] add=5
 Author: A U Thor <author@example.com>
 5 files changed, 110 insertions(+), 0 deletions(-)
 create mode 100644 1
 create mode 100644 2
...
Deleted branch test5 (was 17301fe).
HEAD is now at 679c173 initial
[master c657d7d] add=5
 Author: A U Thor <author@example.com>
 5 files changed, 110 insertions(+), 0 deletions(-)
...
[simple-change 480dc16] unrelated-change
 Author: A U Thor <author@example.com>
 0 files changed, 0 insertions(+), 0 deletions(-)

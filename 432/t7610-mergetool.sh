...
[master (root-commit) 49ed64a] added file1
 Author: A U Thor <author@example.com>
 2 files changed, 2 insertions(+), 0 deletions(-)
 create mode 100644 file1
 create mode 100644 subdir/file3
[branch1 f23ae5a] branch1 changes
 Author: A U Thor <author@example.com>
 3 files changed, 3 insertions(+), 2 deletions(-)
 create mode 100644 file2
[master 1ac7bcb] master updates
 Author: A U Thor <author@example.com>
 3 files changed, 3 insertions(+), 2 deletions(-)
 create mode 100644 file2
...
[test1 4e1a810] branch1 resolved with mergetool
 Author: A U Thor <author@example.com>
...
x")" &&
    ...
    git reset --hard
[test2 766ed7d] branch1 resolved with mergetool - autocrlf
 Author: A U Thor <author@example.com>
HEAD is now at 766ed7d branch1 resolved with mergetool - autocrlf
...
[test3 2dc3b09] branch1 resolved with mergetool - subdir
 Author: A U Thor <author@example.com>
...
HEAD is now at f23ae5a branch1 changes
...
Normal merge conflict for 'subdir/file3':
  {local}: modified
  {remote}: modified
[test4 37c9883] branch2 resolved by mergetool from subdir
 Author: A U Thor <author@example.com>

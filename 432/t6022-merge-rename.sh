...
git checkout master
[master (root-commit) dd1a31b] initial has A and M
 Author: A U Thor <author@example.com>
 2 files changed, 30 insertions(+), 0 deletions(-)
 create mode 100644 A
 create mode 100644 M
[master 9fc5285] master updates A
 Author: A U Thor <author@example.com>
 1 files changed, 1 insertions(+), 1 deletions(-)
[yellow 2f9141d] yellow removes M
 Author: A U Thor <author@example.com>
 1 files changed, 0 insertions(+), 15 deletions(-)
 delete mode 100644 M
[white c099615] white renames A->B, M->N
 Author: A U Thor <author@example.com>
 2 files changed, 2 insertions(+), 2 deletions(-)
 rename A => B (93%)
 rename M => N (93%)
[red cdd8a78] red renames A->B, M->N
 Author: A U Thor <author@example.com>
 2 files changed, 2 insertions(+), 2 deletions(-)
 rename A => B (93%)
 rename M => N (93%)
[blue a3a4b10] blue renames A->C, M->N
 Author: A U Thor <author@example.com>
 2 files changed, 2 insertions(+), 2 deletions(-)
 rename A => C (93%)
 rename M => N (93%)
...
Merging:
9fc5285 master updates A
virtual c099615d1276a2efc2b720dbef69dd35286cdc5e
found 1 common ancestor(s):
dd1a31b initial has A and M
Auto-merging B
...
expecting success: 
	...
	git diff --exit-code white N
HEAD is now at 9fc5285 master updates A
Merging:
cdd8a78 red renames A->B, M->N
virtual c099615d1276a2efc2b720dbef69dd35286cdc5e
found 1 common ancestor(s):
dd1a31b initial has A and M
Auto-merging B
...
expecting success: 
	...
	git diff --exit-code white N
HEAD is now at cdd8a78 red renames A->B, M->N
! [blue] blue renames A->C, M->N
 ! [change] changed
  ! [change+rename] changed and renamed
   ! [master] master updates A
...
Merging:
cdd8a78 red renames A->B, M->N
virtual 9fc52857f72a9c1df8467db21b1e4d04686647fd
found 1 common ancestor(s):
dd1a31b initial has A and M
Auto-merging B
CONFLICT (content): Merge conflict in B
...
Merging:
cdd8a78 red renames A->B, M->N
virtual a3a4b1070fc7ff70d3caf42e7adb2904252d76b2
found 1 common ancestor(s):
dd1a31b initial has A and M
Skipped N (merged same as existing)
CONFLICT (rename/rename): Rename "A"->"B" in branch "HEAD" rename "A"->"C" in "a3a4b1070fc7ff70d3caf42e7adb2904252d76b2"
Automatic merge failed; fix conflicts and then commit the result.
g : red changes a line
...
+++++*+ [yellow^] initial has A and M
Merging:
c099615 white renames A->B, M->N
virtual cdd8a78c647cee988e68a7dd518e41502519b7ba
found 1 common ancestor(s):
dd1a31b initial has A and M
Auto-merging B
CONFLICT (content): Merge conflict in B
...
HEAD is now at c099615 white renames A->B, M->N
...
Merging:
9fc5285 master updates A
virtual 2f9141db9cf97e2f18c24bdd74e6ab8bf088e54a
found 1 common ancestor(s):
dd1a31b initial has A and M
Removing M
...
expecting success: 
	...
	git reset --hard anchor
HEAD is now at 9fc5285 master updates A
Updated tag 'anchor' (was 9fc5285)
! [blue] blue renames A->C, M->N
 ! [change] changed
  ! [change+rename] changed and renamed
   ! [master] master updates A
...
Merge made by recursive.
 A |    2 +-
 1 files changed, 1 insertions(+), 1 deletions(-)
HEAD is now at 2f9141d yellow removes M
...
HEAD is now at 4c44713 changed and renamed
Skipped B (merged same as existing)
...
HEAD is now at b8da69a Merge branch 'change+rename' into change
rm 'B'
rm 'M'
[dir-in-way (root-commit) 69f0d9c] Common commmit
 Author: A U Thor <author@example.com>
...
[dir-in-way 9744f28] Commit to merge, with dir in the way
 Author: A U Thor <author@example.com>
 2 files changed, 2 insertions(+), 0 deletions(-)
rm 'dir/file-in-the-way'
[dir-not-in-way 8fb45fa] Commit to merge, with dir removed
 Author: A U Thor <author@example.com>
 2 files changed, 1 insertions(+), 1 deletions(-)
 delete mode 100644 dir/file-in-the-way
rm 'dir/file-in-the-way'
rm 'sub/file'
[renamed-file-has-no-conflicts f38a07d] Independent change
 Author: A U Thor <author@example.com>
 2 files changed, 1 insertions(+), 2 deletions(-)
 rename sub/file => dir (79%)
 delete mode 100644 dir/file-in-the-way
rm 'dir/file-in-the-way'
[renamed-file-has-conflicts 0874cea] Conflicting change
 Author: A U Thor <author@example.com>
 2 files changed, 1 insertions(+), 1 deletions(-)
...
HEAD is now at 0874cea Conflicting change
Merging:
f38a07d Independent change
virtual dir-not-in-way
found 1 common ancestor(s):
69f0d9c Common commmit
...
HEAD is now at c1264fc Merge branch 'dir-not-in-way' into HEAD
...
HEAD is now at f38a07d Independent change
...
HEAD is now at 9744f28 Commit to merge, with dir in the way
Merging:
0874cea Conflicting change
virtual dir-not-in-way
found 1 common ancestor(s):
69f0d9c Common commmit
Removing dir to make room for subdirectory; may re-add later.
...
HEAD is now at 0874cea Conflicting change
Merging:
9744f28 Commit to merge, with dir in the way
...
rm 'n.stages'
rm 'sub/file'
[rename-dest (root-commit) 011d2ed] Common commmit
 Author: A U Thor <author@example.com>
 1 files changed, 1 insertions(+), 0 deletions(-)
 create mode 100644 one/file
[rename-dest 11e7552] Renamed to destdir
 Author: A U Thor <author@example.com>
 1 files changed, 0 insertions(+), 0 deletions(-)
 rename one/file => destdir (100%)
rm 'one/file'
[source-conflict 18e7386] Conflicts in the way
 Author: A U Thor <author@example.com>
...
HEAD is now at 18e7386 Conflicts in the way
Merging:
11e7552 Renamed to destdir
virtual source-conflict
found 1 common ancestor(s):
011d2ed Common commmit
...
HEAD is now at 11e7552 Renamed to destdir
rm 'destdir'
[rename-two (root-commit) cd92bac] Common commmit
 Author: A U Thor <author@example.com>
 2 files changed, 2 insertions(+), 0 deletions(-)
 create mode 100644 one/file
 create mode 100644 two/file
rm 'one/file'
[rename-two d683b61] Rename two/file -> one
 Author: A U Thor <author@example.com>
 2 files changed, 0 insertions(+), 1 deletions(-)
 rename two/file => one (100%)
 delete mode 100644 one/file
rm 'two/file'
[rename-one 2057481] Rename one/file -> two
 Author: A U Thor <author@example.com>
 2 files changed, 0 insertions(+), 1 deletions(-)
...
Merging:
2057481 Rename one/file -> two
virtual rename-two
found 1 common ancestor(s):
cd92bac Common commmit
...
expecting success: 
	...
	test "other" = $(cat one) &&
	test "stuff" = $(cat two)
HEAD is now at 2057481 Rename one/file -> two
Merging:
2057481 Rename one/file -> two
virtual rename-two
found 1 common ancestor(s):
...
HEAD is now at 2057481 Rename one/file -> two
rm 'two'
[first-rename (root-commit) e96a8d4] Common commmit
 Author: A U Thor <author@example.com>
 1 files changed, 1 insertions(+), 0 deletions(-)
 create mode 100644 original
[first-rename 56b233c] Put two/file in the way, rename to one
 Author: A U Thor <author@example.com>
 1 files changed, 0 insertions(+), 0 deletions(-)
 rename original => one (100%)
 create mode 100644 two/file
[second-rename e27e265] Put one/file in the way, rename to two
 Author: A U Thor <author@example.com>
 1 files changed, 0 insertions(+), 0 deletions(-)
 create mode 100644 one/file
...
expecting success: 
	...
	! test -f original
Merging:
56b233c Put two/file in the way, rename to one
virtual second-rename
found 1 common ancestor(s):
e96a8d4 Common commmit
...
HEAD is now at 56b233c Put two/file in the way, rename to one
rm 'one'
rm 'two/file'
[first-rename-redo (root-commit) dbbf8d7] Common commmit
 Author: A U Thor <author@example.com>
 1 files changed, 1 insertions(+), 0 deletions(-)
 create mode 100644 one/file
 create mode 100644 original
 create mode 100644 two/file
rm 'one/file'
[first-rename-redo 22bb3bf] Rename to one
 Author: A U Thor <author@example.com>
 1 files changed, 0 insertions(+), 0 deletions(-)
 rename original => one (100%)
 delete mode 100644 one/file
rm 'two/file'
[second-rename-redo a4abce5] Rename to two
 Author: A U Thor <author@example.com>
 1 files changed, 0 insertions(+), 0 deletions(-)
 rename original => two (100%)
 delete mode 100644 two/file
...
expecting success: 
	...
	! test -f original
Merging:
22bb3bf Rename to one
virtual second-rename-redo
found 1 common ancestor(s):
dbbf8d7 Common commmit
Removing one to make room for subdirectory; may re-add later.
Removing two/file

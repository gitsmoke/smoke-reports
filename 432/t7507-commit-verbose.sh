...
[master (root-commit) e9d32d2] subject
...
[master 408e0b3] This is an example commit message that contains a diff.
 Author: A U Thor <author@example.com>
 1 files changed, 1 insertions(+), 1 deletions(-)
...
[master 50563d9] This is an example commit message that contains a diff.
 Author: A U Thor <author@example.com>
 1 files changed, 1 insertions(+), 1 deletions(-)
--- diff	2011-01-08 04:08:45.000000000 +0000
+++ actual	2011-01-08 04:08:45.000000000 +0000
@@ -1,9 +1,2 @@

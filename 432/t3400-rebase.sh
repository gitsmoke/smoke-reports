...
[master (root-commit) d0fa66c] Add A.
 Author: author@name <bogus@email@address>
 1 files changed, 1 insertions(+), 0 deletions(-)
 create mode 100644 A
[force-3way 0eb6a31] Add Y.
 Author: author@name <bogus@email@address>
 1 files changed, 1 insertions(+), 0 deletions(-)
 create mode 100644 Y
[filemove 33074a4] Move A.
 Author: author@name <bogus@email@address>
 2 files changed, 1 insertions(+), 0 deletions(-)
 rename A => D/A (100%)
 create mode 100644 Y
[my-topic-branch a689775] Add B.
 Author: author@name <bogus@email@address>
 1 files changed, 1 insertions(+), 0 deletions(-)
 create mode 100644 B
[master 3bc08d8] Modify A.
 Author: author@name <bogus@email@address>
 1 files changed, 1 insertions(+), 0 deletions(-)
[side af77902] Add C
 Author: author@name <bogus@email@address>
...
Merge made by recursive.
 ...
 create mode 100644 C
Merging:
a2de46d Merge branch 'side' into nonlinear
virtual master
found 1 common ancestor(s):
d0fa66c Add A.
Merge made by recursive.
...
[master f4cef75] prepare
 Author: author@name <bogus@email@address>
 1 files changed, 1 insertions(+), 0 deletions(-)
 create mode 100644 X
[modechange dd53b26] modechange
 Author: author@name <bogus@email@address>
 1 files changed, 1 insertions(+), 0 deletions(-)
...
[quiet e5b44d0] A file with a line with CR
 Author: author@name <bogus@email@address>
...
[detached HEAD 43d5d86] n1
 Author: author@name <bogus@email@address>
 1 files changed, 1 insertions(+), 0 deletions(-)
 create mode 100644 n1.t
[detached HEAD d62f841] n2
 Author: author@name <bogus@email@address>
 1 files changed, 1 insertions(+), 0 deletions(-)
 create mode 100644 n2.t
[detached HEAD 6dfa694] n3
 Author: author@name <bogus@email@address>
 1 files changed, 1 insertions(+), 0 deletions(-)

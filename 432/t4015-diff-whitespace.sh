...
[master (root-commit) fc39276] snapshot
...
HEAD is now at 57b75f4 yet another
[master 9021238] hello 1
 Author: A U Thor <author@example.com>
 1 files changed, 1 insertions(+), 1 deletions(-)
...
HEAD is now at 9021238 hello 1
[master b211178] base
 Author: A U Thor <author@example.com>
...
HEAD is now at b211178 base
[master a3f1637] empty
 Author: A U Thor <author@example.com>
...
HEAD is now at a3f1637 empty
[master 5d0e979] one side
 Author: A U Thor <author@example.com>
 1 files changed, 1 insertions(+), 9 deletions(-)
[detached HEAD 8ca93ce] the other side
 Author: A U Thor <author@example.com>
 1 files changed, 1 insertions(+), 9 deletions(-)
Merging:
8ca93ce the other side
virtual master
...
expecting success: 
	...
	test_cmp expected current
HEAD is now at 8ca93ce the other side
[detached HEAD 7ec5367] initial
 Author: A U Thor <author@example.com>
 1 files changed, 1 insertions(+), 1 deletions(-)

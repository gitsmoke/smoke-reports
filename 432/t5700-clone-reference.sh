...
[master (root-commit) 471542b] initial
...
Merging:
1972ce0 addition
virtual 06e6fe9dc5f92b4f48bec2a35ff6076953e5c62d
...
[master (root-commit) 65aa60a] initial
 Author: A U Thor <author@example.com>
 1 files changed, 1 insertions(+), 0 deletions(-)
 create mode 100644 file1

...
[master (root-commit) 9e9bd5e] initial
...
[master e8c3daf] master removes file2 and subdir/file2
 Author: A U Thor <author@example.com>
...
D	file2
D	subdir/file2
[side c95452c] side adds file3 and removes file2
 Author: A U Thor <author@example.com>
...
HEAD is now at e8c3daf master removes file2 and subdir/file2
...
expecting success: 
	...
	git checkout side-a
HEAD is now at e8c3daf master removes file2 and subdir/file2
[side-a 8f46215] side-a changes file1
 Author: A U Thor <author@example.com>
 1 files changed, 1 insertions(+), 0 deletions(-)
[side-b 430da8b] side-b changes file2
 Author: A U Thor <author@example.com>
 1 files changed, 1 insertions(+), 0 deletions(-)
...
HEAD is now at 8f46215 side-a changes file1
...
HEAD is now at 8f46215 side-a changes file1
[sym-b ffc8c13] side adds a/b
 Author: A U Thor <author@example.com>
 0 files changed, 0 insertions(+), 0 deletions(-)
 create mode 100644 a/b
[sym-a 2cf2810] we add a/b
 Author: A U Thor <author@example.com>
 1 files changed, 1 insertions(+), 0 deletions(-)
...
HEAD is now at 2cf2810 we add a/b
...
HEAD is now at 2cf2810 we add a/b
[side-a 2d6a12c] side-a changes file2 to directory
 Author: A U Thor <author@example.com>
...
HEAD is now at 430da8b side-b changes file2
Trying simple merge.
...
Merging:
430da8b side-b changes file2
2d6a12c side-a changes file2 to directory

...
[master (root-commit) 1312a55] add normal files
...
[master 47c0eaf] add files with tabs and newlines
 Author: A U Thor <author@example.com>
 0 files changed, 0 insertions(+), 0 deletions(-)
...
[master 65d3076] add file for rm test
 Author: A U Thor <author@example.com>
...
[master 58089a1] remove file from rm test
 Author: A U Thor <author@example.com>
...
[master e29160e] add file for rm --quiet test
 Author: A U Thor <author@example.com>
 1 files changed, 1 insertions(+), 0 deletions(-)
 create mode 100644 test-file
[master 3473cb0] remove file from rm --quiet test
 Author: A U Thor <author@example.com>
 1 files changed, 0 insertions(+), 1 deletions(-)
 delete mode 100644 test-file
...
[master (root-commit) 9b23974] add a file
 Author: A U Thor <author@example.com>
 1 files changed, 1 insertions(+), 0 deletions(-)
...
HEAD is now at 84ce93e subdir test
rm 'frotz/nitfol'

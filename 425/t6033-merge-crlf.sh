...
[master (root-commit) c91931c] Initial
 Author: A U Thor <author@example.com>
 1 files changed, 1 insertions(+), 0 deletions(-)
 create mode 100644 file
[master 8f64717] add line from a
 Author: A U Thor <author@example.com>
 1 files changed, 1 insertions(+), 1 deletions(-)
[side ebf8ab5] add line from b
 Author: A U Thor <author@example.com>
 1 files changed, 1 insertions(+), 1 deletions(-)
...
HEAD is now at c91931c Initial
Merge made by ours.
...
HEAD is now at 8f64717 add line from a
Merging:
8f64717 add line from a
virtual side

...
Initialized empty Git repository in /Users/trast/git-smoke/t/trash directory.t9103-git-svn-tracked-directory-removed/x/.git/
	A	README
r1 = bf5e0cdde50c96d946e7076facc2cc00a5548085 (refs/remotes/trunk)
	D	README
	A	FOLLOWME
r3 = b2e9ea263833582e0cd4cfeac67cc7af94aca083 (refs/remotes/trunk)
...
HEAD is now at bf5e0cd initial

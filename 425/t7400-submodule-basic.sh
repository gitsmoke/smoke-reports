...
[master (root-commit) 1aa431f] initial commit
...
[master (root-commit) 73c44e1] submodule commit 1
 Author: A U Thor <author@example.com>
...
[master (root-commit) 5fcae5f] Ignore everything
 Author: A U Thor <author@example.com>
 1 files changed, 1 insertions(+), 0 deletions(-)
...
" "$rev1" &&
	test -n "$rev1"
rev1: 73c44e15c376b88fcd99f92f0a5e71fe44c01e21
...
-73c44e15c376b88fcd99f92f0a5e71fe44c01e21 init
...
Submodule path 'init': checked out '73c44e15c376b88fcd99f92f0a5e71fe44c01e21'
...
expecting success: 
	...
	grep "^ $rev1" list
 73c44e15c376b88fcd99f92f0a5e71fe44c01e21 init (rev-1)
...
[detached HEAD bc3ea78] submodule commit 2
 Author: A U Thor <author@example.com>
 1 files changed, 1 insertions(+), 0 deletions(-)
 create mode 100644 b
+bc3ea78c61f2dfc87d1ba26a1b5b61737c3b092a init (rev-1-1-gbc3ea78)
...
+Subproject commit bc3ea78c61f2dfc87d1ba26a1b5b61737c3b092a
...
[detached HEAD cf2f652] change subproject
 Author: A U Thor <author@example.com>
 1 files changed, 1 insertions(+), 0 deletions(-)
 create mode 100644 s
[master bdca232] change init
 Author: A U Thor <author@example.com>
...
Submodule path 'init': checked out 'cf2f652e8b74fc2f40b23a2ba267aaba8d45416a'
...
HEAD is now at 8761f99 super commit 1
...
expecting success: 
	...
	test $commit = $(git ls-files --stage |
		sed -n "s/^160000 \([^ ]*\).*/\1/p")
HEAD is now at 8761f99 super commit 1
[second e7d029d] commit subproject
 Author: A U Thor <author@example.com>
 1 files changed, 1 insertions(+), 1 deletions(-)
diff --git a/init b/init
index cf2f652..07a46d2 160000
--- a/init
+++ b/init
@@ -1 +1 @@
-Subproject commit cf2f652e8b74fc2f40b23a2ba267aaba8d45416a
+Subproject commit 07a46d24af29b2dccc03c75e56c2964ae07c20e4
...
HEAD is now at e7d029d commit subproject
...
[master (root-commit) bf55cda] repo commit 1
 Author: A U Thor <author@example.com>
 1 files changed, 1 insertions(+), 0 deletions(-)

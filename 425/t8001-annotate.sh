...
[master (root-commit) 4830f7e] Initial.
 Author: A <A@test.git>
...
Merging:
690712a Branch2-1
virtual 6580a0cdab601da42a00f43eaa9faa5058650e7b
...
expecting success: echo "evil merge." >>file &&
     git commit -a --amend
[branch2 dba60eb] Merge branch 'branch1' into branch2

...
[master (root-commit) fb5fdde] initial
...
[other 1239a6d] changesimplefile
 Author: A U Thor <author@example.com>
 1 files changed, 1 insertions(+), 0 deletions(-)
rm 'sub1'
[main a336707] changefiletodir
 Author: A U Thor <author@example.com>

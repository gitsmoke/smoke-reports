...
[master (root-commit) e651ef1] initial
...
Updating e651ef1..96e0d80
Fast-forward
 file |    1 +
 1 files changed, 1 insertions(+), 0 deletions(-)
[master 1789139] third
 Author: A U Thor <author@example.com>
...
[master 93e1255] sixth.1
 Author: A U Thor <author@example.com>
 1 files changed, 1 insertions(+), 1 deletions(-)
[master 373ccbf] sixth.2
 Author: A U Thor <author@example.com>
 1 files changed, 1 insertions(+), 0 deletions(-)
[master 0182071] sixth.3
 Author: A U Thor <author@example.com>
 1 files changed, 1 insertions(+), 0 deletions(-)
...
0182071dcdbe1b8c2cb2b9b1d391409a88023f80
[master ba1eddb] seventh
 Author: A U Thor <author@example.com>
 1 files changed, 1 insertions(+), 1 deletions(-)

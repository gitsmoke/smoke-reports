...
[master (root-commit) 3355ebd] initial
...
Merging:
d2a5714 addition
virtual 6b036391a4de1cde9b5735c5017a1afb9e0950fc
...
[master (root-commit) 4539898] initial
 Author: A U Thor <author@example.com>
 1 files changed, 1 insertions(+), 0 deletions(-)
 create mode 100644 file1

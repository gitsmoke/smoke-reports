...
[master 7de82d2] new file in ugly parent
...
Committed r2
	A	#{bad_directory_name}/ foo
r2 = b827e47b2ff1d0b6a7847b26b8ad19dec8568049 (refs/remotes/git-svn)
...
[master deb4cdc] rename ugly file
 Author: A U Thor <author@example.com>
...
r3 = 547336b838a07949146b4796e7f55377c2d34964 (refs/remotes/git-svn)
No changes between current HEAD and refs/remotes/git-svn
Resetting to the latest refs/remotes/git-svn
...
Committed r4
	A	pretty
r4 = 63efcd6639463a4001c8a12871c98ddd98e328e5 (refs/remotes/git-svn)
No changes between current HEAD and refs/remotes/git-svn
Resetting to the latest refs/remotes/git-svn
[master 3e51fca] moved pretty file
 Author: A U Thor <author@example.com>
 1 files changed, 0 insertions(+), 0 deletions(-)
...
r5 = 268fb029ec6f02f61c6433a950f61b1ffc402100 (refs/remotes/git-svn)
No changes between current HEAD and refs/remotes/git-svn
Resetting to the latest refs/remotes/git-svn
...
r6 = 2adb9db77a017d03d01fe72da8d05902c94a9cf2 (refs/remotes/git-svn)
No changes between current HEAD and refs/remotes/git-svn
Resetting to the latest refs/remotes/git-svn
...
Committed r7
	A	+_+
r7 = 97e5e21f0b28dcc24b51042897fb2c4c720a9b75 (refs/remotes/git-svn)
No changes between current HEAD and refs/remotes/git-svn
Resetting to the latest refs/remotes/git-svn
...
Committed r8
	D	+_+
	A	gtk+/_+_
r8 = f6571b9b59986ef3f5a3919bebcbbb0a54eccc92 (refs/remotes/git-svn)
No changes between current HEAD and refs/remotes/git-svn
Resetting to the latest refs/remotes/git-svn
...
[master ef49c31] test-rebase-main
 Author: A U Thor <author@example.com>
 1 files changed, 1 insertions(+), 0 deletions(-)
...
Committed r9
	A	test-rebase-main
r9 = c177e022a8a9696f5aeb8594f0a4cf4b59716641 (refs/remotes/git-svn)
No changes between current HEAD and refs/remotes/git-svn
Resetting to the latest refs/remotes/git-svn

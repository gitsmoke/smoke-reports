...
git checkout master
[master (root-commit) 3bd10e9] initial has A and M
 Author: A U Thor <author@example.com>
 2 files changed, 30 insertions(+), 0 deletions(-)
 create mode 100644 A
 create mode 100644 M
[master 3faff5a] master updates A
 Author: A U Thor <author@example.com>
 1 files changed, 1 insertions(+), 1 deletions(-)
[yellow fbfaa4d] yellow removes M
 Author: A U Thor <author@example.com>
 1 files changed, 0 insertions(+), 15 deletions(-)
 delete mode 100644 M
[white fa27e6b] white renames A->B, M->N
 Author: A U Thor <author@example.com>
 2 files changed, 2 insertions(+), 2 deletions(-)
 rename A => B (93%)
 rename M => N (93%)
[red 19bb1ea] red renames A->B, M->N
 Author: A U Thor <author@example.com>
 2 files changed, 2 insertions(+), 2 deletions(-)
 rename A => B (93%)
 rename M => N (93%)
[blue 2189b32] blue renames A->C, M->N
 Author: A U Thor <author@example.com>
 2 files changed, 2 insertions(+), 2 deletions(-)
 rename A => C (93%)
 rename M => N (93%)
...
Merging:
3faff5a master updates A
virtual fa27e6b9c13858640af31e5d92f25c531ea7c9d6
found 1 common ancestor(s):
3bd10e9 initial has A and M
Auto-merging B
...
expecting success: 
	...
	git diff --exit-code white N
HEAD is now at 3faff5a master updates A
Merging:
19bb1ea red renames A->B, M->N
virtual fa27e6b9c13858640af31e5d92f25c531ea7c9d6
found 1 common ancestor(s):
3bd10e9 initial has A and M
Auto-merging B
...
expecting success: 
	...
	git diff --exit-code white N
HEAD is now at 19bb1ea red renames A->B, M->N
! [blue] blue renames A->C, M->N
 ! [change] changed
  ! [change+rename] changed and renamed
   ! [master] master updates A
...
Merging:
19bb1ea red renames A->B, M->N
virtual 3faff5afc2428400d099a0d5cfc6a10f8da50668
found 1 common ancestor(s):
3bd10e9 initial has A and M
Auto-merging B
CONFLICT (content): Merge conflict in B
...
Merging:
19bb1ea red renames A->B, M->N
virtual 2189b32e960a649953eaa1b35c7be9272f3f8665
found 1 common ancestor(s):
3bd10e9 initial has A and M
Skipped N (merged same as existing)
CONFLICT (rename/rename): Rename "A"->"B" in branch "HEAD" rename "A"->"C" in "2189b32e960a649953eaa1b35c7be9272f3f8665"
Automatic merge failed; fix conflicts and then commit the result.
g : red changes a line
...
+++++*+ [yellow^] initial has A and M
Merging:
fa27e6b white renames A->B, M->N
virtual 19bb1eaa512685af9b71c01da3e618b1d732c1aa
found 1 common ancestor(s):
3bd10e9 initial has A and M
Auto-merging B
CONFLICT (content): Merge conflict in B
...
HEAD is now at fa27e6b white renames A->B, M->N
...
Merging:
3faff5a master updates A
virtual fbfaa4d2dc3ace0a2ea69bee692a63a693023958
found 1 common ancestor(s):
3bd10e9 initial has A and M
Removing M
...
HEAD is now at 3faff5a master updates A
Updated tag 'anchor' (was 3faff5a)
! [blue] blue renames A->C, M->N
 ! [change] changed
  ! [change+rename] changed and renamed
   ! [master] master updates A
...
Merge made by recursive.
 A |    2 +-
 1 files changed, 1 insertions(+), 1 deletions(-)
HEAD is now at fbfaa4d yellow removes M
...
HEAD is now at d0e9db6 changed and renamed
Skipped B (merged same as existing)
...
HEAD is now at f5a38bd Merge branch 'change+rename' into change
rm 'B'
rm 'M'
[dir-in-way (root-commit) 7152e2d] Common commmit
 Author: A U Thor <author@example.com>
...
[dir-in-way 892e41e] Commit to merge, with dir in the way
 Author: A U Thor <author@example.com>
 2 files changed, 2 insertions(+), 0 deletions(-)
rm 'dir/file-in-the-way'
[dir-not-in-way 5d5ba6f] Commit to merge, with dir removed
 Author: A U Thor <author@example.com>
 2 files changed, 1 insertions(+), 1 deletions(-)
 delete mode 100644 dir/file-in-the-way
rm 'dir/file-in-the-way'
rm 'sub/file'
[renamed-file-has-no-conflicts 6c1796e] Independent change
 Author: A U Thor <author@example.com>
 2 files changed, 1 insertions(+), 2 deletions(-)
 rename sub/file => dir (79%)
 delete mode 100644 dir/file-in-the-way
rm 'dir/file-in-the-way'
[renamed-file-has-conflicts da86e06] Conflicting change
 Author: A U Thor <author@example.com>
 2 files changed, 1 insertions(+), 1 deletions(-)
...
HEAD is now at da86e06 Conflicting change
Merging:
6c1796e Independent change
virtual dir-not-in-way
found 1 common ancestor(s):
7152e2d Common commmit
...
HEAD is now at 6a923bd Merge branch 'dir-not-in-way' into HEAD
...
HEAD is now at 6c1796e Independent change
...
HEAD is now at 892e41e Commit to merge, with dir in the way
Merging:
da86e06 Conflicting change
virtual dir-not-in-way
found 1 common ancestor(s):
7152e2d Common commmit
Removing dir to make room for subdirectory; may re-add later.
...
HEAD is now at da86e06 Conflicting change
Merging:
892e41e Commit to merge, with dir in the way
...
rm 'n.stages'
rm 'sub/file'
[rename-dest (root-commit) 0f2d563] Common commmit
 Author: A U Thor <author@example.com>
 1 files changed, 1 insertions(+), 0 deletions(-)
 create mode 100644 one/file
[rename-dest 724850e] Renamed to destdir
 Author: A U Thor <author@example.com>
 1 files changed, 0 insertions(+), 0 deletions(-)
 rename one/file => destdir (100%)
rm 'one/file'
[source-conflict 0195dbc] Conflicts in the way
 Author: A U Thor <author@example.com>
...
HEAD is now at 0195dbc Conflicts in the way
Merging:
724850e Renamed to destdir
virtual source-conflict
found 1 common ancestor(s):
0f2d563 Common commmit
...
HEAD is now at 724850e Renamed to destdir
rm 'destdir'
[rename-two (root-commit) 9d9948d] Common commmit
 Author: A U Thor <author@example.com>
 2 files changed, 2 insertions(+), 0 deletions(-)
 create mode 100644 one/file
 create mode 100644 two/file
rm 'one/file'
[rename-two e8ec3b8] Rename two/file -> one
 Author: A U Thor <author@example.com>
 2 files changed, 0 insertions(+), 1 deletions(-)
 rename two/file => one (100%)
 delete mode 100644 one/file
rm 'two/file'
[rename-one 5cf35e6] Rename one/file -> two
 Author: A U Thor <author@example.com>
 2 files changed, 0 insertions(+), 1 deletions(-)
...
expecting success: 
	...
	test "stuff" = $(cat two)
Merging:
5cf35e6 Rename one/file -> two
virtual rename-two
found 1 common ancestor(s):
9d9948d Common commmit
...
expecting success: 
	...
	test "other" = $(cat one) &&
	test "stuff" = $(cat two)
HEAD is now at 5cf35e6 Rename one/file -> two
Merging:
5cf35e6 Rename one/file -> two
virtual rename-two
found 1 common ancestor(s):
...
HEAD is now at 5cf35e6 Rename one/file -> two
rm 'two'
[first-rename (root-commit) b331660] Common commmit
 Author: A U Thor <author@example.com>
 1 files changed, 1 insertions(+), 0 deletions(-)
 create mode 100644 original
[first-rename 6ae13ca] Put two/file in the way, rename to one
 Author: A U Thor <author@example.com>
 1 files changed, 0 insertions(+), 0 deletions(-)
 rename original => one (100%)
 create mode 100644 two/file
[second-rename c1b21dc] Put one/file in the way, rename to two
 Author: A U Thor <author@example.com>
 1 files changed, 0 insertions(+), 0 deletions(-)
 create mode 100644 one/file
...
expecting success: 
	...
	! test -f original
Merging:
6ae13ca Put two/file in the way, rename to one
virtual second-rename
found 1 common ancestor(s):
b331660 Common commmit
...
HEAD is now at 6ae13ca Put two/file in the way, rename to one
rm 'one'
rm 'two/file'
[first-rename-redo (root-commit) 16e87c1] Common commmit
 Author: A U Thor <author@example.com>
 1 files changed, 1 insertions(+), 0 deletions(-)
 create mode 100644 one/file
 create mode 100644 original
 create mode 100644 two/file
rm 'one/file'
[first-rename-redo 65c5515] Rename to one
 Author: A U Thor <author@example.com>
 1 files changed, 0 insertions(+), 0 deletions(-)
 rename original => one (100%)
 delete mode 100644 one/file
rm 'two/file'
[second-rename-redo 19fe3b9] Rename to two
 Author: A U Thor <author@example.com>
 1 files changed, 0 insertions(+), 0 deletions(-)
 rename original => two (100%)
 delete mode 100644 two/file
...
Merging:
65c5515 Rename to one
virtual second-rename-redo
found 1 common ancestor(s):
16e87c1 Common commmit
Removing one to make room for subdirectory; may re-add later.
Removing two/file

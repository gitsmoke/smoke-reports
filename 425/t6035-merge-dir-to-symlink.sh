...
expecting success: 
	...
	git commit -m "untracked symlink remains" &&
	 ...
	 test -f a/b-2/c/d
HEAD is now at 72a76f6 dir to symlink
rm 'a/b'
[detached HEAD f6b5ccc] untracked symlink remains
 Author: A U Thor <author@example.com>
...
HEAD is now at 157ea77 base
[detached HEAD ac933dc] x
 Author: A U Thor <author@example.com>
 1 files changed, 1 insertions(+), 0 deletions(-)
...
HEAD is now at 261771f Merge branch 'master' into HEAD
Merging:
ac933dc x
virtual master
...
HEAD is now at f41ad84 Merge branch 'master' into HEAD
Trying really trivial in-index merge...
Nope.
Trying simple merge.
Simple merge failed, trying Automatic merge.
...
HEAD is now at 0286893 Merge commit 'baseline^0' into HEAD
Merging:
72a76f6 dir to symlink
virtual baseline^0
found 1 common ancestor(s):
157ea77 base
...
HEAD is now at ac933dc x
[detached HEAD e16a92f] dir a/b-2 to symlink
 Author: A U Thor <author@example.com>
...
HEAD is now at e16a92f dir a/b-2 to symlink
Trying really trivial in-index merge...
Nope.
Trying simple merge.
Simple merge failed, trying Automatic merge.
...
HEAD is now at a2004a4 Merge commit 'test2' into HEAD
Merging:
ac933dc x
virtual test2
found 1 common ancestor(s):

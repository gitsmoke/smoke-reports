...
[master (root-commit) 526aec2] commit
...
Unstaged changes after reset:
M	file
[master 22128d0] commit
 Author: A U Thor <author@example.com>
 1 files changed, 1 insertions(+), 1 deletions(-)
HEAD is now at 526aec2 commit
...
[master 1ec401a] clear local changes
 Author: A U Thor <author@example.com>
 1 files changed, 1 insertions(+), 0 deletions(-)
...
HEAD is now at 1ec401a clear local changes
[master a9818a3] non-empty
 Author: A U Thor <author@example.com>
 1 files changed, 1 insertions(+), 0 deletions(-)
...
HEAD is now at a9818a3 non-empty
[master a831856] empty
 Author: A U Thor <author@example.com>

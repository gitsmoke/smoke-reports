...
expecting success: git branch l/m &&
        git branch -d l/m &&
        git branch l
Deleted branch l/m (was 0f2d372).
...
Deleted branch s/t (was 0f2d372).
...
Deleted branch my7 (was 0f2d372).
...
0f2d3725e1124810734983f87930271f05ee0fb4
...
expecting success: 
	...
	git branch -d my8
Deleted branch my8 (was 0f2d372).

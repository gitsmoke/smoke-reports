...
[master (root-commit) 2ab6355] initial
...
[master efedf13] master removes file2 and subdir/file2
 Author: A U Thor <author@example.com>
...
D	file2
D	subdir/file2
[side dd22295] side adds file3 and removes file2
 Author: A U Thor <author@example.com>
...
HEAD is now at efedf13 master removes file2 and subdir/file2
...
expecting success: 
	...
	git checkout side-a
HEAD is now at efedf13 master removes file2 and subdir/file2
[side-a 828a146] side-a changes file1
 Author: A U Thor <author@example.com>
 1 files changed, 1 insertions(+), 0 deletions(-)
[side-b ee714a0] side-b changes file2
 Author: A U Thor <author@example.com>
 1 files changed, 1 insertions(+), 0 deletions(-)
...
HEAD is now at 828a146 side-a changes file1
...
HEAD is now at 828a146 side-a changes file1
[sym-b 9daffb8] side adds a/b
 Author: A U Thor <author@example.com>
 0 files changed, 0 insertions(+), 0 deletions(-)
 create mode 100644 a/b
[sym-a cd596dd] we add a/b
 Author: A U Thor <author@example.com>
 1 files changed, 1 insertions(+), 0 deletions(-)
...
HEAD is now at cd596dd we add a/b
...
HEAD is now at cd596dd we add a/b
[side-a 842d21e] side-a changes file2 to directory
 Author: A U Thor <author@example.com>
...
HEAD is now at ee714a0 side-b changes file2
Trying simple merge.
...
Merging:
ee714a0 side-b changes file2
842d21e side-a changes file2 to directory

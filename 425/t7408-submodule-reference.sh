...
[master (root-commit) da39cc1] A-initial
...
[master (root-commit) ea0e2bc] B-super-initial
 Author: A U Thor <author@example.com>
 1 files changed, 1 insertions(+), 0 deletions(-)
...
Cloning into sub...
Submodule path 'sub': checked out 'da39cc1d483dea26c76a2a6f96c264f552436488'

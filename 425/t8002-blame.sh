...
[master (root-commit) 7741acc] Initial.
 Author: A <A@test.git>
...
Merging:
193618a Branch2-1
virtual 8ca0ef7df6ea1aaf84d6edd96a0472bcf4c3bb36
...
expecting success: echo "evil merge." >>file &&
     git commit -a --amend
[branch2 40bd5c4] Merge branch 'branch1' into branch2

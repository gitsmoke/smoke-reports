...
expecting success: git svn fetch
	...
	A	ne_crlf
	A	empty
r1 = 1ad112e96ba738bfcb38170d2b5e93e6373146c2 (refs/remotes/git-svn)
	M	kw.c
r2 = 1dc52883d98e5b478dc45485865c89cfdedd716c (refs/remotes/git-svn)
	M	kw.c
r3 = 090e4d4c5194d6503b3fc67726ae333edf7a5418 (refs/remotes/git-svn)
	M	kw.c
r4 = f9420f07c677bbaa6d026cd5ccc262753e282240 (refs/remotes/git-svn)
...
[mybranch 1436a14] test keywords ignoring
 Author: A U Thor <author@example.com>
 1 files changed, 1 insertions(+), 0 deletions(-)
	M	kw.c
	M	kw.c
r5 = cc2724894e56a60ac43ca2c2a923dd642a038b20 (refs/remotes/git-svn)
Done committing 1 revisions to SVN
Updating 1436a14..cc27248
Fast-forward
...
expecting success: git svn fetch &&
	...
	M	ne_crlf
	M	empty
r6 = f913854d69fef0085d328bc3a38b01e7a3ba57a7 (refs/remotes/git-svn)
Updating cc27248..f913854
Fast-forward
 crlf    |    3 +--
 ne_crlf |    3 +--
...
expecting success: git svn fetch && git pull . ${remotes_git_svn}
	M	cr
	M	ne_cr
r7 = d0ad8599c7727c74fc40e637f5fba917b7e40648 (refs/remotes/git-svn)
Updating f913854..d0ad859
Fast-forward
 cr    |    4 +++-
 ne_cr |    4 +++-
...
expecting success: 
	...
	A	deeply/nested/directory/.keep
r8 = d15b89e4bddfe1fedda4292ecac4ee26d8808c28 (refs/remotes/git-svn)
Updating d0ad859..d15b89e
Fast-forward

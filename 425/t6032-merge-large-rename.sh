...
expecting success: 
	...
	git tag initial
[master (root-commit) c77728a] initial
...
HEAD is now at c77728a initial
[master 6490708] add=5
 Author: A U Thor <author@example.com>
...
Deleted branch test5 (was 2ce9fa9).
HEAD is now at c77728a initial
[master 332fc28] add=5
 Author: A U Thor <author@example.com>
 5 files changed, 110 insertions(+), 0 deletions(-)
 create mode 100644 1
 create mode 100644 2
...
Deleted branch test5 (was 456dc66).
HEAD is now at c77728a initial
[master 332fc28] add=5
 Author: A U Thor <author@example.com>
 5 files changed, 110 insertions(+), 0 deletions(-)
...
[simple-change a7c790f] unrelated-change
 Author: A U Thor <author@example.com>
 0 files changed, 0 insertions(+), 0 deletions(-)

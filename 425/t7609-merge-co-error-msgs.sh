...
expecting success: 
	...
	echo other >four &&
	echo other >five
[master (root-commit) ddfb869] First
 Author: A U Thor <author@example.com>
 1 files changed, 1 insertions(+), 0 deletions(-)
 create mode 100644 one
[branch 394693e] Second
 Author: A U Thor <author@example.com>
...
expecting success: 
	...
	git reset --hard HEAD^
Updating ddfb869..394693e
Aborting
[master f7382b1] empty
 Author: A U Thor <author@example.com>
Aborting
HEAD is now at ddfb869 First
...
[master (root-commit) 8ceb72e] init
 Author: A U Thor <author@example.com>
...
rm 'rep/foo'
rm 'rep2/foo'
[branch 9448639] added test as a file
 Author: A U Thor <author@example.com>

...
ok 28 - set up .gitattributes declaring drivers to test
ok 29 - preset java pattern
ok 30 - preset perl pattern
ok 31 - perl pattern accepts K&R style brace placement, too
ok 32 - but is not distracted by end of <<here document
ok 33 - perl pattern is not distracted by sub within POD
ok 34 - perl pattern gets full line of POD header
ok 35 - perl pattern is not distracted by forward declaration
ok 36 - custom pattern
ok 37 - last regexp must not be negated
ok 38 - pattern which matches to end of line
ok 39 - alternation in pattern

...
[master (root-commit) ef31797] initial
...
Updating ef31797..dff858c
Fast-forward
 file |    1 +
 1 files changed, 1 insertions(+), 0 deletions(-)
[master ca7d524] third
 Author: A U Thor <author@example.com>
...
[master dacf8e1] sixth.1
 Author: A U Thor <author@example.com>
 1 files changed, 1 insertions(+), 1 deletions(-)
[master d654a00] sixth.2
 Author: A U Thor <author@example.com>
 1 files changed, 1 insertions(+), 0 deletions(-)
[master ca6989c] sixth.3
 Author: A U Thor <author@example.com>
 1 files changed, 1 insertions(+), 0 deletions(-)
...
ca6989c0c2b1a21256dc1db8693b9ff206833d48
[master e9ff22e] seventh
 Author: A U Thor <author@example.com>
 1 files changed, 1 insertions(+), 1 deletions(-)

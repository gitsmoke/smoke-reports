...
[master (root-commit) 47a6a29] commit
...
Unstaged changes after reset:
M	file
[master 6ae09e9] commit
 Author: A U Thor <author@example.com>
 1 files changed, 1 insertions(+), 1 deletions(-)
HEAD is now at 47a6a29 commit
...
[master d10792a] clear local changes
 Author: A U Thor <author@example.com>
 1 files changed, 1 insertions(+), 0 deletions(-)
...
HEAD is now at d10792a clear local changes
[master f3b53d7] non-empty
 Author: A U Thor <author@example.com>
 1 files changed, 1 insertions(+), 0 deletions(-)
...
HEAD is now at f3b53d7 non-empty
[master afa9ed3] empty
 Author: A U Thor <author@example.com>

...
expecting success: 
	...
	git svn fetch
r1 = 349ea343095b43678a7154100518412ba0257419 (refs/remotes/git-svn)
	A	foo
r2 = e6eea11d23ddecbc777fe72900548c2a6188e14e (refs/remotes/git-svn)
...
Committed r3
	A	bar
r3 = 47ffafff476f1e81ace49aec3ac278ca173c946e (refs/remotes/git-svn)

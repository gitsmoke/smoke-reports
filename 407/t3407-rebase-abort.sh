...
[master 8ef8692] c
 Author: A U Thor <author@example.com>
 1 files changed, 1 insertions(+), 1 deletions(-)
[to-rebase 589960a] merge should fail on this
 Author: A U Thor <author@example.com>
 1 files changed, 1 insertions(+), 1 deletions(-)
[to-rebase 1a9a4f1] merge should fail on this, too
 Author: A U Thor <author@example.com>
 1 files changed, 1 insertions(+), 1 deletions(-)
...
HEAD is now at 1a9a4f1 merge should fail on this, too
...
Merging HEAD with merge should fail on this, too
Merging:
4d80b5b merge should fail on this
virtual merge should fail on this, too
found 1 common ancestor(s):
virtual f788de73cfc81f8d734fa7efc658cc63ca083f50
Auto-merging a
...
Merging:
8ef8692 c
589960a merge should fail on this
found 1 common ancestor(s):
d6cff9c a
Auto-merging a
CONFLICT (content): Merge conflict in a
...
Merging:
8ef8692 c
1a9a4f1 merge should fail on this, too
found 1 common ancestor(s):
589960a merge should fail on this
Auto-merging a
CONFLICT (content): Merge conflict in a
...
Auto-merging a
CONFLICT (content): Merge conflict in a
[detached HEAD 82ca86b] merge should fail on this
 Author: A U Thor <author@example.com>
 1 files changed, 1 insertions(+), 0 deletions(-)
Committed: 0001 merge should fail on this
Merging master with HEAD~0
Merging:
82ca86b merge should fail on this
1a9a4f1 merge should fail on this, too
found 1 common ancestor(s):
589960a merge should fail on this
Auto-merging a

...
Committed revision 1.
	A	foo
r1 = 31ea1384fb5898e7784435394d25c08381595f3a (refs/remotes/git-svn)
...
[master 51221ea] files for enabled auto-props
...
Committed r2
	...
	A	bar
	A	exec1.sh
r2 = 227e865df0ace120303998cbb7a9f80f11904203 (refs/remotes/git-svn)
...
[master 7a94726] files for disabled auto-props
 Author: A U Thor <author@example.com>
 3 files changed, 3 insertions(+), 0 deletions(-)
...
Committed r3
	...
	A	world.txt
	A	zot
r3 = 68dc1dce13f54a8cb4f918dd4ea1720dd5b7aa87 (refs/remotes/git-svn)
No changes between current HEAD and refs/remotes/git-svn
Resetting to the latest refs/remotes/git-svn
...
Committed r4
	D	foo
	A	foo.sh
r4 = 9c1ecc6034ec01721db11239454e5fc2385e5c8b (refs/remotes/git-svn)
No changes between current HEAD and refs/remotes/git-svn
Resetting to the latest refs/remotes/git-svn
D    foo
A    foo.sh

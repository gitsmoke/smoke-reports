...
expecting success: 
	...
	git tag b &&
	git checkout master
[master (root-commit) 512c7ff] Initial
 Author: A U Thor <author@example.com>
 1 files changed, 1 insertions(+), 0 deletions(-)
 create mode 100644 file
[master 32783bb] add line from a
 Author: A U Thor <author@example.com>
 1 files changed, 1 insertions(+), 1 deletions(-)
[side ee095f5] add line from b
 Author: A U Thor <author@example.com>
 1 files changed, 1 insertions(+), 1 deletions(-)
...
HEAD is now at 512c7ff Initial
Merge made by ours.
...
expecting success: 
	...
	cat file | remove_cr | append_cr >file.temp &&
	test_cmp file file.temp
HEAD is now at 32783bb add line from a
Merging:
32783bb add line from a
virtual side

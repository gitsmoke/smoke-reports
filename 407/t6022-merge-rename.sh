...
git checkout master
[master (root-commit) f6ed75b] initial has A and M
 Author: A U Thor <author@example.com>
 2 files changed, 30 insertions(+), 0 deletions(-)
 create mode 100644 A
 create mode 100644 M
[master d97ec2b] master updates A
 Author: A U Thor <author@example.com>
 1 files changed, 1 insertions(+), 1 deletions(-)
[yellow 8533b17] yellow removes M
 Author: A U Thor <author@example.com>
 1 files changed, 0 insertions(+), 15 deletions(-)
 delete mode 100644 M
[white ed5dd8e] white renames A->B, M->N
 Author: A U Thor <author@example.com>
 2 files changed, 2 insertions(+), 2 deletions(-)
 rename A => B (93%)
 rename M => N (93%)
[red 1b9b6a4] red renames A->B, M->N
 Author: A U Thor <author@example.com>
 2 files changed, 2 insertions(+), 2 deletions(-)
 rename A => B (93%)
 rename M => N (93%)
[blue 3c09eae] blue renames A->C, M->N
 Author: A U Thor <author@example.com>
 2 files changed, 2 insertions(+), 2 deletions(-)
 rename A => C (93%)
 rename M => N (93%)
...
Merging:
d97ec2b master updates A
virtual ed5dd8eb718153335e8e302803207a8c63d36b96
found 1 common ancestor(s):
f6ed75b initial has A and M
Auto-merging B
...
expecting success: 
	...
	git diff --exit-code white N
HEAD is now at d97ec2b master updates A
Merging:
1b9b6a4 red renames A->B, M->N
virtual ed5dd8eb718153335e8e302803207a8c63d36b96
found 1 common ancestor(s):
f6ed75b initial has A and M
Auto-merging B
...
HEAD is now at 1b9b6a4 red renames A->B, M->N
! [blue] blue renames A->C, M->N
 ! [change] changed
  ! [change+rename] changed and renamed
   ! [master] master updates A
...
Merging:
1b9b6a4 red renames A->B, M->N
virtual d97ec2bd4432ea08df368cab41a639841bd68cfa
found 1 common ancestor(s):
f6ed75b initial has A and M
Auto-merging B
CONFLICT (content): Merge conflict in B
...
Merging:
1b9b6a4 red renames A->B, M->N
virtual 3c09eae080ed1af12ef21531bfb58a4d94eb1a2d
found 1 common ancestor(s):
f6ed75b initial has A and M
Skipped N (merged same as existing)
CONFLICT (rename/rename): Rename "A"->"B" in branch "HEAD" rename "A"->"C" in "3c09eae080ed1af12ef21531bfb58a4d94eb1a2d"
Automatic merge failed; fix conflicts and then commit the result.
g : red changes a line
...
+++++*+ [change+rename^] initial has A and M
Merging:
ed5dd8e white renames A->B, M->N
virtual 1b9b6a44196d987c5dbb27af40cb4c40d171e819
found 1 common ancestor(s):
f6ed75b initial has A and M
Auto-merging B
CONFLICT (content): Merge conflict in B
...
HEAD is now at ed5dd8e white renames A->B, M->N
...
Merging:
d97ec2b master updates A
virtual 8533b17e440e178e496ace5fe935f7f07048a709
found 1 common ancestor(s):
f6ed75b initial has A and M
Removing M
...
HEAD is now at d97ec2b master updates A
Updated tag 'anchor' (was d97ec2b)
! [blue] blue renames A->C, M->N
 ! [change] changed
  ! [change+rename] changed and renamed
   ! [master] master updates A
...
Merge made by recursive.
 A |    2 +-
 1 files changed, 1 insertions(+), 1 deletions(-)
HEAD is now at 8533b17 yellow removes M
...
HEAD is now at 45183eb changed and renamed
Skipped B (merged same as existing)
...
HEAD is now at 9d46b4f Merge branch 'change+rename' into change
rm 'B'
rm 'M'
[dir-in-way (root-commit) df58bb0] Common commmit
 Author: A U Thor <author@example.com>
...
[dir-in-way 7694e37] Commit to merge, with dir in the way
 Author: A U Thor <author@example.com>
 2 files changed, 2 insertions(+), 0 deletions(-)
rm 'dir/file-in-the-way'
[dir-not-in-way e2b4fda] Commit to merge, with dir removed
 Author: A U Thor <author@example.com>
 2 files changed, 1 insertions(+), 1 deletions(-)
 delete mode 100644 dir/file-in-the-way
rm 'dir/file-in-the-way'
rm 'sub/file'
[renamed-file-has-no-conflicts 9248915] Independent change
 Author: A U Thor <author@example.com>
 2 files changed, 1 insertions(+), 2 deletions(-)
 rename sub/file => dir (79%)
 delete mode 100644 dir/file-in-the-way
rm 'dir/file-in-the-way'
[renamed-file-has-conflicts 00e5566] Conflicting change
 Author: A U Thor <author@example.com>
 2 files changed, 1 insertions(+), 1 deletions(-)
...
HEAD is now at 00e5566 Conflicting change
Merging:
9248915 Independent change
virtual dir-not-in-way
found 1 common ancestor(s):
df58bb0 Common commmit
...
HEAD is now at bc5a995 Merge branch 'dir-not-in-way' into HEAD
...
HEAD is now at 9248915 Independent change
...
HEAD is now at 7694e37 Commit to merge, with dir in the way
Merging:
00e5566 Conflicting change
virtual dir-not-in-way
found 1 common ancestor(s):
df58bb0 Common commmit
Removing dir to make room for subdirectory; may re-add later.
...
HEAD is now at 00e5566 Conflicting change
Merging:
7694e37 Commit to merge, with dir in the way
...
rm 'n.stages'
rm 'sub/file'
[rename-dest (root-commit) 57d5fe3] Common commmit
 Author: A U Thor <author@example.com>
 1 files changed, 1 insertions(+), 0 deletions(-)
 create mode 100644 one/file
[rename-dest a3656af] Renamed to destdir
 Author: A U Thor <author@example.com>
 1 files changed, 0 insertions(+), 0 deletions(-)
 rename one/file => destdir (100%)
rm 'one/file'
[source-conflict 9dd0f61] Conflicts in the way
 Author: A U Thor <author@example.com>
...
HEAD is now at 9dd0f61 Conflicts in the way
Merging:
a3656af Renamed to destdir
virtual source-conflict
found 1 common ancestor(s):
57d5fe3 Common commmit
...
HEAD is now at a3656af Renamed to destdir
rm 'destdir'
[rename-two (root-commit) eb55d2f] Common commmit
 Author: A U Thor <author@example.com>
 2 files changed, 2 insertions(+), 0 deletions(-)
 create mode 100644 one/file
 create mode 100644 two/file
rm 'one/file'
[rename-two 7bd5f31] Rename two/file -> one
 Author: A U Thor <author@example.com>
 2 files changed, 0 insertions(+), 1 deletions(-)
 rename two/file => one (100%)
 delete mode 100644 one/file
rm 'two/file'
[rename-one dd6279c] Rename one/file -> two
 Author: A U Thor <author@example.com>
 2 files changed, 0 insertions(+), 1 deletions(-)
...
Merging:
dd6279c Rename one/file -> two
virtual rename-two
found 1 common ancestor(s):
eb55d2f Common commmit
...
expecting success: 
	...
	test "other" = $(cat one) &&
	test "stuff" = $(cat two)
HEAD is now at dd6279c Rename one/file -> two
Merging:
dd6279c Rename one/file -> two
virtual rename-two
found 1 common ancestor(s):
...
HEAD is now at dd6279c Rename one/file -> two
rm 'two'
[first-rename (root-commit) bfb9303] Common commmit
 Author: A U Thor <author@example.com>
 1 files changed, 1 insertions(+), 0 deletions(-)
 create mode 100644 original
[first-rename 60a1411] Put two/file in the way, rename to one
 Author: A U Thor <author@example.com>
 1 files changed, 0 insertions(+), 0 deletions(-)
 rename original => one (100%)
 create mode 100644 two/file
[second-rename c22ef14] Put one/file in the way, rename to two
 Author: A U Thor <author@example.com>
 1 files changed, 0 insertions(+), 0 deletions(-)
 create mode 100644 one/file
...
Merging:
60a1411 Put two/file in the way, rename to one
virtual second-rename
found 1 common ancestor(s):
bfb9303 Common commmit
...
HEAD is now at 60a1411 Put two/file in the way, rename to one
rm 'one'
rm 'two/file'
[first-rename-redo (root-commit) 4c26940] Common commmit
 Author: A U Thor <author@example.com>
 1 files changed, 1 insertions(+), 0 deletions(-)
 create mode 100644 one/file
 create mode 100644 original
 create mode 100644 two/file
rm 'one/file'
[first-rename-redo 3fb09b6] Rename to one
 Author: A U Thor <author@example.com>
 1 files changed, 0 insertions(+), 0 deletions(-)
 rename original => one (100%)
 delete mode 100644 one/file
rm 'two/file'
[second-rename-redo e454ff6] Rename to two
 Author: A U Thor <author@example.com>
 1 files changed, 0 insertions(+), 0 deletions(-)
 rename original => two (100%)
 delete mode 100644 two/file
...
expecting success: 
	...
	! test -f original
Merging:
3fb09b6 Rename to one
virtual second-rename-redo
found 1 common ancestor(s):
4c26940 Common commmit
Removing one to make room for subdirectory; may re-add later.
Removing two/file

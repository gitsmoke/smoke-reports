...
expecting success: git svn fetch
	...
	A	ne_crlf
	A	empty
r1 = f806d9daa0fa8ff6826bf90e3df320ef95555b99 (refs/remotes/git-svn)
	M	kw.c
r2 = b24e90402cba1cc4d465ba317bde113ea97b94f7 (refs/remotes/git-svn)
	M	kw.c
r3 = a12cae5b07b37e40cdcf5738481b271d4e045dae (refs/remotes/git-svn)
	M	kw.c
r4 = 04258f784bcdde03d829a848993bc4d078427e09 (refs/remotes/git-svn)
...
[mybranch 2f70e34] test keywords ignoring
 Author: A U Thor <author@example.com>
 1 files changed, 1 insertions(+), 0 deletions(-)
	M	kw.c
	M	kw.c
r5 = 60098405b8aaaf89a5766e6b16dd946be671bc9f (refs/remotes/git-svn)
Done committing 1 revisions to SVN
Updating 2f70e34..6009840
Fast-forward
...
expecting success: git svn fetch &&
	...
	M	ne_crlf
	M	empty
r6 = 68a3dfc62363760ed8079b313d70733c55cac2b4 (refs/remotes/git-svn)
Updating 6009840..68a3dfc
Fast-forward
 crlf    |    3 +--
 ne_crlf |    3 +--
...
expecting success: git svn fetch && git pull . ${remotes_git_svn}
	M	cr
	M	ne_cr
r7 = de2bd2afb3a8139491122594e1f3840c03c4128d (refs/remotes/git-svn)
Updating 68a3dfc..de2bd2a
Fast-forward
 cr    |    4 +++-
 ne_cr |    4 +++-
...
expecting success: 
	...
	A	deeply/nested/directory/.keep
r8 = 95ebdc78fbcd280e5adfe3578730a9acfc143a83 (refs/remotes/git-svn)
Updating de2bd2a..95ebdc7
Fast-forward

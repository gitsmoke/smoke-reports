...
[master (root-commit) c43f324] snapshot
...
HEAD is now at 5aabc82 yet another
[master 4565b41] hello 1
 Author: A U Thor <author@example.com>
 1 files changed, 1 insertions(+), 1 deletions(-)
...
HEAD is now at 4565b41 hello 1
[master 602e8a4] base
 Author: A U Thor <author@example.com>
...
HEAD is now at 602e8a4 base
[master 8ed1e27] empty
 Author: A U Thor <author@example.com>
...
expecting success: 
	...
	! grep "^-" actual
HEAD is now at 8ed1e27 empty
[master 0dba62f] one side
 Author: A U Thor <author@example.com>
 1 files changed, 1 insertions(+), 9 deletions(-)
[detached HEAD c8f98da] the other side
 Author: A U Thor <author@example.com>
 1 files changed, 1 insertions(+), 9 deletions(-)
Merging:
c8f98da the other side
virtual master
...
expecting success: 
	...
	test_cmp expected current
HEAD is now at c8f98da the other side
[detached HEAD 89bafb9] initial
 Author: A U Thor <author@example.com>
 1 files changed, 1 insertions(+), 1 deletions(-)

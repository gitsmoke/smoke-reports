...
expecting success: 
	...
	echo other >four &&
	echo other >five
[master (root-commit) d03664a] First
 Author: A U Thor <author@example.com>
 1 files changed, 1 insertions(+), 0 deletions(-)
 create mode 100644 one
[branch ba18249] Second
 Author: A U Thor <author@example.com>
...
expecting success: 
	...
	git reset --hard HEAD^
Updating d03664a..ba18249
Aborting
[master 7fdd77f] empty
 Author: A U Thor <author@example.com>
Aborting
HEAD is now at d03664a First
...
[master (root-commit) 191d780] init
 Author: A U Thor <author@example.com>
...
rm 'rep/foo'
rm 'rep2/foo'
[branch 69b85c0] added test as a file
 Author: A U Thor <author@example.com>

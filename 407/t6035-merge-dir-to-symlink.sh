...
HEAD is now at a219a76 dir to symlink
rm 'a/b'
[detached HEAD 3adb364] untracked symlink remains
 Author: A U Thor <author@example.com>
...
HEAD is now at f1bac9b base
[detached HEAD 8e05e7f] x
 Author: A U Thor <author@example.com>
 1 files changed, 1 insertions(+), 0 deletions(-)
...
HEAD is now at d89f50b Merge branch 'master' into HEAD
Merging:
8e05e7f x
virtual master
...
HEAD is now at 8ee3058 Merge commit 'baseline^0' into HEAD
Merging:
a219a76 dir to symlink
virtual baseline^0
found 1 common ancestor(s):
f1bac9b base
...
HEAD is now at a3637f5 Merge branch 'master' into HEAD
Merging:
8e05e7f x
virtual master
found 1 common ancestor(s):
...
HEAD is now at 8e05e7f x
[detached HEAD 62f0f3c] dir a/b-2 to symlink
 Author: A U Thor <author@example.com>
...
HEAD is now at 62f0f3c dir a/b-2 to symlink
Trying really trivial in-index merge...
Nope.
Trying simple merge.
Simple merge failed, trying Automatic merge.
...
HEAD is now at 94eaab2 Merge commit 'test2' into HEAD
Merging:
8e05e7f x
virtual test2
found 1 common ancestor(s):

...
[master (root-commit) f72b07c]  Add bar
 Author: A U Thor <author@example.com>
 0 files changed, 0 insertions(+), 0 deletions(-)
 create mode 100644 bar
[master 50eb9dc]  Add foo
 Author: A U Thor <author@example.com>
 0 files changed, 0 insertions(+), 0 deletions(-)
 create mode 100644 foo
[master (root-commit) f668854] Add submodule sub
 Author: A U Thor <author@example.com>
...
HEAD is now at 50eb9dc  Add foo
...
HEAD is now at 1b48c58 next change
...
[master 1ba39df] added .real to .gitignore
 Author: A U Thor <author@example.com>
 1 files changed, 1 insertions(+), 0 deletions(-)

...
[master (root-commit) b9a6c0f] A-initial
...
[master (root-commit) 30a1a7a] B-super-initial
 Author: A U Thor <author@example.com>
 1 files changed, 1 insertions(+), 0 deletions(-)
...
Cloning into sub
Submodule path 'sub': checked out 'b9a6c0fd286013bc9d343b236b6bede2644c6b90'

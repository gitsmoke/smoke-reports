...
[master (root-commit) bafa947] Initial commit.
...
expecting success: git branch g/h &&
     ...
     git pack-refs --all &&
     git branch -d g
Deleted branch g/h (was bafa947).
Deleted branch g (was bafa947).
...
expecting success: git branch k/l &&
     ...
     git branch -d k/lm &&
     git branch k
Deleted branch k/l (was bafa947).
Deleted branch k/l/m (was bafa947).
Deleted branch k/lm (was bafa947).
...
expecting success: git branch n/o &&
     ...
     git branch -d n/o/p &&
     git branch n
Deleted branch n/o (was bafa947).
Deleted branch n/op (was bafa947).
Deleted branch n/o/p (was bafa947).

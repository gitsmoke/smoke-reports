...
expecting success: 
	...
	git branch initial
[master (root-commit) c1b11ea] initial commit
...
[master (root-commit) 2a7d7ec] submodule commit 1
 Author: A U Thor <author@example.com>
...
[master (root-commit) 53ed038] Ignore everything
 Author: A U Thor <author@example.com>
 1 files changed, 1 insertions(+), 0 deletions(-)
...
rev1: 2a7d7ec5043df67f9dc0d7f3ebad5726089551b6
...
expecting success: 
	git submodule status >lines &&
	grep "^-$rev1" lines
-2a7d7ec5043df67f9dc0d7f3ebad5726089551b6 init
...
Submodule path 'init': checked out '2a7d7ec5043df67f9dc0d7f3ebad5726089551b6'
...
expecting success: 
	...
	grep "^ $rev1" list
 2a7d7ec5043df67f9dc0d7f3ebad5726089551b6 init (rev-1)
...
[detached HEAD 819027a] submodule commit 2
 Author: A U Thor <author@example.com>
 1 files changed, 1 insertions(+), 0 deletions(-)
 create mode 100644 b
+819027a9f0692f62c8c9a8df08a6181fb8003ef2 init (rev-1-1-g819027a)
...
+Subproject commit 819027a9f0692f62c8c9a8df08a6181fb8003ef2
...
[detached HEAD 9bcff5d] change subproject
 Author: A U Thor <author@example.com>
 1 files changed, 1 insertions(+), 0 deletions(-)
 create mode 100644 s
[master fe21deb] change init
 Author: A U Thor <author@example.com>
...
Submodule path 'init': checked out '9bcff5d8729d0766eaf0a461e6f229e9caadc257'
...
HEAD is now at 8f32262 super commit 1
...
HEAD is now at 8f32262 super commit 1
[second ba2c85e] commit subproject
 Author: A U Thor <author@example.com>
 1 files changed, 1 insertions(+), 1 deletions(-)
diff --git a/init b/init
index 9bcff5d..669e98f 160000
--- a/init
+++ b/init
@@ -1 +1 @@
-Subproject commit 9bcff5d8729d0766eaf0a461e6f229e9caadc257
+Subproject commit 669e98f8c6b4c41b9cbbbb28732f86898364541d
...
expecting success: 
	...
	test ! -d init &&
	git checkout second
HEAD is now at ba2c85e commit subproject
...
[master (root-commit) 582bcce] repo commit 1
 Author: A U Thor <author@example.com>
 1 files changed, 1 insertions(+), 0 deletions(-)

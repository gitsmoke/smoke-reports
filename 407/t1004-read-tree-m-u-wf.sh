...
[master (root-commit) fb712f2] initial
...
[master 2fdca24] master removes file2 and subdir/file2
 Author: A U Thor <author@example.com>
...
D	file2
D	subdir/file2
[side 333a212] side adds file3 and removes file2
 Author: A U Thor <author@example.com>
...
HEAD is now at 2fdca24 master removes file2 and subdir/file2
...
expecting success: 
	...
	git checkout side-a
HEAD is now at 2fdca24 master removes file2 and subdir/file2
[side-a 818b2c0] side-a changes file1
 Author: A U Thor <author@example.com>
 1 files changed, 1 insertions(+), 0 deletions(-)
[side-b a5b8a2e] side-b changes file2
 Author: A U Thor <author@example.com>
 1 files changed, 1 insertions(+), 0 deletions(-)
...
HEAD is now at 818b2c0 side-a changes file1
...
HEAD is now at 818b2c0 side-a changes file1
[sym-b c0bb73c] side adds a/b
 Author: A U Thor <author@example.com>
 0 files changed, 0 insertions(+), 0 deletions(-)
 create mode 100644 a/b
[sym-a 09083ef] we add a/b
 Author: A U Thor <author@example.com>
 1 files changed, 1 insertions(+), 0 deletions(-)
...
HEAD is now at 09083ef we add a/b
...
HEAD is now at 09083ef we add a/b
[side-a 4474c64] side-a changes file2 to directory
 Author: A U Thor <author@example.com>
...
HEAD is now at a5b8a2e side-b changes file2
Trying simple merge.
...
Merging:
a5b8a2e side-b changes file2
4474c64 side-a changes file2 to directory

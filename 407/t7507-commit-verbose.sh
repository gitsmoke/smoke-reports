...
[master (root-commit) 1c13f3d] subject
...
expecting success: 
	...
	check_message diff
[master a3dc8b8] This is an example commit message that contains a diff.
 Author: A U Thor <author@example.com>
 1 files changed, 1 insertions(+), 1 deletions(-)
...
checking known breakage: 
	...
	check_message diff
[master adb30bd] This is an example commit message that contains a diff.
 Author: A U Thor <author@example.com>
 1 files changed, 1 insertions(+), 1 deletions(-)
--- diff	2010-12-31 04:08:18.000000000 +0000
+++ actual	2010-12-31 04:08:18.000000000 +0000
@@ -1,9 +1,2 @@

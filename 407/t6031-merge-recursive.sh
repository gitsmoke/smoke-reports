...
[master (root-commit) 4e4fcdc] initial
...
[other 26664b0] changesimplefile
 Author: A U Thor <author@example.com>
 1 files changed, 1 insertions(+), 0 deletions(-)
rm 'sub1'
[main 934af89] changefiletodir
 Author: A U Thor <author@example.com>

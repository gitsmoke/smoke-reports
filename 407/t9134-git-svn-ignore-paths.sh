...
Initialized empty Git repository in /Users/trast/git-smoke/t/trash directory.t9134-git-svn-ignore-paths/g/.git/
	A	qqq/test_qqq.txt
r1 = 454505d7e44217f2f8466dafbf3e6304a019b3c1 (refs/remotes/git-svn)
r2 = 90dd54d836e31fa7db6ce60cb3d8d15aa386e79b (refs/remotes/git-svn)
...
" > expect &&
	...
	M	qqq/test_qqq.txt
r3 = a6d69d9947cf62ce4c1f49703631a4ae35b8d948 (refs/remotes/git-svn)
...
r4 = e049580dcfded2528ba3391a3cb7b20028c933ad (refs/remotes/git-svn)
First, rewinding head to replay your work on top of it...
Fast-forwarded master to refs/remotes/git-svn.
...
" > expect &&
	...
	M	qqq/test_qqq.txt
r5 = 7e43f0f1ecd382c3edf696147d29c524e2a68479 (refs/remotes/git-svn)
First, rewinding head to replay your work on top of it...
Fast-forwarded master to refs/remotes/git-svn.

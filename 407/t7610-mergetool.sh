...
[master (root-commit) 8c8b6aa] added file1
 Author: A U Thor <author@example.com>
 2 files changed, 2 insertions(+), 0 deletions(-)
 create mode 100644 file1
 create mode 100644 subdir/file3
[branch1 e8f6da2] branch1 changes
 Author: A U Thor <author@example.com>
 3 files changed, 3 insertions(+), 2 deletions(-)
 create mode 100644 file2
[master 1836ef1] master updates
 Author: A U Thor <author@example.com>
 3 files changed, 3 insertions(+), 2 deletions(-)
 create mode 100644 file2
...
[test1 5010bb9] branch1 resolved with mergetool
 Author: A U Thor <author@example.com>
...
x")" &&
    ...
    git reset --hard
[test2 70ef35b] branch1 resolved with mergetool - autocrlf
 Author: A U Thor <author@example.com>
HEAD is now at 70ef35b branch1 resolved with mergetool - autocrlf
...
[test3 0b30e71] branch1 resolved with mergetool - subdir
 Author: A U Thor <author@example.com>
...
HEAD is now at e8f6da2 branch1 changes
...
Normal merge conflict for 'subdir/file3':
  {local}: modified
  {remote}: modified
[test4 fee1c98] branch2 resolved by mergetool from subdir
 Author: A U Thor <author@example.com>

...
expecting success: 
	...
	git tag initial
[master (root-commit) 949d13a] initial
...
HEAD is now at 949d13a initial
[master 5ec2dd5] add=5
 Author: A U Thor <author@example.com>
...
Deleted branch test5 (was 979681a).
HEAD is now at 949d13a initial
[master bb6d5b7] add=5
 Author: A U Thor <author@example.com>
 5 files changed, 110 insertions(+), 0 deletions(-)
 create mode 100644 1
 create mode 100644 2
...
Deleted branch test5 (was 1f2152b).
HEAD is now at 949d13a initial
[master bb6d5b7] add=5
 Author: A U Thor <author@example.com>
 5 files changed, 110 insertions(+), 0 deletions(-)
...
[simple-change bdb6668] unrelated-change
 Author: A U Thor <author@example.com>
 0 files changed, 0 insertions(+), 0 deletions(-)

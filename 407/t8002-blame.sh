...
[master (root-commit) ebc589a] Initial.
 Author: A <A@test.git>
...
Merging:
bc41204 Branch2-1
virtual 2bff2c322d417143a849c2bcbc00205bc1d5e8ac
...
expecting success: echo "evil merge." >>file &&
     git commit -a --amend
[branch2 514026a] Merge branch 'branch1' into branch2

...
expecting success: 
	...
	git add hello &&
	git commit -m master
[master (root-commit) c1a081f] initial
...
[master (root-commit) 112d631] initial git-gui
 Author: A U Thor <author@example.com>
 1 files changed, 1 insertions(+), 0 deletions(-)
...
[master (root-commit) de87734] initial git
 Author: A U Thor <author@example.com>
 1 files changed, 1 insertions(+), 0 deletions(-)
...
Updating gui
[master 056aa65] Merge git-gui as our subdirectory
 Author: A U Thor <author@example.com>
ok 4 - initial merge
...
expecting success: 
	...
	test_cmp expected actual
M	git-gui.sh
[master2 dc9ceaf] update git-gui
 Author: A U Thor <author@example.com>
 1 files changed, 1 insertions(+), 1 deletions(-)
Merging:
056aa65 Merge git-gui as our subdirectory
virtual dc9ceafe10fb7ef8f170a8e441c8241179978daa
found 1 common ancestor(s):
112d631 initial git-gui
Merge made by subtree.
...
expecting success: 
	...
	test_cmp expected actual
HEAD is now at 056aa65 Merge git-gui as our subdirectory
Already up-to-date.
[master2 ffc13e6] Merge git-gui2 as our subdirectory
 Author: A U Thor <author@example.com>
 1 files changed, 1 insertions(+), 0 deletions(-)
...
expecting success: 
	...
	test_cmp expected actual
HEAD is now at ffc13e6 Merge git-gui2 as our subdirectory
Merging:
ffc13e6 Merge git-gui2 as our subdirectory
virtual dc9ceafe10fb7ef8f170a8e441c8241179978daa
found 1 common ancestor(s):
112d631 initial git-gui

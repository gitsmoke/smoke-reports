...
[master (root-commit) 6d13ae5] add normal files
...
[master 0017ec3] add files with tabs and newlines
 Author: A U Thor <author@example.com>
 0 files changed, 0 insertions(+), 0 deletions(-)
...
[master 631efe0] add file for rm test
 Author: A U Thor <author@example.com>
...
[master 1e68bfd] remove file from rm test
 Author: A U Thor <author@example.com>
...
[master 0086014] add file for rm --quiet test
 Author: A U Thor <author@example.com>
 1 files changed, 1 insertions(+), 0 deletions(-)
 create mode 100644 test-file
[master 9d474df] remove file from rm --quiet test
 Author: A U Thor <author@example.com>
 1 files changed, 0 insertions(+), 1 deletions(-)
 delete mode 100644 test-file
...
[master (root-commit) 3a78386] add a file
 Author: A U Thor <author@example.com>
 1 files changed, 1 insertions(+), 0 deletions(-)
...
expecting success: 
	...
	git rm frotz/nitfol &&
	test ! -f frotz/nitfol
HEAD is now at ce69339 subdir test
rm 'frotz/nitfol'

...
[master (root-commit) ade07a7] Initial commit.
 Author: A U Thor <author@example.com>
 1 files changed, 1 insertions(+), 0 deletions(-)
 create mode 100644 A
[master 5861d0f] Second commit.
 Author: A U Thor <author@example.com>
 1 files changed, 1 insertions(+), 0 deletions(-)
...
expecting success: git branch l/m &&
        git branch -d l/m &&
        git branch l
Deleted branch l/m (was 5861d0f).
...
Deleted branch s/t (was 5861d0f).
...
Deleted branch my7 (was 5861d0f).
...
5861d0f1800f9db0c25ec3348c1be83688fb7242
...
expecting success: 
	...
	git branch -d my8
Deleted branch my8 (was 5861d0f).

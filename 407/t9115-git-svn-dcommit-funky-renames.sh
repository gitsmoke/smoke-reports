...
[master e860206] new file in ugly parent
...
Committed r2
	A	#{bad_directory_name}/ foo
r2 = 35089fe06b31f8cc8a447b8bd67901e24f86dd13 (refs/remotes/git-svn)
...
[master 30ccaea] rename ugly file
 Author: A U Thor <author@example.com>
...
r3 = a662b05e615f0a2c956c2ec99dfdb3ba6bce4627 (refs/remotes/git-svn)
No changes between current HEAD and refs/remotes/git-svn
Resetting to the latest refs/remotes/git-svn
...
Committed r4
	A	pretty
r4 = 524d2968ebf8fb2e05d8780785383ae6a8b8fbea (refs/remotes/git-svn)
No changes between current HEAD and refs/remotes/git-svn
Resetting to the latest refs/remotes/git-svn
[master 7c9aafb] moved pretty file
 Author: A U Thor <author@example.com>
 1 files changed, 0 insertions(+), 0 deletions(-)
...
r5 = ff35e4172c580d7227d566a5a8459fba0487b3fa (refs/remotes/git-svn)
No changes between current HEAD and refs/remotes/git-svn
Resetting to the latest refs/remotes/git-svn
...
r6 = 8eac60a44eb715cd3893c8ac22bd9016410c45ff (refs/remotes/git-svn)
No changes between current HEAD and refs/remotes/git-svn
Resetting to the latest refs/remotes/git-svn
...
Committed r7
	A	+_+
r7 = 9388741e30950d66c67b0cedd6dd20429995d6dd (refs/remotes/git-svn)
No changes between current HEAD and refs/remotes/git-svn
Resetting to the latest refs/remotes/git-svn
...
Committed r8
	D	+_+
	A	gtk+/_+_
r8 = 07ff917e69827e3bdf7c8a9788618c28012752e0 (refs/remotes/git-svn)
No changes between current HEAD and refs/remotes/git-svn
Resetting to the latest refs/remotes/git-svn
...
[master a3683bc] test-rebase-main
 Author: A U Thor <author@example.com>
 1 files changed, 1 insertions(+), 0 deletions(-)
...
Committed r9
	A	test-rebase-main
r9 = 35cc8f8944315240ed21d794fb3cf35573cd8e64 (refs/remotes/git-svn)
No changes between current HEAD and refs/remotes/git-svn
Resetting to the latest refs/remotes/git-svn

...
ok 50 - format-patch --signature
ok 51 - format-patch with format.signature config
ok 52 - format-patch --signature overrides format.signature
ok 53 - format-patch --no-signature ignores format.signature
ok 54 - format-patch --signature --cover-letter
ok 55 - format.signature="" supresses signatures
ok 56 - format-patch --no-signature supresses signatures
ok 57 - format-patch --signature="" supresses signatures
